...
- [Video Agent Paradigm Compute Talent Flywheel Ethan He 20260606](ch04/502-agent.md)
...
## Ch15.017 RL Beyond the Verifiable: 当奖励信号无法自动验证时
...
## Ch15.023 LLM Post-Training全景指南：从RLHF到GRPO再到AgenticRL
...
- [Agent自我改进六条路](ch04/502-agent.md) — RL训练与Agent对齐
...
- **Twinlight 混合推理架构**：强推理路径 + 高效路径，由模型自主选择推理路径（[Claude Managed Agents Developer Guide](ch04/502-agent.md) 中的混合推理思路类似但工程实现不同） 
...
## Ch15.025 Reinforcing Recursive Language Models | alphaXiv
...
- [While Breathless In Stodgy Viridian](ch01/450-while-breathless-in-stodgy-viridian.md)
...
## Ch15.027 NVIDIA-ZPPO: Zone of Proximal Policy Optimization
...
## Ch15.028 AlphaEvolve交出一周年炸裂成绩单！AI自我改进不再科幻
...
## Ch15.029 Overcoming Reward Signal Challenges: Verifiable Rewards-based RL with GRPO on SageMaker AI
...
## Ch15.031 EMO: Pretraining mixture of experts for emergent modularity | Ai2
