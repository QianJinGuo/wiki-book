...
## Ch15.015 RL训练一层就够了！单层RL超越全参数训练，跨任务跨模型跨算法全部验证

> 📊 Level ⭐⭐ | 2.4KB | `entities/rl训练一层就够了单层rl超越全参数训练跨任务跨模型跨算法全部验证.md`
...
-> [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/rl训练一层就够了单层rl超越全参数训练跨任务跨模型跨算法全部验证-2026-07-08.md)

---

## Ch15.016 Mind Lab LoRA 持续学习体系：δ-mem + MinT + LoRA Scaling Law + Macaron-A2UI
...
## Ch15.018 SFT, RL, and On-Policy Distillation Through a Distributional Lens
...
## Ch15.019 在线蒸馏OPD vs 离线蒸馏SFT：数学原理与实战优势
...
## Ch15.020 DeepSeek V4 训练方法论深度解读
...
## Ch15.021 RL Beyond the Verifiable: 当奖励信号无法自动验证时
...
## Ch15.023 Yann Dubois（OpenAI Post-Training）× Matt Turck 深度访谈：GPT-5.5、RL 突破、后训练流水线
...
## Ch15.024 Fine-Tuning NVIDIA Cosmos Predict 2.5 with LoRA/DoRA for Robot Video Generation
...
## Ch15.025 xOPD 全景梳理：16 篇论文拆解 On-Policy Distillation 的六个维度与教师角色演化主线
...
## Ch15.026 ACL 2026｜块越大，推理越差？扩散语言模型的新难题被T*破解了
...
## Ch15.027 无惧Off-Policy偏移！Bengio团队解绑后训练，大模型RL提速50倍
...
## Ch15.028 三个理想火枪手创业，打破具身最快百台交付纪录

> 📊 Level ⭐⭐⭐ | 8.3KB | `entities/三个理想火枪手创业打破具身最快百台交付纪录.md`
...
## Ch15.029 小米承办 WPC Qi Plugfest & SRT Event，推动国产无线充电方案融入全球标准体系

> 📊 Level ⭐⭐⭐ | 7.7KB | `entities/小米承办-wpc-qi-plugfest-srt-event推动国产无线充电方案融入全球标准体系.md`
...
## Ch15.030 LLM Post-Training全景指南：从RLHF到GRPO再到AgenticRL
...
> 📊 Level ⭐⭐⭐ | 7.6KB | `entities/看见用户每一步session-replay-与热力图让体验优化有据可依.md`
...
## Ch15.033 全球第一位AI哲学家，在谷歌DeepMind的9年：为AGI安全奔走

> 📊 Level ⭐⭐⭐ | 6.9KB | `entities/全球第一位ai哲学家在谷歌deepmind的9年为agi安全奔走.md`
...
## Ch15.034 百度文心大模型后训练进化（ERNIE 3.0→5.0）
...
## Ch15.035 Reinforcing Recursive Language Models | alphaXiv
...
## Ch15.036 时间序列预测增强方法总结：频域、分解、patch
...
## Ch15.037 NVIDIA-ZPPO: Zone of Proximal Policy Optimization
...
## Ch15.038 AlphaEvolve交出一周年炸裂成绩单！AI自我改进不再科幻
...
## Ch15.039 Overcoming Reward Signal Challenges: Verifiable Rewards-based RL with GRPO on SageMaker AI
...
## Ch15.040 Heidi Health 临床 AI 微调：小模型通过偏好信号达前沿水平
...
> 📊 Level ⭐⭐⭐ | 5.7KB | `entities/强烈推荐的-7-个-神级-python-库.md`
...
## Ch15.042 EMO: Pretraining mixture of experts for emergent modularity | Ai2
...
## Ch15.043 MobileForge：无标注手机 GUI Agent 适配系统（快手、浙大）
...
## Ch15.044 EMCES (ICML 2026) — Episodic Memory-Guided Controllable Experience Synthesis for Reinforcement Learning
...
## Ch15.046 LocalDPO — 面向视频扩散模型的局部细节偏好优化方法 (CVPR 2026)
...
## Ch15.047 Predicting Risk in Content Launches: How Data-Driven Insights can Transform Launch Planning
...
## Ch15.049 50FPS、成本打掉70%，魔芯MoWorld把世界模型带进产业时代
...
ingested: 2026-07-08
source_published: 2026年7月8日 17:59
---
# 50FPS、成本打掉70%，魔芯MoWorld把世界模型带进产业时代
##### 允中 发自 凹非寺  
量子位 | 公众号 QbitAI
...
## Ch15.050 Generalization Dynamics of LM Pre-training — Jiaxin Wen
...
## Ch15.052 What I've been building: ATOM Report, post-training course, finishing my book, and ongoing research
