...
- [750B MoE PD 分离推理 EFA vs RoCE](ch01/217-0.md) — AWS 上的 MoE 推理对比
...
- [Olmo Hybrid and the Hybrid Architecture Wave (2026)](ch01/217-0.md) — 同一架构趋势下 GDN 3:1 混合的工业实践
- [最新开放模型快照](ch01/217-0.md) — Nemotron 3 Nano 线性架构对比
...
- [Jury Dismisses All Claims In Elon Musk S Lawsuit Against Ope](ch01/783-jury-dismisses-all-claims-in-elon-musk-s-lawsuit-against-ope.md)
...
- [SkillRM](ch04/256-skill.md) 关注 skill-level reward model，本文提供更底层的 rubric 评价框架 → 理论-实践互补
...
这一发现对 [Skill Rm Qwen Agent Skill Reward Model](ch04/256-skill.md) 有直接启示：Skill-RM 的渐进式披露机制可以类比为 OPSD 的 per-token KL 分析——资源应该在需要时才激活，而不是一股脑全部暴露。
...
这与 [Skill Rm Qwen Agent Skill Reward Model](ch04/256-skill.md) 中"append resources 反而降分"的消融实验形成强烈呼应：把大量资源（rubric、checklist、verifier）一股脑 append 进 prompt，等价于对所有 token 无差别地增加信息密度，结果是 key signal 被稀释。OPSD 的 per-token clipping 机制和 Skill-RM 的渐进式披露机制，本质上是在解决同一个问题：如何让关键信息在需要的地方出现，而不是均匀分布在所有地方。
...
- [Skill Rm Qwen Agent Skill Reward Model](ch04/256-skill.md)
...
## 相关实体
- [Yann Dubois Openai Post Training Interview](ch04/277-ai.md)
- [Ettin Reranker Family](ch01/479-introducing-the-ettin-reranker-family.md)
- [Rag Chunking Vectorization Rerank Distillation](ch01/310-rag.md)
- [Apo Autonomous Preference Optimization](ch01/528-apo-autonomous-preference-optimization-icml-2026.md)
- [Introducing The Ettin Reranker Family](ch01/479-introducing-the-ettin-reranker-family.md)
...
- → [ds4.c — DeepSeek V4 本地推理](ch01/541-ds4c-deepseek-v4-antirez.md)
...
- [Self-Taught RLVR](ch01/807-self-taught-rlvr.md) — 自监督 RLVR 训练方法
...
- [Self Taught Rlvr](ch01/807-self-taught-rlvr.md)
- [Llm Rl Algorithms Ppo Dpo Grpo Marl Evolution 2026](https://github.com/QianJinGuo/wiki/blob/main/concepts/llm-rl-algorithms-ppo-dpo-grpo-marl-evolution-2026.md)
- [Slim Cuhk Skill Lifecycle Agentic Rl](ch04/256-skill.md)
- [frontier post-training recipe review with finbarr timbers](ch04/277-ai.md)
...
## 交叉参考
- [Skill Design Patterns](ch04/256-skill.md) — Anthropic 14 模式中的 RL 后训练相关策略对比
...
## 相关实体
- [Language Models and Meaning](ch01/489-language-models-and-meaning.md)
...
→ [GEPA优化框架](ch01/380-gepa-optimize-anything.md) — 包含AlphaEvolve等传统LLM进化框架的对比分析
...
- [LLM RL 算法综述](ch01/217-0.md) — DPO 作为本文核心训练方法的算法背景
- [Amazon Nova Lite 微调](ch11/259-amazon-nova.md) — 另一个垂直领域微调的工程实践
- [递归强化语言模型](ch01/803-reinforcing-recursive-language-models-alphaxiv.md) — 奖励模型与偏好学习的理论框架
...
EMCES 是**首个将情景记忆引入可控扩散模型并用于指导强化学习样本合成**的工作。它与 [扩散模型](https://github.com/QianJinGuo/wiki/blob/main/concepts/diffusion-model-architecture.md) 架构相关，但核心创新在记忆驱动的可控生成范式。与 [MR-Agent (NUS ICML 2026)](ch01/310-rag.md) 同属 ICML 2026 记忆增强学习论文，但 EMCES 聚焦于样本合成场景，MR-Agent 聚焦于 memory-reconstructed retrieval。
...
## Ch15.036 LocalDPO — 面向视频扩散模型的局部细节偏好优化方法 (CVPR 2026)
...
- → [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/localdpo-cvpr2026-video-diffusion-local-preference-taobao.md)
...
- [Rlhf Dpo Grpo Alignment](https://github.com/QianJinGuo/wiki/blob/main/concepts/rlhf-dpo-grpo-alignment.md)
- [Diffusion Model Consistency Framework 2026 Survey](ch01/217-0.md)
- [A2Rd Agentic Autoregressive Diffusion Long Video](ch03/045-agent.md)
...
- [New Ai Lock In](ch01/858-the-new-ai-lock-in.md)
...
## Ch15.038 Generalization Dynamics of LM Pre-training — Jiaxin Wen
...
## Ch15.039 What I've been building: ATOM Report, post-training course, finishing my book, and ongoing research
...
- Post-training
- Agent 记忆系统
- [Karpathy: Agentic Engineering](ch04/131-karpathy-vibe-coding-agentic-engineering.md)
- MOC: Evaluation Landscape

---

## Ch15.040 Generalization Dynamics of LM Pre-training — Jiaxin Wen
