...
- [Jury Dismisses All Claims In Elon Musk S Lawsuit Against Ope](ch01/450-jury-dismisses-all-claims-in-elon-musk-s-lawsuit-against-ope.html)
...
- [Nvidia Gemma 4 Edge Ai](ch01/165-nvidia-gemma-4-edge-ai.html)
...
→ [GEPA优化框架](ch01/529-gepa-optimize-anything.html) — 包含AlphaEvolve等传统LLM进化框架的对比分析
...
- → [ds4.c — DeepSeek V4 本地推理](ch01/591-ds4c-deepseek-v4-antirez.html)

## 相关实体
- [DeepSeek-V4深度拆解：一篇论文同时做了五件大事](ch01/367-deepseek-v4.html)
...
- [Reinforcing Recursive Language Models Alphaxiv](ch01/448-reinforcing-recursive-language-models-alphaxiv.html)
...
- Post-training
- Agent 记忆系统
- [Karpathy: Agentic Engineering](ch04/106-karpathy-vibe-coding-agentic-engineering.html)
...
- [递归强化语言模型](ch01/448-reinforcing-recursive-language-models-alphaxiv.html) — 奖励模型与偏好学习的理论框架
...
- [Self-Taught RLVR](ch01/455-self-taught-rlvr.html) — 自监督 RLVR 训练方法
