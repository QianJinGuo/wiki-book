...
## Ch15.034 LLM Post-Training全景指南：从RLHF到GRPO再到AgenticRL
...
## Ch15.036 强烈推荐的 7 个 神级 Python 库
...
## Ch15.037 百度文心大模型后训练进化（ERNIE 3.0→5.0）
...
## Ch15.038 Reinforcing Recursive Language Models | alphaXiv
...
## Ch15.039 时间序列预测增强方法总结：频域、分解、patch
...
## Ch15.040 Vime-Ascend — 基于 vLLM 的开源 RL 后训练框架（华为云昇腾版）
...
## Ch15.042 AlphaEvolve交出一周年炸裂成绩单！AI自我改进不再科幻
...
## Ch15.043 Overcoming Reward Signal Challenges: Verifiable Rewards-based RL with GRPO on SageMaker AI
...
## Ch15.044 Heidi Health 临床 AI 微调：小模型通过偏好信号达前沿水平
...
## Ch15.045 EMO: Pretraining mixture of experts for emergent modularity | Ai2
...
## Ch15.046 MobileForge：无标注手机 GUI Agent 适配系统（快手、浙大）
...
## Ch15.047 EMCES (ICML 2026) — Episodic Memory-Guided Controllable Experience Synthesis for Reinforcement Learning
...
## Ch15.050 LocalDPO — 面向视频扩散模型的局部细节偏好优化方法 (CVPR 2026)
...
## Ch15.052 北航、北大和美团联合提出策略提升强化学习（PIRL/PIPO）
