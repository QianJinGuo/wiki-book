...
## Ch15.037 Vime-Ascend — 基于 vLLM 的开源 RL 后训练框架（华为云昇腾版）
...
## Ch15.038 NVIDIA-ZPPO: Zone of Proximal Policy Optimization
...
## Ch15.039 AlphaEvolve交出一周年炸裂成绩单！AI自我改进不再科幻
...
## Ch15.040 Overcoming Reward Signal Challenges: Verifiable Rewards-based RL with GRPO on SageMaker AI
...
## Ch15.041 Heidi Health 临床 AI 微调：小模型通过偏好信号达前沿水平
...
## Ch15.042 强烈推荐的 7 个 神级 Python 库
...
## Ch15.043 EMO: Pretraining mixture of experts for emergent modularity | Ai2
...
## Ch15.044 MobileForge：无标注手机 GUI Agent 适配系统（快手、浙大）
...
## Ch15.045 EMCES (ICML 2026) — Episodic Memory-Guided Controllable Experience Synthesis for Reinforcement Learning
...
## Ch15.047 LocalDPO — 面向视频扩散模型的局部细节偏好优化方法 (CVPR 2026)
