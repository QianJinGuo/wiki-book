...
- [Pilotdeck Agent Os Openbmb Tsinghua](ch04-124-小龙虾彻底凉了-清华团队连夜开源agent神器pilotdeck-token成本狂降70.html)
...
## 相关主题
- [OpenAI 推理模型（o1/o3/o4-mini）](ch01-381-openai-reasoning-models-o1-o3-o4-mini.html) — OpenAI 推理模型系列
...
- **Twinlight 混合推理架构**：强推理路径 + 高效路径，由模型自主选择推理路径（[Claude Managed Agents Developer Guide](ch01-329-claude-managed-agents-开发者指南.html) 中的混合推理思路类似但工程实现不同） 
...
## 交叉参考
- [Skill Design Patterns](ch07-002-skill.html) — Anthropic 14 模式中的 RL 后训练相关策略对比
- [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/baidu-wenxin-post-training-evolution.md)

## 相关实体
- [LLM Post-Training全景指南：从RLHF到GRPO再到AgenticRL](ch01-710-2026-年面向-llm-的-rl-方法总结-从-ppo-到-dpo-到-grpo-再到多智能体-rl.html)
- [Llm Rl Algorithms Ppo Dpo Grpo Marl Evolution 2026](ch01-725-2026-llm-rl-ppo-dpo-grpo-rl.html)
- MOC
...
→ [GEPA优化框架](ch01-263-gepa-optimize-anything.html) — 包含AlphaEvolve等传统LLM进化框架的对比分析
