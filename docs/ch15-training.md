...
## Ch15.026 无惧Off-Policy偏移！Bengio团队解绑后训练，大模型RL提速50倍
...
## Ch15.027 LLM Post-Training全景指南：从RLHF到GRPO再到AgenticRL
...
## Ch15.028 GRPO遭遇瓶颈？G²RPO-A让自适应指导为小模型推理能力「开外挂」
...
## Ch15.029 百度文心大模型后训练进化（ERNIE 3.0→5.0）
...
## Ch15.030 Reinforcing Recursive Language Models | alphaXiv
...
## Ch15.031 时间序列预测增强方法总结：频域、分解、patch
...
## Ch15.032 NVIDIA-ZPPO: Zone of Proximal Policy Optimization
...
## Ch15.033 AlphaEvolve交出一周年炸裂成绩单！AI自我改进不再科幻
...
## Ch15.034 Overcoming Reward Signal Challenges: Verifiable Rewards-based RL with GRPO on SageMaker AI
...
## Ch15.035 Heidi Health 临床 AI 微调：小模型通过偏好信号达前沿水平
...
## Ch15.036 EMO: Pretraining mixture of experts for emergent modularity | Ai2
...
## Ch15.037 EMCES (ICML 2026) — Episodic Memory-Guided Controllable Experience Synthesis for Reinforcement Learning
...
## Ch15.039 LocalDPO — 面向视频扩散模型的局部细节偏好优化方法 (CVPR 2026)
...
## Ch15.040 50FPS、成本打掉70%，魔芯MoWorld把世界模型带进产业时代

> 📊 Level ⭐⭐⭐ | 1.9KB | `entities/50fps成本打掉70魔芯moworld把世界模型带进产业时代.md`
...
## Ch15.041 Generalization Dynamics of LM Pre-training — Jiaxin Wen
...
## Ch15.042 Generalization Dynamics of LM Pre-training — Jiaxin Wen
...
## Ch15.043 What I've been building: ATOM Report, post-training course, finishing my book, and ongoing research
