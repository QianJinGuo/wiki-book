...
- [Olmo Hybrid and the Hybrid Architecture Wave (2026)](ch01/216-0.md) — 同一架构趋势下 GDN 3:1 混合的工业实践
- [最新开放模型快照](ch01/216-0.md) — Nemotron 3 Nano 线性架构对比
...
## 相关实体
- [Huawei Fuxi Recommendation System Ascend Npu Scaling Law](ch01/534-scaling.md)
...
- → [DeepSeek V4 Triton FP4 优化](ch01/295-deepseek-v4.md)
...
- [Redis之父下场，给DeepSeek V4单独造了一台推理引擎](ch01/295-deepseek-v4.md)
- [MOC](https://github.com/QianJinGuo/wiki/blob/main/moc/llm-core-technology.md)
...
- [Self-Taught RLVR](ch01/808-self-taught-rlvr.md) — 自监督 RLVR 训练方法
...
- [Nvidia Gemma 4 Edge Ai](ch01/672-nvidia-gemma-4-edge-ai.md)
...
→ [GEPA优化框架](ch01/379-gepa-optimize-anything.md) — 包含AlphaEvolve等传统LLM进化框架的对比分析
...
- [Rlhf Dpo Grpo Alignment](https://github.com/QianJinGuo/wiki/blob/main/concepts/rlhf-dpo-grpo-alignment.md)
- [Diffusion Model Consistency Framework 2026 Survey](ch01/216-0.md)
- [A2Rd Agentic Autoregressive Diffusion Long Video](ch03/045-agent.md)
