...
- [Llm Post Training Full Guide](ch04/150-ai.md)
...
- [750B MoE PD 分离推理 EFA vs RoCE](ch01/206-0.md) — AWS 上的 MoE 推理对比
- [Microsoft / GitHub / AWS AI 算力承压](ch04/150-ai.md) — 超大规模算力承压事件
...
> **核心洞察**：PRISM 揭示了 TTT-MLP 高表达力（"步长 × 残差 × 方向"多步迭代）与串行瓶颈是**同一根因的两面**，通过 anchor 代理消除 token 间串行 + 闭合式预计算消除 step 间串行，实现 TTT 级别质量 × GDN 级别速度。[原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/icml-2026-prism-parallel-residual-iterative-sequence-model.md)
...
- [Olmo Hybrid and the Hybrid Architecture Wave (2026)](ch01/206-0.md) — 同一架构趋势下 GDN 3:1 混合的工业实践
- [最新开放模型快照](ch01/214-latest-open-artifacts-20-new-orgs-new-types-of-models.md) — Nemotron 3 Nano 线性架构对比

→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/icml-2026-prism-parallel-residual-iterative-sequence-model.md)
...
> 原文存档：[原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/aws-sagemaker-sft-dpo-tool-calling.md)
...
## 相关引用
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/aws-sagemaker-sft-dpo-tool-calling.md)

---

## Ch15.005 多轮Agent蒸馏终于不翻车！港中文x通义新方法成功率暴涨18点，训练还快32%
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/2026-05-07-多轮Agent蒸馏终于不翻车-港中文x通义新方法成功率暴涨18点-训练还快32--量子位.md)

---

## Ch15.006 xai解散但grok还没死马斯克声称新模型正在训练
...
- [奥特曼最险一战 前女Cto当庭翻脸 Openai权斗彻底打到台前 6Bf26E92E29B](ch04/150-ai.md)
...
## Ch15.007 Notes on pretraining parallelisms and failed training runs.
...
> **来源**：机器之心（2026-05-26）| 原文存档：[原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/minicpm5-1b-forgetrain-machine-heart.md)
...
## 相关实体
- [Thousand Token Wood Sim V2 Hackathon](ch12/003-token.md)
- [Pilotdeck Agent Os Openbmb Tsinghua](ch03/045-agent.md)

→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/minicpm5-1b-forgetrain-machine-heart.md)

---

## Ch15.009 untitled v2
...
## Ch15.010 PhoneWorld (arxiv 2605.29486)：腾讯混元+港中深+人大+武大 规模化可训练 mock Android 环境基础设施（机器之心解读）
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/phoneworld-mobile-agent-scaling-mock-environments-tencent-hunyuan-arxiv-2605-29486.md)
...
## Ch15.011 面壁让AI写了训练框架ForgeTrain，然后它自己训出了最强1B模型

> 📊 Level ⭐⭐ | 3.6KB | `entities/minicpm5-1b-forgetrain-agh-hunt.md`

# 面壁让AI写了训练框架ForgeTrain，然后它自己训出了最强1B模型

→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/minicpm5-1b-forgetrain-agh-hunt.md)
...
## Ch15.012 Rubrics 综述：LLM 训练与评测的显式质量接口
...
- [SkillRM](ch04/245-skill.md) 关注 skill-level reward model，本文提供更底层的 rubric 评价框架 → 理论-实践互补
- [Harness Engineering](ch04/150-ai.md) 的评测循环可引入 rubrics 作为多维质量标准
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/rubrics-survey-llm-evaluation-ruc-nlpir-2026.md)

---

## Ch15.013 Mind Lab LoRA 持续学习体系：δ-mem + MinT + LoRA Scaling Law + Macaron-A2UI
...
## 相关实体
- [Huawei Fuxi Recommendation System Ascend Npu Scaling Law](ch01/658-scaling.md)
...
- [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/nvidia-cosmos-fine-tuning-robot-video-generation.md)
...
## Ch15.015 SFT, RL, and On-Policy Distillation Through a Distributional Lens

> 📊 Level ⭐⭐⭐ | 15.5KB | `entities/untitled-v2.md`

# SFT, RL, and On-Policy Distillation Through a Distributional Lens

→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/untitled-v2.md)
...
这一发现对 [Skill Rm Qwen Agent Skill Reward Model](ch04/245-skill.md) 有直接启示：Skill-RM 的渐进式披露机制可以类比为 OPSD 的 per-token KL 分析——资源应该在需要时才激活，而不是一股脑全部暴露。
...
这与 [Skill Rm Qwen Agent Skill Reward Model](ch04/245-skill.md) 中"append resources 反而降分"的消融实验形成强烈呼应：把大量资源（rubric、checklist、verifier）一股脑 append 进 prompt，等价于对所有 token 无差别地增加信息密度，结果是 key signal 被稀释。OPSD 的 per-token clipping 机制和 Skill-RM 的渐进式披露机制，本质上是在解决同一个问题：如何让关键信息在需要的地方出现，而不是均匀分布在所有地方。
...
## Ch15.016 在线蒸馏OPD vs 离线蒸馏SFT：数学原理与实战优势
...
## 相关实体
- [Yann Dubois Openai Post Training Interview](ch04/150-ai.md)
- [Ettin Reranker Family](ch01/372-introducing-the-ettin-reranker-family.md)
- [Rag Chunking Vectorization Rerank Distillation](ch01/207-rag.md)
- [Apo Autonomous Preference Optimization](ch01/421-apo-autonomous-preference-optimization-icml-2026.md)
...
## Ch15.017 DeepSeek V4 训练方法论深度解读
...
- → [DeepSeek V4 Triton FP4 优化](ch01/777-deepseek.md)
- → [ds4.c — DeepSeek V4 本地推理](ch01/431-ds4c-deepseek-v4-antirez.md)
...
## Ch15.018 RL Beyond the Verifiable: 当奖励信号无法自动验证时
...
- [Self-Taught RLVR](ch01/668-self-taught-rlvr.md) — 自监督 RLVR 训练方法
- [AWS GRPO RLVR](ch11/098-aws-grpo-rlvr-sagemaker-math-reasoning.md) — AWS 在 SageMaker 上实现的 RLVR
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/rl-beyond-the-verifiable.md)

---

## Ch15.019 Fine-Tuning NVIDIA Cosmos Predict 2.5 with LoRA/DoRA for Robot Video Generation
...
- [Navigating Eu Ai Act Requirements For Llm Fine Tuning On Amazon Sagemaker Ai](ch04/150-ai.md)
...
Cosmos Predict 2.5 + Domain LoRA
  ...
  真实机器人部署
```
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/fine-tuning-nvidia-cosmos-predict-25-with-loradora-for-robot-video-generation.md)

---

## Ch15.020 Yann Dubois（OpenAI Post-Training）× Matt Turck 深度访谈：GPT-5.5、RL 突破、后训练流水线
...
- [frontier post-training recipe review with finbarr timbers](ch04/150-ai.md)

## 相关主题
- [OpenAI 推理模型（o1/o3/o4-mini）](ch04/150-ai.md) — OpenAI 推理模型系列
...
## Ch15.022 xOPD 全景梳理：16 篇论文拆解 On-Policy Distillation 的六个维度与教师角色演化主线
...
## Ch15.023 无惧Off-Policy偏移！Bengio团队解绑后训练，大模型RL提速50倍

> 📊 Level ⭐⭐⭐ | 8.5KB | `entities/trajectory-balance-asynchrony-tba-bengio-papweekly.md`

> -> [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/trajectory-balance-asynchrony-tba-bengio-papweekly.md)
...
- [Skillos](ch04/245-skill.md)
- [Yann Dubois Openai Post Training Interview](ch04/150-ai.md)

---

## Ch15.024 LLM Post-Training全景指南：从RLHF到GRPO再到AgenticRL
...
- [Agent自我改进六条路](ch03/045-agent.md) — RL训练与Agent对齐
...
- [Self Taught Rlvr](ch01/668-self-taught-rlvr.md)
- [Llm Rl Algorithms Ppo Dpo Grpo Marl Evolution 2026](https://github.com/QianJinGuo/wiki/blob/main/concepts/llm-rl-algorithms-ppo-dpo-grpo-marl-evolution-2026.md)
- [Slim Cuhk Skill Lifecycle Agentic Rl](ch04/245-skill.md)
- [frontier post-training recipe review with finbarr timbers](ch04/150-ai.md)
...
## Ch15.025 GRPO遭遇瓶颈？G²RPO-A让自适应指导为小模型推理能力「开外挂」
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/2026-05-06-GRPO遭遇瓶颈-G²RPO-A让自适应指导为小模型推理能力-开外挂--机器之心.md)

---

## Ch15.026 百度文心大模型后训练进化（ERNIE 3.0→5.0）
...
- **Twinlight 混合推理架构**：强推理路径 + 高效路径，由模型自主选择推理路径（[Claude Managed Agents Developer Guide](ch03/045-agent.md) 中的混合推理思路类似但工程实现不同） 
...
## 交叉参考
- [Skill Design Patterns](ch04/245-skill.md) — Anthropic 14 模式中的 RL 后训练相关策略对比
- [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/baidu-wenxin-post-training-evolution.md)

## 相关实体
- [LLM Post-Training全景指南：从RLHF到GRPO再到AgenticRL](ch04/150-ai.md)
- [Llm Rl Algorithms Ppo Dpo Grpo Marl Evolution 2026](https://github.com/QianJinGuo/wiki/blob/main/concepts/llm-rl-algorithms-ppo-dpo-grpo-marl-evolution-2026.md)
- [MOC](https://github.com/QianJinGuo/wiki/blob/main/moc/llm-core-technology.md)

---

## Ch15.027 Reinforcing Recursive Language Models | alphaXiv

> 📊 Level ⭐⭐⭐ | 6.4KB | `entities/reinforcing-recursive-language-models-alphaxiv.md`

> -> [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/reinforcing-recursive-language-models-alphaxiv.md)
...
## Ch15.028 时间序列预测增强方法总结：频域、分解、patch
...
- [While Breathless In Stodgy Viridian](ch01/542-while-breathless-in-stodgy-viridian.md)
- [Aws Grpo Rlvr Sagemaker Math Reasoning](ch11/098-aws-grpo-rlvr-sagemaker-math-reasoning.md)
- [Ai True Moat Not Llm But Organization](ch04/150-ai.md)
...
## Ch15.029 NVIDIA-ZPPO: Zone of Proximal Policy Optimization
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/nvidia-zppo-zone-proximal-policy-optimization.md)

---

## Ch15.030 AlphaEvolve交出一周年炸裂成绩单！AI自我改进不再科幻
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/alphaevolve交出一周年炸裂成绩单ai自我改进不再科幻.md)

→ [GEPA优化框架](ch01/313-gepa-optimize-anything.md) — 包含AlphaEvolve等传统LLM进化框架的对比分析

---

## Ch15.031 Overcoming Reward Signal Challenges: Verifiable Rewards-based RL with GRPO on SageMaker AI

> 📊 Level ⭐⭐⭐ | 6.2KB | `entities/overcoming-reward-signal-challenges-verifiable-rewards-based-reinforcement-learn.md`

> -> [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/overcoming-reward-signal-challenges-verifiable-rewards-based-reinforcement-learn.md)
...
## Ch15.032 Heidi Health 临床 AI 微调：小模型通过偏好信号达前沿水平
...
- [LLM RL 算法综述](ch01/890-llm.md) — DPO 作为本文核心训练方法的算法背景
- [Amazon Nova Lite 微调](ch11/250-amazon-nova.md) — 另一个垂直领域微调的工程实践
- [递归强化语言模型](ch01/658-reinforcing-recursive-language-models-alphaxiv.md) — 奖励模型与偏好学习的理论框架
- [腾讯 Token 经济学](ch04/150-ai.md) — AI 模型的成本-质量权衡分析
...
## Ch15.033 EMO: Pretraining mixture of experts for emergent modularity | Ai2
...
## Ch15.034 EMCES (ICML 2026) — Episodic Memory-Guided Controllable Experience Synthesis for Reinforcement Learning
...
EMCES 是**首个将情景记忆引入可控扩散模型并用于指导强化学习样本合成**的工作。它与 [扩散模型](https://github.com/QianJinGuo/wiki/blob/main/concepts/diffusion-model-architecture.md) 架构相关，但核心创新在记忆驱动的可控生成范式。与 [MR-Agent (NUS ICML 2026)](ch03/045-agent.md) 同属 ICML 2026 记忆增强学习论文，但 EMCES 聚焦于样本合成场景，MR-Agent 聚焦于 memory-reconstructed retrieval。

论文地址：https://openreview.net/forum?id=mjYcL7esQO

→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/emces-icml2026-episodic-memory-controlled-experience-synthesis-rl.md)
...
## Ch15.036 Generalization Dynamics of LM Pre-training — Jiaxin Wen
...
## 相关实体
- [Generalization Dynamics Of Lm Pre Training Jiaxin Wen](ch01/820-generalization-dynamics-of-lm-pre-training-jiaxin-wen.md)
...
- [New Ai Lock In](ch01/716-the-new-ai-lock-in.md)
...
## Ch15.037 Generalization Dynamics of LM Pre-training — Jiaxin Wen

> 📊 Level ⭐⭐⭐⭐ | 21.4KB | `entities/generalization-dynamics-pre-training-jiaxin-wen.md`

## 核心要点

- source: [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/generalization-dynamics-pre-training-jiaxin-wen.md)
- review: v=9 × c=9 = 81
- 作者：Jiaxin Wen, Zhengxuan Wu, Dawn Song, Lijie Chen
...
## Ch15.038 What I've been building: ATOM Report, post-training course, finishing my book, and ongoing research
...
- Post-training
- Agent 记忆系统
- [Karpathy: Agentic Engineering](ch04/118-karpathy-vibe-coding-agentic-engineering.md)
- MOC: Evaluation Landscape

---

## Ch15.039 Generalization Dynamics of LM Pre-training — Jiaxin Wen
