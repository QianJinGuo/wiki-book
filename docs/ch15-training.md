...
- [Llm Post Training Full Guide](/ch01-232-how-harnesses-and-post-training-close-the-open-weight-bug-fi/)
...
## 相关实体
- [Llm Rl Algorithms Ppo Dpo Grpo Marl Evolution 2026](/ch01-725-2026-llm-rl-ppo-dpo-grpo-rl/)
...
## 相关实体
- [On Policy Distillation Vs Offline Distillation Loster](/ch04-181-co-existence-vs-co-intelligence-mollick-s-paradigm-shift-on/)
...
- [Rlhf Dpo Grpo Alignment](/ch01-710-2026-年面向-llm-的-rl-方法总结-从-ppo-到-dpo-到-grpo-再到多智能体-rl/)
...
## 相关实体
- [LLM Post-Training全景指南：从RLHF到GRPO再到AgenticRL](/ch01-710-2026-年面向-llm-的-rl-方法总结-从-ppo-到-dpo-到-grpo-再到多智能体-rl/)
- [Llm Rl Algorithms Ppo Dpo Grpo Marl Evolution 2026](/ch01-725-2026-llm-rl-ppo-dpo-grpo-rl/)
- MOC
...
- [LLM RL 算法演进 — ZPPO 的理论基础](/ch01-849-llm-rl中的熵-part-2-熵对训练的调控/)
- [RLHF/DPO/GRPO Alignment — ZPPO 对比的传统方法](/ch01-710-2026-年面向-llm-的-rl-方法总结-从-ppo-到-dpo-到-grpo-再到多智能体-rl/)
- NVIDIA ZPPO — 本实体
- [LLM RL 算法演进 — LLM 强化学习训练范式](/ch01-849-llm-rl中的熵-part-2-熵对训练的调控/)
...
- [腾讯 Token 经济学 — AI 模型的成本-质量权衡分析](/ch09-119-ai-coding-agent-token-成本控制五层模型/)
...
- [Agent 记忆系统](/ch04-073-agent-记忆系统工程税-写入纪律-prompt-cache-冲突-跨模型容量-embedding-迁移-自产-ski/)
