...
→ [Agent Memory 模块化框架与评测](../ch01-238-agent-memory-模块化框架与评测-memory-in-the-llm-era-4-模块-10-方案对比) — Memory 4 模块框架（ICLR 2026 论文）
→ [Agent Memory 架构本质](../ch04-087-agent-memory-架构本质) — Memory 治理理论
