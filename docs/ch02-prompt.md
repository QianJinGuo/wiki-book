...
- **同 skill description / 触发信号**：
  ...
  - AI Skill Evolution Framework（skill 评估与度量）
...
- LLM Post-Training 全景指南 — Post-training 方法论基础（RLHF/GRPO/RLVR）
...
- Yann Dubois OpenAI Post-Training 访谈 — Post-training 职业路径
