...
## Ch02.015 腾讯 Token 优化实战 — 省 Token 和用好 AI 是同一件事

> 📊 Level ⭐⭐ | 10.5KB | `entities/tencent-token-optimization-agent-architecture.md`
...
## Ch02.040 从 Prompt 到 Harness：企业级 Agent 工程的完整演进之路（阿里云开发者）
...
## Ch02.041 Claude Opus 5 系统提示词疑似泄露：Agent 规则到底该如何定？
...
## Ch02.042 从 Prompt 到 Graph：一文理解五层 Agent 工程
...
## Ch02.043 OneReason：快手将推理注入推荐基模的系统性尝试
