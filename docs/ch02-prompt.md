...
HTML Artifacts 是 [Claude Code](ch01-571-claude-code-架构解析.html) 中一种强大的输出形式，它使 Agent 能够生成富交互式的 HTML 文档，显著超越传统 Markdown 的表达能力。
...
-  — 本文讨论的主要工具
- [Claude Code 最佳实践](ch01-248-cursor-harness-model-production-floor.html) — 相关实践指南
...
**Logo 设计场景**：如果模型输出的是栅格图像，曲线错了，用户必须 mask、inpaint、重新生成或手动重画。如果输出是 SVG，用户可以直接编辑路径、原语、渐变、描边或文本元素。这已经是设计师在 [Quiver 等工具](ch04-442-ai-内容创作-开始进入-画布-agent-时代.html) 上设计 Logo 的方式。
...
- [ICLR 2026: 英伟达/普渡用 Agent 闭环实现文生 3D](ch01-417-scenethesis-iclr-2026-英伟达-普渡大学用-agent-闭环实现文生-3d.html) — 同一时期 3D 生成的 Agent 闭环探索
- [DeepSeek 视觉原语](ch09-118-deepseek-visual-primitives-视觉原语作为思考媒介.html) — 视觉表征的另一思路：堆指代精度而非图像分辨率
- [ICLR Agent 3D 生成](ch04-263-build-ai-agents-for-business-intelligence-with-amazon-bedroc.html) — Agent 在 3D 生成中的另一研究路径
...
- [Ethan He: Cosmos / Grok Imagine / Latent Space 视频 Agent](ch01-781-world-s-first-native-color-lidar-gives-machines-human-like-v.html) — 视频与多模态生成的前沿
...
- [From Prompt To Harness Claude Official](ch01-664-stochastic-parrot-thought-experiment.html)
- [Agentcore Managed Harness](ch04-428-harness-engineering-coding-agent.html)
- [Harness Engineering Framework](ch05-041-harness-engineering.html)
- [Hermes Agent Deep Dive Alibaba](ch04-418-hermes-agent.html)
...
## 相关实体
- [Qoder Skills 完全指南](ch07-029-qoder-skills.html)
...
- [Skill 设计模式](ch07-002-skill.html) — 工作流模式与 Skill 设计的关系
- Agent Skill 编写指南 — Skill 格式规范参考
- [Anthropic MCP 重新定义](ch07-044-anthropic-mcp-重新定义-tool-search-代码编排.html) — Anthropic 官方对 Skill + MCP 互补关系的定义

## 相关实体
- [Lessons from Building Claude Code: Seeing like an Agent](ch01-396-how-claude-code-works-in-large-codebases-best-practices-and.html)

- [Anthropic 官方 14 种 Skill 设计模式](ch01-283-anthropic-官方-14-种-skill-设计模式.html)
- MOC
