...
- [DeepSeek 视觉原语](ch09/125-deepseek-visual-primitives.md) — 视觉表征的另一思路：堆指代精度而非图像分辨率
...
- [Claude Fable 5 安全寓言](ch01/675-claude-fable-5-and-new-ai-safety-fables.md) — Nathan Lambert 的安全政策分析
