...
## Ch02.030 新程Alpha认知模型：4B参数端侧部署，群体智能以小搏大比肩GPT-5.4
...
## Ch02.032 Skills 重新定义 Agent 喂知识：从'提前给'到'按需取'的范式反转
...
## Ch02.033 vivo LLM 游戏推荐表达层：从"推什么"到"怎么选
...
- **normalize 层是 Harness 工程的具体实现** — 与 [腾讯 Token 优化 架构](https://github.com/QianJinGuo/wiki/blob/main/entities/腾讯-token-优化-架构.md) 的"约束金字塔"理念一致：模型的原始输出不做接口，外层确定性结构才是接口
- **探索→收敛的工作流** 与 [Improving Agents Data Mining Perspective Langchain](https://github.com/QianJinGuo/wiki/blob/main/entities/improving-agents-data-mining-perspective-langchain.md) 的 Agent 迭代思路相通：先发散再收敛，先探索再约束
...
## Ch02.034 Enrich your datasets with business context: Migrating from legacy Topics to semantic datasets in Amazon Quick
...
## Ch02.035 PROJECT_ANALYSIS.md — PromptQueue + OpenGorilla 项目全景分析
...
## Ch02.036 第 09 篇 · Agent 配置：模型、工具、技能、MCP 与提示词的组合
...
## Ch02.037 腾讯 Token 优化实战 — 省 Token 和用好 AI 是同一件事
...
## Ch02.038 OneReason：快手将推理注入推荐基模的系统性尝试
