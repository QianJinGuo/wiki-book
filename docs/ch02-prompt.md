...
- [001. Hermes Agent 自进化机制源码解析](ch02/001-hermes-agent)
- [002. Claude Code Prompt 与上下文 Harness 设计](ch02/002-claude-code-prompt-harness)
- [003. Agent Skill 编写指南](ch02/003-agent-skill)
- [004. Skills 重新定义 Agent 喂知识：从'提前给'到'按需取'的范式反转](ch02/004-skills-agent)
- [005. Enrich your datasets with business context](ch02/005-enrich-your-datasets-with-business-context)
- [006. AE 到可运行代码：大淘宝 AI 动画全链路方案（实践篇）](ch02/006-ae-ai)
...
- [021. LLM Wiki 架构](ch02/021-llm-wiki)
- [022. OneReason：快手将推理注入推荐基模的系统性尝试](ch02/022-onereason)

### ⭐⭐⭐⭐⭐ 大师（4 篇）

- [023. Hugging Face AI Agent 术语表：Model / Agent / Scaffolding / Harness / Context Engineering / Policy / Tool / Skill / Sub-agent 完整区分](ch02/023-hugging-face-ai-agent-model-agent-scaffolding-harnes)
- [024. 反向审计 Prompt 范式 — 从 VB 50 行 Codex 自我蒸馏到 5 行核心](ch02/024-prompt-vb-50-codex-5)
- [025. Hermes Agent 深度解析（阿里云/飞樰）](ch02/025-hermes-agent)
- [026. Claude Code Prompt 提示词体系源码解析](ch02/026-claude-code-prompt)
