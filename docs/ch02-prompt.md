...
- **同 skill description / 触发信号**：
  ...
  - [Anthropic 官方技能最佳实践 14 模式](/ch04-030-anthropic-官方技能最佳实践-14-个可复用的-agent-skills-设计模式/)（5 类设计模式）
  - [AI Skill Evolution Framework（skill 评估与度量）](/ch07-010-ai-skill-evolution底层逻辑/)
  - [Anthropic+Google Agent Skills 设计模式](/ch04-178-从-anthropic-到-google-agent-skills-进入设计模式阶段/)
- [**同 Codex / OpenAI**：](/ch01-818-一文看懂-openai-开源的-codex-编排规范-symphony/)
...
- [**同 AGENTS.md / 角色边界**：](/ch04-230-一个文件让-ai-coding-效率翻倍-agents-md-实践指南/)
...
- **同 prompt 工程 / 范式**：
  - [Claude Managed Agents](/ch04-421-claude-managed-agents/)（prompt 工程的边界探索）
...
尽管"/responses/compact"端点使用"latent understanding"措辞，但向量表征与模型架构深度耦合使得纯 Latent Compression 的工程可行性存疑。更合理的推断是：厂商做的是 Semantic Compression，但拥有关键信息优势（注意力分布、真实数据、专用压缩模型）。这与 [Harness Engineering](/ch05-010-harness-engineering-ai-从-聪明-到-可靠-的第三代工程范式/) 实践中"在不确定黑盒内部机制时，聚焦可控部分"的原则一致。
...
5. **警惕压缩能力的结构性不对称**：应用层压缩永远受限于信息劣势。不要过度投入"更智能的摘要算法"，而是将资源投入到缓存友好的架构设计和规范的 [Harness Engineering](/ch05-010-harness-engineering-ai-从-聪明-到-可靠-的第三代工程范式/) 实践中——这些是真正可控且可累积的工程优势。
...
- [反向审计 prompt 范式 — 从 vb 50 行 codex 自我蒸馏到 5 行核心](/ch01-508-gpt-5-4-codex-评测-interconnects-的-agent-使用体验/)
- MOC
...
- VibeCoder / Vibe编码 公众号其他文章 — [Cli Mcp Skill Architecture Decision Vibecoder](/ch07-030-cli-mcp-和-cli-skill-应该如何选/) / [Impeccable Vibe Design Philosophy Anomaly](/ch20-ai-philosophy/) / [Impeccable Vibe Design Philosophy Anomaly](/ch20-ai-philosophy/)
...
## Related
- [Hermes Agent](/ch04-418-hermes-agent/) — Nous Research 开源框架（4万+ Stars），核心亮点自进化
...
6. **视觉 AI 的下一竞争点不是模型规模，而是反馈循环质量**：拥有精确、可验证反馈的循环比单纯堆参数更能提升输出质量。这与 Agentic 工程范式 中"反馈驱动改进"的核心一致。
...
- [Agent Memory 架构](/ch04-146-agent-memory-架构本质/) — 与 CC Memory 的对比
- [Obsidian + Claude Code 集成指南](/ch03-002-obsidian-claude-code-集成指南/) — 五种集成策略
...
- [Google Genkit Middleware](/ch04-007-announcing-genkit-middleware-intercept-extend-and-harden/)
...
5. **任务级别预算 + 中断机制是高风险领域的必备**：当系统检测到方向偏离合法研究/合法防御时，**主动中断而非被动拒绝**。这与 [Harness Engineering](/ch05-041-harness-engineering-概念框架/) 中的"deterministic guards" 思路一致——哪些事交给模型决定、哪些事用确定性代码保证，这条线要画清楚。
...
- [Fable 5 on AWS Bedrock](/ch01-293-anthropic-claude-fable-5-on-aws-内置保护措施的-mythos-级功能现已推出/) — 企业部署视角
...
- [Mythos bug hunting 营销](/ch01-675-anthropic-s-bug-hunting-mythos-was-greatest-marketing-stunt/)
...
- [Anthropic 12 MCP 生产模式](/ch04-032-anthropic-官方生产级-agent-最佳实践-12-个可复用的-mcp-设计模式/)
- [Anthropic 14 Skill 模式](/ch04-030-anthropic-官方技能最佳实践-14-个可复用的-agent-skills-设计模式/)
- [Skill Issues Claude Code](/ch09-084-skill-issues-compromising-claude-code-with-malicious-skills/) — 同样的 supply chain 攻击视角
- [System Prompt vs Post-Training — 行为约束应进训练而非 prompt](/ch01-232-how-harnesses-and-post-training-close-the-open-weight-bug-fi/)
...
- **[Hermes Agent](/ch04-418-hermes-agent/)** Hermes的Self-Evolving与OpenClaw的Memory机制对照
...
- [Skills Refiner Design Quality Evaluation Framework](/ch01-531-skills-anthropic-openai-comparison-frontend-design/)
...
- Agent Skill 编写指南 — Skill 格式规范参考
- [Anthropic MCP 重新定义](/ch07-044-anthropic-mcp-重新定义-tool-search-代码编排/) — Anthropic 官方对 Skill + MCP 互补关系的定义
...
## Related
- [Hermes Agent](/ch04-418-hermes-agent/) — Skill 机制是 Hermes 的核心特性之一
...
- [LLM Post-Training 全景指南 — Post-training 方法论基础（RLHF/GRPO/RLVR）](/ch01-710-2026-年面向-llm-的-rl-方法总结-从-ppo-到-dpo-到-grpo-再到多智能体-rl/)
...
- [Qoder Skills 指南](/ch04-024-qoder-skills-完全指南-agent-skill-迭代式编写-ai-按你的标准执行/) — 讨论 skill 约束与 prompt 边界
- [文心 Post-training 演进 — Post-training 工程实践案例](/ch01-232-how-harnesses-and-post-training-close-the-open-weight-bug-fi/)
- [Yann Dubois OpenAI Post-Training 访谈 — Post-training 职业路径](/ch01-374-yann-dubois-matt-turck-openai-后训练与强化学习的内部视角/)
- [Kimi K2.5 架构创新](/ch01-882-kimi-k2-5-架构创新-1t-moe-一层路由-三能力跃迁/) — 同样强调"模型层处理行为，harness 层处理任务"
- [goodfire predictive data debugging：可解释性指导 post-training 数据塑形](/ch01-232-how-harnesses-and-post-training-close-the-open-weight-bug-fi/)
...
- [Harness Engineering](/ch05-076-harness-engineering-从理论到实战-行为正确性死结-上下文腐烂-可驾驭性-ashby-定律/)
- [Karpathy: Vibe Coding 到 Agentic Engineering](/ch04-070-从氛围编程到智能体工程/)
- [Claude Code 源码中的 Agent Harness 构建之道](/ch01-170-深入理解-claude-code-源码中的-agent-harness-构建之道/)
- [Claude Code 源码核心机制](/ch09-056-两万字详解claude-code源码核心机制/)
