...
## Ch01.920 ACL 2026 | RouteMoA：无需预推理的动态路由，实现高效多智能体混合

> 📊 Level ⭐⭐ | 4.9KB | `entities/acl-2026-routemoa无需预推理的动态路由实现高效多智能体混合.md`
...
RouteMoA 引入了一个轻量级 scorer，只根据用户 query，就预测每个模

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/acl-2026-routemoa无需预推理的动态路由实现高效多智能体混合.md)
