...
## Ch01.524 Claude Science — Anthropic 推出面向科研的 AI 工作台
...
2. **结果的可复现性**：科研 Agent 的输出必须可复现、可追溯。Claude Science 提供完整代码、运行环境和对话历史，确保每一步结论都有据可查。这与 [Hermes Agent 技能设计](ch01/395-hermes-agent-skill.html) 中的"透明导向"设计原则一致。
...
- [Anthropic Claude Code 安全争议](ch01/1175-anthropic-claude-code.html)
- [Agent Skill 设计模式](../ch04/264-agent-skill.html)
- [Hermes Agent 技能设计分析](ch01/395-hermes-agent-skill.html)
- [NVIDIA BioNeMo Agent Toolkit](../ch04/312-nvidia-bionemo-agent-toolkit.html)
