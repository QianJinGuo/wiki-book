...
> 📊 Level ⭐⭐⭐⭐ | 13.1KB | `entities/tencent-ai-infra-backend-engineer-huangrunpeng.md`
...
- [Pydantic AI Progressive Agent Skills](https://github.com/QianJinGuo/wiki-public/blob/main/entities/pydantic-ai-progressive-agent-skills-automatorrunner.md) — Python-first AI 框架的另一视角
- [原文存档](https://mp.weixin.qq.com/s/Hg8uPMjTMX8Tk7slrVvfNA)
