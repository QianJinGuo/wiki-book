...
- [Openai Realtime Api Architecture](ch05/100-ai.html) — OpenAI Realtime API 的整体架构
- [Openai Three Voice Models Kill Simultaneous Translation](ch05/100-ai.html) — OpenAI 语音模型矩阵与同传能力的讨论
