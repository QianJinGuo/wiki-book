...
## 核心产品
- [Claude Managed Agents 平台](ch01/217-0.md)
- Claude 系列模型（Claude Haiku/Sonnet/Opus）
- Claude Code 开发工具

## 核心研究
- [Natural Language Autoencoders（NLAs）](ch01/1097-natural-language-autoencoders-anthropic.md) — 激活→文字翻译
- [LLM 内省意识检测](ch01/606-llm.md)
