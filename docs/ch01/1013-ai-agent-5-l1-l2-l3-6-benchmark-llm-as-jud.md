...
## Ch01.1013 AI Agent 评测实战：5 维指标体系 + L1/L2/L3 准出分级 + 评测集三层设计 + 6 大 Benchmark + LLM-as-Judge 三模式
...
| [Agent Eval Wallezhang Yaml Driven Agent Evaluation Framework](ch03/044-agent.md) | **YAML 驱动框架** | AgentEval 工具（130 行）：YAML 驱动的 Agent 评测框架 + pass@k + Golang + CI-CD |
| [Agent Evalkit Aws Opensource Cli Agent Eval Toolkit](ch03/044-agent.md) | **AWS 开源工具** | AgentEvalKit：AWS 开源的 CLI Agent 评测工具包 |
...
| [Saas Bench Gui Agent Eval Unipat](ch03/044-agent.md) | **GUI Agent 评测** | SaaS-Bench：GUI Agent 评测基准 |
