...
> 📊 Level ⭐⭐⭐⭐ | 16.9KB | `entities/读完这篇你就搞懂-deepseek-v4-了-v2.md`
...
> → [原文存档](https://mp.weixin.qq.com/s/MamimcCQj_Hd12T8iFVmKg)
...
这与 [DeepSeek MoE 并行策略](https://github.com/QianJinGuo/wiki-public/blob/main/entities/deepseek-moe-parallel-strategy.md)、[DeepSeek 成本迁移系统层 KV Cache Harness](https://github.com/QianJinGuo/wiki-public/blob/main/entities/deepseek-cost-migration-system-layer-kv-cache-harness.md)、[DeepSeek V4 Training 58-page Paper Deep Dive](https://github.com/QianJinGuo/wiki-public/blob/main/entities/deepseek-v4-training-58-page-paper-deep-dive.md) 等文章形成完整图景。
...
- [DeepSeek V4 Flash Means LLM Steering is Interesting Again](392-deepseek-v4-flash-means-llm-steering-is-interesting-again.html) 关注 V4 Flash 的"可控生成"能力
...
- [DeepSeek Code Harness](../ch09/059-deepseek-code-harness.html) 关注 V4 在 Agent / Harness 场景的工程实践
- [DeepSeek Code Harness 竞争者 Tina](https://github.com/QianJinGuo/wiki-public/blob/main/entities/deepseek-code-harness-competitor-tina.md) 关注竞品分析
...
- **关注 V4 在 Agent / Harness 场景的工程实践**——V4 的能力需要 harness 配合才能在生产中稳定输出，关注 [DeepSeek Code Harness](../ch09/059-deepseek-code-harness.html) 等。
...
- [DeepSeek V4 Flash Means LLM Steering is Interesting Again](392-deepseek-v4-flash-means-llm-steering-is-interesting-again.html)
...
- [DeepSeek 成本迁移系统层 KV Cache Harness](https://github.com/QianJinGuo/wiki-public/blob/main/entities/deepseek-cost-migration-system-layer-kv-cache-harness.md)
- [DeepSeek Code Harness](../ch09/059-deepseek-code-harness.html)
- [DeepSeek Code Harness 竞争者 Tina](https://github.com/QianJinGuo/wiki-public/blob/main/entities/deepseek-code-harness-competitor-tina.md)
