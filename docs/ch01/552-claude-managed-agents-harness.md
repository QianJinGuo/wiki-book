...
## Ch01.552 Claude Managed Agents 官方 Harness 平台指南
...
## 与现有知识库内容的关联
- [Claude Managed Agents](../ch04/531-claude-managed-agents.html) — 托管 Harness 平台
- [Agent/Skills/Teams 架构演进与选型](../ch04/238-agent-skills-teams.html) — Anthropic Skills 认知一致性机制
