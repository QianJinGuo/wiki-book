...
## Ch01.582 Cline releases open-source agent runtime SDK
...
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](../ch04/718-agentic.html) — 从 vibe coding 到 agentic engineering 的范式跃迁
...
- [Agentops Operationalize Agentic Ai At Scale With Amazon Bedr](../ch04/290-agentops-operationalize-agentic-ai-at-scale-with-amazon-bed.html) — AWS Bedrock AgentOps 的规模化运营实践
- [Claude Code Harness Deep Understanding](ch01/637-claude-code-harness-deep-understanding.html) — Claude Code harness 的另一深度解析
...
- [the code-as-content era](ch01/687-the-code-as-content-era.html)
- [the shape of the thing](ch01/400-the-shape-of-the-thing.html)
