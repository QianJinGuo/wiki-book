...
## Ch01.394 DeepSeek V4 Triton FP4 优化实战
...
## 与现有知识关联
- [LBS-IntentBench](../ch04/414-lbs-intentbench.html) — 靳岩岩也是作者之一
- 原文存档 — raw articles 中的完整版本

## 相关实体
- [DeepSeek-V4深度拆解：一篇论文同时做了五件大事](615-deepseek-v4.html)
