...
## Ch01.809 AlphaEvolve: A coding agent for scientific and algorithmic discovery
...
## 相关实体
- [Alphaevolve Impact](../ch04/559-alphaevolve-impact-deepmind.html)
- [Agentmemory Source Analysis Coding Agent Local Memory](../ch09/054-coding-agent.html)
- [Gemma 4 Qat Models Optimizing Compression](ch01/864-gemma-4.html)
- [Servicenow Ui Is Dead Agent](../ch03/037-agent.html)
- [Agentexecutorgooglesdistributedagentruntime](../ch04/466-agentrun.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/alphaevolve-deepmind-discovery-agent.md)

- [hacker news 热帖：ai 会写代码了，为啥还要用 python？](../ch05/124-ai-coding.html)
- [7个月，234次提交，1690行代码：ai编程大型翻车现场：我决定全部作废，手动重写！](../ch05/107-ai.html)
- [一个文件让 ai coding 效率翻倍：agents.md 实践指南](../ch05/124-ai-coding.html)
