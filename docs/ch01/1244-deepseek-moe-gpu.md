...
## Ch01.1244 DeepSeek MoE 并行策略与GPU通信优化

> 📊 Level ⭐⭐ | 4.5KB | `entities/deepseek-moe-parallel-strategy.md`
...
- → [DeepSeek V4论文解读](ch01/1384-deepseek-v4.html) — 训练流程
- → [DeepSeek V4 Pro评测](ch01/1384-deepseek-v4.html) — 模型能力
