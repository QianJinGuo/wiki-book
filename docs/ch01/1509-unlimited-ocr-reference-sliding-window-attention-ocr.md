...
## Ch01.1509 百度提出 Unlimited OCR：用 Reference Sliding Window Attention 实现长文档 OCR 常量 KV Cache
...
- [DeepSeek 效率之争与 JetSpec](ch01/1470-deepseek.html) — 探讨 LLM 解码加速技术，与 R-SWA 的常量 KV cache 设计形成互补
