...
## Ch01.184 Kimi K3，这是 DeepSeek 2.0 时刻

> 📊 Level ⭐ | 2.8KB | `entities/kimi-k3这是-deepseek-20-时刻.md`
...
- [Kimi K3 2 8T Params Open Source](ch01/644-kimi-k3-2-8t.html) — K3 技术参数与开源信息
...
- [Deepseek V4 详解1M 上下文背后真正发生了什么](ch01/687-deepseek-v4.html) — DeepSeek V4 的技术解析
- [Fable 5 官方实战指南找到你的未知](../ch04/576-fable-5.html) — Claude Fable 5 的实战对比
- [Seed 开启持续进化Fable 5 点评Opus 48 水准不比我差](../ch04/576-fable-5.html) — Fable 5 与 Opus 4.8 的对比
