...
## Ch01.539 Seed2.0 Model Card: Towards Intelligence Frontier for Real-World Complexity
...
- [ByteDance Trae Harness 工程指南](ch01/689-trae-harness-engineering.html) — ByteDance 相关工程实践
- [Agent-World](../ch04/697-agent-world.html) — Agent 训练环境扩展，提及 Seed2.0 作为对比基线
