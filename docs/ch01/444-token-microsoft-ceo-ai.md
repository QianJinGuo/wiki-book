...
- vs **[企业 AI 记忆底座 三层架构](../ch06/015-memory.html)** — 三层架构 = 知识底座的**工程实现**;纳德拉 Token 资本 = 知识底座背后的**经济学理由**。
- vs **[Anthropic 缓存 Token 经济](ch01/1592-anthropic.html)** — 缓存是**Token 成本优化**的具体技术杠杆;纳德拉说的是**Token 作为资本形态**的存在论层面。
...
- [企业 AI 记忆底座 三层架构](../ch06/015-memory.html)
- [Anthropic 缓存 Token 经济](ch01/1592-anthropic.html)
