...
- [Loop Engineering Overview Tech Minimalism](../ch05/122-loop-engineering.html) — Loop Engineering 的编排范式，与 AI 搜索 agent 的可靠性建设相关
- [Alibaba Data Rd Harness Engineering Nl2Sql](../ch05/065-harness-engineering.html) — 阿里 NL2SQL 实践中的幻觉防控策略，与搜索结果的真实性校验互补
- [Ant Group Medical Agent Afu](../ch03/019-agent.html) — 蚂蚁医疗 Agent 的安全评测实践
