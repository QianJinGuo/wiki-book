...
## Ch01.409 Can We Agree on a Storage/Workload Architecture Taxonomy? — Jack Vanlightly
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/storage-workload-architecture-taxonomy-vanlightly.md)
