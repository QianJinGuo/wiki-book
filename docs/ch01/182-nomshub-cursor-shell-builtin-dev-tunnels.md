...
- [Microsoft MXC](../ch03/004-agent.html) — 微软自家跨 OS 沙箱，提供 kernel 隔离，可作 NomShub 的防御侧
- [CrewAI 三步防护](../ch05/008-harness.html) — 应用层 guardrail 视角
- [AI Tool Poisoning](../ch04/226-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s.html) — 工具被污染的通用风险
