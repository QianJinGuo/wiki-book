...
这与 [nanobot](ch04/502-agent.md) 的 subagent 机制本质相同（spawn 长任务到后台），但 OpenAI 把这个机制产品化、规模化，让无技术背景的用户也能用。
...
- [Nanobot Agent Framework Architecture Deep Dive](ch04/502-agent.md) — subagent / 长周期任务的极简框架样本
...
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](ch04/502-agent.md) — 锯齿智能与 Codex 能力组合
...
- [Agent Harness Context Management Working Set](ch04/502-agent.md) — Appshots 引发的 working set 管理新挑战
