...
- [2026 年面向 LLM 的 RL 方法总结](ch01/859-llm.html) — PPO/DPO/GRPO 全景综述
- [APPO：阿里高德 Agent RL 信用分配到每个决策点](../ch04/718-agentic.html) — 另一 ARPO 系列 RL 方法
- [Self-Taught RLVR：京东让大模型自己教自己](ch01/1146-self-taught-rlvr.html)
