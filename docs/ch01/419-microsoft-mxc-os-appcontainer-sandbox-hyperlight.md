...
>
> 原文：→ [原文存档](http://www.originhq.com/research/mxc-execution-containers-internals)
...
→ [MXC Internals 原文存档](http://www.originhq.com/research/mxc-execution-containers-internals)

## 相关阅读

- [Microsoft RAMPART/Clarity](https://github.com/QianJinGuo/wiki-public/blob/main/entities/microsoft-open-sources-rampart-clarity.md) — 同期微软开源的 agent 红队 + 可观测性栈
- **Cloud Agent Infrastructure** — 云端 agent state/凭据隔离
- [CrewAI Agent Security 三步防护](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-security-three-step-sequence-harness-governance-identity-crewai.md) — 应用层 guardrail 视角
- [AI Tool Poisoning 调查](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-security-v2.md) — agent 工具被污染的攻击面
