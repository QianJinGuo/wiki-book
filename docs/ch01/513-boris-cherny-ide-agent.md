...
这与 [Harness Engineering Core Patterns](../ch05/096-harness-engineering.html) 中"控制面应当外置给人类"的工程原则一致——Human-in-the-Loop 不是降级方案，而是 Agent 系统设计的核心约束。
...
这与 [Claude Code Harness 深度解析](../ch05/089-claude-code-harness.html) 中的 harness 设计哲学一致——harness 的核心价值就是为 Agent 提供持续运行的工程环境，而非一次性对话界面。
...
这些边界问题在 [Agent 记忆系统工程实践](../ch03/006-agent.html) 中被称为"过程资产"——Agent 系统不仅要完成任务，还要留下可审查、可重放、可学习的中间表示。
...
这与 [Karpathy Vibe Coding 到 Agentic Engineering](../ch04/757-agentic.html) 中的论述相互印证——"Vibe Coding"是 Agent 时代的临时形态，"Agentic Engineering"才是稳定形态。
...
- [DeepSeek V4 Flash Pro](ch01/1308-deepseek-v4-flash-pro.html)
- [加速 LLM 模型加载与上下文窗口](ch01/1402-accelerate-llm-model-loading-and-increase-context-windows-wi.html)
- [大型表格模型基础](../ch05/113-ai.html)
