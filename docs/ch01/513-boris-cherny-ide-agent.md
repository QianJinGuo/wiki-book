...
这与 [Karpathy Vibe Coding 到 Agentic Engineering](../ch04/725-agentic.html) 中的论述相互印证——"Vibe Coding"是 Agent 时代的临时形态，"Agentic Engineering"才是稳定形态。
...
- [加速 LLM 模型加载与上下文窗口](ch01/1380-accelerate-llm-model-loading-and-increase-context-windows-wi.html)
