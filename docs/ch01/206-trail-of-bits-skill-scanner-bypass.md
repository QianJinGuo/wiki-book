...
### 与 [Skillclaw](../ch04/472-skillclaw-nacos-agent-skill-registry.html) 的关系
...
5. **企业内 skill hub + 代码审计**：相比公共 marketplace，企业自建 skill hub 并对 skill 进行代码审计是更可靠的安全模型。可参考 [Skillsieve Agent Skill Security](../ch04/457-skillsieve-agent-skill.html) 中的企业级 skill 安全实践。
...
- [Skillsieve Agent Skill Security](../ch04/457-skillsieve-agent-skill.html) — 企业级 skill 安全实践
