...
## Ch01.1059 高德 Uplift 模型迭代 Agent：长时间运行 Harness
...
- [gemma 4 and what makes an open model succeed](ch01/717-gemma-4-and-what-makes-an-open-model-succeed.html)
- [model-harness-fit-agent-harness](ch01/250-model-harness-fit-agent.html)
