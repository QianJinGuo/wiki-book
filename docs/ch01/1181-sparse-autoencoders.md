...
## Ch01.1181 Sparse Autoencoders

> 📊 Level ⭐⭐⭐⭐ | 5.6KB | `entities/sparse-autoencoders.md`

## 关联
- [Natural Language Autoencoders](ch01/1200-natural-language-autoencoders-anthropic.md) — NLA 在 SAE 基础上增加文字输出能力
- [Anthropic](ch01/855-anthropic.md) — 主要研究机构
