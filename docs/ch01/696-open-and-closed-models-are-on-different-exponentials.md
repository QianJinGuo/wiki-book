...
## Ch01.696 Open and Closed Models Are on Different Exponentials
...
- 模型经济学
- [Karpathy: Vibe Coding 到 Agentic Engineering](../ch04/129-karpathy-vibe-coding-agentic-engineering.html)
- Anthropic Claude
- OpenAI
- 开源 AI
