...
## Ch01.913 因熟知而忽视：底层系统里，藏着 20% 未被挖掘的算力成本

> 📊 Level ⭐⭐ | 5.0KB | `entities/因熟知而忽视底层系统里藏着-20-未被挖掘的算力成本.md`
...
```mermaid
mindmap
  root(("因熟知而忽视 底层系统里 藏着 20 未被挖掘的算力成本"))
    CPU 时代 误把成熟当不再变化
    GPU 时代 CPU 从未退场
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/因熟知而忽视底层系统里藏着-20-未被挖掘的算力成本.md)
