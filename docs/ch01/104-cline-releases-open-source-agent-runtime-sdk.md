...
## Ch01.104 Cline releases open-source agent runtime SDK
...
- [Cline open-source agent runtime SDK（姊妹条目）](../ch03/006-agent.html)
- [State of CLI coding agents（2026 年中）](../ch09/176-state-of-cli-coding-agents-mid-2026.html)
- [OpenSquilla 开源 AI Agent](../ch04/805-opensquilla-launches-open-source-ai-agent-to-cut-token-costs.html)
