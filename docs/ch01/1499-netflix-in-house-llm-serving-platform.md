...
- [LLM 推理流水线完整解析](ch01/855-llm.html) — Prefill/Decode 理论
- [SGLang](../ch04/699-agent-assisted-sglang-ai-llm.html) — 另一推理框架
- [Disaggregated Prefill/Decode](ch01/855-llm.html) — 分离式推理架构
- [OpenAI-Compatible API on SageMaker](ch01/964-announcing-openai-compatible-api-support-for-amazon-sagemake.html) — 类似 API 设计决策
- [FSx for Lustre GPU Direct](ch01/437-aws.html) — 模型加载/缓存方案
