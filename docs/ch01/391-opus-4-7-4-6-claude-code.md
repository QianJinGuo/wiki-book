...
- [Claude Code Dynamic Workflows Multi Agent Orchestration](ch03/077-claude-code.html) — Claude Code 多 Agent 编排完整指南
- [Claude Code Dynamic Workflows 8Th Translation Xingxiaozhao](ch03/077-claude-code.html) — Claude Code 动态工作流译注
