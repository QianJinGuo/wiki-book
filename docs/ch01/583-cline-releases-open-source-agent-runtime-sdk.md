...
- [存之有序治之有矩Agent 记忆系统的工程实践与演进](../ch03/019-agent.html) — Agent 记忆系统的工程实践，与"持久化在文件系统"理念呼应
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](../ch04/298-agentic.html) — 从 vibe coding 到 agentic engineering 的范式跃迁
- [Karpathy Vibe Coding Agentic Engineering](../ch04/824-karpathy-vibe-coding-agentic-engineering.html) — Vibe Coding 与 Agentic Engineering 的同源访谈
