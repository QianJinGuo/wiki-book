...
## Ch01.1343 6 Months to Live for Open Models

> 📊 Level ⭐⭐⭐⭐⭐ | 8.9KB | `entities/6-months-to-live-for-open-models.md`
...
- [Kimi K3 The Open Weights Escalation](ch01/493-kimi-k3-the-open-weights-escalation.html) — Companion piece on Kimi K3 as the strongest open model ever released, directly relevant to the frontier capability debate
