...
## Ch01.564 Claude Managed Agents 开发者指南
...
## 与 PM 视角的关系
| 视角 | 本文（开发者指南） | [PM 视角](../ch04/576-anthropic-pm-agentic.html) |
|------|-----------------|-----------------|
...
- [Agent Harness 上下文管理：工作集视角](../ch05/042-agent-harness.html) — 托管 Harness 与本地 Harness 的上下文管理对比
