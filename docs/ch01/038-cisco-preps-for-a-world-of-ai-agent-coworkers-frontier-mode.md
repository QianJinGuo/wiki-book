...
## Ch01.038 Cisco Preps For A World Of AI Agent Coworkers, Frontier Model Threats
...
前沿模型的能力提升带来新的安全威胁——更强的模型可能被滥用于社会工程、代码漏洞利用和信息操纵。

### 3. 企业网络的 agent 准备度
企业网络当前设计假设所有流量来自人类用户——agent 流量有不同的模式（高频、自动化、批量），需要不同的监控和安全策略。
...
### 2. Agent 流量需要独立的监控策略
Agent 流量的模式不同于人类——需要独立的异常检测和安全策略。
...
- [World Knowledge Agent Self Evolution Tencent Hkustgz](../ch04/357-world-knowledge-agent.html)
- [Introducing Aimap Security Testing For Ai Agent Bishop Fox](../ch04/511-introducing-aimap-security-testing-for-ai-agent-bishop-f.html)
- [Alphaevolve Deepmind Discovery Agent](../ch03/035-agent.html)
- [Huggingface Ai Agent Glossary Model Scaffolding Harness Tool Skill Subagent](../ch04/762-ai-agent.html)
...
- [olmo-eval: an evaluation workbench for the model development](ch01/1082-olmo-eval-an-evaluation-workbench-for-the-model-development.html)

## 摘要

Published Time: 2026-06-03T00:10:37.000Z
