...
## Ch01.949 Dwarkesh Patel：下一代AI，可能是干活干出来的

> 📊 Level ⭐⭐ | 4.4KB | `entities/dwarkesh-patel下一代ai可能是干活干出来的.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/dwarkesh-patel下一代ai可能是干活干出来的.md)
