...
## Ch01.1377 Ishigaki-IDS — 建筑 BIM 领域专用基础模型（合成数据 + CPT/SFT/RLVR）
...
- [RLVR 概念](https://github.com/QianJinGuo/wiki/blob/main/concepts/rlvr-reinforcement-learning-verified-reasoning.md) / [Self-taught RLVR](ch01/1153-self-taught-rlvr.html) / [可验证奖励 RL](https://github.com/QianJinGuo/wiki/blob/main/entities/overcoming-reward-signal-challenges-verifiable-rewards-based-reinforcement-learn.md) / [合成数据](https://github.com/QianJinGuo/wiki/blob/main/concepts/synthetic-data-generation.md)
