...
## Ch01.1190 FDE（Field Deployment Engineer）非共识与落地指南 — 硅谷一线实践者圆桌
...
- 与 [Ibm Forward Deployed Units Ai Deployment](../ch05/079-ai.html) 互补——IBM 的 FDE 是公司战略视角，本文是一线实践视角
...
- "模型是最容易被替代的一层" 呼应 [Agent Vs Workflow Control Continuum Framework](../ch04/597-agent-vs-workflow.html) 中护城河不在模型而在工程层
