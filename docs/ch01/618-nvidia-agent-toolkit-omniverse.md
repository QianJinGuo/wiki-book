...
这实际上是对 [NVIDIA Agentic Systems](../ch04/740-agentic.html) 中"极端协同设计"理念的具体化——智能体不仅是辅助设计的工具，更是仿真环境的构建者和验证者。
...
- [NVIDIA Agentic Systems 极端协同设计](../ch04/740-agentic.html)
...
- [NVIDIA Nemotron-3 多模态 Agent](../ch04/740-agentic.html)
- [Harness Engineering 范式](../ch05/065-harness-engineering.html)
- Bedrock AgentCore 质量优化飞轮
- [NVIDIA ENPIRE 机器人策略自改进](../ch04/740-agentic.html)
