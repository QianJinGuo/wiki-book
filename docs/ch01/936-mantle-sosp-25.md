...
## Ch01.936 百度沧海·存储 Mantle 系统架构演进之路，SOSP'25 论文背后的故事

> 📊 Level ⭐⭐ | 4.8KB | `entities/百度沧海存储-mantle-系统架构演进之路sosp25-论文背后的故事.md`
...
```mermaid
mindmap
  root(("百度沧海·存储 Mantle 系统架构演进之路，SOSP…"))
    1. 背景
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/百度沧海存储-mantle-系统架构演进之路sosp25-论文背后的故事.md)
