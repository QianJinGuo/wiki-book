...
## Ch01.430 Olmo Hybrid and future LLM architectures
...
This connects directly to the [inference cost analysis](ch01/902-20.html) — memory bandwidth is the bottleneck for long-context inference, and hybrid architectures fundamentally reduce this pressure.
...
- [Inference cost at scale with napkin math](ch01/902-20.html)
