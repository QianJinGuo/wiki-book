...
- [Nathan Lambert：开源权重安全论的三个认知陷阱](ch01/610-nathan-lambert.html) — Lambert 之前的文章，聚焦于开源安全论点的具体错误
- [Dean Ball 论开源模型与政府控制](ch01/1044-dean-ball-on-open-models-and-government-control.html) — 从政策角度分析，但缺少事件内幕视角
- [Claude Fable 5 and new AI safety fables](ch01/1174-claude-fable-5-and-new-ai-safety-fables.html) — Fable 安全讨论的综述
