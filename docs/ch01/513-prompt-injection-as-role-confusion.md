...
## Ch01.513 Prompt Injection as Role Confusion
...
这个框架对 [Hermes Agent Self-Evolving](ch04/503-agent.md) 和其他 Agent 系统的安全设计有直接启示：
...
- [Hermes Agent Self-Evolving](ch04/503-agent.md) — Agent 安全治理
- Agent Security Threat Model — Agent 安全威胁模型
- [Agent Harness Context Management](ch04/503-agent.md) — 上下文管理中的安全挑战
