...
## Ch01.1000 Interaction Models: A Scalable Approach to Human-AI Collaboration
...
We train an interaction model from...^[].md]
...
**3. 双模型架构的工程哲学：响应性 vs. 智能性的正交分解**^[].md]
...
→ [[raw/articles/genesis-ai-gene-25-embodied-foundation-model.md|原文存档]

## 实践启示
**1. 评估现有 Agent 系统的"人在 loop"体验**^[].md]
...
**3. 多模态 Agent 项目优先考虑"最难模态优先"的架构原则**^[].md]
