...
## Ch01.289 AGI 之路，可能从一开始就走错了（腾讯研究院·王鹏）
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/agi-之路-可能从一开始就走错了.md)
...
```mermaid
mindmap
  root(("AGI 之路，可能从一开始就走错了（腾讯研究院·王鹏）"))
    深度分析
      「博弈论锁定」是这篇文章最重要的概念
...
一旦任何一家先做出更大一号的模型，其他公司在估值、融资、人才争夺上全线落后。整个行业进入「谁不 scale 谁就死」的纳什均衡。这个框架解释了为什么连 [DeepMind](../ch03/035-agent.html) 这样原本走专业路线的机构也必须做 Gemini，为什么 Anthropic 分裂出来仍然押大模型，为什么坚守专业化的公司都得在内部单开大模型产品线——**不是大模型赢了，是 scaling 叙事赢了**。
...
- [Agi Road May Be Wrong From The Start Wang Peng Tencent](ch01/221-agi.html) — 同一文章的英文 slug 版本
- [Ai Employment Eight Changes Tencent Research](../ch05/094-ai.html) — 腾讯研究院对 AI 就业的另一篇分析
- [Alphaevolve Deepmind Discovery Agent](../ch03/035-agent.html) — DeepMind 专业化路径的代表作
- [Alphaevolve Impact Deepmind](../ch04/464-alphaevolve-impact-deepmind.html) — DeepMind 路线的影响评估
- [100 年压缩到 100 天红杉资本这就是 Agi](ch01/221-agi.html) — 红杉对 AGI 速度的判断
...
- [Reasoning Models](https://github.com/QianJinGuo/wiki/blob/main/concepts/reasoning-models.md) — 推理模型与 scaling 替代路径- [腾讯研究院ai速递 20260508](../ch05/094-ai.html)
