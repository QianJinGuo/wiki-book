...
## Ch01.1170 Residual Context Diffusion (RCD)：Apple 残差上下文扩散语言模型
...
RCD 为扩散语言模型的推理效率提供了一个实用改进方向，特别适用于需要高精度推理能力的场景。与 `diffusion-language-models` 和 [推理优化](https://github.com/QianJinGuo/wiki/blob/main/entities/morphllm-codegen-inference-optimization.md) 相关。

→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/residual-context-diffusion-apple-ml-2026-07.md)
