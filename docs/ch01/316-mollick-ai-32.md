...
> 📊 Level ⭐⭐⭐ | 8.2KB | `entities/mollick-ai-32-otters-benchmark.md`
...
- `[Oneusefulthing Claude Code What Comes Next](https://github.com/QianJinGuo/wiki-public/blob/main/entities/oneusefulthing-claude-code-what-comes-next.md)` — Mollick 早期对 Claude Code 实战评估（实体待建）
- `[Gpt5 Just Does Stuff Mollick](https://github.com/QianJinGuo/wiki-public/blob/main/entities/gpt5-just-does-stuff-mollick.md)` — Mollick 对 GPT-5 自主性的判断（实体待建）
- `[Jagged Ai Frontier Mollick](https://github.com/QianJinGuo/wiki-public/blob/main/entities/jagged-ai-frontier-mollick.md)` — Mollick 锯齿前沿理论（实体待建）
- `[Mass Intelligence](https://github.com/QianJinGuo/wiki-public/blob/main/entities/mass-intelligence.md)` — 群体智能边界（实体待建）

## 相关实体

- [fusedash -  generative analytics platform | ai dashboard sof](https://github.com/QianJinGuo/wiki-public/blob/main/entities/fusedash-generative-analytics-platform.md)
