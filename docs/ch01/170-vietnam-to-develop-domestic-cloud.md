...
## Ch01.170 Vietnam to develop domestic cloud
...
- 数据主权和网络安全是核心驱动力，当前法律要求个人数据本地存储
...
## 实践启示
- **云服务商**：越南市场的机会在于帮助其建设而非直接运营，数据主权需求创造本地化合作窗口。
...
- [Vietnam to develop domestic cloud so it can ditch risky overseas operators for government workloads](https://github.com/QianJinGuo/wiki/blob/main/entities/vietnam-domestic-cloud.md)- [anthropic](ch01/1299-anthropic.html)- [inference cost at scale with napkin math](ch01/888-20.html)- [why use app-level auth when every database has auth? (splunk](ch01/173-why-use-app-level-auth-when-every-database-has-auth-splunk.html)
