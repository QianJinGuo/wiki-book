...
- [AI Infra：大模型高效推理](ch05/100-ai.html) — vLLM 技术原理层面
- [LLM 推理流水线完整解析](ch01/1476-llm.html) — Prefill/Decode 理论
- [SGLang](ch01/963-1-sglang-radixark-ai.html) — 另一推理框架
- [Disaggregated Prefill/Decode](ch01/1476-llm.html) — 分离式推理架构
- [OpenAI-Compatible API on SageMaker](ch05/100-ai.html) — 类似 API 设计决策
