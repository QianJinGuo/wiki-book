...
## Ch01.246 NomShub — Cursor 远程隧道利用链：Shell Builtin 沙箱逃逸 + Dev Tunnels 武器化
...
- [AI Tool Poisoning](../ch04/310-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s.html) — 工具被污染的通用风险
