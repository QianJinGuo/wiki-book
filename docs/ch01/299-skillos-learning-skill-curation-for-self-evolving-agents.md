...
## Ch01.299 SkillOS: Learning Skill Curation for Self-Evolving Agents
...
## 相关实体
- [SkillOS: Learning Skill Curation for Self-Evolving Agents](../ch04/222-self-evolving-agents.html)
...
- [LLM-as-a-Verifier: A General-Purpose Verification Framework](ch01/607-llm.html)
- [民生银行基于规格驱动开发（SDD）的 CodeAgent 私域研发探索与实践](../ch03/035-agent.html)
- [LLM agent脚手架如何具备自进化能力？——以hermes agent为例](../ch03/093-hermes-agent.html)
...
- [self-evolving agents 系统性综述（厦门大学等多机构联合）](../ch04/222-self-evolving-agents.html)
- [万级实时推理的商品领域agent实践思考和总结](../ch03/035-agent.html)
- [工作流的 skill 怎么写？从 7 个顶级 skill 中提炼的模式与最佳实践](../ch04/270-skill.html)
