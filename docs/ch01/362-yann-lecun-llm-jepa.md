...
## Ch01.362 Yann LeCun 谈 LLM 不是智能与世界模型 JEPA
...
- [private fintech has quietly become bigger than public fintec](425-private-fintech-has-quietly-become-bigger-than-public-fintec.html)
- [the inevitable need for an open model consortium](359-the-inevitable-need-for-an-open-model-consortium.html)
