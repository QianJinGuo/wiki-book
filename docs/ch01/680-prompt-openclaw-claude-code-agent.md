...
## Ch01.680 别再亲自写Prompt了！OpenClaw与Claude Code创始人已经用'循环'让一堆Agent自动打工了

> 📊 Level ⭐⭐ | 6.7KB | `entities/openclaw-boris-cherny-agent-loop-design-patterns.md`
...
- [MCP 12 设计模式](ch01/1299-anthropic.html)
- [OpenClaw 多智能体团队](../ch11/228-openclaw.html)
...
- [Agent 原理与工程实践](../ch03/046-agent.html)
- [Figma Make](../ch03/048-figma-make.html)
- [华术设计 2.0](ch01/1216-0.html)
