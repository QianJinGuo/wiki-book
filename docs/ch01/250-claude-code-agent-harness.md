...
## Ch01.250 深入理解 Claude Code 源码中的 Agent Harness 构建之道
...
- [OpenClaw 完整指南](ch11/215-openclaw.md) — 开源对应物（Worktree 隔离模式实现）
- [Harness Engineering 一文](ch04/277-ai.md) — Harness 概念的系统阐释
