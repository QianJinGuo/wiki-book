...
## Ch01.1301 看完 Claude Code Agent Teams，我更确定接下来拼的是 Agent Runtime，技术拆解：Lead、Task List、Mailbox 和 Hooks 是什么东西

> 📊 Level ⭐⭐ | 3.9KB | `entities/claude-code-agent-teams-xingxiaozhao.md`
