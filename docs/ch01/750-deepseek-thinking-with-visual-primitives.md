...
## Ch01.750 DeepSeek Thinking with Visual Primitives 深度解读
...
分开训的原因：避免模式冲突（用框和用点的思维方式有差异，混在一起训会互相干扰） See also [Karpathy Vibe Coding To Agentic Engineering](https://github.com/QianJinGuo/wiki-public/blob/main/entities/karpathy-vibe-coding-to-agentic-engineering.md)
...
- [被裁了想转 ai agent？先看面试官到底在筛你哪 7 样东西](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-interview-7-capabilities.md)
