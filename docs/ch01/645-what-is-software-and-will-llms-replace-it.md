...
## Ch01.645 What Is Software, and Will LLMs Replace It?
...
现代 agent 架构（如 [Claude Code](../ch09/085-claude-code-dynamic-workflows.html)、Codex）的设计本质上就是这一分层的实现：
...
这与 [Anthropic 数据分析](ch01/1286-anthropic.html) 的实践相呼应——即使 LLM 能生成分析，数据的结构化组织仍然是前提。
...
- [Agent Harnesses](../ch04/671-agent-harnesses-are-dead-long-live-agent-harnesses.html) — Agent 架构的演进
- [Claude Code Workflows](../ch09/085-claude-code-dynamic-workflows.html) — Agent 工作流设计
- [本文实体](ch01/1231-llm.html) — Tomassetti 的分析
- [AI Agent Hype](../ch04/291-ai-agent.html) — 对 AI agent 过度炒作的冷静分析
