...
## Ch01.956 LLM-as-a-Verifier: A General-Purpose Verification Framework
...
- [LLM-as-a-Verifier Framework（同源实体）](ch01/1132-llm.html)
- [LLM-as-a-Verifier（同源实体）](ch01/781-llm-as-a-verifier-a-general-purpose-verification.html)
...
- [LLM-as-a-Judge 实践案例](ch01/457-evaluating-netflix-show-synopses-with-llm-as-a-judge.html)
- [SWE-bench Agent 评估方法论](../ch04/462-swe-bench-agent.html)
