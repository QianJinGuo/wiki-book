...
## Ch01.1134 Introducing Claude Tag
...
- [Claude Code Agent View](ch09/001-claude-code-agent-view.md) — Claude Code 的 Agent 架构
- [Context Engineering](https://github.com/QianJinGuo/wiki/blob/main/concepts/context-engineering.md) — 上下文工程的理论与实践
- [Agent Harness Context Management](ch05/009-harness.md) — Agent 上下文管理
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/claude-tag-agent-identity-slack-xinzhiyuan-2026.md)

---

## 第 3 来源 — 架构师 JiaGouX 报道：Karpathy 三段式 LLM UI/UX 范式 + Boris Cherny 原话（2026-06-30）

> Source: [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/claude-tag-karpathy-three-paradigms-jiagoux-2026.md)
> Author: 架构师（JiaGouX）
> Date: 2026-06-30
...
→ [第3原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/claude-tag-karpathy-three-paradigms-jiagoux-2026.md)
