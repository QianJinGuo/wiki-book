...
## Ch01.659 Prompt Injection as Role Confusion
...
这个框架对 [Hermes Agent Self-Evolving](../ch03/093-hermes-agent.html) 和其他 Agent 系统的安全设计有直接启示：
...
- [Hermes Agent Self-Evolving](../ch03/093-hermes-agent.html) — Agent 安全治理
