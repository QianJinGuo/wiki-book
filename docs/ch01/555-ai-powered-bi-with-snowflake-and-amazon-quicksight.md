...
- **[SchemaFlow](ch01/435-openai.md)**：Agent 驱动的数据库 SQL 生成，同样需要语义约束
- **[Data-Native Agents](../ch04/469-how-to-build-agents-where-data-already-lives.md)**：Agent 直接在数据平台上运行，语义层是关键基础设施
...
- [SchemaFlow](ch01/435-openai.md) — Agent 驱动的 SQL 生成
- [Anthropic Data Analysis](ch01/833-anthropic.md) — LLM 数据分析的另一个视角
