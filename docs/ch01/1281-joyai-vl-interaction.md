...
## Ch01.1281 京东JoyAI-VL-Interaction：全球首个全栈开源实时视频交互模型
...
JoyAI-VL-Interaction是京东2026年模型基建系列的一部分，与[JoyAI-Echo长视频生成框架](../ch05/089-ai.html)、JoyAI-Image-Edit、JoyAI-LLM Flash等共同构成京东的开源AI矩阵。
