...
## Ch01.160 Thread by @ZeusRWA on Thread Reader App
...
传统 Crypto 市场倾向于将 token 按功能价值定价——即 token 能带来什么具体的使用权、折扣或权益。但 @ZeusRWA 捕捉到的核心变化是：部分 RWA token 正在被市场重新定价为**对未来金融基础设施的看涨期权**。
这一转变的底层逻辑：
