...
## Ch01.265 Claude Code 1.0.24 工具调用安全事故：静默删 .gitignore 与 Redis flush 复盘
...
- [Knowledge Work Plugins Anthropic Source Analysis](ch01/1295-anthropic.html)：Anthropic 插件系统深度分析（Anthropic 整体生态视角）
