...
## Ch01.316 安全护栏的三域演进 — 阿里云云原生从 Claude Fable 5 提炼的护栏设计原则
...
- **同 Fable 5 主题**（互补不重叠）：
  ...
  - [Claude Fable 5 Safety Fables (Lambert)](ch01/867-claude-fable-5-and-new-ai-safety-fables.html)（政策视角）
  - [Fable 5 Mollick hands-on](ch01/512-claude-fable-5.html)（用户体验视角）
- **同护栏 / 安全主题**：
