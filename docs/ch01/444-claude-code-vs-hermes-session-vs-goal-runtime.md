...
| 实体 | 角度 | 互补性 |
|------|------|------|
| [Harness 7 Layers OpenClaw/Hermes/Claude Code](ch03/084-claude-code.html) | 3 工具 × 7 层 harness 视角 | **互补** (本实体: 2 工具 × 6 维生命周期) |
| [Hermes 9 Module 架构](ch01/294-hermes.html) | Hermes 源码级 | 互补 (本实体: 跨工具对比) |
| [Claude Code Agentic Harness](ch03/084-claude-code.html) | CC 内部 harness 模式 | 互补 (本实体: CC vs Hermes 外部对比) |
| [Hermes Goal Runtime 架构](ch03/035-agent.html) | Goal-in-loop 实现 | **直接相关** (本实体 Goal 概念的实现) |
