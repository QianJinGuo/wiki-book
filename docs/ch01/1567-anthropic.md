...
## Ch01.1567 Anthropic 模型性格研究 — 四条价值轴与语言差异
...
- [Anthropic Claude Code Trojan Telemetry Security 2026](ch01/796-anthropic-claude-code.html) — Anthropic 在安全层面的其他研究，构成完整的模型治理图景
