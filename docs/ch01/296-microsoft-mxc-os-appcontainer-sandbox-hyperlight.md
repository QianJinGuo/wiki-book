...
## Ch01.296 Microsoft MXC — 跨 OS 代理代码执行容器：AppContainer/Sandbox/Hyperlight 三层隔离
...
- [CrewAI Agent Security 三步防护](../ch05/099-harness.html) — 应用层 guardrail 视角
- [AI Tool Poisoning 调查](../ch04/431-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s.html) — agent 工具被污染的攻击面
