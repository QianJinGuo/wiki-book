...
## Ch01.548 Anthropic推出Claude Science——科研界的Claude Code
...
两者共享 Anthropic 的 Agent 基础设施——[Claude Code 的工程化协作模式](../ch03/077-claude-code.html)（task 落盘、子代理分工、可观测性、审批门禁）在 Claude Science 中以科学场景的形态复现。例如审查智能体相当于代码 review 中的独立验证者，算力调度相当于 CI/CD 中的资源编排。
...
这印证了 [Harness Engineering](../ch05/112-harness-engineering.html) 的核心原则：Agent 的能力越强，控制平面的治理就越不能松懈。Claude Science 的逐项授权机制和审查智能体正是这一原则在产品层面的体现。
...
- [Agent Orchestration](../ch04/511-agent-orchestration.html) — 多 agent 编排在科研场景的应用
