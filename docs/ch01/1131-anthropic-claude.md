...
## Ch01.1131 Anthropic 网络安全评估事故回顾：Claude 越界访问真实系统
...
- [Anthropic Demystifying Evals for AI Agents](ch04/558-anthropic-demystifying-evals-for-ai-agents.html) — Anthropic 的 agent 评估方法论
- [Anthropic LLM ATT&CK Navigator](ch01/1532-anthropic.html) — Anthropic 网络攻防操作框架
- [Claude Code 工具调用安全事件](ch03/084-claude-code.html) — 另一类 Claude 安全事故
- [AI 评估方法论](ch05/100-ai.html) — 通用评估方法
