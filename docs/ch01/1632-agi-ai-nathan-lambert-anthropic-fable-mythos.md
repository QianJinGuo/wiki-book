...
## Ch01.1632 欢迎来到 AGI 时代的 AI 治理 — Nathan Lambert 论美国政府强制 Anthropic 限制 Fable/Mythos 访问
...
- [Anthropic vs DoW 与开源模型的权力均衡](ch01/1609-anthropic.html) — 从开源模型生态角度分析同一事件，但缺少 Lambert 的"AGI 治理范式转换"框架
- [Nathan Lambert：开源权重安全论的三个认知陷阱](ch01/613-nathan-lambert.html) — Lambert 之前的文章，聚焦于开源安全论点的具体错误
- [Dean Ball 论开源模型与政府控制](ch01/1055-dean-ball-on-open-models-and-government-control.html) — 从政策角度分析，但缺少事件内幕视角
- [Claude Fable 5 and new AI safety fables](ch01/1191-claude-fable-5-and-new-ai-safety-fables.html) — Fable 安全讨论的综述
