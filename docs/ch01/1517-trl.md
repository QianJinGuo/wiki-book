...
> 📊 Level ⭐⭐⭐ | 8.6KB | `entities/fine-tuning-with-trl.md`
...
- [LLM Fine-Tuning Cost Breakdown](ch01/1147-llm.html)
- [Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](../ch04/298-agentic.html)
- [Anthropic Institute《When AI builds itself》深度解读：AI 进入 AI 研发执行层、瓶颈迁移与研发级 Harness（架构师 JiaGouX）](ch01/1594-anthropic.html)
...
- [SFT+DPO 双阶段微调：Qwen3-1.7B Tool Calling 精度提升方案](https://github.com/QianJinGuo/wiki/blob/main/entities/aws-sagemaker-sft-dpo-tool-calling.md)
- [AWS GRPO RLVR SageMaker Math Reasoning](../ch11/112-aws-grpo-rlvr-sagemaker-math-reasoning.html)
- [Cursor Reward Hacking Coding Benchmarks](https://github.com/QianJinGuo/wiki/blob/main/entities/cursor-reward-hacking-coding-benchmarks.md)
