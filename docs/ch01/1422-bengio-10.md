...
## Ch01.1422 Bengio团队新作：强化学习重做符号回归，后验采样提速10倍

> 📊 Level ⭐⭐ | 2.6KB | `entities/bengio团队新作强化学习重做符号回归后验采样提速10倍.md`
...
- 原文完整记录：[原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/bengio团队新作强化学习重做符号回归后验采样提速10倍.md)
