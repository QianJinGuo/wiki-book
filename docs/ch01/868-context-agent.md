...
## Ch01.868 Context 不是免费的：解析长文档 agent 的性能天花板与架构优化

> 📊 Level ⭐⭐ | 5.3KB | `entities/context-不是免费的解析长文档-agent-的性能天花板与架构优化.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/context-不是免费的解析长文档-agent-的性能天花板与架构优化.md)
