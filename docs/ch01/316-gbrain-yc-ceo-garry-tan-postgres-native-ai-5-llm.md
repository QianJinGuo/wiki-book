...
## Ch01.316 GBrain — YC CEO Garry Tan 的 Postgres-native AI 第二大脑：5 大设计决策 + 零 LLM 知识图谱 + 8 阶段检索 + Brain⊥Source 正交维度
...
## 相关实体
- [AgentBrowser](../ch09/068-agent-browser-claude-code-qoderwork.html)
...
- [AutoCLI](../ch03/120-autocli.html)
- [阿里巴巴 Aone 面向 Agent 的研发模式探索](../ch04/057-aone-agentic.html)
- [CLI-Anything](../ch03/096-cli-anything.html)
- [AgentRun](../ch04/003-agentrun.html)
- [OpenCLI](../ch03/085-opencli.html)
- [CLI-Tools 横向对比](https://github.com/QianJinGuo/wiki/blob/main/comparisons/cli-tools-comparison.md)
- [24h打工人](../ch03/046-agent.html)
...
- [agent 记忆注入实战：5 维框架（选什么/放哪里/怎么放/放多少/何时放）+ 4 前沿论文（memguide/sti](../ch04/099-agent-memory.html)
