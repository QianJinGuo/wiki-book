...
## Ch01.367 Anthropic 官方 Agent Harness 平台：Claude Managed Agents 完整指南
...
- [Anthropic 联创：2028 年实现 AI 自我构建的概率超过 60%](ch01/833-anthropic.md)
...
- [深度拆解 Hermes Agent 记忆系统：它修正了 OpenClaw 的哪层误区？](../ch03/090-hermes-agent.md)
