...
## Ch01.263 Codex 三件套：6 职位插件 + Sites + Annotations
...
- [Codex Computer Use](../ch09/142-codex-can-now-control-other-desktop-devices-via-computer-use.html)
...
- [扣子 3.0 协作系统](ch01/692-3-0.html)（同类协作产品）
