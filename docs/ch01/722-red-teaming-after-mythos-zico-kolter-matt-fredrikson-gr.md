...
## Ch01.722 Red-Teaming after Mythos — Zico Kolter & Matt Fredrikson, Gray Swan
...
这与 [Role Confusion](https://github.com/QianJinGuo/wiki-public/blob/main/entities/role-confusion-github-io.md) 研究形成互补——后者提供理论框架（prompt injection 本质是角色混淆），Gray Swan 提供实战工具和方法论。
...
- [Claude Tag](651-introducing-claude-tag.html) — Anthropic 的 agent 安全实践
