...
## 相关页面
[Agentcore Harness](../ch04/474-amazon-bedrock-agentcore-harness-ga-api-agent.html) — AWS 托管 Harness 平台，同样探索 Agent 基础设施抽象
...
[Thin Harness Fat Skills](../ch05/074-thin-harness-fat-skills-ai.html) — YC/Garry Tan 的 Fat Skills + Thin Harness 思路
