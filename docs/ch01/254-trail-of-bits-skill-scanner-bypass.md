...
## Ch01.254 Trail of Bits: Skill Scanner Bypass 实证研究
...
5. **企业内 skill hub + 代码审计**：相比公共 marketplace，企业自建 skill hub 并对 skill 进行代码审计是更可靠的安全模型。可参考 [Skillsieve Agent Skill Security](ch04/255-skill.md) 中的企业级 skill 安全实践。
...
**相关实体**：
- [Skill Design Patterns](ch04/255-skill.md) — skill 的设计维度（与攻击维度互补）
- [Skillsieve Agent Skill Security](ch04/255-skill.md) — 企业级 skill 安全实践
