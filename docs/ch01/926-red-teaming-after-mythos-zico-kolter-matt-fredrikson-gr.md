...
这与 [Role Confusion](ch01/676-github.md) 研究形成互补——后者提供理论框架（prompt injection 本质是角色混淆），Gray Swan 提供实战工具和方法论。
...
- [Role Confusion](ch01/676-github.md) — Prompt injection 的理论框架
...
- [Claude Tag](ch01/898-introducing-claude-tag.md) — Anthropic 的 agent 安全实践
