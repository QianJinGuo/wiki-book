...
## Ch01.852 Anthropic's bug-hunting Mythos was greatest marketing stunt ever, says cURL creator
...
## 相关实体
- [Anthropic's bug-hunting Mythos was greatest marketing stunt ever says curl creator](ch12/106-anthropic-s-bug-hunting-mythos-was-greatest-marketing-stunt.md)
- [Japan's PM orders cybersecurity review to defend against Anthropic Mythos](ch01/854-anthropic.md)
- [Mythos 发现 curl 漏洞](ch12/010-mythos-finds-a-curl-vulnerability.md) — Daniel Stenberg（curl 作者）亲述 Mythos 扫描 curl 代码库的真实经历：5个"确认"漏洞经人工审核后只有1个真正成立
