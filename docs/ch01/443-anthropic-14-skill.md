...
- [Skills 详解：拆一个技能，看 Anthropic 和 OpenAI 的思路差异](160-skills-anthropic-openai-comparison-frontend-design.html)
- [Claude Design 系统提示词 → web-design-engineer Skill](../ch07/032-claude-design-skill.html)
