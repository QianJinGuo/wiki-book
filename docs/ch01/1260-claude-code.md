...
- [Agentium — 从零实现 Agent 系统的开源框架](ch01/1239-agentium-agent.html)
- [17种Agent架构演进：控制流设计的完整演化史](../ch04/697-17-agent.html)
- [Owner-Worker-Verifier 架构](ch01/1300-owner-worker-verifier.html)
