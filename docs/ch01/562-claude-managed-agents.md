...
## Ch01.562 Claude Managed Agents 开发者指南
...
## 与 PM 视角的关系
| 视角 | 本文（开发者指南） | [PM 视角](../ch04/559-anthropic-pm-agentic.html) |
|------|-----------------|-----------------|
...
## Related
- [Claude Code Agent 工程设计](../ch03/074-claude-code-agent.html) — Claude Code 的本地 Harness 架构
