...
## Ch01.1221 大模型RL为何越训越窄？ACL 2026杰出论文揭秘熵坍缩真相
...
- [2026 年面向 LLM 的 RL 方法总结](ch01/1132-llm.html) — LLM 强化学习方法全景
- [LLM RL中的熵 part 1: 熵的调控](ch01/1132-llm.html) — 熵调控方法
- [Agentic RL 六框架实践地图](../ch04/305-agentic-rl.html) — Agentic RL 训练实践
- [LLM Post-Training 全景指南](ch01/1132-llm.html) — LLM 后训练综述
