...
## Ch01.587 最适合机器人的视频基座模型，被中国团队开源了

> 📊 Level ⭐⭐ | 7.7KB | `entities/最适合机器人的视频基座模型被中国团队开源了.md`
...
```mermaid
mindmap
  root(("最适合机器人的视频基座模型，被中国团队开源了"))
    三重系统设计
    深度分析
      '生成好看'vs'生成有用'：视频生成模型的两…
      MoE 在视频生成中的价值：不止是效率提升
      Single-Stream vs Dual-S…
      从'数据不够'到'仿真不够'：机器人训练的第三…
    实践启示
```
...
→ [LingBot-Video：全球首个具身专属MoE视频模型](ch01/977-lingbot-video-moe.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/最适合机器人的视频基座模型被中国团队开源了.md)
