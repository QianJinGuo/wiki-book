...
## Ch01.614 What Is Software, and Will LLMs Replace It?
...
- [Agent Harnesses](../ch04/609-agent-harnesses-are-dead-long-live-agent-harnesses.md) — Agent 架构的演进
- [Claude Code Workflows](../ch09/078-claude-code-dynamic-workflows.md) — Agent 工作流设计
- [本文实体](ch01/590-llm.md) — Tomassetti 的分析
