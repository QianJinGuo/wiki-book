...
## Ch01.483 Gemma 4 QAT Models: Quantization-Aware Training for Mobile and Edge
...
- [Gemma 4 Multi Token Prediction Drafters](ch01/252-gemma-4-multi-token-prediction-drafters.html)
- [Google Ai Vulnerability Exploitation Threat Intel](../ch05/091-ai.html)
- [Bonsai Image 4B 1 Bit Ternary](../ch05/091-ai.html)
- [Stochastic Parrot Language Models And Meaning](ch01/436-language-models-and-meaning.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/gemma-4-qat-models-optimizing-compression.md)
