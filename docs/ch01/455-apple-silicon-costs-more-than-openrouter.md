...
## Ch01.455 Apple Silicon costs more than OpenRouter
...
[ds4.c 项目](../ch09/046-deepseek-v4-ds4c-antirez.html)（Redis 作者 antirez 开发的 DeepSeek V4 专用推理引擎）展示了另一种路线：
...
- [离线 LLM 能量使用](ch01/1217-llm.html) — 同一作者的另一篇相关文章
- [LightSeek TokenSpeed](ch01/1133-lightseek-tokenspeed.html) — 推理引擎优化技术（Speculative Decoding、KV Cache、Continuous Batching）
