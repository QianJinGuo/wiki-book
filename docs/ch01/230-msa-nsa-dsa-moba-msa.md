...
## Ch01.230 MSA 稀疏注意力三国杀：NSA / DSA / MoBA / MSA 四方案深度对比
...
- [MiniMax M3 开源 Frontier 模型](../ch09/079-minimax-m3-frontier.html) — MSA 是 M3 的核心架构创新
- [DeepSeek V4 Flash Pro 1M 上下文](ch01/1033-deepseek-v4-flash-pro.html) — 压得狠路线的最新代表
- [DeepSeek V4 训练方法学](ch01/670-deepseek-v4.html) — 训练配方对比
