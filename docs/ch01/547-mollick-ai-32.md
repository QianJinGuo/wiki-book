...
- `[Oneusefulthing Claude Code What Comes Next](../ch03/075-claude-code.md)` — Mollick 早期对 Claude Code 实战评估（实体待建）
...
- `[Jagged Ai Frontier Mollick](../ch04/070-ai.md)` — Mollick 锯齿前沿理论（实体待建）
- `[Mass Intelligence](ch01/524-mass-intelligence-ai.md)` — 群体智能边界（实体待建）

## 相关实体

- [fusedash -  generative analytics platform | ai dashboard sof](ch01/379-fusedash-generative-analytics-platform-ai-dashboard-sof.md)
