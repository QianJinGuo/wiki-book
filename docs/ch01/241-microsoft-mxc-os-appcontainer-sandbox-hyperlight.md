...
## Ch01.241 Microsoft MXC — 跨 OS 代理代码执行容器：AppContainer/Sandbox/Hyperlight 三层隔离
...
- [CrewAI Agent Security 三步防护](ch05/094-ai.html) — 应用层 guardrail 视角
- [AI Tool Poisoning 调查](ch05/094-ai.html) — agent 工具被污染的攻击面
