...
## 与 [Agent Memory Architecture](../ch04/508-perplexity-brain-self-improving-agent-memory-architecture.html) 的关系
...
- [Agent Self Improvement Six Mechanisms](../ch03/037-agent.html) — Agent 自我改进机制，与 Memory 的"修正+遗忘"机制有交叉
