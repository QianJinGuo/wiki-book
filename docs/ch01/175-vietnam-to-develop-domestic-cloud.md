...
- [Vietnam to develop domestic cloud so it can ditch risky overseas operators for government workloads](https://github.com/QianJinGuo/wiki/blob/main/entities/vietnam-domestic-cloud.md)- [anthropic](ch05/100-ai.html)- [inference cost at scale with napkin math](ch01/1429-0.html)- [why use app-level auth when every database has auth? (splunk](ch01/177-why-use-app-level-auth-when-every-database-has-auth-splunk.html)
