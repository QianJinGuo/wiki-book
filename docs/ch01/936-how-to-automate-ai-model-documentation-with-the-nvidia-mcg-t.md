...
## Ch01.936 How to Automate AI Model Documentation with the NVIDIA MCG Toolkit
...
- [reducing container cold start times using soci index on dlam](ch01/1113-reducing-container-cold-start-times-using-soci-index-on-dlam.md)
