...
## 相关页面
[Agentcore Harness](ch03/045-agent.md) — AWS 托管 Harness 平台，同样探索 Agent 基础设施抽象
...
[Thin Harness Fat Skills](ch04/256-skill.md) — YC/Garry Tan 的 Fat Skills + Thin Harness 思路
