...
> 📊 Level ⭐⭐⭐⭐ | 10.8KB | `entities/iii-dev.md`
...
→ [原文存档](https://mp.weixin.qq.com/s/VYZq3CzaQ72-gq1FlzniMw)

## 相关页面
[Agentcore Harness](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agentcore-harness.md) — AWS 托管 Harness 平台，同样探索 Agent 基础设施抽象
[Harness Engineering Framework](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/harness-engineering-framework.md) — Harness Engineering 六层框架
[Thin Harness Fat Skills](https://github.com/QianJinGuo/wiki-public/blob/main/entities/thin-harness-fat-skills.md) — YC/Garry Tan 的 Fat Skills + Thin Harness 思路
[Openclaw Architecture](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/openclaw-architecture.md) — OpenClaw 同样探索 Agent 基础设施薄抽象
