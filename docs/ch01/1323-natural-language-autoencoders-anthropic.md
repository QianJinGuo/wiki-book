...
## Ch01.1323 Natural Language Autoencoders — Anthropic 激活→文字可解释性方法
...
## 相关概念
- [Anthropic](ch01/1326-anthropic.html) — 研究机构，NLAs 是其可解释性研究的最新成果
...
- [Sparse Autoencoders](ch01/1336-sparse-autoencoders.html) — 前代可解释性方法，NLAs 在其基础上发展出文字翻译能力
...
## 相关实体
- [Natural Language Autoencoders (Anthropic)](ch01/1326-anthropic.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/anthropic-natural-language-autoencoders.md)

- [QuickSight Dataset QA：NL直查S3 Iceberg](../ch11/180-aws-quicksight-dataset-qa-natural-language.html)
