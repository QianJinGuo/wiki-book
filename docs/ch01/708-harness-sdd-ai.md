...
## Ch01.708 告别“氛围编程”：基于 Harness 治理和 SDD 的团队级 AI 研发范式演进与实践
...
- [基于 Harness + SDD + 多仓管理模式的 AI 全栈开发实践](../ch05/080-harness.html)
...
## 相关实体
- [Agent 开发范式演进：从环境工程出发，“简化”多源实时上下文](../ch03/006-agent.html)
...
- [吴恩达：AI 将最先杀死前端](../ch05/113-ai.html)
