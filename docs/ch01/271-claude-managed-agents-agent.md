...
## Ch01.271 Claude Managed Agents 新更新\"专属云\"模式：把Agent的手放回企业内部
...
## 相关实体
- [Claude Managed Agents Self Hosted Sandbox Enterprise](../ch04/680-claude-managed-agents.html)
...
- [Anthropic Pm Jess Yan Managed Agents](ch01/1299-anthropic.html)
...
- [openai 的最强对手，离「ai windows」又近了一步](../ch04/460-anthropic-ai.html)
