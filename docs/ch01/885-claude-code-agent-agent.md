...
## Ch01.885 Claude Code 多智能体协作体系设计：从单Agent到多Agent工作流
...
- [Claude Code Prompt Context Harness](ch03/073-claude-code.md) - Claude Code Prompt/Context/Harness设计
- [Hermes Agent Memory System](ch04/502-agent.md) - Hermes记忆系统
