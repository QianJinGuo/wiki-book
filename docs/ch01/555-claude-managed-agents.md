...
## 与 PM 视角的关系
| 视角 | 本文（开发者指南） | [PM 视角](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic-pm-agentic-workflow.md) |
|------|-----------------|-----------------|
...
## Related
- [Claude Code Agent 工程设计](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-agent-engineering.md) — Claude Code 的本地 Harness 架构
- [Agent Harness 上下文管理：工作集视角](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-harness-context-management-working-set.md) — 托管 Harness 与本地 Harness 的上下文管理对比
...
- [PM 视角原始存档](https://mp.weixin.qq.com/s/lF7yYI2Q2b_D5-jSsrfGcQ)
