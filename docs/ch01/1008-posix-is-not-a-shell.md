...
## Ch01.1008 POSIX Is Not A Shell

> 📊 Level ⭐⭐ | 4.1KB | `entities/posix-is-not-a-shell.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/posix-is-not-a-shell.md)
