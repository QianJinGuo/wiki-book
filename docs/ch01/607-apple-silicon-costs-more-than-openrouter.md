...
- [离线 LLM 能量使用](ch01/1523-llm.html) — 同一作者的另一篇相关文章
- [LightSeek TokenSpeed](ch01/1429-lightseek-tokenspeed.html) — 推理引擎优化技术（Speculative Decoding、KV Cache、Continuous Batching）
- [Ollama 安全问题](../ch06/049-memory.html) — 本地推理基础设施的安全考量
