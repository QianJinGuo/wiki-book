...
## Ch01.251 Introducing TabFM: A zero-shot foundation model for tabular data

> 📊 Level ⭐ | 1.5KB | `entities/introducing-tabfm-a-zero-shot-foundation-model-for-tabular-d.md`
