...
- [Claude Code Skill 编写指南](../ch03/075-claude-code.md) — Anthropic 官方 skill 编写指南
- [Superpowers 深度解读](../ch04/070-ai.md) — Rule/Gate/Hook 与 Iron Law 方法论
- [Anthropic Skill 设计模式](ch01/846-anthropic.md) — 官方推荐的技巧和模式
