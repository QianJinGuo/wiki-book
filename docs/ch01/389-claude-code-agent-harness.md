...
## Ch01.389 深入理解 Claude Code 源码中的 Agent Harness 构建之道
...
这与 [Claude Managed Agents 企业自托管](../ch04/775-claude-managed-agents.html) 中关于"Hybrid Control Plane"的设计哲学一致——**控制是分层的，不是二元的**。
...
- [Claude Managed Agents 企业自托管](../ch04/775-claude-managed-agents.html)
- [OpenClaw 多 Agent 团队实践](../ch04/103-openclaw-multi-agent-team-practice-v2.html)
...
- [AI Agent Harness 构建](ch01/1168-ai-agent-harness.html)
