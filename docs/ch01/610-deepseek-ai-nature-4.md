...
## Ch01.610 DeepSeek之后，中国AI「自己出题」杀进Nature通讯！全球仅4家
...
这种「数据即参数」的视角，与[AReaL 2.0的在线强化学习闭环](../ch04/438-agentic-rl.html)形成互补——前者聚焦数据生成，后者聚焦训练基础设施。
...
- [DeepSeek V4](ch01/687-deepseek-v4.html) — 同为登上Nature主要期刊的中国AI公司
- [AReaL 2.0](../ch04/438-agentic-rl.html) — 在线强化学习基础设施，与推理数据生成互补
