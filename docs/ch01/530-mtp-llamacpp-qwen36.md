...
## Ch01.530 mtp 加速推理最佳实践在亚马逊云科技中国区使用 llamacpp 部署 qwen36 的实测指南
...
- [llama.cpp 部署](../ch11/290-llama-cpp-deployment.html) — llama.cpp 推理引擎的部署实践和性能优化
...
- [投机解码](ch01/1009-spec.html) — Speculative Decoding 与 MTP 的技术对比
