...
## Ch01.329 Claude Code 之父最新访谈：编程已经结束、harness 将消失、Claude Code 将只有 100 行代码、loop 才是未来
...
- [Hermes Agent /goal 长任务运行时架构](../ch04/351-hermes-agent-goal.md)
- [LLM agent脚手架如何具备自进化能力？——以hermes agent为例](../ch03/090-hermes-agent.md)
- [LoongSuite GenAI 可观测语义规范](../ch04/421-loongsuite-genai.md)
- [低代码 Agent、框架 Agent、自研 Agent 决策框架](../ch03/045-agent.md)
- [三器合一：gstack + Superpowers + OpenSpec 工程化 AI 编程实战](../ch05/082-ai-coding.md)
