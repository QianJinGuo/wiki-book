...
## Ch01.441 谷歌PM公开：2026开发者五大新技能——问题塑形/上下文设计/审美/编排/判断力
...
## 相关主题
- [Agent Orchestration](../ch04/466-agent-orchestration.html) — Agent 编排模式（AWS Step Functions 控制平面）
- [Claude Code Governance Soft Rules](../ch03/075-claude-code.html) — Claude Code 可控性设计
- [Openai Skills Shell Compaction Agent Primitives](../ch05/024-openai-skills-shell-compaction-agent.html) — OpenAI Skills/Shell/Compaction 三位一体
