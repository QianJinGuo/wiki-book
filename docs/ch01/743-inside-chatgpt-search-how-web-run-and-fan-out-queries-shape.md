...
## Ch01.743 Inside ChatGPT Search: how web.run and fan-out queries shape results

> 📊 Level ⭐⭐ | 8.3KB | `entities/chatgpt-search-web-run-fanout-searchengineland.md`
...
## 技术洞察
**搜索引擎从检索到综合的范式转变**：
ChatGPT Search 的核心技术创新：**web.run 查询广播 + 多源综合**。^[].md]
...
这代表了搜索引擎从"检索工具"向"信息综合助手"的根本转变。^[].md]

→ [[raw/articles/chatgpt-search-web-run-fanout-searchengineland.md|原文存档]

## 深度分析
**1. Fan-out 搜索架构的信息论含义**^[].md]
