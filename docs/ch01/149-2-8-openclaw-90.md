...
> 📊 Level ⭐⭐ | 7.0KB | `entities/openclaw-architecture-8-part-summary.md`
...
- [Agent Context Management Architecture Patterns](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-context-management-architecture-patterns.md)

→ [原文存档](https://mp.weixin.qq.com/s/tCjNDrk4fRMUmngmbOih-w)
