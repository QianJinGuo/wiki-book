...
这种"Fixed Flow + 程序化门禁"的设计哲学，与[Agent配置模型](../ch04/341-skill.html)中"渐进式披露"的思路形成对照——前者通过纪律保障可靠性，后者通过结构控制信息密度。
...
这与[钉钉招聘Agent](../ch05/062-agent-harness.html)中"可审计的Agent行为日志"的需求一致——在AI执行关键业务链时，可观测性不是运维锦上添花，而是信任AI的工程前提。
...
- [钉钉招聘Agent](../ch05/062-agent-harness.html)
- [AgentCore旅行分配系统](../ch04/751-agentcore-harness.html)
