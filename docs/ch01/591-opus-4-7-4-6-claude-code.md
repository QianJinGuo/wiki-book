...
- [claude opus 4.8 系统卡片深度分析](ch01/1442-claude.html)
...
- [Claude Code Dynamic Workflows Multi Agent Orchestration](../ch09/102-claude-code-dynamic-workflows.html) — Claude Code 多 Agent 编排完整指南
- [Claude Code Dynamic Workflows 8Th Translation Xingxiaozhao](../ch09/102-claude-code-dynamic-workflows.html) — Claude Code 动态工作流译注
