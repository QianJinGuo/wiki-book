...
## 子页面
- [七大模块详解](../ch03/076-claude-code.html) — 入口链路、REPL、Query Loop、Tool Runtime、Permission、多Agent、扩展性
- [设计原则与对照分析](../ch03/076-claude-code.html) — 五条设计原则、Harness 映射、OpenClaw/Hermes 对比
...
- [Agentium — 从零实现 Agent 系统的开源框架](ch01/1212-agentium-agent.html)
- [17种Agent架构演进：控制流设计的完整演化史](../ch04/668-17-agent.html)
- [Owner-Worker-Verifier 架构](ch01/1268-owner-worker-verifier.html)
