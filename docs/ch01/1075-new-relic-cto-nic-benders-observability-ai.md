...
## Ch01.1075 New Relic CTO Nic Benders：Observability 三大时代演进与 AI 可观测性的双面挑战
...
- [Agentic Incident Triage Assistant with Amazon Quick, New Relic MCP Server, and Asana](../ch11/237-amazon-quick.html)
- [让 Coding Agent 从黑盒到透明：阿里云 Agent 观测审计数据采集实践](../ch09/053-coding-agent.html)
