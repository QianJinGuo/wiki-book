...
## Ch01.589 Anthropic 实战分享：如何让 AI Agent 持续工作几天？
...
这种模式与 [Anthropic 多智能体研究系统](../ch04/670-anthropic-multi-agent-research-system.html) 中的验证者-执行者分离思路一脉相承。
...
这与 [Claude Code 大型代码库团队部署](../ch05/042-agent-harness.html) 中讨论的 Harness 工程实践高度互补。
...
- [Claude Code Large Codebase Team Deployment Agent Harness](../ch05/042-agent-harness.html)
- [Hidden Technical Debt Agent Harness](../ch05/042-agent-harness.html)
