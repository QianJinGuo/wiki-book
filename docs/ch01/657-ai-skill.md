...
## 相关实体
- [Agentic AI 系统架构与分层模型](../ch05/097-harness-skill.html)
- [Hermes Agent Skill 系统深度解析](../ch07/018-hermes-skill.html)

- [Skill工程化设计：把Agent当算法用](../ch04/339-skill.html)
- [使用 Kiro AI IDE 开发 基于Amazon EMR 的Flink 智能监控系统实践 | 亚马逊AWS官方博客](../ch05/100-ai.html)
...
- [LBS-IntentBench — 首个真实出行隐式意图评测基准](../ch04/340-lbs-intentbench.html)
