...
本页作为知识图谱锚点，连接了以下关键实体：[要实现一个工作流选择-agent-skills-还是-ai-表格](ch04/271-skill.html)。 相关主题通过 [钉钉 Stream + CLI 代理双引擎 AI 助手架构](ch05/094-ai.html) 延伸。
...
- [Nearly every enterprise is investing in AI, but only 5% say their data is ready](ch05/094-ai.html)
...
- [ScarfBench: Benchmarking AI Agents for Enterprise Java Framework Migration](ch05/094-ai.html)
