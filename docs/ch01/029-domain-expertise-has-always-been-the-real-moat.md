...
## Ch01.029 Domain Expertise Has Always Been the Real Moat
...
这与 [真实的 AI Agent 与真实工作](../ch04/177-real-ai-agents-and-real-work.html) 中关于 AI 在生产环境中的"上半场 vs 下半场"论点形成呼应：AI 擅长的是"执行已知模式"的上半场，而"建立问题框架"的下半场仍然需要人类。
...
- [Seangoedeckecom Build Agents Not Pipelines](https://github.com/QianJinGuo/wiki-public/blob/main/entities/seangoedeckecom-build-agents-not-pipelines.md) — 同一系列关于软件工程方法论的文章
