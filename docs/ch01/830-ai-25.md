...
## Ch01.830 AI优先战略为何可能是错误的：一家 25 人公司的工程实践分析

> 📊 Level ⭐⭐ | 5.6KB | `entities/ai优先战略为何可能是错误的一家-25-人公司的工程实践分析.md`
...
```mermaid
mindmap
  root(("AI优先战略为何可能是错误的 一家 25 人公司的工程实践分析"))
    当 99 的生产代码由 AI 编写
    AI 优先与 AI 辅助的本质区别
    三个必须改变的瓶颈
      产品管理瓶颈
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/ai优先战略为何可能是错误的一家-25-人公司的工程实践分析.md)
