...
## Ch01.508 GPT-5：It Just Does Stuff — Mollick 的主动式 AI 原语
...
- [Co Existence Paradigm Shift Agentic Ai Mollick 2026](ch01/575-ai-mollick.html) — Co-Existence 范式（Mollick 后续的完整框架，同一作者）
- [Management As Ai Superpower Mollick](ch01/496-management-as-ai-superpower.html) — 管理作为 AI 超级能力（同一作者，同期不同议题）
- [Guide Ai Agents Models Apps Harnesses Mollick](../ch04/349-ai-agent.html) — 模型/应用/harness 选型指南（同一作者，2026-02 更新）
