...
这些处理确保交到 Agent 手上的是干净、精确的信息。AI 只需要处理真正的判断问题——「这个图层是装饰还是内容？」。这种「工程做工程的事、AI 做 AI 的事」的边界划分，是 [Agent-Native 设计](../ch09/090-deepseek-code-harness.html) 的核心实践。
...
- [Agent-Native 设计](../ch09/090-deepseek-code-harness.html) — 为 AI Agent 设计工具的方法论
