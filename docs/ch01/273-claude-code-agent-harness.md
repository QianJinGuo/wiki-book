...
- [Claude Code 深度解析](../ch05/064-claude-code-harness.html) — Claude Code 架构的另一次深度解读
- [Claude Code Dynamic Workflows](../ch09/083-claude-code-dynamic-workflows.html) — AgentTool 子智能体 + Dynamic Workflow 范式
...
- [Harness Engineering 一文](../ch05/066-harness-engineering.html) — Harness 概念的系统阐释
