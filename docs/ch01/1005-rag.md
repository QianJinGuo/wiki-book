...
## Ch01.1005 【RAG】如何炼成强大的向量召回模型

> 📊 Level ⭐⭐ | 4.0KB | `entities/rag如何炼成强大的向量召回模型.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/rag如何炼成强大的向量召回模型.md)
