...
## Ch01.028 How we made WINDOW JOIN parallel and vectorized
...
- [How to create websites with great UX designs: Principles and examples](https://github.com/QianJinGuo/wiki-public/blob/main/entities/how-to-create-websites-with-great-ux-designs.md)
