...
## Ch01.572 一文看懂 AI 编程智能体工程化新范式：Loop Engineering
...
与 [Hermes Agent](../ch03/096-hermes-agent.html) 的自动化流水线理念相似，Loop Engineering 强调系统自主运转而非人工驱动。这一范式也与 [Claude Code 的架构设计](../ch03/078-claude-code.html) 和 Cursor 等 AI 编程工具的实践经验形成互补。
