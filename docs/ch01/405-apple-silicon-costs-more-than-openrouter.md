...
## Ch01.405 Apple Silicon costs more than OpenRouter
...
- [离线 LLM 能量使用](ch01/607-llm.html) — 同一作者的另一篇相关文章
- [LightSeek TokenSpeed](ch01/1173-lightseek-tokenspeed.html) — 推理引擎优化技术（Speculative Decoding、KV Cache、Continuous Batching）
