...
## Ch01.976 新智源：OpenAI Tax AI 自改进 Codex 评估循环
...
- [claude skill 质检工具 skill craft](ch01/1022-claude.md)
- [code intelligence – changelog](../ch04/447-code-intelligence-changelog.md)
- [opd revisiting failure modes simple fixes storm](ch01/988-opd.md)
