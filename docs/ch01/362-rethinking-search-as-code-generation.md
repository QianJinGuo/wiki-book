...
## Ch01.362 Rethinking Search as Code Generation
...
→ [Agentic search models](https://github.com/QianJinGuo/wiki/blob/main/entities/agentic-search-models-softwaredoug.md) — 同主题概念层 vs 架构层互补
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/perplexity-search-as-code-generation.md)
