...
## Ch01.443 From "System of Record" to "System of Intelligence
...
过去三十年，企业软件领域有一个普遍规律：谁拥有数据库，谁就拥有最大价值 。^[].md]
...
## 核心论点：系统正在发生层级迁移
a16z 的这篇文章提出了一个核心观察：企业软件的价值正在发生自下而上的迁移 。^[].md]
...
### 正在创造全新的工作类别
其中一些以新方式做现有工作，但更多实际上在完全创造新的工作——它们在做以前没有人真正做过的事情 。^[].md]
...
这与"AI 工作大替代"的叙事相反——总饼在增长，而非劳动力预算在萎缩 。^[].md]
...
一个新世代的公司正在这个新兴层级之上构建 。下一代 GTM 软件将在那里被书写 。^[].md]
...
→ [[raw/articles/from-system-of-record-to-system-of-intelligence-1|原文存档]
