...
## Ch01.520 MoleculeOS（MOS）——许锦波团队AI原生生物经济操作系统
...
- [MiniMax M2.5 部署指南](../ch11/158-amazon-bedrock.html)
- [Harness Engineering](https://github.com/QianJinGuo/wiki/blob/main/concepts/harness-engineering-framework.md)
- [Gemma 4 端侧大模型](ch01/605-gemma-4.html)

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/ai生物研发进入操作系统时代许锦波团队moleculeos正式开放.md)
