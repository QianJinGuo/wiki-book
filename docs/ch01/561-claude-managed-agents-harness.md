...
## Ch01.561 Claude Managed Agents 官方 Harness 平台指南
...
## 与现有知识库内容的关联
- [Claude Managed Agents](../ch04/702-claude-managed-agents.html) — 托管 Harness 平台
...
- [obsidian claude code integration guide](../ch09/137-obsidian-claude-code-integration-guide.html)
