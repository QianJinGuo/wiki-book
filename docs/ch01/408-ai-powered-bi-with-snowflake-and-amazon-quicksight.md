...
## Ch01.408 AI-powered BI with Snowflake and Amazon QuickSight
...
- **[Data-Native Agents](../ch04/346-how-to-build-agents-where-data-already-lives.html)**：Agent 直接在数据平台上运行，语义层是关键基础设施
