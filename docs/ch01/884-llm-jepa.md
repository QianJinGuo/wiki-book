...
## Ch01.884 从LLM到JEPA，中国团队正在把“世界模型”搬进细胞内部

> 📊 Level ⭐⭐ | 5.2KB | `entities/从llm到jepa中国团队正在把世界模型搬进细胞内部.md`
...
**原文链接**: https://mp.weixin.qq.com/s/ScFLbo9UlLnLK-GRTJtN4A
...
```mermaid
mindmap
  root(("从LLM到JEPA，中国团队正在把“世界模型”搬进细胞内部"))
    AIVC走到十字路口
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/从llm到jepa中国团队正在把世界模型搬进细胞内部.md)
