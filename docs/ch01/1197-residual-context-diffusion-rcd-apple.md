...
## Ch01.1197 Residual Context Diffusion (RCD)：Apple 残差上下文扩散语言模型
...
RCD 为扩散语言模型的推理效率提供了一个实用改进方向，特别适用于需要高精度推理能力的场景。与 `diffusion-language-models` 和 [推理优化](ch01/606-llm.md) 相关。
