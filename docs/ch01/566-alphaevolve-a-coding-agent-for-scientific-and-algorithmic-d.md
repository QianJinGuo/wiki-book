...
## Ch01.566 AlphaEvolve: A coding agent for scientific and algorithmic discovery
...
## 相关实体
- [Alphaevolve Impact](ch04/410-alphaevolve-impact-deepmind.md)
...
- [hacker news 热帖：ai 会写代码了，为啥还要用 python？](ch04/069-ai.md)
- [7个月，234次提交，1690行代码：ai编程大型翻车现场：我决定全部作废，手动重写！](ch04/069-ai.md)
- [一个文件让 ai coding 效率翻倍：agents.md 实践指南](ch04/069-ai.md)
