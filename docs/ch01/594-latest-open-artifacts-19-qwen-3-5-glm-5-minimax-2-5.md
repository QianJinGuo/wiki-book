...
## Ch01.594 Latest open artifacts (#19)：Qwen 3.5、GLM 5、MiniMax 2.5 — 中国实验室的前沿推进
...
- [DeepSeek V4](ch01/433-deepseek-v4.html) — 业界关注度最高、即将发布的中国前沿模型
- [CybersecQwen 4B](../ch12/108-cybersecqwen-4b.html) — Qwen 在安全垂域的专用模型
- [OpenClaw 完全指南](../ch11/248-openclaw.html) — Agent 工具栈的实践参考
