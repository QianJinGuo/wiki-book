...
## Ch01.292 Anthropic LLM ATT&CK Navigator: AI-Enabled Cyber Operations
...
本文与 [N-days Frontier Agent 研究](../ch04/263-anthropic-n-days-frontier-agent-vulnerability-research.html) 构成 Anthropic 2026-06 的**双联报告**：
...
- [hackers accessed bwh hotels reservation system for months](../ch05/092-ai.html)
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/anthropic-llm-attck-navigator-cyber-operations.md)
- → [同 Anthropic 红队研究：前沿模型 N-day 利用能力](../ch04/263-anthropic-n-days-frontier-agent-vulnerability-research.html)
- → [Mythos 营销角度](ch01/1326-anthropic.html)
