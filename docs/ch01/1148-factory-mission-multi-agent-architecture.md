...
## Ch01.1148 Factory Mission Multi Agent Architecture

> 📊 Level ⭐⭐⭐ | 12.8KB | `entities/factory-mission-multi-agent-architecture.md`

- [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/factory-mission-multi-agent-architecture.md)
...
## 相关框架对比
- **[DeerFlow vs Hermes vs OpenClaw](../ch04/447-deerflow-hermes-openclaw.html)** — 都是 multi-agent 编排框架，与 Mission 的三角架构有相通之处
...
## 相关实体
- [Multi-Agent 架构在零售供应链运营中的实践：贯穿数据、洞察与行动 | 亚马逊AWS官方博客](../ch03/045-agent.html)
