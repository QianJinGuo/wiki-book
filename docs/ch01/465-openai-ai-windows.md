...
## Ch01.465 OpenAI 的最强对手，离「AI Windows」又近了一步
...
```mermaid
mindmap
  root(("OpenAI 的最强对手 离「AI Windows」又近了一步"))
    MCP 是什么
    ...
    对算力成本的潜在影响
    挑战与局限
    MCP 作为AI 时代的 USB 标准的战略意义
    为什么 Anthropic 选择精选而非开放
```
...
- [Anthropic AI Gateways vs MCP Gateways](../ch11/080-ai-gateways-vs-mcp-gateways-what-security-teams-need-to-kno.html) — MCP 安全架构分析（protocol 概念另见 ai-gateways-vs-mcp-gateways 页面）
