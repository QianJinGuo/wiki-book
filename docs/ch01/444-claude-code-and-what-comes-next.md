...
- 与 [管理即超能力](ch01/509-management-as-ai-superpower.html) 的同源：Karpathy 编程工作"变成管理 AI agent"是 Mollick 商业观察在技术领域的镜像。
...
- [boris cherny 新访谈：开发工具正在从 ide 变成 agent 控制台](ch01/682-9.html)
