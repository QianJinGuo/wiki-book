...
## Ch01.689 mtp 加速推理最佳实践在亚马逊云科技中国区使用 llamacpp 部署 qwen36 的实测指南
...
- [MoE 架构](ch01/1409-moe-architecture.html) — Mixture-of-Experts 模型架构的原理和优势
- [量化技术](https://github.com/QianJinGuo/wiki/blob/main/entities/quantization-techniques.md) — 模型量化方法及其对推理性能的影响
- [投机解码](ch01/1191-spec.html) — Speculative Decoding 与 MTP 的技术对比
