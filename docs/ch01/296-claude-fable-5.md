...
## Ch01.296 安全护栏的三域演进 — 阿里云云原生从 Claude Fable 5 提炼的护栏设计原则
...
> 与 [Fable 5 AWS 中文译本](ch01/1307-anthropic-claude.html) 同 Fable 5 主题，但本文 80% 篇幅在 3 域对比 + 5 原则抽象，AWS 译本聚焦 Fable 5 产品本身（能力 + 接入 + 部署）。**互补不重叠**。
...
- **同 Fable 5 主题**（互补不重叠）：
  - [Fable 5 AWS 中文译本](ch01/1307-anthropic-claude.html)（产品视角）
  - [Claude Fable 5 Safety Fables (Lambert)](ch01/875-claude-fable-5-and-new-ai-safety-fables.html)（政策视角）
  - [Fable 5 Mollick hands-on](ch01/496-claude-fable-5.html)（用户体验视角）
- **同护栏 / 安全主题**：
  ...
  - [Enable Safe Agentic Payments with Built-in Guardrails](../ch04/610-enable-safe-agentic-payments-with-built-in-guardrails-using.html)
  - [Nemotron 3.5 Content Safety](ch01/480-nemotron-3-5-content-safety-customizable-multimodal-safety.html)
  - [阿里集团 AI 代码评审安全带](../ch05/089-ai.html)
- **同阿里云生态**：
  - [Aliyun AgentRun](../ch04/366-agentrun.html)
  - [阿里云 CMS CLI 可观测](../ch04/267-skill.html)
