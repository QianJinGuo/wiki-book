...
## Ch01.1522 POPO (Group Prioritized Off-Policy Optimization)：清华 RLVR 训练高效组级回放框架
...
- [2026 年面向 LLM 的 RL 方法总结](ch01/1484-llm.html) — PPO/DPO/GRPO 全景综述
- [APPO：阿里高德 Agent RL 信用分配到每个决策点](../ch04/727-agentic.html) — 另一 ARPO 系列 RL 方法
