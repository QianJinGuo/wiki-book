...
## Ch01.625 独家对话罗福莉：AI范式已然巨变！

> 📊 Level ⭐⭐ | 7.4KB | `entities/luo-fuli-ai-paradigm-shift.md`

> -> [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/luo-fuli-ai-paradigm-shift.md)
...
## 相关主题
- [OpenClaw](../ch11/235-openclaw.html) — 开源 Agent 框架，社区进化速度最快
- [Claude Code](../ch03/078-claude-code.html) — 架构文档
- [Hermes-Agent](../ch03/096-hermes-agent.html) — 轻量消息调度
- [pi-mono](../ch03/073-pi-mono-ai-agent-openclaw.html) — OpenClaw 执行引擎核心
- [SkillClaw](../ch04/474-skillclaw-nacos-agent-skill-registry.html) — 群体智能进化系统
