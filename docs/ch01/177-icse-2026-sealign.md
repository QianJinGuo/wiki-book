...
## Ch01.177 ICSE 2026杰出论文 | 突破代码模型真实工程落地瓶颈，北大团队提出SEAlign对齐框架：显著提升软件工程智能体决策质量

> 📊 Level ⭐ | 2.9KB | `entities/icse-2026杰出论文-突破代码模型真实工程落地瓶颈北大团队提出sealign对齐框架显著提升软件工程智能体决策质量.md`
