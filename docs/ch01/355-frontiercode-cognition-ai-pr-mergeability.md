...
## Ch01.355 FrontierCode — Cognition AI 的 PR Mergeability 编码基准
...
- [ProgramBench](../ch04/161-programbench-agent-benchmark.md) — 程序化编码基准 (与 FrontierCode 的 maintainer-rubric 范式对比)
