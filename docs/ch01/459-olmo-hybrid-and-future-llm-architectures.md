...
This connects directly to the [inference cost analysis](ch01/216-0.md) — memory bandwidth is the bottleneck for long-context inference, and hybrid architectures fundamentally reduce this pressure.
...
- [Inference cost at scale with napkin math](ch01/216-0.md)
