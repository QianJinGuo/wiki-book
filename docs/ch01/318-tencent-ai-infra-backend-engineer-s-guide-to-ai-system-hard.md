...
## Ch01.318 Tencent AI Infra: Backend Engineer's Guide to AI System Hardware and Software
...
- [Pydantic AI Progressive Agent Skills](../ch04/398-agent-skills.html) — Python-first AI 框架的另一视角
- [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/tencent-ai-infra-backend-engineer-huangrunpeng.md)
