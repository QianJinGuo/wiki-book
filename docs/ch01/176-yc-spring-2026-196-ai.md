...
> 📊 Level ⭐⭐ | 3.5KB | `entities/yc-spring-2026-196-companies-chris-lu-analysis.md`

> 原文归档：[原文归档](https://mp.weixin.qq.com/s/jmemmxwVXYKTtwS_7v5tXQ)
...
- [Harness Engineering](../ch05/066-harness-engineering.html) — Agent 差异化来自 harness 而非模型
- [Claw-SWE-Bench](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claw-swe-bench-harness-evaluation-benchmark-tokenrhythm.md) — harness 独立变量实证
- [Agent Eval WalleZhang](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-eval-wallezhang-yaml-driven-agent-evaluation-framework.md)
