...
## Ch01.1230 LLM 自我提升系统综述 — Yang 等 113 页四阶段闭环框架（Zesearch NLP Lab）
...
| **科学研究（Science）** | 自主假设提出、实验执行 | [Prime Intellect / nanoGPT Opus 4.7 突破人类纪录](../ch05/095-ai.html) |
...
| **问题域** | LLM 自我提升的**系统级闭环** | 多为单点机制（[六条路](../ch03/035-agent.html)）/ 单点实验（[nanoGPT](../ch05/095-ai.html)）/ 单点产品（[LangSmith](../ch03/035-agent.html)） |
...
- **同主题不同 artifact**：
  ...
  - [AI 科研超越人类 — Prime Intellect 递归自改进实验](../ch05/095-ai.html)（单点实验：nanoGPT 突破人类纪录）
  ...
  - [MUSE AutoSkill — 字节 ByteBrain 自演化 Agent](../ch04/273-skill.html)（arXiv 2605.27366 工业级实现）
