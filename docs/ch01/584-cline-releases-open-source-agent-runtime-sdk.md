...
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](../ch04/074-agentic.html) — 从 vibe coding 到 agentic engineering 的范式跃迁
- [Karpathy Vibe Coding Agentic Engineering](../ch04/774-karpathy-vibe-coding-agentic-engineering.html) — Vibe Coding 与 Agentic Engineering 的同源访谈
- [Agentops Operationalize Agentic Ai At Scale With Amazon Bedr](../ch04/363-agentops-operationalize-agentic-ai-at-scale-with-amazon-bed.html) — AWS Bedrock AgentOps 的规模化运营实践
- [Claude Code Harness Deep Understanding](ch01/640-claude-code-harness-deep-understanding.html) — Claude Code harness 的另一深度解析
...
- [the code-as-content era](ch01/690-the-code-as-content-era.html)
- [the shape of the thing](ch01/403-the-shape-of-the-thing.html)
