...
## Ch01.730 算力风洞：GPU 集群的 AI Native 稳定性验证系统
...
```mermaid
mindmap
  root(("算力风洞：GPU 集群的 AI Native 稳定性验证系统"))
    背景
    三层架构
      认知层：双源学习
      验证层：在算力风洞中验证决策能力
...
参见 [AI Infra 运维智能体基准](ch01/772-ai-infra.html) — GPU 集群故障诊断领域的前沿进展。
...
- [LLM 超算协议](ch01/390-openai.html) — 解决超大集群训练不稳定性的网络协议层面方案，与算力风洞在 GPU 集群稳定性领域互补
- [AI Infra 运维智能体基准](ch01/772-ai-infra.html) — 首个针对 GPU 集群故障的 AI Infra 运维智能体评测基准
- [Spec as AIOS：AI-Native 全栈交付的抗熵架构](../ch05/018-ai-native.html) — 高德的 AI Native 架构实践，与算力风洞同为阿里巴巴系 AI Native 体系
