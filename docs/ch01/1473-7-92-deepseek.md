...
## Ch01.1473 大三本科生一作，交出7.92倍加速的投机解码新答卷！DeepSeek和阶跃星辰双双引用
...
2. **"主干 + 轻量修正"是通用设计模式**：将昂贵的主干计算与轻量的修正/优化解耦，在保持核心性能的同时增加灵活性，这种模式不仅适用于投机解码，也可推广到 [Agent 框架设计](../ch03/036-agent.html) 等领域
...
- [生产级 Agent 全景架构](../ch05/017-harness.html)
- [LLM 语义聚类与标签体系](ch01/1132-llm.html)
