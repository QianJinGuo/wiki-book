...
- [AgentCore Harness Trip Allocation Multi-Agent System AWS](../ch04/782-agentcore-harness.html) — AWS Agent ecosystem
- [Agent Config Model Tool Skill MCP](../ch04/349-skill.html) — Model/tool configuration patterns
