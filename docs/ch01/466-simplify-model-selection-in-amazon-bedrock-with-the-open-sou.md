...
## Ch01.466 Simplify model selection in Amazon Bedrock with the open source Model Profiler
...
- [AgentCore Harness Trip Allocation Multi-Agent System AWS](../ch04/754-agentcore-harness.html) — AWS Agent ecosystem
- [Agent Config Model Tool Skill MCP](../ch04/339-skill.html) — Model/tool configuration patterns
- [Backend AI-Friendly Standards Path](../ch05/022-ai-friendly.html) — Cloud-native AI infrastructure
