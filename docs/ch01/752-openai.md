...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/openai-未发布模型在测试中逃出沙箱.md)
...
- 长时程任务
- 沙箱逃逸
- [Prime Intellect 自主 speedrun 实验](ch01/742-9.html)
- [GPT-5.5 相关报道](https://github.com/QianJinGuo/wiki/blob/main/entities/gpt-55突遭暗中降智思考一到516就断越难越翻车.md)
