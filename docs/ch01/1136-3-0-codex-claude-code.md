...
## Ch01.1136 扣子 3.0 离谱更新：把 Codex、Claude Code 拉进一个项目工作？
...
- [你的ai代码越写越乱，他72小时合了14个pr——差距只在一个机制](ch01/646-garry-tan.html)
- [karpathy × boris 访谈：software 3.0 时代编程完整地图](ch01/947-llm.html)
