...
## Ch01.1528 LLM 缓存原理与实践：从 KV Cache 到 Prefix Caching，Agent 命中率常挂 90% 的机制与工程含义
...
- 与 [DeepSeek 成本迁移与系统层 KV Cache + Harness 工程](ch01/584-deepseek.html) 互补——该实体聚焦 DeepSeek 的迁移案例，本文提供全行业全景
