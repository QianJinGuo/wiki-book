...
## Ch01.228 750B MoE PD 分离推理：AWS EFA vs 自建 RoCE 通信架构实战对比
...
- [Foundation Model Building Blocks on AWS](ch05/094-ai.html) — AWS 训练与推理基础组件
- [Foundation Model Building Blocks](ch03/091-foundation-model-building-blocks.html) — 通用基础组件
- [GLM-5 Scaling Pain](ch05/094-ai.html) — GLM 系列规模化的工程挑战
