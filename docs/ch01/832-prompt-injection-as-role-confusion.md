...
## Ch01.832 Prompt Injection as Role Confusion
...
这个框架对 [Hermes Agent Self-Evolving](../ch03/102-hermes-agent.html) 和其他 Agent 系统的安全设计有直接启示：
...
- [Hermes Agent Self-Evolving](../ch03/102-hermes-agent.html) — Agent 安全治理
- Agent Security Threat Model — Agent 安全威胁模型
- [Agent Harness Context Management](../ch05/062-agent-harness.html) — 上下文管理中的安全挑战
