...
## Ch01.1037 多 Agent 不是虚拟公司：从 Anthropic 五种模式看信息流怎么设计
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/多-agent-不是虚拟公司从-anthropic-五种模式看信息流怎么设计.md)
