...
## 与现有知识关联
- [Claude Code 架构解析](../ch03/057-claude-code.html) — 互补页面，本文更深更全面
- [Claude Code Prompt/Context/Harness](../ch09/054-claude-code-prompt.html) — 三层工程视角
- [Prompt Caching 工程实践](160-anthropic-prompt-caching-claude-code.html) — 与 microCompact 相关
- [Agent Harness 12 组件](../ch05/035-agent-harness.html) — Harness 通用框架
- [Claude Code Subagent 上下文卫生](../ch04/253-claude-code-subagent.html) — Sub-Agent 设计
- [原文存档](https://mp.weixin.qq.com/s/bMjXlD-OcnFW-wuN1yW8FA)
