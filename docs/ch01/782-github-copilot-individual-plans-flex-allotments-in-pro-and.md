...
## Ch01.782 GitHub Copilot Individual Plans: Flex Allotments in Pro and Pro+, and a New Max Plan
...
```mermaid
mindmap
  root(("GitHub Copilot Individual Plans"))
    定价结构的双层设计
    套餐价值对比
    Max 套餐的战略意图
    竞争格局影响
...
- [GitHub Copilot](ch01/782-github-copilot-individual-plans-flex-allotments-in-pro-and.html)
