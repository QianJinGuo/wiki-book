...
- [开源模型的下一阶段：三类模型分类与生态化路径](407-what-comes-next-with-open-models.html) — 三类模型分布智能论
...
- [Management as AI superpower](282-management-as-ai-superpower.html) — delegation三变量公式+GDPval 72%实证
...
- [Langsmith Trajectory Evals](368-langsmith-trajectory-evals.html) — 轨迹评估四匹配模式
