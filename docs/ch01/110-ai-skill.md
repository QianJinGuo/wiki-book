...
- [开源模型的下一阶段：三类模型分类与生态化路径](408-what-comes-next-with-open-models.html) — 三类模型分布智能论
...
- [ai-skill-测评指标体系](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-skill-测评指标体系.md) — 九层指标全版
- [05—skill-creator 源码深度拆解：LLM Skill 触发率、防过拟合与三 Agent 评审完整指南](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-skill-skill-creator-源码拆解.md) — 源码级测评实现
...
- [AgentEval：YAML驱动的Agent评测框架](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-eval-wallezhang-yaml-driven-agent-evaluation-framework.md) — 评测框架全版
...
- [Agent-EvalKit：AWS 开源 CLI Agent 评测工具包](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-evalkit-aws-opensource-cli-agent-eval-toolkit.md) — 评测工具包设计
- [Management as AI superpower](283-management-as-ai-superpower.html) — delegation三变量公式+GDPval 72%实证
...
- [Langsmith Trajectory Evals](369-langsmith-trajectory-evals.html) — 轨迹评估四匹配模式
