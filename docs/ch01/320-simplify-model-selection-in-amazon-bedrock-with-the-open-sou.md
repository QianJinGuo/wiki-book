...
## Ch01.320 Simplify model selection in Amazon Bedrock with the open source Model Profiler
...
- [AgentCore Harness Trip Allocation Multi-Agent System AWS](../ch04/654-agentcore-harness.html) — AWS Agent ecosystem
