...
## 相关实体
- [OpenAI buys AI consultancy to sell enterprises on its models](107-openai-buys-ai-consultancy-to-sell-enterprises-on-its-models.html)
- [Interaction Models](https://github.com/QianJinGuo/wiki-public/blob/main/entities/interaction-models.md)
- [Thinking Machines 交互模型（Interaction Models）](../ch04/154-thinking-machines-interaction-models.html)
