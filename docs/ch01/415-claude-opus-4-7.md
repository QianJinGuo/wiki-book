...
- → [Claude Harness 设计：Generator-Evaluator](ch01/707-anthropic.md)
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/claude-code-tool-design-evolution-anthropic.md)
