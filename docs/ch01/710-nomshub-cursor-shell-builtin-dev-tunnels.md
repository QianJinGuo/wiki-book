...
>
> 原文：→ [原文存档](http://www.straiker.ai/blog/nomshub-cursor-remote-tunneling-sandbox-breakout)
...
→ [NomShub 原文存档](http://www.straiker.ai/blog/nomshub-cursor-remote-tunneling-sandbox-breakout)
...
- [Microsoft MXC](https://github.com/QianJinGuo/wiki-public/blob/main/entities/microsoft-mxc-execution-containers-agent-sandbox-origin.md) — 微软自家跨 OS 沙箱，提供 kernel 隔离，可作 NomShub 的防御侧
- [CrewAI 三步防护](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-security-three-step-sequence-harness-governance-identity-crewai.md) — 应用层 guardrail 视角
- [AI Tool Poisoning](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-security-v2.md) — 工具被污染的通用风险
- [Microsoft RAMPART/Clarity](https://github.com/QianJinGuo/wiki-public/blob/main/entities/microsoft-open-sources-rampart-clarity.md) — 微软同源栈，检测类似 agent 行为
