...
## Ch01.751 Gemma 4 Multi Token Prediction Drafters

> 📊 Level ⭐⭐⭐⭐⭐ | 17.0KB | `entities/gemma-4-multi-token-prediction-drafters.md`

## 概述

**Gemma 4 Multi-Token Prediction (MTP) Drafters** 是 Google 于 2026年5月为 Gemma 4 系列模型发布的**推测解码**（Speculative Decoding）加速组件。该技术通过轻量级草稿模型（drafter）并行预测多个 token，再由目标大模型验证，实现最高 **3x 推理加速**，同时保持输出质量完全一致。 See also [Context Window Management](https://github.com/QianJinGuo/wiki-public/blob/main/entities/context-window-management.md)
...
## 相关实体
- [Aws Fsx Lustre Gpudirect Sharded Llm Loading](https://github.com/QianJinGuo/wiki-public/blob/main/entities/aws-fsx-lustre-gpudirect-sharded-llm-loading.md)- [tliveomni vllm 适配与量化方案](https://github.com/QianJinGuo/wiki-public/blob/main/entities/tliveomni-vllm-quantization.md)
