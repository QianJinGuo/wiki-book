...
> 📊 Level ⭐ | 3.6KB | `entities/anthropic-apple-foundation-models-claude.md`
...
- 引用源：[Anthropic Apple Foundation Models Claude](https://platform.claude.com/docs/en/cli-sdks-libraries/libraries/apple-foundation-models)
## 相关实体
- [from doer to director: the ai mindset shift](022-from-doer-to-director-the-ai-mindset-shift.html)
