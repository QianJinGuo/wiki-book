...
## Ch01.348 安全护栏的三域演进 — 阿里云云原生从 Claude Fable 5 提炼的护栏设计原则
...
- **同 Fable 5 主题**（互补不重叠）：
  ...
  - [Claude Fable 5 Safety Fables (Lambert)](ch01/856-claude-fable-5-and-new-ai-safety-fables.html)（政策视角）
...
- **同护栏 / 安全主题**：
  ...
  - [Enable Safe Agentic Payments with Built-in Guardrails](../ch04/593-enable-safe-agentic-payments-with-built-in-guardrails-using.html)
  - [Nemotron 3.5 Content Safety](ch01/514-nemotron-3-5-content-safety-customizable-multimodal-safety.html)
  - [阿里集团 AI 代码评审安全带](../ch05/084-ai.html)
- **同阿里云生态**：
