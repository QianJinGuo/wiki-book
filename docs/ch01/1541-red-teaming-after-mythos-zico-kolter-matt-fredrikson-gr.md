...
这与 [Role Confusion](ch01/897-github.html) 研究形成互补——后者提供理论框架（prompt injection 本质是角色混淆），Gray Swan 提供实战工具和方法论。
...
- [Role Confusion](ch01/897-github.html) — Prompt injection 的理论框架
...
- [Claude Tag](ch01/1440-introducing-claude-tag.html) — Anthropic 的 agent 安全实践
- [OpenClaw](../ch04/639-agent-loop.html) — 计算机使用 agent 的安全挑战
