...
## Ch01.461 The new AI lock-in

> 📊 Level ⭐⭐⭐ | 7.9KB | `entities/new-lock.md`

# The new AI lock-in

## 摘要

AI 供应商锁定（vendor lock-in）并没有消失，而是从模型层向上迁移：模型调用正变得越来越容易替换，但围绕模型的编排、工作流与治理体系却越来越难替换。文章以 Greyhound Research 的判断为线索，结合 OpenAI、Anthropic 的最新动向指出，锁定真实发生在编排层、厂商控制的工作流表面与服务层三个战场，并为企业买家给出了"拥有工作流集成、把模型与伙伴视为可替代层"的应对框架。
...
- [企业级 Agent 编排](https://github.com/QianJinGuo/wiki-public/blob/main/entities/enterprise-agent-orchestration.md)
- [Claude Cowork](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-cowork-2026-big-update.md)
- [LangGraph](https://github.com/QianJinGuo/wiki-public/blob/main/entities/langgraph-state-machine.md)
- [Agent 编排](../ch04/212-agent-orchestration.html)
