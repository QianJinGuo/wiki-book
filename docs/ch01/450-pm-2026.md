...
## Ch01.450 谷歌PM公开：2026开发者五大新技能——问题塑形/上下文设计/审美/编排/判断力
...
## 相关主题
- [Agent Orchestration](ch04/425-agent-orchestration.md) — Agent 编排模式（AWS Step Functions 控制平面）
- [Claude Code Governance Soft Rules](ch03/074-claude-code.md) — Claude Code 可控性设计
- [Openai Skills Shell Compaction Agent Primitives](ch04/245-skill.md) — OpenAI Skills/Shell/Compaction 三位一体
