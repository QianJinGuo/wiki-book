...
## Ch01.033 Cisco Preps For A World Of AI Agent Coworkers, Frontier Model Threats
...
- [World Knowledge Agent Self Evolution Tencent Hkustgz](ch03/045-agent.md)
- [Introducing Aimap Security Testing For Ai Agent Bishop Fox](ch04/069-ai.md)
...
- [olmo-eval: an evaluation workbench for the model development](ch01/775-olmo-eval-an-evaluation-workbench-for-the-model-development.md)
