...
## Ch01.867 235B参数也没用！港中文等发布7模态数据集，专测顶级VLM的感知盲区

> 📊 Level ⭐⭐ | 5.3KB | `entities/235b参数也没用港中文等发布7模态数据集专测顶级vlm的感知盲区.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/235b参数也没用港中文等发布7模态数据集专测顶级vlm的感知盲区.md)
