...
参见 [working set 管理](ch03/035-agent.html)。这种模式的代价是**额外的 tool call 延迟**——但对长寿命 Agent 而言，延迟的代价远小于 context 污染的代价。
...
- [Agent Harness Context Management Working Set](ch03/035-agent.html) — Progressive Loading 与 working set 管理理论
