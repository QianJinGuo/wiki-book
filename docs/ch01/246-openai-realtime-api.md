...
## Ch01.246 OpenAI Realtime API 架构首次公开
...
- [openai发布新一代实时语音模型，能够像人说话一样进行推理、翻译和转录](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openai发布新一代实时语音模型能够像人说话一样进行推理翻译和转录.md)
