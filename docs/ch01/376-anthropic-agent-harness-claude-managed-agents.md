...
## Ch01.376 Anthropic 官方 Agent Harness 平台：Claude Managed Agents 完整指南
...
- [claude managed agents](../ch04/606-claude-managed-agents.md)
- [Claude Managed Agents 开发者指南](../ch04/606-claude-managed-agents.md)
...
- [llm 自我提升系统综述 — yang 等 113 页四阶段闭环框架（zesearch nlp lab）](ch01/590-llm.md)
