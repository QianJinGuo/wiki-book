...
- [MiniMax M3 开源 Frontier 模型](../ch09/056-minimax-m3-frontier.html) — MSA 是 M3 的核心架构创新
- [DeepSeek V4 Flash Pro 1M 上下文](670-deepseek-v4-flash-pro.html) — 压得狠路线的最新代表
- [DeepSeek V4 训练方法学](717-deepseek-v4.html) — 训练配方对比
...
- [近期 LLM 架构进展](458-llm.html) — 注意力架构的近期综述
...
- [M3 开源三件套](../ch09/056-minimax-m3-frontier.html) — 同一文章的不同角度解读
