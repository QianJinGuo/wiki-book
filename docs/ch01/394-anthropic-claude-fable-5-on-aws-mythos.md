...
在编码场景中，视觉能力尤为实用：Fable 5 可以读取设计稿（截图或 PDF 格式）并生成对应代码，同时利用视觉功能对照目标进行自检。这与 [Ai Coding 入门指南 如何更好地让Ai真正帮你干活](../ch05/095-ai-coding.html) 中描述的"视觉-代码闭环"高度吻合。
...
- [Hermes Agent Skills Source Code Analysis Shuge](../ch04/405-hermes-agent-skills.html)
