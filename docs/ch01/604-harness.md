...
## Ch01.604 Harness 实践：将任何文字编辑成精美的文章
...
- [Alibaba Data Rd Harness Engineering Nl2Sql](../ch05/112-harness-engineering.html) — 阿里数据研发的 NL2SQL Harness Engineering 实践
- [Aliyun Loop Engineering Log Scan Auto Fix Deploy](../ch05/004-loop-engineering.html) — 阿里云 Loop Engineering 的日志扫描自修复实践
- [Agent Config Model Tool Skill Mcp Prompt Combination Yexiaochai 09](../ch04/273-skill.html) — Agent 配置层的解耦设计，与 Skill 架构互补
