...
> 📊 Level ⭐⭐⭐ | 12.4KB | `entities/aws-sagemaker-capacity-aware-inference-fallback.md`
...
## 与知识库的连接
- → [SQS异步管道](https://aws.amazon.com/cn/blogs/china/amazon-bedrock-model-inference-serverless-architecture-case-study/)：同样是高并发推理场景，但侧重点不同（管道式队列 vs 实例池调度）
---
## 深度分析
...
---
*Source: [原文存档](https://aws.amazon.com/blogs/machine-learning/capacity-aware-inference-automatic-instance-fallback-for-sagemaker-ai-endpoints/)*
## 相关实体
...
- [GRPO+RLVR: Qwen数学推理3.7x提升的工程细节](../ch11/183-aws-grpo-rlvr-sagemaker-math-reasoning.html)
...
- [redis agentic ai flowers with iris](https://github.com/QianJinGuo/wiki-public/blob/main/entities/www.blocksandfiles.com-5241795.md)
