...
## Ch01.778 扣子 3.0 离谱更新：把 Codex、Claude Code 拉进一个项目工作？
...
- [Claude 做方案，Codex 写代码：多模型协作交接](ch01/639-claude.html)
...
- [Karpathy × Boris：Software 3.0 编程地图](ch01/871-llm.html)
