...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/dream-dense-retrieval-autoregressive-modeling-challengehub-2026.md)
...
- [Agentic RL 六框架](../ch04/200-agentic-rl.html) — Agentic search 的检索质量是关键瓶颈
