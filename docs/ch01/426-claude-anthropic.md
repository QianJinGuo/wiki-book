...
## Ch01.426 全网骂Claude变笨，Anthropic下场揭秘：坑你的不是模型

> 📊 Level ⭐⭐ | 9.7KB | `entities/claude-perceived-degradation-anthropic-effort-model-explanation-2026.md`
...
```mermaid
mindmap
  root(("全网骂Claude变笨 Anthropic下场揭秘 坑你的不是模型"))
    Effort 机制的技术本质
    模型能力与 Effort 的协同效应
    年 3 月变笨危机的深层教训
    从模型排行榜到调度能力的范式转变
