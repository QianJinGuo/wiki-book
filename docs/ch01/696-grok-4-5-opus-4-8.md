...
从 V8-small（约 0.5T）到 V9 基座（1.5T），xAI 的模型参数在单代内增长了 3 倍，是当前最激进的参数扩展之一。更值得关注的是训练基础设施的跃升——数万块 NVIDIA GB300 和异步训练架构支撑超长 agentic rollout。这与 [Xai Dissolved Grok Colossus2 Analysis](../ch05/105-ai.html) 中讨论的 Colossus 集群能力形成呼应。下一代 Grok 5 目标参数规模达 6 万亿以上，按此速度 xAI 正在走一条「参数规模最大化」的路线。
...
- [Xai Dissolved Grok Colossus2 Analysis](../ch05/105-ai.html) — xAI Colossus 集群与 Grok 训练分析
