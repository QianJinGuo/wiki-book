...
## Ch01.509 Agent Skills 开发指南：6 字段规范、3 级加载、5 步评估闭环
...
- [Claude Code Skill 编写指南](ch04/256-skill.md) — Anthropic 官方 skill 编写指南
- [Superpowers 深度解读](ch04/277-ai.md) — Rule/Gate/Hook 与 Iron Law 方法论
- [Anthropic Skill 设计模式](ch04/256-skill.md) — 官方推荐的技巧和模式
