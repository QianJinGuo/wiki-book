...
## Ch01.1230 高德 AI 资产度量与评价体系：三层评估模型 + 离线采集 + 人工反馈闭环
...
- [高德 Harness/SDD 演进](../ch05/129-ai-coding.html) — 同一团队的前序实践
- [AI Agent 评测 5 维体系](../ch05/129-ai-coding.html) — 评估方法论互补（模型评测 vs 资产度量）
