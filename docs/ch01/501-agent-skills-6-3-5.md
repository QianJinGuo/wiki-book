...
## Ch01.501 Agent Skills 开发指南：6 字段规范、3 级加载、5 步评估闭环
...
- [Superpowers 深度解读](../ch05/081-ai.html) — Rule/Gate/Hook 与 Iron Law 方法论
- [Anthropic Skill 设计模式](ch01/873-anthropic.html) — 官方推荐的技巧和模式
