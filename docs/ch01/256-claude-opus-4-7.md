...
- → [Claude Code 深度架构分析](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/claude-code-deep-architecture-analysis.md)
...
- → [Claude Harness 设计：Generator-Evaluator](../ch05/008-harness.html)
