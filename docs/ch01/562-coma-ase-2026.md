...
## Ch01.562 提示词压缩竟成大模型新漏洞？港科大提出黑盒攻击框架COMA | ASE 2026

> 📊 Level ⭐⭐ | 8.0KB | `entities/提示词压缩竟成大模型新漏洞港科大提出黑盒攻击框架coma-ase-2026.md`
...
```mermaid
mindmap
  root(("提示词压缩竟成大模型新漏洞 港科大提出黑盒攻击框架COMA ASE"))
    效率组件如何打开安全缺口
    黑盒攻击的两阶段优化策略
    安全边界从 LLM 前移到中间件
    隔离压缩的结构性防御价值
...
- [Prompt Injection 攻击向量分类](https://github.com/QianJinGuo/wiki/blob/main/entities/mechanistic-explanation-prompt-injection-roles.md) — 传统 Agent 攻击面分类体系
- [Agent 安全防护体系](../ch04/298-ai-agent.html) — Agent 从提示词注入到运行时安全的完整防护实践
- [LLM 安全红队实践](https://github.com/QianJinGuo/wiki/blob/main/concepts/llm-security-red-teaming.md) — 大模型安全部署的红队测试与防护
- [Attention Collapse 与上下文管理](https://github.com/QianJinGuo/wiki/blob/main/entities/attention-collapse-context-management.md) — 上下文长度与模型注意力衰减问题
- [Harness Engineering Framework](https://github.com/QianJinGuo/wiki/blob/main/concepts/harness-engineering-framework.md) — Agent 工程化框架中的安全治理

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/提示词压缩竟成大模型新漏洞港科大提出黑盒攻击框架coma-ase-2026.md)
→ [机器之心补充报道](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/提示词压缩竟成大模型新漏洞港科大提出黑盒攻击框架coma-ase-2026-2026-07-08.md)
