...
## Ch01.729 Fake OpenAI Privacy Filter Repo Hits #1 on Hugging Face, Draws 244K Downloads
...
- [ml-intern — Hugging Face 自主 ML 工程代理](../ch04/643-ml-intern-huggingface-autonomous-ml-agent.html)
- [LLM Share 恶意分发页面](ch01/1422-llmshare-using-shared-chatbot-pages-to-distribute-malware.html)
- [LLM raiders and how to repel them](ch01/1052-llm-raiders-and-how-to-repel-them.html)
