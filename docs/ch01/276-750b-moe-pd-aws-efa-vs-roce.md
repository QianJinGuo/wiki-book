...
## Ch01.276 750B MoE PD 分离推理：AWS EFA vs 自建 RoCE 通信架构实战对比
...
- [Foundation Model Building Blocks on AWS](ch04/277-ai.md) — AWS 训练与推理基础组件
- [Foundation Model Building Blocks](ch03/087-foundation-model-building-blocks.md) — 通用基础组件
- [GLM-5 Scaling Pain](ch04/277-ai.md) — GLM 系列规模化的工程挑战
