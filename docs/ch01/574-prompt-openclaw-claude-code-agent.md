...
## Ch01.574 别再亲自写Prompt了！OpenClaw与Claude Code创始人已经用'循环'让一堆Agent自动打工了
...
- [MCP 12 设计模式](ch04/502-agent.md)
- [OpenClaw 多智能体团队](ch11/209-openclaw.md)
...
- [Agent 原理与工程实践](ch04/502-agent.md)
