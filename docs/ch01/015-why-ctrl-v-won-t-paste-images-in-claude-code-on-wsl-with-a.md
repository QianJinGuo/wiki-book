...
这种"故障层对应修复层"的架构思路，与 [Harness Engineering](../ch05/112-harness-engineering.html) 中的容错模式如出一辙——不是消除故障源，而是在故障路径上插入补偿机制。
...
- [Eclecticlightco 2026 05 29 What Happens In The Log When An App Cra](ch01/910-20.html) — 系统内部机制调试方法
