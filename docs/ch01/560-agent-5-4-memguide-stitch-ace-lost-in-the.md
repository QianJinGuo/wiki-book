...
## Ch01.560 Agent 记忆注入实战：5 维框架（选什么/放哪里/怎么放/放多少/何时放）+ 4 前沿论文（MemGuide/STITCH/ACE/Lost in the Middle）
...
→ [三种 Agent Memory 方案对比实验](../ch06/045-memory.html) — MSA/Doc-to-lora/RAG 量化对比
