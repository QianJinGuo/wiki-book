...
## Ch01.671 Claude Code vs Kimi vs MiniMax：Agent Teams 到底拼的是什么？
...
这些问题的根因不在模型智力，而在缺乏系统化的控制平面——这正是 [Harness Engineering](../ch05/057-harness-engineering.html) 要解决的核心问题。
...
- [Agent Orchestration](../ch04/600-agent-orchestration.html) — 多 agent 编排模式
- [Kimi K2 Agent Swarm](ch01/577-kimi.html) — Kimi 并行 agent 方案的技术细节
