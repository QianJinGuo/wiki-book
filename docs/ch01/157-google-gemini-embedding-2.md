...
> 📊 Level ⭐⭐⭐ | 7.0KB | `entities/gemini-embedding-2-multimodal-unified-vector-hyman.md`
...
## 相关实体
- [Gemini Ai](https://github.com/QianJinGuo/wiki-public/blob/main/entities/gemini-ai.md)
