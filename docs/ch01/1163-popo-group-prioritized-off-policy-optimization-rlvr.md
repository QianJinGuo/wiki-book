...
## Ch01.1163 POPO (Group Prioritized Off-Policy Optimization)：清华 RLVR 训练高效组级回放框架
...
- [2026 年面向 LLM 的 RL 方法总结](https://github.com/QianJinGuo/wiki/blob/main/entities/2026-llm-rl-algorithms-deeplog-imba-ppo-dpo-grpo-marl.md) — PPO/DPO/GRPO 全景综述
- [APPO：阿里高德 Agent RL 信用分配到每个决策点](https://github.com/QianJinGuo/wiki/blob/main/entities/appo-agentic-procedural-policy-optimization-amap-ml-2026.md) — 另一 ARPO 系列 RL 方法
- [Self-Taught RLVR：京东让大模型自己教自己](https://github.com/QianJinGuo/wiki/blob/main/entities/self-taught-rlvr-jd-cii-2026.md)
