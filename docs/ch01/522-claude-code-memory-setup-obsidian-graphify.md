...
## Ch01.522 Claude Code Memory Setup (Obsidian + Graphify)

> 📊 Level ⭐⭐⭐ | 6.4KB | `entities/claude-code-memory-setup-obsidian-graphify.md`
...
- [Graphify：软件工程知识图谱](https://github.com/QianJinGuo/wiki-public/blob/main/entities/graphify-software-engineering-knowledge-graph.md)
- [Claude Code vs OpenClaw 记忆：向量数据库是否必要](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-openclaw-memory-vector-db-doubt.md)
