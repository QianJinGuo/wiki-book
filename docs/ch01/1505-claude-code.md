...
## 子页面
- [七大模块详解](../ch03/085-claude-code.html) — 入口链路、REPL、Query Loop、Tool Runtime、Permission、多Agent、扩展性
- [设计原则与对照分析](../ch03/085-claude-code.html) — 五条设计原则、Harness 映射、OpenClaw/Hermes 对比
...
- [从多智能体编排到AI自主决策：资损防控体系的架构演进](../ch05/110-ai.html)
- [Agentium — 从零实现 Agent 系统的开源框架](ch01/1486-agentium-agent.html)
- [17种Agent架构演进：控制流设计的完整演化史](../ch04/806-17-agent.html)
- [Owner-Worker-Verifier 架构](ch01/1533-owner-worker-verifier.html)
