...
- [Skill Issues Compromising Claude Code With Malicious Skills Agents Part 1](ch01/1121-skill-issues-compromising-claude-code-with-malicious-skills.html)：Skill 安全（恶意 skill 投毒视角，与本文"agent 自主行为越界"形成互补）
...
- [Knowledge Work Plugins Anthropic Source Analysis](ch01/1592-anthropic.html)：Anthropic 插件系统深度分析（Anthropic 整体生态视角）
- [Skill Hub Organization Asset Winty](../ch04/349-skill.html)：Skill 治理与生命周期（含 Skill review 流程的具体设计）
