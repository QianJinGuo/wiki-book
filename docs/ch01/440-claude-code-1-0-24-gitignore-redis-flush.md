...
- [Skill Issues Compromising Claude Code With Malicious Skills Agents Part 1](ch01/1131-skill-issues-compromising-claude-code-with-malicious-skills.html)：Skill 安全（恶意 skill 投毒视角，与本文"agent 自主行为越界"形成互补）
...
- [Knowledge Work Plugins Anthropic Source Analysis](ch01/783-anthropic.html)：Anthropic 插件系统深度分析（Anthropic 整体生态视角）
