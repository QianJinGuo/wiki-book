...
## Ch01.722 面向大型代码库的 Claude Code 团队落地经验与扩展策略（Agent Harness）
...
- [Claude Code 大型代码库 Agent Harness 13 模式（同作者姊妹篇）](../ch05/062-agent-harness.html)
- [深入理解 Claude Code 源码中的 Agent Harness 构建之道](../ch05/062-agent-harness.html)
- [一文带你弄懂 Harness Engineering](../ch05/126-harness-engineering.html)
- [腾讯 Harness 工程团队规范](../ch05/126-harness-engineering.html)
- [小米 Harness 工程：从 prompt 到 hook 到 plugin](../ch05/126-harness-engineering.html)
