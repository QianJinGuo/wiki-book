...
## Ch01.308 Claude Code vs Hermes — Session 工程师 vs Goal Runtime
...
| [Hermes 9 Module 架构](ch01/721-9.html) | Hermes 源码级 | 互补 (本实体: 跨工具对比) |
| [Claude Code Agentic Harness](../ch03/068-claude-code-agent.html) | CC 内部 harness 模式 | 互补 (本实体: CC vs Hermes 外部对比) |
| [Hermes Goal Runtime 架构](../ch04/364-hermes-agent-goal.html) | Goal-in-loop 实现 | **直接相关** (本实体 Goal 概念的实现) |
