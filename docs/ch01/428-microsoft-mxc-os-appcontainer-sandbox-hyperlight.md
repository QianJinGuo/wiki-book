...
## Ch01.428 Microsoft MXC — 跨 OS 代理代码执行容器：AppContainer/Sandbox/Hyperlight 三层隔离

> 📊 Level ⭐⭐ | 17.1KB | `entities/microsoft-mxc-execution-containers-agent-sandbox-origin.md`
...
→ [MXC Internals 原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/microsoft-mxc-execution-containers-agent-sandbox-origin.md)
...
- [CrewAI Agent Security 三步防护](../ch05/017-harness.html) — 应用层 guardrail 视角
- [AI Tool Poisoning 调查](../ch04/353-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s.html) — agent 工具被污染的攻击面
