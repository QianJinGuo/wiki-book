...
这印证了 [Harness Engineering](../ch05/129-harness-engineering.html) 的核心原则：Agent 的能力越强，控制平面的治理就越不能松懈。Claude Science 的逐项授权机制和审查智能体正是这一原则在产品层面的体现。
...
- [Agent Orchestration](../ch04/599-agent-orchestration.html) — 多 agent 编排在科研场景的应用
