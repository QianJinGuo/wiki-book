...
这与 [Harness Engineering Core Patterns](ch03/075-claude-code.md) 中"控制面应当外置给人类"的工程原则一致——Human-in-the-Loop 不是降级方案，而是 Agent 系统设计的核心约束。
...
这与 [Claude Code Harness 深度解析](ch03/075-claude-code.md) 中的 harness 设计哲学一致——harness 的核心价值就是为 Agent 提供持续运行的工程环境，而非一次性对话界面。
...
- [深入理解 Claude Code Agent Harness 构建之道](ch03/075-claude-code.md)
...
- [加速 LLM 模型加载与上下文窗口](ch01/990-accelerate-llm-model-loading-and-increase-context-windows-wi.md)
- [大型表格模型基础](ch04/069-ai.md)
