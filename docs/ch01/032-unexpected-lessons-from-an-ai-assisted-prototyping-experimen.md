...
## Ch01.032 Unexpected lessons from an AI-assisted prototyping experiment
...
- [system over model, tested: reproducing mythos's freebsd find](ch01/939-20.html)
- [from doer to director: the ai mindset shift](ch01/031-from-doer-to-director-the-ai-mindset-shift.html)
- [DDoSing Software Delivery Pipelines](ch01/939-20.html)
