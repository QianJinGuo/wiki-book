...
- **[SchemaFlow](ch05/094-ai.html)**：Agent 驱动的数据库 SQL 生成，同样需要语义约束
...
- [Snowflake Agentic Enterprise](ch03/035-agent.html) — Snowflake 的 Agent 平台愿景
- [SchemaFlow](ch05/094-ai.html) — Agent 驱动的 SQL 生成
- [Anthropic Data Analysis](ch01/742-9.html) — LLM 数据分析的另一个视角
