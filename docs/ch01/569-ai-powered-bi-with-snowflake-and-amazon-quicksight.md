...
## Ch01.569 AI-powered BI with Snowflake and Amazon QuickSight
...
- **[Data-Native Agents](../ch04/500-how-to-build-agents-where-data-already-lives.html)**：Agent 直接在数据平台上运行，语义层是关键基础设施
...
- [Anthropic Data Analysis](ch01/944-anthropic.html) — LLM 数据分析的另一个视角
