...
> -> [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/minimax-token-degradation-jiqia.md)
...
## 来源
- [MiniMax 全链路排查](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/minimax-token-degradation-jiqia.md)
