...
## Ch01.1200 高德 AI 资产度量与评价体系：三层评估模型 + 离线采集 + 人工反馈闭环
...
- [高德 Harness/SDD 演进](../ch05/118-ai-coding.html) — 同一团队的前序实践
- [AI Agent 评测 5 维体系](../ch05/118-ai-coding.html) — 评估方法论互补（模型评测 vs 资产度量）
- [AINMM 成熟度模型](../ch05/021-ai-native.html) — 组织级 AI Native 能力评估（宏观框架）
- [HSCodeComp](ch01/203-acl-2026.html) — 验证信号（Agent Harness +8.5pt，与资产度量中 Agent Harness 的价值信号一致）
- [Harness Engineering](../ch05/129-harness-engineering.html) — Skill/MCP 是 Harness 的执行载体
