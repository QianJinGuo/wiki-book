...
## Ch01.1586 Anthropic 模型性格研究 — 四条价值轴与语言差异
...
- [Anthropic Claude Code Trojan Telemetry Security 2026](ch01/798-anthropic-claude-code.html) — Anthropic 在安全层面的其他研究，构成完整的模型治理图景
- [Anthropic 8X Output Verification Bottleneck Fiona Fung](../ch09/101-anthropic-8x.html) — Anthropic 在 AI 工程实践中的另一维度探索
