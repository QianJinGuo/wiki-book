...
## Ch01.335 Agent 记忆注入实战：5 维框架（选什么/放哪里/怎么放/放多少/何时放）+ 4 前沿论文（MemGuide/STITCH/ACE/Lost in the Middle）
...
→ [Agent Memory 模块化框架与评测](ch04/503-agent.md) — Memory 4 模块框架（ICLR 2026 论文）
→ [Agent Memory 架构本质](ch04/503-agent.md) — Memory 治理理论
...
→ [Agent Loop 8 痛点](ch04/503-agent.md) — 记忆大小是痛点 4（同模型盲区）
→ [Agent Memory 评测综述 (淘天)](ch04/503-agent.md) — Mem0 评测视角
