...
## Ch01.271 Codex 三件套：6 职位插件 + Sites + Annotations
...
- 符合 [Meta Skill](../ch07/025-meta-skill.html) 抽象层
...
- 与 [Embabel](../ch07/021-embabel.html) 的"完全可解释可审计"思路呼应
...
## 相关对照
- [Codex Goal Agent Runtime](../ch04/110-codex-goal-agent.html)
- [Codex Goal 实现拆解](../ch09/046-codex-goal.html)
- [Codex Computer Use](../ch09/139-codex-can-now-control-other-desktop-devices-via-computer-use.html)
- [Codex 自主赚钱](ch01/513-codex.html)
- [Claude Code vs Codex 上下文架构](../ch03/076-claude-code.html)
- [Meta Skill](../ch07/025-meta-skill.html)（Skill 2.0 抽象）
- [扣子 3.0 协作系统](ch01/1177-3-0.html)（同类协作产品）
...
- [Meta Skill](../ch07/025-meta-skill.html) —— Skill 2.0 抽象层理论，解释为何"1 插件 = N 原子 Skill × M 应用集成"是技能演进的必然方向。

- [Embabel](../ch07/021-embabel.html) —— 与 Annotations 的"局部编辑"范式在可解释性设计上形成跨产品呼应，两者共同指向"信任用户满意部分，只改被选中部分"的协作哲学。

## 2nd Source：极客之家译介（2026-06-05）——Sites 落地细节与三层权限

> 来源：[极客之家译介 OpenAI 官方](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/codex-sites-cloudflare-worker-one-click-deploy-geekhome.md)（2026-06-05）
