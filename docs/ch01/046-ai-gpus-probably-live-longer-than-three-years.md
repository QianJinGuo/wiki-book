...
## Ch01.046 AI GPUs probably live longer than three years
...
- [system over model, tested: reproducing mythos's freebsd find](ch01/911-20.html)
- [from doer to director: the ai mindset shift](ch01/031-from-doer-to-director-the-ai-mindset-shift.html)
- [DDoSing Software Delivery Pipelines](ch01/911-20.html)
- [Unexpected lessons from an AI-assisted prototyping experiment](../ch04/070-ai.html)
