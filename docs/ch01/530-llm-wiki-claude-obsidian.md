...
> [!contradiction] 参见 [Karpathy LLM Wiki 第二大脑](ch01/862-llm.html) — 原始方案认为 LLM Wiki 的全局推理能力优于 RAG 切片，但企业场景下规模和溯源问题使这一优势反转

**适用场景判断**：个人知识库、学习研究等低风险场景 → LLM Wiki 效率高体验好；企业知识库 → 需按数据规模、权限要求、引用准确性综合评估

## 相关实体
- [Llm Wiki Architecture](ch01/862-llm.html)
- [Karpathy Claude Md Rules](ch01/424-claude-md.html)
- [Obsidian Llm Wiki Local Kytmanov](ch01/862-llm.html)
- [Claude Md 12 Rules Mnilax](ch01/424-claude-md.html)
