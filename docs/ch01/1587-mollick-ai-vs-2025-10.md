...
## Ch01.1587 Mollick 的 AI 实用指南：免费 vs 付费·模型选择·深度研究（2025-10）
...
- [Guide Ai Agents Models Apps Harnesses Mollick](../ch04/670-ai-agent.html) — 同一作者的 2026-02 更新版（更聚焦 agentic era）
...
- [Jagged Ai Frontier Mollick](../ch05/108-ai.html) — Jagged Frontier / GDPval 实际工作评估（同一作者）
