...
→ [Agentic search models](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agentic-search-models-softwaredoug.md) — 同主题概念层 vs 架构层互补
→ [原文存档](https://research.perplexity.ai/articles/rethinking-search-as-code-generation)
