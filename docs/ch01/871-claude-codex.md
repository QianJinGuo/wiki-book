...
## Ch01.871 Claude 做方案，Codex 写代码：多模型协作怎么交接才稳
...
- [Agent Harness Context Management Working Set](../ch05/063-agent-harness.html) — 上下文窗口作为运行时工作集的观点
- [Codex 5 Layer Architecture](ch01/734-codex.html) — Codex 的架构设计
...
- [Harness Engineering](../ch05/057-harness-engineering.html) — Harness Engineering 总体概念
