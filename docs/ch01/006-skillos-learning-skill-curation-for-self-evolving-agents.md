...
> 📊 Level ⭐ | 14.2KB | `entities/skillos-learning-skill-curation-for-self-evolving-agents.md`
...
- [基于AgentCore构建自学习、可进化的文旅行业近似信息抽取Agents | 亚马逊AWS官方博客](https://github.com/QianJinGuo/wiki-public/blob/main/entities/self-learning-evolvable-agents-for-cultural-tourism-info-extraction-with-agentcore.md)
...
- [工作流的 skill 怎么写？从 7 个顶级 skill 中提炼的模式与最佳实践](https://github.com/QianJinGuo/wiki-public/blob/main/entities/工作流的-skill-怎么写从-7-个顶级-skill-中提炼的模式与最佳实践.md)
