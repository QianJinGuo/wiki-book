...
## Ch01.307 Rethinking Search as Code Generation

> 📊 Level ⭐⭐ | 13.6KB | `entities/perplexity-search-as-code-generation.md`
...
→ [Agentic search models](../ch04/509-agentic-search-models.html) — 同主题概念层 vs 架构层互补
