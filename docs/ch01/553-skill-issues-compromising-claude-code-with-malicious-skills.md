...
## Ch01.553 Skill Issues: Compromising Claude Code with malicious skills & agents -- Part 1

> 📊 Level ⭐⭐⭐ | 5.6KB | `entities/skill-issues-compromising-claude-code-with-malicious-skills-agents-part-1.md`
