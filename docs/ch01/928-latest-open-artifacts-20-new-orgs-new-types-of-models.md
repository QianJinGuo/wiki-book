...
## Ch01.928 Latest open artifacts (#20): New orgs! New types of models! With Nemotron Super, Sarvam, Cohere Transcribe, & others
...
- [interconnects ai p open and closed models are on different](ch04/277-ai.md)
- [reducing container cold start times using soci index on dlam](ch01/1012-reducing-container-cold-start-times-using-soci-index-on-dlam.md)
- [state of routing in model serving](ch11/174-state-of-routing-in-model-serving.md)
- [the distillation panic](ch01/381-the-distillation-panic.md)
