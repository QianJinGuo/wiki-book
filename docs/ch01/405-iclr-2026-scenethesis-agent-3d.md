...
## Ch01.405 ICLR 2026 Scenethesis：英伟达 & 普渡大学用 Agent 闭环实现文生 3D
...
```mermaid
mindmap
  root(("ICLR 2026 Scenethesis 英伟达 普渡大学用"))
    可交互 3D 场景生成的长期困境
    四阶段闭环的工程解构
    实验数据解读
    对具身智能的战略意义
...
- [iclr 2026 | 英伟达×普渡大学：用agent闭环实现文生3d](../ch03/035-agent.html)
...
- [Yann Dubois Openai Post Training Matt Turck Interview](ch01/390-openai.html) — OpenAI 后训练方法访谈
- [Yann Lecun Llm Not Intelligence Jepa](ch01/1274-llm.html) — LeCun 关于 LLM 与空间智能的批判
- [2026 Llm Rl Algorithms Deeplog Imba Ppo Dpo Grpo Marl](ch01/1274-llm.html) — 2026 LLM RL 算法综述
- [Scale Robot Reinforcement Learning With Nvidia Isaac Lab On ](ch01/1170-scale-robot-reinforcement-learning-with-nvidia-isaac-lab-on.html) — NVIDIA Isaac Lab 机器人 RL 扩展
- [Minimax M3 Frontier Three Set Open Source](../ch09/081-minimax-m3-frontier.html) — MiniMax M3 开源前沿三件套
