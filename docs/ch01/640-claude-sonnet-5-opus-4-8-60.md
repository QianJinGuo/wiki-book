...
## Ch01.640 Claude Sonnet 5 发布，性能接近 Opus 4.8，价格只有60%
...
- [Anthropic Claude Code 木马遥测安全事件](ch01/476-anthropic-claude-code.html) — Sonnet 5 的安全改进与 Anthropic 整体的安全策略演进
- [Claude Code 学术文献综述](../ch03/084-claude-code.html) — Sonnet 5 在编码场景中的实际应用案例
- [Agent 评测方法论与体系设计](../ch03/036-agent.html) — SWE-bench、HLE、OSWorld 等评测基准的设计原理
