...
## Ch01.580 Cline releases open-source agent runtime SDK
...
- [深入理解 Claude Code 源码中的 Agent Harness 构建之道](../ch05/042-agent-harness.html) — Claude Code harness 设计的深度剖析
- [存之有序治之有矩Agent 记忆系统的工程实践与演进](../ch03/036-agent.html) — Agent 记忆系统的工程实践，与"持久化在文件系统"理念呼应
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](../ch04/289-agentic.html) — 从 vibe coding 到 agentic engineering 的范式跃迁
- [Karpathy Vibe Coding Agentic Engineering](../ch04/787-karpathy-vibe-coding-agentic-engineering.html) — Vibe Coding 与 Agentic Engineering 的同源访谈
...
- [Claude Code Harness Deep Understanding](ch01/635-claude-code-harness-deep-understanding.html) — Claude Code harness 的另一深度解析
- [Claude Code Harness Deep Dive Founder Park](../ch05/086-claude-code-harness.html) — 同主题的另一种解读视角
- [scaling archunit with nebula archrules](../ch11/313-scaling-archunit-with-nebula-archrules.html)
- [the code-as-content era](ch01/685-the-code-as-content-era.html)
- [the shape of the thing](ch01/398-the-shape-of-the-thing.html)
