...
## 相关实体
- [Lessons from Building Claude Code: Seeing like an Agent](../ch03/076-claude-code.html)
...
- [深度拆解 Claude Code 12 个可复用的 Agentic Harness 设计模式](../ch03/068-claude-code-agent.html)
...
- [钉钉 stream + cli 代理双引擎 ai 助手架构](../ch05/090-ai.html)
