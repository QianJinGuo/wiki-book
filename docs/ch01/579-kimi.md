...
**第一波：模型实力验证。** K3在LMArena Frontend Code Arena取得全球第一，超越Claude Fable 5和GPT-5.6 Sol，第三方盲测中编程能力被公认已摸到Fable 5水平线。[Kimi K3这是 Deepseek 20 时刻](ch01/806-deepseek.html)中有更详细的benchmark对比数据。
...
- [Kimi K3 深度分析](ch01/806-deepseek.html)
- [Kimi Work 通用 Agent](ch01/739-codex.html)
- [模型公司做 Agent 的优势](ch01/579-kimi.html)
- [xAI Grok 新一代模型](../ch04/209-xai-grok-musk.html)
