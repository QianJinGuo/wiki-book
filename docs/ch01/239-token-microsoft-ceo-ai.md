...
纳德拉在 1990 年代末受 [Karpathy LLM Wiki](https://github.com/QianJinGuo/wiki/blob/main/concepts/karpathy-llm-wiki-v2.md) 类比影响颇深，其平台哲学一以贯之。[Microsoft Build 2026](ch04/310-ai.md) 却在同月高调主推"前沿模型"，与本文的"前沿生态系统"叙事形成内部张力——同一 CEO 的两套话语，实际上对应[Harness Engineering](ch04/503-agent.md)所揭示的**产品层**与**战略层**双重现实。
...
- [Microsoft Build 2026 MAI Models Scout Agent](ch04/310-ai.md)
- [MiniMax Token 退化](ch01/277-token.md)
- [Cybersecurity Reach:Revoke Token 擦除计算机](ch01/277-token.md)
