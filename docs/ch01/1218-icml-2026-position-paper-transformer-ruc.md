...
## Ch01.1218 ICML 2026 Position Paper — Transformer 图灵完备性高度依赖上下文管理 (RUC 魏哲巍团队)
...
- [Codex Context Engineering](ch01/535-codex.html)
- [Claude Code Context Engineering (Anthropic Thariq)](../ch03/076-claude-code.html)
- [Claude Fable 5 提示词泄漏](ch01/175-claude-fable-5.html) — 同样指出 "系统 = 模型 + 上下文管理"
