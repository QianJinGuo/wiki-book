...
## Ch01.199 有人只用API就猜出了GPT、Claude、Gemini的参数量？社区吵翻了
...
- 原文: [有人只用API就猜出了GPT、Claude、Gemini的参数量？社区吵翻了](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/2026-05-01-有人只用API就猜出了GPT-Claude-Gemini的参数量-社区吵翻了-机器之心.md)
- 原始链接: : "https://mp.weixin.qq.com/s/ll755HbdLApSa8V761YexA
