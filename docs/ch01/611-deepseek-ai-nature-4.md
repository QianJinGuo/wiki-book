...
这一思路与[AI自我改进：从Harness开始](../ch05/110-harness.html)的理念高度一致——Agent不应只是被动执行指令，而应在执行过程中生成可训练的高质量数据，反哺自身能力的持续进化。
...
- [DeepSeek V4](ch01/688-deepseek-v4.html) — 同为登上Nature主要期刊的中国AI公司
- [AReaL 2.0](../ch04/438-agentic-rl.html) — 在线强化学习基础设施，与推理数据生成互补
- [AI自我改进：从Harness开始](../ch05/110-harness.html) — Agent通过运行轨迹持续优化的理念
