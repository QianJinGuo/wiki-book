...
## Ch01.253 深入理解 Claude Code 源码中的 Agent Harness 构建之道
...
- [Claude Code Dynamic Workflows](../ch09/087-claude-code-dynamic-workflows.html) — AgentTool 子智能体 + Dynamic Workflow 范式
