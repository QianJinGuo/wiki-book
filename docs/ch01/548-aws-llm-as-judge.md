...
## Ch01.548 AWS 强化微调：LLM-as-Judge 训练范式
...
- [Llm Finetuning Cost Breakdown](ch01/625-llm.html)
...
- [stop hand-tuning kernels: how neuron agentic development acc](../ch04/341-stop-hand-tuning-kernels-how-neuron-agentic-development-acc.html)
