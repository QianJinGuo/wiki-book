...
## Ch01.300 Simplify model selection in Amazon Bedrock with the open source Model Profiler
...
- [AgentCore Harness Trip Allocation Multi-Agent System AWS](../ch04/656-agentcore-harness.html) — AWS Agent ecosystem
