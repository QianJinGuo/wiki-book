...
- [Hermes Agent /goal 长任务运行时架构](../ch04/350-hermes-agent-goal.md)
- [LLM agent脚手架如何具备自进化能力？——以hermes agent为例](../ch03/090-hermes-agent.md)
- [LoongSuite GenAI 可观测语义规范](../ch04/420-loongsuite-genai.md)
- [低代码 Agent、框架 Agent、自研 Agent 决策框架](../ch03/045-agent.md)
- [三器合一：gstack + Superpowers + OpenSpec 工程化 AI 编程实战](../ch05/081-ai-coding.md)
