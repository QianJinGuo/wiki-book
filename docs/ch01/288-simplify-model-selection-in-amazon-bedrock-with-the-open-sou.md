...
## Ch01.288 Simplify model selection in Amazon Bedrock with the open source Model Profiler
...
- [AgentCore Harness Trip Allocation Multi-Agent System AWS](../ch04/690-agentcore-harness.html) — AWS Agent ecosystem
- [Agent Config Model Tool Skill MCP](../ch04/273-skill.html) — Model/tool configuration patterns
