...
## Ch01.313 读完这篇你就搞懂 DeepSeek v4 了
...
这与 [DeepSeek MoE 并行策略](ch01/439-deepseek.html)、[DeepSeek 成本迁移系统层 KV Cache Harness](ch01/439-deepseek.html)、[DeepSeek V4 Training 58-page Paper Deep Dive](ch01/679-deepseek-v4.html) 等文章形成完整图景。

### 六、与其他 V4 解读的关系

- [DeepSeek V4 Flash/Pro: 百万级上下文与万亿参数推理新纪元](ch01/984-deepseek-v4-flash-pro.html) 关注产品侧
- [DeepSeek V4 Flash/Pro v2](ch01/984-deepseek-v4-flash-pro.html) 是上一条的更新版
- [DeepSeek V4 Pro vs Claude](ch01/679-deepseek-v4.html) 关注对比评测
- [DeepSeek V4 Flash Means LLM Steering is Interesting Again](ch01/1010-deepseek-v4-flash-means-llm-steering-is-interesting-again.html) 关注 V4 Flash 的"可控生成"能力
...
- [DeepSeek Code Harness](../ch09/082-deepseek-code-harness.html) 关注 V4 在 Agent / Harness 场景的工程实践
- [DeepSeek Code Harness 竞争者 Tina](../ch09/082-deepseek-code-harness.html) 关注竞品分析
...
- **关注 V4 在 Agent / Harness 场景的工程实践**——V4 的能力需要 harness 配合才能在生产中稳定输出，关注 [DeepSeek Code Harness](../ch09/082-deepseek-code-harness.html) 等。
...
- [DeepSeek V4 Flash/Pro: 百万级上下文与万亿参数推理新纪元](ch01/984-deepseek-v4-flash-pro.html)
- [DeepSeek V4 Flash/Pro v2](ch01/984-deepseek-v4-flash-pro.html)
- [DeepSeek V4 Pro vs Claude](ch01/679-deepseek-v4.html)
- [DeepSeek V4 Flash Means LLM Steering is Interesting Again](ch01/1010-deepseek-v4-flash-means-llm-steering-is-interesting-again.html)
...
- [DeepSeek MoE 并行策略](ch01/439-deepseek.html)
- [DeepSeek 成本迁移系统层 KV Cache Harness](ch01/439-deepseek.html)
- [DeepSeek Code Harness](../ch09/082-deepseek-code-harness.html)
- [DeepSeek Code Harness 竞争者 Tina](../ch09/082-deepseek-code-harness.html)
