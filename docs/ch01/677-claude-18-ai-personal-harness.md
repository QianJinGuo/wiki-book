...
## Ch01.677 用好 Claude 的 18 个动作：搭一个个人 AI 工作台（Personal Harness）
...
- 原文链接
- [Harness Engineering](../ch05/096-harness-engineering.html) — Personal Harness 的工程化版本
- [Claude Code 源码核心机制](https://github.com/QianJinGuo/wiki-public/blob/main/entities/两万字详解claude-code源码核心机制.md)
- [Claude Code 源码中的 Agent Harness 构建](https://github.com/QianJinGuo/wiki-public/blob/main/entities/深入理解-claude-code-源码中的-agent-harness-构建之道.md)
- [Agent 记忆系统的工程实践](https://github.com/QianJinGuo/wiki-public/blob/main/entities/存之有序治之有矩agent-记忆系统的工程实践与演进.md)
