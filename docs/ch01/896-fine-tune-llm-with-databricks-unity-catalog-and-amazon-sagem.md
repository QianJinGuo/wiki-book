...
## Ch01.896 Fine-tune LLM with Databricks Unity Catalog and Amazon SageMaker AI
...
## 相关实体
- [基于 MIG 技术在 Amazon SageMaker HyperPod 上实现 GPU 虚拟化的最佳实践 | 亚马逊AWS官方博客](../ch04/444-pod.html)
- [LLM-as-Judge: RFT的6步法官设计方法论](ch01/863-llm.html)
