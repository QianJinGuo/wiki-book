...
## Ch01.081 PyTorch 2.12 Release Blog – PyTorch
...
## 相关实体
- [Pytorch 2 12 Release](ch01/081-pytorch-2-12-release-blog-pytorch.html) — 同一博客的平行存档

- [profiling in pytorch (part 2): from nn.linear to a fused mlp](ch01/950-20.html)
