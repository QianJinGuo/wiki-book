...
## Ch01.1445 相关性 ≠ 因果性：因果推断在 AI 评测归因中的方法与实践

> 📊 Level ⭐⭐ | 2.8KB | `entities/相关性-因果性因果推断在-ai-评测归因中的方法与实践.md`
...
- 原文完整记录：[原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/相关性-因果性因果推断在-ai-评测归因中的方法与实践.md)
