...
## Ch01.415 Fundamental’s Large Tabular Model NEXUS is now available on Amazon SageMaker JumpStart

> 📊 Level ⭐⭐ | 18.2KB | `entities/aws-fundamentals-large-tabular-model-nexus-is-now-available-on-amazon-sagemaker-jump.md`
...
## 相关实体
- [Openai Models Codex Amazon Bedrock Ga](../ch11/181-amazon-bedrock.html)
...
- [Amazon Sagemaker Qualcomm Ai Hub Edge Npu Deployment](../ch05/104-ai.html)
