...
- [Agent Harness 工程学调研](ch04/503-agent.md) — Agent 系统构建的核心架构要素
- [基于 Bedrock AgentCore 构建企业级应用](ch04/503-agent.md) — AWS 生态中 Agent 编排的具体实现路径
- [James 多 Agent 协作模式](ch04/503-agent.md) — 不同多 Agent 协作架构的对比分析
