...
## Ch01.399 Apple Silicon costs more than OpenRouter
...
- [离线 LLM 能量使用](ch01/902-llm.html) — 同一作者的另一篇相关文章
- [LightSeek TokenSpeed](ch01/1183-lightseek-tokenspeed.html) — 推理引擎优化技术（Speculative Decoding、KV Cache、Continuous Batching）
