...
## 相关实体
- [Identity Behavior & Context: ITDR Solution](042-identity-behavior-context-itdr-solution-teleport.html) — 同源姊妹条目，覆盖同一产品线的另一视角
...
- [Zero Trust for AI Agents](../ch04/284-ai-agent.html) — AI 身份信任边界的另一种讨论
