...
## Ch01.1320 算不上AGI，但Anthropic发现了Claude的潜意识！

> 📊 Level ⭐⭐⭐ | 3.4KB | `entities/算不上agi但anthropic发现了claude的潜意识.md`
...
```mermaid
mindmap
  root(("算不上AGI，但Anthropic发现了Claude的潜…"))
    要点
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/算不上agi但anthropic发现了claude的潜意识.md)
