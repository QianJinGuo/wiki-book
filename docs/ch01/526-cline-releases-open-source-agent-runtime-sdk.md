...
## Ch01.526 Cline releases open-source agent runtime SDK

> 📊 Level ⭐⭐ | 12.2KB | `entities/cline-open-source-agent-runtime-sdk.md`
...
## 相关实体
- [Cline releases open-source agent runtime SDK](../ch04/591-cline-releases-open-source-agent-runtime-sdk.html)
- [腾讯混元Hy3-preview发布](ch01/135-hy3-preview.html)
- [Claude Code 接入自建开源模型：企业私有化与降本实践 | 亚马逊AWS官方博客](../ch03/085-claude-code.html)
- [Codex /goal：长任务Agent的目标运行时](../ch04/247-codex-goal-agent.html)
