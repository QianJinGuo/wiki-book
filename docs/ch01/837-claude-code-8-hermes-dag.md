...
## Ch01.837 Claude Code 动态工作流 8 译本（行小招译注 + Hermes DAG 对比）
...
- [深入理解 Claude Code 源码中的 Agent Harness 构建之道](../ch05/063-agent-harness.html) — Claude Code 中的 agent harness 构建
- [存之有序治之有矩Agent 记忆系统的工程实践与演进](../ch03/035-agent.html) — Agent 记忆系统
- [Claude Code Harness Deep Understanding](ch01/636-claude-code-harness-deep-understanding.html) — Claude Code harness 深度解析
- [Claude Code Harness Deep Dive Founder Park](../ch05/083-claude-code-harness.html) — Founder Park 的 Claude Code harness 深度文章
