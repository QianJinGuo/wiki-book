...
## Ch01.883 智能体架构 —— 情景记忆与语义记忆栈，让智能体真正“长脑子”

> 📊 Level ⭐⭐ | 5.2KB | `entities/智能体架构-情景记忆与语义记忆栈让智能体真正长脑子.md`
...
```mermaid
mindmap
  root(("智能体架构 情景记忆与语义记忆栈 让智能体真正长脑子"))
    什么是双栈记忆
    架构工作流 从过目就忘到过目不忘
    动手实现 搭建双栈记忆智能体
      阶段0 基础与设置
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/智能体架构-情景记忆与语义记忆栈让智能体真正长脑子.md)
