...
## Ch01.747 Factory Mission Multi Agent Architecture
...
## 相关框架对比
- **[DeerFlow vs Hermes vs OpenClaw](../ch04/349-deerflow-hermes-openclaw.html)** — 都是 multi-agent 编排框架，与 Mission 的三角架构有相通之处
