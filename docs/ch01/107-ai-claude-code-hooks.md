...
- [Gepa Optimize Anything](437-gepa-optimize-anything.html) — ASI+Pareto前沿，声明式通用文本优化API
...
- [打造 AI 智能体专属的代码知识库：GitNexus 完整上手攻略](https://github.com/QianJinGuo/wiki-public/blob/main/entities/打造-ai-智能体专属的代码知识库gitnexus-完整上手攻略.md) — 预计算关系智能图谱
- [你还在手动调代码，这个工程师的平台已经在自动进化了](https://github.com/QianJinGuo/wiki-public/blob/main/entities/auto-improving-agent-platform-ashpreetbedi-shensi.md) — 自动改进平台全版
...
- [Stripe Sessions 2026 AI Agents](../ch04/181-stripe-sessions-2026-ai-agents.html) — Sessions分析含Radar洞见
