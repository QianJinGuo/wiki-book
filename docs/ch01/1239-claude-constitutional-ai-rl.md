...
## Ch01.1239 Claude 代码能力的系统工程解析：Constitutional AI + 可验证奖励 RL + 产品飞轮
...
- → [Building Next Claude](ch01/944-anthropic.html)：Claude 的产品演进方向
- → [Harness Engineering 范式](../ch05/116-harness-engineering.html)：代码能力在 Agent 场景的价值
