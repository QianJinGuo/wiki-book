...
## Ch01.323 NomShub — Cursor 远程隧道利用链：Shell Builtin 沙箱逃逸 + Dev Tunnels 武器化
...
- [Microsoft MXC](ch04/277-ai.md) — 微软自家跨 OS 沙箱，提供 kernel 隔离，可作 NomShub 的防御侧
- [CrewAI 三步防护](ch04/277-ai.md) — 应用层 guardrail 视角
- [AI Tool Poisoning](ch04/277-ai.md) — 工具被污染的通用风险
