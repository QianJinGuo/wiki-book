...
## Ch01.1234 Anthropic's bug-hunting Mythos was greatest marketing stunt ever, says cURL creator

> 📊 Level ⭐⭐ | 4.4KB | `entities/anthropic-mythos-bug-hunting-marketing.md`
...
## 相关实体
- [Anthropic's bug-hunting Mythos was greatest marketing stunt ever says curl creator](../ch12/117-anthropic-s-bug-hunting-mythos-was-greatest-marketing-stunt.html)
- [Japan's PM orders cybersecurity review to defend against Anthropic Mythos](ch01/1539-anthropic.html)
- [Mythos 发现 curl 漏洞](../ch12/011-mythos-finds-a-curl-vulnerability.html) — Daniel Stenberg（curl 作者）亲述 Mythos 扫描 curl 代码库的真实经历：5个"确认"漏洞经人工审核后只有1个真正成立

## 链接

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/2026.md)

- [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/5238111.md)
