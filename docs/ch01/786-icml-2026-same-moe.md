...
## Ch01.786 ICML 2026 | 南大SAME稳住MoE，缓解多模态持续微调双重遗忘

> 📊 Level ⭐⭐ | 5.7KB | `entities/icml-2026-南大same稳住moe缓解多模态持续微调双重遗忘.md`
...
-> [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/icml-2026-南大same稳住moe缓解多模态持续微调双重遗忘.md)
