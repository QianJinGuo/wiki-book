...
这些问题的根因不在模型智力，而在缺乏系统化的控制平面——这正是 [Harness Engineering](../ch05/116-harness-engineering.html) 要解决的核心问题。
...
- [Harness Engineering](../ch05/116-harness-engineering.html) — Agent 控制平面的系统方法论
- [Agent Orchestration](../ch04/495-agent-orchestration.html) — 多 agent 编排模式
- [Kimi K2 Agent Swarm](ch01/1181-kimi.html) — Kimi 并行 agent 方案的技术细节
- [Agent 评测方法论](../ch03/046-agent.html) — 验证和评估 agent 系统的方法

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/claude-code-vs-kimi-vs-minimaxagent-teams-到底拼的是什么.md)
