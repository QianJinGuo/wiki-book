...
## Ch01.484 Claude Code vs Kimi vs MiniMax：Agent Teams 到底拼的是什么？
...
- [Agent Orchestration](../ch04/513-agent-orchestration.html) — 多 agent 编排模式
- [Kimi K2 Agent Swarm](ch01/398-kimi.html) — Kimi 并行 agent 方案的技术细节
