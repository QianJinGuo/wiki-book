...
## Ch01.223 800行代码实现 Open Claw 的 Tool、消息总线、子Agent管理架构
...
- [iii.dev Worker/Trigger/Function 架构](ch01/229-iii-dev-worker.html) — "Harness 就是后端"：iii 对后端原语的抽象（Worker/Trigger/Function）与 OpenClaw 的薄抽象哲学高度一致，都强调基础设施应该是透明的、可组合的
