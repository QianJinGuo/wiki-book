...
- [Deepseek Moe Parallel Strategy](ch01/393-deepseek.html) — DeepSeek MoE 并行策略
...
- [Kimi Attention Residuals Prenorm Dilution Block Attnres](ch01/1183-kimi.html) — Kimi 注意力残差与 PreNorm 稀释
- [2026 Llm Rl Algorithms Deeplog Imba Ppo Dpo Grpo Marl](ch01/603-llm.html) — 2026 LLM RL 算法综述（DeepSeek V4 训练方法背景）
