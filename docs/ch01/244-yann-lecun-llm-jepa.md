...
> 📊 Level ⭐⭐⭐ | 11.0KB | `entities/yann-lecun-llm-not-intelligence-jepa.md`
...
- [面壁让ai写了训练框架forgetrain，然后它自己训出了最强1b模型](https://github.com/QianJinGuo/wiki-public/blob/main/entities/minicpm5-1b-forgetrain-agh-hunt.md)
...
- [private fintech has quietly become bigger than public fintec](https://github.com/QianJinGuo/wiki-public/blob/main/entities/private-fintech-has-quietly-become-bigger-than-public-fintec.md)
- [the inevitable need for an open model consortium](113-the-inevitable-need-for-an-open-model-consortium.html)
