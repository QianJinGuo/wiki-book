...
## Ch01.464 vivo Agent 系统分析：大模型是大脑不是马，Harness 是 ICU 不是马鞍
...
- **最佳实践收敛论** 与 [Loop Engineering](../ch04/351-loop-engineering.html) 的"先写刹车再写循环"工程哲学呼应——最佳实践在真实使用中显现，而非一次性设计完成
