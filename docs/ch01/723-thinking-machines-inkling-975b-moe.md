...
## Ch01.723 Thinking Machines Inkling — 975B MoE 开放权重模型
...
Thinking Machines Lab（估值约 500 亿美元）由前 OpenAI CTO Mira Murati、OpenAI 强化学习核心人物 John Schulman 以及 PyTorch 创始人 Soumith Chintala 联合创立。参见 [Neolab 浪潮分析](../ch05/105-ai.html)。
