...
- 与 [苦味教训](../ch04/401-the-bitter-lesson-versus-the-garbage-can.html)的张力：苦味教训暗示"算力 + 通用方法"会取代"工艺精心设计"；本文强调"管理能力"成为新稀缺——前者是技术派，后者是组织派。
- 与 [CrewAI 迭代论](../ch04/475-your-first-ai-agent-should-do-one-thing-badly.html)的同源：都强调"迭代"与"真实失败数据"的重要性。不同在于本文关注"管理能力"，CrewAI 关注"工程迭代节奏"。
...
- [The Bitter Lesson Versus The Garbage Can](../ch04/401-the-bitter-lesson-versus-the-garbage-can.html)
