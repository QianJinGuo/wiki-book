...
## Ch01.970 Redis之父下场，给DeepSeek V4单独造了一台推理引擎
...
- [ds4c deepseek v4 antirez](ch01/734-ds4c-deepseek-v4-antirez.html)
- [We Tested DeepSeek V4 Pro and Flash Against Claude Opus 4.7 and Kimi K2.6](ch01/436-deepseek-v4.html)
- [We Tested DeepSeek V4 Pro and Flash Against Claude Opus 4.7 and Kimi K2.6](ch01/588-deepseek.html)
