...
> 📊 Level ⭐⭐⭐ | 8.1KB | `entities/anthropic-claude-managed-agents-guide.md`
...
## 与现有知识库内容的关联
- [Claude Managed Agents](093-claude-managed-agents.html) — 托管 Harness 平台
...
- [Introducing Claude for Small Business](275-introducing-claude-for-small-business.html)
