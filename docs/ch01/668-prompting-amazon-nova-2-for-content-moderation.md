...
## Ch01.668 Prompting Amazon Nova 2 for content moderation
...
→ [[raw/articles/prompting-amazon-nova-2-for-content-moderation|原文存档]
...
对于已经部署了文本审核 pipeline 的团队，这是一个低摩擦的多模态扩展路径。^[].md]
...
### 4. 建立三级置信度路由
文章提到的 confidence-based routing 是生产级审核系统的标准架构：^[].md]
