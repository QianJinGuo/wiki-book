...
## Ch01.1064 百度提出 Unlimited OCR：用 Reference Sliding Window Attention 实现长文档 OCR 常量 KV Cache
...
- [DeepSeek 效率之争与 JetSpec](https://github.com/QianJinGuo/wiki/blob/main/entities/deepseek点燃大模型效率之争阶跃火速接棒jetspec让大模型解码速度最高提升近10倍.md) — 探讨 LLM 解码加速技术，与 R-SWA 的常量 KV cache 设计形成互补
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/baidu-unlimited-ocr-sliding-window-attention.md)
