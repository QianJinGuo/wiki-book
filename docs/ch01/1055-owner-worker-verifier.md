...
## Ch01.1055 Owner-Worker-Verifier 架构
...
## 相关实体
- [Scalable voice agent design with Amazon Nova Sonic: multi-agent, tools, and session segmentation](ch03/044-agent.md)
...
- [routa 多智能体协同交付平台](ch03/044-agent.md)
