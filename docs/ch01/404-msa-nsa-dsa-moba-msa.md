...
- [MiniMax M3 开源 Frontier 模型](../ch09/075-minimax-m3-frontier.html) — MSA 是 M3 的核心架构创新
- [DeepSeek V4 Flash Pro 1M 上下文](ch01/1301-deepseek-v4-flash-pro.html) — 压得狠路线的最新代表
- [DeepSeek V4 训练方法学](ch01/432-deepseek-v4.html) — 训练配方对比
