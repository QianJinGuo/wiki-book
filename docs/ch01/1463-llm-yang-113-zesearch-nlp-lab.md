...
| **科学研究（Science）** | 自主假设提出、实验执行 | [Prime Intellect / nanoGPT Opus 4.7 突破人类纪录](../ch05/110-ai.html) |
...
| **问题域** | LLM 自我提升的**系统级闭环** | 多为单点机制（[六条路](../ch03/006-agent.html)）/ 单点实验（[nanoGPT](../ch05/110-ai.html)）/ 单点产品（[LangSmith](../ch03/006-agent.html)） |
...
- **同主题不同 artifact**：
  ...
  - [AI 科研超越人类 — Prime Intellect 递归自改进实验](../ch05/110-ai.html)（单点实验：nanoGPT 突破人类纪录）
...
- **同领域框架**：
  - [Agent Harness Engineering 综述](../ch05/066-harness-engineering.html)（harness 视角）
