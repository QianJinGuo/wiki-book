...
## Ch01.441 读完 Claude Code 和 OpenClaw 的 memory 源码，我对 Agent 记忆需要向量数据库产生怀疑
...
- [Harness Engineering 7 Layers Openclaw Hermes Claude Code P1Anu](../ch05/068-harness-engineering.html)
