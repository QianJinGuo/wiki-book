...
## Ch01.431 What Is Software, and Will LLMs Replace It?
...
现代 agent 架构（如 [Claude Code](../ch09/069-claude-code-dynamic-workflows.html)、Codex）的设计本质上就是这一分层的实现：
...
- [本文实体](448-llm.html) — Tomassetti 的分析
- [AI Agent Hype](../ch04/423-ai-agent.html) — 对 AI agent 过度炒作的冷静分析
