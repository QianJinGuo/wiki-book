...
## Ch01.402 Yann LeCun 谈 LLM 不是智能与世界模型 JEPA
...
- [OpenClaw 多 Agent 协同开发](../ch11/226-openclaw.html)
...
- [better decisions at scale: how mathematical optimization del](../ch11/165-better-decisions-at-scale-how-mathematical-optimization-del.html)
...
- [Private Fintech Has Quietly Become Bigger Than Public Fintec](../ch03/104-private-fintech-has-quietly-become-bigger-than-public-fintec.html)
- [the inevitable need for an open model consortium](ch01/427-the-inevitable-need-for-an-open-model-consortium.html)
