...
## 核心产品
- [Claude Managed Agents 平台](ch01/283-anthropic-claude-managed-agents.html)
- Claude 系列模型（Claude Haiku/Sonnet/Opus）
- Claude Code 开发工具

## 核心研究
- [Natural Language Autoencoders（NLAs）](ch01/1248-natural-language-autoencoders-anthropic.html) — 激活→文字翻译
