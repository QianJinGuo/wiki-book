...
## Ch01.1304 Latest open artifacts (#20): New orgs! New types of models! With Nemotron Super, Sarvam, Cohere Transcribe, & others
...
- [reducing container cold start times using soci index on dlam](ch01/1399-reducing-container-cold-start-times-using-soci-index-on-dlam.html)
- [state of routing in model serving](../ch11/199-state-of-routing-in-model-serving.html)
- [the distillation panic](ch01/867-the-distillation-panic.html)
