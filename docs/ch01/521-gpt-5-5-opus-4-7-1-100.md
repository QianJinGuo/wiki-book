...
## Ch01.521 这套题，GPT-5.5、Opus 4.7加起来没考到「1分」，人类却拿了满分100？

> 📊 Level ⭐⭐ | 8.4KB | `entities/2026-05-02-这套题-GPT-5-5-Opus-4-7加起来没考到-1分-人类却拿了满分100-机器之心.md`
...
**原文链接**: https://mp.weixin.qq.com/s/S_Z3olXnNNrh5qsPgYS9lw
...
```mermaid
mindmap
  root(("这套题，GPT-5.5、Opus 4.7加起来没考到「1…"))
    详细信息
    原文
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/2026-05-02-这套题-GPT-5-5-Opus-4-7加起来没考到-1分-人类却拿了满分100-机器之心.md)
