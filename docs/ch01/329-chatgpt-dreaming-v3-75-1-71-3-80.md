...
- [Chatgpt Memory](ch01/436-chatgpt-memory.md) — 10KB 旧版 ChatGPT Memory 概览（2026-04 写入），覆盖 V1 自动/手动记忆机制。本实体是**V3 新架构**补充——形成"V1/V0/V3 三阶段演进 + 量化数据 + 工程突破"完整时间线。
...
- 个人助手 / Agent 状态 — [Personavlm Personalized Memory](ch01/759-vlm.md)
- 算力优化 — [Harness Engineering Comprehensive Guide Conardli](ch05/009-harness.md)
...
- **重新设计用户 onboarding 流程**：当 AI 能自动记住用户偏好后，"首次对话自我介绍"不再是必要步骤。产品设计应假设用户已有记忆档案，直接进入任务完成模式，而非引导用户重复自我介绍。参考 [Personavlm Personalized Memory](ch01/759-vlm.md) 的个性化 memory 设计思路。 
