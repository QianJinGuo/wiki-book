...
## Ch01.281 knowledge-work-plugins拆解：Anthropic官方开源，4 种组件、3 级加载、2 层记忆，纯文件的 AI岗位插件集

> 📊 Level ⭐⭐ | 14.2KB | `entities/knowledge-work-plugins-shuge-anthropic-deep-source.md`
...
---
## 关联
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/knowledge-work-plugins-shuge-anthropic-deep-source.md)
