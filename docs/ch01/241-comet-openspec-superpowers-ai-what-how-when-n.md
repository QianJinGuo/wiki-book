...
## Ch01.241 三器合一（Comet + OpenSpec + Superpowers）：用文件系统给 AI 编程上工程纪律 — 术哥源码级深度分析（WHAT/HOW/WHEN-NEXT 分工 + 9 平台 Hook + 上下文压缩 + 多 Agent 协作 + Shell+YAML 工程取舍）
...
→ [Claude Code Skills Superpowers Practice](ch01/506-claude-code-skills-superpowers.html) — Claude Code + Superpowers 实践
