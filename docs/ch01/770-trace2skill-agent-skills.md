...
## Ch01.770 Trace2Skill 把\"轨迹里的局部经验\"蒸馏成可迁移的 Agent Skills
...
- [Yidian Tianxia Context Engineering Agentic Ai](../ch04/251-yidian-tianxia-context-engineering-agentic-ai.html)
- [Agentic Ai System Architecture Harness Skill Mcp](../ch05/087-harness-skill.html)
