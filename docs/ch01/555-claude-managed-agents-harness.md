...
## Ch01.555 Claude Managed Agents 官方 Harness 平台指南
...
## 与现有知识库内容的关联
- [Claude Managed Agents](../ch04/532-claude-managed-agents.html) — 托管 Harness 平台
...
- [Anthropic puts Claude agents on a meter across its subscriptions](../ch04/402-anthropic-claude-agent.html)
