...
## 相关页面
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/anthropic-ai-native-startup-handbook.md)
→ [Skill 写作基础指南](../ch04/555-agent-skill.md) — 与 Agent/Harness 工作流构建相关
→ [Skill 写作进阶指南](../ch04/555-agent-skill.md) — 更深入的实践方法
...
Cowork 是手册中最值得关注的工具形态——它是 Chat 和 Code 之间的中间态，专门针对"耗时的知识工作"。这与 [CLAUDE Code 100 条规则](../ch03/075-claude-code.md) 中倡导的"研究伙伴"角色高度一致。
...
## 相关实体
- [Claude Code Skills 实践与 Superpowers 利器推荐](ch01/503-claude-code-skills-superpowers.md)
