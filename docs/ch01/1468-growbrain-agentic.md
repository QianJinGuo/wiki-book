...
## Ch01.1468 淘宝内容生态：GrowBrain - 淘宝Agentic内容成长引擎
...
这两个问题在本质上反映了 Agent 架构设计中一个尚未被充分认知的原则：**LLM 的职责范围应当与其模型能力相匹配**。小模型的幻觉风险要求从「LLM 全程驱动」转向「框架精确控制 + LLM 在关键节点介入」。这与 [Agent 配置组合](../ch04/345-skill.html) 中「Skill 作为可控边界」的设计理念形成互文。
...
- [Agent 配置组合](../ch04/345-skill.html)
- [Agent Harness 上下文管理](../ch05/042-agent-harness.html)
- [Marvis 多智能体桌面助手](../ch03/095-marvis.html)
- [AgentCore Trip Allocation](../ch04/761-agentcore-harness.html)
