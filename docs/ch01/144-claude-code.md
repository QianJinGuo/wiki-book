...
- [深度拆解 Claude Code 12 个可复用的 Agentic Harness 设计模式](../ch03/049-claude-code-agent.html)
...
- [17种Agent架构演进：控制流设计的完整演化史](../ch04/456-17-agent.html)
...
- [AgentMemory](../ch09/016-agentmemory-coding-agent.html)
