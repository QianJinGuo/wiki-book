...
## Ch01.654 Hermes Agent v0.13 — /goal 目标管理与 Kanban 多 agent 协作
...
## 相关实体
- [Hermes Agent Kanban Deep Test](../ch03/095-hermes-agent.html)
- [Hermes Agent Goal Runtime Architecture](../ch04/380-hermes-agent-goal.html)
