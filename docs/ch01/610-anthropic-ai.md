...
## 相关页面
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/anthropic-ai-native-startup-handbook.md)
→ [Skill 写作基础指南](../ch04/612-agent-skill.html) — 与 Agent/Harness 工作流构建相关
→ [Skill 写作进阶指南](../ch04/612-agent-skill.html) — 更深入的实践方法
...
- [AI Agent工具数量陷阱——5个边界清楚的工具胜过20个模糊工具](../ch04/439-ai-agent.html)
