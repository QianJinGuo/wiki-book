...
## Ch01.1139 Reinforcing Recursive Language Models | alphaXiv
...
## 深度分析
**核心贡献：单策略统一训练 parent 和 child RLM**^[].md]
...
**Rubric-based Reward 优于 Verifiable Reward**^[].md]
