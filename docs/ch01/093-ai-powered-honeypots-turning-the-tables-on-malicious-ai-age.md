...
## Ch01.093 AI-powered honeypots: Turning the tables on malicious AI agents
...
### 系统提示词工程：欺骗的核心
System Prompt 是欺骗成功的关键。文中展示了两种角色模拟：^[].md]
...
## 实践启示
### 对于安全团队
**1. AI 蜜罐是应对 AI agent 威胁的经济选择**^[].md]
