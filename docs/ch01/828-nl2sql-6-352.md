...
## Ch01.828 高德 NL2SQL 知识工程：确定性路由 + 6 节知识卡片 + 352 表生产实践

> 📊 Level ⭐⭐ | 5.6KB | `entities/amap-nl2sql-knowledge-engineering-production.md`
...
```mermaid
mindmap
  root(("高德 NL2SQL 知识工程 确定性路由 6 节知识卡片 352"))
    架构演进 V1 V2
      V1 分域独立 Skill 瓶颈暴露
      V2 统一 Skill 确定性两级路由
    关键设计决策 确定性路由而非 RAG
...
- [Alibaba Data Rd Harness Engineering Nl2Sql](../ch05/120-harness-engineering.html) — 阿里数据研发 NL2SQL 的宏观 Harness Engineering 方法论（7 Agent + NL2DSL2SQL + 幻觉防控）。本文聚焦高德具体生产系统的**架构设计**和**知识工程方法论**，角度互补。
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/amap-nl2sql-knowledge-engineering-2026-07-22.md)
