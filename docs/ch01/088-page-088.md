...
- [Extending MCP support for Amazon Bedrock AgentCore Gateway](../ch11/108-extending-mcp-support-for-amazon-bedrock-agentcore-gateway.html) — MCP三原语统一+OAuth委托网关机制
