...
## Ch01.1493 Kimi K2.5 架构创新 — 1T MoE 一层路由 + 三能力跃迁
...
- [Kimi AttnRes](ch01/580-kimi.html) — Kimi 的 attention 残差机制
- [DeepSeek MoE](ch01/588-deepseek.html) — DeepSeek MoE 架构对比
...
- [MiMo Code](../ch05/114-harness-2026.html) — 类似的全开源策略对比
