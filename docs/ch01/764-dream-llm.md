...
## Ch01.764 DREAM：用冻结 LLM 的自回归预测训练稠密检索器，无需标注正负样本

> 📊 Level ⭐⭐ | 4.6KB | `entities/dream-dense-retrieval-autoregressive-modeling-challengehub-2026.md`
...
- [Agentic RL 六框架](ch03/044-agent.md) — Agentic search 的检索质量是关键瓶颈
