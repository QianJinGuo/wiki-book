...
## Ch01.635 Anthropic LLM ATT&CK Navigator: AI-Enabled Cyber Operations
...
本文与 [N-days Frontier Agent 研究](../ch04/405-anthropic-n-days-frontier-agent-vulnerability-research.html) 构成 Anthropic 2026-06 的**双联报告**：
...
→ 原文存档
- → [同 Anthropic 红队研究：前沿模型 N-day 利用能力](../ch04/405-anthropic-n-days-frontier-agent-vulnerability-research.html)
