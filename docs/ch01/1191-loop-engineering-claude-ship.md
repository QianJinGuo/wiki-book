...
## Ch01.1191 Loop Engineering 半年实战拆解：claude-ship 开源自进化开发系统
...
- [从 SDD 到 Lattice Harness](../ch05/112-ai-coding.html) — 另一团队级 AI Coding 闭环实践
- [《Loop Engineering橙皮书》](ch01/926-20.html) — Loop Engineering 概念框架
