...
- [Agentic Systems Extreme Co-Design（NVIDIA 极简协同设计）](../ch04/073-agentic.html)
- [Agentic AI 系统架构与分层模型](../ch05/105-harness-skill.html)
- [当 OpenClaw 学会"团队记忆"：一个面向多客户服务的企业级共享记忆系统设计 | 亚马逊AWS官方博客](../ch11/253-openclaw.html)
- [快时尚电商行业智能体设计思路与应用实践（八）基于 WebSocket 的语音系统：Nova 2 Sonic, AgentCore, Strands Agents 企业级架构实践 | 亚马逊AWS官方博客](../ch03/037-agent.html)
