...
## Ch01.130 Useful Memories Become Faulty When Continuously Updated by LLMs

> 📊 Level ⭐ | 4.8KB | `entities/useful-memories-become-faulty-when-continuously-updated-by-llms.md`
...
**3. Episodic-Only 打败了所有 Consolidator**^[].md]
...
**4. 这项研究与 Cognitive Science 的关联**^[].md]
