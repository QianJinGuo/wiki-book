...
## Ch01.997 别再幻想用 Spec 替代写代码

> 📊 Level ⭐⭐ | 4.1KB | `entities/别再幻想用-spec-替代写代码.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/别再幻想用-spec-替代写代码.md)
