...
## Ch01.1066 SenseNova-U1 — 商汤原生统一多模态模型
...
## 相关技术
- [DeepSeek Visual Primitives](https://github.com/QianJinGuo/wiki/blob/main/entities/deepseek-visual-primitives.md) — 视觉原语作为思考媒介（同期多模态前沿）
