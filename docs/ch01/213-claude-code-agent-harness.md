...
## Ch01.213 深入理解 Claude Code 源码中的 Agent Harness 构建之道
...
- [Claude Code 深度解析](../ch05/070-claude-code-harness.html) — Claude Code 架构的另一次深度解读
...
- [OpenClaw 完整指南](../ch11/227-openclaw.html) — 开源对应物（Worktree 隔离模式实现）
- [Harness Engineering 一文](../ch05/116-harness-engineering.html) — Harness 概念的系统阐释
