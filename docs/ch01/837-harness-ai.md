...
## Ch01.837 harness技术手册-AI 记忆的两种范式：从向量检索到上下文积累

> 📊 Level ⭐⭐ | 5.5KB | `entities/harness技术手册-ai-记忆的两种范式从向量检索到上下文积累.md`
...
```mermaid
mindmap
  root(("harness技术手册-AI 记忆的两种范式：从向量检索…"))
    阵营 1：记忆后端的技术谱系
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/harness技术手册-ai-记忆的两种范式从向量检索到上下文积累.md)
