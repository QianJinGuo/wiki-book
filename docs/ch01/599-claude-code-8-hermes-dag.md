...
## Ch01.599 Claude Code 动态工作流 8 译本（行小招译注 + Hermes DAG 对比）
...
- [Claude Code Harness Deep Understanding](ch01/426-claude-code-harness-deep-understanding.html) — Claude Code harness 深度解析
- [Claude Code Harness Deep Dive Founder Park](../ch05/070-claude-code-harness.html) — Founder Park 的 Claude Code harness 深度文章
