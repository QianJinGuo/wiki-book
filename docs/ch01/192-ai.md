...
本页作为知识图谱锚点，连接了以下关键实体：[要实现一个工作流选择-agent-skills-还是-ai-表格](../ch04/404-agent-skills.html)。 相关主题通过 [钉钉 Stream + CLI 代理双引擎 AI 助手架构](../ch05/091-ai.html) 延伸。
...
- [ScarfBench: Benchmarking AI Agents for Enterprise Java Framework Migration](../ch04/402-ai-agent.html)
