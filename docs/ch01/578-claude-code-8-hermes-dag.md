...
## Ch01.578 Claude Code 动态工作流 8 译本（行小招译注 + Hermes DAG 对比）
...
- [Claude Code Harness Deep Dive Founder Park](../ch05/060-claude-code-harness.html) — Founder Park 的 Claude Code harness 深度文章
