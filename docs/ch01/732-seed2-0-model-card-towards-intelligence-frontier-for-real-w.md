...
- [ByteDance Trae Harness 工程指南](ch01/882-trae-harness-engineering.html) — ByteDance 相关工程实践
- [Agent-World](../ch04/045-agent-world.html) — Agent 训练环境扩展，提及 Seed2.0 作为对比基线
