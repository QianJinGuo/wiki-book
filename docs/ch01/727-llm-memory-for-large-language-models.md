...
## Ch01.727 LLM 记忆架构三维分类体系（清华《Memory for Large Language Models》综述）
...
- 与 [三种 Agent Memory 方案对比实验](../ch06/045-memory.html)（MSA/D2L/RAG 实证）互补：那是 agent 级记忆方案选型，本文是 model-level 架构分类
