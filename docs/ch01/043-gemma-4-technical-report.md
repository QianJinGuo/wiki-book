...
## Ch01.043 Gemma 4 Technical Report
...
- [DeepSeek V4](ch01/318-deepseek-v4.html) — 同期 MoE 开源模型竞品
- [Kimi K2.5](ch01/951-20.html) — 同期视觉智能开源模型
...
- [Claude Opus 4.7](ch01/1132-claude.html) — 闭源竞品参考
