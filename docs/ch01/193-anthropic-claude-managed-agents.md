...
## Ch01.193 Anthropic Claude Managed Agents 平台正式发布
...
- [Anthropic 长时运行 Agent 架构：对抗式设计 + 合同谈判 + 审美量化](ch04/503-agent.md) — 另一篇技术解读，覆盖 API 细节和定价
- [Anthropic PM 的 Agentic 工作流](ch04/503-agent.md) — 同一时期 Jess Yan 的 PM 视角，同一产品不同维度
...
- [Multica — 开源 Managed Agents 平台](ch07/050-multica-managed-agents.md)
- [claude managed agents official](ch04/464-claude-managed-agents-official.md)
