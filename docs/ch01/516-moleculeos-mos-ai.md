...
## Ch01.516 MoleculeOS（MOS）——许锦波团队AI原生生物经济操作系统
...
```mermaid
mindmap
  root(("MoleculeOS MOS 许锦波团队AI原生生物经济操作系统"))
    平台能力
    从「工具栈人工调度」到「系统智能」的范式转换
    研发意图作为系统入口的设计哲学
    自研模型集群的底层能力闭环
    知识沉淀与研发资产化
```
...
MoleculeOS 代表第二代"系统智能"范式：以"研发意图"为入口（例如"提升这个抗体的亲和力"），AI自主理解生物学意图，自动拆解任务、调度系列模型、执行预测与设计、多维度评估并给出决策建议。核心差异在于：第一代用 AI 增强单点环节，第二代用 AI 组织完整流程。这种转换与 [Harness Engineering](https://github.com/QianJinGuo/wiki/blob/main/concepts/harness-engineering-framework.md) 框架中的"流程编排优于节点优化"理念一致——系统的整体效率瓶颈往往不在单个模型的质量，在于模型之间的衔接与调度效率。
...
- [MiniMax M2.5 部署指南](../ch11/295-amazon-bedrock.html)
- [Harness Engineering](https://github.com/QianJinGuo/wiki/blob/main/concepts/harness-engineering-framework.md)
- [Gemma 4 端侧大模型](ch01/622-gemma-4.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/ai生物研发进入操作系统时代许锦波团队moleculeos正式开放.md)
