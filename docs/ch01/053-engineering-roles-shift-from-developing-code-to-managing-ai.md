...
## Ch01.053 Engineering roles shift from developing code to managing AI

> 📊 Level ⭐ | 8.4KB | `entities/engineering-roles-shift-from-developing-code-to-ma.md`
...
- [DeepMind AI Pointer — 交互范式变革](../ch05/109-ai.html)
