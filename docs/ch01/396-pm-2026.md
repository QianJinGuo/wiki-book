...
## Ch01.396 谷歌PM公开：2026开发者五大新技能——问题塑形/上下文设计/审美/编排/判断力

> 📊 Level ⭐⭐ | 10.4KB | `entities/google-pm-2026-five-developer-skills-shubham.md`

> -> [谷歌PM公开：2026开发者五大新技能——问题塑形/上下文设计/审美/编排/判断力](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/google-pm-2026-five-developer-skills-shubham.md)
...
```mermaid
mindmap
  root(("谷歌PM公开 2026开发者五大新技能问题塑形上下文设计审美编排判断力"))
    背景数据
    被商品化的四项旧技能
    五种新技能
      问题塑形 Problem Shaping
      上下文设计 Context Curation
      审美 Taste
    培养方法
    结论
    2026 开发者的五项核心技能
...
## 相关主题
- [Agent Orchestration](../ch04/518-agent-orchestration.html) — Agent 编排模式（AWS Step Functions 控制平面）
- [Claude Code Governance Soft Rules](../ch03/078-claude-code.html) — Claude Code 可控性设计
- [Openai Skills Shell Compaction Agent Primitives](../ch05/025-openai-skills-shell-compaction-agent.html) — OpenAI Skills/Shell/Compaction 三位一体
