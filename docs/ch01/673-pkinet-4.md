...
## Ch01.673 破解遥感目标的形状与尺度难题，PKINet二代推理提速近4倍！

> 📊 Level ⭐⭐ | 6.7KB | `entities/破解遥感目标的形状与尺度难题pkinet二代推理提速近4倍.md`
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/破解遥感目标的形状与尺度难题pkinet二代推理提速近4倍.md)
