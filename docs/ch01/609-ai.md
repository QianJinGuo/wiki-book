...
- [后端系统 AI Friendly 设计](ch05/094-ai.html) — 阿里技术同系列前作，讨论后端系统如何 AI Friendly 化
- [Agent Harness Engineering](ch03/035-agent.html) — Harness Engineering 作为 Agentic Engineering 的具体落地
