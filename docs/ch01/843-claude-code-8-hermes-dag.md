...
## Ch01.843 Claude Code 动态工作流 8 译本（行小招译注 + Hermes DAG 对比）
...
- [深入理解 Claude Code 源码中的 Agent Harness 构建之道](../ch05/066-agent-harness.html) — Claude Code 中的 agent harness 构建
