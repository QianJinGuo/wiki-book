...
## Ch01.619 NVIDIA Agent Toolkit + Omniverse
...
这实际上是对 [NVIDIA Agentic Systems](../ch04/074-agentic.html) 中"极端协同设计"理念的具体化——智能体不仅是辅助设计的工具，更是仿真环境的构建者和验证者。
...
这意味着物理 AI 开发的瓶颈将从"谁来做仿真"变为"谁定义仿真需求"——与 [Harness Engineering 范式](../ch05/126-harness-engineering.html) 中讨论的从"手动编排"到"意图驱动"的转变一致。
...
- [NVIDIA Agentic Systems 极端协同设计](../ch04/074-agentic.html)
...
- [NVIDIA BioNeMo Agent Toolkit](../ch04/012-nvidia-bionemo-agent-toolkit.html)
- [NVIDIA Nemotron-3 多模态 Agent](../ch04/074-agentic.html)
- [Harness Engineering 范式](../ch05/126-harness-engineering.html)
- Bedrock AgentCore 质量优化飞轮
- [NVIDIA ENPIRE 机器人策略自改进](../ch04/074-agentic.html)
