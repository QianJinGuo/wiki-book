...
## Ch01.1295 Reducing Doom Loops with Final Token Preference Optimization
...
- [LFM — Liquid Foundation Model](../ch05/090-ai.html) — Liquid AI 的基础模型系列
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/antidoom.md)
