...
> 📊 Level ⭐⭐⭐ | 7.1KB | `entities/kimi-k2-5-architecture-innovation-moonshot-2026.md`
...
→ [原文存档](https://mp.weixin.qq.com/s/-LlryKjaW1jS_UouZwAU7Q)

## 相关实体

- [Kimi K2.6 Agent Database](https://github.com/QianJinGuo/wiki-public/blob/main/entities/kimi-k2-6-tidb-agent-database.md) — K2.6 的 TiDB Cloud 基础设施实践
- [Kimi AttnRes](https://github.com/QianJinGuo/wiki-public/blob/main/entities/kimi-attention-residuals-prenorm-dilution-block-attnres.md) — Kimi 的 attention 残差机制
- [DeepSeek MoE](https://github.com/QianJinGuo/wiki-public/blob/main/entities/deepseek-moe-parallel-strategy.md) — DeepSeek MoE 架构对比
- [openJiuwen Swarm](https://github.com/QianJinGuo/wiki-public/blob/main/entities/jiuwenswarm-coordination-engineering.md) — Kimi 关联的开源 harness
- [MiMo Code](https://github.com/QianJinGuo/wiki-public/blob/main/entities/mimo-code-xiaomi-coding-harness-2026.md) — 类似的全开源策略对比
