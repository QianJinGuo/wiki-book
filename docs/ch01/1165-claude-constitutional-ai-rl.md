...
→ 相关实体：[Anthropic LLM 内省意识机制](../ch04/164-anthropic-llm.md)
...
- → [Anthropic LLM 内省意识](../ch04/164-anthropic-llm.md)：Anthropic 的安全研究能力维度
- → [Building Next Claude](ch01/846-anthropic.md)：Claude 的产品演进方向
- → [Harness Engineering 范式](../ch05/062-harness-engineering.md)：代码能力在 Agent 场景的价值
