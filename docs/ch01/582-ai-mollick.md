...
## Ch01.582 给 AI 做工作面试：Mollick 的模型评估方法论
...
- [Opinionated Guide Ai Right Now Mollick](https://github.com/QianJinGuo/wiki/blob/main/entities/opinionated-guide-ai-right-now-mollick.md) — 模型选择实用指南（同一作者，同期不同议题）
