...
- **交叉引用**：与 [OpenClaw Prompt/Context/Harness](../ch11/232-openclaw.html)、[Claude Code Prompt/Context/Harness](../ch09/060-claude-code-prompt.html)、[Hermes Agent 深度解析](../ch03/093-hermes-agent.html) 互为补充
...
- [claude dispatch + 接口力量：ai 从 chatbot 到 agent interface 的转变](ch01/429-claude.html)
