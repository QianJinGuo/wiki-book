...
## Ch01.176 iii-dev-worker-trigger-function
...
- [Anthropic 12 Mcp Production Patterns](ch01/692-anthropic.md)
...
- [Anthropic Long Running Agent Architecture 6H Retroforge](ch04/503-agent.md)
