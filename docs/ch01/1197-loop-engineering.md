...
## Ch01.1197 中金 Loop Engineering 自动化因子发现引擎
...
- [阿里云 Loop 实战（日志扫描→预发部署）](../ch05/006-loop-engineering.html) — Loop 在 devops 场景的应用；本实体是量化金融场景
- [Loop Engineering 四层框架](../ch05/006-loop-engineering.html) — 另一 Loop 落地框架
