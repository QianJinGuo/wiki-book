...
## Ch01.027 Robostral Navigate: single-camera AI navigation | Mistral AI

> 📊 Level ⭐ | 9.2KB | `entities/robostral-navigate.md`
...
- [Mistral AI](../ch05/107-ai.html) — 开发团队
...
- [Milvus](ch01/1129-20.html) — 向量检索（对比：Robostral 是空间导航）
