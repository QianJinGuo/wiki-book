...
- **交叉引用**：与 [OpenClaw Prompt/Context/Harness](../ch11/251-openclaw.html)、[Claude Code Prompt/Context/Harness](../ch09/070-claude-code-prompt.html)、[Hermes Agent 深度解析](../ch03/098-hermes-agent.html) 互为补充
