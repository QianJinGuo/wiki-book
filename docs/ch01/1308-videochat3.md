...
## Ch01.1308 打通感知-理解-交互链路，全栈视频理解大模型VideoChat3开源了
...
- [Shotstream Streaming Multi Shot Video Cuhk Kling Eccv2026](ch01/906-20.html) — 流式视频生成（与 VideoChat3 的流式视频理解互补）
...
- [Liteframeefficientvisionencodersunlockframescalinginvideollms](ch01/553-scaling.html) — 高效视觉编码器与视频 LLM 帧缩放
