...
## Ch01.711 AI-powered BI with Snowflake and Amazon QuickSight
...
- **[SchemaFlow](https://github.com/QianJinGuo/wiki-public/blob/main/entities/schemaflow-agentic-database-sql-generation-openai-cookbook.md)**：Agent 驱动的数据库 SQL 生成，同样需要语义约束
- **[Data-Native Agents](../ch04/284-how-to-build-agents-where-data-already-lives.html)**：Agent 直接在数据平台上运行，语义层是关键基础设施
...
- [Snowflake Agentic Enterprise](https://github.com/QianJinGuo/wiki-public/blob/main/entities/snowflake-agentic-enterprise-summit-2026.md) — Snowflake 的 Agent 平台愿景
- [SchemaFlow](https://github.com/QianJinGuo/wiki-public/blob/main/entities/schemaflow-agentic-database-sql-generation-openai-cookbook.md) — Agent 驱动的 SQL 生成
