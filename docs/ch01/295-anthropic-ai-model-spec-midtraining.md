...
## Ch01.295 Anthropic 最新论文：阻止 AI 叛变的方法（Model Spec Midtraining）
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/anthropic-msm-anti-defection-paper.md)
