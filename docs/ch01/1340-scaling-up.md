...
## Ch01.1340 淘宝闪购爆品团精排 Scaling Up 迭代实践
...
```mermaid
mindmap
  root(("淘宝闪购爆品团精排 Scaling Up 迭代实践"))
    背景与动机
    架构设计
    结构消融关键结论
      负采样
...
- [OneReason：快手 Reasoning Recommender System 实践](../ch05/094-ai.html) — 快手的推理型推荐系统，与淘宝 Token-Based RankMixer 分别探索推荐模型的不同演进方向
