...
## Ch01.763 面向 LLM 的架构设计：什么是真正的 AI Friendly 架构？
...
- [how to build an ai-native startup](ch04/277-ai.md)
- [百型智能 ontoz：企业本体论 + 群智能体协同体系，新一代企业级 ai 基础设施](ch04/277-ai.md)
- [从零构建大语言模型 —— 读完这篇你就懂了](ch01/1171-llm.md)
...
- [垂类 ai 创企的自救：flashlabs 从 flashintel 到 ai native](ch04/277-ai.md)
...
- [perplexity 首次公开了内部 skill 设计指南](ch04/255-skill.md)
...
- [我把 claude design 做成了 skill，人人都能成为顶级网站设计师](ch04/255-skill.md)
