...
## Ch01.1312 Latest open artifacts (#20): New orgs! New types of models! With Nemotron Super, Sarvam, Cohere Transcribe, & others
...
- [interconnects ai p open and closed models are on different](../ch05/104-ai.html)
- [reducing container cold start times using soci index on dlam](ch01/1406-reducing-container-cold-start-times-using-soci-index-on-dlam.html)
- [state of routing in model serving](../ch11/204-state-of-routing-in-model-serving.html)
- [the distillation panic](ch01/482-the-distillation-panic.html)
