...
## Ch01.688 明星开源项目，为什么开始离开 GitHub？
...
## 相关实体
- [Microsoft Copilot Studio Agent Governance](ch04/503-agent.md)
- [Microsoft Mxc Execution Containers Agent Sandbox Origin](ch04/310-ai.md)
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/open-source-projects-leaving-github.md)- [github multilingual repositories dataset — 4000 万仓库多语言元数据](ch01/676-github.md)
