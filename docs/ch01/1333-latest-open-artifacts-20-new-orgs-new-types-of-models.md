...
## Ch01.1333 Latest open artifacts (#20): New orgs! New types of models! With Nemotron Super, Sarvam, Cohere Transcribe, & others
...
- [interconnects ai p open and closed models are on different](../ch05/111-ai.html)
- [reducing container cold start times using soci index on dlam](ch01/1428-reducing-container-cold-start-times-using-soci-index-on-dlam.html)
- [state of routing in model serving](../ch11/206-state-of-routing-in-model-serving.html)
- [the distillation panic](ch01/882-the-distillation-panic.html)
