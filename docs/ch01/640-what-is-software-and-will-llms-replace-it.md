...
## Ch01.640 What Is Software, and Will LLMs Replace It?
...
这与 [Anthropic 数据分析](ch01/963-anthropic.html) 的实践相呼应——即使 LLM 能生成分析，数据的结构化组织仍然是前提。
...
- [本文实体](ch01/610-llm.html) — Tomassetti 的分析
- [AI Agent Hype](../ch04/349-ai-agent.html) — 对 AI agent 过度炒作的冷静分析
