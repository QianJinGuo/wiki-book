...
## Ch01.1003 Red-Teaming after Mythos — Zico Kolter & Matt Fredrikson, Gray Swan

> 📊 Level ⭐⭐⭐⭐ | 6.3KB | `entities/latent-space-p-gray-swan.md`
...
这与 [Role Confusion](ch01/690-github.md) 研究形成互补——后者提供理论框架（prompt injection 本质是角色混淆），Gray Swan 提供实战工具和方法论。
...
- [Role Confusion](ch01/690-github.md) — Prompt injection 的理论框架
...
- [Claude Tag](ch01/910-introducing-claude-tag.md) — Anthropic 的 agent 安全实践
- [OpenClaw](ch01/850-openclaw-boris-cherny-agent-loop-design-patterns.md) — 计算机使用 agent 的安全挑战
