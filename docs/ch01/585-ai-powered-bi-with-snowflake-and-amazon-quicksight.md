...
- **[SchemaFlow](../ch04/612-agentic.html)**：Agent 驱动的数据库 SQL 生成，同样需要语义约束
...
- [Snowflake Agentic Enterprise](../ch04/612-agentic.html) — Snowflake 的 Agent 平台愿景
- [SchemaFlow](../ch04/612-agentic.html) — Agent 驱动的 SQL 生成
