...
## Ch01.585 AI-powered BI with Snowflake and Amazon QuickSight
...
- **[SchemaFlow](../ch04/610-agentic.html)**：Agent 驱动的数据库 SQL 生成，同样需要语义约束
...
- [Snowflake Agentic Enterprise](../ch04/610-agentic.html) — Snowflake 的 Agent 平台愿景
- [SchemaFlow](../ch04/610-agentic.html) — Agent 驱动的 SQL 生成
- [Anthropic Data Analysis](ch01/1291-anthropic.html) — LLM 数据分析的另一个视角
