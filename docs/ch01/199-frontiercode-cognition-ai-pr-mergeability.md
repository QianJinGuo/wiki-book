...
- [ProgramBench](../ch04/138-programbench-agent-benchmark.html) — 程序化编码基准 (与 FrontierCode 的 maintainer-rubric 范式对比)
- [Claude Code Performance Benchmarking](../ch03/057-claude-code.html) — 单 agent 性能基准
