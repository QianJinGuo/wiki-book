...
## Ch01.1296 Owner-Worker-Verifier 架构
...
## 参考
- [Minimax Agent Team Mavis](../ch04/149-ai-minimax-agent-team-mavis.html)

## 相关实体
- [Scalable voice agent design with Amazon Nova Sonic: multi-agent, tools, and session segmentation](../ch11/298-amazon-nova.html)
