...
## Ch01.1105 Consistency, But in Excellence Not Appearance
...
这与 [文档组织](../ch05/113-ai.html) 的讨论有深层共鸣：树状结构（文件夹、分类法）是存储机制而非知识架构；同样，design system 的规则是一致性机制而非卓越机制。
...
- [文档组织: 为人类和 AI](../ch05/113-ai.html) — 系统化结构 vs 知识发现
