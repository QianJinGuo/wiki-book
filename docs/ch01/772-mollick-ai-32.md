...
## Ch01.772 Mollick AI 进展的 32 只水獭基准
...
- `[Jagged Ai Frontier Mollick](../ch05/111-ai.html)` — Mollick 锯齿前沿理论（实体待建）
- `[Mass Intelligence](ch01/746-mass-intelligence-ai.html)` — 群体智能边界（实体待建）
