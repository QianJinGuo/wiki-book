...
## Ch01.241 nanobot：4000行极简 Agent 框架架构解析
...
参见 [working set 管理](../ch05/057-agent-harness.html)。这种模式的代价是**额外的 tool call 延迟**——但对长寿命 Agent 而言，延迟的代价远小于 context 污染的代价。
...
- [Agent Harness Context Management Working Set](../ch05/057-agent-harness.html) — Progressive Loading 与 working set 管理理论
- [Loop Engineering Addy Osmani Challengehub](../ch05/004-loop-engineering.html) — ReAct 循环工程化的另一视角
- [Codex Major Update Appshots Goal Xinzhiyuan](ch01/518-codex.html) — Codex 同样采用单循环 + 长寿命任务设计
