...
## 相关主题
- [Agent Orchestration](../ch04/464-agent-orchestration.md) — Agent 编排模式（AWS Step Functions 控制平面）
- [Claude Code Governance Soft Rules](../ch03/075-claude-code.md) — Claude Code 可控性设计
- [Openai Skills Shell Compaction Agent Primitives](../ch05/024-openai-skills-shell-compaction-agent.md) — OpenAI Skills/Shell/Compaction 三位一体
