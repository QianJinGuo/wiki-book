...
> 来源：[原文存档](https://pytorch.org/blog/pytorch-2-12-release-blog/)
...
## 相关实体
- [Pytorch 2 12 Release](https://github.com/QianJinGuo/wiki-public/blob/main/entities/pytorch-2-12-release.md) — 同一博客的平行存档

- [profiling in pytorch (part 2): from nn.linear to a fused mlp](https://github.com/QianJinGuo/wiki-public/blob/main/entities/huggingface-torch-mlp-fusion-profiling-2026.md)
