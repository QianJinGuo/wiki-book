...
## Ch01.735 如何利用 AgentCore + OpenViking 快速搭建具备高效记忆的 Agent
...
OpenViking 的渐进加载机制提供了优雅解决：高分记忆读全文、低分记忆只给 URI（type="link"），LLM 在需要时通过工具调用深读。这与 [Agent 记忆模块化框架](ch03/035-agent.html) 的理念一致——在有限的 Context 预算下做最优信息分配。
...
- [AI Agent 记忆系统](ch05/094-ai.html)
- [Hermes Agent 记忆系统](ch03/095-hermes-agent.html)
- [Agent 记忆模块化框架](ch03/035-agent.html)
- [Agent 记忆架构](ch03/035-agent.html)
- [Amazon Bedrock AgentCore MCP 扩展](ch03/035-agent.html)
