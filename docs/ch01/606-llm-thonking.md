...
## Ch01.606 LLM Thonking：推理努力与安全分诊效果的实证研究
...
- [gzip 作为语言模型](ch01/637-gzip.md) — 压缩视角下的推理成本分析
- [Anthropic LLM ATT&CK 导航](ch01/1171-llm.md) — LLM 在安全领域的另一应用
- [LLM RL 算法综述](ch01/216-0.md) — 推理努力与 RL 训练的关系
- [腾讯 Token 经济学](ch04/277-ai.md) — Token 成本优化的另一视角
