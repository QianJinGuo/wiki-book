...
## Ch01.1418 UniWorld-View：登顶 WorldScore 的世界模型（单图/视频新视角合成）
...
UniWorld-View 属**几何约束的生成式世界模型**路线，与以下既有 entity 互补：[李飞飞 masked-visual-actions 世界模型](ch01/1135-20.html)、[LoopWM 循环世界模型](https://github.com/QianJinGuo/wiki/blob/main/entities/loopwm-looped-world-models.md)、[高德 3D 原生城市世界模型](ch01/1302-3d.html)、[LeCun JEPA 世界模型](ch01/1588-lecun.html)。它聚焦的是「视频/图像的空间外推」（novel view），而非动作预测或城市级重建，填补了 wiki 在**新视角合成世界模型**子领域的空白。
