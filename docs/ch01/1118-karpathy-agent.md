...
## Ch01.1118 Karpathy最新开喷：一句话让全场Agent开发者安静了

> 📊 Level ⭐⭐ | 2.4KB | `entities/karpathy最新开喷一句话让全场agent开发者安静了.md`
...
**当前****AI****领域最大的错误，就是人们急着逼Agent干活，却根本没先把底层的大模型搞明白。**
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/karpathy最新开喷一句话让全场agent开发者安静了.md)
