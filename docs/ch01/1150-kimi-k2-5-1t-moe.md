...
## Ch01.1150 Kimi K2.5 架构创新 — 1T MoE 一层路由 + 三能力跃迁
...
- [Kimi K2.6 Agent Database](../ch03/045-agent.md) — K2.6 的 TiDB Cloud 基础设施实践
...
- [DeepSeek MoE](ch01/1125-deepseek.md) — DeepSeek MoE 架构对比
...
- [MiMo Code](../ch05/076-harness-2026.md) — 类似的全开源策略对比
