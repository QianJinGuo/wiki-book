...
## Ch01.880 Claude 做方案，Codex 写代码：多模型协作怎么交接才稳
...
- [Codex 5 Layer Architecture](ch01/738-codex.html) — Codex 的架构设计
...
- [Harness 之后 状态边界与失败闭环 若飞](../ch05/080-harness.html) — Harness 工程中的状态与边界管理
- [Harness Engineering](../ch05/096-harness-engineering.html) — Harness Engineering 总体概念
