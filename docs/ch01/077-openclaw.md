...
> 📊 Level ⭐ | 5.7KB | `entities/龙虾装上了可以用来干啥分享下我的-openclaw-多智能体团队搭建经验-v2.md`
...
- [大模型可控新突破：Steering 机制、评估体系与开源落地](https://github.com/QianJinGuo/wiki-public/blob/main/entities/steering-mechanism-evaluation-easyedit2-zju-alibaba.md) — steering机理与评估框架
...
- 同题异语种孪生页：[Openclaw Multi Agent Team Practice](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openclaw-multi-agent-team-practice.md)（归并候选，提案卡 #11 批1）
