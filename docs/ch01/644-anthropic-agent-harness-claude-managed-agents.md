...
> -> 原文存档
从微信文章 Anthropic 官方 Agent Harness 平台：Claude Managed Agents 完整指南 提取。
...
- [claude managed agents](../ch04/095-claude-managed-agents.html)
- [Claude Managed Agents 开发者指南](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-managed-agents-developer-guide.md)
