...
## Ch01.862 harness技术手册-会话管理与百万级上下文实战启示

> 📊 Level ⭐⭐ | 5.4KB | `entities/harness技术手册-会话管理与百万级上下文实战启示.md`
...
```mermaid
mindmap
  root(("harness技术手册-会话管理与百万级上下文实战启示"))
    百万上下文窗口的双面性
    上下文、压缩与上下文旋转基础
    每个对话回合都是分支决策点
    何时开启新会话
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/harness技术手册-会话管理与百万级上下文实战启示.md)
