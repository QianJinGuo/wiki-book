...
- [Agentium — 从零实现 Agent 系统的开源框架](ch01/1211-agentium-agent.html)
- [17种Agent架构演进：控制流设计的完整演化史](../ch04/657-17-agent.html)
- [Owner-Worker-Verifier 架构](ch01/1253-owner-worker-verifier.html)
- [Hermes-Agent Kanban 实测 — 商业 CLI 作为上层 Orchestrator](../ch03/091-hermes-agent.html)
