...
## Ch01.840 DREAM：用冻结 LLM 的自回归预测训练稠密检索器，无需标注正负样本
...
- [Agentic RL 六框架](https://github.com/QianJinGuo/wiki/blob/main/entities/agentic-rl-frameworks-practices-long-horizon-wolfe-2026.md) — Agentic search 的检索质量是关键瓶颈
