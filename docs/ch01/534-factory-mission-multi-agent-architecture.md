...
## 相关框架对比
- **[DeerFlow vs Hermes vs OpenClaw](https://github.com/QianJinGuo/wiki-public/blob/main/entities/deerflow-hermes-openclaw-comparison.md)** — 都是 multi-agent 编排框架，与 Mission 的三角架构有相通之处
