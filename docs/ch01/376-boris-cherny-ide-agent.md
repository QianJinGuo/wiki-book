...
## Ch01.376 Boris Cherny 新访谈：开发工具正在从 IDE 变成 Agent 控制台
...
这与 [Harness Engineering Core Patterns](../ch05/112-harness-engineering.html) 中"控制面应当外置给人类"的工程原则一致——Human-in-the-Loop 不是降级方案，而是 Agent 系统设计的核心约束。
