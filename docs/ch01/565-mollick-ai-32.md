...
## Ch01.565 Mollick AI 进展的 32 只水獭基准
...
- `[Oneusefulthing Claude Code What Comes Next](../ch03/076-claude-code.html)` — Mollick 早期对 Claude Code 实战评估（实体待建）
...
- `[Jagged Ai Frontier Mollick](../ch05/086-ai.html)` — Mollick 锯齿前沿理论（实体待建）
- `[Mass Intelligence](ch01/538-mass-intelligence-ai.html)` — 群体智能边界（实体待建）

## 相关实体

- [fusedash -  generative analytics platform | ai dashboard sof](ch01/367-fusedash-generative-analytics-platform-ai-dashboard-sof.html)
