...
- [Claude Code Prompt/Context/Harness](ch03/084-claude-code.html) — 三层工程视角
- [Prompt Caching 工程实践](ch01/405-anthropic-prompt-caching-claude-code.html) — 与 microCompact 相关
- [Agent Harness 12 组件](ch03/035-agent.html) — Harness 通用框架
- [Claude Code Subagent 上下文卫生](ch03/084-claude-code.html) — Sub-Agent 设计
- [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/claude-code-source-deep-dive-warrior.md)
