...
## Ch01.317 Claude Code 之父最新访谈：编程已经结束、harness 将消失、Claude Code 将只有 100 行代码、loop 才是未来
...
- [RAG深度解析：分块、向量化、召回、重排，才是"蒸馏同事skill"的关键](ch04/255-skill.md)
...
- [LoongSuite GenAI 可观测语义规范](ch04/277-ai.md)
- [低代码 Agent、框架 Agent、自研 Agent 决策框架](ch03/045-agent.md)
- [三器合一：gstack + Superpowers + OpenSpec 工程化 AI 编程实战](ch04/277-ai.md)
