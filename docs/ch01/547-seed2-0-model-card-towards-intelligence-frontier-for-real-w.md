...
## Ch01.547 Seed2.0 Model Card: Towards Intelligence Frontier for Real-World Complexity
...
- [Agent-World](../ch04/703-agent-world.html) — Agent 训练环境扩展，提及 Seed2.0 作为对比基线
