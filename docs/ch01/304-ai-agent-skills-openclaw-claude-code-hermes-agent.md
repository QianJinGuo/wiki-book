...
## Ch01.304 AI Agent 架构设计（七）：Skills 系统设计（OpenClaw、Claude Code、Hermes Agent 对比）
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/skill-system-design-three-way-comparison.md)
