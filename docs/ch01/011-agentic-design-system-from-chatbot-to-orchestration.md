...
## Ch01.011 Agentic Design System - From Chatbot to Orchestration
...
## 相关实体
- [Extreme Co-Design for Agentic Systems Complexity (NVIDIA)](../ch04/051-nvidia-extreme-co-design-agentic-systems.html)
- [Agentic Systems Extreme Co-Design（NVIDIA 极简协同设计）](../ch04/236-agentic.html)
- [Agentic AI 系统架构与分层模型](../ch05/077-harness-skill.html)
