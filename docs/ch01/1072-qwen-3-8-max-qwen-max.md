...
## Ch01.1072 Qwen 3.8-Max：首个开源权重的 Qwen-Max 级模型
...
- [Kimi K3: The Open-Weights Escalation](ch01/714-kimi-k3-the-open-weights-escalation.html) — 开源权重升级竞赛背景
- [Open models recap](ch01/228-kimi-k3.html) — 社区对 Qwen 3.8 的早期观察
