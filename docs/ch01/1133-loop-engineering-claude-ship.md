...
## Ch01.1133 Loop Engineering 半年实战拆解：claude-ship 开源自进化开发系统
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/loop-engineering-6-month-practice-claude-ship-peakstone.md)
...
- [从 SDD 到 Lattice Harness](../ch05/101-ai-coding.html) — 另一团队级 AI Coding 闭环实践
- [《Loop Engineering橙皮书》](ch01/1005-20.html) — Loop Engineering 概念框架
- [Agent Loop 工程手册 8 个未解问题](../ch05/007-loop-engineering.html) — 腾讯云陈进 Loop Engineering 解读
