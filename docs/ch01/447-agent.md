...
## 相关实体
- [民生银行基于规格驱动开发（SDD）的 CodeAgent 私域研发探索与实践](../ch03/004-agent.html)
...
- [Harness Engineering：耗时一周，我是如何将应用的AI Coding率提升至90%的](../ch05/026-harness-engineering.html)

- [两万字详解Claude Code源码核心机制](../ch03/057-claude-code.html)
- [Agent 开发范式演进：从环境工程出发，“简化”多源实时上下文](../ch03/004-agent.html)
- [Anthropic 联创：2028 年实现 AI 自我构建的概率超过 60%](../ch04/052-ai.html)
...
- [2 小时，0 行手写代码，我用 Claude 做了一个生产级 VSCode 插件](310-claude.html)
