...
Meta 与 Hugging Face 合作发布 Muse Glimmer（30B 级），定位**本地规模、可编码、多模态**的开放权重模型——"a local scale personal assistant that can code"。与 [Muse Spark 1.1](../ch04/712-11-agent.html) 系列互补：Spark 主打云端强推理，Glimmer 主打单卡可跑的本地 Agentic 能力。
