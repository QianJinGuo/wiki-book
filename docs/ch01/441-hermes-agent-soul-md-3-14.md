...
## Ch01.441 Hermes Agent SOUL.md：3 层提示词、14 个内置人格，从源码看身份定制的完整设计

> 📊 Level ⭐⭐ | 9.1KB | `entities/hermes-agent-soul-md-personality-shugex.md`
...
这与 [Claude Code 源码分析](ch03/074-claude-code.md) 中的 AGENTS.md 加载机制形成对比——AGENTS.md 从工作目录向上遍历到 git root 发现，而 SOUL.md 管人，人走到哪身份都一样。
...
这种安全设计与 [Hermes Agent v0.14 核心架构](ch03/044-agent.md) 中讨论的整体安全模型一致。
