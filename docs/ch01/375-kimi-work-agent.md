...
## 相关实体
- [Schemaflow Agentic Database Sql Generation Openai Cookbook](../ch04/757-agentic.html)
...
### vs [Codex 6 职位插件](ch01/738-codex.html)
- 之前 Codex 还在"加插件拓展能力"
...
- [Karpathy Vibe Coding → Agentic Engineering](../ch04/757-agentic.html) —— Vibe Coding 原始定义
