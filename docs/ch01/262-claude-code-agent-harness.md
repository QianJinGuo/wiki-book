...
## Ch01.262 深入理解 Claude Code 源码中的 Agent Harness 构建之道
...
- [Claude Code 深度解析](../ch05/060-claude-code-harness.html) — Claude Code 架构的另一次深度解读
- [Claude Code Dynamic Workflows](../ch09/078-claude-code-dynamic-workflows.html) — AgentTool 子智能体 + Dynamic Workflow 范式
...
- [OpenClaw 完整指南](../ch11/213-openclaw.html) — 开源对应物（Worktree 隔离模式实现）
- [Harness Engineering 一文](../ch05/062-harness-engineering.html) — Harness 概念的系统阐释
