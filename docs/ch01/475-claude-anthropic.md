...
## Ch01.475 全网骂Claude变笨，Anthropic下场揭秘：坑你的不是模型
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/claude-perceived-degradation-anthropic-effort-model-explanation-2026.md)
