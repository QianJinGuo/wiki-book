...
## Ch01.154 Announcing AWS CDK Mixins: Composable Abstractions for AWS Resources | Amazon Web Services

> 📊 Level ⭐ | 4.1KB | `entities/announcing-aws-cdk-mixins-composable-abstractions-for-aws-resources-amazon-web-s.md`
...
## 相关实体
- [Announcing Aws Cdk Mixins Composable Abstractions For Aws Re](ch01/436-aws.html)
