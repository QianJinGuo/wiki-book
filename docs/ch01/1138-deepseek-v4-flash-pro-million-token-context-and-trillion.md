...
- [Deepseek Moe Parallel Strategy](ch01/969-deepseek.md) — DeepSeek MoE 并行策略
...
- [2026 Llm Rl Algorithms Deeplog Imba Ppo Dpo Grpo Marl](ch01/586-llm.md) — 2026 LLM RL 算法综述（DeepSeek V4 训练方法背景）
