...
→ 主条目：[Claude Code Dynamic Workflows Multi Agent Orchestration](ch03/084-claude-code.html)
...
- [Claude Code Dynamic Workflows Multi Agent Orchestration](ch03/084-claude-code.html) — 主条目，51KB 完整多 Agent 编排指南
...
- [深入理解 Claude Code 源码中的 Agent Harness 构建之道](ch03/084-claude-code.html) — Claude Code 中的 agent harness 构建
...
- [Claude Code Harness Deep Dive Founder Park](ch03/084-claude-code.html) — Founder Park 的 Claude Code harness 深度文章
