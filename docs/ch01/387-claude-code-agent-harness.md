...
- [Agent Evolution 四阶段六维](../ch03/036-agent.html) — 阶段三/阶段四对应 Claude Code 的生产实践
- [OpenClaw 完整指南](../ch11/250-openclaw.html) — 开源对应物（Worktree 隔离模式实现）
- [Harness Engineering 一文](../ch05/092-harness-engineering.html) — Harness 概念的系统阐释
- [四种 Sub Agent 模式](../ch03/036-agent.html) — AgentTool 子智能体的几种编排模式
- [Agent YAML 评测](../ch03/036-agent.html) — Harness 第五层评估与观测的工程实现
