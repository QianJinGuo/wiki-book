...
- [Claude Code Dynamic Workflows](../ch09/104-claude-code-dynamic-workflows.html) — AgentTool 子智能体 + Dynamic Workflow 范式
...
- [OpenClaw 完整指南](../ch11/253-openclaw.html) — 开源对应物（Worktree 隔离模式实现）
