...
## Ch01.387 深入理解 Claude Code 源码中的 Agent Harness 构建之道
...
这与 [Claude Code Harness Deep Understanding](ch01/636-claude-code-harness-deep-understanding.html) 中关于"分层知识组织"的论述相互印证——配置文件本身构成了 Agent 的"知识层级"。
...
这与 [Claude Code Harness Deep Dive](../ch05/083-claude-code-harness.html) 中关于"流式交互是 Agent 体验核心"的论述一致——用户感受到的"逐字输出"本质就是 `StreamEvent` 实时推送的结果。
...
- [Claude Code Harness 深度解析](../ch05/083-claude-code-harness.html)
- [Claude Code Harness 深度理解](ch01/636-claude-code-harness-deep-understanding.html)
...
- [OpenClaw 多智能体团队搭建经验](../ch11/248-openclaw.html)
- [Headroom Context Compression](../ch03/035-agent.html)
- [AI Agent Harness 构建](ch01/1177-ai-agent-harness.html)
