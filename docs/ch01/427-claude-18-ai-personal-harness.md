...
## Ch01.427 用好 Claude 的 18 个动作：搭一个个人 AI 工作台（Personal Harness）
...
```mermaid
mindmap
  root(("用好 Claude 的 18 个动作 搭一个个人 AI 工作台"))
    范式转移 从提示词优化到环境工程
    六层工作台结构
    关键语录
    最小可行版本 3 Projects
    Personal Harness 是 Harness
    六层结构对应软件工程的成熟分层
    「流程卡片」是最被低估的资产
    上下文治理 最难的工程问题
```
...
- [Harness Engineering](../ch05/120-harness-engineering.html) — Personal Harness 的工程化版本
- [Claude Code 源码核心机制](../ch03/078-claude-code.html)
