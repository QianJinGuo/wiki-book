...
→ [原文存档](https://www.anthropic.com/news/claude-opus-4-7)

- [突发Anthropic拿下马斯克Colossus 1全部算力Claude要放开用了](https://github.com/QianJinGuo/wiki-public/blob/main/entities/突发anthropic拿下马斯克colossus-1全部算力claude要放开用了.md)
- [anthropic 最新播客：如何打造下一代 claude](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic-building-next-claude.md)
