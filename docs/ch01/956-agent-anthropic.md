...
## Ch01.956 多 Agent 不是虚拟公司：从 Anthropic 五种模式看信息流怎么设计

> 📊 Level ⭐⭐ | 4.4KB | `entities/多-agent-不是虚拟公司从-anthropic-五种模式看信息流怎么设计.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/多-agent-不是虚拟公司从-anthropic-五种模式看信息流怎么设计.md)
