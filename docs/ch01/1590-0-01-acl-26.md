...
## Ch01.1590 0.01%参数就能接近全量微调！低数据微调极致省参方案来了 | ACL'26
...
- 原文完整记录：[原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/001参数就能接近全量微调低数据微调极致省参方案来了-acl26.md)
