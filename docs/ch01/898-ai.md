...
## Ch01.898 高德 AI 资产度量与评价体系：三层评估模型 + 离线采集 + 人工反馈闭环
...
- [HSCodeComp](ch01/1151-acl-2026.html) — 验证信号（Agent Harness +8.5pt，与资产度量中 Agent Harness 的价值信号一致）
- [Harness Engineering](../ch05/115-harness-engineering.html) — Skill/MCP 是 Harness 的执行载体
