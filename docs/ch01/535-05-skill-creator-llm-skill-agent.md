...
> 📊 Level ⭐⭐⭐⭐⭐ | 15.6KB | `entities/ai-skill-skill-creator-源码拆解.md`
...
→ [原文存档](https://juejin.cn/post/7620005798770737167)
...
→ [Ai Skill Evolution底层逻辑](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-skill-evolution底层逻辑.md) — Skill 的演进框架底层逻辑

→ [Skills Refiner Design Quality Evaluation Framework](https://github.com/QianJinGuo/wiki-public/blob/main/entities/skills-refiner-design-quality-evaluation-framework.md) — skill-creator 的质量评估补充工具

→ [Ai Skill Metrics System](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-skill-metrics-system.md) — AI Skill 测评指标体系

→ [Ai Skill 四层验证体系](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-skill-四层验证体系.md) — SkillSentry 四层验证体系（四）
