...
## Ch01.219 Anthropic Claude Managed Agents 平台正式发布
...
## 相关产品/人物
- [Claude Managed Agents 开发者指南](../ch04/680-claude-managed-agents.html)
...
- [Anthropic 长时运行 Agent 架构：对抗式设计 + 合同谈判 + 审美量化](ch01/1299-anthropic.html) — 另一篇技术解读，覆盖 API 细节和定价
- [Anthropic PM 的 Agentic 工作流](../ch04/458-anthropic-pm-agentic.html) — 同一时期 Jess Yan 的 PM 视角，同一产品不同维度
...
- [Multica — 开源 Managed Agents 平台](../ch07/064-multica-managed-agents.html)
- [claude managed agents official](../ch04/577-claude-managed-agents-official.html)
- [claude managed agents](../ch04/680-claude-managed-agents.html)

- [从 Anthropic 到 Google：Agent Skills 进入设计模式阶段](../ch04/372-anthropic-google-agent-skills.html)
- [Anthropic puts Claude agents on a meter across its subscriptions](../ch04/394-anthropic-claude-agent.html)
- [Introducing Claude for Small Business](ch01/027-introducing-claude-for-small-business.html)
- [Introducing Claude for Small Business](ch01/027-introducing-claude-for-small-business.html)
- [Xero Announces Integration with Anthropic's Claude](ch01/1299-anthropic.html)
- [Mythos for Offensive Security: XBOW's Evaluation](../ch12/030-mythos.html)
- [Anthropic 首次揭秘下一代 Claude 怎么造](ch01/1316-anthropic-claude.html)
- [Anthropic 14 个 Agent Skills 设计模式](../ch04/279-anthropic-agent.html)
