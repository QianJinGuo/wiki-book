...
## Ch01.666 Detecting Misuse with the Claude Compliance API: The Threat Is in the Content
...
- [Agent Security Three-Step Sequence](../ch05/018-harness.html)
- [Agent Harness Observability](../ch05/039-agent-harness.html)
