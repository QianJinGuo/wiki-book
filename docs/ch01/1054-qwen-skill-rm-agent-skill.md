...
## Ch01.1054 阿里Qwen提出Skill-RM：把奖励模型做成可复用Agent Skill
...
- **vs [Evaluating Netflix with LLM-as-a-Judge](ch01/348-evaluating-netflix-show-synopses-with-llm-as-a-judge.md)**：Netflix案例是 judge 应用层；Skill-RM 是 judge框架层
