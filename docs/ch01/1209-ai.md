...
本页作为知识图谱锚点，连接了以下关键实体：[Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](../ch04/237-agentic.html)。 相关主题通过 [Is Software Losing Its Head](ch01/650-is-software-losing-its-head.html) 延伸。
