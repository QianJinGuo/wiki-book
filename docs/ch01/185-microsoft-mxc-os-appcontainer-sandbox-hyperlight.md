...
- [CrewAI Agent Security 三步防护](../ch05/008-harness.html) — 应用层 guardrail 视角
- [AI Tool Poisoning 调查](../ch04/226-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s.html) — agent 工具被污染的攻击面
