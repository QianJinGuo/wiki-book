...
## Ch01.588 GPT-5.5参数有10T？病毒式论文刚刚被打假，实际缩水至1.5T

> 📊 Level ⭐⭐ | 7.7KB | `entities/2026-05-03-GPT-5-5参数有10T-病毒式论文刚刚被打假-实际缩水至1-5T-新智元.md`
...
```mermaid
mindmap
  root(("GPT-5.5参数有10T？病毒式论文刚刚被打假，实际缩…"))
    详细信息
      --- 新智元报道
    原文
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/2026-05-03-GPT-5-5参数有10T-病毒式论文刚刚被打假-实际缩水至1-5T-新智元.md)
