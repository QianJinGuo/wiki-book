...
## Ch01.163 YC Spring 2026 全批 196 家公司分析：AI 不再是差异点
...
- [Harness Engineering](../ch05/052-harness-engineering.html) — Agent 差异化来自 harness 而非模型
- [Claw-SWE-Bench](../ch05/018-harness.html) — harness 独立变量实证
- [Agent Eval WalleZhang](../ch03/046-agent.html)
