...
## 相关概念
- [Anthropic](ch01/969-anthropic.html) — 研究机构，NLAs 是其可解释性研究的最新成果
...
## 相关实体
- [Natural Language Autoencoders (Anthropic)](ch01/969-anthropic.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/anthropic-natural-language-autoencoders.md)

- [QuickSight Dataset QA：NL直查S3 Iceberg](../ch11/178-aws-quicksight-dataset-qa-natural-language.html)
