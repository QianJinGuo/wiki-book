...
## Ch01.913 Red Queen Gödel Machine (RQGM)：共进化 Agent 与评估器的递归自改进框架

> 📊 Level ⭐⭐ | 3.3KB | `entities/rqgm-red-queen-godel-machine-cambridge-nvidia-2026.md`
...
- [AI 递归自改进](ch04/150-ai.md) — 自改进的更广泛背景
- [Agent 自改进六机制](ch03/044-agent.md) — 自改进机制分类
