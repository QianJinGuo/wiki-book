...
## Ch01.766 AWS 强化微调：LLM-as-Judge 训练范式
...
- [Llm Finetuning Cost Breakdown](ch01/854-llm.html)
...
- [stop hand-tuning kernels: how neuron agentic development acc](../ch04/393-stop-hand-tuning-kernels-how-neuron-agentic-development-acc.html)
