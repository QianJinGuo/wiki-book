...
## Ch01.634 从月球漫步到赛博都市，WBench测出了世界模型的边界
...
```mermaid
mindmap
  root(("从月球漫步到赛博都市 WBench测出了世界模型的边界"))
    评测框架设计
    五维度评测指标
    模型表现对比
    导航能力独立于画质的结构性根源
...
- [世界模型评测综述](ch01/913-20.html) — 更广泛的 world model 评测方法
- **视频生成评测体系** — WBench 的视频评测技术背景
- **具身智能评测** — 空间导航与交互的评测关联
- [Kling 视频生成模型](ch01/913-20.html) — WBench 评测的模型之一
