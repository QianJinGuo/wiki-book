...
## Ch01.965 大模型RL为何越训越窄？ACL 2026杰出论文揭秘熵坍缩真相
...
```mermaid
mindmap
  root(("大模型RL为何越训越窄 ACL 2026杰出论文揭秘熵坍缩真相"))
    问题 RLVR 训练中的熵坍缩
    Token-level 熵变分析
    现有方法的局限
...
- [2026 年面向 LLM 的 RL 方法总结](ch01/1274-llm.html) — LLM 强化学习方法全景
- [LLM RL中的熵 part 1: 熵的调控](ch01/1274-llm.html) — 熵调控方法
- [Agentic RL 六框架实践地图](../ch04/327-agentic-rl.html) — Agentic RL 训练实践
- [LLM Post-Training 全景指南](ch01/1274-llm.html) — LLM 后训练综述
