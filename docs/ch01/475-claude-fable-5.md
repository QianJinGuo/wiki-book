...
> 与 [AI Gateway vs MCP Gateway 安全分析](ch07/001-mcp.html) 在"网关层安全"维度同框架。
...
> 与 [Fable 5 AWS 中文译本](ch01/1532-anthropic.html) 同 Fable 5 主题，但本文 80% 篇幅在 3 域对比 + 5 原则抽象，AWS 译本聚焦 Fable 5 产品本身（能力 + 接入 + 部署）。**互补不重叠**。
...
- **同 Fable 5 主题**（互补不重叠）：
  - [Fable 5 AWS 中文译本](ch01/1532-anthropic.html)（产品视角）
...
- **同阿里云生态**：
  ...
  - [阿里云 哈勃业务 Agent 评估](ch03/035-agent.html)
