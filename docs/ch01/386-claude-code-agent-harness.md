...
这与 [Claude Managed Agents 企业自托管](../ch04/810-claude-managed-agents.html) 中关于"Hybrid Control Plane"的设计哲学一致——**控制是分层的，不是二元的**。
...
- [Claude Managed Agents 企业自托管](../ch04/810-claude-managed-agents.html)
