...
- [Agent Evolution 四阶段六维](../ch03/019-agent.html) — 阶段三/阶段四对应 Claude Code 的生产实践
...
- [四种 Sub Agent 模式](../ch03/019-agent.html) — AgentTool 子智能体的几种编排模式
- [Agent YAML 评测](../ch03/019-agent.html) — Harness 第五层评估与观测的工程实现
