...
## Ch01.335 Codex 三件套：6 职位插件 + Sites + Annotations
...
- [Codex Computer Use](../ch09/118-codex-can-now-control-other-desktop-devices-via-computer-use.html)
- [Codex 自主赚钱](ch01/538-codex.html)
- [Claude Code vs Codex 上下文架构](../ch03/075-claude-code.html)
- [Meta Skill](../ch07/024-meta-skill.html)（Skill 2.0 抽象）
- [扣子 3.0 协作系统](ch01/1136-3-0.html)（同类协作产品）
