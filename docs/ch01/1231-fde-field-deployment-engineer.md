...
## Ch01.1231 FDE（Field Deployment Engineer）非共识与落地指南 — 硅谷一线实践者圆桌
...
- "模型是最容易被替代的一层" 呼应 [Agent Vs Workflow Control Continuum Framework](../ch04/618-agent-vs-workflow.html) 中护城河不在模型而在工程层
