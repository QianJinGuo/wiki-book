...
- [Edgeclaw Openbmb](../ch04/490-edgeclaw.md) — EdgeClaw端云两栖（MiniCPM是端侧对比）
- [Gstack Ai Workflow](../ch03/060-gstack-ai.md) — 并行Sprint工作流
-  — 企业级Agent落地对比
- [Hermes Agent Deep Dive](../ch03/090-hermes-agent.md) — Self-Evolution概念对照
