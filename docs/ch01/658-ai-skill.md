...
→ [AI Skill 测评体系：从零到一](ch04/341-skill.html)（系列主框架）

## 相关实体
- [Agentic AI 系统架构与分层模型](ch07/001-mcp.html)
- [Hermes Agent Skill 系统深度解析](ch04/341-skill.html)
