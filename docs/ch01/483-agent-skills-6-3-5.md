...
## Ch01.483 Agent Skills 开发指南：6 字段规范、3 级加载、5 步评估闭环
...
- [Superpowers 深度解读](../ch04/229-ai.md) — Rule/Gate/Hook 与 Iron Law 方法论
- [Anthropic Skill 设计模式](ch01/833-anthropic.md) — 官方推荐的技巧和模式
