...
## Ch01.1078 Loop Engineering 半年实战拆解：claude-ship 开源自进化开发系统
...
- [从 SDD 到 Lattice Harness](../ch05/088-ai-coding.html) — 另一团队级 AI Coding 闭环实践
- [《Loop Engineering橙皮书》](ch01/912-20.html) — Loop Engineering 概念框架
- [Agent Loop 工程手册 8 个未解问题](../ch05/006-loop-engineering.html) — 腾讯云陈进 Loop Engineering 解读
