...
## Ch01.1214 Parallel Rollout Approximation (PRA) — 像素空间自回归图像生成
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/peking-pra-pixel-space-ar-image-2026.md)
