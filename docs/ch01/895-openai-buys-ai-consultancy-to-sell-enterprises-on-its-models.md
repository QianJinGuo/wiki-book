...
## Ch01.895 OpenAI buys AI consultancy to sell enterprises on its models
...
## 相关实体
- [OpenAI buys AI consultancy to sell enterprises on its models](ch01/449-openai.html)
- [Interaction Models: A Scalable Approach to Human-AI Collaboration](../ch05/082-ai.html)
- [OpenAI三个语音模型发布同传被杀死](ch01/449-openai.html)
