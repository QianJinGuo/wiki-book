...
## Ch01.675 DeliAutoResearch SKILL：DeepSeek陈德里的自主科研智能体框架
...
- [Claude Code Dynamic Workflows](../ch09/102-claude-code-dynamic-workflows.html) — 编排子Agent执行任务，本框架关注科研任务的自主设计
