...
## Ch01.925 Cursor如何把一个通用模型，训成顶级编程 Agent

> 📊 Level ⭐⭐ | 4.6KB | `entities/cursor如何把一个通用模型训成顶级编程-agent.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/cursor如何把一个通用模型训成顶级编程-agent.md)
