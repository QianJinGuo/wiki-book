...
## Ch01.1437 DeepSeek V4 Flash & Pro: Million-Token Context and Trillion-Parameter Inference
...
- [Ai Infra Llm Efficient Inference Vllm](ch01/954-ai-infra.html) — LLM 高效推理基础设施综述（vLLM 推荐 0.20.0+）
...
- [Deepseek Moe Parallel Strategy](ch01/800-deepseek.html) — DeepSeek MoE 并行策略
...
- [2026 Llm Rl Algorithms Deeplog Imba Ppo Dpo Grpo Marl](ch01/1484-llm.html) — 2026 LLM RL 算法综述（DeepSeek V4 训练方法背景）
