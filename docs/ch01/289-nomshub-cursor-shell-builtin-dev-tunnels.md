...
## Ch01.289 NomShub — Cursor 远程隧道利用链：Shell Builtin 沙箱逃逸 + Dev Tunnels 武器化
...
- [CrewAI 三步防护](../ch05/099-harness.html) — 应用层 guardrail 视角
- [AI Tool Poisoning](../ch04/431-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s.html) — 工具被污染的通用风险
