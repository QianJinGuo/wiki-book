...
5. **关注下一代"共在感"的轻量实现。** 虚拟场景渲染被证明过于笨重，但"降低会议认知负荷"的需求仍在——[Granola](../ch05/109-ai.html) 这类 AI 会议笔记工具、[Webex 的 AI 会议助手](../ch11/239-amazon-quick.html) 用摘要、跟进与实时洞察等更轻的交互切入同一问题，说明正确的载体可能不是画面，而是信息结构。
