...
这些问题的根因不在模型智力，而在缺乏系统化的控制平面——这正是 [Harness Engineering](../ch05/050-harness-engineering.html) 要解决的核心问题。
...
- [Agent Orchestration](../ch04/630-agent-orchestration.html) — 多 agent 编排模式
