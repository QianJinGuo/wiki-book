...
## Ch01.821 What Is Software, and Will LLMs Replace It?
...
- [Agent Harnesses](../ch04/779-agent-harnesses-are-dead-long-live-agent-harnesses.html) — Agent 架构的演进
- [Claude Code Workflows](../ch09/102-claude-code-dynamic-workflows.html) — Agent 工作流设计
- [本文实体](ch01/854-llm.html) — Tomassetti 的分析
