...
- [Yann Dubois Openai Post Training Matt Turck Interview](ch01/435-openai.md) — OpenAI 后训练方法访谈
- [Yann Lecun Llm Not Intelligence Jepa](ch01/580-llm.md) — LeCun 关于 LLM 与空间智能的批判
- [2026 Llm Rl Algorithms Deeplog Imba Ppo Dpo Grpo Marl](ch01/580-llm.md) — 2026 LLM RL 算法综述
- [Scale Robot Reinforcement Learning With Nvidia Isaac Lab On ](ch01/1057-scale-robot-reinforcement-learning-with-nvidia-isaac-lab-on.md) — NVIDIA Isaac Lab 机器人 RL 扩展
...
- [Four Sub Agent Patterns](../ch03/045-agent.md) — 2026 四大子 Agent 模式
