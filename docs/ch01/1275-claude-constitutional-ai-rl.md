...
→ 相关实体：[Anthropic LLM 内省意识机制](ch01/1016-spec.html)
...
- → [Anthropic LLM 内省意识](ch01/1016-spec.html)：Anthropic 的安全研究能力维度
- → [Building Next Claude](ch01/976-claude.html)：Claude 的产品演进方向
