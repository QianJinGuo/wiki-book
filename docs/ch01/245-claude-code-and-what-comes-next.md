...
- 与 [苦味教训](../ch04/170-the-bitter-lesson-versus-the-garbage-can.html) 的对照：Claude Code 是"工艺派"——精心设计的 harness + 强大模型。ChatGPT agent 才是"结果训练派"。两者代表了 harness 工程的两种路线。
...
- 与 [管理即超能力](272-management-as-ai-superpower.html) 的同源：Karpathy 编程工作"变成管理 AI agent"是 Mollick 商业观察在技术领域的镜像。
...
- [The Bitter Lesson Versus The Garbage Can](../ch04/170-the-bitter-lesson-versus-the-garbage-can.html)
- [Management As Ai Superpower](272-management-as-ai-superpower.html)
...
- [an opinionated guide to using ai right now](../ch09/090-an-opinionated-guide-to-using-ai-right-now.html)
