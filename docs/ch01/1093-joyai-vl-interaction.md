...
JoyAI-VL-Interaction是京东2026年模型基建系列的一部分，与[JoyAI-Echo长视频生成框架](https://github.com/QianJinGuo/wiki/blob/main/entities/joyai-echo-long-video-framework-jd.md)、JoyAI-Image-Edit、JoyAI-LLM Flash等共同构成京东的开源AI矩阵。
