...
## Ch01.464 Simplify model selection in Amazon Bedrock with the open source Model Profiler
...
- [AgentCore Harness Trip Allocation Multi-Agent System AWS](../ch04/756-agentcore-harness.html) — AWS Agent ecosystem
