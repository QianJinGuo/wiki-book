...
## 实战调试案例：从需求到可用 Skill
*来源：[如何把经验装到Skills](https://mp.weixin.qq.com/s/GIpqXfAT8ESR7c50yctpRQ)*
...
## 相关实体
- [Agent Skill 高质量编写规范](255-agent-skill.html)

- [Agent Skill 评估与迭代](255-agent-skill.html)
- [SkillSieve — Agent Skill 安全检测三层框架（arXiv 2604.06550）](../ch04/342-skillsieve-agent-skill.html)
