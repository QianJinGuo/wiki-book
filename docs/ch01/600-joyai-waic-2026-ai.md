...
## Ch01.600 京东 JoyAI 模型矩阵亮相 WAIC 2026 — 从数字世界走向物理世界的 AI 全栈布局
...
- **JoyAI-Echo**：长音视频生成框架，支持 5 分钟一致性输出 + 7.5x DMD 加速 + Director Agent，详见 [JoyAI-Echo 框架](../ch05/097-ai.html)
- **JoyAI-VL-Interaction**：全栈开源视频语言交互模型，详见 [JoyAI-VL-Interaction](ch01/1473-joyai-vl-interaction.html)
