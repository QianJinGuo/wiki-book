...
→ 主条目：[Claude Code Dynamic Workflows Multi Agent Orchestration](../ch09/087-claude-code-dynamic-workflows.html)
...
- [Claude Code Dynamic Workflows Multi Agent Orchestration](../ch09/087-claude-code-dynamic-workflows.html) — 主条目，51KB 完整多 Agent 编排指南
...
- [Claude Code Harness Deep Understanding](ch01/458-claude-code-harness-deep-understanding.html) — Claude Code harness 深度解析
