...
- [Claude Code Dynamic Workflows Multi Agent Orchestration](../ch09/094-claude-code-dynamic-workflows.html) — 主条目，51KB 完整多 Agent 编排指南
- [两万字详解Claude Code源码核心机制](../ch03/078-claude-code.html) — Claude Code 源码级机制
...
- [Claude Code Harness Deep Dive Founder Park](../ch05/073-claude-code-harness.html) — Founder Park 的 Claude Code harness 深度文章
