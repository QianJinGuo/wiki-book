...
## Ch01.576 RAG深度解析：分块、向量化、召回、重排，才是"蒸馏同事skill"的关键
...
## 相关实体
- [RAG技术框架的演进方向](ch01/1029-rag.html)
...
- [Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](../ch04/633-agentic.html)
...
- [使用 Agent Skills 做知识库检索，能比传统 RAG 效果更好吗？](../ch04/398-agent-skills.html)
