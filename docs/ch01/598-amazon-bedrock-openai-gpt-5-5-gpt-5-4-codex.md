...
在 [Amazon Bedrock AgentCore](../ch04/567-amazon-bedrock-agentcore-harness-ga-api-agent.html) 中，可以将 OpenAI 模型配置为 Agent 的推理引擎，实现完整的工具调用、记忆管理和多步推理：
...
- [Amazon Bedrock AgentCore Harness GA](../ch04/567-amazon-bedrock-agentcore-harness-ga-api-agent.html)
...
- [Deep Agents on Bedrock AgentCore](../ch04/595-agent-orchestration.html)
