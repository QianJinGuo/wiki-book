...
## Ch01.399 PromptQueue + OpenGorilla 集成 — AI-Native 异步任务引擎与自进化认知层
...
- [Prompt Context Harness Three Evolutions](../ch05/085-harness.html)
...
- [Openai Skills Shell Compaction Agent Primitives](../ch05/027-openai-skills-shell-compaction-agent.html)
