...
## Ch01.166 Vietnam to develop domestic cloud
...
- [Vietnam to develop domestic cloud so it can ditch risky overseas operators for government workloads](https://github.com/QianJinGuo/wiki/blob/main/entities/vietnam-domestic-cloud.md)- [anthropic](ch01/890-anthropic.html)- [inference cost at scale with napkin math](ch01/956-20.html)- [why use app-level auth when every database has auth? (splunk](ch01/170-why-use-app-level-auth-when-every-database-has-auth-splunk.html)
