...
## Ch01.899 别再亲自写Prompt了！OpenClaw与Claude Code创始人已经用'循环'让一堆Agent自动打工了
...
- [MCP 12 设计模式](ch01/779-anthropic.html)
- [OpenClaw 多智能体团队](../ch11/252-openclaw.html)
- [OpenClaw 完全指南](../ch11/252-openclaw.html)
- [Claude Code 源码机制](../ch03/085-claude-code.html)
