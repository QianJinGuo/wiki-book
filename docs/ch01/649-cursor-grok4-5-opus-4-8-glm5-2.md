...
## Ch01.649 Cursor让马斯克的Grok4.5咸鱼翻身，追平Opus 4.8，成本比GLM5.2还低
...
```mermaid
mindmap
  root(("Cursor让马斯克的Grok45咸鱼翻身 追平Opus 48"))
    与 Cursor 联合训练 治好了跑分强 实战弱的顽疾
    性价比革命 两重折扣的实际账单效应
    编程基准的全面评估
    算力基础与月更承诺
```
...
- [Grok 4.5 模型发布详情](../ch05/094-ai.html)
- [Claude Opus 4.8 系统卡分析](ch01/976-claude.html)
- [Cursor 复盘：模型决定能力上限，Harness 决定生产下限](../ch05/009-harness.html)
- [Cursor Harness 模型生产化实践](ch01/265-cursor-harness-model-production-floor.html)
- [Claude Code Checkup 功能](../ch03/078-claude-code.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/cursor让马斯克的grok45咸鱼翻身追平opus-48成本比glm52还低.md)
