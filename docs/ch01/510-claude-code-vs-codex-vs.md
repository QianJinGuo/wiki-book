...
## Ch01.510 Claude Code vs Codex 上下文架构：五层压缩管道 vs 容器文件系统
...
- [Claude Code Harness Deep Dive](../ch05/082-claude-code-harness.html) — Founder Park 深度分析（含 Auto-compaction）
