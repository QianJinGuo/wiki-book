...
## Ch01.696 DeepSeek Code Harness：对标 Claude Code 的中国方案
...
### 与 [Claude Code 内部机制](https://github.com/QianJinGuo/wiki-public/blob/main/entities/两万字详解claude-code源码核心机制.md) 的对比
