...
## Ch01.704 破解遥感目标的形状与尺度难题，PKINet二代推理提速近4倍！
...
```mermaid
mindmap
  root(("破解遥感目标的形状与尺度难题，PKINet二代推理提速近…"))
    详细信息
    原文
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/破解遥感目标的形状与尺度难题pkinet二代推理提速近4倍.md)
