...
> 📊 Level ⭐⭐⭐ | 7.4KB | `entities/anthropic-pm-jess-yan-managed-agents.md`
...
- [Anthropic Claude Managed Agents Guide](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic-claude-managed-agents-guide.md)
