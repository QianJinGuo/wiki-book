...
## Ch01.621 开启Harness Engineering探索之旅
...
这种"Fixed Flow + 程序化门禁"的设计哲学，与[Agent配置模型](../ch04/338-skill.html)中"渐进式披露"的思路形成对照——前者通过纪律保障可靠性，后者通过结构控制信息密度。
...
- [AgentCore旅行分配系统](../ch04/746-agentcore-harness.html)
