...
## Ch01.436 Three Years from GPT-3 to Gemini 3
...
这与 [Code As Agent Harness Survey](../ch09/063-code-as-agent-harness.html) 中关于"代码即 Agent Harness"的论述形成强对应——编程能力是 Agent 系统能力的"乘数因子"，而不是"附属技能"。
...
Mollick 截图展示的工作场景："同时有四个不同 Agent 在工作，一个在工作，另一个需要你的帮助才能继续"——这与 [Factory Mission](../ch03/037-agent.html) 中 Orchestrator 协调多 Worker 的模式有异曲同工之妙，但 Inbox 把"协调者"角色直接交给了用户。
...
**这一判断与 [Karpathy Vibe Coding 到 Agentic Engineering](../ch04/739-agentic.html) 形成跨作者印证**——两篇文章都指向同一个结论：AI 工具的产品形态正在从"对话窗口"迁移到"工作流伙伴"。
...
- [Karpathy Vibe Coding 到 Agentic Engineering](../ch04/739-agentic.html)
- [Karpathy Agentic Engineering 综述](../ch04/813-karpathy-vibe-coding-agentic-engineering.html)
- [AgentOps on Bedrock](../ch04/298-agentops-operationalize-agentic-ai-at-scale-with-amazon-bed.html)
...
- [Agent Vibecoder 上下文压缩](../ch06/041-headroom.html)
- [腾讯混元 HY3 开源预览](ch01/135-hy3-preview.html)
