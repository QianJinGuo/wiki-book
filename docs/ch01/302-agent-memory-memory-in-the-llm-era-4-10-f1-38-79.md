...
## Ch01.302 Agent Memory 模块化框架与评测：Memory in the LLM Era 4 模块 + 10 方案对比 + 新方法 F1 38.79 + 4 条工程原则
...
## 与 [Agent Memory Architecture](../ch04/407-perplexity-brain-self-improving-agent-memory-architecture.html) 的关系
...
- [Agent Self Improvement Six Mechanisms](../ch03/046-agent.html) — Agent 自我改进机制，与 Memory 的"修正+遗忘"机制有交叉
