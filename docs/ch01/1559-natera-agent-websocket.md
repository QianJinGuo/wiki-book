...
- [Loka 低延迟语音 Agent](../ch04/392-how-loka-built-a-natural-low-latency-voice-agent-with-amazo.html) 同为低延迟语音 Agent 架构实践
- [Nova Sonic 实时语音 Agent](../ch04/112-real-time-voice-agents-with-stream-vision-agents-and-amazon.html) 聚焦 Nova Sonic 模型接入
