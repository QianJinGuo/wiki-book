...
## Ch01.927 Natural Language Autoencoders — Anthropic 激活→文字可解释性方法
...
## 相关概念
- [Anthropic](ch01/707-anthropic.md) — 研究机构，NLAs 是其可解释性研究的最新成果
...
## 相关实体
- [Natural Language Autoencoders (Anthropic)](ch01/707-anthropic.md)
