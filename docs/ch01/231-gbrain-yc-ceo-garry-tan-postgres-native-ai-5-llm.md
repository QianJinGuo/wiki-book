...
## Ch01.231 GBrain — YC CEO Garry Tan 的 Postgres-native AI 第二大脑：5 大设计决策 + 零 LLM 知识图谱 + 8 阶段检索 + Brain⊥Source 正交维度
...
## 相关实体
- [AgentBrowser](ch04/502-agent.md)
