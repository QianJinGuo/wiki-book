...
## Ch01.599 现代AI之父新作：13个大模型实测，检索agent真的可信吗？
...
- [Alibaba Data Rd Harness Engineering Nl2Sql](../ch05/118-harness-engineering.html) — 阿里 NL2SQL 实践中的幻觉防控策略，与搜索结果的真实性校验互补
