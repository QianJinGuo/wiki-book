...
这与 [Claude Code Harness Deep Understanding](ch01/465-claude-code-harness-deep-understanding.md) 中关于"分层知识组织"的论述相互印证——配置文件本身构成了 Agent 的"知识层级"。
...
这与 [Claude Managed Agents 企业自托管](../ch04/606-claude-managed-agents.md) 中关于"Hybrid Control Plane"的设计哲学一致——**控制是分层的，不是二元的**。
...
- [Claude Code Harness 深度理解](ch01/465-claude-code-harness-deep-understanding.md)
...
- [Claude Managed Agents 企业自托管](../ch04/606-claude-managed-agents.md)
