...
## Ch01.352 Anthropic 博客：Claude Code 大型代码库最佳实践
...
- [Claude Code Core Internals](../ch03/075-claude-code.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/anthropic-claude-code-large-codebase-best-practices-50002a089323.md)

- 博客原文：https://claude.com/blog/how-claude-code-works-in-large-codebases-best-practices-and-where-to-start
- [openai 的最强对手，离「ai windows」又近了一步](../ch04/438-anthropic-ai.html)
- [钉钉 stream + cli 代理双引擎 ai 助手架构](../ch05/079-ai.html)
- [claude code 1.0.24 工具调用安全事故：静默删 .gitignore 与 redis flush 复盘](../ch03/075-claude-code.html)
