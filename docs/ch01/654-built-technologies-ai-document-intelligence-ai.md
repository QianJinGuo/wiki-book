...
## Ch01.654 Built Technologies AI Document Intelligence — 房地产金融 AI 文档处理引擎
...
- [Amazon Bedrock](../ch11/181-amazon-bedrock.html) — AWS 的基础模型服务和文档处理能力
- [AWS IDP Accelerator](../ch11/305-aws-idp-accelerator.html) — AWS 智能文档处理加速器
- [文档处理 Agent](../ch04/764-document-processing-agent.html) — AI 驱动的文档处理 Agent
- [金融行业 Agentic AI](../ch04/673-agentic-ai.html) — AI Agent 在金融领域的应用
