...
- [Hermes Agent /goal 长任务运行时架构](../ch04/451-hermes-agent-goal.html)
- [LLM agent脚手架如何具备自进化能力？——以hermes agent为例](../ch03/102-hermes-agent.html)
- [LoongSuite GenAI 可观测语义规范](../ch04/546-loongsuite-genai.html)
- [低代码 Agent、框架 Agent、自研 Agent 决策框架](../ch03/035-agent.html)
- [三器合一：gstack + Superpowers + OpenSpec 工程化 AI 编程实战](../ch05/118-ai-coding.html)
