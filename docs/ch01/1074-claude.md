...
## Ch01.1074 Claude 最歧视的，是印度三哥

> 📊 Level ⭐⭐ | 3.2KB | `entities/claude-最歧视的是印度三哥.md`
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/claude-最歧视的是印度三哥.md)
