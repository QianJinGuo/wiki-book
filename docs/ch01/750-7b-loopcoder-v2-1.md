...
## Ch01.750 都在卷「让大模型多循环几遍」，这个7B模型LoopCoder v2说：多循环 1 次就够了

> 📊 Level ⭐⭐ | 6.4KB | `entities/都在卷让大模型多循环几遍这个7b模型loopcoder-v2说多循环-1-次就够了.md`
...
```mermaid
mindmap
  root(("都在卷「让大模型多循环几遍」 这个7B模型LoopCoder"))
    一 「循环」 当下最热的卷法
    二 旋钮拧大 更强
    第 2 遍封顶 第 3 遍跳水
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/都在卷让大模型多循环几遍这个7b模型loopcoder-v2说多循环-1-次就够了.md)
