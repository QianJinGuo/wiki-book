...
- [Ethan He Cosmos Grok Imagine Latent Space Video Agent 20260606](../ch03/019-agent.html) — 多模态视频 agent 的另一前沿
...
- [你不知道的 Agent原理架构与工程实践 V2](../ch03/019-agent.html) — Agent 原理架构的综合性参考
