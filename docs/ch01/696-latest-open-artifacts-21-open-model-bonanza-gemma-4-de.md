...
## Ch01.696 Latest open artifacts (#21): Open model bonanza! Gemma 4, DeepSeek V4, Kimi K2.6, MiMo 2.5, GLM-5.1 & others. On CAISI's V4 assessment.

> 📊 Level ⭐⭐ | 8.9KB | `entities/latest-open-artifacts-21-open-model-bonanza-gemma-4-deepseek.md`

# Latest open artifacts (#21): Open model bonanza! Gemma 4, DeepSeek V4, Kimi K2.6, MiMo 2.5, GLM-5.1 & others. On CAISI's V4 assessment.

> 原文存档：[原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/latest-open-artifacts-21-open-model-bonanza-gemma-4-deepseek.md)
...
## 相关实体
- [Latest Open Artifacts 19 Qwen Glm Minimax Interconnects](ch01/358-1.html)
- [Interconnects Latest Open Artifacts 20 New Orgs New Types Of Models With Nemotron Super Sarvam](ch01/424-latest-open-artifacts-20-new-orgs-new-types-of-models.html)
...
- [Wetesteddeepseekv4Proandflashagainstclau](ch01/1475-deepseek.html)

## 相关引用
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/latest-open-artifacts-21-open-model-bonanza-gemma-4-deepseek.md)
