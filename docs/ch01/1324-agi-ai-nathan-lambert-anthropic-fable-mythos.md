...
## Ch01.1324 欢迎来到 AGI 时代的 AI 治理 — Nathan Lambert 论美国政府强制 Anthropic 限制 Fable/Mythos 访问
...
- [Anthropic vs DoW 与开源模型的权力均衡](ch01/1299-anthropic.html) — 从开源模型生态角度分析同一事件，但缺少 Lambert 的"AGI 治理范式转换"框架
...
- [Claude Fable 5 and new AI safety fables](ch01/877-claude-fable-5-and-new-ai-safety-fables.html) — Fable 安全讨论的综述
