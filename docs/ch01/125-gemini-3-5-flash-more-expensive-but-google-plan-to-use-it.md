...
## Ch01.125 Gemini 3.5 Flash: more expensive, but Google plan to use it for everything
...
- [Computer Use 45X More Expensive Than Structured Apis](../ch04/411-computer-use-45x-more-expensive-than-structured-apis.html)
