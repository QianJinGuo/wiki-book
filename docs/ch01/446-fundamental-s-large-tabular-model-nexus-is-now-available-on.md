...
## Ch01.446 Fundamental’s Large Tabular Model NEXUS is now available on Amazon SageMaker JumpStart

> 📊 Level ⭐⭐ | 15.8KB | `entities/aws-fundamentals-large-tabular-model-nexus-is-now-available-on-amazon-sagemaker-jump.md`
...
- [Amazon Sagemaker Qualcomm Ai Hub Edge Npu Deployment](../ch05/097-ai.html)
