...
## Ch01.1272 LLM 缓存原理与实践：从 KV Cache 到 Prefix Caching，Agent 命中率常挂 90% 的机制与工程含义
...
- 与 [DeepSeek 成本迁移与系统层 KV Cache + Harness 工程](ch01/389-deepseek.html) 互补——该实体聚焦 DeepSeek 的迁移案例，本文提供全行业全景
- 与 [OpenClacky Prompt Cache Harness](../ch05/018-harness.html) 互补——该实体聚焦特定提示缓存方案，本文覆盖原理和所有主流方案
- 与 [Claude Cache Tokenomics](ch01/951-claude.html) 互补——该实体聚焦 Anthropic 的 5 分钟 TTL 机制，本文提供跨厂商对比
