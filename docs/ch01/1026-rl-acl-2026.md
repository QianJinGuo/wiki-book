...
## Ch01.1026 大模型RL为何越训越窄？ACL 2026杰出论文揭秘熵坍缩真相

> 📊 Level ⭐⭐ | 4.0KB | `entities/llm-rl-entropy-collapse-acl-2026-outstanding-paper.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/llm-rl-entropy-collapse-acl-2026-outstanding-paper.md)
...
健康的训练需要二者保持动态平衡。论文推导了 token-level 熵变的近似表达式，发现熵变方向主要由**优势信号（advantage）**和**token 生成概率**共同决定：
...
- 在不同模型（Qwen/Llama/Mistral）、算法（GRPO/RLOO/OPO）、规模上均表现稳定

## 相关实体

- [2026 年面向 LLM 的 RL 方法总结](ch01/607-llm.html) — LLM 强化学习方法全景
- [LLM RL中的熵 part 1: 熵的调控](ch01/607-llm.html) — 熵调控方法
- [Agentic RL 六框架实践地图](../ch04/434-agentic-rl.html) — Agentic RL 训练实践
- [LLM Post-Training 全景指南](ch01/607-llm.html) — LLM 后训练综述
