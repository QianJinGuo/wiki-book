...
## Ch01.386 Claude Code vs Codex 上下文架构：五层压缩管道 vs 容器文件系统
...
## 相关主题
- [Claude Code 架构](ch03/074-claude-code.md) — Claude Code 完整架构分析
...
- [Claude Code Harness Deep Dive](ch03/074-claude-code.md) — Founder Park 深度分析（含 Auto-compaction）
