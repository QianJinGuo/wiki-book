...
## Ch01.593 AI Agent Gateway 架构设计 — OpenClaw/Claude Code/Hermes 三框架对比
...
- **乘积**：64 — strong ★★★★
- **策略对齐**：与 [DeerFlow vs Hermes vs OpenClaw](ch01/294-hermes.html) 互补（整体选型 vs Gateway 专深）
...
- **交叉引用**：与 [OpenClaw Prompt/Context/Harness](ch11/247-openclaw.html)、[Claude Code Prompt/Context/Harness](ch03/084-claude-code.html)、[Hermes Agent 深度解析](ch03/035-agent.html) 互为补充
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/gateway-architecture-openclaw-claude-hermes-comparison.md)
...
- [Claude Code Integration Other Tools](ch03/084-claude-code.html)
...
- [claude dispatch + 接口力量：ai 从 chatbot 到 agent interface 的转变](ch01/1442-claude.html)
