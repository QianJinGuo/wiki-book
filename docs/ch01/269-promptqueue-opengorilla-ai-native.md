...
## Ch01.269 PromptQueue + OpenGorilla 集成 — AI-Native 异步任务引擎与自进化认知层
...
- [Prompt Context Harness Three Evolutions](ch05/085-harness.md)
...
- [Openai Skills Shell Compaction Agent Primitives](ch04/258-skill.md)
