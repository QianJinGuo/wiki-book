...
## Ch01.646 Hermes Agent v0.13 — /goal 目标管理与 Kanban 多 agent 协作
...
## 相关实体
- [Hermes Agent Kanban Deep Test](../ch03/091-hermes-agent.html)
- [Hermes Agent Goal Runtime Architecture](../ch04/363-hermes-agent-goal.html)
- [Hermes Agent](../ch03/091-hermes-agent.html)
- [Hermes Agent Kanban Deep Test By Wjjagi 2026](../ch03/091-hermes-agent.html)
