...
## Ch01.247 强化学习的进化 从PPO到MaxRL LLM推理训练的算法演进史 机器之心
...
- 原文: [强化学习的进化 从PPO到MaxRL LLM推理训练的算法演进史 机器之心](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/2026-05-01-强化学习的进化-从PPO到MaxRL-LLM推理训练的算法演进史-机器之心.md)
