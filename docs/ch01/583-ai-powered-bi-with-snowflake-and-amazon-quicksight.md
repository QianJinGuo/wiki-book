...
## Ch01.583 AI-powered BI with Snowflake and Amazon QuickSight
...
- **[SchemaFlow](../ch04/629-agentic.html)**：Agent 驱动的数据库 SQL 生成，同样需要语义约束
- **[Data-Native Agents](../ch04/516-how-to-build-agents-where-data-already-lives.html)**：Agent 直接在数据平台上运行，语义层是关键基础设施
...
- [Snowflake Agentic Enterprise](../ch04/629-agentic.html) — Snowflake 的 Agent 平台愿景
- [SchemaFlow](../ch04/629-agentic.html) — Agent 驱动的 SQL 生成
- [Anthropic Data Analysis](ch01/1326-anthropic.html) — LLM 数据分析的另一个视角
