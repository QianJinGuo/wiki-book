...
- [DeepSeek V4](ch01/1384-deepseek-v4.html) — 业界关注度最高、即将发布的中国前沿模型
- [CybersecQwen 4B](../ch12/108-cybersecqwen-4b.html) — Qwen 在安全垂域的专用模型
- [OpenClaw 完全指南](../ch11/255-openclaw.html) — Agent 工具栈的实践参考
- [Agent 记忆系统的工程实践](../ch03/006-agent.html) — 长上下文在 Agent 记忆中的工程化
- [Claude Code 源码核心机制](../ch03/085-claude-code.html) — 编码场景的 Agent 实现细节
