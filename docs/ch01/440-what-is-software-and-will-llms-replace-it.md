...
- [Agent Harnesses](../ch04/468-agent-harnesses-are-dead-long-live-agent-harnesses.html) — Agent 架构的演进
- [Claude Code Workflows](../ch09/073-claude-code-dynamic-workflows.html) — Agent 工作流设计
- [本文实体](458-llm.html) — Tomassetti 的分析
- [AI Agent Hype](../ch04/284-ai-agent.html) — 对 AI agent 过度炒作的冷静分析
