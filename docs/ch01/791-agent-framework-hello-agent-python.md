...
## Ch01.791 微软 Agent Framework 全栈指南：从 Hello Agent 到生产托管（Python）
...
## 相关实体
- [Microsoft Agent Framework Python Zizhi](../ch04/611-python.html)
...
- [Agent Harness 12 Components 7 Decisions](../ch05/057-agent-harness.html)
