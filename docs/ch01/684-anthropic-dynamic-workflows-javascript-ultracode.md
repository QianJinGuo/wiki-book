...
## Ch01.684 Anthropic Dynamic Workflows 深度实战：JavaScript 编排脚本 + ultracode 模式 + /deep-research + 保存复用

> 📊 Level ⭐⭐ | 6.8KB | `entities/anthropic-dynamic-workflows-ultracode-deep-research-lyuyuebannzi.md`
...
> Source: [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/anthropic-dynamic-workflows-six-patterns-agent-parallel-pipeline.md)
> Author: 林月半子的AI笔记
...
→ [第2原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/anthropic-dynamic-workflows-six-patterns-agent-parallel-pipeline.md)
