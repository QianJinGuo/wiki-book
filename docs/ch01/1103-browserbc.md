...
## Ch01.1103 BrowserBC：人类轨迹蒸馏为可复用技能，让小模型获得大模型的网页操作能力
...
- [Autobrowse：浏览器 Agent 的失忆问题](ch04/245-skill.md) — 持久化探索 vs 人类轨迹蒸馏，互补方案
- [Browser Use：为 Agent 构建 Runtime Harness](ch05/009-harness.md) — 浏览器 Agent 的运行时验证
