...
## Ch01.202 GEPA：让 LLM 用反思进化提示词，样本效率甚至超过强化学习
...
- 原文: [GEPA：让 LLM 用反思进化提示词，样本效率甚至超过强化学习](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/gepa-reflective-prompt-evolution-iclr2026-oral.md)
