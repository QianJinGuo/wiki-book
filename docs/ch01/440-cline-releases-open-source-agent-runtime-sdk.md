...
## Ch01.440 Cline releases open-source agent runtime SDK
...
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](../ch04/597-agentic.html) — 从 vibe coding 到 agentic engineering 的范式跃迁
...
- [Claude Code Harness Deep Understanding](ch01/469-claude-code-harness-deep-understanding.html) — Claude Code harness 的另一深度解析
- [Claude Code Harness Deep Dive Founder Park](../ch05/066-claude-code-harness.html) — 同主题的另一种解读视角
- [scaling archunit with nebula archrules](../ch11/275-scaling-archunit-with-nebula-archrules.html)
- [the code-as-content era](ch01/511-the-code-as-content-era.html)
- [the shape of the thing](ch01/279-the-shape-of-the-thing.html)
