...
- [xz, two years on: what scanners still cannot catch](469-xz.html)
- [一个 mission 跑 16 天、烧 7.78 亿 token：factory 公开了多 agent 系统的构建哲学](../ch03/004-agent.html)
- [gemma 4 and what makes an open model succeed](463-gemma-4-and-what-makes-an-open-model-succeed.html)
- [model-harness-fit-agent-harness](190-model-harness-fit-agent.html)
- [what i’ve been building: atom report, post-training course,](../ch04/052-ai.html)
