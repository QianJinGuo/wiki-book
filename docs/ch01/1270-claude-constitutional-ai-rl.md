...
## Ch01.1270 Claude 代码能力的系统工程解析：Constitutional AI + 可验证奖励 RL + 产品飞轮
...
→ 相关实体：[Anthropic LLM 内省意识机制](../ch04/169-anthropic-llm.html)
...
- → [Anthropic LLM 内省意识](../ch04/169-anthropic-llm.html)：Anthropic 的安全研究能力维度
- → [Building Next Claude](ch01/1324-anthropic.html)：Claude 的产品演进方向
- → [Harness Engineering 范式](../ch05/118-harness-engineering.html)：代码能力在 Agent 场景的价值
