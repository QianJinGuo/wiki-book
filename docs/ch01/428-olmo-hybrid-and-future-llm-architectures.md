...
This connects directly to the [inference cost analysis](ch01/913-20.html) — memory bandwidth is the bottleneck for long-context inference, and hybrid architectures fundamentally reduce this pressure.
