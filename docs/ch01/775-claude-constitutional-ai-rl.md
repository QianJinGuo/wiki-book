...
→ 相关实体：[Anthropic LLM 内省意识机制](../ch04/144-anthropic-llm.html)
...
- → [Anthropic LLM 内省意识](../ch04/144-anthropic-llm.html)：Anthropic 的安全研究能力维度
- → [Building Next Claude](341-claude.html)：Claude 的产品演进方向
- → [Harness Engineering 范式](../ch05/026-harness-engineering.html)：代码能力在 Agent 场景的价值
