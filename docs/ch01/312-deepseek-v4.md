...
## Ch01.312 读完这篇你就搞懂 DeepSeek v4 了
...
这与 [DeepSeek MoE 并行策略](ch01/1016-deepseek.html)、[DeepSeek 成本迁移系统层 KV Cache Harness](ch01/1016-deepseek.html)、[DeepSeek V4 Training 58-page Paper Deep Dive](ch01/678-deepseek-v4.html) 等文章形成完整图景。
...
- [DeepSeek V4 Pro vs Claude](ch01/678-deepseek-v4.html) 关注对比评测
...
- [DeepSeek V4 Training 58-page Paper Deep Dive](ch01/678-deepseek-v4.html) 关注训练侧
- [DeepSeek Code Harness](../ch09/083-deepseek-code-harness.html) 关注 V4 在 Agent / Harness 场景的工程实践
- [DeepSeek Code Harness 竞争者 Tina](../ch09/083-deepseek-code-harness.html) 关注竞品分析
...
- **关注 V4 在 Agent / Harness 场景的工程实践**——V4 的能力需要 harness 配合才能在生产中稳定输出，关注 [DeepSeek Code Harness](../ch09/083-deepseek-code-harness.html) 等。
...
- [DeepSeek V4 Pro vs Claude](ch01/678-deepseek-v4.html)
...
- [DeepSeek V4 Training 58-page Paper Deep Dive](ch01/678-deepseek-v4.html)
- [DeepSeek MoE 并行策略](ch01/1016-deepseek.html)
- [DeepSeek 成本迁移系统层 KV Cache Harness](ch01/1016-deepseek.html)
- [DeepSeek Code Harness](../ch09/083-deepseek-code-harness.html)
- [DeepSeek Code Harness 竞争者 Tina](../ch09/083-deepseek-code-harness.html)
