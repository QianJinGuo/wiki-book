...
## Ch01.287 LLM 主题 = 生成变量 — 别把 LLM 提取的主题当成真实变量（William Gieng 因果推断方法论）
...
- [Video Rag Chunking Strategy](ch01/295-rag.html)（文本 + AI 同源 — 视频 RAG 切片策略）
- [2 Year 25 Ai Projects Summary](ch01/1045-5-ai.html)（2 年 25 个 AI 项目总结 — 失败案例对照）
- [Loss Function Development Elvis Sun Goal Loop 2026](ch01/951-20.html)（LFD 强制熵同源 — 都是"系统化检查"思维）
- [State Of Memory In Agent Harness Mem0 2026](../ch05/039-agent-harness.html)（Agent 记忆体系 — 类似"看起来像观测但实际是生成"）
- [Recent Developments In Llm Architectures Jiqizhixin](ch01/947-llm.html)（LLM 架构最新进展 — 同主题）
- [2 Year 25 Ai Projects Summary](ch01/1045-5-ai.html)（2 年 25 个 AI 项目 — 失败方法论对照）
