...
## Ch01.640 DeepSeek V4 Flash & Pro: Million-Token Context and Trillion-Parameter Inference
...
- [Ai Infra Llm Efficient Inference Vllm](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-infra-llm-efficient-inference-vllm.md) — LLM 高效推理基础设施综述（vLLM 推荐 0.20.0+）
- [Recent Developments In Llm Architectures Kv Sharing Mhc And Compressed Attention](https://github.com/QianJinGuo/wiki-public/blob/main/entities/recent-developments-in-llm-architectures-kv-sharing-mhc-and-compressed-attention.md) — LLM 架构最新进展：KV Sharing、mHC 与压缩注意力
- [Deepseek Moe Parallel Strategy](https://github.com/QianJinGuo/wiki-public/blob/main/entities/deepseek-moe-parallel-strategy.md) — DeepSeek MoE 并行策略
- [Msa Sparse Attention Three Kingdoms Huashu](https://github.com/QianJinGuo/wiki-public/blob/main/entities/msa-sparse-attention-three-kingdoms-huashu.md) — MSA 稀疏注意力（三国华术）
- [Kimi Attention Residuals Prenorm Dilution Block Attnres](https://github.com/QianJinGuo/wiki-public/blob/main/entities/kimi-attention-residuals-prenorm-dilution-block-attnres.md) — Kimi 注意力残差与 PreNorm 稀释
- [2026 Llm Rl Algorithms Deeplog Imba Ppo Dpo Grpo Marl](https://github.com/QianJinGuo/wiki-public/blob/main/entities/2026-llm-rl-algorithms-deeplog-imba-ppo-dpo-grpo-marl.md) — 2026 LLM RL 算法综述（DeepSeek V4 训练方法背景）
