...
这与 [DeepSeek MoE 并行策略](ch01/774-deepseek.md)、[DeepSeek 成本迁移系统层 KV Cache Harness](ch01/774-deepseek.md)、[DeepSeek V4 Training 58-page Paper Deep Dive](ch04/310-ai.md) 等文章形成完整图景。
...
- [DeepSeek V4 Pro vs Claude](ch01/380-claude.md) 关注对比评测
...
- [DeepSeek V4 DS4C / Antirez 本地推理](ch09/041-deepseek-v4-ds4c-antirez-local-inference-qbitai.md) 关注本地部署
- [DeepSeek V4 Training 58-page Paper Deep Dive](ch04/310-ai.md) 关注训练侧
- [DeepSeek Code Harness](ch09/070-deepseek-code-harness.md) 关注 V4 在 Agent / Harness 场景的工程实践
- [DeepSeek Code Harness 竞争者 Tina](ch09/070-deepseek-code-harness.md) 关注竞品分析
...
- **关注 V4 在 Agent / Harness 场景的工程实践**——V4 的能力需要 harness 配合才能在生产中稳定输出，关注 [DeepSeek Code Harness](ch09/070-deepseek-code-harness.md) 等。
...
- [DeepSeek V4 DS4C / Antirez 本地推理](ch09/041-deepseek-v4-ds4c-antirez-local-inference-qbitai.md)
- [DeepSeek V4 Training 58-page Paper Deep Dive](ch04/310-ai.md)
- [DeepSeek MoE 并行策略](ch01/774-deepseek.md)
- [DeepSeek 成本迁移系统层 KV Cache Harness](ch01/774-deepseek.md)
