...
## Ch01.779 AI-powered BI with Snowflake and Amazon QuickSight
...
- **[SchemaFlow](../ch04/298-agentic.html)**：Agent 驱动的数据库 SQL 生成，同样需要语义约束
...
- [Anthropic Data Analysis](ch01/1609-anthropic.html) — LLM 数据分析的另一个视角
