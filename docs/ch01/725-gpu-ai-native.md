...
## Ch01.725 算力风洞：GPU 集群的 AI Native 稳定性验证系统
...
参见 [AI Infra 运维智能体基准](ch01/767-ai-infra.html) — GPU 集群故障诊断领域的前沿进展。
...
- [LLM 超算协议](ch01/391-openai.html) — 解决超大集群训练不稳定性的网络协议层面方案，与算力风洞在 GPU 集群稳定性领域互补
- [AI Infra 运维智能体基准](ch01/767-ai-infra.html) — 首个针对 GPU 集群故障的 AI Infra 运维智能体评测基准
