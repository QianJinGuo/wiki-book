...
## Ch01.545 Checkmarx Jenkins plugin compromised in new supply chain attack

> 📊 Level ⭐⭐ | 11.6KB | `entities/checkmarx-jenkins-plugin-compromised-in-new-supply-chain-attack.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/checkmarx-jenkins-plugin-compromised-in-new-supply-chain-attack.md)
