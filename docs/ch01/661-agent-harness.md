...
## Ch01.661 Agent Harness 解析：智能体架构深度拆解
...
- [Claude Code Dynamic Workflows Source Code Architecture](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-dynamic-workflows-source-code-architecture.md)
