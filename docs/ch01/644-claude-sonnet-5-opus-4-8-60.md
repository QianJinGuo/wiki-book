...
## Ch01.644 Claude Sonnet 5 发布，性能接近 Opus 4.8，价格只有60%
...
- [Anthropic Claude Code 木马遥测安全事件](ch01/789-anthropic-claude-code.html) — Sonnet 5 的安全改进与 Anthropic 整体的安全策略演进
