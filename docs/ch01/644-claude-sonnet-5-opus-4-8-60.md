...
这与 [开源 AI 的成本优势讨论](ch01/029-banning-open-source-ai-would-be-a-mistake-interconnects.html) 中提到的模型推理成本下降对 AI 普及的推动作用一致——但 Sonnet 5 走的是"闭源高端模型降价"路径，而非开源模型替代。
...
- [Anthropic Claude Code 木马遥测安全事件](ch01/802-anthropic-claude-code.html) — Sonnet 5 的安全改进与 Anthropic 整体的安全策略演进
- [Claude Code 学术文献综述](../ch03/085-claude-code.html) — Sonnet 5 在编码场景中的实际应用案例
- [Agent 评测方法论与体系设计](../ch03/006-agent.html) — SWE-bench、HLE、OSWorld 等评测基准的设计原理
