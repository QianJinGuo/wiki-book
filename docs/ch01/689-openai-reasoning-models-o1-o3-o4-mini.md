...
## Ch01.689 OpenAI Reasoning Models (o1/o3/o4-mini)
...
- [Recent Developments in LLM Architectures](https://github.com/QianJinGuo/wiki-public/blob/main/entities/recent_developments_in_llm_architectures.md) — 推理时代对 KV-cache 等架构的优化
- → 原文存档
