...
- [Harness Engineering](../ch05-010-harness-engineering-ai-从-聪明-到-可靠-的第三代工程范式/) — Agent 差异化来自 harness 而非模型
- [Claw-SWE-Bench](../ch09-049-claw-swe-bench-首个独立测量harness对编程agent影响的基准/) — harness 独立变量实证
- [Agent Eval WalleZhang](../ch04-141-agenteval-yaml驱动的agent评测框架/)
