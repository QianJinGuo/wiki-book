...
## Ch01.488 告别“氛围编程”：基于 Harness 治理和 SDD 的团队级 AI 研发范式演进与实践
...
- [基于 Harness + SDD + 多仓管理模式的 AI 全栈开发实践](../ch05/018-harness.html)
...
- [SkillOS: Learning Skill Curation for Self-Evolving Agents](../ch04/146-skillos-learning-skill-curation-for-self-evolving-agents.html)
...
- [RAG深度解析：分块、向量化、召回、重排，才是"蒸馏同事skill"的关键](../ch04/270-skill.html)
...
- [吴恩达：AI 将最先杀死前端](../ch05/091-ai.html)
