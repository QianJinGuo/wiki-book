...
## 延伸概念
- [DeepSeek Visual Primitives](../ch09/189-deepseek-visual-primitives.html) — 视觉原语推理
- [SensNova U1](ch01/334-1.html) — 商汤多模态模型
- [NVIDIA 多模态 RAG](ch01/1266-rag.html) — 多模态知识系统
- [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/laser-acl2026-latent-superposition-visual-reasoning.md)
...
- [Chroma To Qdrant 1M Vector Migration](ch01/334-1.html)
- [Unlocking Ai Flexibility In Europe A Guide To Cross Region I](../ch09/174-unlocking-ai-flexibility-in-europe-a-guide-to-cross-region.html)
