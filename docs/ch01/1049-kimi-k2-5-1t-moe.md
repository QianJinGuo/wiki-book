...
## Ch01.1049 Kimi K2.5 架构创新 — 1T MoE 一层路由 + 三能力跃迁
...
- [Kimi K2.6 Agent Database](ch03/044-agent.md) — K2.6 的 TiDB Cloud 基础设施实践
...
- [DeepSeek MoE](ch01/777-deepseek.md) — DeepSeek MoE 架构对比
...
- [MiMo Code](ch05/009-harness.md) — 类似的全开源策略对比
