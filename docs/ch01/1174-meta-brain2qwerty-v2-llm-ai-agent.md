...
## Ch01.1174 Meta Brain2Qwerty v2: 非侵入式脑机接口解码，LLM微调+AI Agent优化，代码全开源
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/meta-brain2qwerty-v2-bci-2026.md)
→ [Meta脑机接口 Nature 子刊报道](ch01/956-20.html)
