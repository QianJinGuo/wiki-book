...
## 相关实体
- [独家对话罗福莉：AI范式已然巨变！](https://github.com/QianJinGuo/wiki-public/blob/main/entities/luo-fuli-ai-paradigm-shift.md)
- [agentic code review](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agentic-code-review-addyosmani.md)
- [apple foundation models](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic-apple-foundation-models-claude.md)
...
- [a backdoor in a linkedin job offer](https://github.com/QianJinGuo/wiki-public/blob/main/entities/roman-linkedin-backdoor-supply-chain.md)
- [every frame perfect](https://github.com/QianJinGuo/wiki-public/blob/main/entities/tonsky-every-frame-perfect.md)
