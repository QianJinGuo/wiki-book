...
## Ch01.1000 Agent Harness 综述：同一个模型，为什么做出来的 Agent 差这么远

> 📊 Level ⭐⭐ | 4.4KB | `entities/agent-harness-综述同一个模型为什么做出来的-agent-差这么远.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/agent-harness-综述同一个模型为什么做出来的-agent-差这么远.md)
