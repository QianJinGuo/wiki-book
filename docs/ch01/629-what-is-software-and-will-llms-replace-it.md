...
这与 [Anthropic 数据分析](ch01/1299-anthropic.html) 的实践相呼应——即使 LLM 能生成分析，数据的结构化组织仍然是前提。
...
- [Agent Harnesses](../ch04/687-agent-harnesses-are-dead-long-live-agent-harnesses.html) — Agent 架构的演进
- [Claude Code Workflows](../ch09/092-claude-code-dynamic-workflows.html) — Agent 工作流设计
- [本文实体](ch01/882-llm.html) — Tomassetti 的分析
