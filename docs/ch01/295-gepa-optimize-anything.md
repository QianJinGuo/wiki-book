...
## Ch01.295 Gepa Optimize Anything
...
- [Skill RAG 清华 SRA](ch04/271-skill.html) — 技能增强型检索
...
**[Hermes Agent Skill 互优化](ch04/271-skill.html)**（KK大叔 4 轮互优化实验，2026-06）是 GEPA 通用优化方法论在 **Skill 自进化场景**的具体落地。
