...
## Ch01.281 LLM 主题 = 生成变量 — 别把 LLM 提取的主题当成真实变量（William Gieng 因果推断方法论）
...
- [Video Rag Chunking Strategy](ch01/289-rag.html)（文本 + AI 同源 — 视频 RAG 切片策略）
...
- [Recent Developments In Llm Architectures Jiqizhixin](ch01/1231-llm.html)（LLM 架构最新进展 — 同主题）
- [2 Year 25 Ai Projects Summary](ch01/1052-5-ai.html)（2 年 25 个 AI 项目 — 失败方法论对照）
- [While Breathless In Stodgy Viridian](ch01/559-while-breathless-in-stodgy-viridian.html)（对 LLM 局限的反思同源）
