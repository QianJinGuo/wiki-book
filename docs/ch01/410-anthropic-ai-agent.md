...
## Ch01.410 Anthropic 实战分享：如何让 AI Agent 持续工作几天？

> 📊 Level ⭐⭐ | 10.2KB | `entities/anthropic-long-running-agent-architecture-6h-retroforge.md`
...
这种模式与 [Anthropic 多智能体研究系统](../ch04/546-anthropic-multi-agent-research-system.html) 中的验证者-执行者分离思路一脉相承。
...
这与 [Claude Code 大型代码库团队部署](../ch05/039-agent-harness.html) 中讨论的 Harness 工程实践高度互补。
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/agent-night-overnight-rakuten-vibecoder-2026-07-22.md)

## 相关实体

- [Anthropic Multi Agent Research System](../ch04/546-anthropic-multi-agent-research-system.html)
- [Claude Code Large Codebase Team Deployment Agent Harness](../ch05/039-agent-harness.html)
- [Hidden Technical Debt Agent Harness](../ch05/039-agent-harness.html)
