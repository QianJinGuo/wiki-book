...
- [基于 Bedrock AgentCore 构建企业级应用](../ch11/060-bedrock-agentcore.html) — AWS 生态中 Agent 编排的具体实现路径
- [James 多 Agent 协作模式](../ch03/037-agent.html) — 不同多 Agent 协作架构的对比分析
