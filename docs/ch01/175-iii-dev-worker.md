...
## Ch01.175 III Dev Worker 触发函数架构
...
## 相关实体
- [Anthropic 官方生产级 Agent 最佳实践12 个可复用的 Mcp 设计模式](ch04/502-agent.md)
...
- [Anthropic Long Running Agent Architecture 6H Retroforge](ch04/502-agent.md)
