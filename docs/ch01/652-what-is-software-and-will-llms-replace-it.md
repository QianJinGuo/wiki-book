...
现代 agent 架构（如 [Claude Code](ch03/077-claude-code.html)、Codex）的设计本质上就是这一分层的实现：
...
这与 [Anthropic 数据分析](ch01/742-9.html) 的实践相呼应——即使 LLM 能生成分析，数据的结构化组织仍然是前提。
...
- [Claude Code Workflows](ch03/077-claude-code.html) — Agent 工作流设计
- [本文实体](ch01/1274-llm.html) — Tomassetti 的分析
- [AI Agent Hype](ch05/094-ai.html) — 对 AI agent 过度炒作的冷静分析
