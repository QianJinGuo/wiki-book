...
## Ch01.978 Latest open artifacts (#20): New orgs! New types of models! With Nemotron Super, Sarvam, Cohere Transcribe, & others
...
- [deepseek视觉原语论文：当所有人在堆图像分辨率时，它在堆「指代精度」！](ch01/1146-deepseek.html)
- [dynamically splitting wide partitions in cassandra for time](../ch11/024-dynamically-splitting-wide-partitions-in-cassandra-for-time.html)
- [interconnects ai p open and closed models are on different](../ch05/077-ai.html)
- [reducing container cold start times using soci index on dlam](ch01/1099-reducing-container-cold-start-times-using-soci-index-on-dlam.html)
- [state of routing in model serving](../ch11/174-state-of-routing-in-model-serving.html)
- [the distillation panic](ch01/355-the-distillation-panic.html)
