...
## Ch01.961 当理解成为瓶颈：AI 编程时代的认知债与意图债
...
- [认知债与意图债（英文条目）](../ch05/109-ai.html) — 本实体对应的英文条目
- [认知架构](https://github.com/QianJinGuo/wiki/blob/main/concepts/cognitive-architecture-ai.md) — 系统理解与心智模型
- [Spec-Driven Development](ch01/1214-spec.html) — 用规格外化意图的实践路径
- [Loop Engineering 概念解析](../ch05/122-loop-engineering.html) — 文中提到的 Token 生意与循环范式
