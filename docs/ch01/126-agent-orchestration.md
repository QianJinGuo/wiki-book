...
> 📊 Level ⭐ | 5.0KB | `entities/agent-orchestration.md`
...
- [Multi-Agent 深度思考交易系统](https://github.com/QianJinGuo/wiki-public/blob/main/entities/构建基于多智能体架构的深度思考交易系统.md) — 多 Agent 协作模式的具体实践
- [Agent Harness 工程学调研](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-harness-engineering-survey-etcvlovg-taxonomy.md) — Agent 系统构建的核心架构要素
- [基于 Bedrock AgentCore 构建企业级应用](https://github.com/QianJinGuo/wiki-public/blob/main/entities/building-enterprise-level-with-bedrock-agentcore-and-strands.md) — AWS 生态中 Agent 编排的具体实现路径
- [James 多 Agent 协作模式](https://github.com/QianJinGuo/wiki-public/blob/main/entities/james-multi-agent-collaboration-modes.md) — 不同多 Agent 协作架构的对比分析
