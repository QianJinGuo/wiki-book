...
## Ch01.570 Knowledge Agents: Beat Frontier Models with Better Structure
...
- [Claude Code 动态工作流](../ch09/078-claude-code-dynamic-workflows.md) — Knowledge Agent 的主要使用场景之一
