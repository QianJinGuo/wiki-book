...
## Ch01.1452 Scaling Domain Data Repetition in LLM Pretraining — 域数据重复率随规模扩展
...
该研究直接回应 LLM 训练中的数据工程难题——当高质量域数据供给不足时，重复率该如何设定。它与 [LM 预训练泛化动力学](../ch05/113-ai.html)、[预训练并行与失败记录](../ch05/113-ai.html) 同属 LLM 预训练实证研究前沿，为数据配比与训练预算设计提供可迁移的 scale 规律。
