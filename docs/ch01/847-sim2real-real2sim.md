...
## Ch01.847 李飞飞署名具身新论文：Sim2Real烧不起，Real2Sim量大管饱

> 📊 Level ⭐⭐ | 5.4KB | `entities/李飞飞署名具身新论文sim2real烧不起real2sim量大管饱.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/李飞飞署名具身新论文sim2real烧不起real2sim量大管饱.md)
