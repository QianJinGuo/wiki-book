...
## Ch01.593 现代AI之父新作：13个大模型实测，检索agent真的可信吗？
...
- [Loop Engineering Overview Tech Minimalism](../ch05/005-loop-engineering.html) — Loop Engineering 的编排范式，与 AI 搜索 agent 的可靠性建设相关
- [Alibaba Data Rd Harness Engineering Nl2Sql](../ch05/117-harness-engineering.html) — 阿里 NL2SQL 实践中的幻觉防控策略，与搜索结果的真实性校验互补
