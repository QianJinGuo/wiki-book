...
## Ch01.364 Claude Code and What Comes Next
...
这与 [CrewAI 多 agent 模式](ch04/333-your-first-ai-agent-should-do-one-thing-badly.md)呼应，但更"轻"——subagent 是按需创建，不是预设架构。
...
- 与 [苦味教训](ch04/301-the-bitter-lesson-versus-the-garbage-can.md) 的对照：Claude Code 是"工艺派"——精心设计的 harness + 强大模型。ChatGPT agent 才是"结果训练派"。两者代表了 harness 工程的两种路线。
