...
## Ch01.499 Kimi K3: The Open-Weights Escalation
...
- [6 Months To Live For Open Models](ch01/1345-6-months-to-live-for-open-models.html) — Companion piece on the regulatory timeline that K3's release accelerates
