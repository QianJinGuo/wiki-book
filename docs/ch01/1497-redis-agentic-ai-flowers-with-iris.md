...
## Ch01.1497 Redis agentic AI flowers with Iris
...
## 相关实体
- [Redis 之父为 DeepSeek v4 造推理引擎](ch01/1363-deepseek-v4.html)
...
- [Agent Memory 架构](../ch04/506-perplexity-brain-self-improving-agent-memory-architecture.html)
- [Agentic AI 数据网格与 MCP](../ch04/117-agentic-ai.html)
