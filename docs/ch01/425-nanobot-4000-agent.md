...
这与 [天猫团队的 AGENT.md 持续约定](../ch05/111-ai.html)、Anthropic Skills、Claude Code 的 `.claude/` 目录是同一种范式。**Markdown-as-Config 正在成为 LLM 时代的事实标准**。
...
参见 [working set 管理](../ch05/066-agent-harness.html)。这种模式的代价是**额外的 tool call 延迟**——但对长寿命 Agent 而言，延迟的代价远小于 context 污染的代价。
...
- [Agent Harness Context Management Working Set](../ch05/066-agent-harness.html) — Progressive Loading 与 working set 管理理论
...
- [天猫新品营销技术团队Ai编码实战指南上](../ch05/111-ai.html) — AGENT.md 持续约定模式的实战
- [腾讯研究院Ai速递 20260506](../ch05/111-ai.html) — CL-Bench Life 揭示的"上下文误用"问题，呼应 nanobot 的 progressive loading 设计
