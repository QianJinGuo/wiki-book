...
## Ch01.201 后端架构 AI Friendly 的标准与路径：面向无人值守开发时代的系统重构
...
- [AI Friendly架构](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-friendly-architecture.md)
- [后端for Agent](https://github.com/QianJinGuo/wiki-public/blob/main/entities/backend-for-agent.md)
- 阿里技术标准
