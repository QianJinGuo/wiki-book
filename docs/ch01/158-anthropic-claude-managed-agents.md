...
- [Anthropic PM 的 Agentic 工作流](../ch04/340-anthropic-pm-agentic.html) — 同一时期 Jess Yan 的 PM 视角，同一产品不同维度
...
- [Multica — 开源 Managed Agents 平台](../ch07/056-multica-managed-agents.html)
