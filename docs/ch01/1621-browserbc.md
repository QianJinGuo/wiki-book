...
## Ch01.1621 BrowserBC：人类轨迹蒸馏为可复用技能，让小模型获得大模型的网页操作能力
...
- [Autobrowse：浏览器 Agent 的失忆问题](../ch03/077-skills.html) — 持久化探索 vs 人类轨迹蒸馏，互补方案
- [Browser Use：为 Agent 构建 Runtime Harness](../ch05/080-harness.html) — 浏览器 Agent 的运行时验证
