...
## Ch01.1610 ACL 2026 | AI润色还是代写？中科院四分类检测框架开源，锁定真实作者

> 📊 Level ⭐⭐⭐⭐ | 2.4KB | `entities/acl-2026-ai润色还是代写中科院四分类检测框架开源锁定真实作者.md`
...
- 原文完整记录：[原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/acl-2026-ai润色还是代写中科院四分类检测框架开源锁定真实作者.md)
