...
## 与 [Agent Memory Architecture](../ch04/388-perplexity-brain-self-improving-agent-memory-architecture.md) 的关系
...
- [Agent Self Improvement Six Mechanisms](../ch03/045-agent.md) — Agent 自我改进机制，与 Memory 的"修正+遗忘"机制有交叉
