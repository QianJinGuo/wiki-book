...
## Ch01.976 小白也能搞懂：.claude/ 文件夹里到底应该放什么

> 📊 Level ⭐⭐ | 4.5KB | `entities/小白也能搞懂claude-文件夹里到底应该放什么.md`
...
```mermaid
mindmap
  root(("小白也能搞懂：.claude/ 文件夹里到底应该放什么"))
    太长不看版
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/小白也能搞懂claude-文件夹里到底应该放什么.md)
