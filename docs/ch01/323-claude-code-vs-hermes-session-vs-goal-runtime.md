...
## Ch01.323 Claude Code vs Hermes — Session 工程师 vs Goal Runtime
...
| 实体 | 角度 | 互补性 |
|------|------|------|
| [Harness 7 Layers OpenClaw/Hermes/Claude Code](ch03/074-claude-code.md) | 3 工具 × 7 层 harness 视角 | **互补** (本实体: 2 工具 × 6 维生命周期) |
| [Hermes 9 Module 架构](ch01/342-hermes-9-module-architecture-winty.md) | Hermes 源码级 | 互补 (本实体: 跨工具对比) |
| [Claude Code Agentic Harness](ch03/074-claude-code.md) | CC 内部 harness 模式 | 互补 (本实体: CC vs Hermes 外部对比) |
| [Hermes Goal Runtime 架构](ch03/044-agent.md) | Goal-in-loop 实现 | **直接相关** (本实体 Goal 概念的实现) |
