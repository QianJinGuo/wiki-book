...
- [Anthropic AI Gateways vs MCP Gateways](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-gateways-vs-mcp-gateways-what-security-teams-need-to-know.md) — MCP 安全架构分析（protocol 概念另见 ai-gateways-vs-mcp-gateways 页面）
