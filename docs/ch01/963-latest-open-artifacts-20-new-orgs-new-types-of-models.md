...
## Ch01.963 Latest open artifacts (#20): New orgs! New types of models! With Nemotron Super, Sarvam, Cohere Transcribe, & others
...
- [deepseek视觉原语论文：当所有人在堆图像分辨率时，它在堆「指代精度」！](ch01/1125-deepseek.md)
...
- [interconnects ai p open and closed models are on different](../ch04/229-ai.md)
- [reducing container cold start times using soci index on dlam](ch01/1084-reducing-container-cold-start-times-using-soci-index-on-dlam.md)
- [state of routing in model serving](../ch11/174-state-of-routing-in-model-serving.md)
- [the distillation panic](ch01/597-the-distillation-panic.md)
