...
## Ch01.137 Gemini 3.5 Flash: more expensive, but Google plan to use it for everything

> 📊 Level ⭐ | 4.8KB | `entities/gemini-35-flash-more-expensive-but-google-plan-to-use-it-for-everything.md`
...
**2. Google 战略：用高性能模型覆盖全部产品线，免费产品也不例外**^[].md]
...
**3. 基准测试成本揭示真实成本结构：3.5 Flash 高于 3.1 Pro Preview**^[].md]
...
**4. Interactions API 的发布标志着 AI API 迈向有状态化**^[].md]
...
→ [[raw/articles/gemini-35-flash-more-expensive-but-google-plan-to-use-it-for-everything|原文存档]
