...
> 📊 Level ⭐⭐⭐ | 8.2KB | `entities/vera-arrives-nvidia-s-first-cpu-built-for-agents-lands-at-top-ai-labs.md`
...
- [Nvidia Edge First Llms Av Robotics](199-nvidia-edge-first-llms-av-robotics.html) — NVIDIA 边缘 LLM 与机器人场景
- [Anthropic Demystifying Evals For Ai Agents](../ch04/068-anthropic-demystifying-evals-for-ai-agents.html) — Anthropic 的 Agent 评估实践
