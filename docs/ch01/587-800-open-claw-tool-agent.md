...
## Ch01.587 800行代码实现 Open Claw 的 Tool、消息总线、子Agent管理架构

> 📊 Level ⭐⭐⭐⭐ | 40.1KB | `entities/800行代码实现-open-claw-的-tool消息总线子agent管理架构.md`
...
- [iii.dev Worker/Trigger/Function 架构](https://github.com/QianJinGuo/wiki-public/blob/main/entities/iii-dev-worker-trigger-function.md) — "Harness 就是后端"：iii 对后端原语的抽象（Worker/Trigger/Function）与 OpenClaw 的薄抽象哲学高度一致，都强调基础设施应该是透明的、可组合的
- [OpenClaw Tool/消息总线/子Agent管理架构](https://github.com/QianJinGuo/wiki-public/blob/main/entities/open-claw-tool-bus-subagent-architecture.md) — 800行代码实现的 OpenClaw 核心架构：Tool 抽象、MessageBus、SubagentManager、REPL 主循环
