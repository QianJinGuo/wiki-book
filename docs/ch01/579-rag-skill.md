...
## Ch01.579 RAG深度解析：分块、向量化、召回、重排，才是"蒸馏同事skill"的关键
...
- [Codeindex · 让大模型更好地理解你的代码](ch01/426-codeindex.html)
- [使用 Agent Skills 做知识库检索，能比传统 RAG 效果更好吗？](../ch04/384-agent-skills.html)
