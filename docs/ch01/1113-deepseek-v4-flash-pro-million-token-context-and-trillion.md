...
## Ch01.1113 DeepSeek V4 Flash & Pro: Million-Token Context and Trillion-Parameter Inference
...
- [pithtrain：陈天奇 + cmu flame center 推出的 agent-native moe 训练框架（1](ch04/277-ai.md)
...
- [Ai Infra Llm Efficient Inference Vllm](ch04/277-ai.md) — LLM 高效推理基础设施综述（vLLM 推荐 0.20.0+）
...
- [Deepseek Moe Parallel Strategy](ch01/923-deepseek.md) — DeepSeek MoE 并行策略
