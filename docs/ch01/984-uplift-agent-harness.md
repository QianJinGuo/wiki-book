...
## Ch01.984 高德 Uplift 模型迭代 Agent：长时间运行 Harness
...
- [xz, two years on: what scanners still cannot catch](ch01/657-xz.html)
- [一个 mission 跑 16 天、烧 7.78 亿 token：factory 公开了多 agent 系统的构建哲学](../ch04/162-factory-missions.html)
- [gemma 4 and what makes an open model succeed](ch01/710-gemma-4-and-what-makes-an-open-model-succeed.html)
- [model-harness-fit-agent-harness](ch01/293-model-harness-fit-agent.html)
