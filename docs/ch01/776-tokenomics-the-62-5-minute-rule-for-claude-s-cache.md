...
## Ch01.776 Tokenomics: the 62.5-minute rule for Claude's cache
...
--- See also [Claude Code Architecture](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-architecture.md)
