...
## Ch01.1133 用 LiteLLM WebSearch Interception 集成 AWS 托管的 Amazon Bedrock AgentCore Web Search 能力

> 📊 Level ⭐⭐ | 5.4KB | `entities/用-litellm-websearch-interception-集成-aws-托管的-amazon-bedrock-agentcore-web-search-.md`
...
-> [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/用-litellm-websearch-interception-集成-aws-托管的-amazon-bedrock-agentcore-web-search-.md)
