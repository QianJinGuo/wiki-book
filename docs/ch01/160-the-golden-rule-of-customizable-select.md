...
## Ch01.160 The golden rule of Customizable Select
...
## 相关实体
- [tokenomics: the 62.5-minute rule for claude](https://github.com/QianJinGuo/wiki/blob/main/entities/anthropic_cache_tokenomics.md)
