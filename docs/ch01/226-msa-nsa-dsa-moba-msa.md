...
- [DeepSeek V4 Flash Pro 1M 上下文](ch01/1053-deepseek-v4-flash-pro.html) — 压得狠路线的最新代表
- [DeepSeek V4 训练方法学](ch01/681-deepseek-v4.html) — 训练配方对比
...
- [近期 LLM 架构进展](ch01/610-llm.html) — 注意力架构的近期综述
