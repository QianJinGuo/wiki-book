...
## Ch01.723 面向大型代码库的 Claude Code 团队落地经验与扩展策略（Agent Harness）
...
- [一文带你弄懂 Harness Engineering](../ch05/066-harness-engineering.html)
- [腾讯 Harness 工程团队规范](../ch05/066-harness-engineering.html)
- [小米 Harness 工程：从 prompt 到 hook 到 plugin](../ch05/066-harness-engineering.html)
