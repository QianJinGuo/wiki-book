...
## Ch01.406 ICLR 2026 Scenethesis：英伟达 & 普渡大学用 Agent 闭环实现文生 3D
...
- [Yann Dubois Openai Post Training Matt Turck Interview](ch01/391-openai.html) — OpenAI 后训练方法访谈
- [Yann Lecun Llm Not Intelligence Jepa](ch01/637-llm.html) — LeCun 关于 LLM 与空间智能的批判
- [2026 Llm Rl Algorithms Deeplog Imba Ppo Dpo Grpo Marl](ch01/637-llm.html) — 2026 LLM RL 算法综述
- [Scale Robot Reinforcement Learning With Nvidia Isaac Lab On ](ch01/1175-scale-robot-reinforcement-learning-with-nvidia-isaac-lab-on.html) — NVIDIA Isaac Lab 机器人 RL 扩展
