...
## Ch01.293 Gemma 4 Multi Token Prediction Drafters
...
## 相关实体
- [Aws Fsx Lustre Gpudirect Sharded Llm Loading](ch01/1171-llm.md)- [tliveomni vllm 适配与量化方案](ch01/1171-llm.md)
- [diffusiongemma：扩散式文本生成模型（google 26b moe，4× 推理加速）](ch01/216-0.md)
