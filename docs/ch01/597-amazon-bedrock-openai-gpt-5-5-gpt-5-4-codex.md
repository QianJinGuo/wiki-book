...
在 [Amazon Bedrock AgentCore](../ch04/586-amazon-bedrock-agentcore-harness-ga-api-agent.html) 中，可以将 OpenAI 模型配置为 Agent 的推理引擎，实现完整的工具调用、记忆管理和多步推理：
...
Bedrock 的一大优势是可以在同一平台上混合使用 OpenAI 和 [Anthropic Claude](ch01/1586-anthropic.html) 模型。典型场景：
...
- [Amazon Bedrock AgentCore Harness GA](../ch04/586-amazon-bedrock-agentcore-harness-ga-api-agent.html)
...
- [Deep Agents on Bedrock AgentCore](../ch04/618-agent-orchestration.html)
