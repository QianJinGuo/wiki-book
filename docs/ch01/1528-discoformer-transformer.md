...
## Ch01.1528 DiScoFormer: 单一 Transformer 实现跨分布密度与分数估计
...
这直接关联到 [DiffusionGemma](ch01/867-gemma-4.html) 等扩散模型架构的分数估计组件。
...
- [DiffusionGemma](ch01/867-gemma-4.html)
...
- [HuggingFace Torch MLP Fusion](ch01/1135-20.html)
