...
- [豆包 Seed 2.0 Lite：Agent 多模态](../ch03/006-agent.html) — Seed2.0 的 Lite 变体，专注 Agent 感官层
- [豆包 Seed 2.0 Lite](https://github.com/QianJinGuo/wiki/blob/main/entities/doubao-seed-2-lite.md) — Seed 2.0 Lite 版本总览
- [ByteDance Trae Harness 工程指南](ch01/900-trae-harness-engineering.html) — ByteDance 相关工程实践
- [Agent-World](../ch04/044-agent-world.html) — Agent 训练环境扩展，提及 Seed2.0 作为对比基线
