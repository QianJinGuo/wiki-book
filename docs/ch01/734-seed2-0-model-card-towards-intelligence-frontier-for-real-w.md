...
## Ch01.734 Seed2.0 Model Card: Towards Intelligence Frontier for Real-World Complexity
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/seed2-0-model-card-bytedance-seed-2026.md)

## 相关实体

- [豆包 Seed 2.0 Lite：Agent 多模态](../ch03/037-agent.html) — Seed2.0 的 Lite 变体，专注 Agent 感官层
- [豆包 Seed 2.0 Lite](https://github.com/QianJinGuo/wiki/blob/main/entities/doubao-seed-2-lite.md) — Seed 2.0 Lite 版本总览
- [ByteDance Trae Harness 工程指南](ch01/898-trae-harness-engineering.html) — ByteDance 相关工程实践
- [Agent-World](../ch04/809-agent-world.html) — Agent 训练环境扩展，提及 Seed2.0 作为对比基线
