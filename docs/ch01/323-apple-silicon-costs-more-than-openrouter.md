...
[ds4.c 项目](../ch09/037-deepseek-v4-ds4c-antirez.html)（Redis 作者 antirez 开发的 DeepSeek V4 专用推理引擎）展示了另一种路线：
...
- [离线 LLM 能量使用](451-llm.html) — 同一作者的另一篇相关文章
- [LightSeek TokenSpeed](../ch12/002-token.html) — 推理引擎优化技术（Speculative Decoding、KV Cache、Continuous Batching）
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/apple-silicon-costs-more-than-openrouter.md)
