...
```mermaid
mindmap
  root(("Claude Code 七层记忆架构"))
    文章概要
    核心问题 上下文窗口 LLM 的金鱼记忆
    层记忆架构详解
      设计原则 防御金字塔
      第1层 工具结果存储 日常清洁工
      第2层 微压缩 每轮对话前的日常保洁
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/claude-code-7-layer-memory-architecture.md)
