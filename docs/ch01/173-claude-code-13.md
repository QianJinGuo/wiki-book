...
- [Prompt Caching 工程实践](131-anthropic-prompt-caching-claude-code.html) — 与 microCompact 相关
- [Agent Harness 12 组件](../ch05/035-agent-harness.html) — Harness 通用框架
- [Claude Code Subagent 上下文卫生](../ch04/249-claude-code-subagent.html) — Sub-Agent 设计
- [原文存档](https://mp.weixin.qq.com/s/bMjXlD-OcnFW-wuN1yW8FA)
