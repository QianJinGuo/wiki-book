...
## Ch01.581 给 AI 做工作面试：Mollick 的模型评估方法论
...
- [Jagged Ai Frontier Mollick](ch04/277-ai.md) — Jagged Frontier 概念（同一作者，更深入的能力地图分析）
- [Opinionated Guide Ai Right Now Mollick](ch04/277-ai.md) — 模型选择实用指南（同一作者，同期不同议题）
