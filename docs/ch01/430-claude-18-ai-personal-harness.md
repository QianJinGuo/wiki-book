...
## Ch01.430 用好 Claude 的 18 个动作：搭一个个人 AI 工作台（Personal Harness）
...
- [Claude Code 源码中的 Agent Harness 构建](../ch05/058-agent-harness.html)
- [Agent 记忆系统的工程实践](../ch03/035-agent.html)
