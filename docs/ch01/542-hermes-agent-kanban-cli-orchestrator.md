...
## Ch01.542 Hermes-Agent 官方 Kanban 深度实测：让商业 CLI 工具当 Orchestrator
...
- [Hermes Agent Goal And Kanban](../ch04/369-hermes-agent-goal.html) — Hermes Agent 基础教程（/goal + Kanban）
