...
## Ch01.169 800行代码实现 Open Claw 的 Tool、消息总线、子Agent管理架构
...
- [OpenClaw Tool/消息总线/子Agent管理架构](ch04/503-agent.md) — 800行代码实现的 OpenClaw 核心架构：Tool 抽象、MessageBus、SubagentManager、REPL 主循环
