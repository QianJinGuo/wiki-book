...
```mermaid
mindmap
  root(("Claude 做方案 Codex 写代码 多模型协作怎么交接才稳"))
...
- [Claude Code Multi Agent Collaboration 多智能体协作体系设计](../ch03/078-claude-code.html) — 多智能体协作体系设计
- [Ai Agent Loops Claude Code Codex](../ch03/078-claude-code.html) — AI Agent 循环与代码生成
