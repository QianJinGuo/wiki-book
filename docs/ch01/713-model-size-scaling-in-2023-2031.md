...
## Ch01.713 Model Size Scaling in 2023-2031
...
- [Moebius](https://github.com/QianJinGuo/wiki-public/blob/main/entities/moebius.md) — 模型压缩的极端案例（0.22B 替代 11.9B）
- MoE（Mixture of Experts）架构是 Sparsity 实现的核心技术
- Chinchilla Scaling Law 是本文修正和扩展的理论基础
- [模型服务路由](../ch11/143-state-of-routing-in-model-serving.html) — 推理时的模型选择策略
