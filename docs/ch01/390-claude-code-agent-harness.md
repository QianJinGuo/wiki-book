...
- [Claude Code 深度解析](ch03/084-claude-code.html) — Claude Code 架构的另一次深度解读
- [Claude Code Dynamic Workflows](ch03/084-claude-code.html) — AgentTool 子智能体 + Dynamic Workflow 范式
...
- [Harness Engineering 一文](ch05/100-ai.html) — Harness 概念的系统阐释
