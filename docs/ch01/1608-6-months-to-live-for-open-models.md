...
## Ch01.1608 6 Months to Live for Open Models
...
- [Kimi K3 The Open Weights Escalation](ch01/608-kimi-k3-the-open-weights-escalation.html) — Companion piece on Kimi K3 as the strongest open model ever released, directly relevant to the frontier capability debate
