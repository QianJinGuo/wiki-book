...
## Ch01.1338 Gemini 3.5 Flash 内置 Computer Use 能力

> 📊 Level ⭐⭐⭐⭐ | 6.4KB | `entities/gemini-35-flash-computer-use-agent-harness.md`
...
```mermaid
mindmap
  root(("Gemini 35 Flash 内置 Computer Use 能力"))
    架构升级 从独立模型到原生能力
    核心能力矩阵
    安全防护体系
    模型原生的架构意义
