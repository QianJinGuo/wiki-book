...
## Ch01.404 Anthropic 实战分享：如何让 AI Agent 持续工作几天？
...
这种模式与 [Anthropic 多智能体研究系统](../ch04/568-anthropic-multi-agent-research-system.html) 中的验证者-执行者分离思路一脉相承。
...
- [Anthropic Multi Agent Research System](../ch04/568-anthropic-multi-agent-research-system.html)
