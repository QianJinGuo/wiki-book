...
## Ch01.376 Latest open artifacts (#19)：Qwen 3.5、GLM 5、MiniMax 2.5 — 中国实验室的前沿推进
...
- [CybersecQwen 4B](ch12/092-cybersecqwen-4b.md) — Qwen 在安全垂域的专用模型
- [OpenClaw 完全指南](ch03/012-openclaw.md) — Agent 工具栈的实践参考
