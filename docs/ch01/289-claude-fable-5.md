...
- **同 Fable 5 主题**（互补不重叠）：
  ...
  - [Claude Fable 5 Safety Fables (Lambert)](ch01/890-claude-fable-5-and-new-ai-safety-fables.html)（政策视角）
...
- **同护栏 / 安全主题**：
  ...
  - [Enable Safe Agentic Payments with Built-in Guardrails](../ch04/625-enable-safe-agentic-payments-with-built-in-guardrails-using.html)
