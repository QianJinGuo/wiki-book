...
## Ch01.1484 Claude 代码能力的系统工程解析：Constitutional AI + 可验证奖励 RL + 产品飞轮
...
→ 相关实体：[Anthropic LLM 内省意识机制](../ch04/228-anthropic-llm.html)
...
- → [Anthropic LLM 内省意识](../ch04/228-anthropic-llm.html)：Anthropic 的安全研究能力维度
- → [Building Next Claude](ch01/1539-anthropic.html)：Claude 的产品演进方向
