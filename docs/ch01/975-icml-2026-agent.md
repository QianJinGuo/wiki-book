...
## Ch01.975 美团ICML 2026入选论文精选，两场直播聚焦Agent与视频生成

> 📊 Level ⭐⭐ | 4.5KB | `entities/美团icml-2026入选论文精选两场直播聚焦agent与视频生成.md`
...
```mermaid
mindmap
  root(("美团ICML 2026入选论文精选，两场直播聚焦Agen…"))
    **
    ** 01  **
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/美团icml-2026入选论文精选两场直播聚焦agent与视频生成.md)
