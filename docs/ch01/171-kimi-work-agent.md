...
## Ch01.171 Kimi Work：通用 Agent 战场从云端迁移到本地
...
## 相关实体
- [Schemaflow Agentic Database Sql Generation Openai Cookbook](ch04/150-ai.md)
...
### vs [Codex 6 职位插件](ch01/436-codex.md)
- 之前 Codex 还在"加插件拓展能力"
...
- [Karpathy Vibe Coding → Agentic Engineering](ch03/044-agent.md) —— Vibe Coding 原始定义
