...
- [Self Harness Shanghai Ai Lab Agent Improves Harness](ch05/094-ai.html) — 上海人工智能实验室（合作方之一）相关工作
- [Shotstream Streaming Multi Shot Video Cuhk Kling Eccv2026](ch01/913-20.html) — 流式视频生成（与 VideoChat3 的流式视频理解互补）
- [Joyai Vl Interaction Jd Open Source Real Time Video 2026](ch05/094-ai.html) — 京东 JoyAI-VL 实时视频交互开源模型
