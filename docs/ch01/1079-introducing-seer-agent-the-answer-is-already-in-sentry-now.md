...
## Ch01.1079 Introducing Seer Agent: The answer is already in Sentry. Now you can ask for it.
...
- [intercom, now called fin, launches an ai agent whose only jo](../ch04/399-intercom-now-called-fin-launches-an-ai-agent-whose-only-jo.html)
