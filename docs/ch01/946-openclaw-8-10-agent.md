...
## Ch01.946 拆解 OpenClaw 架构（二）：8 个文件 + 10 步流水线，Agent 人格系统的源码级设计

> 📊 Level ⭐⭐ | 4.7KB | `entities/拆解-openclaw-架构二8-个文件-10-步流水线agent-人格系统的源码级设计.md`
...
```mermaid
mindmap
  root(("拆解 OpenClaw 架构（二）：8 个文件 + 10…"))
    不只是 SOUL.md：8 个文件构成完整的'…
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/拆解-openclaw-架构二8-个文件-10-步流水线agent-人格系统的源码级设计.md)
