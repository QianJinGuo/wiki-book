...
- [LLM Fine-Tuning Cost Breakdown](ch01/1135-llm.html)
- [Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](../ch04/294-agentic.html)
- [Anthropic Institute《When AI builds itself》深度解读：AI 进入 AI 研发执行层、瓶颈迁移与研发级 Harness（架构师 JiaGouX）](ch01/776-anthropic.html)
...
- [SFT+DPO 双阶段微调：Qwen3-1.7B Tool Calling 精度提升方案](ch01/432-aws.html)
