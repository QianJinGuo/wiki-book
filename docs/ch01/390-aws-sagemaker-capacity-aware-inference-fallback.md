...
## Ch01.390 AWS Sagemaker Capacity Aware Inference Fallback
...
- [GRPO+RLVR: Qwen数学推理3.7x提升的工程细节](https://github.com/QianJinGuo/wiki/blob/main/entities/aws-grpo-rlvr-sagemaker-math-reasoning.md)
