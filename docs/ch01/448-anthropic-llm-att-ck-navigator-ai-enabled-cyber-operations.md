...
本文与 [N-days Frontier Agent 研究](../ch04/313-anthropic-n-days-frontier-agent-vulnerability-research.html) 构成 Anthropic 2026-06 的**双联报告**：
...
- → [同 Anthropic 红队研究：前沿模型 N-day 利用能力](../ch04/313-anthropic-n-days-frontier-agent-vulnerability-research.html)
