...
## Ch01.603 MSA 稀疏注意力三国杀：NSA / DSA / MoBA / MSA 四方案深度对比

> 📊 Level ⭐⭐⭐⭐ | 21.1KB | `entities/msa-sparse-attention-three-kingdoms-huashu.md`

# MSA 稀疏注意力三国杀：NSA / DSA / MoBA / MSA 四方案深度对比

> 本实体整理自 原文存档，并参考 MiniMax M3 论文 *MiniMax Sparse Attention*（https://github.com/MiniMax-AI/MSA/blob/main/docs/MiniMaxSparseAttention.pdf ）。
...
1. 给块内每个 token 打分
2. 取**块内最高分**当这块的分（论文叫 **block max pooling**）
...
**16 块 × 128 token = 每生成一个词固定只精算 2048 个 token**——不管上下文是 10 万还是 100 万。**预算焊死**就是省钱的核心。
...
**效果**：索引分支挑出来的块，覆盖了主分支**九成以上**的 attention 权重——用结果说话。
...
- [MiniMax M3 开源 Frontier 模型](https://github.com/QianJinGuo/wiki-public/blob/main/entities/minimax-m3-frontier-open-source-model.md) — MSA 是 M3 的核心架构创新
- [DeepSeek V4 Flash Pro 1M 上下文](https://github.com/QianJinGuo/wiki-public/blob/main/entities/deepseek-v4-flash-pro-通往百万级上下文与万亿参数推理的新纪元-v2.md) — 压得狠路线的最新代表
- [DeepSeek V4 训练方法学](https://github.com/QianJinGuo/wiki-public/blob/main/entities/deepseek-v4-training-methodology.md) — 训练配方对比
...
- [近期 LLM 架构进展](https://github.com/QianJinGuo/wiki-public/blob/main/entities/recent-developments-in-llm-architectures-jiqizhixin.md) — 注意力架构的近期综述
...
- [M3 开源三件套](https://github.com/QianJinGuo/wiki-public/blob/main/entities/minimax-m3-frontier-three-set-open-source.md) — 同一文章的不同角度解读
