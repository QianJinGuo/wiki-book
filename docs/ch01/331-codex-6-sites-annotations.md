...
## Ch01.331 Codex 三件套：6 职位插件 + Sites + Annotations
...
- 符合 [Meta Skill](../ch07/024-meta-skill.html) 抽象层
...
## 相关对照
- [Codex Goal Agent Runtime](../ch04/107-codex-goal-agent.html)
- [Codex Goal 实现拆解](../ch09/047-codex-goal.html)
- [Codex Computer Use](../ch09/116-codex-can-now-control-other-desktop-devices-via-computer-use.html)
- [Codex 自主赚钱](ch01/529-codex.html)
- [Claude Code vs Codex 上下文架构](../ch03/075-claude-code.html)
- [Meta Skill](../ch07/024-meta-skill.html)（Skill 2.0 抽象）
- [扣子 3.0 协作系统](ch01/1109-3-0.html)（同类协作产品）
...
- [Meta Skill](../ch07/024-meta-skill.html) —— Skill 2.0 抽象层理论，解释为何"1 插件 = N 原子 Skill × M 应用集成"是技能演进的必然方向。
