...
这印证了 [Harness Engineering](../ch05/065-harness-engineering.html) 的核心原则：Agent 的能力越强，控制平面的治理就越不能松懈。Claude Science 的逐项授权机制和审查智能体正是这一原则在产品层面的体现。
...
- [Anthropic 输出验证](../ch09/103-anthropic-8x.html) — Anthropic 的验证与质量控制理念
