...
## Ch01.542 Mollick AI 进展的 32 只水獭基准
...
- `[Jagged Ai Frontier Mollick](../ch04/229-ai.md)` — Mollick 锯齿前沿理论（实体待建）
- `[Mass Intelligence](ch01/520-mass-intelligence-ai.md)` — 群体智能边界（实体待建）

## 相关实体

- [fusedash -  generative analytics platform | ai dashboard sof](ch01/377-fusedash-generative-analytics-platform-ai-dashboard-sof.md)
