...
## Ch01.568 QoderWork Skills 开发实践：从传统数科到 AI 数科的转型探索-我的Skills进阶之旅
...
- [AI Native 开发工作流](../ch05/022-ai-native.html) — Skills 驻留的 AI 开发范式
- [Agent 工程范式](../ch05/042-agent-harness.html) — 从传统开发到 AI Agent 开发的范式转变
