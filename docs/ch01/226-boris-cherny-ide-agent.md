...
这与 [Harness Engineering Core Patterns](../ch05/026-harness-engineering.html) 中"控制面应当外置给人类"的工程原则一致——Human-in-the-Loop 不是降级方案，而是 Agent 系统设计的核心约束。
...
这与 [Claude Code Harness 深度解析](../ch05/059-claude-code-harness.html) 中的 harness 设计哲学一致——harness 的核心价值就是为 Agent 提供持续运行的工程环境，而非一次性对话界面。
...
- [DeepSeek V4 Flash Pro](430-deepseek-v4.html)
- [加速 LLM 模型加载与上下文窗口](422-llm.html)
- [大型表格模型基础](../ch04/052-ai.html)
