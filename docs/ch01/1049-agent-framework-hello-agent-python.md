...
## Ch01.1049 微软 Agent Framework 全栈指南：从 Hello Agent 到生产托管（Python）
...
## 相关实体
- [Microsoft Agent Framework Python Zizhi](../ch04/493-python.html)
...
- [Agent Harness 12 Components 7 Decisions](../ch05/066-agent-harness.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/microsoft-agent-framework-python-full-guide-zizhi.md)
