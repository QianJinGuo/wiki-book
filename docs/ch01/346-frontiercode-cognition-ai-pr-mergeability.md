...
- [ProgramBench](../ch04/162-programbench-agent-benchmark.md) — 程序化编码基准 (与 FrontierCode 的 maintainer-rubric 范式对比)
- [Claude Code Performance Benchmarking](../ch03/075-claude-code.md) — 单 agent 性能基准
