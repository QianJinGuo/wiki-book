...
## Ch01.611 Claude 4/5 Sonnet & Opus Release Notes
...
- [Claude Opus 4.7](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-opus-47.md) — 最新旗舰模型发布
- [Claude Opus 4.7 深度分析](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-opus-4-7-launch.md) — 详细发布分析
- [Anthropic](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic.md) — 模型开发商
