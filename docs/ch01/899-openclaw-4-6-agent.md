...
## Ch01.899 拆解 OpenClaw 架构（五）：4 个工具原语 + 6 层安全策略，一套 Agent 的放权与收权工程

> 📊 Level ⭐⭐ | 5.1KB | `entities/拆解-openclaw-架构五4-个工具原语-6-层安全策略一套-agent-的放权与收权工程.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/拆解-openclaw-架构五4-个工具原语-6-层安全策略一套-agent-的放权与收权工程.md)
