...
## Ch01.814 RAG深度解析：分块、向量化、召回、重排，才是"蒸馏同事skill"的关键
...
- [Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](../ch04/294-agentic.html)
...
- [使用 Agent Skills 做知识库检索，能比传统 RAG 效果更好吗？](../ch04/481-agent-skills.html)
