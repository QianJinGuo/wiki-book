...
## Ch01.939 Open and Closed Models Are on Different Exponentials
...
- 模型经济学
- [Karpathy: Vibe Coding 到 Agentic Engineering](../ch04/183-karpathy-vibe-coding-agentic-engineering.html)
- Anthropic Claude
- OpenAI
- 开源 AI
