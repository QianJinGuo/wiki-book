...
## Ch01.525 Cline releases open-source agent runtime SDK
...
- [腾讯混元Hy3-preview发布](ch01/134-hy3-preview.html)
- [Claude Code 接入自建开源模型：企业私有化与降本实践 | 亚马逊AWS官方博客](../ch03/084-claude-code.html)
- [Codex /goal：长任务Agent的目标运行时](../ch04/243-codex-goal-agent.html)
