...
## Ch01.650 Detecting Misuse with the Claude Compliance API: The Threat Is in the Content
...
- [Agent Security Three-Step Sequence](../ch05/009-harness.md)
- [Agent Harness Observability](../ch05/038-agent-harness.md)
