...
## Ch01.1220 小扎「芒果」生图只输GPT Image 2，没人教它改稿，它自己学会了
...
这一发现与 [Agent 世界模型扩展](ch01/234-agent-world.html) 中讨论的推理时 Scaling 趋势一致，也与 OpenAI o1/o3 系列模型在推理任务上的测试时计算 Scaling 现象同源——说明"用更多计算换取更高质量"是通用范式，不仅适用于语言推理，也适用于视觉生成。
...
- [Meta AI 负责人 Alex Wang 谈 Muse Spark 与 AI 战争](../ch05/085-ai.html) — Meta AI 整体战略
...
- [Agent 世界模型扩展](ch01/234-agent-world.html) — 测试时计算 Scaling 的相关讨论
