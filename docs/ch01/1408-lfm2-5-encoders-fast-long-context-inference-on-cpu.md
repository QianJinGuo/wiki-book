...
LFM2.5-Encoders 与 [LFM2.5-230M](../ch05/101-ai.html)（decoder 小模型，面向边缘部署/Agent 工具调用）同属 LFM2.5 架构家族，但产品线不同：Encoders 是双向编码器，面向理解/分类/路由类任务；230M decoder 面向生成/Agent 场景。
...
- [LFM2.5-230M](../ch05/101-ai.html) — 同家族 decoder 模型
