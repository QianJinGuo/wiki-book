...
这与 [真实的 AI Agent 与真实工作](../ch04/284-real-ai-agents-and-real-work.html) 中关于 AI 在生产环境中的"上半场 vs 下半场"论点形成呼应：AI 擅长的是"执行已知模式"的上半场，而"建立问题框架"的下半场仍然需要人类。
...
- [Rajveerbachkaniwalacom Blog 2026 05 24 On The Difficulty Of Pasting A Pic](ch01/1108-20.html) — 同为 TLDR AI Newsletter 推荐的深度技术分析
...
- [Eclecticlightco 2026 05 29 What Happens In The Log When An App Cra](ch01/1108-20.html) — 技术深度分析系列
