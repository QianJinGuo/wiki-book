...
## Ch01.1467 DeepSeek V4 Flash & Pro: Million-Token Context and Trillion-Parameter Inference
...
- [Ai Infra Llm Efficient Inference Vllm](ch01/1473-ai-infra.html) — LLM 高效推理基础设施综述（vLLM 推荐 0.20.0+）
- [Recent Developments In Llm Architectures Kv Sharing Mhc And Compressed Attention](ch01/1452-recent-developments-in-llm-architectures-kv-sharing-mhc-a.html) — LLM 架构最新进展：KV Sharing、mHC 与压缩注意力
- [Deepseek Moe Parallel Strategy](ch01/1465-deepseek.html) — DeepSeek MoE 并行策略
...
- [Kimi Attention Residuals Prenorm Dilution Block Attnres](ch01/578-kimi.html) — Kimi 注意力残差与 PreNorm 稀释
- [2026 Llm Rl Algorithms Deeplog Imba Ppo Dpo Grpo Marl](ch01/1515-llm.html) — 2026 LLM RL 算法综述（DeepSeek V4 训练方法背景）
