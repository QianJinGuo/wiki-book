...
这与 [开源 AI 的成本优势讨论](ch05/100-ai.html) 中提到的模型推理成本下降对 AI 普及的推动作用一致——但 Sonnet 5 走的是"闭源高端模型降价"路径，而非开源模型替代。
...
- [Anthropic Claude Code 木马遥测安全事件](ch03/084-claude-code.html) — Sonnet 5 的安全改进与 Anthropic 整体的安全策略演进
...
- [禁止开源 AI 将是错误](ch05/100-ai.html) — 模型定价与开源/闭源生态的讨论
