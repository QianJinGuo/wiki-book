...
## Ch01.621 Claude Code vs Hermes — Session 工程师 vs Goal Runtime
...
| 实体 | 角度 | 互补性 |
|------|------|------|
| [Harness 7 Layers OpenClaw/Hermes/Claude Code](https://github.com/QianJinGuo/wiki-public/blob/main/entities/harness-engineering-7-layers-openclaw-hermes-claude-code-p1anu.md) | 3 工具 × 7 层 harness 视角 | **互补** (本实体: 2 工具 × 6 维生命周期) |
| [Hermes 9 Module 架构](https://github.com/QianJinGuo/wiki-public/blob/main/entities/hermes-9-module-architecture.md) | Hermes 源码级 | 互补 (本实体: 跨工具对比) |
| [Claude Code Agentic Harness](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-agentic-harness-design-patterns.md) | CC 内部 harness 模式 | 互补 (本实体: CC vs Hermes 外部对比) |
| [Hermes Goal Runtime 架构](https://github.com/QianJinGuo/wiki-public/blob/main/entities/hermes-agent-goal-runtime-architecture-state-persistence-judge-closed-loop.md) | Goal-in-loop 实现 | **直接相关** (本实体 Goal 概念的实现) |
...
[Harness Engineering](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/harness-engineering-framework.md) 关心的是"这一刀能不能切准"；Persistent Runtime 关心的是"这台机器能不能连续切一周，而且知道什么时候该停"。前者偏工程方法，后者偏系统架构。
