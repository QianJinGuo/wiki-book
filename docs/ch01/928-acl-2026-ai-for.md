...
## Ch01.928 ACL 2026｜AI for聋哑群体，港理工开源思考型手语翻译模型

> 📊 Level ⭐⭐ | 4.0KB | `entities/acl-2026ai-for聋哑群体港理工开源思考型手语翻译模型-1.md`
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/acl-2026ai-for聋哑群体港理工开源思考型手语翻译模型-1.md)
