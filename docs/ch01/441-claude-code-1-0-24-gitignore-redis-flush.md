...
- [Knowledge Work Plugins Anthropic Source Analysis](ch01/1586-anthropic.html)：Anthropic 插件系统深度分析（Anthropic 整体生态视角）
- [Skill Hub Organization Asset Winty](../ch04/348-skill.html)：Skill 治理与生命周期（含 Skill review 流程的具体设计）
