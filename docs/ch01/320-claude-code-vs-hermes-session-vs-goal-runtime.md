...
## Ch01.320 Claude Code vs Hermes — Session 工程师 vs Goal Runtime
...
| [Hermes 9 Module 架构](ch01/250-9.md) | Hermes 源码级 | 互补 (本实体: 跨工具对比) |
| [Claude Code Agentic Harness](../ch03/067-claude-code-agent.md) | CC 内部 harness 模式 | 互补 (本实体: CC vs Hermes 外部对比) |
| [Hermes Goal Runtime 架构](../ch04/351-hermes-agent-goal.md) | Goal-in-loop 实现 | **直接相关** (本实体 Goal 概念的实现) |
