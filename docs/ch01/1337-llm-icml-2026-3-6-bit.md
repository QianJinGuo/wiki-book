...
## Ch01.1337 LLM 记忆容量：ICML 2026 获奖论文揭示每个参数约 3.6 bit
...
- 与 [Loop Engineering](../ch05/005-loop-engineering.html) 中评估器设计的隐含联系：如果模型记忆容量有限且受数据-容量比驱动，那么"模型是否记住了测试数据"就不是一个 binary 问题，而是 continuum 问题
