...
## Ch01.472 AI-powered BI with Snowflake and Amazon QuickSight
...
- **[Data-Native Agents](ch04/428-how-to-build-agents-where-data-already-lives.md)**：Agent 直接在数据平台上运行，语义层是关键基础设施
...
- [Snowflake Agentic Enterprise](ch04/503-agent.md) — Snowflake 的 Agent 平台愿景
