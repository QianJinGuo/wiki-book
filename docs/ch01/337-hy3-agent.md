...
> 📊 Level ⭐⭐⭐ | 7.6KB | `entities/tencent-hunyuan-hy3-full-release.md`
...
- 补充 [腾讯混元新里程碑Hy3 Preview 发布开源Agent 表现全面提升](https://github.com/QianJinGuo/wiki-public/blob/main/entities/腾讯混元新里程碑hy3-preview-发布开源agent-表现全面提升.md)：该实体覆盖 4 月 Hy3 preview 发布，本文覆盖 7 月 Hy3 正式版及多产品落地数据。
