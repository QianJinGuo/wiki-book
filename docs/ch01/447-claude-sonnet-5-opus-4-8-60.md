...
- [Anthropic Claude Code 木马遥测安全事件](ch01/598-anthropic-claude-code.html) — Sonnet 5 的安全改进与 Anthropic 整体的安全策略演进
- [Claude Code 学术文献综述](../ch03/078-claude-code.html) — Sonnet 5 在编码场景中的实际应用案例
