...
## 相关实体
- [Hermes Agent Kanban Deep Test](https://github.com/QianJinGuo/wiki-public/blob/main/entities/hermes-agent-kanban-deep-test.md)
- [Hermes Agent Goal Runtime Architecture](https://github.com/QianJinGuo/wiki-public/blob/main/entities/hermes-agent-goal-runtime-architecture.md)
...
→ [原文存档](https://mp.weixin.qq.com/s/sSpaBEcClrB04JqDgBu0TQ)

## 第 2 来源 — 小红书奥森木：Kanban 调度系统深度拆解

[Hermes Agent 推出 Kanban 多 agent 调度](https://www.xiaohongshu.com/explore/69f9a0df0000000038037336)
...
→ [原文存档](https://www.xiaohongshu.com/explore/69f9a0df0000000038037336)
