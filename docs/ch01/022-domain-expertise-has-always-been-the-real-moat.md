...
这与 [真实的 AI Agent 与真实工作](https://github.com/QianJinGuo/wiki-public/blob/main/entities/real-ai-agents-and-real-work.md) 中关于 AI 在生产环境中的"上半场 vs 下半场"论点形成呼应：AI 擅长的是"执行已知模式"的上半场，而"建立问题框架"的下半场仍然需要人类。
