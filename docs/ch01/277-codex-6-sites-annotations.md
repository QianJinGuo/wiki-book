...
## Ch01.277 Codex 三件套：6 职位插件 + Sites + Annotations
...
- [Codex Computer Use](../ch09/135-codex-can-now-control-other-desktop-devices-via-computer-use.html)
...
- [扣子 3.0 协作系统](ch01/1154-3-0.html)（同类协作产品）
