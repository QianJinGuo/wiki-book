...
## Ch01.172 4秒出图、10秒成片，Google上线两个轻量创作模型

> 📊 Level ⭐ | 2.9KB | `entities/4秒出图10秒成片google上线两个轻量创作模型.md`
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/4秒出图10秒成片google上线两个轻量创作模型.md)
