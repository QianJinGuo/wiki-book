...
## Ch01.182 Claude 做方案，Codex 写代码：多模型协作怎么交接才稳

> 📊 Level ⭐ | 2.9KB | `entities/claude-做方案codex-写代码多模型协作怎么交接才稳.md`
...
- [Agent Harness Context Management Working Set](../ch05/057-agent-harness.html) — 上下文窗口作为运行时工作集的观点
- [Codex 5 Layer Architecture](ch01/518-codex.html) — Codex 的架构设计
- [Claude Code Multi Agent Collaboration 多智能体协作体系设计](../ch03/077-claude-code.html) — 多智能体协作体系设计
- [Ai Agent Loops Claude Code Codex](../ch03/077-claude-code.html) — AI Agent 循环与代码生成
- [Harness 之后 状态边界与失败闭环 若飞](../ch05/009-harness.html) — Harness 工程中的状态与边界管理
