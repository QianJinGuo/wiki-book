...
## Ch01.403 Claude Code and What Comes Next
...
- 与 [苦味教训](ch04/309-the-bitter-lesson-versus-the-garbage-can.md) 的对照：Claude Code 是"工艺派"——精心设计的 harness + 强大模型。ChatGPT agent 才是"结果训练派"。两者代表了 harness 工程的两种路线。
