...
## Ch01.1136 ICML 2026 Position Paper — Transformer 图灵完备性高度依赖上下文管理 (RUC 魏哲巍团队)
...
- [Agent Harness 上下文管理 工作集视角](ch05/009-harness.md) — 工业 Harness 上下文管理实操
...
- [Codex Context Engineering](ch01/542-codex.md)
