...
## Ch01.571 阿里开源PromptEcho：用冻结多模态大模型为文生图训练提供高质量Reward

> 📊 Level ⭐⭐ | 7.9KB | `entities/2026-05-06-阿里开源PromptEcho-用冻结多模态大模型为文生图训练提供高质量Rewar-机器之心.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/2026-05-06-阿里开源PromptEcho-用冻结多模态大模型为文生图训练提供高质量Rewar-机器之心.md)
