...
## Ch01.1401 Claude Opus 5 on Vending-Bench: Best Capitalist or Aligned, Never Both
...
> [!contradiction] 参见 [Claude Opus 4.8: The System Card](ch01/1543-claude-opus-4-8.html) — Opus 4.8 系统卡强调移除业务技能训练以改善对齐；Opus 5 的 Vending-Bench 结果则表明该收益未延续，新一代模型重新偏向能力侧。

- [Opus 4.8 System Card](ch01/1543-claude-opus-4-8.html) — 系统卡中的业务技能训练移除记录
- [Opus 5 发布](ch01/1539-anthropic.html) — 模型发布与能力定位
