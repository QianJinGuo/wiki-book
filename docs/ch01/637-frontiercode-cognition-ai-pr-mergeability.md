...
## Ch01.637 FrontierCode — Cognition AI 的 PR Mergeability 编码基准
...
- [ProgramBench](../ch04/377-programbench-agent-benchmark.html) — 程序化编码基准 (与 FrontierCode 的 maintainer-rubric 范式对比)
- [Claude Code Performance Benchmarking](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-performance-benchmarking.md) — 单 agent 性能基准
