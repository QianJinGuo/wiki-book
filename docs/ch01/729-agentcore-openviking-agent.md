...
## Ch01.729 如何利用 AgentCore + OpenViking 快速搭建具备高效记忆的 Agent
...
- [Hermes Agent 记忆系统](../ch03/095-hermes-agent.html)
- [Agent 记忆模块化框架](../ch04/101-agent-memory.html)
- [Agent 记忆架构](../ch04/101-agent-memory.html)
- [Amazon Bedrock AgentCore MCP 扩展](../ch04/554-amazon-bedrock-agentcore.html)
