...
## Ch01.666 LLM Thonking：推理努力与安全分诊效果的实证研究
...
- [gzip 作为语言模型](ch01/660-gzip.html) — 压缩视角下的推理成本分析
- [Anthropic LLM ATT&CK 导航](../ch04/168-anthropic-llm.html) — LLM 在安全领域的另一应用
- [LLM RL 算法综述](ch01/1270-llm.html) — 推理努力与 RL 训练的关系
