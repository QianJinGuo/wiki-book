...
这与 [Role Confusion](ch01/892-github.html) 研究形成互补——后者提供理论框架（prompt injection 本质是角色混淆），Gray Swan 提供实战工具和方法论。
...
- [Role Confusion](ch01/892-github.html) — Prompt injection 的理论框架
...
- [OpenClaw](../ch04/631-agent-loop.html) — 计算机使用 agent 的安全挑战
