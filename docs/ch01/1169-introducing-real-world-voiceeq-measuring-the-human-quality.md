...
完整技术报告见 arXiv 2607.14846，公开排行榜在 Hugging Face Spaces（HumeAI/rw-voice-eq）。对 [GPT-Live 实时语音的前后端分工](ch01/1526-openai-gpt-live.html) 这类产品架构而言，VoiceEQ 提供的分维度评测（情绪理解 vs 精确复述 vs 表现力）也直接支持了"按场景选模型"的产品决策。
