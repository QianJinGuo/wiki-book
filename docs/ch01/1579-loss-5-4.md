...
## Ch01.1579 免蒸馏，只改一个Loss！5行代码实现扩散模型4步生成

> 📊 Level ⭐⭐⭐ | 2.4KB | `entities/免蒸馏只改一个loss5行代码实现扩散模型4步生成.md`
...
- 原文完整记录：[原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/免蒸馏只改一个loss5行代码实现扩散模型4步生成.md)
