...
## Ch01.527 mtp 加速推理最佳实践在亚马逊云科技中国区使用 llamacpp 部署 qwen36 的实测指南
...
- [llama.cpp 部署](https://github.com/QianJinGuo/wiki/blob/main/entities/llama-cpp-deployment.md) — llama.cpp 推理引擎的部署实践和性能优化
- [Graviton 推理](https://github.com/QianJinGuo/wiki/blob/main/entities/graviton-inference.md) — AWS Graviton 处理器上的 LLM 推理优化
- [MoE 架构](https://github.com/QianJinGuo/wiki/blob/main/entities/moe-architecture.md) — Mixture-of-Experts 模型架构的原理和优势
- [量化技术](https://github.com/QianJinGuo/wiki/blob/main/entities/quantization-techniques.md) — 模型量化方法及其对推理性能的影响
- [投机解码](ch01/1026-spec.html) — Speculative Decoding 与 MTP 的技术对比
