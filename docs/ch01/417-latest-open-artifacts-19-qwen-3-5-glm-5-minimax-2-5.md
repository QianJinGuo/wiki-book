...
## Ch01.417 Latest open artifacts (#19)：Qwen 3.5、GLM 5、MiniMax 2.5 — 中国实验室的前沿推进

> 📊 Level ⭐⭐ | 9.9KB | `entities/latest-open-artifacts-19-qwen-35-glm-5-minimax-25-chinese-la.md`
...
- [DeepSeek V4](ch01/710-deepseek-v4.html) — 业界关注度最高、即将发布的中国前沿模型
- [CybersecQwen 4B](../ch12/102-cybersecqwen-4b.html) — Qwen 在安全垂域的专用模型
- [OpenClaw 完全指南](../ch11/237-openclaw.html) — Agent 工具栈的实践参考
- [Agent 记忆系统的工程实践](../ch03/035-agent.html) — 长上下文在 Agent 记忆中的工程化
- [Claude Code 源码核心机制](../ch03/077-claude-code.html) — 编码场景的 Agent 实现细节
