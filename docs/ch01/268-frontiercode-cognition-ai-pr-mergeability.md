...
## Ch01.268 FrontierCode — Cognition AI 的 PR Mergeability 编码基准
...
- [ProgramBench](ch04/153-programbench-agent-benchmark.md) — 程序化编码基准 (与 FrontierCode 的 maintainer-rubric 范式对比)
- [Claude Code Performance Benchmarking](ch03/073-claude-code.md) — 单 agent 性能基准
