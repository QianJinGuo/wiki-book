...
## Ch01.676 DeliAutoResearch SKILL：DeepSeek陈德里的自主科研智能体框架
...
- [Karpathy AutoResearch](../ch03/037-agent.html) — 专注于软件开发领域的自动研究，本框架扩展到通用科研
- [Claude Code Dynamic Workflows](../ch09/106-claude-code-dynamic-workflows.html) — 编排子Agent执行任务，本框架关注科研任务的自主设计
