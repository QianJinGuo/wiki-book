...
## Ch01.543 Latest Open Artifacts #19：Qwen 3.5·GLM-5·MiniMax M2.5 中国开源模型前沿
...
```mermaid
mindmap
  root(("Latest Open Artifacts 19 Qwen"))
    ...
    Our Picks 重点模型
      ...
      GLM-5
    中国 AI 实验室的开源模型竞争态势
    RAM 指标的价值 超越绝对下载量的相对评估
    Qwen 35 的全面升级与 overthinking 权衡
    MiniMax-M25 的效率突破
    模型选型 用 RAM 评估社区采纳而非只看 benchmark
    Qwen 35 小模型用户 默认关闭推理模式
```
...
- [Gemma 4 Open Model Adoption Framework Interconnects](ch01/622-gemma-4.html)
