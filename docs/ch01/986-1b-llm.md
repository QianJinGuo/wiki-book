...
## Ch01.986 个人从零预训练1B LLM心路历程

> 📊 Level ⭐⭐ | 4.4KB | `entities/个人从零预训练1b-llm心路历程.md`
...
https://hf-mirror.com/gqszhanshijin/Steel-LLMhttps://modelscope.c

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/个人从零预训练1b-llm心路历程.md)
