...
- [Management As Ai Superpower Mollick](ch01/500-management-as-ai-superpower.html) — 管理作为 AI 超级能力（同一作者，同期不同议题）
- [Guide Ai Agents Models Apps Harnesses Mollick](../ch04/505-ai-agent.html) — 模型/应用/harness 选型指南（同一作者，2026-02 更新）
