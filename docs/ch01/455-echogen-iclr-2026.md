...
## Ch01.455 EchoGen — ICLR 2026 首个基于视觉自回归模型的前馈式主体驱动图像生成
...
- [MoE 架构](ch01/1218-moe-architecture.html) — 稀疏激活的架构效率路线，与 EchoGen 的范式效率路线互补
...
- [Speculative Decoding](ch01/1034-spec.html) — 推理加速方法，虽然用于 LLM，但其"推测 + 验证"的框架思路可以启发更多生成模型的加速设计
