...
## Ch01.851 面向 LLM 的架构设计：什么是真正的 AI Friendly 架构？
...
- [一个 mission 跑 16 天、烧 7.78 亿 token：factory 公开了多 agent 系统的构建哲学](../ch04/165-factory-missions.html)
...
- [我把 claude design 做成了 skill，人人都能成为顶级网站设计师](ch01/964-claude.html)
