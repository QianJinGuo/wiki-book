...
## Ch01.100 强化学习如何不用奖励模型提高通用问题推理能力
...
## 原始内容
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/强化学习如何不用奖励模型提高通用问题推理能力.md)
...
- [Langchain用Agent做销售获客3个月转化率提升25倍看完后我发现国内 Agent 落地的方法都错了](../ch03/035-agent.html)
