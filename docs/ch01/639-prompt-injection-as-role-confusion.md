...
## Ch01.639 Prompt Injection as Role Confusion
...
这个框架对 [Hermes Agent Self-Evolving](../ch03/090-hermes-agent.html) 和其他 Agent 系统的安全设计有直接启示：
...
- [Hermes Agent Self-Evolving](../ch03/090-hermes-agent.html) — Agent 安全治理
