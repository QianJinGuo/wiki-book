...
## Ch01.443 AI Agent Gateway 架构设计 — OpenClaw/Claude Code/Hermes 三框架对比
...
- **乘积**：64 — strong ★★★★
- **策略对齐**：与 [DeerFlow vs Hermes vs OpenClaw](../ch04/467-deerflow-hermes-openclaw.html) 互补（整体选型 vs Gateway 专深）
...
- **交叉引用**：与 [OpenClaw Prompt/Context/Harness](../ch11/225-openclaw.html)、[Claude Code Prompt/Context/Harness](../ch09/059-claude-code-prompt.html)、[Hermes Agent 深度解析](../ch03/091-hermes-agent.html) 互为补充
...
- [claude dispatch + 接口力量：ai 从 chatbot 到 agent interface 的转变](ch01/1084-claude.html)
