...
- [Harness Engineering](ch05/061-harness-engineering.md) — Agent 差异化来自 harness 而非模型
- [Claw-SWE-Bench](ch05/009-harness.md) — harness 独立变量实证
- [Agent Eval WalleZhang](ch03/045-agent.md)
