...
## Ch01.531 GPT-5：It Just Does Stuff — Mollick 的主动式 AI 原语
...
- [Co Existence Paradigm Shift Agentic Ai Mollick 2026](ch01/590-ai-mollick.html) — Co-Existence 范式（Mollick 后续的完整框架，同一作者）
- [Management As Ai Superpower Mollick](ch01/522-management-as-ai-superpower.html) — 管理作为 AI 超级能力（同一作者，同期不同议题）
