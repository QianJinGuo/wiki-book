...
## Ch01.1425 AI Agent 评测实战：5 维指标体系 + L1/L2/L3 准出分级 + 评测集三层设计 + 6 大 Benchmark + LLM-as-Judge 三模式
...
| [Aws Reinforcement Fine Tuning Llm As Judge](ch01/1484-llm.html) | **LLM-as-Judge RFT** | AWS 用 LLM-as-Judge 做 RLHF/RFT 的实践 |
| [Spotify Llm Evals Funnel Not Fork](ch01/1484-llm.html) | **评测漏斗** | Spotify：评测要 funnel 而非 fork |
| [Langsmith Trajectory Evals](ch01/1009-langsmith-trajectory-evals.html) | **LangSmith trace 评测** | LangSmith trajectory 级评测 |
...
| [Aliyun Agentloop Enterprise Agent Self Evolution Flywheel](../ch04/356-agentloop.html) | **阿里 AgentLoop** | 4 环飞轮中"评估环"的产品化（Agent-as-a-Judge 13 个评估器） |
...
| [Anthropic Demystifying Evals For Ai Agents](../ch04/567-anthropic-demystifying-evals-for-ai-agents.html) | **Anthropic evals** | Anthropic Agent 评测揭秘 |
