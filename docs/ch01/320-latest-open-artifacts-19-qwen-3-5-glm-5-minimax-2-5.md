...
## Ch01.320 Latest open artifacts (#19)：Qwen 3.5、GLM 5、MiniMax 2.5 — 中国实验室的前沿推进
...
- [DeepSeek V4](459-deepseek-v4.html) — 业界关注度最高、即将发布的中国前沿模型
- [CybersecQwen 4B](../ch12/090-cybersecqwen-4b.html) — Qwen 在安全垂域的专用模型
- [OpenClaw 完全指南](../ch04/176-openclaw.html) — Agent 工具栈的实践参考
- [Agent 记忆系统的工程实践](../ch03/004-agent.html) — 长上下文在 Agent 记忆中的工程化
- [Claude Code 源码核心机制](../ch03/057-claude-code.html) — 编码场景的 Agent 实现细节
