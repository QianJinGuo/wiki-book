...
## Ch01.391 深入理解 Claude Code 源码中的 Agent Harness 构建之道
...
- [Claude Code 深度解析](../ch05/079-claude-code-harness.html) — Claude Code 架构的另一次深度解读
- [Claude Code Dynamic Workflows](../ch09/102-claude-code-dynamic-workflows.html) — AgentTool 子智能体 + Dynamic Workflow 范式
...
- [OpenClaw 完整指南](../ch11/247-openclaw.html) — 开源对应物（Worktree 隔离模式实现）
- [Harness Engineering 一文](../ch05/126-harness-engineering.html) — Harness 概念的系统阐释
