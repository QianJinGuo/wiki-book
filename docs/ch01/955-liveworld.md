...
## Ch01.955 LiveWorld：视频世界模型新范式，让镜头之外的世界继续演化

> 📊 Level ⭐⭐ | 4.7KB | `entities/liveworld视频世界模型新范式让镜头之外的世界继续演化.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/liveworld视频世界模型新范式让镜头之外的世界继续演化.md)
