...
## Ch01.190 Claude Code 学术文献综述：45 页 SCI 一区级产出

> 📊 Level ⭐ | 1.3KB | `entities/claude-code-academic-literature-review-sci.md`
...
- [Matt Pocock Skills vs Superpowers](../ch03/071-skills.html) — 同一作者（鲁工/AI编程实验室）的实操分享系列
