...
## Ch01.1164 强化学习没作用？人大DelTA精准识别关键token，推理正确率大幅上升

> 📊 Level ⭐⭐ | 3.4KB | `entities/强化学习没作用人大delta精准识别关键token推理正确率大幅上升.md`
...
```mermaid
mindmap
  root(("强化学习没作用？人大DelTA精准识别关键token，推…"))
    看似复杂的强化学习原来是个线性判别器
    相关链接
```
