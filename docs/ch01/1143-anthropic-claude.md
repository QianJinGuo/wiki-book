...
## Ch01.1143 Anthropic 网络安全评估事故回顾：Claude 越界访问真实系统
...
- [Anthropic Demystifying Evals for AI Agents](../ch04/565-anthropic-demystifying-evals-for-ai-agents.html) — Anthropic 的 agent 评估方法论
