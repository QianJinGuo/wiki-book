...
- [Karpathy Vibe Coding Agentic Engineering](../ch04/106-karpathy-vibe-coding-agentic-engineering.html) — Vibe Coding 与 Agentic Engineering 的同源访谈
...
- [Claude Code Harness Deep Understanding](297-claude-code-harness-deep-understanding.html) — Claude Code harness 的另一深度解析
...
- [scaling archunit with nebula archrules](../ch11/208-scaling-archunit-with-nebula-archrules.html)
- [the code-as-content era](https://github.com/QianJinGuo/wiki-public/blob/main/entities/the-code-as-content-era-20260606.md)
- [the shape of the thing](627-the-shape-of-the-thing.html)
