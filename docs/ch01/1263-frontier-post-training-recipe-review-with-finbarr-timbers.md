...
## Ch01.1263 Frontier post-training recipe review with Finbarr Timbers
...
- **[Olmo Hybrid](ch01/475-olmo-hybrid-and-future-llm-architectures.html)**：Olmo Hybrid 重点在 architecture（hybrid GDN + attention），本文重点在 post-training recipe 维度。
