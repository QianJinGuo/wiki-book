...
## Ch01.669 LLM Thonking：推理努力与安全分诊效果的实证研究
...
```mermaid
mindmap
  root(("LLM Thonking：推理努力与安全分诊效果的实证研究"))
    深度分析
      推理努力的非线性收益
      LLM 委员会的集体智慧
      粒度效应：上下文窗口的诅咒
...
- [gzip 作为语言模型](ch01/663-gzip.html) — 压缩视角下的推理成本分析
- [Anthropic LLM ATT&CK 导航](../ch04/166-anthropic-llm.html) — LLM 在安全领域的另一应用
- [LLM RL 算法综述](ch01/1274-llm.html) — 推理努力与 RL 训练的关系
- [腾讯 Token 经济学](../ch12/003-token.html) — Token 成本优化的另一视角

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/llm-thonking-reasoning-effort-security-triage.md)
