...
## Ch01.781 How I Build Software in June 2026
...
- [Claude Code MCP Server](https://github.com/QianJinGuo/wiki/blob/main/entities/claude-code-mcp-server.md)：assist 控制的核心执行引擎之一
