...
> -> [原文存档](https://aws.amazon.com/blogs/machine-learning/improve-bot-accuracy-with-amazon-lex-assisted-nlu/)
...
- [From siloed data to unified insights: Cross-account Athena Access for Amazon Quick](485-from-siloed-data-to-unified-insights-cross-account-athena-a.html)
