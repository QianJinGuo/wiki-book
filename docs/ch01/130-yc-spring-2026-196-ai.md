...
- [Harness Engineering](../ch05/057-harness-engineering.html) — Agent 差异化来自 harness 而非模型
- [Claw-SWE-Bench](../ch05/008-harness.html) — harness 独立变量实证
- [Agent Eval WalleZhang](../ch03/004-agent.html)
