...
## Ch01.372 Boris Cherny 新访谈：开发工具正在从 IDE 变成 Agent 控制台
...
这与 [Harness Engineering Core Patterns](../ch05/052-harness-engineering.html) 中"控制面应当外置给人类"的工程原则一致——Human-in-the-Loop 不是降级方案，而是 Agent 系统设计的核心约束。
...
- [Anthropic 内部实践](ch01/726-9.html)
- [DeepSeek V4 Flash Pro](ch01/988-deepseek-v4-flash-pro.html)
- [加速 LLM 模型加载与上下文窗口](ch01/1130-accelerate-llm-model-loading-and-increase-context-windows-wi.html)
- [大型表格模型基础](../ch05/086-ai.html)
