...
- [深度拆解 Claude Code 12 个可复用的 Agentic Harness 设计模式](ch03/075-claude-code.md)
...
- [AgentMemory](ch09/047-coding-agent.md)
- [AI Agent 工程师能力地图](ch04/277-ai.md)
- [钉钉 stream + cli 代理双引擎 ai 助手架构](ch04/277-ai.md)
