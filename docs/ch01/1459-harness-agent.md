...
## Ch01.1459 Harness 即后端：当Agent基础设施消解于统一原语
...
2. **品类折叠比功能堆叠更具长期价值**：当一个新需求出现时，如果答案总是"添加一类新产品/组件"，说明架构尚未收敛到正确的最小原语。如果答案收敛为"添加一个 Worker"，说明原语设计有效。参考 [Harness 范式](../ch05/085-harness.html) 中对统一抽象的讨论。
