...
- [Karpathy Vibe Coding Agentic Engineering](ch04/593-karpathy-vibe-coding-agentic-engineering.md) — vibe coding 到 agentic engineering 的演进
...
- [Agent Harness Context Management Working Set](ch05/009-harness.md) — Appshots 引发的 working set 管理新挑战
