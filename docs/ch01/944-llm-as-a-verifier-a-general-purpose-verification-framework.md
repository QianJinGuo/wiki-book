...
## Ch01.944 LLM-as-a-Verifier: A General-Purpose Verification Framework
...
- [LLM-as-a-Verifier Framework（同源实体）](ch01/855-llm.html)
...
- [LLM-as-a-Judge 实践案例](ch01/462-evaluating-netflix-show-synopses-with-llm-as-a-judge.html)
- [SWE-bench Agent 评估方法论](../ch04/748-swe-bench-agent.html)
