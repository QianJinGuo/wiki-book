...
## Ch01.486 Gemma 4 and what makes an open model succeed
...
- [DeepSeek Code Harness](https://github.com/QianJinGuo/wiki-public/blob/main/entities/deepseek-code-harness-competitor-tina.md)
