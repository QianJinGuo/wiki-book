...
## Ch01.500 Claude Code vs Kimi vs MiniMax：Agent Teams 到底拼的是什么？
...
这些问题的根因不在模型智力，而在缺乏系统化的控制平面——这正是 [Harness Engineering](../ch05/052-harness-engineering.html) 要解决的核心问题。
...
- [Harness Engineering](../ch05/052-harness-engineering.html) — Agent 控制平面的系统方法论
- [Agent Orchestration](../ch04/492-agent-orchestration.html) — 多 agent 编排模式
- [Kimi K2 Agent Swarm](ch01/981-20.html) — Kimi 并行 agent 方案的技术细节
