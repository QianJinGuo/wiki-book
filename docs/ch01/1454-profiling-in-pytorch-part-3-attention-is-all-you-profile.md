...
## Ch01.1454 Profiling in PyTorch (Part 3) — Attention is all you profile
...
与 [HF Torch MLP fusion profiling](ch01/1135-20.html) 同属 HF 性能工程系列；方法论适用于 [推理优化](https://github.com/QianJinGuo/wiki/blob/main/concepts/inference-optimization.md) 与训练侧 [PyTorch 版本迭代](ch01/131-pytorch-2-12-release-blog-pytorch.html) 的验证。
