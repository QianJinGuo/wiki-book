...
## Ch01.385 III Dev Worker 触发函数架构
...
- [Anthropic 12 Mcp Production Patterns](ch01/1215-anthropic.html)
...
- [Anthropic Long Running Agent Architecture 6H Retroforge](ch01/1215-anthropic.html)
