...
- [Co Existence Paradigm Shift Agentic Ai Mollick 2026](ch04/069-ai.md) — Co-Existence 范式（Mollick 后续的完整框架，同一作者）
- [Management As Ai Superpower Mollick](ch04/069-ai.md) — 管理作为 AI 超级能力（同一作者，同期不同议题）
- [Guide Ai Agents Models Apps Harnesses Mollick](ch04/069-ai.md) — 模型/应用/harness 选型指南（同一作者，2026-02 更新）
