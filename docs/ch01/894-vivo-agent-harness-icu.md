...
- **Harness-as-ICU** 与 [Harness Engineering](../ch05/096-harness-engineering.html) 的"多层重试+可续传机制"互补——Harness Engineering 从"工程落地"侧设计，vivo 从"隐喻/哲学"侧给出定位
...
- **vivoPPT DSL 中间层** 与 [Flow2Spec 结构化知识路由](ch01/1222-spec.html) 的结构化中间表示思想一致
