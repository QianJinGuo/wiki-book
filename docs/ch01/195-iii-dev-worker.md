...
## Ch01.195 III Dev Worker 触发函数架构
...
- [Anthropic 官方生产级 Agent 最佳实践12 个可复用的 Mcp 设计模式 V2](ch01/986-anthropic.html)
...
- [Anthropic Long Running Agent Architecture 6H Retroforge](ch01/986-anthropic.html)
