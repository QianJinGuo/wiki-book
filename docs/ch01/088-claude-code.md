...
> 📊 Level ⭐ | 5.5KB | `entities/两万字详解claude-code源码核心机制.md`
...
- 同题异语种孪生页：[Claude Code Large Codebase Enterprise Deployment](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-large-codebase-enterprise-deployment.md)（归并候选，提案卡 #11 批1）
