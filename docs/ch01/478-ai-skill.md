...
> 📊 Level ⭐⭐⭐⭐ | 9.6KB | `entities/ai-skill-metrics-system.md`
...
→ [AI Skill 测评体系：从零到一](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-skill-evolution-framework.md)（系列主框架）
...
- [Hermes Agent Skill 系统深度解析](https://github.com/QianJinGuo/wiki-public/blob/main/entities/hermes-skill-system.md)
...
- [LBS-IntentBench — 首个真实出行隐式意图评测基准](../ch04/316-lbs-intentbench.html)
