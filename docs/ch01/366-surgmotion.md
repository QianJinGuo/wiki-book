...
## Ch01.366 中国科学院携手全球顶尖机构发布首个十亿参数级的手术视频基础模型SurgMotion！
...
```mermaid
mindmap
  root(("中国科学院携手全球顶尖机构发布首个十亿参数级的手术视频基础模型Sur"))
    范式颠覆 从像素重建到时空运动预测
...
- [维纳智能登上Nature通讯](../ch05/094-ai.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/中国科学院携手全球顶尖机构发布首个十亿参数级的手术视频基础模型surgmotion-2026-07-08.md)
