...
## Ch01.311 Claude Opus 4.8: The System Card
...
- [claude opus 4.8: the system card](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-opus-4-8-system-card-zvi.md)
