...
## Ch01.512 Boris Cherny 新访谈：开发工具正在从 IDE 变成 Agent 控制台
...
这与 [Harness Engineering Core Patterns](../ch05/065-harness-engineering.html) 中"控制面应当外置给人类"的工程原则一致——Human-in-the-Loop 不是降级方案，而是 Agent 系统设计的核心约束。
...
这与 [Claude Code Harness 深度解析](../ch05/087-claude-code-harness.html) 中的 harness 设计哲学一致——harness 的核心价值就是为 Agent 提供持续运行的工程环境，而非一次性对话界面。
...
这与 [Karpathy Vibe Coding 到 Agentic Engineering](../ch04/294-agentic.html) 中的论述相互印证——"Vibe Coding"是 Agent 时代的临时形态，"Agentic Engineering"才是稳定形态。
...
- [深入理解 Claude Code Agent Harness 构建之道](../ch05/042-agent-harness.html)
...
- [Anthropic 内部实践](ch01/933-9.html)
- [DeepSeek V4 Flash Pro](ch01/1287-deepseek-v4-flash-pro.html)
- [加速 LLM 模型加载与上下文窗口](ch01/1381-accelerate-llm-model-loading-and-increase-context-windows-wi.html)
- [大型表格模型基础](../ch05/105-ai.html)
