...
## Ch01.538 AWS 强化微调：LLM-as-Judge 训练范式
...
## 相关实体
- [Navigating Eu Ai Act Requirements For Llm Fine Tuning On Amazon Sagemaker Ai](ch01/421-navigating-eu-ai-act-requirements-for-llm-fine-tuning.md)
- [Llm Finetuning Cost Breakdown](ch01/586-llm.md)
- [Harness Engineering 第三代工程范式](../ch05/062-harness-engineering.md)
- [Aws Sagemaker Ai Agent Guided Workflows Finetuning](../ch04/381-aws-sagemaker-ai-agent.md)
- [Fine Tune Llm With Databricks Unity Catalog And Amazon Sagemaker](ch01/615-fine-tune-llm-with-databricks-unity-catalog-and-amazon-sagem.md)

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/aws-reinforcement-fine-tuning-llm-as-judge.md)

- [stop hand-tuning kernels: how neuron agentic development acc](../ch04/315-stop-hand-tuning-kernels-how-neuron-agentic-development-acc.md)
