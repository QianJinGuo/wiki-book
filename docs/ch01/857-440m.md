...
## Ch01.857 腾讯混元最新开源：440M翻译模型手机离线就能用，翻译质量超谷歌

> 📊 Level ⭐⭐ | 5.4KB | `entities/腾讯混元最新开源440m翻译模型手机离线就能用翻译质量超谷歌.md`
...
```mermaid
mindmap
  root(("腾讯混元最新开源 440M翻译模型手机离线就能用 翻译质量超谷歌"))
    基于混元翻译大模型Hy-MT15打造 翻译效果比肩商业翻译模型
    极致量化压缩 把模型装进手机
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/腾讯混元最新开源440m翻译模型手机离线就能用翻译质量超谷歌.md)
