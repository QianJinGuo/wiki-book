...
## Ch01.678 NotebookLM：Google AI 笔记本工具
...
- [Obsidian](https://github.com/QianJinGuo/wiki-public/blob/main/entities/obsidian.md) — 本地离线笔记
- [ChatGPT Memory](664-chatgpt-memory.html) — 对话式记忆
## 相关实体

- [the interface is no longer the product](https://github.com/QianJinGuo/wiki-public/blob/main/entities/interface-commoditization-ai-era.md)
