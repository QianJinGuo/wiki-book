...
## Ch01.201 Kimi Work：通用 Agent 战场从云端迁移到本地
...
## 相关实体
- [Schemaflow Agentic Database Sql Generation Openai Cookbook](../ch04/616-agentic.html)
...
### vs [Codex 6 职位插件](ch01/512-codex.html)
- 之前 Codex 还在"加插件拓展能力"
...
- [Karpathy Vibe Coding → Agentic Engineering](../ch04/616-agentic.html) —— Vibe Coding 原始定义
