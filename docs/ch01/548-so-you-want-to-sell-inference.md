...
- [AgentCore](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agentcore-harness.md) — 平台层产品的定位参考
- Inference Economics — 推理经济学的更广泛讨论
- Sierra — value-based pricing 的案例
- Devin — ACU 定价模型的案例
- Model Distillation — cost optimization 的核心策略

→ [原文存档](https://tomtunguz.com/so-you-want-to-sell-inference/)
