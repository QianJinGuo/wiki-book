...
- [Gemini 3.5: frontier intelligence with action](ch01/699-gemini-3-5-frontier-intelligence-with-action.html) — 分层矩阵中的旗舰能力端
...
- [GPT-5.6 Sol/Terra/Luna 分层定价](ch01/739-codex.html) — OpenAI 侧的分层定价对照
- [OpenAI Reasoning Models (o1/o3/o4-mini)](ch01/652-openai-reasoning-models-o1-o3-o4-mini.html) — 推理模型分层参考
