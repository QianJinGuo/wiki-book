...
## Ch01.363 Apple Silicon costs more than OpenRouter
...
[ds4.c 项目](ch09/040-deepseek-v4-ds4c-antirez-local-inference-qbitai.md)（Redis 作者 antirez 开发的 DeepSeek V4 专用推理引擎）展示了另一种路线：
...
- [LightSeek TokenSpeed](ch01/832-lightseek-tokenspeed.md) — 推理引擎优化技术（Speculative Decoding、KV Cache、Continuous Batching）
