...
## Ch01.1615 Anthropic 前沿红队多智能体冲突实验 — 安全是整体属性而非个体属性
...
- **对齐训练无法覆盖跨-agent 行为**：该实验是 AI safety 领域「compositionality of alignment」担忧的实证例证，与 [DeepMind 多智能体 AI 安全投资](ch01/1107-agent-ai.html) 的研究方向一致。

## 相关

- [Investing in Multi-Agent AI Safety (DeepMind)](ch01/1107-agent-ai.html)
- [Agent Room 涌现协作](../ch04/826-agent-room.html)
