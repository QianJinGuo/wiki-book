...
## Ch01.679 What it feels like to work with Mythos
...
### 与 [Hermes Agent V014 Architecture Shugex](ch03/044-agent.md) 的关联
...
### 与 [两万字详解Claude Code源码核心机制](ch03/074-claude-code.md) 的关联
