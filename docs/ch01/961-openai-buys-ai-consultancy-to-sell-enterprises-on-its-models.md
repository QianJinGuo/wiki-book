...
## Ch01.961 OpenAI buys AI consultancy to sell enterprises on its models
...
## 相关实体
- [OpenAI buys AI consultancy to sell enterprises on its models](ch01/168-openai.html)
- [Interaction Models: A Scalable Approach to Human-AI Collaboration](../ch05/089-ai.html)
- [OpenAI三个语音模型发布同传被杀死](ch01/168-openai.html)
