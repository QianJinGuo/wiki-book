...
## Ch01.263 Claude Code 源码深度解析（13 核心机制）
...
- [Prompt Caching 工程实践](ch01/219-anthropic-prompt-caching-claude-code.html) — 与 microCompact 相关
- [Agent Harness 12 组件](../ch05/057-agent-harness.html) — Harness 通用框架
