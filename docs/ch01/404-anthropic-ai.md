...
## Ch01.404 Anthropic发布「AI原生创业公司」手册：涵盖全流程四大核心阶段，一人公司法典来了
...
Cowork 是手册中最值得关注的工具形态——它是 Chat 和 Code 之间的中间态，专门针对"耗时的知识工作"。这与 [CLAUDE Code 100 条规则](ch03/074-claude-code.md) 中倡导的"研究伙伴"角色高度一致。
