...
## Ch01.1478 SenseNova-U1 — 商汤原生统一多模态模型
...
## 相关技术
- [DeepSeek Visual Primitives](../ch09/191-deepseek-visual-primitives.html) — 视觉原语作为思考媒介（同期多模态前沿）
- [Kimi AttnRes](ch01/576-kimi.html) — 训练效率优化
