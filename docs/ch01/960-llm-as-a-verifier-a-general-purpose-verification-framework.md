...
## Ch01.960 LLM-as-a-Verifier: A General-Purpose Verification Framework
...
- [LLM-as-a-Verifier Framework（同源实体）](ch01/1484-llm.html)
- [LLM-as-a-Verifier（同源实体）](ch01/782-llm-as-a-verifier-a-general-purpose-verification.html)
...
- [LLM-as-a-Judge 实践案例](ch01/459-evaluating-netflix-show-synopses-with-llm-as-a-judge.html)
- [SWE-bench Agent 评估方法论](../ch04/469-swe-bench-agent.html)
