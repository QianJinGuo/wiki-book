...
## Ch01.1450 OlmoEarth v1.1: A more efficient family of Earth observation models
...
![OlmoEarth v1.1 模型架构概览](https://cdn-uploads.huggingface.co/production/uploads/638e39b249de7ae552d977b5/4Nsn7CxsnxPkVfK5BsCHN.png) ^[olmoearth-v1-1-efficiency]^[olmoearth-v1-1-efficiency.md]
...
![分辨率分块方案示意](https://cdn-uploads.huggingface.co/production/uploads/638e39b249de7ae552d977b5/-OzFWBJPTKBDXOJR2Iguw.png) ^[olmoearth-v1-1-efficiency]^[olmoearth-v1-1-efficiency.md]
...
![Token 合并后的设计示意](https://cdn-uploads.huggingface.co/production/uploads/638e39b249de7ae552d977b5/mPjOTX0JVZij1-6q2DFLY.png) ^[olmoearth-v1-1-efficiency]^[olmoearth-v1-1-efficiency.md]
...
为在不影响性能的前提下合并 token，团队修改了预训练策略，具体方案详见技术报告。 ^[olmoearth-v1-1-efficiency]^[olmoearth-v1-1-efficiency.md]

## 效率提升效果

![MACs 效率对比](https://cdn-uploads.huggingface.co/production/uploads/638e39b249de7ae552d977b5/E_EJ2q5ZLbGn2dZ4j92r_.png) ^[olmoearth-v1-1-efficiency]^[olmoearth-v1-1-efficiency.md]
...
Transformer 架构中影响效率的两个关键因素： ^[olmoearth-v1-1-efficiency]^[olmoearth-v1-1-efficiency.md]
...
## 相关实体
- [Olmoearth V1 1 A More Efficient Family Of Earth Observation Models](ch01/1450-olmoearth-v1-1-a-more-efficient-family-of-earth-observation.html)
- [Kamacoder Agent Context Drift Tool Hallucination](../ch03/037-agent.html)
- [Olmo Hybrid Gdn Wave 2026](ch01/1119-20.html)
- [How Llms Actually Work 0Xkato](ch01/1480-how-llms-actually-work-0xkato-transformer-walkthrough.html)
- [Agent Reliability Context Drift Tool Hallucination](../ch03/037-agent.html)
