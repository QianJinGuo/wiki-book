...
## Ch01.325 Claude Code vs Codex 上下文架构：五层压缩管道 vs 容器文件系统
...
## 相关主题
- [Claude Code 架构](../ch03/076-claude-code.html) — Claude Code 完整架构分析
...
- [Claude Code Harness Deep Dive](../ch05/070-claude-code-harness.html) — Founder Park 深度分析（含 Auto-compaction）
