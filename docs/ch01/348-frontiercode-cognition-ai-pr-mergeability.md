...
## Ch01.348 FrontierCode — Cognition AI 的 PR Mergeability 编码基准
...
- [ProgramBench](../ch04/161-programbench-agent-benchmark.html) — 程序化编码基准 (与 FrontierCode 的 maintainer-rubric 范式对比)
- [Claude Code Performance Benchmarking](../ch03/075-claude-code.html) — 单 agent 性能基准
