...
## Ch01.1531 Redis agentic AI flowers with Iris
...
## 相关实体
- [Redis 之父为 DeepSeek v4 造推理引擎](ch01/432-deepseek-v4.html)
...
- [Agent Memory 架构](../ch04/519-perplexity-brain-self-improving-agent-memory-architecture.html)
