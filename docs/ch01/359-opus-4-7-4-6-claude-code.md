...
## Ch01.359 Opus 4.7 发布：相比 4.6 核心变化与 Claude Code 搭配最佳实践
...
- [Claude Code Dynamic Workflows Multi Agent Orchestration](ch03/073-claude-code.md) — Claude Code 多 Agent 编排完整指南
