...
## Ch01.1580 Natural Language Autoencoders — Anthropic 激活→文字可解释性方法
...
## 相关概念
- [Anthropic](ch01/778-anthropic.html) — 研究机构，NLAs 是其可解释性研究的最新成果
...
- [Sparse Autoencoders](ch01/1591-sparse-autoencoders.html) — 前代可解释性方法，NLAs 在其基础上发展出文字翻译能力
...
## 相关实体
- [Natural Language Autoencoders (Anthropic)](ch01/778-anthropic.html)
