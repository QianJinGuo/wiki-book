...
## Ch01.1299 Owner-Worker-Verifier 架构
...
## 相关实体
- [Scalable voice agent design with Amazon Nova Sonic: multi-agent, tools, and session segmentation](../ch11/304-amazon-nova.html)
