...
## Ch01.441 Cline releases open-source agent runtime SDK
...
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](../ch04/236-agentic.html) — 从 vibe coding 到 agentic engineering 的范式跃迁
...
- [Claude Code Harness Deep Dive Founder Park](../ch05/062-claude-code-harness.html) — 同主题的另一种解读视角
...
- [the shape of the thing](ch01/281-the-shape-of-the-thing.html)
