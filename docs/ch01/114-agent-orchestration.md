...
## 关联阅读
→ [原始来源](https://pages.awscloud.com/awsmp-gro-ufin-webinar-mss-module-6-agent-orchestration-workshop.html)

- [Multi-Agent 深度思考交易系统](https://github.com/QianJinGuo/wiki-public/blob/main/entities/构建基于多智能体架构的深度思考交易系统.md) — 多 Agent 协作模式的具体实践
- [Agent Harness 工程学调研](../ch05/057-harness-engineering.html) — Agent 系统构建的核心架构要素
- [基于 Bedrock AgentCore 构建企业级应用](../ch11/045-bedrock-agentcore.html) — AWS 生态中 Agent 编排的具体实现路径
