...
- [Shotstream Streaming Multi Shot Video Cuhk Kling Eccv2026](ch01/908-20.html) — 流式视频生成（与 VideoChat3 的流式视频理解互补）
...
- [Liteframeefficientvisionencodersunlockframescalinginvideollms](ch01/556-scaling.html) — 高效视觉编码器与视频 LLM 帧缩放
