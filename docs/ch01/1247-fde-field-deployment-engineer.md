...
## Ch01.1247 FDE（Field Deployment Engineer）非共识与落地指南 — 硅谷一线实践者圆桌
...
- FDE "听到炮声改产品"的模式是 [Harness Engineering](../ch05/115-harness-engineering.html) 的生产实践——前线和产品之间的超短反馈环
- "模型是最容易被替代的一层" 呼应 [Agent Vs Workflow Control Continuum Framework](../ch04/641-agent-vs-workflow.html) 中护城河不在模型而在工程层
