...
## Ch01.780 Trace2Skill 把\"轨迹里的局部经验\"蒸馏成可迁移的 Agent Skills
...
- [Yidian Tianxia Context Engineering Agentic Ai](../ch04/255-yidian-tianxia-context-engineering-agentic-ai.html)
- [Agentic Ai System Architecture Harness Skill Mcp](../ch05/088-harness-skill.html)
