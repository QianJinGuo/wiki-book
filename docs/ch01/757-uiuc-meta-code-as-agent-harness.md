...
## Ch01.757 UIUC、Meta、斯坦福等最新综述！Code as Agent Harness
...
- [ai 硬件迎来寒武纪时刻：百度智能云如何成为爆发催化剂](ch04/277-ai.md)
- [cmu language models need sleep (arxiv 2605.26099)：ssm-attent](ch01/217-0.md)
...
- [codex discovered a hidden http/2 bomb](ch01/542-codex.md)
- [面向大型代码库的 claude code 团队落地经验与扩展策略（agent harness）](ch03/075-claude-code.md)
- [面向大型代码库的 claude code 团队落地经验与扩展策略（agent harness）](ch03/075-claude-code.md)
- [code intelligence – changelog](ch04/437-code-intelligence-changelog.md)
- [deepseek视觉原语论文：当所有人在堆图像分辨率时，它在堆「指代精度」！](ch01/923-deepseek.md)
- [democratizing machine learning at netflix: building the mode](ch11/245-democratizing-machine-learning-at-netflix-building-the-mode.md)
- [gemma 4 and what makes an open model succeed](ch01/678-gemma-4-and-what-makes-an-open-model-succeed.md)
- [how my non-engineering team at sentry learned to ship](ch01/217-0.md)
- [我把 karpathy 的 autoresearch 搬到了软件开发领域，效果炸了](ch04/251-karpathy-autoresearch.md)
...
- [the shape of the thing](ch01/299-the-shape-of-the-thing.md)
...
- [5亿视频炼出全球最大gui开源数据集、推理token省71%小模型反超大模型——小米ai团队多篇论文入选icml 202](ch01/217-0.md)
- [吴恩达2026新课上线！3小时包教包会，零代码小白也能成为ai超级玩家](ch04/277-ai.md)
