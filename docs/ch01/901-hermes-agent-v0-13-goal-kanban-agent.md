...
## Ch01.901 Hermes Agent v0.13 — /goal 目标管理与 Kanban 多 agent 协作
...
## 相关实体
- [Hermes Agent Kanban Deep Test](../ch03/098-hermes-agent.html)
- [Hermes Agent Goal Runtime Architecture](../ch04/365-hermes-agent-goal.html)
