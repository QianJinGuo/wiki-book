...
## Ch01.396 AI Agent Gateway 架构设计 — OpenClaw/Claude Code/Hermes 三框架对比
...
- **乘积**：64 — strong ★★★★
- **策略对齐**：与 [DeerFlow vs Hermes vs OpenClaw](../ch04/482-deerflow-hermes-openclaw.html) 互补（整体选型 vs Gateway 专深）
...
- [claude dispatch + 接口力量：ai 从 chatbot 到 agent interface 的转变](ch01/964-claude.html)
