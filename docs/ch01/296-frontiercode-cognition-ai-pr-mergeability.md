...
## Ch01.296 FrontierCode — Cognition AI 的 PR Mergeability 编码基准
...
- [ProgramBench](../ch04/162-programbench-agent-benchmark.html) — 程序化编码基准 (与 FrontierCode 的 maintainer-rubric 范式对比)
