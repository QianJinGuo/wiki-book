...
- [高德 Harness/SDD 演进](../ch05/078-ai-coding.html) — 同一团队的前序实践
- [AI Agent 评测 5 维体系](../ch05/078-ai-coding.html) — 评估方法论互补（模型评测 vs 资产度量）
...
- [Harness Engineering](../ch05/026-harness-engineering.html) — Skill/MCP 是 Harness 的执行载体
