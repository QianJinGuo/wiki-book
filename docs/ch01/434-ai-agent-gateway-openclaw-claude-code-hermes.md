...
- **乘积**：64 — strong ★★★★
- **策略对齐**：与 [DeerFlow vs Hermes vs OpenClaw](ch11/213-openclaw.md) 互补（整体选型 vs Gateway 专深）
...
- **交叉引用**：与 [OpenClaw Prompt/Context/Harness](ch05/085-harness.md)、[Claude Code Prompt/Context/Harness](ch03/075-claude-code.md)、[Hermes Agent 深度解析](ch03/045-agent.md) 互为补充
...
- [claude dispatch + 接口力量：ai 从 chatbot 到 agent interface 的转变](ch01/1022-claude.md)
