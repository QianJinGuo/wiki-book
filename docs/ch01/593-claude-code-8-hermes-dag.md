...
## Ch01.593 Claude Code 动态工作流 8 译本（行小招译注 + Hermes DAG 对比）
...
- [Claude Code Harness Deep Understanding](ch01/429-claude-code-harness-deep-understanding.html) — Claude Code harness 深度解析
