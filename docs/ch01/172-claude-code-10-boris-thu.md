...
## Ch01.172 Claude Code 团队 10 条经验：Boris 数据派 THU 分享
...
- [karpathy × boris 访谈：software 3.0 时代编程完整地图](https://github.com/QianJinGuo/wiki-public/blob/main/entities/karpathy-boris-software3-llm-era-programming-2026.md)
→ 原文存档
