...
## Ch01.188 投毒！Meta竟雇外包，大规模给ChatGPT和Gemini下套

> 📊 Level ⭐ | 2.7KB | `entities/投毒meta竟雇外包大规模给chatgpt和gemini下套.md`
...
> 本文通过article、llm、meta视角，分析了的AI/ML技术动态。
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/投毒meta竟雇外包大规模给chatgpt和gemini下套.md)
