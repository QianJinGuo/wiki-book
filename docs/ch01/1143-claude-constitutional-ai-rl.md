...
→ 相关实体：[Anthropic LLM 内省意识机制](../ch04/165-anthropic-llm.md)
...
- → [Anthropic LLM 内省意识](../ch04/165-anthropic-llm.md)：Anthropic 的安全研究能力维度
- → [Building Next Claude](ch01/833-anthropic.md)：Claude 的产品演进方向
