...
## Ch01.1299 Netflix In-House LLM Serving Platform
...
- [AI Infra：大模型高效推理](ch01/772-ai-infra.html) — vLLM 技术原理层面
- [LLM 推理流水线完整解析](ch01/1274-llm.html) — Prefill/Decode 理论
- [SGLang](../ch04/631-agent-assisted-sglang-ai-llm.html) — 另一推理框架
- [Disaggregated Prefill/Decode](ch01/1274-llm.html) — 分离式推理架构
- [OpenAI-Compatible API on SageMaker](ch01/731-announcing-openai-compatible-api-support-for-amazon-sagemake.html) — 类似 API 设计决策
- [FSx for Lustre GPU Direct](ch01/1274-llm.html) — 模型加载/缓存方案
