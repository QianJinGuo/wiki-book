...
## Ch01.1527 Redis agentic AI flowers with Iris
...
- [Agent Memory 架构](../ch04/512-perplexity-brain-self-improving-agent-memory-architecture.html)
- [Agentic AI 数据网格与 MCP](../ch04/693-agentic-ai.html)
