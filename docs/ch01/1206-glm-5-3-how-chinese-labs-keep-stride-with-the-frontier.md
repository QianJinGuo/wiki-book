...
Lambert 明确否定「蒸馏是主因」的常见解释（详见其 [The Distillation Panic](ch01/914-the-distillation-panic.html) 系列），提出六个大图景因素：
...
- [The Distillation Panic](ch01/914-the-distillation-panic.html) — 蒸馏争论系列，本文明确否定蒸馏为主因
- [Open models 差距](ch01/1139-20.html) — 开放模型前沿差距语境
- [Gemma 4 开放模型采纳框架](ch01/868-gemma-4.html) — Interconnects 开放模型系列
