...
## Ch01.030 How to create websites with great UX designs: Principles and examples

> 📊 Level ⭐ | 8.8KB | `entities/how-to-create-websites-with-great-ux-designs.md`
...
### Navigation as comprehension: the workflow-label pattern
...
- [How we made WINDOW JOIN parallel and vectorized](028-how-we-made-window-join-parallel-and-vectorized.html)
...
- [Scaling UX testing with Amazon Nova Act](https://github.com/QianJinGuo/wiki-public/blob/main/entities/scaling-ux-testing-with-amazon-nova-act-a-new-approach-to-us.md)
