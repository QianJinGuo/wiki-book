...
## Ch01.1334 Sparse Autoencoders

> 📊 Level ⭐⭐⭐⭐ | 5.6KB | `entities/sparse-autoencoders.md`

## 关联
- [Natural Language Autoencoders](ch01/1321-natural-language-autoencoders-anthropic.html) — NLA 在 SAE 基础上增加文字输出能力
- [Anthropic](ch01/1324-anthropic.html) — 主要研究机构
