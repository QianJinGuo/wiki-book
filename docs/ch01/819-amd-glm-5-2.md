...
## Ch01.819 AMD跑GLM 5.2，成本只要英伟达一半

> 📊 Level ⭐⭐ | 5.7KB | `entities/amd跑glm-52成本只要英伟达一半.md`
...
- [GLM 5.2](https://github.com/QianJinGuo/wiki/blob/main/entities/z-glm-5.2.md)
- **AMD MI355X**
- **NVIDIA B200**
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/amd跑glm-52成本只要英伟达一半.md)
