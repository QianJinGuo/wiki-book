...
## Ch01.1436 NL2SQL 在超大规模数仓场景的架构突破与工程实践

> 📊 Level ⭐⭐ | 2.8KB | `entities/nl2sql-在超大规模数仓场景的架构突破与工程实践.md`
