...
## Ch01.967 高德 Uplift 模型迭代 Agent：长时间运行 Harness
...
- [gemma 4 and what makes an open model succeed](ch01/692-gemma-4-and-what-makes-an-open-model-succeed.html)
- [model-harness-fit-agent-harness](ch01/319-model-harness-fit-agent.html)
- [what i’ve been building: atom report, post-training course,](../ch05/082-ai.html)
