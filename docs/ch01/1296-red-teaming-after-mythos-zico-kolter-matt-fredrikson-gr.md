...
## Ch01.1296 Red-Teaming after Mythos — Zico Kolter & Matt Fredrikson, Gray Swan
...
这与 [Role Confusion](ch01/882-github.html) 研究形成互补——后者提供理论框架（prompt injection 本质是角色混淆），Gray Swan 提供实战工具和方法论。
...
- [Role Confusion](ch01/882-github.html) — Prompt injection 的理论框架
...
- [Claude Tag](ch01/1209-introducing-claude-tag.html) — Anthropic 的 agent 安全实践
- [OpenClaw](../ch04/567-agent-loop.html) — 计算机使用 agent 的安全挑战
