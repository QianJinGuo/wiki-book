...
## Ch01.017 NotebookLM：Google AI 笔记本工具
...
- [Obsidian](ch01/888-claude-code-memory-setup-obsidian-graphify.html) — 本地离线笔记
- [ChatGPT Memory](ch01/398-chatgpt-memory.html) — 对话式记忆
## 相关实体
