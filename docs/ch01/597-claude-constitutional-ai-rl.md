...
→ 相关实体：[Anthropic LLM 内省意识机制](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic-llm-introspection-awareness-mechanisms.md)
...
- → [Anthropic LLM 内省意识](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic-llm-introspection-awareness-mechanisms.md)：Anthropic 的安全研究能力维度
- → [Building Next Claude](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic-building-next-claude.md)：Claude 的产品演进方向
- → [Harness Engineering 范式](https://github.com/QianJinGuo/wiki-public/blob/main/entities/harness-engineering-paradigm-comprehensive-2026.md)：代码能力在 Agent 场景的价值
