...
## Ch01.906 OpenAI buys AI consultancy to sell enterprises on its models
...
## 相关实体
- [OpenAI buys AI consultancy to sell enterprises on its models](ch01/433-openai.html)
- [Interaction Models: A Scalable Approach to Human-AI Collaboration](../ch05/086-ai.html)
- [OpenAI三个语音模型发布同传被杀死](ch01/433-openai.html)
