...
## Ch01.1102 Latest open artifacts (#20): New orgs! New types of models! With Nemotron Super, Sarvam, Cohere Transcribe, & others
...
- [interconnects ai p open and closed models are on different](../ch05/095-ai.html)
- [reducing container cold start times using soci index on dlam](ch01/1203-reducing-container-cold-start-times-using-soci-index-on-dlam.html)
- [state of routing in model serving](../ch11/195-state-of-routing-in-model-serving.html)
- [the distillation panic](ch01/293-the-distillation-panic.html)
