...
## Ch01.508 What Is Software, and Will LLMs Replace It?
...
现代 agent 架构（如 [Claude Code](ch03/074-claude-code.md)、Codex）的设计本质上就是这一分层的实现：
...
- [Claude Code Workflows](ch03/074-claude-code.md) — Agent 工作流设计
