...
## Ch01.673 DeepSeek MoE 并行策略与GPU通信优化
...
- → [DeepSeek V4论文解读](/ch01-751-deepseek-v4是怎么训练出来的-58页论文深入解读/) — 训练流程
- → [DeepSeek V4 Pro评测](/ch01-623-we-tested-deepseek-v4-pro-and-flash-against-claude-opus-4-7/) — 模型能力
