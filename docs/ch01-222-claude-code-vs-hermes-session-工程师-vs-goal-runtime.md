...
| [Hermes 9 Module 架构](/ch01-336-hermes-9-module-architecture-winty/) | Hermes 源码级 | 互补 (本实体: 跨工具对比) |
...
| [Hermes Goal Runtime 架构](/ch04-418-hermes-agent/) | Goal-in-loop 实现 | **直接相关** (本实体 Goal 概念的实现) |
