...
- [Cloudflare 临时账户](/ch04-360-temporary-cloudflare-accounts-for-ai-agents/) — SEC411 覆盖的 AI 安全原则与 Agent 认证直接相关
- [AFine CSP HTML Injection](/ch09-114-stealing-passwords-via-html-injection-under-a-strict-csp/) — SEC535 的攻击技术覆盖了类似的攻击向量
...
- [Harness Engineering — AI 安全控制作为 harness 的一部分](/ch05-031-harness-engineering-实战-ai-coding-率从-25-提升至-90/)
- [Cloudflare 临时账户](/ch04-360-temporary-cloudflare-accounts-for-ai-agents/) — Agent 认证安全
- [AFine CSP HTML Injection](/ch09-114-stealing-passwords-via-html-injection-under-a-strict-csp/) — 安全漏洞案例
- [Building Reliable Agentic AI Systems](/ch04-229-building-reliable-agentic-ai-systems/) — AI 系统可靠性工程
- MCP — SEC573 课程中涉及的协议

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/www-sans-org-ai-in-cybersecurity-training-resources-sans-instit.md)
