...
## Ch01.352 Apple Silicon costs more than OpenRouter
...
[ds4.c 项目](../ch09-040-deepseek-v4-ds4c-antirez-local-inference-qbitai)（Redis 作者 antirez 开发的 DeepSeek V4 专用推理引擎）展示了另一种路线：
...
- [离线 LLM 能量使用](../ch01-081-apple-silicon-costs-more-than-openrouter) — 同一作者的另一篇相关文章
- [LightSeek TokenSpeed](../ch01-817-lightseek-tokenspeed) — 推理引擎优化技术（Speculative Decoding、KV Cache、Continuous Batching）
- [Ollama 安全问题](../ch12-013-bleeding-llama-critical-unauthenticated-memory-leak-in-ollam) — 本地推理基础设施的安全考量
