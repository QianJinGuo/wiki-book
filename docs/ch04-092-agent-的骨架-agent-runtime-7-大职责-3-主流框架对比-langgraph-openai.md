...
## Ch04.092 Agent 的骨架:Agent Runtime 7 大职责 + 3 主流框架对比 (LangGraph / OpenAI Agents SDK / 自研)
...
- vs **[Google Agent Executor Distributed Runtime](../ch04-003-agentrun)** — Google 自家 Runtime 实现;与本文 LangGraph / OpenAI SDK 平行
- vs **[Anthropic Claude Managed Agents Platform](../ch01-677-anthropic)** — Anthropic Managed Agents 视角
...
- vs **[AgentCore Harness](../ch04-408-amazon-bedrock-agentcore-harness-ga-两-api-调用生产级-agent-基础设施)** / **[AgentCore Managed Harness](../ch04-206-agentcore-managed-harness)** — AWS 实现的 8 职责具体形态
...
- [Google Agent Executor Runtime](../ch04-003-agentrun)
- [Anthropic Claude Managed Agents](../ch01-677-anthropic)
