...
- [Claude Code Tool Call Security Incident Gitignore Redis Anthropic Apology 2026 06 17](/ch01-223-claude-code-1-0-24-工具调用安全事故-静默删-gitignore-与-redis-flush-复盘/)：Claude Code 安全事故 — ThinkingAgent 的 Safeguard 代理模式是直接应对方案
