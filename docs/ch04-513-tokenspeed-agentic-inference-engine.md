...
## Ch04.513 tokenspeed agentic inference engine
...
- 推理系统优化 — 涵盖 KV-Cache 管理、连续批处理、投机解码、PD 分离等核心优化技术
...
- [LightSeek TokenSpeed — TokenSpeed 的姐妹项目，专注于轻量级推理优化](../ch01-817-lightseek-tokenspeed)
- [GLM-5 Scaling Pain 推理优化 — 高并发 Coding Agent 场景的推理问题复盘](../ch09-120-glm-5-scaling-pain-推理复盘)
- [AgentCore Managed Harness — AWS 的托管 Harness 平台，与推理引擎紧密配合](../ch04-408-amazon-bedrock-agentcore-harness-ga-两-api-调用生产级-agent-基础设施)
