...
- AI agent security (see [1Password Securing Ai Agents Machine Identities](../ch04/684-ai-agent.html), [Ai Agents Security Survey Attack Defense](../ch04/684-ai-agent.html))
