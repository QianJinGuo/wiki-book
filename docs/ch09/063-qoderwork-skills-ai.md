...
这一数字与[Agent配置模型](../ch04/339-skill.html)中"配置需要反复调参"的经验高度一致——AI工程的测试成本远高于传统软件工程，因为概率性系统的行为空间远大于确定性系统。
...
- [Agent配置模型](../ch04/339-skill.html)
- [Agent落地真相](../ch03/035-agent.html)
- [淘宝数字人Agentic架构](../ch04/718-agentic.html)
