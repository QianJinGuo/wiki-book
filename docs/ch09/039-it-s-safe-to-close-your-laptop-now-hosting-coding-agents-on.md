...
## Ch09.039 It’s safe to close your laptop now: Hosting coding agents on Amazon Bedrock AgentCore

> 📊 Level ⭐⭐ | 15.0KB | `entities/bedrock-agentcore-coding-agent-hosting.md`

# It’s safe to close your laptop now: Hosting coding agents on Amazon Bedrock AgentCore

> **Source archive**: [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/its-safe-to-close-your-laptop-now-hosting-coding-agents-on-a.md)
...
- [development environments for your cloud agents](../ch01/353-development-environments-for-your-cloud-agents.html)
