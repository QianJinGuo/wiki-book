...
> 📊 Level ⭐⭐⭐ | 7.3KB | `entities/tencent-ai-coding-practices.md`
...
- [开启Harness Engineering探索之旅](https://github.com/QianJinGuo/wiki-public/blob/main/entities/harness-engineering-exploration-journey-tencent.md)
- [腾讯CDN LEGO Harness Engineering实战](https://github.com/QianJinGuo/wiki-public/blob/main/entities/tencent-cdn-lego-harness.md)
- [腾讯 Token 优化实战 — 省 Token 和用好 AI 是同一件事](https://github.com/QianJinGuo/wiki-public/blob/main/entities/tencent-token-optimization-agent-architecture.md)
- [QQ音乐 Harness Engineering 实践（大仓多服务场景）](https://github.com/QianJinGuo/wiki-public/blob/main/entities/qq-music-harness-engineering-monorepo-microservices.md)
- [Harness 工程 2026 年度调研](https://github.com/QianJinGuo/wiki-public/blob/main/entities/harness-engineering-survey-2026.md)
- 淘宝前端 AI 实践
- [World Knowledge：Agent推理前先探索环境生成可迁移知识](https://github.com/QianJinGuo/wiki-public/blob/main/entities/world-knowledge-agent-self-evolution-tencent-hkustgz.md)
