...
## Ch09.116 打造 Claude Code 可持续推进的工作流：Loop Engineering 完整上手攻略

> 📊 Level ⭐⭐ | 4.1KB | `entities/loop-engineering-claude-code-sustainable-workflow.md`
...
- 补充 [Agent Loop Engineering Handbook 8 Questions Chen Jin Tencent Self 2026](ch03/044-agent.md) 的工程视角（本文更偏实操指南，陈进版更偏理论探讨）
- 与 [Agent Harness Architecture](ch03/044-agent.md) 形成架构+工程对照
