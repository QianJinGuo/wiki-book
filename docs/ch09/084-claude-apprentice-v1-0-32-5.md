...
这种"先规格后实现"的模式避免了 AI 在方向未明确时盲目编写代码，减少了返工成本。与 [Claude Code Loop Engineering](ch09/158-claude-code-loop-engineering.html) 中的"验证-执行"循环互补。
...
与 [兔兔AGI Loop Engineering](ch09/158-claude-code-loop-engineering.html) 和 [黄佳 8 关卡](../ch03/085-claude-code.html) 互补：
