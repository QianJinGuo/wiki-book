...
## Ch09.164 FastContext（微软开源 Coding Agent 仓库探索子代理）
...
- [Headroom 是怎么省上下文的](../ch03/045-agent.html)（VibeCoder 上下文优化系列前篇：工具输出字节级压缩；FastContext 偏仓库探索分工，角度互补）
- [AI Coding Agent 质量防御的五个控制机制](../ch04/314-ai-coding-agent.html)
- [Coding Agent 在百度的落地实践](ch09/048-coding-agent.html)
- [AgentMemory：Coding Agent 本地记忆](ch09/040-agentmemory-coding-agent.html)
- [阿里 LoongSuite Pilot：Coding Agent 从黑盒到透明](ch09/048-coding-agent.html)
