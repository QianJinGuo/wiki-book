...
## Ch09.039 DeepSeek V4 DS4C Antirez 本地推理实践
...
- [ds4c-deepseek-v4-antirez](../ch01/702-ds4c-deepseek-v4-antirez.html) — 同一项目的另一篇报道
...
- [DeepSeek-V4深度拆解](../ch01/615-deepseek-v4.html) — DeepSeek V4 论文深度解读
