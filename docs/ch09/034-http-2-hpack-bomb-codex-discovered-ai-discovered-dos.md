...
## Ch09.034 HTTP/2 HPACK Bomb — Codex Discovered AI-Discovered DoS
...
- AI agent security (see [1Password Securing Ai Agents Machine Identities](ch04/150-ai.md), [Ai Agents Security Survey Attack Defense](ch04/150-ai.md))
