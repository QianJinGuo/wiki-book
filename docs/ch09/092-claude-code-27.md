...
- [Loop Engineering](../ch05/006-loop-engineering.md)：第 23 条"Loop 先做只读小闭环"直接呼应 Loop Engineering 的保守五原则
- [Claude 18 个动作](../ch01/1022-claude.md)：同一作者（若飞）的前作，本文是更系统的升级版
- [Harness Engineering](../ch05/092-harness-engineering.md)：Hooks/CLAUDE.md/Skills 的分层设计呼应 Harness 的制动优先原则
- [Skills 重新定义 Agent 知识](../ch03/069-skills.md)：第 11 条"重复提示沉淀成 Skills"的实践指南
