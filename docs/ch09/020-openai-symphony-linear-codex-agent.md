...
- Symphony 强调的「**任务系统驱动 agent 干活**」与 [agent orchestration](../ch04/490-agent-orchestration.html) 的核心一致，但**控制平面从代码 session 切到了任务管理系统**
...
## 相关实体
- [Figma Make Local Code](../ch03/048-figma-make.html)
