...
## Ch09.063 Claude Code 七种自定义方法：官方全景指南
...
与 [Claude Code 源码解析：Skills/MCP/Rules 底层机制对比](ch04/271-skill.html) 互补——源码分析侧重底层 API 注入位置，本文侧重官方使用指南和决策框架。
...
→ [Claude Code 源码解析](ch04/271-skill.html)
...
→ [Claude Code 子智能体上下文卫生](ch03/077-claude-code.html)
...
→ [Claude Code Hooks 完整指南](ch05/094-ai.html)
