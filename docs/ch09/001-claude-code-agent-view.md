...
> -> [原文存档](https://mp.weixin.qq.com/s/panfFxjQOFdV-RM0KAtUsw)
...
## 与 Hermes 的关联
Agent View 解决的问题域与 Hermes 的 [Agent 编排](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/hermes-agent.md) 高度相关：
...
## 参考来源
[^1]: 花叔. *Claude Code 发布 Agent View，多任务流的 ADHD 患者有救了*. 微信公众号, 2026-05-12. [raw](001-claude-code-agent-view.html)
...
- [AI Agent工具数量陷阱——5个边界清楚的工具胜过20个模糊工具](../ch04/284-ai-agent.html)
