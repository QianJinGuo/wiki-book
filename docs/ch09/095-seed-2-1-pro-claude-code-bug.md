...
本文是一次极具启发性的实战记录：作者将字节跳动最新发布的 Seed 2.1 Pro 模型（开源，主打编程能力）与 [Claude Code](ch03/077-claude-code.html) 工具结合，让该模型直接修复自己产品中的真实 bug。
...
- [Coding Agent Quality Defense](ch05/094-ai.html)
