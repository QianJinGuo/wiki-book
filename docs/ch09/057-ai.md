...
## Ch09.057 AI 编码效率分析方法论

> 📊 Level ⭐⭐⭐ | 7.9KB | `entities/ai-coding-efficiency-analysis.md`
...
- [天猫新品营销技术团队AI编码实战指南（上）](https://github.com/QianJinGuo/wiki-public/blob/main/entities/天猫新品营销技术团队ai编码实战指南上.md)
...
- [ColaOS 与 AI 原生组织](https://github.com/QianJinGuo/wiki-public/blob/main/entities/colaos-listenhub-agency-native-organization-juzi.md)
- [规格驱动开发与 Harness](https://github.com/QianJinGuo/wiki-public/blob/main/entities/spec-driven-development-harness.md)
- [GSD 完胜 OpenSpec 和 Superpowers？三者防的是 context rot 的三道防线](https://github.com/QianJinGuo/wiki-public/blob/main/entities/gsd-openspec-superpowers-context-rot-three-defenses.md)
- [拒绝"感觉有效"：用数据证明 AI Coding 的真实团队价值](https://github.com/QianJinGuo/wiki-public/blob/main/entities/拒绝感觉有效用数据证明-ai-coding-的真实团队价值天猫ai-coding实践系列.md)
- [Token 不经济（腾讯研究院）](https://github.com/QianJinGuo/wiki-public/blob/main/entities/2026-06-29-Token不经济-腾讯研究院.md)
...
- [The New Bottleneck: Theory of Constraints in the Age of AI Coding](https://github.com/QianJinGuo/wiki-public/blob/main/entities/the-new-bottleneck-theory-of-constraints-ai-coding-tools.md)
- [Claude Code 到底有多费 token？三大框架最多差 30 倍](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-token-cost-harness-comparison-30x-jiqizhixin-2026.md)
- [龙套件 Pilot SLS AI 编程指标实践](https://github.com/QianJinGuo/wiki-public/blob/main/entities/loongsuite-pilot-sls-ai-coding-metrics-practice.md)
