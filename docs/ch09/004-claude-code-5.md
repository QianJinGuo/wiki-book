...
作者若飞（JiaGouX）系列关联：[Harness 实践指南](../ch05/065-harness-engineering.html)、[Harness 框架](https://github.com/QianJinGuo/wiki/blob/main/concepts/harness-engineering-framework.md)
