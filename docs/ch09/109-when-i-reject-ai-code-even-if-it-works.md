...
## Ch09.109 When I reject AI code even if it works
...
- [Building Reliable Agentic AI Systems](../ch04/246-building-reliable-agentic-ai-systems.html) — 同样关注 AI 系统的工程可靠性
- [Claude Code Dynamic Workflows](ch09/092-claude-code-dynamic-workflows.html) — AI 编码代理的实践模式
