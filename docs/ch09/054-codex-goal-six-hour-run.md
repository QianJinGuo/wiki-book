...
- [Codex /goal：长任务Agent的目标运行时](ch09/041-codex-goal.md) — 若飞源码级拆解，目标状态机 + completion audit 协议 + budget_limit 收束模板
- [Claude Code / OpenClaw Memory 对比](ch03/073-claude-code.md) — 记忆架构与 Codex 的对比参考
- [Anthropic Claude Code 大型代码库最佳实践](ch03/073-claude-code.md) — Claude Code 在大规模代码库中的实践
- [Claude Code Session 管理 1M Context](ch03/073-claude-code.md) — 长上下文会话管理
