...
## Ch09.130 Skill Issues: Compromising Claude Code with malicious skills & agents — Part 1
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/skill-issues-compromising-claude-code-with-malicious-skills-agents.md)

- [xz-utils backdoor 2 years on — maintainer trust hijack patte](../ch05/100-ai.html)
