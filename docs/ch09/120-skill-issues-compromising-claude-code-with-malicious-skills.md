...
## Ch09.120 Skill Issues: Compromising Claude Code with malicious skills & agents — Part 1
...
- [xz-utils backdoor 2 years on — maintainer trust hijack patte](../ch05/095-ai.html)
