...
本页作为知识图谱锚点，连接了以下关键实体：[Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](../ch03/045-agent.md)。 相关主题通过 [Vibe Coding and Agentic Engineering Convergence: Simon Willison Interview](../ch04/405-vibe-coding-agentic-engineering.md) 延伸。
...
- [Vibe Coding and Agentic Engineering Convergence: Simon Willison Interview](../ch04/405-vibe-coding-agentic-engineering.md)
- [无障碍设计师 vibe coding：当所有同事都在用 AI 写代码时](../ch01/911-20.md)
- [Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](../ch03/045-agent.md)
