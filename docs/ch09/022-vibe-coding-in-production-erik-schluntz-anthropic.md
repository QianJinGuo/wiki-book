...
- [Tencent Vibe Coding To Agentic Engineering Backend](../ch04/306-tencent-vibe-coding-to-agentic-engineering-backend.html)
...
> [!contradiction] 参见 [Agent 时代的生产力悖论](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-时代的生产力悖论当协作本身成为最大的瓶颈.md) 与 [工程角色转向管理 AI](051-engineering-roles-shift-from-developing-code-to-managing-ai.html) 持相反观点：本文主张 vibe coding 已可进入生产环境，而两文分别强调协作瓶颈与审查成本不可忽视。
