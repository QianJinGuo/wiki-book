...
## Ch09.018 Anthropic 的 Harness 没管住 Claude Code？软规则 vs 硬约束
...
## 相关实体
- [Claude Code Governance Soft Rules](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-governance-soft-rules.md)
