...
> 📊 Level ⭐⭐⭐⭐⭐ | 16.9KB | `entities/adopting-ai-coding-agents-six-lessons.md`
...
- 大任务用 [Harness Engineering](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/harness-engineering-framework.md) 的 Explore-Plan-Act 循环：先探索、再规划、最后动手
...
- 模板代码 → 封装成 `npm package`（[天猫团队](https://github.com/QianJinGuo/wiki-public/blob/main/entities/tmall-ai-coding-practice-guide.md)的创新做法）
...
- [规范每一行都对应一个历史失败案例](https://github.com/QianJinGuo/wiki-public/blob/main/entities/harness-engineering-90-percent-pillars.md)——凭空设计的"最佳实践"不如真实踩坑后的约束
...
- [马丁·福勒](https://github.com/QianJinGuo/wiki-public/blob/main/entities/martin-fowler-的-ai-研发提醒非确定性进了研发链路harness-才真正开始承重.md)的核心观点：测试和重构不是旧时代包袱，而是 AI 时代的价值锚——AI 生成越快，确定性反馈环越值钱
...
### 实践要点
- [Claude Code 源码分析](https://mp.weixin.qq.com/s/eUbRoyKxOjiAPuXZi8DPsQ) 显示其权限控制细到很具体的粒度，远比大多数 Agent 框架更严格
...
- 用错误分类驱动 [Harness Engineering](https://github.com/QianJinGuo/wiki-public/blob/main/entities/harness-engineering-systematic-framework.md) 的迭代：Guides（事前防御）+ Sensors（事中检测）+ Garbage Collection（事后清理）
...
- [Claude Code 12 个设计模式](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-agentic-harness-design-patterns.md) — 生产级 Agent 的架构参考
- [Agent Context Management](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-harness-context-management-working-set.md) — 上下文管理的最佳实践
