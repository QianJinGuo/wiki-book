...
## 相关实体
- [Obsidian + Claude Code 集成指南](../ch03-002-obsidian-claude-code-集成指南/) — 知识管理工具集成
- [Claude Code MCP Server](../ch07-024-claude-code-mcp-server/) — MCP 协议集成
- [IMClaw](../ch01-328-imclaw-通过微信-飞书操控claudecode-codex-geminicli-pi-agent蜂群/) — IM 平台操控
- [OpenClaw 安全增强](../ch12-025-openclaw-安全和功能增强实践/) — 自托管 Agent 平台
- [Kiro + Claude Code](../ch09-023-使用-kiro-ai-ide-开发-基于amazon-emr-的flink-智能监控系统实践-亚马逊aws官方博客/) — AI IDE 协同
- [企业级 Agentic AI](../ch04-144-用-kiro构建-ai-基于-aws-基础设施快速构建企业级-agentic-ai-平台-亚马逊aws官方博客/) — AWS 集成
- MOC
