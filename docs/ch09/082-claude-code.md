...
## 相关实体
- [Obsidian + Claude Code 集成指南](ch09/152-obsidian-claude-code-integration-guide.html) — 知识管理工具集成
...
- [企业级 Agentic AI](../ch04/677-agentic-ai.html) — AWS 集成
