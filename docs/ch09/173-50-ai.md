...
## Ch09.173 从需求到原型：50 个设计师与产品经理的 AI 智能体技能

> 📊 Level ⭐⭐ | 4.4KB | `entities/50-ai-agent-skills-designer-pm-workflow-v2.md`
...
- 补充 [50 Ai Agent Skills For Designers And Pms](../ch04/532-ai-agent-skill.html) 的更新版（本文为 2026-06-10 版本，内容更完整）
