...
## Ch09.076 claude-apprentice v1.0：32 文件设计取舍与 5 层架构工程实现
...
这种"先规格后实现"的模式避免了 AI 在方向未明确时盲目编写代码，减少了返工成本。与 [Claude Code Loop Engineering](ch03/077-claude-code.html) 中的"验证-执行"循环互补。
...
与 [兔兔AGI Loop Engineering](ch03/077-claude-code.html) 和 [黄佳 8 关卡](ch03/077-claude-code.html) 互补：
...
- [Claude Code Loop Engineering](ch03/077-claude-code.html) — 兔兔AGI 的 Loop Engineering 方法论
...
- [OpenSpec/Solo Spec 驱动开发](ch01/1016-spec.html) — 规格先行在 AI 开发中的应用
