...
## Ch09.104 Vibe Coding in Production — Erik Schluntz / Anthropic
...
- [从Vibe Coding到Agentic Engineering重构后台开发全流程](ch04/502-agent.md)
- [Tencent Vibe Coding To Agentic Engineering Backend](ch04/192-tencent-vibe-coding-to-agentic-engineering-backend.md)
- [Anthropic 官方生产级 Agent 最佳实践12 个可复用的 Mcp 设计模式 V2](ch04/502-agent.md)
