...
- 中途插话调整方向
- 接着上次没完成的继续聊
- **不用守着，随时可以管** See also [Claude Code Architecture](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-architecture.md)
...
---
## 关联
→ [原文存档](https://mp.weixin.qq.com/s/J1PU1yegNM32PjUp7JQ7iQ)
