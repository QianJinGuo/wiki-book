...
## Ch09.139 从需求到原型：50 个设计师与产品经理值得掌握的 AI 智能体技能
...
- [Skill 设计模式](../ch04/267-skill.html) — 从顶级仓库提炼的核心设计模式
- [Agent Skill 编写指南](../ch04/607-agent-skill.html) — Skill 编写方法论
- [Knowledge Work Plugins](../ch01/1292-anthropic.html) — Anthropic 知识工作插件
- [Skill 设计规范 8 块检查清单](../ch04/267-skill.html)
