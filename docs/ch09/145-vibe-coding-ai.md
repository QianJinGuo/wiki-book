...
## Ch09.145 Vibe Coding 与 AI 软件工程
...
本页作为知识图谱锚点，连接了以下关键实体：[Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](../ch04/597-agentic.html)。 相关主题通过 [Vibe Coding and Agentic Engineering Convergence: Simon Willison Interview](../ch04/418-vibe-coding-agentic-engineering.html) 延伸。
...
- [无障碍设计师 vibe coding：当所有同事都在用 AI 写代码时](../ch01/959-20.html)
- [Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](../ch04/597-agentic.html)
