...
## 相关实体
- [Auditing Gitlab Cicd Kill Chain Black Hills 2026](../ch04/257-ai.html)
...
→ [Claw Chain Cyera Research Unveil Four Chainable Vulnerabilities In Openclaw](058-claw-chain-cyera-research-unveil-four-chainable-vulnerabili.html) — OpenClaw 多漏洞链披露，与本文同为 2026 年安全研究，展示了从 webview XSS 到 RCE 的链式利用完整路径，对理解 IDE/扩展攻击面具有重要参考价值。
