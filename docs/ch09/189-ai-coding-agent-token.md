...
## Ch09.189 AI Coding Agent Token 成本控制五层模型
...
- [Claw-SWE-Bench](ch12/003-token.html) — Pareto 成本分析
- [快手 RCA Agent](ch05/100-ai.html) — Workflow 快思考+Agent 慢思考
- [Skill 版本对比](ch04/341-skill.html) — Token/时延门禁
