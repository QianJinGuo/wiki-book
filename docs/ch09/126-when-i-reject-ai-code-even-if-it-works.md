...
## Ch09.126 When I reject AI code even if it works

> 📊 Level ⭐⭐ | 7.2KB | `entities/when-i-reject-ai-code-even-if-it-works-vinibrasil.md`
...
- [Building Reliable Agentic AI Systems](../ch04/299-building-reliable-agentic-ai-systems.html) — 同样关注 AI 系统的工程可靠性
- [Claude Code Dynamic Workflows](ch09/104-claude-code-dynamic-workflows.html) — AI 编码代理的实践模式
