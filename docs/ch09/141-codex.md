...
## Ch09.141 Codex 五层架构：记忆/知识/护栏/委派/分发

> 📊 Level ⭐⭐ | 2.3KB | `entities/codex-5-layer-architecture.md`
...
- [Codex AGENTS.md 配置实践](ch03/044-agent.md)
- [古法程序员 Codex 三层 Skill 架构](ch01/436-codex.md)
