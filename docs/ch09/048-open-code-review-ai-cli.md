...
## Ch09.048 Open Code Review：阿里开源的 AI 代码评审 CLI 工具
...
- [Claude Code 治理软规则](../ch03/057-claude-code.html) — 探讨 Agent 行为治理模式，与 Open Code Review 的确定性约束形成对比
- [复杂任务规范（gufabiancheng）](../ch01/393-codex.html) — 探讨 Agent 在复杂任务中的规范执行
