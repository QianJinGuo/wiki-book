...
> → [原文存档](https://mp.weixin.qq.com/s/OXXZdKfBwFJJK14kKBJ5Kw)
...
这与 [Karpathy: Software 3.0 与 vibe coding 时代的终结](https://github.com/QianJinGuo/wiki-public/blob/main/entities/karpathy-software3-vibe-coding-dead-agentic-engineering.md) 中关于"AI 编程工具的最终形态是 agentic engineering"的判断同构——只有当 Agent 工具沉淀出"自我验证 + 异步调度 + 异步 Routine"的工程模式时，它的价值才会从"工具"升级为"基础设施"。
...
Routines 与 [24h Worker Agent](https://github.com/QianJinGuo/wiki-public/blob/main/entities/24h-worker-agent.md) 描述的"持续运行的 Agent"完全一致——Claude Code 的 Routine 是工业级实现。Routine 在产品形态上对应到：
...
这与 [Agent Security 三步走: Harness + Governance + Identity](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-security-three-step-sequence-harness-governance-identity-crewai.md) 中"governance 必须可验证、可审计"的原则一致——Auto Mode 是 governance 的工业级实现。
...
这与 [From Prompt to Harness: Claude 官方](https://github.com/QianJinGuo/wiki-public/blob/main/entities/from-prompt-to-harness-claude-official.md) 描述的"harness 不是更大 prompt，是更好结构"理念一致——harness engineering 的核心不是"塞更多 context"，而是"提供对的 tools + 对的评估 + 对的 Skill 沉淀机制"。
...
- [Boris Cherny: 从 IDE 到 Agent Console](https://github.com/QianJinGuo/wiki-public/blob/main/entities/boris-cherny-ide-to-agent-console.md)
- [Boris Cherny Interview 2026: 从 IDE 到 Agent Console](https://github.com/QianJinGuo/wiki-public/blob/main/entities/boris-cherny-interview-2026-ide-to-agent-console.md)
- [Boris Cherny 新访谈: 开发工具正在从 IDE 变成 Agent 控制台 v2](https://github.com/QianJinGuo/wiki-public/blob/main/entities/boris-cherny-新访谈开发工具正在从-ide-变成-agent-控制台-v2.md)
...
- [Claude Code 一周年回顾 Boris+Cat 2026](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-first-year-retrospective-boris-cat-2026.md)
- [OpenClaw × Boris Cherny: Agent Loop 设计模式](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openclaw-boris-cherny-agent-loop-design-patterns.md)
- [Claude Code Prompt 源码分析](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-prompt-source-analysis.md)
- [Claude Code Prompt 源码分析 fanone](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-prompt-source-analysis-fanone.md)
...
- [From Prompt to Harness: Claude 官方](https://github.com/QianJinGuo/wiki-public/blob/main/entities/from-prompt-to-harness-claude-official.md)
- [Anthropic Prompt Caching 与 Claude Code](../ch01/211-anthropic-prompt-caching-claude-code.html)
- [24h Worker Agent](https://github.com/QianJinGuo/wiki-public/blob/main/entities/24h-worker-agent.md)
