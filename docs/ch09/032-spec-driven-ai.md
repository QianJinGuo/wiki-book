...
## Ch09.032 Spec-Driven AI 编程半年实战 — 有损管道、三工具比较与三大认知陷阱

> 📊 Level ⭐⭐ | 4.0KB | `entities/spec-driven-development-cognitive-framework.md`
...
与 [Harness Engineering](../ch05/096-harness-engineering.html) 互补——该实体是 Harness 工程框架，本实体是 **Spec 层的认知与选型理论**。
...
- [OpenSpec 四步法复盘](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openspec-四步法深度复盘-流程完整不等于代码正确.md) — 互补：该实体聚焦 OpenSpec 具体流程短板，本实体提供 **SDD 的认知基础框架**
- [OpenSpec + Trae/Solo 实践](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openspec-spec-driven-development-trae-solo.md) — 互补：工具实操 vs 认知理论
- [Spec 作为反熵架构](https://github.com/QianJinGuo/wiki-public/blob/main/entities/spec-as-aios-anti-entropy-architecture-gaode-ai-native-series-2.md) — 互补：该实体聚焦 Spec 作为架构工具，本实体聚焦 **SDD 的开发流程认知**
