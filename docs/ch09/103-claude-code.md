...
- [CLAUDE.md 12 条规则](../ch01/182-claude-md.html) — 本文解决"写什么规则"，本文解决"规则放哪里"
- [Claude Code 大型代码库 Harness 配置](../ch03/057-claude-code.html) — CLAUDE.md 作为 Harness 五扩展点之一
- [Claude Code 七种自定义方法](../ch03/057-claude-code.html) — Anthropic 官方全景指南
