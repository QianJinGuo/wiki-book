...
## Ch09.079 老代码克星：36k Star的 AI 神器，跑一条命令就把项目结构整明白了！
...
- [Ai Coding Agent Quality Defense Five Control Mechanisms](../ch04/326-ai-coding-agent.html)
...
- [How Ai Agent Memory Works](../ch04/159-how-ai-agent-memory-works.html) — Agent 记忆机制
