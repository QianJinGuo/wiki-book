...
4. **开源 Coding Agent 模型正在形成分层竞争格局**：Laguna XS 2.1 (63.1% SWE-bench ML) 与 [DeepSeek](../ch01/796-deepseek.html)、Qwen 等国产模型之间的差距正在收窄，开发者应基于本地部署成本、推理速度和特定语言/框架的支持度做综合选型，而非仅看单点基准分数。
...
- [LLM Post-Training](../ch01/859-llm.html)
