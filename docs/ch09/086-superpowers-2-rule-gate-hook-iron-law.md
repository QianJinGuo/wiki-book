...
- [Superpowers 深度解析（1）：概率操控与负向收益](../ch05/070-superpowers-claude-code.html) — 第 1 来源
- [Harness Engineering](../ch05/057-harness-engineering.html)
- [12 Agent 设计模式](../ch03/004-agent.html) — 同样强调"确定性从 LLM 剥离"
- [AI Coding Agent Token 成本控制](038-coding-agent.html) — Superpowers 多阶段会大幅增加 token 成本
