...
## Ch09.100 2 小时，0 行手写代码，我用 Claude 做了一个生产级 VSCode 插件
...
- [Claude Vscode Plugin Zero Code](ch01/380-claude.md)
- [Doubao Seed 2 Lite Agent Multimodal](ch04/503-agent.md)
