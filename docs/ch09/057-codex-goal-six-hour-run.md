...
- [Codex /goal：长任务Agent的目标运行时](../ch04/104-codex-goal-agent.md) — 若飞源码级拆解，目标状态机 + completion audit 协议 + budget_limit 收束模板
- [Claude Code / OpenClaw Memory 对比](../ch03/075-claude-code.md) — 记忆架构与 Codex 的对比参考
- [Anthropic Claude Code 大型代码库最佳实践](../ch01/342-anthropic-claude-code.md) — Claude Code 在大规模代码库中的实践
