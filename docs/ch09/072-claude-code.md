...
→ [Claude Code 子智能体上下文卫生](../ch04/236-claude-code-subagents.html)
...
→ [Claude Code Hooks 完整指南](../ch03/085-claude-code.html)
...
- → [Claude Code 治理：软规则与硬约束](../ch03/085-claude-code.html)
- → [Claude Code 子智能体上下文卫生](../ch04/236-claude-code-subagents.html)
- → [Claude Code Hooks 完整指南](../ch03/085-claude-code.html)
- → [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/claude-code-seven-customization-methods-anthropic-official.md)
