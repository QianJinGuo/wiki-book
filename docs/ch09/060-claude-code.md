...
与 [Claude Code 源码解析：Skills/MCP/Rules 底层机制对比](../ch07/006-claude-code-skills-mcp-rules.md) 互补——源码分析侧重底层 API 注入位置，本文侧重官方使用指南和决策框架。
...
→ [Claude Code 源码解析](../ch07/006-claude-code-skills-mcp-rules.md)
...
→ [Claude Code 子智能体上下文卫生](../ch04/172-claude-code-subagents.md)
...
→ [Claude Code Hooks 完整指南](../ch03/075-claude-code.md)
