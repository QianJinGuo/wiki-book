...
## Ch09.092 老代码克星：36k Star的 AI 神器，跑一条命令就把项目结构整明白了！
...
## 相关实体
- [Spec As Aios Anti Entropy Architecture Gaode Ai Native Series 2](../ch05/022-ai-native.html)
- [Business Agent Augmentation Layer Practitioner Methodology 20260606](../ch03/037-agent.html)
...
- [How Ai Agent Memory Works](../ch04/216-how-ai-agent-memory-works.html) — Agent 记忆机制
