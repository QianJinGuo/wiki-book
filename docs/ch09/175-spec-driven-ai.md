...
## Ch09.175 Spec-Driven AI 编程半年实战 — 有损管道、三工具比较与三大认知陷阱
...
- [OpenSpec 四步法复盘](../ch05/054-openspec.html) — 互补：该实体聚焦 OpenSpec 具体流程短板，本实体提供 **SDD 的认知基础框架**
- [OpenSpec + Trae/Solo 实践](../ch05/054-openspec.html) — 互补：工具实操 vs 认知理论
