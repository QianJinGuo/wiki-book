...
## Ch09.165 从需求到原型：50 个设计师与产品经理值得掌握的 AI 智能体技能
...
- [Agent Skill 编写指南](../ch04/612-agent-skill.html) — Skill 编写方法论
- [Knowledge Work Plugins](../ch01/779-anthropic.html) — Anthropic 知识工作插件
- [Skill 设计规范 8 块检查清单](../ch04/349-skill.html)
- [Agent Skill 编写实践](../ch04/612-agent-skill.html)
