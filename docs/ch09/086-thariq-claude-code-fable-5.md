...
## Ch09.086 Thariq（Claude Code工程师）的Fable 5使用心法：地图≠领土，用未知消除法突破模型瓶颈
...
- [Fable 5 模型能力分析](../ch01/177-claude-fable-5.html) — Fable 5 模型能力分析
- [Agentic Coding 方法论](../ch04/631-agentic.html) — Agentic Coding 方法论的整体框架
