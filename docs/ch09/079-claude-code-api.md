...
## Ch09.079 Claude Code 静默识别中国 API 路由
...
- [Anthropic Skill Stack 架构](ch04/271-skill.html) — Anthropic 的 Agent 工程架构背景，帮助理解 Claude Code 的底层设计
...
- [AI Gateway vs MCP Gateway 安全须知](ch05/094-ai.html) — API 路由与安全网关的讨论，与本实体的 API 路由指纹识别直接相关
