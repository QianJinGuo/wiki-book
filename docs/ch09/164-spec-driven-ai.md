...
- [OpenSpec 四步法复盘](ch01/1016-spec.html) — 互补：该实体聚焦 OpenSpec 具体流程短板，本实体提供 **SDD 的认知基础框架**
- [OpenSpec + Trae/Solo 实践](ch01/1016-spec.html) — 互补：工具实操 vs 认知理论
- [Spec 作为反熵架构](ch05/094-ai.html) — 互补：该实体聚焦 Spec 作为架构工具，本实体聚焦 **SDD 的开发流程认知**
