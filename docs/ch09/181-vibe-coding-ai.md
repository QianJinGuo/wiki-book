...
- [Vibe Coding and Agentic Engineering Convergence: Simon Willison Interview](ch09/052-coding-agent.html)
- [无障碍设计师 vibe coding：当所有同事都在用 AI 写代码时](ch01/1429-0.html)
- [Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](ch03/035-agent.html)
