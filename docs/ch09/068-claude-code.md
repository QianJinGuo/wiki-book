...
## 相关实体
- [Obsidian + Claude Code 集成指南](ch09/127-obsidian-claude-code-integration-guide.html) — 知识管理工具集成
- [Claude Code MCP Server](../ch07/027-claude-code-mcp-server.html) — MCP 协议集成
- [IMClaw](../ch03/076-claude-code.html) — IM 平台操控
- [OpenClaw 安全增强](../ch11/224-openclaw.html) — 自托管 Agent 平台
- [Kiro + Claude Code](../ch05/086-ai.html) — AI IDE 协同
- [企业级 Agentic AI](../ch04/566-agentic-ai.html) — AWS 集成
