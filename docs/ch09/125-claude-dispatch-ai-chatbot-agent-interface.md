...
## Ch09.125 Claude Dispatch + 接口力量：AI 从 Chatbot 到 Agent Interface 的转变
...
- [Anthropic Claude Cowork Task Boundary 5 Signals 6 Stages](../ch01/1614-anthropic-claude.html)
