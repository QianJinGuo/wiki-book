...
## Ch09.143 一年吃掉一块固态硬盘，Codex日志bug被骂「劣质软件
...
- [Codex HTTP/2 HPACK Bomb](https://github.com/QianJinGuo/wiki/blob/main/entities/califio-codex-http2-hpack-bomb-880k-servers.md) — 另一个 Codex 工程问题
- [Claude Code vs Codex 架构对比](https://github.com/QianJinGuo/wiki/blob/main/entities/claude-code-vs-codex-context-architecture-02.md)

→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/一年吃掉一块固态硬盘codex日志bug被骂劣质软件.md)
