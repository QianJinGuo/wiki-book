...
- [Anthropic 95Pct Data Analysis Skill Stack Architecture](../ch01/776-anthropic.html) — Skills 系统的架构设计
...
- [Kimi Work Beta Foundation Model Company Advantage](../ch01/575-kimi.html) — 模型公司做 Agent 的战略逻辑
- [Anthropic Biology Agent Data Infrastructure Virbench](../ch01/776-anthropic.html) — 数据基础设施对 Agent 能力的影响
