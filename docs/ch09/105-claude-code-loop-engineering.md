...
- 补充 [Agent Loop Engineering Handbook 8 Questions Chen Jin Tencent Self 2026](../ch04/350-loop-engineering.html) 的工程视角（本文更偏实操指南，陈进版更偏理论探讨）
- 与 [Agent Harness Architecture](../ch05/035-agent-harness.html) 形成架构+工程对照
