...
## Ch09.154 从需求到原型：50 个设计师与产品经理值得掌握的 AI 智能体技能
...
```mermaid
mindmap
  root(("从需求到原型 50 个设计师与产品经理值得掌握的 AI 智能体技能"))
    个开源技能集合
    阶段技能地图
      一 发现与研究 10 个技能
      二 策略与定义 7 个技能
...
- [Skill 设计模式](../ch04/271-skill.html) — 从顶级仓库提炼的核心设计模式
- [Agent Skill 编写指南](../ch04/269-agent-skill.html) — Skill 编写方法论
- [Knowledge Work Plugins](../ch01/989-anthropic.html) — Anthropic 知识工作插件
- [Skill 设计规范 8 块检查清单](../ch04/271-skill.html)
- [Agent Skill 编写实践](../ch04/269-agent-skill.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/50-ai-agent-skills-for-designers-and-pms.md)
