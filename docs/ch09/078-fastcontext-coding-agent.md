...
→ [原文存档](https://mp.weixin.qq.com/s/vIsZKoH-RZkaTiZS0tiDlw)

- [Headroom 是怎么省上下文的](https://github.com/QianJinGuo/wiki-public/blob/main/entities/headroom-context-compression-agent-vibecoder.md)（VibeCoder 上下文优化系列前篇：工具输出字节级压缩；FastContext 偏仓库探索分工，角度互补）
- [AI Coding Agent 质量防御的五个控制机制](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-coding-agent-quality-defense-five-control-mechanisms-tutu-agi.md)
- [Coding Agent 在百度的落地实践](https://github.com/QianJinGuo/wiki-public/blob/main/entities/baidu-comate-coding-agent-feedback-loop-wanpeng.md)
- [AgentMemory：Coding Agent 本地记忆](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agentmemory-coding-agent-local-memory.md)
- [阿里 LoongSuite Pilot：Coding Agent 从黑盒到透明](https://github.com/QianJinGuo/wiki-public/blob/main/entities/alibaba-agent-observability-audit-loongsuite-pilot-coding-agent-blackbox-transparent.md)
