...
- → [Hermes Agent自进化机制](https://github.com/QianJinGuo/wiki-public/blob/main/entities/hermes-agent-self-evolving.md) — 另一角度分析
- → [Hermes记忆系统](https://github.com/QianJinGuo/wiki-public/blob/main/entities/hermes-agent-memory-system-openclaw-comparison.md) — vs OpenClaw
...
> 参见 [原文存档](https://mp.weixin.qq.com/s/qdycBcCUujnVBkO4vky0wA) 
## 相关实体
