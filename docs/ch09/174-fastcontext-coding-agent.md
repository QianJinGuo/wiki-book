...
## Ch09.174 FastContext（微软开源 Coding Agent 仓库探索子代理）
...
- [Headroom 是怎么省上下文的](../ch03/046-agent.html)（VibeCoder 上下文优化系列前篇：工具输出字节级压缩；FastContext 偏仓库探索分工，角度互补）
- [AI Coding Agent 质量防御的五个控制机制](../ch04/321-ai-coding-agent.html)
