...
- [State Of Memory In Agent Harness Mem0 2026](ch04/502-agent.md)（mem0 Agent 记忆体系对照）
...
- [Snowflake Agentic Enterprise Summit 2026](ch04/502-agent.md)（Snowflake — 企业级 AI 可审计性同主线）
...
- [Hermes Agent Self Evolving](ch04/502-agent.md)（Hermes Agent 自演进对照）
