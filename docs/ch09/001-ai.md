...
mindmap
  root(("视觉还原 AI 技术"))
    ...
    布局推理 Layout Inference
    组件匹配 Component Matching
    样式推导 Style Derivation
...
[淘宝前端 AI 实践](https://github.com/QianJinGuo/wiki/blob/main/entities/taobao-frontend-practices.md) 在视觉还原领域积累了丰富的落地经验。其核心方案参见 [场景营销前端 AI Coding — AI Native 的视觉稿还原](../ch05/018-ai-native.html)，核心方法论参见 [场景营销前端 AI Coding — 从问题到方案](../ch05/111-ai-coding.html)。
...
- [AE 到可运行代码：大淘宝 AI 动画全链路方案](../ch01/913-20.html)
