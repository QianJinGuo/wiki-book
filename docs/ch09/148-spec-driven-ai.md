...
## Ch09.148 Spec-Driven AI 编程半年实战 — 有损管道、三工具比较与三大认知陷阱

> 📊 Level ⭐⭐ | 3.8KB | `entities/spec-driven-development-cognitive-framework.md`
...
与 [Harness Engineering](../ch05/052-harness-engineering.html) 互补——该实体是 Harness 工程框架，本实体是 **Spec 层的认知与选型理论**。
...
- [Spec 作为反熵架构](../ch05/019-ai-native.html) — 互补：该实体聚焦 Spec 作为架构工具，本实体聚焦 **SDD 的开发流程认知**
