...
## Ch09.126 AI Coding Agent Token 成本控制五层模型
...
- [Claw-SWE-Bench](ch01/277-token.md) — Pareto 成本分析
- [快手 RCA Agent](ch04/310-ai.md) — Workflow 快思考+Agent 慢思考
- [Skill 版本对比](ch04/245-skill.md) — Token/时延门禁
- [12 Agent 设计模式](ch04/503-agent.md) — 分层记忆+上下文隔离
