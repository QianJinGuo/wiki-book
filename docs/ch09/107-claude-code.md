...
## Ch09.107 Claude Code 为什么会忽略指令：四类失效原因 + 五层规则框架
...
- [Claude Code 大型代码库 Harness 配置](ch03/073-claude-code.md) — CLAUDE.md 作为 Harness 五扩展点之一
- [Claude Code 七种自定义方法](ch03/073-claude-code.md) — Anthropic 官方全景指南
