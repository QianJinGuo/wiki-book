...
这与 [Agent Security 三步走: Harness + Governance + Identity](ch05/094-ai.html) 中"governance 必须可验证、可审计"的原则一致——Auto Mode 是 governance 的工业级实现。
...
这与 [From Prompt to Harness: Claude 官方](ch01/976-claude.html) 描述的"harness 不是更大 prompt，是更好结构"理念一致——harness engineering 的核心不是"塞更多 context"，而是"提供对的 tools + 对的评估 + 对的 Skill 沉淀机制"。
...
- [Claude Code Prompt 源码分析](ch03/077-claude-code.html)
- [Claude Code Prompt 源码分析 fanone](ch03/077-claude-code.html)
- [Claude Code Prompt Context Harness](ch03/077-claude-code.html)
- [From Prompt to Harness: Claude 官方](ch01/976-claude.html)
...
- [Agent Security 三步走: Harness + Governance + Identity](ch05/094-ai.html)
