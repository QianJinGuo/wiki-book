...
## Ch09.102 Superpowers 深度解读（2）：Rule/Gate/Hook 与 Iron Law 方法论
...
- [Superpowers 深度解析（1）：概率操控与负向收益](../ch05/078-superpowers-claude-code.html) — 第 1 来源
- [Harness Engineering](../ch05/050-harness-engineering.html)
- [12 Agent 设计模式](../ch03/045-agent.html) — 同样强调"确定性从 LLM 剥离"
- [AI Coding Agent Token 成本控制](ch09/048-coding-agent.html) — Superpowers 多阶段会大幅增加 token 成本
