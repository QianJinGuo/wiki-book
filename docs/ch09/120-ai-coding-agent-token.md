...
- [Claw-SWE-Bench](../ch09-049-claw-swe-bench-首个独立测量harness对编程agent影响的基准/) — Pareto 成本分析
- [快手 RCA Agent](../ch04-419-快手-rca-agent-复杂业务场景下排障-agent-的探索实践/) — Workflow 快思考+Agent 慢思考
- [Skill 版本对比](../ch07-049-skill-版本对比五大原则-从-两个数字比大小-到工程化质量门禁/) — Token/时延门禁
- [12 Agent 设计模式](../ch05-068-12-个-agent-工程设计底层逻辑-脚手架-vs-承重墙/) — 分层记忆+上下文隔离
