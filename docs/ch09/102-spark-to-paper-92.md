...
> 📊 Level ⭐⭐ | 8.5KB | `entities/端到端论文生成系统假结论检出率92自动跑实验画图直出论文初稿.md`
...
> 与 [Agent 评估基准](https://github.com/QianJinGuo/wiki/blob/main/concepts/agent-evaluation-benchmarks.md) 及科研自动化智能体家族互补：本实体展示了把科研流程拆成可组合技能、以确定性 Gate + 对抗式评审对抗幻觉的完整工程范式，是 [Agent Harness Engineering](https://github.com/QianJinGuo/wiki/blob/main/concepts/agent-harness-engineering-paradigm.md) 在科研写作场景的实例。

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/端到端论文生成系统假结论检出率92自动跑实验画图直出论文初稿.md)
