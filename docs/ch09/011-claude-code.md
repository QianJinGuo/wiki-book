...
参见 [Agent Harness 架构](../ch05/038-agent-harness.md)（AHE框架）。
...
- [Feishu Aily Agent Lobster](../ch04/472-aily-agent.md)
...
- [Red Sequoia Ai Summit Agi Declaration](../ch01/281-agi.md)
...
- [100 年压缩到 100 天红杉资本这就是 Agi](../ch01/281-agi.md)
- [Stripe Agent Economic Infrastructure Emily Sands](../ch03/045-agent.md)
- [Pilotdeck Data派Thu 2026](../ch01/911-20.md)
- [Four Sub Agent Patterns](../ch03/045-agent.md)
- [A Guide To Which Ai To Use In The Agentic Era](../ch01/582-a-guide-to-which-ai-to-use-in-the-agentic-era.md)
- [Ai Xiaolaoliu Business Agent Augmentation Layer General Base 20260606](../ch03/045-agent.md)
- [Cloud Agent Development Environments](../ch03/045-agent.md)
- [Volcengine Data Agent Product Overview](../ch04/573-data-agent.md)
- [Ai Agent Engineer Learning Roadmap Backend 2026](../ch04/147-ai-agent.md)
- [Emergent Collaboration Ai High Quality Decision Agent Room](../ch04/607-agent-room.md)
- [Iclr 2026 英伟达 普渡大学用Agent闭环实现文生3D](../ch03/045-agent.md)
...
- [Hermes Agent Long Running Governance Five Cards Ruofei](../ch03/090-hermes-agent.md)
- [Agentic Rl Token In Token Out Done Right C6Aaa4](../ch04/567-agentic-rl-token-in-token-out-done-right.md)
- [Ai Techliwen Creaoai Cloud Agent Infrastructure Two Lessons 20260606](../ch03/045-agent.md)
- [你不知道的 Agent原理架构与工程实践 V2](../ch03/045-agent.md)
- [Kimi Work 300 Agent Cluster Yin John Agi Hunt](../ch03/045-agent.md)
- [Your First Ai Agent Should Do One Thing Badly](../ch04/365-your-first-ai-agent-should-do-one-thing-badly.md)
- [A Missing Layer In Agentic Systems](../ch04/342-a-missing-layer-in-agentic-systems.md)
...
- [Lessons From 2 Billion Agentic Workflows](../ch04/399-lessons-from-2-billion-agentic-workflows.md)
- [Local Vs Cloud Agent Onsite Context Debate Xingxiaozhao](../ch03/045-agent.md)
- [Volcengine Data Agent Marketing Strategy Agent](../ch04/573-data-agent.md)
- [Phoneworld Mobile Agent Scaling Mock Environments Tencent Hunyuan Arxiv 2605 29486](../ch01/549-scaling.md)
- [Hermes Agent Self Evolution 源码解析](../ch03/090-hermes-agent.md)
- [Real Ai Agents And Real Work](../ch04/220-real-ai-agents-and-real-work.md)
- [Volcengine Data Agent Intelligent Query Agent](../ch04/573-data-agent.md)
- [Hermes Agent Tool System Analysis](../ch03/090-hermes-agent.md)
- [How To Build Agents Where Data Already Lives](../ch04/471-how-to-build-agents-where-data-already-lives.md)
- [Rocketmq 5 5 0 Litetopics Ai Agent Messaging](../ch04/147-ai-agent.md)
