...
## Ch09.045 HTTP/2 HPACK Bomb — Codex Discovered AI-Discovered DoS
...
- AI agent security (see [1Password Securing Ai Agents Machine Identities](../ch04/581-ai-agent.html), [Ai Agents Security Survey Attack Defense](../ch04/581-ai-agent.html))
