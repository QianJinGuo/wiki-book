...
## Ch09.185 Claude Code Loop 四档控制权：自检→目标→定时→工作域
...
- 与 [Agent vs Workflow 控制权连续谱](../ch04/768-agent-vs-workflow.html) 互补——前者讨论宏观的 Agent/Workflow 选型，本文是 Claude Code 具体实现的控制权分层
- 补充 [Loop Engineering](../ch05/006-loop-engineering.html) 中"停止条件"的设计——条件句 vs 愿望句可以作为停止条件设计的决策框架
- 与 [Claude Code Loop Engineering 完整攻略](ch09/157-claude-code-loop-engineering.html) 互补——前者从功能/命令角度，本文从控制权/工程约束角度
