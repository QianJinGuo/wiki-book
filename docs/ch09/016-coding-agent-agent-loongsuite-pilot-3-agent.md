...
## Ch09.016 让 Coding Agent 从黑盒到透明：阿里云 Agent 观测审计数据采集实践（LoongSuite Pilot 端侧平台 + 3 类 Agent 形态 + 4 大观测审计能力）
...
## 相关实体
- [阿里巴巴蚂蚁 Loongsuite Genai 可观测语义规范从统一数据语言到规模化落地](../ch04/550-loongsuite-genai.html)
- [Alibabacloud Cms Manage Skill Natural Language Observability](../ch04/340-skill.html)
- [Baidu Comate Coding Agent Feedback Loop Wanpeng](ch09/052-coding-agent.html)
