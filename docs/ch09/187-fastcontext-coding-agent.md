...
## Ch09.187 FastContext（微软开源 Coding Agent 仓库探索子代理）
...
- [AI Coding Agent 质量防御的五个控制机制](../ch04/398-ai-coding-agent.html)
- [Coding Agent 在百度的落地实践](ch09/051-coding-agent.html)
- [AgentMemory：Coding Agent 本地记忆](ch09/047-agentmemory-coding-agent.html)
- [阿里 LoongSuite Pilot：Coding Agent 从黑盒到透明](ch09/051-coding-agent.html)
