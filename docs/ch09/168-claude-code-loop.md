...
## Ch09.168 Claude Code Loop 四档控制权：自检→目标→定时→工作域
...
- 与 [Agent vs Workflow 控制权连续谱](../ch04/671-agent-vs-workflow.html) 互补——前者讨论宏观的 Agent/Workflow 选型，本文是 Claude Code 具体实现的控制权分层
