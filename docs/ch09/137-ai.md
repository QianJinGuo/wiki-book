...
> 📊 Level ⭐⭐ | 3.4KB | `entities/tencent-ai-coding-practices.md`
...
本页作为知识图谱锚点，连接了以下关键实体：[腾讯 AI Team 知识沉淀体系（Harness Engineering 实践）](https://github.com/QianJinGuo/wiki/blob/main/entities/tencent-ai-team-knowledge-harness.md)。 相关主题通过 [开启Harness Engineering探索之旅](https://github.com/QianJinGuo/wiki/blob/main/entities/harness-engineering-exploration-journey-tencent.md) 延伸。
...
2. 建议优先采集 腾讯 AI 编码实践 相关的一手来源（论文/官方文档/工程博客）
...
- [腾讯CDN LEGO Harness Engineering实战](https://github.com/QianJinGuo/wiki/blob/main/entities/tencent-cdn-lego-harness.md)
