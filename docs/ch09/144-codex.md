...
## Ch09.144 Codex 五层架构：记忆/知识/护栏/委派/分发
...
- [Codex AGENTS.md 配置实践](https://github.com/QianJinGuo/wiki/blob/main/entities/codex-agentsmd-project-instructions-rookie.md)
- [古法程序员 Codex 三层 Skill 架构](https://github.com/QianJinGuo/wiki/blob/main/entities/gufabiancheng-spec-for-complex-tasks-cc-codex.md)
