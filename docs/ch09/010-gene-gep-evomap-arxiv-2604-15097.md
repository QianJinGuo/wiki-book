...
[Agent Skill 编写指南](../ch01/284-agent-skill.html)的渐进式披露设计（分阶段加载 Skill 内容）在这里是一个互补视角——Gene 解决的是"注入后是什么形态"，渐进式披露解决的是"何时加载"，两者结合才能构建完整的经验复用系统。
...
- [Agent Skill Writing](../ch01/284-agent-skill.html) — Agent Skill 编写指南（渐进式披露三阶段）
- [Agent Skill Writing Advanced](../ch01/284-agent-skill.html) — Skill 高级实践
- [Agent Skill Writing Evaluation](../ch01/284-agent-skill.html) — Skill 评估方法
- [Agent Skill Writing Guide](../ch01/284-agent-skill.html) — Skill 编写完整指南
- [Agent Skill Writing Practices](../ch01/284-agent-skill.html) — Skill 最佳实践
