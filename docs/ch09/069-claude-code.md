...
## Ch09.069 Claude Code 七种自定义方法：官方全景指南
...
与 [Claude Code 源码解析：Skills/MCP/Rules 底层机制对比](../ch07/007-claude-code-skills-mcp-rules.html) 互补——源码分析侧重底层 API 注入位置，本文侧重官方使用指南和决策框架。
...
→ [Claude Code 源码解析](../ch07/007-claude-code-skills-mcp-rules.html)
...
→ [Claude Code 子智能体上下文卫生](../ch04/233-claude-code-subagents.html)
...
→ [Claude Code Hooks 完整指南](../ch03/084-claude-code.html)
...
- → [Claude Code 治理：软规则与硬约束](../ch03/084-claude-code.html)
- → [Claude Code 子智能体上下文卫生](../ch04/233-claude-code-subagents.html)
- → [Claude Code Hooks 完整指南](../ch03/084-claude-code.html)
- → [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/claude-code-seven-customization-methods-anthropic-official.md)
