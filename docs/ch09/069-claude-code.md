...
与 [Claude Code 源码解析：Skills/MCP/Rules 底层机制对比](ch07/032-claude-code-skills.html) 互补——源码分析侧重底层 API 注入位置，本文侧重官方使用指南和决策框架。
...
→ [Claude Code 源码解析](ch07/032-claude-code-skills.html)
...
→ [Claude Code 子智能体上下文卫生](ch03/084-claude-code.html)
...
→ [Claude Code Hooks 完整指南](ch05/100-ai.html)
