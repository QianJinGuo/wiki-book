...
## Ch09.160 从需求到原型：50 个设计师与产品经理的 AI 智能体技能

> 📊 Level ⭐⭐ | 4.1KB | `entities/50-ai-agent-skills-designer-pm-workflow-v2.md`
...
```mermaid
mindmap
  root(("从需求到原型：50 个设计师与产品经理的 AI 智能体技能"))
    概览
    5 个开源技能集合
    8 阶段技能地图
      一、发现与研究（10 个技能）
...
- 补充 [50 Ai Agent Skills For Designers And Pms](../ch04/455-ai-agent-skill.html) 的更新版（本文为 2026-06-10 版本，内容更完整）

---

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/50-ai-agent-skills-designer-pm-workflow-v2.md)
