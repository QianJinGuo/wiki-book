...
## Ch09.149 Claude Code Loop Types — 官方四种循环模式分类法
...
- [Claude Code Loop Engineering 完整攻略](ch09/131-claude-code-loop-engineering.html) — 兔兔AGI 第三方教程，侧重实战技法；本实体是官方分类法，侧重模式选择决策
