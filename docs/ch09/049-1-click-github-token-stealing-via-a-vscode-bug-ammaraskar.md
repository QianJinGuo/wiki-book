...
- [bagel — fleet 级 secret scanning 守护开发工作站](../ch12/044-bagel-fleet-secret-scanning.html)
...
→ [Checkmarx Jenkins Plugin Compromised In New Supply Chain Attack](../ch04/052-ai.html) — Jenkins 插件供应链投毒事件，攻击路径与本漏洞相似：均通过依赖链的信任假设进行初始代码执行，代表了近两年最活跃的 supply chain 攻击向量之一。
