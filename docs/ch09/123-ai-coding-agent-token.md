...
这也解释了为什么「让固定前缀保持字节级稳定」比「每次精简 Prompt」更有效——前者把每轮成本压到亚线性，后者只是省了零星几 K。相关实证见 [625 分钟缓存规则](../ch01/341-claude.html) 与 [OpenClacky Prompt Cache Harness](../ch05/008-harness.html)。
