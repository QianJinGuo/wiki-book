...
## Ch09.049 Claude Code团队10个使用技巧（Boris二刷）
...
- [Claude Code Founder Harness 100 Lines](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-founder-harness-100-lines.md) — Boris 第一次公开的个人技巧
- [Subagents 详解Claude Code 如何避免上下文污染](https://github.com/QianJinGuo/wiki-public/blob/main/entities/subagents-详解claude-code-如何避免上下文污染.md) — Subagents 详解
- [Claude Code Governance Soft Rules](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-governance-soft-rules.md) — Claude Code 可控性设计
