...
## Ch09.081 claude-apprentice v1.0：32 文件设计取舍与 5 层架构工程实现
...
这一设计理念与 [Agent Harness 上下文管理](../ch05/042-agent-harness.html) 中讨论的"上下文分层"技术完全一致——通过将信息从热（高频访问）到冷（低频访问）进行分级，优化上下文窗口利用率。
...
与 [兔兔AGI Loop Engineering](ch09/156-claude-code-loop-engineering.html) 和 [黄佳 8 关卡](../ch03/084-claude-code.html) 互补：
...
- [Agent Harness 上下文管理](../ch05/042-agent-harness.html) — 上下文分层与工作集管理技术
