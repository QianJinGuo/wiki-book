...
这与 [Karpathy: Software 3.0 与 vibe coding 时代的终结](/ch01-745-karpathy加入anthropic后首讲-vibe-coding已死-software3-0来了/) 中关于"AI 编程工具的最终形态是 agentic engineering"的判断同构——只有当 Agent 工具沉淀出"自我验证 + 异步调度 + 异步 Routine"的工程模式时，它的价值才会从"工具"升级为"基础设施"。
...
第三层是 Anthropic 真正的护城河：**Agent 通过 Skill 把"工程经验"沉淀为可重放的代码**。这与 [Harness Engineering](/ch05-041-harness-engineering-概念框架/) 的核心命题完全一致——harness 不是单次 prompt，而是"输入约束 + 评估机制 + Skill 沉淀"的闭环。
...
Routines 与 [24h Worker Agent](/ch04-009-24h打工人/) 描述的"持续运行的 Agent"完全一致——Claude Code 的 Routine 是工业级实现。Routine 在产品形态上对应到：
...
这与 [Agent Security 三步走: Harness + Governance + Identity](/ch04-157-agent-安全三步法-先-harness-再-governance-最后-identity-顺序反了一切白做/) 中"governance 必须可验证、可审计"的原则一致——Auto Mode 是 governance 的工业级实现。
...
这与 [From Prompt to Harness: Claude 官方](/ch01-664-从-prompt-到-harness-claude-官方学习资料/) 描述的"harness 不是更大 prompt，是更好结构"理念一致——harness engineering 的核心不是"塞更多 context"，而是"提供对的 tools + 对的评估 + 对的 Skill 沉淀机制"。
...
- [Boris Cherny: 从 IDE 到 Agent Console](/ch03-069-boris-cherny-从-ide-到-agent-控制台/)
- [Boris Cherny Interview 2026: 从 IDE 到 Agent Console](/ch04-315-boris-cherny-新访谈-开发工具正在从-ide-变成-agent-控制台/)
- [Boris Cherny 新访谈: 开发工具正在从 IDE 变成 Agent 控制台 v2](/ch04-126-boris-cherny-新访谈-开发工具正在从-ide-变成-agent-控制台/)
- [Boris Cherny 新访谈: 开发工具正在从 IDE 变成 Agent 控制台](/ch04-086-boris-cherny-新访谈-开发工具正在从-ide-变成-agent-控制台/)
- [Claude Code 一周年回顾 Boris+Cat 2026](/ch09-010-claude-code-一周年回顾-boris-cherny-cat-wu-的完整时间线/)
- [OpenClaw × Boris Cherny: Agent Loop 设计模式](/ch01-835-openclaw-boris-cherny-agent-loop-design-patterns/)
- Claude Code Prompt 源码分析
- [Claude Code Prompt 源码分析 fanone](/ch09-054-图解-claude-code-源码解析-prompt-提示词模块/)
- Claude Code Prompt Context Harness
- [From Prompt to Harness: Claude 官方](/ch01-664-从-prompt-到-harness-claude-官方学习资料/)
- [Anthropic Prompt Caching 与 Claude Code](/ch09-022-prompt-caching-工程实践-anthropic-claude-code-经验总结/)
- [24h Worker Agent](/ch04-009-24h打工人/)
- [Agent Security 三步走: Harness + Governance + Identity](/ch04-157-agent-安全三步法-先-harness-再-governance-最后-identity-顺序反了一切白做/)
