...
## Ch09.060 When I reject AI code even if it works
...
- [Building Reliable Agentic AI Systems](https://github.com/QianJinGuo/wiki-public/blob/main/entities/building-reliable-agentic-ai-systems-martinfowler.md) — 同样关注 AI 系统的工程可靠性
- [Claude Code Dynamic Workflows](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-dynamic-workflows-thariq-practical-patterns.md) — AI 编码代理的实践模式
