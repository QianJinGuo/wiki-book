...
## Ch09.176 AI Coding Agent Token 成本控制五层模型
...
- [Claw-SWE-Bench](../ch05/018-harness.html) — Pareto 成本分析
- [快手 RCA Agent](../ch03/046-agent.html) — Workflow 快思考+Agent 慢思考
- [Skill 版本对比](../ch04/266-skill.html) — Token/时延门禁
- [12 Agent 设计模式](../ch03/046-agent.html) — 分层记忆+上下文隔离
