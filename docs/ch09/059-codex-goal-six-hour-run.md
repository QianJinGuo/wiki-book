...
## Ch09.059 Codex Goal Six Hour Run
...
- [Codex /goal：长任务Agent的目标运行时](ch09/046-codex-goal.html) — 若飞源码级拆解，目标状态机 + completion audit 协议 + budget_limit 收束模板
- [Claude Code / OpenClaw Memory 对比](ch03/077-claude-code.html) — 记忆架构与 Codex 的对比参考
- [Anthropic Claude Code 大型代码库最佳实践](ch03/077-claude-code.html) — Claude Code 在大规模代码库中的实践
