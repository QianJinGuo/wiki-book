...
### 实践要点
- [Claude Code 源码分析](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/claude-code-agentic-harness-design-patterns.md) 显示其权限控制细到很具体的粒度，远比大多数 Agent 框架更严格
