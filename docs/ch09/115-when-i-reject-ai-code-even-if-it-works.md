...
## Ch09.115 When I reject AI code even if it works
...
- [Building Reliable Agentic AI Systems](ch05/094-ai.html) — 同样关注 AI 系统的工程可靠性
- [Claude Code Dynamic Workflows](ch03/077-claude-code.html) — AI 编码代理的实践模式
