...
## Ch09.068 复制这套神仙配置，让Claude Code全自动修Bug！告别每天重复教AI写代码
...
- [Agent Hooks：可编程工作流](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-hooks-programmable-workflow.md) — Hooks 生命周期节点详解（PostToolUse/Stop/PreToolUse 等）
