...
## Ch09.121 小米零售研发团队 AI 工程化三层实践：VAF + VKF + eight-claw
...
```mermaid
mindmap
  root(("小米零售研发团队 AI 工程化三层实践 VAF VKF"))
    VAF 的「菜单驱动」是对 AI 采用公平性的务实回答
    VKF 10 的失败教训是行业级的认知突破
    eight-claw 的「文件系统即状态机」是轻量架构的典范
    多引擎抽象是对 AI CLI 生态的正确姿态
```
