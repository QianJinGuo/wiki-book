...
- [Claude Code MCP Server](../ch07/050-claude-code-mcp-server.html) — MCP 协议集成
...
- [企业级 Agentic AI](https://github.com/QianJinGuo/wiki-public/blob/main/entities/building-enterprise-agentic-ai-with-kiro-on-aws.md) — AWS 集成
