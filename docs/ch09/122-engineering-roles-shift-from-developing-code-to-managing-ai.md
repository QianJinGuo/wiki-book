...
## Ch09.122 Engineering roles shift from developing code to managing AI | CIO Dive
...
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](../ch04/297-agentic.html) — Karpathy 关于 AI 时代工程师角色转变的访谈
- [Karpathy Vibe Coding Agentic Engineering](../ch04/821-karpathy-vibe-coding-agentic-engineering.html) — Vibe Coding 到 Agentic Engineering 范式转变
