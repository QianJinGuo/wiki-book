...
## Ch09.129 从需求到原型：50 个设计师与产品经理的 AI 智能体技能

> 📊 Level ⭐⭐ | 4.0KB | `entities/50-ai-agent-skills-designer-pm-workflow-v2.md`
...
一套面向设计师和产品经理的 50 个开源 Agent Skills，来自 5 个开源技能集合，按真实项目流程（从需求发现到原型交付）组织为 8 个关键阶段。
...
### 三、概念与构思（6 个技能）
设计 sprint、脑力风暴、概念草图、设计原则定义等。

### 四、原型与设计（8 个技能）
信息架构、线框图、交互设计、设计系统审计等。

### 五、验证与测试
用户测试、可访问性审查、A/B 测试设计。

### 六、交付与文档
PRD 生成、技术交底、设计决策记录。

### 七、无障碍与包容性
Inclusive Design Skills 专区：辅助技术用户画像、认知负荷评估、视觉/听觉无障碍检查。

### 八、AI 产品专项
AI Design Skills 专区：智能体交互模式、提示词架构设计、偏见风险识别。

## 与现有实体的关系

- 补充 [50 Ai Agent Skills For Designers And Pms](https://github.com/QianJinGuo/wiki/blob/main/entities/50-ai-agent-skills-for-designers-and-pms.md) 的更新版（本文为 2026-06-10 版本，内容更完整）

---

→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/50-ai-agent-skills-designer-pm-workflow-v2.md)
