...
- [Building Reliable Agentic AI Systems](../ch04/243-building-reliable-agentic-ai-systems.md) — 同样关注 AI 系统的工程可靠性
- [Claude Code Dynamic Workflows](ch09/078-claude-code-dynamic-workflows.md) — AI 编码代理的实践模式
