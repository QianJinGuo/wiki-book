...
> 📊 Level ⭐⭐⭐ | 8.1KB | `entities/ai-native-development-workflow.md`
...
- [Codex 重磅升级：Appshots / Goal 毕业 / 锁屏远程操控](https://github.com/QianJinGuo/wiki-public/blob/main/entities/codex-major-update-appshots-goal-xinzhiyuan.md)
- [Karpathy加入Anthropic后首讲：Vibe Coding已死，Software3.0来了](https://github.com/QianJinGuo/wiki-public/blob/main/entities/karpathy-software3-vibe-coding-dead-agentic-engineering.md)
...
- [场景营销前端 AI Coding — AI Native 的视觉稿还原](https://github.com/QianJinGuo/wiki-public/blob/main/entities/frontend-ai-native-visual-reduction-taobao.md)
