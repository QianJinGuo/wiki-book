...
## Ch09.113 The New Bottleneck: Theory of Constraints in the Age of AI Coding
...
- [Harness Engineering 系统化框架](ch05/061-harness-engineering.md) — 通用约束管理视角
- [Claude Code 大型代码库配置](ch03/073-claude-code.md) — AI 编程工具的实际约束案例
