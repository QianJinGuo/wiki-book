...
## Ch09.008 小米 MiMo Code — 长程编程 Agent 三大主线（计算/记忆/进化）+ 与 Claude Code 工程分化
...
- [Claude Code Dynamic Workflows Thariq Blog Gaia](ch04/310-ai.md)（Anthropic Dynamic Workflow 同主题）
...
- [Spec As Aios Anti Entropy Architecture Gaode Ai Native Series 2](ch04/310-ai.md)（Spec-as-AIOS — 可审查性同主线）
