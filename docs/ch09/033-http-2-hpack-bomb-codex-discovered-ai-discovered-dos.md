...
## Ch09.033 HTTP/2 HPACK Bomb — Codex Discovered AI-Discovered DoS
...
- AI agent security (see [1Password Securing Ai Agents Machine Identities](ch04/310-ai.md), [Ai Agents Security Survey Attack Defense](ch04/310-ai.md))
