...
这一架构与[Harness Engineering](../ch05/050-harness-engineering.html)中的"三层叠加"（Prompt → Context → Harness）异曲同工：四层分离正是Harness Engineering在Skill粒度上的具体实现。
...
- [阿里巴巴NL2SQL Harness](../ch05/050-harness-engineering.html)
