...
- [ProgramBench / SWE-agent Benchmark](../ch04/552-programbench-swe-agent-benchmark.html) — 传统 Agent 基准，主要关注代码修改能力
- [VitaBench 2.0](../ch01/906-20.html) — 真实生活场景中长期动态用户建模基准，互补关注个性化维度
