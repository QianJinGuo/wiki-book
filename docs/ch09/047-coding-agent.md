...
## Ch09.047 Coding Agent在百度的落地实践：从反馈闭环到工程范式重构
...
```mermaid
mindmap
  root(("Coding Agent在百度的落地实践 从反馈闭环到工程范式重构"))
    双层Loop架构
    Feedback Loop四层数据
    Skill vs MCP优化
    Benchmark方法论
...
- [Alibaba Agent Observability Audit Loongsuite Pilot Coding Agent Blackbox To Transparent](ch09/047-coding-agent.html)
- [Anthropic Coding Agents Social Science Survey 2026](ch09/042-anthropic-coding-agent.html)
- [柚漫剧 Ai全流程提效拆解 从单点提效到工程融合](../ch05/094-ai.html)
