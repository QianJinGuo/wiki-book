...
- 补充 [Agent Loop Engineering Handbook 8 Questions Chen Jin Tencent Self 2026](ch01/216-0.md) 的工程视角（本文更偏实操指南，陈进版更偏理论探讨）
- 与 [Agent Harness Architecture](ch05/009-harness.md) 形成架构+工程对照
