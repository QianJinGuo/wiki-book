...
## 相关实体
- [Obsidian + Claude Code 集成指南](ch09/157-obsidian-claude-code-integration-guide.html) — 知识管理工具集成
...
- [Kiro + Claude Code](../ch05/113-ai.html) — AI IDE 协同
- [企业级 Agentic AI](../ch04/710-agentic-ai.html) — AWS 集成
