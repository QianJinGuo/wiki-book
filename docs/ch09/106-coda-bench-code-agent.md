...
## Ch09.106 CoDA-Bench：Code Agent 数据智能基准
...
- [ProgramBench / SWE-agent Benchmark](../ch04/632-programbench-swe-agent-benchmark.html) — 传统 Agent 基准，主要关注代码修改能力
...
- [Agent AI 系统架构](../ch05/104-harness-skill.html) — Agent 系统的工程架构设计模式
