...
- [Skill 设计模式](ch04/258-skill.md) — 从顶级仓库提炼的核心设计模式
- [Agent Skill 编写指南](ch04/258-skill.md) — Skill 编写方法论
- [Knowledge Work Plugins](ch01/855-anthropic.md) — Anthropic 知识工作插件
- [Skill 设计规范 8 块检查清单](ch04/258-skill.md)
- [Agent Skill 编写实践](ch04/258-skill.md)
