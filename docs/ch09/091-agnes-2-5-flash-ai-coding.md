...
这一策略的风险在于可持续性：模型推理成本（特别是长上下文场景下的 token 消耗）是否能够通过其他变现渠道（如企业版、Agnes-2.5-Pro 旗舰模型）覆盖。Agnes 的定价赌注是：免费基础层吸引海量用户打磨产品，企业高级特性作为利润中心。这与 [AI Coding 评估](../ch05/126-ai-coding.html) 体系中提到的"先规模后变现"策略一致。
...
- [AI Coding 评估](../ch05/126-ai-coding.html)
- [AI Coding 入门指南](../ch05/126-ai-coding.html)
