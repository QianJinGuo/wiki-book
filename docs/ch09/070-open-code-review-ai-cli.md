...
- [复杂任务规范（gufabiancheng）](../ch01/738-codex.html) — 探讨 Agent 在复杂任务中的规范执行
- [Harness Engineering](../ch05/096-harness-engineering.html) — Agent 工程化的核心理念，与确定性工程 × Agent 混合驱动设计相关
