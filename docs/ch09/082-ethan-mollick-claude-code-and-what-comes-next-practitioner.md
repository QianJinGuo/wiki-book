...
## Ch09.082 Ethan Mollick: Claude Code and What Comes Next (Practitioner View)

> 📊 Level ⭐⭐⭐⭐ | 17.3KB | `entities/oneusefulthing-claude-code-what-comes-next.md`
...
## 与 [Opus 4 7 Launch Claude Code Best Practices Wechat](https://github.com/QianJinGuo/wiki-public/blob/main/entities/opus-4-7-launch-claude-code-best-practices-wechat.md) 的关系
