...
## Ch09.082 When I reject AI code even if it works
...
- [Building Reliable Agentic AI Systems](../ch04-229-building-reliable-agentic-ai-systems) — 同样关注 AI 系统的工程可靠性
- [Claude Code Dynamic Workflows](../ch09-070-claude-code-dynamic-workflows-实战模式与构建技巧) — AI 编码代理的实践模式
