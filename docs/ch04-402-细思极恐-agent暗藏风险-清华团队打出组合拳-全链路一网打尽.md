...
## Ch04.402 细思极恐！Agent暗藏风险，清华团队打出组合拳，全链路一网打尽
...
## 关联阅读
- [Managed Agents Architecture — 管理 Agent 的规模化运行](/ch01-280-anthropic-官方-agent-harness-平台-claude-managed-agents-完整指南/)
- [Harness Engineering Framework](/ch05-041-harness-engineering-概念框架/) — Agent 运行时 Harness 框架
- [Claude Code Source Leak Lifecycle — Claude Code 源码分析中的安全机制](/ch07-006-claude-code-skills-mcp-rules-source-analysis/)
