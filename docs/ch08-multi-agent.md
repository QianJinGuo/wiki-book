...
## Ch08.019 AP2 协议实测：Mandate 机制、Task 状态机与多 Agent 支付
...
## Ch08.020 对抗式验证：多 Agent 交叉校验设计哲学
...
## Ch08.022 Nature丨Google和FutureHouse同日登刊，把AI科学助理推到科研前线
...
## Ch08.023 Multi-Agent AI Safety Research Funding Call（DeepMind 主导，1000 万美元，四大方向）
...
## Ch08.024 OpenRath：以 Session 为核心的多 Agent 运行时状态系统（清华）
...
## Ch08.026 γ-World: 多 Agent 世界建模（NVIDIA Research）
