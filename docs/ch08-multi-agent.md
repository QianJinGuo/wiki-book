...
## Ch08.008 Claude Code Dynamic Workflows 多Agent编排
...
## Ch08.009 JiuwenSwarm — Coordination Engineering 多智能体协作框架（含 SwarmFlow 可控编排 + Jiuwen Symphony 技能编排与分发）
...
## Ch08.010 AI Agent Memory Systems
...
## Ch08.011 古法程序员复杂任务 Spec 写作：多 Agent 编排 + Skill 三层架构 + Gate 四态
...
## Ch08.015 Scalable voice agent design with Amazon Nova Sonic: multi-agent, tools, and session segmentation
...
## Ch08.017 Thousand Token Wood v2: Multi-Model Heterogeneous Agent Council
...
## Ch08.018 MiniMax Agent Team: Mavis (Owner-Worker-Verifier)
...
## Ch08.021 对抗式验证：多 Agent 交叉校验设计哲学
...
## Ch08.023 Nature丨Google和FutureHouse同日登刊，把AI科学助理推到科研前线
...
## Ch08.024 Multi-Agent AI Safety Research Funding Call（DeepMind 主导，1000 万美元，四大方向）
...
## Ch08.025 OpenRath：以 Session 为核心的多 Agent 运行时状态系统（清华）
...
## Ch08.029 γ-World: 多 Agent 世界建模（NVIDIA Research）
