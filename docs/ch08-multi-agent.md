...
- [字节 Trae Harness 指南](ch01/530-trae-harness-engineering.md)
...
- [字节 Trae Harness 工程指南](ch01/530-trae-harness-engineering.md) —— 字节另一款 AI 产品 Trae 的工程化指南，可与 Coze 3.0 的本地 Agent 接入思路对照，理解字节在 AI 协作产品上的不同布局方向。
...
## Ch08.023 OpenRath：以 Session 为核心的多 Agent 运行时状态系统（清华）
...
## Ch08.025 γ-World: 多 Agent 世界建模（NVIDIA Research）
