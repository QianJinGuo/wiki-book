...
- **核心定位**：first truly multi-harness control plane for cloud agents——比 [AgentCore Harness](ch05/009-harness.md) 多了一层「harness 选择权」的抽象
...
- [Agent Harness Architecture](ch05/009-harness.md) — Agent Harness 架构
...
- [DeepSeek V4 Flash Pro](ch01/295-deepseek-v4.md)
- [AutoResearch 多 Agent 系统](ch04/069-ai.md)
- [RocketMQ Agent 消息](ch04/069-ai.md)
- [高德 Uplift 模型 Agent](ch05/009-harness.md)
- [NVIDIA Isaac Lab 机器人 RL](ch01/1046-scale-robot-reinforcement-learning-with-nvidia-isaac-lab-on.md)
...
- [Agent Harness 架构深度](ch05/009-harness.md)
- [MOC](https://github.com/QianJinGuo/wiki/blob/main/moc/multi-agent-coordination.md)
...
- [字节 Trae Harness 指南](ch05/009-harness.md)
...
- [字节 Trae Harness 工程指南](ch05/009-harness.md) —— 字节另一款 AI 产品 Trae 的工程化指南，可与 Coze 3.0 的本地 Agent 接入思路对照，理解字节在 AI 协作产品上的不同布局方向。
...
- → [Harness Context](ch05/009-harness.md) — 多 Agent 协作的上下文管理
