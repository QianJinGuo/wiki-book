...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/icml-2026-hoi-edit-scpe-self-correcting-pku.md)
...
> -> [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/autoresearch-ai-scientific-discovery-l0-l4-challengehub.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/taobao-high-price-rate-ai-workbench-eval-optimization.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/coze-3-release-official-quantum-bit.md)
...
> -> [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/nature-ai-scientific-assistant-google-futurehouse.md)
...
## Ch08.025 Multi-Agent AI Safety Research Funding Call（DeepMind 主导，1000 万美元，四大方向）
...
> 原文存档：[原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/investing-in-multi-agent-ai-safety-research.md)
...
## Ch08.026 Crayotter: Traceable Multi-Agent Workflows for Long-Form Video Editing
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/crayotter-traceable-multi-agent-long-form-video-editing-ustc-2026.md)

---

## Ch08.027 OpenRath：以 Session 为核心的多 Agent 运行时状态系统（清华）
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/unitymas-o-multi-agent-rl-optimization-framework-2026.md)

---

## Ch08.030 CoAgent

> 📊 Level ⭐⭐⭐ | 2.7KB | `entities/coagent.md`
