...
## 关联
- Managed Agents Architecture — Anthropic Managed Agents 架构
- [Harness Engineering Framework](/ch05-041-harness-engineering-概念框架/) — Harness Engineering 框架
## 相关实体
...
- [Anthropic Dreaming Claude Managed Agents Ovz5V7Jjkqdksu9Xmxwt8W](/ch04-231-anthropic-上线-做梦-功能-让-agent-越睡越聪明/)
