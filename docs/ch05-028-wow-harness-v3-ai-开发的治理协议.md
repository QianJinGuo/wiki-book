...
- [Claude Code 20000 字符源码分析](/ch09-056-两万字详解claude-code源码核心机制/) —— 98.4% 基础设施论据
- Agent Harness 上下文管理 —— 工作集视角 + subagent 隔离
- [Harness Engineering](/ch04-422-harness-engineering-让-coding-agent-可靠完成长程任务/) —— 系统性 harness 实践
- [Agent Self-Improvement Six Mechanisms](/ch04-047-agent-自我改进的六条路/) —— 长期连贯性相关
- [From Agent Protocol to Harness Skill](/ch04-351-from-agent-protocol-to-harness-skill/) —— 协议 → skill 演化
