...
[已有 DSpark 实体](https://github.com/QianJinGuo/wiki/blob/main/entities/deepseek-dspark-speculative-decoding-2026.md) 涵盖了 DSpark 的整体架构设计，本文补充了 V4 版本的具体性能数据和 DeepSpec 全栈工具链的细节。
