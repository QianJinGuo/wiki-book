...
## Ch16.003 Build real-time voice applications with Amazon SageMaker AI and vLLM
...
## Ch16.004 Apple Siri 私有推理（Private Inference）不私有：三个对抗者都不受加密学保护
...
## Ch16.006 EAGLE-3 投机解码与 USP 长序列训练优化
...
## Ch16.007 PithTrain：陈天奇 + CMU Flame Center 推出的 agent-native MoE 训练框架（11K Python / 双重效率）
...
## Ch16.008 刚刚DeepSeek开源推理神器DSpark，V4最高提速85%，连底层训练全家桶都开源了
