...
- [Apple Silicon Costs More Than Openrouter](ch01/094-apple-silicon-costs-more-than-openrouter.md)：Apple 硬件成本视角
...
## Ch16.022 14× faster embeddings: how we rebuilt the ONNX path in Manticore
