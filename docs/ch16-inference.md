...
## Ch16.014 小米多篇论文入选 ECCV 2026 — 人脸修复、视频大模型推理加速
...
## Ch16.015 The next generation of speculative decoding: DFlash and Spec V2 - LMSYS Blog
...
## Ch16.016 TLiveOmni vLLM 适配与量化方案
...
## Ch16.017 vLLM V0→V1 迁移中的 logprob 差异修复
...
## Ch16.018 京东 JoyAI-VL-Interaction — 全栈开源视频语言交互模型
...
## Ch16.019 ServiceNow vLLM V0→V1 正确性修复
...
## Ch16.020 Profiling in PyTorch (Part 2): From nn.Linear to a Fused MLP
...
## Ch16.021 MiMo-V2.5 推理系统全链路优化：Hybrid SWA + MoE + 多模态生产级落地
...
## Ch16.022 LLM 推理流水线完整解析：Prefill-Decode 双阶段模型
...
## Ch16.023 elasticpp重塑elasticsearch查询性能的c内核引擎
...
## Ch16.024 腾讯混元 Hy3 preview 在 Hopper 卡上的推理优化实践
...
## Ch16.025 vLLM V0 to V1: Correctness Before Corrections in RL
...
## Ch16.026 Bonsai Image 4B: 1-bit 和 Ternary 量化
...
## Ch16.027 Pytorch in Kernel Recsys Optimization
...
## Ch16.028 14× faster embeddings: how we rebuilt the ONNX path in Manticore
