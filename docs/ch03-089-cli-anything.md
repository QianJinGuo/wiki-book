...
## Agent 兼容性
支持 OpenClaw, [OpenCLI](/ch04-165-浏览器自动化-从-gui-到-opencli-agent-时代的可调用性竞争/), Nanobot, Claude Code, Codex, Antigravity 等主流 Agent。
安装命令：
```bash
...
## 与 [Hermes-Agent](/ch07-007-hermes-agent-满配-12-层配置完整指南-从裸装到-24h-agent-团队/) 的关系
