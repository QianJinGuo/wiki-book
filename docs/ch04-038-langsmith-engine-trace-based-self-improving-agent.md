...
- [Hermes Agent Operator](/ch04-067-hermes-agent-operator-上手-把一个-agent-养成可运营系统/) — "模型侧自改进"路径（定时任务把对话总结成 Skill），与本文"系统侧自改进"互补
...
- [深入理解 Claude Code Harness](/ch01-170-深入理解-claude-code-源码中的-agent-harness-构建之道/) — Plan Mode + Tasks 系统的"避免问题复发"机制
- [OpenClaw 完整指南](/ch01-642-openclaw-完全指南-这可能是全网最新最全的系统化教程了-3-2w字-建议收藏/) — 开源 Agent 的故障处理与自我恢复机制
