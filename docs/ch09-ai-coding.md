...
- [005. Loop 的产品视角——项目中心从人挪到 Agent 系统](ch09/005-loop-agent)
- [006. 用 Kiro 构建行业专业软件：Spec vs Vibe Coding 的分层结论](ch09/006-kiro-spec-vs-vibe-coding)
- [007. Dynamically Splitting Wide Partitions in Cassandra for Time Series Workloads](ch09/007-dynamically-splitting-wide-partitions-in-cassandra-for-time)
- [008. Device Code Phishing Forensics: What We Learned from BEC Investigations in the Wild](ch09/008-device-code-phishing-forensics-what-we-learned-from-bec-inv)
...
- [012. Peter Steinberger / OpenClaw — 100个AI程序员案例](ch09/012-peter-steinberger-openclaw-100-ai)
...
- [018. 让 Kiro 和 Claude Code 响应 IM 消息：用 ACP Bridge 打造异步 AI 编程工作流 | 亚马逊AWS官方博客](ch09/018-kiro-claude-code-im-acp-bridge-ai-aws)
...
- [026. It’s safe to close your laptop now: Hosting coding agents on Amazon Bedrock AgentCore](ch09/026-it-s-safe-to-close-your-laptop-now-hosting-coding-agents-on)
- [027. OpenAI models and Codex on Amazon Bedrock are now generally available](ch09/027-openai-models-and-codex-on-amazon-bedrock-are-now-generally)
- [028. DeepSeek V4 DS4C Antirez 本地推理实践](ch09/028-deepseek-v4-ds4c-antirez)
- [029. Coding Agent在百度的落地实践：从反馈闭环到工程范式重构](ch09/029-coding-agent)
- [030. Cat Wu: Anthropic Claude Code/Cowork 产品负责人访谈](ch09/030-cat-wu-anthropic-claude-code-cowork)
- [031. Claude Code 黑客松：技艺数字化六项目](ch09/031-claude-code)
- [032. 1-Click GitHub Token Stealing via a VSCode Bug — ammaraskar 2026](ch09/032-1-click-github-token-stealing-via-a-vscode-bug-ammaraskar)
- [033. Open Code Review：阿里开源的 AI 代码评审 CLI 工具](ch09/033-open-code-review-ai-cli)
- [034. 天猫AI助手调度框架重构与AI Coding工程化](ch09/034-ai-ai-coding)
- [035. 两万字详解Claude Code源码核心机制](ch09/035-claude-code)
- [036. Hacker News 热帖：AI 会写代码了，为啥还要用 Python？](ch09/036-hacker-news-ai-python)
- [037. Claw Chain: Cyera Research Unveil Four Chainable Vulnerabilities in OpenClaw](ch09/037-claw-chain-cyera-research-unveil-four-chainable-vulnerabili)
- [038. Claude Code团队10个使用技巧（Boris二刷）](ch09/038-claude-code-10-boris)
- [039. Claude Code 官方插件系统 (claude-plugins-official)](ch09/039-claude-code-claude-plugins-official)
- [040. 从提需求到部署发布，全AI全自动化后，研发效能全面跃升](ch09/040-ai)
- [041. BlueCode 0 行手写代码重构 2 万行 Vue：约束体系驱动 AI 大规模重构](ch09/041-bluecode-0-2-vue-ai)
- [042. Claude Code 可控性：软规则无法变成硬约束](ch09/042-claude-code)
- [043. Claude Code 接入自建开源模型：企业私有化与降本实践 | 亚马逊AWS官方博客](ch09/043-claude-code-aws)
- [044. AI 原生开发工作流](ch09/044-ai)
- [045. 停止编码的那天，就是失去架构判断力的开始：一位 30 年架构师的 AI 生存指南](ch09/045-30-ai)
- [046. AI 编码效率分析方法论](ch09/046-ai)
...
- [050. 腾讯 AI 编码实践](ch09/050-ai)
- [051. Sakana Fugu 发布：Claude 禁令后的多 Agent 编排 API，LiveCodeBench 93.2](ch09/051-sakana-fugu-claude-agent-api-livecodebench-93-2)
- [052. AI can write code, but the CIOs still owns the operating model](ch09/052-ai-can-write-code-but-the-cios-still-owns-the-operating-mod)
- [053. How to Avoid AI Code Slop](ch09/053-how-to-avoid-ai-code-slop)
- [054. Skill Issues: Compromising Claude Code with malicious skills & agents — Part 1](ch09/054-skill-issues-compromising-claude-code-with-malicious-skills)
...
- [059. DeepSeek Code Harness](ch09/059-deepseek-code-harness)
...
- [067. Prompt Caching 工程实践 — Anthropic Claude Code 经验总结](ch09/067-prompt-caching-anthropic-claude-code)
- [068. Thought-Aligner：智能体行为安全新范式——可插拔思维校正层（ICML 2026）](ch09/068-thought-aligner-icml-2026)
...
- [074. CLAUDE.md 12 条规则：Karpathy 扩展模板](ch09/074-claude-md-12-karpathy)
- [075. Claude Code 18个隐藏设置](ch09/075-claude-code-18)
- [076. Claude Code 大型代码库最佳实践 — Anthropic 企业级部署指南](ch09/076-claude-code-anthropic)
...
- [094. Anthropic 内部 95% 数据分析自动化：分析 Agent 技术栈 + Skill 框架（21%→95% 准确率）](ch09/094-anthropic-95-agent-skill-21-95)
- [095. 让 Coding Agent 从黑盒到透明：阿里云 Agent 观测审计数据采集实践（LoongSuite Pilot 端侧平台 + 3 类 Agent 形态 + 4 大观测审计能力）](ch09/095-coding-agent-agent-loongsuite-pilot-3-agent)
- [096. Claude Code 在大型代码库中的实战经验：从哪里入手？怎么做对？](ch09/096-claude-code)
- [097. 业务 Agent 增强层架构：复用通用 Agent 基座，把业务能力做成可验证增强层](ch09/097-agent-agent)
- [098. Claude Code 一周年回顾：Boris Cherny + Cat Wu 的完整时间线](ch09/098-claude-code-boris-cherny-cat-wu)
- [099. Gene/GEP — EvoMap×清华 提出的「策略基因」经验对象框架（arXiv 2604.15097）](ch09/099-gene-gep-evomap-arxiv-2604-15097)
- [100. Claude Code 从 Demo 到产线 · 企业 Harness 工程化的 8 道关卡（黄佳/咖哥 CSDN）](ch09/100-claude-code-demo-harness-8-csdn)
- [101. AgentMemory：Coding Agent 本地记忆系统](ch09/101-agentmemory-coding-agent)
- [102. 采用 AI 编码智能体的六条经验](ch09/102-ai)
- [103. 基于浏览器请求录制与AI代码生成的E2E接口自动化测试实践](ch09/103-ai-e2e)
- [104. 天猫新品营销技术团队AI编码实战指南（上）](ch09/104-ai)
- [105. Claude Code Openclaw Usage Ettin](ch09/105-claude-code-openclaw-usage-ettin)
- [106. CLAUDE.md 规则从 Karpathy 的 4 条增加到 12 条](ch09/106-claude-md-karpathy-4-12)
- [107. Claude Code 性能基准评测](ch09/107-claude-code)
