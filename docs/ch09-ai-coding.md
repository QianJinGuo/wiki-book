...
- [098. 停止编码的那天，就是失去架构判断力的开始：一位 30 年架构师的 AI 生存指南](ch09/098-30-ai)
...
- [102. 吴恩达最新思考：从分钟到天，AI产品如何靠三层Loop迭代](ch09/102-ai-loop)
- [103. 云效 AI Code Review — GitLab Integration for Private-Network Code Review](ch09/103-ai-code-review-gitlab-integration-for-private-network-co)
- [104. CoDA-Bench：Code Agent 数据智能基准](ch09/104-coda-bench-code-agent)
- [105. Codex Discovered a Hidden HTTP/2 Bomb](ch09/105-codex-discovered-a-hidden-http-2-bomb)
- [106. Engineering roles shift from developing code to managing AI | CIO Dive](ch09/106-engineering-roles-shift-from-developing-code-to-managing-ai)
- [107. Harness Engineering - 让 Coding Agent 可靠完成长程任务](ch09/107-harness-engineering-coding-agent)
- [108. Claude Dispatch + 接口力量：AI 从 Chatbot 到 Agent Interface 的转变](ch09/108-claude-dispatch-ai-chatbot-agent-interface)
- [109. Peter Steinberger / OpenClaw — 100个AI程序员案例](ch09/109-peter-steinberger-openclaw-100-ai)
- [110. AI Coding 入门指南：如何更好地让 AI 真正帮你干活](ch09/110-ai-coding-ai)
- [111. Notes Inside China AI Labs Lambert](ch09/111-notes-inside-china-ai-labs-lambert)
- [112. GPT-5.6 Sol：Workhorse vs Architect — Zvi 深度对比分析](ch09/112-gpt-5-6-sol-workhorse-vs-architect-zvi)
- [113. Anthropic 的 Harness 没管住 Claude Code？软规则 vs 硬约束](ch09/113-anthropic-harness-claude-code-vs)
- [114. When I reject AI code even if it works](ch09/114-when-i-reject-ai-code-even-if-it-works)
- [115. Sakana Fugu 发布：Claude 禁令后的多 Agent 编排 API，LiveCodeBench 93.2](ch09/115-sakana-fugu-claude-agent-api-livecodebench-93-2)
- [116. 天猫新品营销技术团队 AI 编码实战指南](ch09/116-ai)
- [117. Codex 48小时两次被迫重置Token额度——消耗太快的真相来了](ch09/117-codex-48-token)
- [118. Skill Issues: Compromising Claude Code with malicious skills & agents — Part 1](ch09/118-skill-issues-compromising-claude-code-with-malicious-skills)
- [119. AI can write code, but the CIOs still owns the operating model](ch09/119-ai-can-write-code-but-the-cios-still-owns-the-operating-mod)
- [120. 小米零售研发团队 AI 工程化三层实践：VAF + VKF + eight-claw](ch09/120-ai-vaf-vkf-eight-claw)
- [121. 7个月，234次提交，1690行代码：AI编程大型翻车现场：我决定全部作废，手动重写！](ch09/121-7-234-1690-ai)
- [122. How to Avoid AI Code Slop](ch09/122-how-to-avoid-ai-code-slop)
- [123. Superpowers 深度解读（2）：Rule/Gate/Hook 与 Iron Law 方法论](ch09/123-superpowers-2-rule-gate-hook-iron-law)
- [124. Reward hacking is swamping model intelligence gains](ch09/124-reward-hacking-is-swamping-model-intelligence-gains)
- [125. PostHog 用 Claude Code 重写 SQL 解析器：PBT + 影子模式的生产级 AI 重写实践](ch09/125-posthog-claude-code-sql-pbt-ai)
- [126. 复制这套神仙配置，让Claude Code全自动修Bug！告别每天重复教AI写代码](ch09/126-claude-code-bug-ai)
- [127. Development environments for your cloud agents](ch09/127-development-environments-for-your-cloud-agents)
...
- [129. Hermes Agent自我进化机制与OpenClaw对比](ch09/129-hermes-agent-openclaw)
- [130. 让 Kiro 和 Claude Code 响应 IM 消息：用 ACP Bridge 打造异步 AI 编程工作流 | 亚马逊AWS官方博客](ch09/130-kiro-claude-code-im-acp-bridge-ai-aws)
- [131. 华为云码道（CodeArts）重构图形编程项目实践 — Py4OH-Flow 2.0 SDD 案例](ch09/131-codearts-py4oh-flow-2-0-sdd)
- [132. Notes From Inside Chinas AI Labs](ch09/132-notes-from-inside-chinas-ai-labs)
- [133. Claude Code 命令使用指南](ch09/133-claude-code)
- [134. 2 小时，0 行手写代码，我用 Claude 做了一个生产级 VSCode 插件](ch09/134-2-0-claude-vscode)
- [135. AI Coding 的底层框架：一切优化都是在对抗熵增——信息论视角](ch09/135-ai-coding)
- [136. Poolside Laguna XS 2.1: 33B MoE Coding Agent Model](ch09/136-poolside-laguna-xs-2-1-33b-moe-coding-agent-model)
- [137. Prompt Caching Engineering — Earendil Coding Agent Architecture](ch09/137-prompt-caching-engineering-earendil-coding-agent-architect)
- [138. Claude Code Loop Types — 官方四种循环模式分类法](ch09/138-claude-code-loop-types)
- [139. Obsidian Claude Code Integration Guide](ch09/139-obsidian-claude-code-integration-guide)
- [140. Vibe Coding in Production — Erik Schluntz / Anthropic](ch09/140-vibe-coding-in-production-erik-schluntz-anthropic)
- [141. Cursor AI 蜂群：规划器+Worker 架构与多模型经济学的突破](ch09/141-cursor-ai-worker)
- [142. Codex can now control other desktop devices via Computer Use](ch09/142-codex-can-now-control-other-desktop-devices-via-computer-use)
- [143. Code is the easy part, or how we refactored half the business to fix a janky script | Swizec Teller](ch09/143-code-is-the-easy-part-or-how-we-refactored-half-the-busines)
- [144. Claude Code Loop Engineering 完整攻略](ch09/144-claude-code-loop-engineering)
- [145. Linn Fritz looks at the lighter side of life](ch09/145-linn-fritz-looks-at-the-lighter-side-of-life)
- [146. Claude Code 为什么会忽略指令：四类失效原因 + 五层规则框架](ch09/146-claude-code)
- [147. 无障碍设计师 vibe coding：当所有同事都在用 AI 写代码时](ch09/147-vibe-coding-ai)
- [148. 逆了个大天！负责人亲自下场，教大家反代Codex](ch09/148-codex)
- [149. Tether launches developer grants program for local AI payments](ch09/149-tether-launches-developer-grants-program-for-local-ai-paymen)
- [150. We have Mythos at Home: GLM 5.2 beats Claude in our Cyber Benchmarks](ch09/150-we-have-mythos-at-home-glm-5-2-beats-claude-in-our-cyber-be)
- [151. 百度 AI Coding 质量关卡实践](ch09/151-ai-coding)
- [152. Introducing deepsec: The security harness for finding vulnerabilities in your codebase](ch09/152-introducing-deepsec-the-security-harness-for-finding-vulner)
- [153. 从需求到原型：50 个设计师与产品经理值得掌握的 AI 智能体技能](ch09/153-50-ai)
- [154. 天猫新品营销技术团队AI编码实战指南（上）](ch09/154-ai)
- [155. Using Local Coding Agents](ch09/155-using-local-coding-agents)
- [156. State of CLI Coding Agents, Mid-2026](ch09/156-state-of-cli-coding-agents-mid-2026)
- [157. 打造 Claude Code 可持续推进的工作流：Loop Engineering 完整上手攻略](ch09/157-claude-code-loop-engineering)
- [158. The New Bottleneck: Theory of Constraints in the Age of AI Coding](ch09/158-the-new-bottleneck-theory-of-constraints-in-the-age-of-ai-c)
- [159. 从需求到原型：50 个设计师与产品经理的 AI 智能体技能](ch09/159-50-ai)
- [160. 天猫新品团队AI编码实战指南（下）](ch09/160-ai)
- [161. Automate progressive rollouts with Vercel Flags - Vercel](ch09/161-automate-progressive-rollouts-with-vercel-flags-vercel)
- [162. Loop 的产品视角——项目中心从人挪到 Agent 系统](ch09/162-loop-agent)
- [163. Spec-Driven AI 编程半年实战 — 有损管道、三工具比较与三大认知陷阱](ch09/163-spec-driven-ai)
- [164. AI 写前端 ≠ 设计 —— Anomaly 创始人对 Vibe Coding 哲学批判](ch09/164-ai-anomaly-vibe-coding)
- [165. Unlocking AI flexibility in Europe: A guide to cross-region inference for EU data processing and model access](ch09/165-unlocking-ai-flexibility-in-europe-a-guide-to-cross-region)
- [166. Claude code创始人最新揭秘：Claude Tag如何在团队内部「大杀四方」](ch09/166-claude-code-claude-tag)
- [167. Dynamically Splitting Wide Partitions in Cassandra for Time Series Workloads](ch09/167-dynamically-splitting-wide-partitions-in-cassandra-for-time)
- [168. How Baz improved its AI Agent Code Review accuracy using Amazon Bedrock AgentCore](ch09/168-how-baz-improved-its-ai-agent-code-review-accuracy-using-ama)
- [169. Claude Code Loop 四档控制权：自检→目标→定时→工作域](ch09/169-claude-code-loop)
- [170. OpenAI大神教你如何榨干Codex](ch09/170-openai-codex)
- [171. 百度网盘主端 FE AICR：AI Code Review 准入实践](ch09/171-fe-aicr-ai-code-review)
