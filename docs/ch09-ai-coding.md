...
- [015. 7个月，234次提交，1690行代码：AI编程大型翻车现场：我决定全部作废，手动重写！](ch09/015-7-234-1690-ai)
- [016. Superpowers 深度解读（2）：Rule/Gate/Hook 与 Iron Law 方法论](ch09/016-superpowers-2-rule-gate-hook-iron-law)
- [017. 场景营销前端 AI Coding — AI Native 的视觉稿还原](ch09/017-ai-coding-ai-native)
- [018. 让 Kiro 和 Claude Code 响应 IM 消息：用 ACP Bridge 打造异步 AI 编程工作流 | 亚马逊AWS官方博客](ch09/018-kiro-claude-code-im-acp-bridge-ai-aws)
- [019. 2 小时，0 行手写代码，我用 Claude 做了一个生产级 VSCode 插件](ch09/019-2-0-claude-vscode)
...
- [028. OpenAI models and Codex on Amazon Bedrock are now generally available](ch09/028-openai-models-and-codex-on-amazon-bedrock-are-now-generally)
- [029. DeepSeek V4 DS4C Antirez 本地推理实践](ch09/029-deepseek-v4-ds4c-antirez)
- [030. Coding Agent在百度的落地实践：从反馈闭环到工程范式重构](ch09/030-coding-agent)
- [031. Cat Wu: Anthropic Claude Code/Cowork 产品负责人访谈](ch09/031-cat-wu-anthropic-claude-code-cowork)
- [032. Claude Code 黑客松：技艺数字化六项目](ch09/032-claude-code)
- [033. 1-Click GitHub Token Stealing via a VSCode Bug — ammaraskar 2026](ch09/033-1-click-github-token-stealing-via-a-vscode-bug-ammaraskar)
- [034. Open Code Review：阿里开源的 AI 代码评审 CLI 工具](ch09/034-open-code-review-ai-cli)
- [035. 天猫AI助手调度框架重构与AI Coding工程化](ch09/035-ai-ai-coding)
...
- [062. How Claude Code works in large codebases: Best practices and where to start](ch09/062-how-claude-code-works-in-large-codebases-best-practices-and)
- [063. OpenAI Symphony：Linear 即 Codex Agent 控制平面](ch09/063-openai-symphony-linear-codex-agent)
- [064. AI 编程智能体的质量防线：5 个代码质量控制机制（反馈传感器 / 语义评估 / 重构边界 / 来源追溯 / 智能体攻击面清单）](ch09/064-ai-5)
- [065. Ethan Mollick: Claude Code and What Comes Next (Practitioner View)](ch09/065-ethan-mollick-claude-code-and-what-comes-next-practitioner)
- [066. Thought-Aligner：智能体行为安全新范式——可插拔思维校正层（ICML 2026）](ch09/066-thought-aligner-icml-2026)
- [067. CLAUDE.md 规则从 Karpathy 的 4 条增加到 12 条](ch09/067-claude-md-karpathy-4-12)
- [068. AutoResearch：多 Agent 自动化软件开发](ch09/068-autoresearch-agent)
- [069. HTTP/2 HPACK Bomb — Codex Discovered AI-Discovered DoS](ch09/069-http-2-hpack-bomb-codex-discovered-ai-discovered-dos)
- [070. gpt-54-烧完额度后我把七家国产-ai-公司-coding-plan-对比了一遍想不到最应该买的竟然是这家](ch09/070-gpt-54-ai-coding-plan)
- [071. Matt Van Horn 的 22 个 Claude Code 黑客技巧：让 AI 写 plan.md 但不读 plan.md](ch09/071-matt-van-horn-22-claude-code-ai-plan-md-plan-md)
- [072. Anthropic Coding Agent 社会科学家采用调查](ch09/072-anthropic-coding-agent)
- [073. Claude Code 18个隐藏设置](ch09/073-claude-code-18)
- [074. FastContext（微软开源 Coding Agent 仓库探索子代理）](ch09/074-fastcontext-coding-agent)
- [075. Chromium AI Coding 开发体系](ch09/075-chromium-ai-coding)
- [076. Code as Agent Harness 综述](ch09/076-code-as-agent-harness)
- [077. Claw-SWE-Bench：首个独立测量Harness对编程Agent影响的基准](ch09/077-claw-swe-bench-harness-agent)
- [078. Codex Goal Six Hour Run](ch09/078-codex-goal-six-hour-run)
- [079. Claude Code 七种自定义方法：官方全景指南](ch09/079-claude-code)
- [080. AI Coding Agent Token 成本控制五层模型](ch09/080-ai-coding-agent-token)
- [081. MiniMax M3 开源 Frontier 模型](ch09/081-minimax-m3-frontier)
- [082. Claude Code Routines：从工具到队友的主动 Agent 模式](ch09/082-claude-code-routines-agent)
- [083. OpenAI秘密矩阵曝光：Codex将所有设备连成超级电脑](ch09/083-openai-codex)
