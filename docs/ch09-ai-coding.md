...
- [010. 停止编码的那天，就是失去架构判断力的开始：一位 30 年架构师的 AI 生存指南](ch09/010-30-ai)
- [011. Harness Engineering - 让 Coding Agent 可靠完成长程任务](ch09/011-harness-engineering-coding-agent)
- [012. Claude Dispatch + 接口力量：AI 从 Chatbot 到 Agent Interface 的转变](ch09/012-claude-dispatch-ai-chatbot-agent-interface)
- [013. Peter Steinberger / OpenClaw — 100个AI程序员案例](ch09/013-peter-steinberger-openclaw-100-ai)
...
- [023. Automate progressive rollouts with Vercel Flags - Vercel](ch09/023-automate-progressive-rollouts-with-vercel-flags-vercel)
...
- [036. 两万字详解Claude Code源码核心机制](ch09/036-claude-code)
...
- [038. Hacker News 热帖：AI 会写代码了，为啥还要用 Python？](ch09/038-hacker-news-ai-python)
...
- [069. CLAUDE.md 规则从 Karpathy 的 4 条增加到 12 条](ch09/069-claude-md-karpathy-4-12)
- [070. AutoResearch：多 Agent 自动化软件开发](ch09/070-autoresearch-agent)
- [071. HTTP/2 HPACK Bomb — Codex Discovered AI-Discovered DoS](ch09/071-http-2-hpack-bomb-codex-discovered-ai-discovered-dos)
- [072. gpt-54-烧完额度后我把七家国产-ai-公司-coding-plan-对比了一遍想不到最应该买的竟然是这家](ch09/072-gpt-54-ai-coding-plan)
- [073. Matt Van Horn 的 22 个 Claude Code 黑客技巧：让 AI 写 plan.md 但不读 plan.md](ch09/073-matt-van-horn-22-claude-code-ai-plan-md-plan-md)
- [074. Anthropic Coding Agent 社会科学家采用调查](ch09/074-anthropic-coding-agent)
- [075. Claude Code 18个隐藏设置](ch09/075-claude-code-18)
- [076. CLAUDE.md 12 条规则：Karpathy 扩展模板](ch09/076-claude-md-12-karpathy)
- [077. Claude Code 大型代码库最佳实践 — Anthropic 企业级部署指南](ch09/077-claude-code-anthropic)
...
- [106. Claude Code Openclaw Usage Ettin](ch09/106-claude-code-openclaw-usage-ettin)
