...
## Ch04.118 鹅厂 Skill 写作完整 Playbook：14 章节 end-to-end 实战 + 工程化评估（腾讯一线踩坑 + Anthropic 官方做法整合）
...
- [Anthropic 14 Skill Patterns Best Practices](../ch01-677-anthropic) — 60KB，14 patterns 5 类（发现与选择/上下文经济/指令校准/工作流控制/可执行代码）。本实体是**鹅厂实战版完整 Playbook**（14 章节顺序结构），那个是**14 设计模式分类索引**。两者互补：patterns 提供分类视角，playbook 提供流程视角。
...
- [Ai Skill 测评指标体系](../ch01-383-ai-skill-测评指标体系) / [Ai Skill 测评报告解读](https://github.com/QianJinGuo/wiki/blob/main/entities/ai-skill-测评报告解读.md) / [Ai Skill 测评体系进阶指南](https://github.com/QianJinGuo/wiki/blob/main/entities/ai-skill-测评体系进阶指南.md) / [Ai Skill 测试用例设计](../ch03-032-03-ai-skill-测试用例设计完整指南-8-种类型-断言自检-覆盖率从-40-到-90) / [Ai Skill 测评指标体系](../ch01-383-ai-skill-测评指标体系) — AI Skill 测评系列（覆盖部分指标体系）。本实体是**腾讯视角的工程化评估**，与系列互补。
- [Anthropic 官方技能最佳实践14 个可复用的 Agent Skills 设计模式](../ch01-677-anthropic) — Anthropic 官方 14 patterns 译本。命名相似但内容不同。
- [Agent Skill Writing Practices](../ch04-242-agent-skill-高质量编写规范) / [Agent Skill Writing Advanced](../ch01-319-agent-skill-进阶模式与治理) / [Agent Skill Writing Evaluation](https://github.com/QianJinGuo/wiki/blob/main/entities/agent-skill-writing-evaluation.md) — 系列其他 skill 写作视角。本实体是**鹅厂完整 Playbook 视角**。
...
- Skill 系统综述 — [Agent Skills Comprehensive Survey](../ch04-340-agent-skills-系统性综述-表示-获取-检索-进化)
- Skill 元技能 — [Meta Skill](../ch07-022-meta-skill)
- Skill vs Coze/Dify/n8n — [Agent Skills Vs Coze Dify N8N Lowcode Yexiaocha](../ch04-282-agent-skills-vs-workflow低代码平台-选型分析)
