...
这与 [AI Tool Poisoning Exposes a Major Flaw in Enterprise Agent Security](/ch04-277-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s/) 中讨论的"工具返回值被恶意篡改"是同一类问题——L3 prompt injection 是 2026 年 Agent 安全的头号威胁。
...
- [AI Agent 的迁移与现代化: OpenClaw → Bedrock AgentCore](/ch11-193-ai-agent-的迁移与现代化-使用-amazon-bedrock-agentcore-将-openclaw-从单/)
...
- [Claude Managed Agents 自托管沙箱企业版](/ch04-421-claude-managed-agents/)
