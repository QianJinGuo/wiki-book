...
## Ch12.075 JetBrains Marketplace Ecosystem Security Update: Malicious AI Plugins
...
- [Semgrep Intercom PHP](ch12/115-semgrep-intercom-php-supply-chain.html) - malicious package via package manager
- [Claude Code Malicious Skills](../ch01/808-skill-issues-compromising-claude-code-with-malicious-skills.html) - Agent/Skill ecosystem risk
- [Checkmarx Jenkins Plugin](../ch01/415-checkmarx-jenkins-plugin-compromised-in-new-supply-chain-att.html) - plugin marketplace attack
