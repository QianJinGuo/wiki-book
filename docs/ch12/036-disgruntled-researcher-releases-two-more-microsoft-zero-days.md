...
> 📊 Level ⭐⭐ | 9.9KB | `entities/microsoft-zero-days-researcher-disgruntled-theregister.md`
...
- [13 Disgruntled Researcher Releases Two More Microsoft Zero Days 5239758](067-disgruntled-researcher-releases-two-more-microsoft-zero-days.html)
...
- [Defense_At_Ai_Speed_Microsofts_New_Multi](../ch04/135-ai.html)
