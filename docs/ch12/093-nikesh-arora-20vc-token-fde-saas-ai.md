...
- [Token 经济学与 AI 效率](ch04/069-ai.md) — 从 token 效率工程层看同一问题；Arora 提供了宏观市场定价的 CEO 视角
- [腾讯 Token 经济学与 AI 普惠](ch04/069-ai.md) — 腾讯视角的 token 经济分析，可对照 Arora 的硅谷视角
- [纳德拉 Token 资本论](ch04/069-ai.md) — 另一位 CEO 的 AI 经济战略宣言，对比阅读
