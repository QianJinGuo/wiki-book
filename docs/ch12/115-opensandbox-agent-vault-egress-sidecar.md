...
## Ch12.115 OpenSandbox：阿里开源的云端 Agent 安全沙箱（凭据 Vault + egress sidecar）
...
与 [Claude Managed Agents](ch07/001-mcp.html) 的关系：OpenSandbox 更接近 Environment、Sandbox、Vault、Permission policy 里偏运行时的部分，Agent harness 那层不会替你做。
...
- [LangChain Sandbox Architecture](ch05/100-ai.html) — 另一种 sandbox 设计
- [Microsoft mxc Containers](ch05/100-ai.html) — Microsoft 的 sandbox 方案
