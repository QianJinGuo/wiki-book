...
这项研究也直接呼应了 [Securing Ai Agents How Aws And Cisco Ai Defense Scale Mcp And A2A](../ch04/279-ai-agent.html) 的核心议题：MCP / A2A 协议让 AI Agent 拥有更强的工具调用和跨系统能力，但同样的能力既可以被良性 Agent 使用，也可以被恶意 Agent 武器化。AI 蠕虫本质上就是"恶意 Agent 在网络中的传播"。
...
- [Disgruntled Researcher Releases Two More Microsoft Zero Days 5239758](064-disgruntled-researcher-releases-two-more-microsoft-zero-days.html)
