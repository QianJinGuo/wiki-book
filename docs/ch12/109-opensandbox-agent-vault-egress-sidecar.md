...
## Ch12.109 OpenSandbox：阿里开源的云端 Agent 安全沙箱（凭据 Vault + egress sidecar）
...
与 [Claude Managed Agents](../ch04/504-claude-managed-agents.html) 的关系：OpenSandbox 更接近 Environment、Sandbox、Vault、Permission policy 里偏运行时的部分，Agent harness 那层不会替你做。
...
- [Claude Managed Agents](../ch04/504-claude-managed-agents.html) — 类似的 sandbox 架构
- [LangChain Sandbox Architecture](../ch05/081-ai.html) — 另一种 sandbox 设计
