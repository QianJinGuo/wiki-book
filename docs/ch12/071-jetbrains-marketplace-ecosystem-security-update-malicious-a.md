...
- [Semgrep Intercom PHP](098-semgrep-intercom-php-supply-chain.html) - malicious package via package manager
- [Claude Code Malicious Skills](../ch01/575-skill-issues-compromising-claude-code-with-malicious-skills.html) - Agent/Skill ecosystem risk
