...
## Ch12.108 OpenSandbox：阿里开源的云端 Agent 安全沙箱（凭据 Vault + egress sidecar）
...
与 [Claude Managed Agents](https://github.com/QianJinGuo/wiki/blob/main/entities/claude-managed-agents-self-hosted-sandbox-mcp-tunnels-enterprise.md) 的关系：OpenSandbox 更接近 Environment、Sandbox、Vault、Permission policy 里偏运行时的部分，Agent harness 那层不会替你做。
...
- [LangChain Sandbox Architecture](https://github.com/QianJinGuo/wiki/blob/main/entities/langchain-harrison-chase-sandbox-architecture.md) — 另一种 sandbox 设计
- [Microsoft mxc Containers](https://github.com/QianJinGuo/wiki/blob/main/entities/microsoft-mxc-execution-containers-agent-sandbox-origin.md) — Microsoft 的 sandbox 方案
