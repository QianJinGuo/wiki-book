...
这与 [Tool Poisoning 攻击](/ch04-370-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s//) 形成互补威胁——后者针对工具供应链，前者针对身份认证层。
...
这一思路与 [AWS 和 Cisco 的 AI Defense 方案](/ch07-027-securing-ai-agents-aws-cisco-ai-defense-给-mcp-a2a-加上企业级//) 在「覆盖人类和机器的统一审计」目标上形成呼应，但 1Password 更聚焦于开发者端点侧的凭证发现与保护。
...
详见 [MCP Gateway 与 AI Gateway 的安全对比](/ch11-079-ai-gateways-vs-mcp-gateways-what-security-teams-need-to-kno//)。
...
- [AgentCore Identity](/ch04-171-agentcore-identity-3-legged-oauth-session-binding的安全架构//) — AWS Bedrock Agent 身份与访问管理
