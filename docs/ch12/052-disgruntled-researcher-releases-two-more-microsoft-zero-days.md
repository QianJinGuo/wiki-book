...
## Ch12.052 Disgruntled researcher releases two more Microsoft zero-days
...
- [LLM raiders and how to repel them](https://github.com/QianJinGuo/wiki-public/blob/main/entities/llm-raiders-how-to-repel.md) — AI 基础设施安全的另一个威胁向量
