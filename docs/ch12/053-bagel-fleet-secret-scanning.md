...
## Ch12.053 bagel — Fleet 级 Secret Scanning 守护开发工作站
...
- [Trail Of Bits Skill Scanner Bypass Distribution](../ch01/278-trail-of-bits-skill-scanner-bypass.html) — Trail of Bits 的 Skill scanner 工具，AI 编程安全的另一个维度
