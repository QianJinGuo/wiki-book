...
- [process-financial-documents-using-amazon-bedrock-data-automa](../ch11/158-amazon-bedrock.html) — 同 BDA 平台，重点是金融文档的实际提取案例
- [automate-schema-generation-for-intelligent-document-processing](../ch11/167-automate-schema-generation-for-intelligent-document-processi.html) — schema 自动生成（与 blueprint 优化互补：先生成 schema，再优化 instruction）
- [amazon-bedrock-agentcore-runtime-deep-dive-and-scenario-analysis](../ch04/534-amazon-bedrock-agentcore.html) — Bedrock AgentCore 平台深度（非 BDA，但同 Bedrock 体系）
...
5. **与 [Process Financial Documents Using Amazon Bedrock Data Automa](../ch11/158-amazon-bedrock.html) 联合使用** — 后者侧重金融文档的端到端提取场景，前者侧重 blueprint instruction 的自动化优化，两者构成"schema 设计 → instruction 优化 → 生产部署"的完整 IDP pipeline。
