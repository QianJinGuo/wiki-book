...
## 相关主题
- [Hermes Agent Tool System Architecture](ch04/502-agent.md) — Hermes Agent 工具系统架构专篇（术哥，2026-05-23）— 工具注册/执行/生命周期管理
- [Hermes Agent Goal And Kanban](ch04/502-agent.md) — Hermes Agent goal 与 Kanban 集成
