...
## Ch12.019 JetBrains Marketplace Ecosystem Security Update: Malicious AI Plugins
...
- [Semgrep Intercom PHP](024-semgrep-intercom-php-supply-chain.html) - malicious package via package manager
