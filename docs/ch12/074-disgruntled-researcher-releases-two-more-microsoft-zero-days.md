...
## Ch12.074 Disgruntled researcher releases two more Microsoft zero-days
...
- [Cline releases open-source agent runtime SDK](../ch04/498-agentrun.html)
- [LLM raiders and how to repel them](../ch01/854-llm.html) — AI 基础设施安全的另一个威胁向量
