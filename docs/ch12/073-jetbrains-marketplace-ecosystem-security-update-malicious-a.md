...
- [Semgrep Intercom PHP](ch12/112-semgrep-intercom-php-supply-chain.md) - malicious package via package manager
- [Claude Code Malicious Skills](../ch01/756-skill-issues-compromising-claude-code-with-malicious-skills.md) - Agent/Skill ecosystem risk
- [Checkmarx Jenkins Plugin](../ch01/402-checkmarx-jenkins-plugin-compromised-in-new-supply-chain-att.md) - plugin marketplace attack
