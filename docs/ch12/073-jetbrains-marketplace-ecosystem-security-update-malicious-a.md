...
- [Semgrep Intercom PHP](ch12/112-semgrep-intercom-php-supply-chain.html) - malicious package via package manager
- [Claude Code Malicious Skills](../ch01/786-skill-issues-compromising-claude-code-with-malicious-skills.html) - Agent/Skill ecosystem risk
- [Checkmarx Jenkins Plugin](../ch01/412-checkmarx-jenkins-plugin-compromised-in-new-supply-chain-att.html) - plugin marketplace attack
