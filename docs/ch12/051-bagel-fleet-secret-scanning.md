...
## Ch12.051 bagel — Fleet 级 Secret Scanning 守护开发工作站
...
- [Bedrock Agentcore Secrets Manager Identity](ch04/503-agent.md) — AWS Bedrock AgentCore 的 secret 管理视角（云端 secret 而非本地泄漏）
