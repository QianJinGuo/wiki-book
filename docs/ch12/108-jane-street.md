...
## Ch12.108 Jane Street — 形式化方法与编程的未来
...
- [Claude Code 大型代码库 Harness](ch03/073-claude-code.md) — 同主题 AI 编程 vs 验证
- [AI Friendly 架构](ch04/310-ai.md) — 形式化 spec 是 AI-friendly 的一种表达
