...
- [Semis Memo: Supply Chain Inheritance](../ch01/460-semis-memo-supply-chain-inheritance.html)
...
- [semgrep intercom php supply chain](098-semgrep-intercom-php-supply-chain.html)
