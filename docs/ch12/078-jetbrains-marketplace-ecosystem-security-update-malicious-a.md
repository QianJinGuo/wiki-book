...
## Ch12.078 JetBrains Marketplace Ecosystem Security Update: Malicious AI Plugins
...
- [Claude Code Malicious Skills](../ch01/1089-skill-issues-compromising-claude-code-with-malicious-skills.html) - Agent/Skill ecosystem risk
- [Checkmarx Jenkins Plugin](../ch01/548-checkmarx-jenkins-plugin-compromised-in-new-supply-chain-att.html) - plugin marketplace attack
