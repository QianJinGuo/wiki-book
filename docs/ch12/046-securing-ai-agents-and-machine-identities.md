...
## Ch12.046 Securing AI Agents and Machine Identities
...
这与 [Tool Poisoning 攻击](../ch04/442-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s.html) 形成互补威胁——后者针对工具供应链，前者针对身份认证层。
...
- [AgentCore Identity](../ch11/256-aws-bedrock-agentcore.html) — AWS Bedrock Agent 身份与访问管理
