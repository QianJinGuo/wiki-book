...
这与 [Tool Poisoning 攻击](ch05/094-ai.html) 形成互补威胁——后者针对工具供应链，前者针对身份认证层。
...
这一思路与 [AWS 和 Cisco 的 AI Defense 方案](ch05/094-ai.html) 在「覆盖人类和机器的统一审计」目标上形成呼应，但 1Password 更聚焦于开发者端点侧的凭证发现与保护。
...
详见 [MCP Gateway 与 AI Gateway 的安全对比](ch05/094-ai.html)。
