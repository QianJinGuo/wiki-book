...
- [Semgrep Intercom PHP](091-semgrep-intercom-php-supply-chain.html) - malicious package via package manager
- [Claude Code Malicious Skills](../ch01/535-skill-issues-compromising-claude-code-with-malicious-skills.html) - Agent/Skill ecosystem risk
- [Checkmarx Jenkins Plugin](../ch04/052-ai.html) - plugin marketplace attack
