...
这种"凭证管理"实践是 [Harness Engineering](/ch05-041-harness-engineering-概念框架//) 中"工具调用沙箱化"的延伸——凭证不应与 Agent 代码同位，而应通过受控的 secret manager 注入。
...
这与 [AI Tool Poisoning Exposes a Major Flaw in Enterprise Agent Security](/ch04-370-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s//) 中讨论的"工具返回值被恶意篡改"是同一类问题——L3 prompt injection 是 2026 年 Agent 安全的头号威胁。
...
这与 [EKS Graviton 多租户 OpenClaw 实践](/ch11-050-基于-amazon-eks-和-graviton-构建多租户-ai-agent-平台-openclaw-on-kuber//) 直接对应——后者是该文章中"方案 3"的工程细节展开。
...
- [AI Agent 的迁移与现代化: OpenClaw → Bedrock AgentCore](/ch11-076-ai-agent-的迁移与现代化-使用-amazon-bedrock-agentcore-将-openclaw-从单机改//)
- [EKS Graviton 多租户 OpenClaw K8s 实践](/ch11-050-基于-amazon-eks-和-graviton-构建多租户-ai-agent-平台-openclaw-on-kuber//)
- [CI/CD on Bedrock AgentCore OpenClaw 企业智能运营最佳实践](/ch11-056-ci-amp-t基于-amazon-bedrock-agentcore-与-openclaw-的企业级智能运维最佳实践//)
...
- Claude Code vs OpenClaw Memory 对比
- Claude Code vs OpenClaw Memory 向量数据库之争
- [Claude Code vs OpenClaw 使用 Ettin](/ch09-028-claude-code-openclaw-usage-ettin//)
- [Claude Managed Agents 自托管沙箱企业版](/ch04-517-claude-managed-agents-企业边界更新//)
