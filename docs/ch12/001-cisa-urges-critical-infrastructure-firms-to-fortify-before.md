...
```mermaid
mindmap
  root(("CISA urges critical"))
    CI Fortify 指南的战略背景
    Volt Typhoon 行动的深远影响
    隔离 Isolation 战略的核心要素
    恢复 Recovery 战略的核心要素
    对关键基础设施运营商的建议
    对 OT 安全团队的启示
    对政策制定者的建议
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/cisa-urges-critical-infrastructure-firms-to-fortify-before-i.md)
