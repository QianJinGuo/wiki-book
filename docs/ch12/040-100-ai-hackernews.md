...
## Ch12.040 100万+AI服务暴露在公网——HackerNews扫描报告
...
## 相关实体
- [Your AI Agents Are Already Inside the Perimeter. Do You Know Who They Are?](../ch04/377-ai-agent.html)
...
> [!related] 相关漏洞
> [Bleeding Llama](../ch06/048-memory.html) (CVE-2026-7482, CVSS 9.1) 揭示了 Ollama 的更深层问题——不仅默认无认证，还存在未认证内存泄漏漏洞，可导致整个进程堆内存被窃取。300,000+ 台暴露的 Ollama 服务器面临严重威胁。
