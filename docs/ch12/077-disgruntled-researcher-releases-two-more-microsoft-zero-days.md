...
## Ch12.077 Disgruntled researcher releases two more Microsoft zero-days
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/disgruntled-researcher-microsoft-zero-days.md)
...
- [Cline releases open-source agent runtime SDK](../ch04/463-agentrun.html)
- [LLM raiders and how to repel them](../ch01/1135-llm.html) — AI 基础设施安全的另一个威胁向量
