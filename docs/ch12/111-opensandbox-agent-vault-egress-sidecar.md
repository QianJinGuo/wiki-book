...
与 [Claude Managed Agents](../ch04/517-claude-managed-agents.html) 的关系：OpenSandbox 更接近 Environment、Sandbox、Vault、Permission policy 里偏运行时的部分，Agent harness 那层不会替你做。
...
- [Claude Managed Agents](../ch04/517-claude-managed-agents.html) — 类似的 sandbox 架构
