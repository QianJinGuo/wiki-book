...
与 [Claude Managed Agents](../ch04/678-claude-managed-agents.html) 的关系：OpenSandbox 更接近 Environment、Sandbox、Vault、Permission policy 里偏运行时的部分，Agent harness 那层不会替你做。
...
- [Claude Managed Agents](../ch04/678-claude-managed-agents.html) — 类似的 sandbox 架构
- [LangChain Sandbox Architecture](../ch05/089-ai.html) — 另一种 sandbox 设计
