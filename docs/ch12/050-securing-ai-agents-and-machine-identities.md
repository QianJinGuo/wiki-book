...
这一思路与 [AWS 和 Cisco 的 AI Defense 方案](../ch04/430-ai-agent.html) 在「覆盖人类和机器的统一审计」目标上形成呼应，但 1Password 更聚焦于开发者端点侧的凭证发现与保护。
...
- [AgentCore Identity](../ch11/269-aws-bedrock-agentcore.html) — AWS Bedrock Agent 身份与访问管理
