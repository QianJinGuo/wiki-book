...
与 [Claude Managed Agents](../ch04/609-claude-managed-agents.md) 的关系：OpenSandbox 更接近 Environment、Sandbox、Vault、Permission policy 里偏运行时的部分，Agent harness 那层不会替你做。
...
- [Claude Managed Agents](../ch04/609-claude-managed-agents.md) — 类似的 sandbox 架构
- [LangChain Sandbox Architecture](../ch04/070-ai.md) — 另一种 sandbox 设计
- [Microsoft mxc Containers](../ch03/045-agent.md) — Microsoft 的 sandbox 方案
