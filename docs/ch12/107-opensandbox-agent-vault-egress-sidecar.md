...
与 [Claude Managed Agents](ch03/045-agent.md) 的关系：OpenSandbox 更接近 Environment、Sandbox、Vault、Permission policy 里偏运行时的部分，Agent harness 那层不会替你做。
...
- [LangChain Sandbox Architecture](ch04/069-ai.md) — 另一种 sandbox 设计
- [Microsoft mxc Containers](ch04/069-ai.md) — Microsoft 的 sandbox 方案
