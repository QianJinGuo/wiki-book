...
## Ch12.124 ShinyHunters hack 7-Eleven: franchisee data and Salesforce records exposed
...
值得注意的是，ShinyHunters 的后续行动（包括 [Canvas LMS 攻击事件](../ch05/100-ai.html)）表明该组织正在扩大 SaaS 平台的攻击面，并将运营基础设施从 clearnet 向 Tor 转移，以规避执法压力。
