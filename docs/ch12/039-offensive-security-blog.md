...
## Ch12.039 Offensive Security Blog
...
- [CloudSectiDbits: Masso - Cognito SSO Bypass](../ch11/104-cloudsectidbits.html)
...
这与 Boris Cherny 访谈中提到的 MCP 作为 AI 工具连接标准 形成有趣对照——MCP 一方面是 AI Agent 的能力放大器，另一方面也带来了新的攻击向量。
