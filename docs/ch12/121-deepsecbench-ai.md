...
## Ch12.121 DeepSecBench：评估 AI 模型在网络安全漏洞发现中的性能
...
- [Agentic Penetration Testing Legal Questions](../ch04/633-agentic.html)
- [Multimodal Evaluators：MLLM-as-Judge](../ch01/307-mllm-as-judge.html)
