...
## Ch12.115 Jane Street — 形式化方法与编程的未来
...
- [Claude Code 大型代码库 Harness](../ch03/075-claude-code.html) — 同主题 AI 编程 vs 验证
- [AI Friendly 架构](../ch05/023-ai-friendly.html) — 形式化 spec 是 AI-friendly 的一种表达
