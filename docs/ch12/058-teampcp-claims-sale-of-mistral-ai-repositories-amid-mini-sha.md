...
## 相关实体
- [Restrict Access to Sensitive Documents in Amazon QuickSight](../ch11/134-restrict-access-to-sensitive-documents-in-your-amazon-quick.md) — 企业级文档访问控制实践
- [PyTorch 2.12 Release Blog – PyTorch](../ch01/270-pytorch-2-12-release-blog.md) — AI 框架生态安全
