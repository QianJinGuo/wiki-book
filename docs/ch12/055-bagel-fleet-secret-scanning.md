...
## Ch12.055 bagel — Fleet 级 Secret Scanning 守护开发工作站
...
- [Bedrock Agentcore Secrets Manager Identity](../ch11/050-bedrock-agentcore.html) — AWS Bedrock AgentCore 的 secret 管理视角（云端 secret 而非本地泄漏）
- [Trail Of Bits Skill Scanner Bypass Distribution](../ch01/217-trail-of-bits-skill-scanner-bypass.html) — Trail of Bits 的 Skill scanner 工具，AI 编程安全的另一个维度
- [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/recyclebin-zip-secret-scanning-fleet-bagel-2026.md)
