...
- [Karpathy Vibe Coding 访谈](ch03/035-agent.html) — Agentic Engineering 范式
- [Harness Engineering 概念](ch05/100-ai.html)
...
- [LLMReaper Browser Extension Attack](ch05/100-ai.html) — 浏览器扩展攻击向量
