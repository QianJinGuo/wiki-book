...
## Ch12.042 Securing AI Agents and Machine Identities
...
这与 [Tool Poisoning 攻击](ch04/150-ai.md) 形成互补威胁——后者针对工具供应链，前者针对身份认证层。
...
这一思路与 [AWS 和 Cisco 的 AI Defense 方案](ch04/150-ai.md) 在「覆盖人类和机器的统一审计」目标上形成呼应，但 1Password 更聚焦于开发者端点侧的凭证发现与保护。
...
详见 [MCP Gateway 与 AI Gateway 的安全对比](ch04/150-ai.md)。
...
- [AgentCore Identity](ch03/044-agent.md) — AWS Bedrock Agent 身份与访问管理
