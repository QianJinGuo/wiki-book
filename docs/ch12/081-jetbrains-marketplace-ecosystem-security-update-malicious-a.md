...
## Ch12.081 JetBrains Marketplace Ecosystem Security Update: Malicious AI Plugins
...
- [Semgrep Intercom PHP](ch12/123-semgrep-intercom-php-supply-chain.html) - malicious package via package manager
- [Claude Code Malicious Skills](../ch01/1106-skill-issues-compromising-claude-code-with-malicious-skills.html) - Agent/Skill ecosystem risk
- [Checkmarx Jenkins Plugin](../ch01/543-checkmarx-jenkins-plugin-compromised-in-new-supply-chain-att.html) - plugin marketplace attack
