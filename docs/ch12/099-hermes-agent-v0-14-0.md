...
## Ch12.099 Hermes Agent v0.14.0 核心架构与快速上手
...
术哥 2026-06-03 发布的 SOUL.md 专题深度续篇（原文存档），把 v0.14 架构篇简述的 3 层提示词展开为**完整的身份系统专题**——SOUL.md 是如何从文件到提示词、14 personality 如何叠加、为什么需要安全扫描、容器为什么不能自改身份。
