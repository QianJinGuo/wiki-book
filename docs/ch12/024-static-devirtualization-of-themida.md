...
- "通用 Pass + 配置化范围约束" 类似 [nanobot](../ch03/045-agent.md) 的"统一 Tool 接口 + Skill 范围声明"
...
- [Nanobot Agent Framework Architecture Deep Dive](../ch03/045-agent.md) — "通用机制 + 范围约束"的元模式在 Agent 领域的应用
