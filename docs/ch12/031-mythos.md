...
这一发现与[Agent团队协作](../ch01/1219-claude.html)中的"群聊模式"讨论高度相关——多个专精Agent通过编排调度层实现能力互补，比单一通用Agent在复杂安全任务中表现更优。MDASH的架构设计（编排调度层 + 五段流水线 + 支撑底座）可以作为AI安全红队的参考模板。
...
- [Agent团队协作](../ch01/1219-claude.html) — 多Agent协同模式
