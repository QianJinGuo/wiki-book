...
## Ch12.104 peerd: 浏览器原生的 AI Agent Harness

> 📊 Level ⭐⭐ | 4.3KB | `entities/peerd-browser-native-agent-harness.md`
...
- [Gemini 3.5 Flash Computer Use Agent Harness](../ch05/038-agent-harness.html)
