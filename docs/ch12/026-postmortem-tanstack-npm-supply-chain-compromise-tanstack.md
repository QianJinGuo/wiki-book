...
- [Semis Memo: Supply Chain Inheritance](../ch01/138-semis-memo-supply-chain-inheritance.html)
...
- [semgrep intercom php supply chain](019-semgrep-intercom-php-supply-chain.html)
