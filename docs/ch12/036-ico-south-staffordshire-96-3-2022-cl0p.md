...
## Ch12.036 ICO 对 South Staffordshire 处以 96.3 万英镑罚款：2022 年 Cl0p 勒索软件攻击暴露的安全失败
...
- Canvas LMS 攻击事件 — 同一时期教育领域 SaaS 被攻击，体现关键供应链攻击常态化
...
- 视觉 AI 的下一前沿是代码 — a16z 关于视觉生成栈的论述
