...
## Ch11.113 Sovereign cloud is only possible if you're Chinese or American: Gartner
...
- [**AWS** / **Microsoft Azure** / **Google Cloud** — 美国云代表，受 Toombs 主权悖论约束](/ch11-166-archera-insured-cloud-commitments-for-aws-azure-and-goog/)
- **Alibaba Cloud** / **Huawei Cloud** — 中国云代表，全球少数能提供全栈主权云的玩家
- **Geopolitical Tech** — Toombs 和 Wong 分析的地缘政治维度
- [**Agent AI** — 主权依赖在 Agent 时代被进一步加深](/ch11-193-ai-agent-的迁移与现代化-使用-amazon-bedrock-agentcore-将-openclaw-从单/)
