...
## Ch11.041 LiteLLM 驱动的 Amazon Bedrock 成本治理：四层防护体系
...
> 来源：[原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/通过-litellm-实现-amazon-bedrock-成本管控实时限额多维监控与平台级兜底.md)
...
对于任何在 AWS 上部署 AI 应用的团队，用 IAM Role 替换 Long-lived AK/SK 是**必须完成的基础安全改造**。配合 Secrets Manager 集中托管 + 90 天自动轮转 + GitHub Secret Scanning，可以将 API Key 盗刷风险降到最低。参见 [Amazon Bedrock Agentcore Gateway Mcp Extension](/ch11-014-extending-mcp-support-for-amazon-bedrock-agentcore-gateway/) 了解 Bedrock 场景下的安全最佳实践。
...
- [AWS Bedrock AgentCore Gateway MCP 扩展](/ch11-014-extending-mcp-support-for-amazon-bedrock-agentcore-gateway/)
- [阿里云云原生 API Gateway Gateway API 指南](/ch11-237-告别-ingress-nginx-云原生-api-网关-gateway-api-使用指引/)
