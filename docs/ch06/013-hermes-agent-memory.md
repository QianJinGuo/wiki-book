...
这与 [Hermes Agent 记忆系统深度拆解](ch06/013-hermes-agent-memory.html) 中提到的"档案室不等于随身备忘录"是同一设计哲学的两面表达。
...
- [Hermes Agent 三级 Memory 架构解析（One掌柜视角）](../ch03/099-hermes-agent.html) — 同一作者的另一篇分析
- [AI Agent 记忆系统架构](../ch04/216-how-ai-agent-memory-works.html) — Agent 记忆系统的通识性框架
- [17种Agent架构演进](../ch04/803-17-agent.html) — 记忆设计在 Agent 演化中的位置
