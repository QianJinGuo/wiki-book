...
- [Harness Engineering](../ch05/096-harness-engineering.html) 的系统性框架：模型外的 harness 决定下限
- [Anthropic PM 的 Agentic 工作流](../ch04/584-anthropic-pm-agentic.html)：任务委派和上下文边界的判断
