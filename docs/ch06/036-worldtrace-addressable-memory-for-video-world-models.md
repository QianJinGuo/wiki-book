...
- [李飞飞掩码视觉动作世界模型](../ch01/1132-20.html) — 同为世界模型方向，WorldTrace 聚焦记忆寻址而非动作预测
- [BAAI Orca 世界模型](../ch05/111-ai.html) — 下一状态预测范式对照
- [A2RD 长视频自回归扩散](../ch04/298-agentic.html) — 长视频生成的自回归一致性
- [The great memory panic of 2026](../ch01/1159-the-great-memory-panic-of-2026.html) — 记忆/上下文基础设施的行业视角
- [高德 Abot Earth 3D 原生世界模型](../ch01/1301-3d.html)
