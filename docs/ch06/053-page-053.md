...
总趋势：注意力塌缩不会消失，但上下文管理重心正从模型内部（更长窗口、更好位置编码）向系统外部（检索、压缩、记忆、遗忘）迁移——正如 [How LLMs Actually Work: 0xkato Transformer Walkthrough](../ch01/1509-how-llms-actually-work-0xkato-transformer-walkthrough.html) 所揭示的"模型能力天花板由系统补足"的 Agent 时代范式。
...
- [用好 Claude 的 18 个动作：搭一个个人 AI 工作台（Personal Harness）](../ch01/639-claude.html)
...
- [How LLMs Actually Work: 0xkato Transformer Walkthrough](../ch01/1509-how-llms-actually-work-0xkato-transformer-walkthrough.html)
