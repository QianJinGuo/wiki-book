...
## Ch06.049 AI Memory Architecture: Deep Dive
...
- [Agent Memory 架构本质](../ch04/517-perplexity-brain-self-improving-agent-memory-architecture.html) — Governance-centric view
- [Hermes Agent 记忆系统](ch06/013-hermes-agent-memory.html) — Production implementation deep-dive
- [Memory in LLM Era — ICLR 2026](ch06/015-memory.html) — Academic framework and benchmarks
