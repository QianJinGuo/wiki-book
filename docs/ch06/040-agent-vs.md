...
## Ch06.040 Agent 记忆系统的主矛盾：历史增长 vs 临场上下文调度
...
- → [Agent 记忆系统的工程实践与演进](../ch03/037-agent.html) — 更侧重工程落地（写入纪律、Prompt Cache、Embedding迁移等），本实体侧重理论框架
- → [State of Memory in Agent Harness](../ch05/042-agent-harness.html) — Mem0 的行业状态报告
