...
## Ch05.075 DIPG 蚂蚁保 Host-Research-Verify 三 Agent 离线 verify 闭环：C 端 AIGC 工程化范式
...
## 相关实体
- [Wall Not Model Harness Three Case Studies Stripe Deerflow Ant](/ch05-079-墙比模型更重要-stripe-minions-字节-deerflow-2-0-蚂蚁支小助-的同结论/)
...
- [Openclacky Harness Engineering 100 Percent Cache Hit](/ch05-074-harness-工程实践复盘-100-cache-命中的-agent-怎么设计/)
