...
> 📊 Level ⭐⭐ | 111.3KB | `entities/loop-engineering-addy-osmani-challengehub.md`
...
- **State 部件**与 [Hermes Loop 架构](/ch04-418-hermes-agent/)的状态管理同源——本文的 State = Hermes 的 LoopState/HandoffRecord
