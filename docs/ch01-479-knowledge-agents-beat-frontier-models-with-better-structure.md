...
## Ch01.479 Knowledge Agents: Beat Frontier Models with Better Structure
...
这一经济逻辑与 Moebius 的"task-specific specialist > general-purpose giant"范式形成共振——在明确场景下，小模型 + 结构化知识 > 大模型 + 通用推理。
...
- Moebius — 任务特化小模型超越通用大模型的另一范式
- [RAG（Retrieval-Augmented Generation）是 Knowledge Agent 的理论基础和差异化点](/ch04-430-skill-retrieval-augmentation-for-agentic-ai-清华-skill-rag/)
- [Claude Code 动态工作流](/ch09-070-claude-code-dynamic-workflows-实战模式与构建技巧/) — Knowledge Agent 的主要使用场景之一
