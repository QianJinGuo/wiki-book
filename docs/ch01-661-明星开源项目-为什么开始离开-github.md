...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/open-source-projects-leaving-github.md)- github multilingual repositories dataset — 4000 万仓库多语言元数据
