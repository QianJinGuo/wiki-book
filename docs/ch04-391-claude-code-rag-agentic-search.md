...
## Ch04.391 Claude Code 开发负责人：为何放弃 RAG 而选择 Agentic Search
...
这与 [Claude Code 源码分析](/ch01-734-两万字详解claude-code源码核心机制/) 中揭示的架构一致：Claude Code 的核心不是 RAG pipeline，而是工具编排能力。
...
- [Agentic Search](/ch04-386-claude-code-开发负责人-为何放弃-rag-而选择-agentic-search/)
...
- [Claude Code 源码分析](/ch01-734-两万字详解claude-code源码核心机制/)
