...
> 全球第一部基于 4040 篇一手 AI 材料系统编撰的开源读物。
...
| 篇 | 章节 | 定位 | 文章数 |
|---|---|---|---|
| **第一篇 · 入门篇** | Ch01 AI 与 LLM 基础 | 任何人 | 1241 篇 |
|  | Ch02 提示词工程与上下文工程 |  | 31 篇 |
|  | Ch03 AI 工具与产品全景 |  | 166 篇 |
| **第二篇 · 工程师篇** | Ch04 Agent 核心架构 | 有编程基础 | 764 篇 |
|  | Ch05 Harness 工程 |  | 144 篇 |
|  | Ch06 记忆与上下文管理 |  | 35 篇 |
|  | Ch07 技能、工具与 MCP |  | 105 篇 |
|  | Ch08 多 Agent 协作 |  | 24 篇 |
|  | Ch09 AI 编程与代码生成 |  | 185 篇 |
|  | Ch10 RAG 与知识检索 |  | 21 篇 |
| **第三篇 · 专家篇** | Ch11 云基础设施与部署 | 有 ML 基础 | 347 篇 |
|  | Ch12 安全与治理 |  | 117 篇 |
|  | Ch13 MLOps 与评估 |  | 16 篇 |
|  | Ch14 数据工程 |  | 29 篇 |
...
| **总计** | **20 个章节 · 5 篇** |  | **4040 篇** |

---

## 第一篇 · 入门篇 — 从零理解 AI

### [Ch01 AI 与 LLM 基础](ch01-ai-basics.md) — 1241 篇
...
### [Ch03 AI 工具与产品全景](ch03-ai-tools.md) — 166 篇
...
### [Ch04 Agent 核心架构](ch04-agent-core.md) — 764 篇
...
### [Ch07 技能、工具与 MCP](ch07-skill-tool.md) — 105 篇
...
### [Ch09 AI 编程与代码生成](ch09-ai-coding.md) — 185 篇
...
### [Ch11 云基础设施与部署](ch11-infra.md) — 347 篇
...
### [Ch12 安全与治理](ch12-security.md) — 117 篇
...
> 
> 内容来源：4040 篇一手 AI 材料 | 许可协议：CC BY-SA 4.0
