<header class="home-hero">
  ...
  <div class="home-stats">
    ...
    <div class="home-stats__item"><span class="home-stats__num">2,248</span><span class="home-stats__label">编撰条目</span></div>
...
| 第二篇 · 工程师篇 | 构建 AI 应用 | 有编程基础 | 835 篇 |
| 第三篇 · 专家篇 | 深入系统架构 | 有ML基础 | 366 篇 |
...
### [Ch04 Agent 核心架构](ch04-agent-core.md) — 471 篇
> 什么是 Agent？从 ReAct 到 Agentic Engineering 的范式跃迁
  ...
  - ... 共 **471** 篇 → [完整章节](ch04-agent-core.md)
...
### [Ch12 安全与治理](ch12-security.md) — 103 篇
...
**📊 全书收录：2,248 篇编撰条目 | 20 章 · 5 篇 | 开源 · 每日更新**
