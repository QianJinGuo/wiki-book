...
| 第二篇 · 工程师篇 — 构建 AI 应用 | 有编程基础 | 1346 篇 |
...
### [Ch04 Agent 核心架构](ch04-agent-core.md) — 793 篇
> 什么是 Agent？从 ReAct 到 Agentic Engineering 的范式跃迁
  ...
  - ... 共 **793** 篇 → [完整章节](ch04-agent-core.md)
...
**📊 全书收录：3829 篇编撰实体 | 20 章 5 篇 | 开源读物**

生成时间: 2026-08-02 | 来源: ~/wiki/entities/
