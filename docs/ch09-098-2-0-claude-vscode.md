...
- [Claude Vscode Plugin Zero Code](/ch01-562-2-小时-0-行手写代码-我用-claude-做了一个生产级-vscode-插件/)
...
## 相关实体
- [`Claude Code记忆` — AI辅助长程项目的上下文管理](/ch03-002-obsidian-claude-code-集成指南/)
- [`OpenClaw团队` — AI辅助编码的工程实践](/ch11-193-ai-agent-的迁移与现代化-使用-amazon-bedrock-agentcore-将-openclaw-从单/)
