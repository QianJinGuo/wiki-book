...
- [Claude Opus 4.7](/ch01-195-claude-opus-47-并不是一次全面升级甚至部分能力大幅衰退nn大家应该在合适的场景下选择使用nn昨晚-opus/) — 最新旗舰模型发布
- [Claude Opus 4.7 深度分析](/ch01-314-claude-opus-4-7-发布分析/) — 详细发布分析
- [Anthropic](/ch07-044-anthropic-mcp-重新定义-tool-search-代码编排/) — 模型开发商
- MOC
