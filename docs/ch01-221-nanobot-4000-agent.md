...
参见 working set 管理。这种模式的代价是**额外的 tool call 延迟**——但对长寿命 Agent 而言，延迟的代价远小于 context 污染的代价。
...
- [腾讯研究院Ai速递 20260506](/ch01-340-腾讯研究院ai速递-20260506/) — CL-Bench Life 揭示的"上下文误用"问题，呼应 nanobot 的 progressive loading 设计
