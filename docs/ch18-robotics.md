...
## Ch18.002 LingBot-VA 2.0 — 蚂蚁灵波具身原生预训练视频-动作基座模型
...
## Ch18.005 逐际动力 Pre-IPO 融资 — 具身智能商业化路径

> 📊 Level ⭐⭐ | 6.9KB | `entities/zhuji-dynamics-pre-ipo-embodied-ai-2026.md`
...
## Ch18.006 Unitree's IPO Filing: The State of the Robotics Market
...
## Ch18.008 Google DeepMind Robotics Accelerator（欧洲版，3 个月计划，15 家初创）
...
## Ch18.009 NVIDIA Isaac Lab + Amazon SageMaker AI：机器人强化学习训练基础设施（Humanoid RL Scale-up）
...
## Ch18.010 蔚蓝BabyAlpha A3消费级机器狗撕开英伟达垄断
...
## Ch18.011 原力灵机 DM0.5：4B 具身基础模型，Zero-Shot 提升 31%
...
## Ch18.012 机器人端杯子之前在想什么？Afford-VLA：先找到杯子最趁手的那块区域
...
## Ch18.013 TouchWorld: 触觉基础模型与灵巧操作 — 破晓智能/哈工大
...
## Ch18.014 ICRA'26双奖加冕！华人博士生重新定义机器人长时程操控
...
## Ch18.015 具身原生世界动作模型（Embodied World Action Model）
...
## Ch18.016 NVIDIA ASPIRE：机器人技能库与持续学习新范式
...
## Ch18.017 景烁科技 — 具身智能数据基础设施

> 📊 Level ⭐⭐⭐⭐ | 2.6KB | `entities/jingshuo-tech-embodied-ai-data-infrastructure-2026.md`
