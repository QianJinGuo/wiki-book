...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/zhuji-dl-robot-pre-ipo-2026.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/刚刚首个空间原生的具身视觉基模开源机器人更会看我们的世界了.md)
...
## Ch18.010 MiniCPM-Robot：面壁智能开源具身智能 VLA 模型系列
...
RobotManip 基于面壁智能 2026 年 5 月发布的 [MiniCPM-V 4.6](https://github.com/QianJinGuo/wiki/blob/main/entities/minicpm-v-46-13b.md) 多模态大模型训练而成。其核心技术是 **视觉 Token 极致压缩**——将图片转换的 Token 数量大幅降低而不损失关键信息。这一压缩能力使模型能流畅地将历史观测数据纳入推理，让机器人「记住」过去几秒甚至几十秒的画面和动作，而不像大多数 VLA 模型那样只看「当下这一帧」。通过流式计算，带记忆的推理成本被追平了传统单帧反应式模型的水平，参数规模也比同类型模型（如 π0.5）更小。
...
## Ch18.011 NVIDIA Isaac Lab + Amazon SageMaker AI：机器人强化学习训练基础设施（Humanoid RL Scale-up）
...
## Ch18.012 蔚蓝BabyAlpha A3消费级机器狗撕开英伟达垄断
...
## Ch18.013 原力灵机 DM0.5：4B 具身基础模型，Zero-Shot 提升 31%
...
→ [第 2 来源原文](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/zero-shot长记忆抗干扰dm05把vla带进真实世界.md)

---

## Ch18.014 机器人端杯子之前在想什么？Afford-VLA：先找到杯子最趁手的那块区域
...
## Ch18.015 TouchWorld: 触觉基础模型与灵巧操作 — 破晓智能/哈工大
...
创始人杨朔曾获 Google PhD Fellowship（全球 9 人之一），博士阶段工作入选 ICLR Best Paper Finalist，26 岁任哈工大（深圳）长聘教授、博导，同年获评国家级青年人才。→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/poxiaointelligent-tactile-robot-foundation-model-2026.md)
...
## Ch18.016 小米开源-xiaomi-robotics-u0让具身数据进入大规模生成时代

> 📊 Level ⭐⭐ | 0.8KB | `entities/小米开源-xiaomi-robotics-u0让具身数据进入大规模生成时代-xiaomi.md`

# 小米开源-xiaomi-robotics-u0让具身数据进入大规模生成时代

> 来源：小米技术 | 发布日期：2026-07-15 | 评分：v×c=49

## 概述

# 小米开源 Xiaomi-Robotics-U0：让具身数据进入大规模生成时代 --- source: wechat source_url: https://mp.weixin.qq.com/s/jiaq2VE7IU7_Wv5lOclc3Q ingested: 2026-07-22 source_published: 2026年7月15日 14:42 --- # 小米开源 Xiaomi-Robo

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/小米开源-xiaomi-robotics-u0让具身数据进入大规模生成时代-xiaomi.md)

---

## Ch18.017 具身智能空间视觉死穴，终于被最新顶会彻底解决！
...
## Ch18.018 ICRA'26双奖加冕！华人博士生重新定义机器人长时程操控
...
## Ch18.019 具身原生世界动作模型（Embodied World Action Model）
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/全球首个具身原生世界动作模型来了.md)

---

## Ch18.020 景烁科技 — 具身智能数据基础设施
...
## Ch18.021 NVIDIA ASPIRE：机器人技能库与持续学习新范式
