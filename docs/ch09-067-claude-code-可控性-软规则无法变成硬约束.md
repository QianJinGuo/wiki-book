...
- [Agent Harness 12 组件](../ch04-061-一篇看懂-agent-harness-的结构-12组件-7决策完整框架) — 12 个 harness 设计模式
- [Harness Engineering 可靠长程Agent](../ch09-076-harness-engineering-让-coding-agent-可靠完成长程任务) — 治理方法论
