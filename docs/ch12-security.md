...
- [072. JetBrains Marketplace Ecosystem Security Update: Malicious AI Plugins](ch12/072-jetbrains-marketplace-ecosystem-security-update-malicious-a.md)
- [073. Thinkst Package Proxy: Supply Chain Safety Checks](ch12/073-thinkst-package-proxy-supply-chain-safety-checks.md)
- [074. AI Detection and Response Aidr a Zero Impact Operating Model](ch12/074-ai-detection-and-response-aidr-a-zero-impact-operating-model.md)
...
- [085. Unlocking the Cloudflare app ecosystem with OAuth for all](ch12/085-unlocking-the-cloudflare-app-ecosystem-with-oauth-for-all.md)
- [086. LLMReaper: 浏览器扩展的对话窃取攻击](ch12/086-llmreaper.md)
- [087. How Unified EDR and ITDR Stop Attacks Before They Spread](ch12/087-how-unified-edr-and-itdr-stop-attacks-before-they-spread.md)
- [088. GitHub Secret Scanning: AI/ML 驱动的大规模误报降低](ch12/088-github-secret-scanning-ai-ml.md)
...
- [104. peerd: 浏览器原生的 AI Agent Harness](ch12/104-peerd-ai-agent-harness.md)
- [105. Anthropic's bug-hunting Mythos was greatest marketing stunt ever, says cURL creator](ch12/105-anthropic-s-bug-hunting-mythos-was-greatest-marketing-stunt.md)
- [106. Incendium Fuzzing Ms Rpc](ch12/106-incendium-fuzzing-ms-rpc.md)
- [107. OpenSandbox：阿里开源的云端 Agent 安全沙箱（凭据 Vault + egress sidecar）](ch12/107-opensandbox-agent-vault-egress-sidecar.md)
- [108. How Semgrep Cut Taint Analysis Time by 75%](ch12/108-how-semgrep-cut-taint-analysis-time-by-75.md)
- [109. Sandworm Hackers Shift From IT Breaches to Critical OT Targets](ch12/109-sandworm-hackers-shift-from-it-breaches-to-critical-ot-targe.md)
