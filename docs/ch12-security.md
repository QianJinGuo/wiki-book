...
- [079. AI Detection and Response Aidr a Zero Impact Operating Model](ch12/079-ai-detection-and-response-aidr-a-zero-impact-operating-model)
...
- [082. Milvus 3.0 聚合下推：3 层隔离、2 条路径、4 倍安全因子](ch12/082-milvus-3-0-3-2-4)
- [083. GitHub Breached — Employee Device Hack Led to Exfiltration of 3,800+ Internal Repos](ch12/083-github-breached-employee-device-hack-led-to-exfiltration-o)
- [084. Getting a CVE Without Shipping Slop](ch12/084-getting-a-cve-without-shipping-slop)
- [085. The IT and security field guide to AI adoption | Tines](ch12/085-the-it-and-security-field-guide-to-ai-adoption-tines)
...
- [087. Mythos for Offensive Security: XBOW's Evaluation](ch12/087-mythos-for-offensive-security-xbow-s-evaluation)
- [088. Fedora Hummingbird brings the container security model to a Linux host OS](ch12/088-fedora-hummingbird-brings-the-container-security-model-to-a)
- [089. GitHub Secret Scanning: AI/ML 驱动的大规模误报降低](ch12/089-github-secret-scanning-ai-ml)
- [090. 飞连 AI 办公安全体系 1+3+N 架构](ch12/090-ai-1-3-n)
- [091. Meet Bluekit: The AI-Powered All-in-One Phishing Kit](ch12/091-meet-bluekit-the-ai-powered-all-in-one-phishing-kit)
- [092. Building is just the beginning: Introducing Discoverability | Lovable](ch12/092-building-is-just-the-beginning-introducing-discoverability)
- [093. Scammers Send Physical Phishing Letters to Steal Ledger Wallet Seed Phrases](ch12/093-scammers-send-physical-phishing-letters-to-steal-ledger-wall)
- [094. LLMReaper: 浏览器扩展的对话窃取攻击](ch12/094-llmreaper)
