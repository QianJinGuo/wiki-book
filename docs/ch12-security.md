...
- [059. Autonomous Vulnerability Hunting with MCP](ch12/059-autonomous-vulnerability-hunting-with-mcp)
- [060. A 0-click exploit chain for the Pixel 10: When a Door Closes, a Window Opens](ch12/060-a-0-click-exploit-chain-for-the-pixel-10-when-a-door-closes)
- [061. GlassWASM: WebAssembly Malware Found in Trojanized Open VSX Extensions](ch12/061-glasswasm-webassembly-malware-found-in-trojanized-open-vsx)
- [062. Static Devirtualization of Themida](ch12/062-static-devirtualization-of-themida)
- [063. NIST SP 800-213r1 — IoT Product Cybersecurity Guidelines](ch12/063-nist-sp-800-213r1-iot-product-cybersecurity-guidelines)
- [064. CVE-2026-20182: Unauthenticated Cisco SD-WAN Control Plane Compromise via vHub Authentication Bypass](ch12/064-cve-2026-20182-unauthenticated-cisco-sd-wan-control-plane-c)
...
- [066. TeamPCP Claims Sale of Mistral AI Repositories Amid Mini Shai-Hulud Attack](ch12/066-teampcp-claims-sale-of-mistral-ai-repositories-amid-mini-sha)
- [067. Meta U-turns on encryption push for Instagram as DMs go plaintext](ch12/067-meta-u-turns-on-encryption-push-for-instagram-as-dms-go-plai)
- [068. AI Voice Cloning: The Technology Behind It, Who's Building It, and Where It's Headed](ch12/068-ai-voice-cloning-the-technology-behind-it-who-s-building-i)
- [069. Grafana GitHub Token Breach Led to Codebase Download and Extortion Attempt](ch12/069-grafana-github-token-breach-led-to-codebase-download-and-ext)
- [070. Google and Amnesty International teamed up to make Android spyware detectable](ch12/070-google-and-amnesty-international-teamed-up-to-make-android-s)
- [071. RFC 9958: Post-Quantum Cryptography for Engineers](ch12/071-rfc-9958-post-quantum-cryptography-for-engineers)
- [072. Thinkst Package Proxy: Supply Chain Safety Checks](ch12/072-thinkst-package-proxy-supply-chain-safety-checks)
- [073. OpenAI launches Daybreak to combat cyber threats](ch12/073-openai-launches-daybreak-to-combat-cyber-threats)
- [074. Disgruntled researcher releases two more Microsoft zero-days](ch12/074-disgruntled-researcher-releases-two-more-microsoft-zero-days)
- [075. Funnel Builder 漏洞正被利用于 WooCommerce 支付 skimming](ch12/075-funnel-builder-woocommerce-skimming)
- [076. The down fall of bug bounties](ch12/076-the-down-fall-of-bug-bounties)
- [077. Mozilla warns UK: Breaking VPNs will not magically fix Britain's age-check mess](ch12/077-mozilla-warns-uk-breaking-vpns-will-not-magically-fix-brita)
- [078. JetBrains Marketplace Ecosystem Security Update: Malicious AI Plugins](ch12/078-jetbrains-marketplace-ecosystem-security-update-malicious-a)
- [079. LLMReaper: 浏览器扩展的对话窃取攻击](ch12/079-llmreaper)
- [080. AI Detection and Response Aidr a Zero Impact Operating Model](ch12/080-ai-detection-and-response-aidr-a-zero-impact-operating-model)
- [081. Exploiting vulnerabilities in Johnson & Johnson web apps](ch12/081-exploiting-vulnerabilities-in-johnson-johnson-web-apps)
...
- [083. Milvus 3.0 聚合下推：3 层隔离、2 条路径、4 倍安全因子](ch12/083-milvus-3-0-3-2-4)
- [084. GitHub Breached — Employee Device Hack Led to Exfiltration of 3,800+ Internal Repos](ch12/084-github-breached-employee-device-hack-led-to-exfiltration-o)
- [085. Getting a CVE Without Shipping Slop](ch12/085-getting-a-cve-without-shipping-slop)
- [086. The IT and security field guide to AI adoption | Tines](ch12/086-the-it-and-security-field-guide-to-ai-adoption-tines)
...
- [088. Mythos for Offensive Security: XBOW's Evaluation](ch12/088-mythos-for-offensive-security-xbow-s-evaluation)
- [089. Fedora Hummingbird brings the container security model to a Linux host OS](ch12/089-fedora-hummingbird-brings-the-container-security-model-to-a)
- [090. GitHub Secret Scanning: AI/ML 驱动的大规模误报降低](ch12/090-github-secret-scanning-ai-ml)
- [091. 飞连 AI 办公安全体系 1+3+N 架构](ch12/091-ai-1-3-n)
- [092. Meet Bluekit: The AI-Powered All-in-One Phishing Kit](ch12/092-meet-bluekit-the-ai-powered-all-in-one-phishing-kit)
- [093. Building is just the beginning: Introducing Discoverability | Lovable](ch12/093-building-is-just-the-beginning-introducing-discoverability)
- [094. Scammers Send Physical Phishing Letters to Steal Ledger Wallet Seed Phrases](ch12/094-scammers-send-physical-phishing-letters-to-steal-ledger-wall)
- [095. Cyberscammers are bypassing banks' security with illicit tools sold on Telegram](ch12/095-cyberscammers-are-bypassing-banks-security-with-illicit-too)
- [096. How Unified EDR and ITDR Stop Attacks Before They Spread](ch12/096-how-unified-edr-and-itdr-stop-attacks-before-they-spread)
- [097. Guide to Security Operations at Machine Speed](ch12/097-guide-to-security-operations-at-machine-speed)
- [098. Discord 全平台端到端加密](ch12/098-discord)
- [099. Nikesh Arora 20VC 访谈：Token 定价、FDE、SaaS→AI 转型与记忆护城河](ch12/099-nikesh-arora-20vc-token-fde-saas-ai)
- [100. Funnel Builder Flaw Under Active Exploitation Enables WooCommerce Checkout Skimming](ch12/100-funnel-builder-flaw-under-active-exploitation-enables-woocom)
- [101. Forward launches Predict to verify network changes before they reach production - SiliconANGLE](ch12/101-forward-launches-predict-to-verify-network-changes-before-th)
- [102. Static Devirtualization of Themida](ch12/102-static-devirtualization-of-themida)
- [103. CyberSecQwen-4B](ch12/103-cybersecqwen-4b)
- [104. Mystery Microsoft bug leaker keeps the zero-days coming](ch12/104-mystery-microsoft-bug-leaker-keeps-the-zero-days-coming)
- [105. GitHub Breached — Employee Device Hack Led to Exfiltration](ch12/105-github-breached-employee-device-hack-led-to-exfiltration)
- [106. AI phishing attacks are on the rise — Are you prepared? | Bitwarden](ch12/106-ai-phishing-attacks-are-on-the-rise-are-you-prepared-bi)
- [107. cPanel, WHM Release Fixes for Three New Vulnerabilities — Patch Now](ch12/107-cpanel-whm-release-fixes-for-three-new-vulnerabilities-pa)
- [108. Semgrep Intercom Php Security](ch12/108-semgrep-intercom-php-security)
- [109. peerd: 浏览器原生的 AI Agent Harness](ch12/109-peerd-ai-agent-harness)
- [110. A DOD contractor’s API flaw exposed military course data and service member records](ch12/110-a-dod-contractor-s-api-flaw-exposed-military-course-data-and)
- [111. OpenSandbox：阿里开源的云端 Agent 安全沙箱（凭据 Vault + egress sidecar）](ch12/111-opensandbox-agent-vault-egress-sidecar)
- [112. Anthropic's bug-hunting Mythos was greatest marketing stunt ever, says cURL creator](ch12/112-anthropic-s-bug-hunting-mythos-was-greatest-marketing-stunt)
- [113. Incendium Fuzzing Ms Rpc](ch12/113-incendium-fuzzing-ms-rpc)
- [114. How Semgrep Cut Taint Analysis Time by 75%](ch12/114-how-semgrep-cut-taint-analysis-time-by-75)
- [115. On Post-Quantum Security Adoption](ch12/115-on-post-quantum-security-adoption)
- [116. Sandworm Hackers Shift From IT Breaches to Critical OT Targets](ch12/116-sandworm-hackers-shift-from-it-breaches-to-critical-ot-targe)
