...
- [015. Disgruntled researcher releases two more Microsoft zero-days](ch12/015-disgruntled-researcher-releases-two-more-microsoft-zero-days)
...
- [024. A 0-click exploit chain for the Pixel 10: When a Door Closes, a Window Opens](ch12/024-a-0-click-exploit-chain-for-the-pixel-10-when-a-door-closes)
...
- [028. Temporarily disabling new user registrations](ch12/028-temporarily-disabling-new-user-registrations)
...
- [039. 飞来汇借助 AWS Security Agent 构建跨境支付应用的智能安全防线](ch12/039-aws-security-agent)
