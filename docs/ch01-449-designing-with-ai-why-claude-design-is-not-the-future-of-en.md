...
## Ch01.449 Designing with AI: Why Claude Design is not the future of enterprise design
...
### 对 [Jim Nielsen 设计哲学](/ch01-616-consistency-but-in-excellence-not-appearance/) 的呼应
...
- [Consistency, But in Excellence](/ch01-616-consistency-but-in-excellence-not-appearance/) — 设计一致性 vs 个体卓越的哲学
- [MCP (Model Context Protocol) — Model Context Protocol 技术规范](/ch01-802-accelerate-llm-model-loading-and-increase-context-windows-wi/)
- [Design Systems — 设计系统理论与实践](/ch04-040-nvidia-extreme-co-design-agentic-systems/)
- 供应商锁定 — 技术供应商锁定的风险与缓解

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/penpot-claude-design-not-future-enterprise.md)
