...
- [AI Native 团队搭建：七层模型与六步演进路线](/ch04-189-ai-native-团队搭建-七层模型与六步演进路线/) — 叶小钗，**框架驱动**（7 层 + 6 步 + L1-L5 + 数字员工）
- 本文 — 实战失败案例驱动（4 痛点 + AI 销售线索分配 + 评价权冲突）
- [范凌：关于 AI 时代组织的 5 个反思](/ch04-347-范凌-当公司变成agent-关于-ai-时代组织的-5-个反思/) — 范凌，特赞 CEO，pod + community 双轨制
- [AI 时代生产力悖论](/ch04-117-agent-时代的生产力悖论-当协作本身成为最大的瓶颈/) — 协作本身成为最大瓶颈
...
电销案例的核心经验不是用了什么 AI 工具，而是"整个公司随着 AI 做了一次改造"——这是真正的 AI 原生。研发案例的局限在于，它只改造了研发协作流程，没有触动产品层和业务层。要达到真正的 AI 原生，需要有勇气去问：**现有流程中哪些是"因为人习惯了就这样"而存在的？这些流程在 AI 时代是否还有必要保留？** 如果答案是否定的，那就需要进入[AI 原生研发组织设计](/ch05-018-ai-native-时代研发组织何去何从/)的更深层思考。
