...
> 原文存档：[原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/varoa-ddosing-software-delivery-pipelines-2026.md)
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/varoa-ddosing-software-delivery-pipelines-2026.md)
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/clickhouse-ingestion-at-scale-an-open-source-zepto-engineering-story.md)

---

## Ch14.003 构建 AI 时代的知识底座：直播数据 LLM Wiki 实践

> 📊 Level ⭐ | 2.3KB | `entities/ai-knowledge-base-llm-wiki-practice-alicloud.md`

> 原文归档：[原文归档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/ai-knowledge-base-llm-wiki-practice-alicloud-2026-06-26.md)
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/aliyun-kafka-iceberg-zero-etl-architecture-subtraction-2026-06-18.md)
...
> → [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/good-qc-for-rl-data.md)
...
- → [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/kimi-k2-6-tidb-agent-database.md)
- → [Hermes + Kimi K2.6 多智能体军团](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/hermes-agent-k2-6-multi-agent.md)
- → [Karpathy: Vibe Coding → Agentic Engineering](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/karpathy-vibe-coding-to-agentic-engineering.md)
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/databricks-storage-ecosystem-opensharing-govern-everything-2026.md)

---

## Ch14.010 London's police asked Big Tech for comms data over 700,000 times last year
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/london-met-police-big-tech-data-requests.md)
...
## Ch14.011 AI-Enhanced Data Solutions with Database 26ai
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/ai-enhanced-data-solutions-with-database-26ai.md)
...
## Ch14.012 EVA-Bench Data 2.0: 3 Domains, 121 Tools, 213 Scenarios

> 📊 Level ⭐⭐ | 9.8KB | `entities/eva-bench-data-2-voice-agent-evaluation.md`

# EVA-Bench Data 2.0: 3 Domains, 121 Tools, 213 Scenarios

→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/eva-bench-data-2-voice-agent-evaluation.md)
...
## Ch14.013 LiveKit Agents 语音 AI 框架工程解析
...
## Ch14.014 Moneyball for Physical AI
...
## Ch14.015 Lightfield AI pipeline generation

> 📊 Level ⭐⭐ | 8.1KB | `entities/lightfield-ai-pipeline-generation.md`

> → [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/lightfield-ai-pipeline-generation.md)
...
## Ch14.016 Amazon Quick: Accelerating the path from enterprise data to AI-powered decisions

> 📊 Level ⭐⭐ | 7.9KB | `entities/amazon-quick-accelerating-the-path-from-enterprise-data-to-ai-powered-decisions.md`

> -> [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/amazon-quick-accelerating-the-path-from-enterprise-data-to-ai-powered-decisions.md)
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/verify-data-agent-skill-data-validation.md)
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/livekit-agents-voice-ai-streaming-cascade-interruption-detection.md)

---

## Ch14.019 Goodfire Predictive Data Debugging：可解释性指导 Post-Training 数据塑形
...
## 引用与延伸阅读
- **原文存档** → [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/goodfire-predictive-data-debugging-post-training-anatomy-2026.md)
...
## Ch14.020 基于 Amazon Kinesis Data Streams 实现 DynamoDB 历史数据清理

> 📊 Level ⭐⭐ | 6.7KB | `entities/基于-amazon-kinesis-data-streams-实现-dynamodb-历史数据清理与增量同步.md`

> -> [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/基于-amazon-kinesis-data-streams-实现-dynamodb-历史数据清理与增量同步.md)
...
**来源**: → [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/stop-giving-your-agents-database-credentials.md)

---

## Ch14.022 AI 驱动的大数据工程：从平台驱动到 AIDLC 的范式迁移
...
## Ch14.023 Amazon Redshift 推出集成数据湖查询引擎的 Graviton RG 实例
...
## Ch14.024 SQL NOT IN 与 NULL 的经典陷阱：De Morgan 定律到解析器行为
...
## Ch14.025 GitHub Multilingual Repositories Dataset — 4000 万仓库多语言元数据
...
> Source: [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/github-blog-multilingual-ai-open-dataset.md)
...
## Ch14.027 Databend — 开源云原生湖仓（Snowflake-like），面向 AI 的多模态一体化数仓
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/databend-on-aws-ai-multimodal-lakehouse-2026.md)
...
> 📊 Level ⭐⭐ | 4.1KB | `entities/turning-scattered-data-into-queryable-segments-at-scale-how.md`
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/turning-scattered-data-into-queryable-segments-at-scale-how.md)

---

## Ch14.029 Transforming rare cancer research with Amazon Quick: Integrating biomedical databases for breakthrough discoveries
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/transforming-rare-cancer-research-with-amazon-quick-integrat.md)
...
> 📊 Level ⭐⭐ | 4.0KB | `entities/kafka-share-groups-pathological-fetch-waits-with-record-limi.md`
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/kafka-share-groups-pathological-fetch-waits-with-record-limi.md)

---

## Ch14.031 Amazon Quick integration with time-series databases for market intelligence using MCP
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/amazon-quick-mcp-kdbx-time-series.md)
...
## Ch14.032 Metric Semantic Layer: How Lyft Governs and Scales Key Data Definitions
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/metric-semantic-layer-how-lyft-governs-and-scales-key-data-definitions.md)

---

## Ch14.033 Write-Ahead Intent Log: a Foundation for Efficient CDC at Scale
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/write-ahead-intent-log-a-foundation-for-efficient-cdc-at-scale.md)

---

## Ch14.034 The Data Operating System for the Foundation Model Era — Data Juicer
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/the-data-operating-system-for-the-foundation-model-era-data-juicer.md)

---

## Ch14.035 ai 驱动的大数据工程 从平台驱动到 aidlc 的范式迁移
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/ai-驱动的大数据工程-从平台驱动到-aidlc-的范式迁移.md)
