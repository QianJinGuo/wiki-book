...
- [How Far Behind Are Open Models 2026](ch01/206-0.md)
...
- [Fine-tune LLM with Databricks Unity Catalog and Amazon SageMaker AI](ch01/552-fine-tune-llm-with-databricks-unity-catalog-and-amazon-sagem.md) — 同 vendor 不同焦点（ML 训练 vs 数据治理）
...
- [DiffusionGemma](ch01/206-0.md) — 生成模型与分数估计
...
本文聚焦**级联打断检测**这一细分能力，与 [LiveKit Agents 语音 AI 框架工程解析](ch04/150-ai.md) 互补——后者侧重完整架构对比（如与 OpenAI Realtime API 的横评），本文深耕流式管线与语义打断的工程细节。语音 AI 领域的竞品包括 [Amazon Nova Sonic 实时语音方案](ch03/045-agent.md)，后者采用统一语音到语音架构而非级联管线。
...
- [aws graviton5 m9g/m9gd 实例 ga 公告](ch01/206-0.md)
