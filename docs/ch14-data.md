...
## Ch14.015 Moneyball for Physical AI
...
## Ch14.017 Amazon Quick: Accelerating the path from enterprise data to AI-powered decisions
...
## Ch14.018 verify-data：一个端到端的数据验数 Agent Skill
...
## Ch14.019 LiveKit Agents：给大模型接上麦克风，没你想的那么简单
...
## Ch14.021 基于 Amazon Kinesis Data Streams 实现 DynamoDB 历史数据清理
...
## Ch14.022 Stop Giving Your Agents Database Credentials — Agent Data Governance Patterns
...
## Ch14.023 AI 驱动的大数据工程：从平台驱动到 AIDLC 的范式迁移
...
## Ch14.024 Amazon Redshift 推出集成数据湖查询引擎的 Graviton RG 实例
...
## Ch14.025 SQL NOT IN 与 NULL 的经典陷阱：De Morgan 定律到解析器行为
...
## Ch14.026 GitHub Multilingual Repositories Dataset — 4000 万仓库多语言元数据
...
## Ch14.027 DataComp for Language Models
...
## Ch14.028 Databend — 开源云原生湖仓（Snowflake-like），面向 AI 的多模态一体化数仓
...
## Ch14.030 Transforming rare cancer research with Amazon Quick: Integrating biomedical databases for breakthrough discoveries
...
## Ch14.032 Amazon Quick integration with time-series databases for market intelligence using MCP
...
## Ch14.036 ai 驱动的大数据工程 从平台驱动到 aidlc 的范式迁移
