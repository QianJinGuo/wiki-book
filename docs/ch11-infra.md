...
- [059. Amazon Nova Lite Fine-Tuning: 高性价比的视觉检测模型微调案例与实践 | 亚马逊AWS官方博客](ch11/059-amazon-nova-lite-fine-tuning-aws)
...
- [061. AgentCore Payments 与代理商务创新：技术深度解析](ch11/061-agentcore-payments)
- [062. Client-Side Load Balancing at a Million Requests Per Second](ch11/062-client-side-load-balancing-at-a-million-requests-per-second)
...
- [065. Netflix Switchboard → Lightbulb: 百万请求/秒 ML 模型路由架构演进](ch11/065-netflix-switchboard-lightbulb-ml)
...
- [067. From PDFs to insights: Architecting an intelligent document processing pipeline with AWS generative AI services](ch11/067-from-pdfs-to-insights-architecting-an-intelligent-document)
