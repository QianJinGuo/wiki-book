...
## Ch01.367 Anthropic发布「AI原生创业公司」手册：涵盖全流程四大核心阶段，一人公司法典来了
...
## 相关页面
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/anthropic-ai-native-startup-handbook.md)
→ [Skill 写作基础指南](/ch04-163-从-0-到-1-教你写-agent-skill-让-ai-懂你的-潜规则/) — 与 Agent/Harness 工作流构建相关
→ [Skill 写作进阶指南](/ch01-319-agent-skill-进阶模式与治理/) — 更深入的实践方法
...
Cowork 是手册中最值得关注的工具形态——它是 Chat 和 Code 之间的中间态，专门针对"耗时的知识工作"。这与 [CLAUDE Code 100 条规则](/ch01-487-最新claude-code创始人-编程已经解决了-harness重要性持续降低-cc未来只有100行代码/) 中倡导的"研究伙伴"角色高度一致。
...
- [Claude Code Hiring Engineers](/ch09-047-claude-code-agent-teams-架构分析/)
- MOC
