...
### 4. 渐进式细节加载架构
Skill 文件结构支持主文件和支撑文件的分离：主 SKILL.md 保持精简（快速加载），支撑文件通过 markdown link 按需引入（[View palette](../ch03-./colors)）。这种架构让 skill 可包含深度细节而不影响触发性能。
...
- Lovable Discoverability 介绍

- [Claude Code Skills 超能力实战](../ch01-408-claude-code-skills-superpowers-practice)
- [Anthropic Agent Skills 设计模式14条](../ch01-677-anthropic)
- [Matt Pocock Skills Grill](../ch07-033-matt-pocock-skills-ai编程技能集合)
