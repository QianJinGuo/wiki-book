...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/how-to-encode-experience-into-skills.md)

## 相关实体

- [Agent Skill Writing Practices — Skill 写作规范与模式](/ch04-242-agent-skill-高质量编写规范/)
- [AI Skill 进化框架 — Skill 沉淀与持续优化](/ch07-010-ai-skill-evolution底层逻辑/)
- [Agent Skill Writing — Skill 基础框架](/ch04-498-skillclaw-nacos-从一次-agent-会话到可治理-skill-registry-的自动演化闭环/)
