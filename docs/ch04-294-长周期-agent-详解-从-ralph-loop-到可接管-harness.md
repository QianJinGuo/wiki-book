...
## Ch04.294 长周期-agent-详解-从-ralph-loop-到可接管-harness
...
- [Long Running Agent Ralph Loop Handover Harness Ruofei](/ch05-012-长周期-agent-详解-从-ralph-loop-到可接管-harness/)
- [Agent Harness Architecture Deep Dive Aksahy](/ch01-316-agent-harness-解析-智能体架构深度拆解/)
