...
- [057. 翁荔再写万字长文：AI自我改进，先从Harness开始](ch05/057-ai-harness)
- [058. Devin Fusion: 多模型路由 Harness 实现 35% 成本降低](ch05/058-devin-fusion-harness-35)
- [059. Harness Engineering：AI 能在真正\"出事会炸\"的后端系统里写代码吗？](ch05/059-harness-engineering-ai)
- [060. Trellis vs Superpowers 源码对比：不同抽象层的工程框架](ch05/060-trellis-vs-superpowers)
- [061. OMEGA: 面向多机器人协作的具身Agent Harness](ch05/061-omega-agent-harness)
- [062. 腾讯 AI Team 知识沉淀体系（Harness Engineering 实践）](ch05/062-ai-team-harness-engineering)
- [063. Loop Engineering 会是 AI 的下个关键词吗？](ch05/063-loop-engineering-ai)
...
- [084. Harness 工程之道：Skill 原理与最佳实践](ch05/084-harness-skill)
- [085. Superpowers 深度解析：给 Claude Code 装上工程大脑](ch05/085-superpowers-claude-code)
- [086. AI 原生组织方法论：叶小钗的完整框架与实战](ch05/086-ai)
...
- [089. Karpathy AutoResearch Loop Cycle & Harness Optimization](ch05/089-karpathy-autoresearch-loop-cycle-harness-optimization)
- [090. SEAGym: 自进化Agent评测环境 — 清华大学](ch05/090-seagym-agent)
- [091. Cloudflare Copy Fail Linux 内核漏洞应急响应](ch05/091-cloudflare-copy-fail-linux)
- [092. Harness 工程 2026 年度调研](ch05/092-harness-2026)
...
- [099. 规格驱动开发与 Harness](ch05/099-harness)
- [100. 场景营销前端 AI Coding — 从问题到方案](ch05/100-ai-coding)
- [101. Harness Engineering Deletable Worksite Ruofei](ch05/101-harness-engineering-deletable-worksite-ruofei)
- [102. 开启Harness Engineering探索之旅](ch05/102-harness-engineering)
- [103. 从渐进式 SDD 到 Lattice Harness：AI Coding 团队级闭环实践](ch05/103-sdd-lattice-harness-ai-coding)
- [104. How I Cut an AI Agent's Token Use by 94% — 将 Skill 从自然语言编译为确定性代码](ch05/104-how-i-cut-an-ai-agent-s-token-use-by-94-skill)
- [105. 开启Harness Engineering探索之旅](ch05/105-harness-engineering)
- [106. 从 Vibe Coding 到 Harness Engineering：小米 JDK21 升级中可控演进的 AI 工程实践](ch05/106-vibe-coding-harness-engineering-jdk21-ai)
- [107. Harness Engineering：AI 能在真正"出事会炸"的后端系统里写代码吗？](ch05/107-harness-engineering-ai)
- [108. Loss Function Development (LFD) — 损失函数开发与 /goal 循环（Elvis Sun）](ch05/108-loss-function-development-lfd-goal-elvis-sun)
- [109. Harness 工程实践复盘：100% Cache 命中的 Agent 怎么设计？](ch05/109-harness-100-cache-agent)
- [110. DIPG 蚂蚁保 Host-Research-Verify 三 Agent 离线 verify 闭环：C 端 AIGC 工程化范式](ch05/110-dipg-host-research-verify-agent-verify-c-aigc)
- [111. Harness Engineering 从理论到实战：行为正确性死结 + 上下文腐烂 + 可驾驭性 + Ashby 定律](ch05/111-harness-engineering-ashby)
- [112. Harness Engineering 四根支柱与四要素架构](ch05/112-harness-engineering)
- [113. Claude Harness 设计：Generator-Evaluator 架构与 Context Reset 演进](ch05/113-claude-harness-generator-evaluator-context-reset)
- [114. Harness不是目的，知识才是护城河 —— 一个AI工程交付团队的知识沉淀实践](ch05/114-harness-ai)
- [115. 墙比模型更重要：Stripe Minions + 字节 DeerFlow 2.0 + 蚂蚁支小助 的同结论](ch05/115-stripe-minions-deerflow-2-0)
- [116. Harness 工程可视化：Vibe Coding 中重建工程可控性](ch05/116-harness-vibe-coding)
- [117. 为什么 2026 年真正重要的是 Harness Engineering？](ch05/117-2026-harness-engineering)
- [118. 知识沉淀是护城河](ch05/118-page-118)
- [119. 应用宝活动平台 Harness 工程实践——从对话式 AI Coding 到工程化系统](ch05/119-harness-ai-coding)
- [120. Better-Harness：Agent Harness 自动优化方法论](ch05/120-better-harness-agent-harness)
- [121. Cloud Use 框架：Agent 作为云上受治理主体的四层模型](ch05/121-cloud-use-agent)
- [122. Superpowers 6.0 反作弊重写：reviewer 只读怀疑论者 + 上下文经济学 + progress ledger + model 纪律 —— 术哥源码级拆解 158 commits](ch05/122-superpowers-6-0-reviewer-progress-ledger-model)
- [123. Code is cheap: Harness 方法论——水流理论、最小混沌单元与反 slop](ch05/123-code-is-cheap-harness-slop)
- [124. HSCodeComp：阿里 ACL 2026 最佳资源论文——层级规则应用 Agent 基准](ch05/124-hscodecomp-acl-2026-agent)
- [125. 阿里 Harness 工程实战：Agent 自主迭代 17 小时优化业务 Agent](ch05/125-harness-agent-17-agent)
- [126. MoonBit：面向 Agent 协作的编程语言（语言即工具链 + 形式化验证 + Wasm 沙箱）](ch05/126-moonbit-agent-wasm)
- [127. browser-use v0.13 Browser Harness：薄抽象层设计哲学](ch05/127-browser-use-v0-13-browser-harness)
- [128. Harness进化论文 — M⋆记忆程序进化与AutoHarness动作约束](ch05/128-harness-m-autoharness)
