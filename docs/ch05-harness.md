...
- [053. 腾讯 AI Team 知识沉淀体系（Harness Engineering 实践）](ch05/053-ai-team-harness-engineering)
- [054. Harness Engineering for Self-Improvement — 翁荔 Lilian Weng 系统梳理 Harness 自我提升研究全景](ch05/054-harness-engineering-for-self-improvement-lilian-weng-h)
- [055. Harness Engineering Deletable Worksite Ruofei](ch05/055-harness-engineering-deletable-worksite-ruofei)
- [056. 开启Harness Engineering探索之旅](ch05/056-harness-engineering)
- [057. WorkBuddy 产品实践：从模型到 Harness 的 Agent 可用产品架构](ch05/057-workbuddy-harness-agent)
- [058. Harness Engineering 的未来——什么会消失，什么不会](ch05/058-harness-engineering)
- [059. 从零复刻 Claude Code：Harness 构建学习笔记](ch05/059-claude-code-harness)
- [060. 从渐进式 SDD 到 Lattice Harness：AI Coding 团队级闭环实践](ch05/060-sdd-lattice-harness-ai-coding)
- [061. Harness Engineering：快手电商用 AI 流水线重塑研发范式（需求全生命周期自动化交付）](ch05/061-harness-engineering-ai)
- [062. GSD 完胜 OpenSpec 和 Superpowers？源码拆完发现：三者防的是 context rot 的三道防线](ch05/062-gsd-openspec-superpowers-context-rot)
- [063. Engineering roles shift from developing code to managing AI](ch05/063-engineering-roles-shift-from-developing-code-to-managing-ai)
- [064. 清华大学：驾驭工程 (Harness Engineering) 研究报告](ch05/064-harness-engineering)
- [065. Agent Harness Skill 系统实战指南 — Reference/Action 类型、动态注入与 frontmatter 全解](ch05/065-agent-harness-skill-reference-action-frontmatter)
- [066. 全球首个完全AI编写的训练框架：面壁ForgeTrain速度反超英伟达Megatron，年底要把国产算力软件重写一遍](ch05/066-ai-forgetrain-megatron)
- [067. Thin Harness, Fat Skills：AI工程架构的本质](ch05/067-thin-harness-fat-skills-ai)
- [068. Skill Factory：三天手搓面向Harness设计的技能工厂](ch05/068-skill-factory-harness)
- [069. Harness 工程之道：Skill 原理与最佳实践](ch05/069-harness-skill)
- [070. 腾讯 TAB Harness 全链路实战：从 Vibe Coding 到 13 阶段接力赛](ch05/070-tab-harness-vibe-coding-13)
- [071. Karpathy AutoResearch Loop Cycle & Harness Optimization](ch05/071-karpathy-autoresearch-loop-cycle-harness-optimization)
- [072. Superpowers 深度解析：给 Claude Code 装上工程大脑](ch05/072-superpowers-claude-code)
- [073. 去哪儿网 AI Coding 研发平台实践：L0-L5 自动化分级 + Harness 四把锁 + QunarDevCenter + 天弦 QDO](ch05/073-ai-coding-l0-l5-harness-qunardevcenter-qdo)
- [074. Cloudflare Copy Fail Linux 内核漏洞应急响应](ch05/074-cloudflare-copy-fail-linux)
- [075. Build a serverless image editing agent with Amazon Bedrock AgentCore harness](ch05/075-build-a-serverless-image-editing-agent-with-amazon-bedrock-a)
- [076. Beyond Vibe Coding — Directed Generation as Design Methodology](ch05/076-beyond-vibe-coding-directed-generation-as-design-methodolo)
- [077. 快手 AgentX——推荐系统自我迭代的 Agent 驱动研发闭环](ch05/077-agentx-agent)
- [078. 场景营销前端 AI Coding — 从问题到方案](ch05/078-ai-coding)
- [079. Harness Engineering：AI 能在真正"出事会炸"的后端系统里写代码吗？](ch05/079-harness-engineering-ai)
- [080. Loss Function Development (LFD) — 损失函数开发与 /goal 循环（Elvis Sun）](ch05/080-loss-function-development-lfd-goal-elvis-sun)
- [081. DIPG 蚂蚁保 Host-Research-Verify 三 Agent 离线 verify 闭环：C 端 AIGC 工程化范式](ch05/081-dipg-host-research-verify-agent-verify-c-aigc)
- [082. Harness 工程实践复盘：100% Cache 命中的 Agent 怎么设计？](ch05/082-harness-100-cache-agent)
- [083. Harness Engineering 从理论到实战：行为正确性死结 + 上下文腐烂 + 可驾驭性 + Ashby 定律](ch05/083-harness-engineering-ashby)
- [084. Claude Harness 设计：Generator-Evaluator 架构与 Context Reset 演进](ch05/084-claude-harness-generator-evaluator-context-reset)
- [085. Harness Engineering 四根支柱与四要素架构](ch05/085-harness-engineering)
- [086. Harness不是目的，知识才是护城河 —— 一个AI工程交付团队的知识沉淀实践](ch05/086-harness-ai)
- [087. 墙比模型更重要：Stripe Minions + 字节 DeerFlow 2.0 + 蚂蚁支小助 的同结论](ch05/087-stripe-minions-deerflow-2-0)
- [088. Harness 工程可视化：Vibe Coding 中重建工程可控性](ch05/088-harness-vibe-coding)
- [089. 应用宝活动平台 Harness 工程实践——从对话式 AI Coding 到工程化系统](ch05/089-harness-ai-coding)
- [090. Superpowers 6.0 反作弊重写：reviewer 只读怀疑论者 + 上下文经济学 + progress ledger + model 纪律 —— 术哥源码级拆解 158 commits](ch05/090-superpowers-6-0-reviewer-progress-ledger-model)
- [091. Cloud Use 框架：Agent 作为云上受治理主体的四层模型](ch05/091-cloud-use-agent)
- [092. Code is cheap: Harness 方法论——水流理论、最小混沌单元与反 slop](ch05/092-code-is-cheap-harness-slop)
- [093. browser-use v0.13 Browser Harness：薄抽象层设计哲学](ch05/093-browser-use-v0-13-browser-harness)
- [094. HSCodeComp：阿里 ACL 2026 最佳资源论文——层级规则应用 Agent 基准](ch05/094-hscodecomp-acl-2026-agent)
- [095. MoonBit：面向 Agent 协作的编程语言（语言即工具链 + 形式化验证 + Wasm 沙箱）](ch05/095-moonbit-agent-wasm)
