...
- [103. 开启Harness Engineering探索之旅](ch05/103-harness-engineering)
- [104. 从渐进式 SDD 到 Lattice Harness：AI Coding 团队级闭环实践](ch05/104-sdd-lattice-harness-ai-coding)
- [105. How I Cut an AI Agent's Token Use by 94% — 将 Skill 从自然语言编译为确定性代码](ch05/105-how-i-cut-an-ai-agent-s-token-use-by-94-skill)
- [106. 开启Harness Engineering探索之旅](ch05/106-harness-engineering)
- [107. 从 Vibe Coding 到 Harness Engineering：小米 JDK21 升级中可控演进的 AI 工程实践](ch05/107-vibe-coding-harness-engineering-jdk21-ai)
- [108. Harness Engineering：AI 能在真正"出事会炸"的后端系统里写代码吗？](ch05/108-harness-engineering-ai)
- [109. Loss Function Development (LFD) — 损失函数开发与 /goal 循环（Elvis Sun）](ch05/109-loss-function-development-lfd-goal-elvis-sun)
- [110. Harness 工程实践复盘：100% Cache 命中的 Agent 怎么设计？](ch05/110-harness-100-cache-agent)
- [111. DIPG 蚂蚁保 Host-Research-Verify 三 Agent 离线 verify 闭环：C 端 AIGC 工程化范式](ch05/111-dipg-host-research-verify-agent-verify-c-aigc)
- [112. Harness Engineering 从理论到实战：行为正确性死结 + 上下文腐烂 + 可驾驭性 + Ashby 定律](ch05/112-harness-engineering-ashby)
- [113. Harness Engineering 四根支柱与四要素架构](ch05/113-harness-engineering)
- [114. Claude Harness 设计：Generator-Evaluator 架构与 Context Reset 演进](ch05/114-claude-harness-generator-evaluator-context-reset)
- [115. Harness不是目的，知识才是护城河 —— 一个AI工程交付团队的知识沉淀实践](ch05/115-harness-ai)
- [116. 墙比模型更重要：Stripe Minions + 字节 DeerFlow 2.0 + 蚂蚁支小助 的同结论](ch05/116-stripe-minions-deerflow-2-0)
- [117. Harness 工程可视化：Vibe Coding 中重建工程可控性](ch05/117-harness-vibe-coding)
- [118. 为什么 2026 年真正重要的是 Harness Engineering？](ch05/118-2026-harness-engineering)
- [119. 知识沉淀是护城河](ch05/119-page-119)
- [120. 应用宝活动平台 Harness 工程实践——从对话式 AI Coding 到工程化系统](ch05/120-harness-ai-coding)
- [121. Better-Harness：Agent Harness 自动优化方法论](ch05/121-better-harness-agent-harness)
- [122. Cloud Use 框架：Agent 作为云上受治理主体的四层模型](ch05/122-cloud-use-agent)
- [123. Superpowers 6.0 反作弊重写：reviewer 只读怀疑论者 + 上下文经济学 + progress ledger + model 纪律 —— 术哥源码级拆解 158 commits](ch05/123-superpowers-6-0-reviewer-progress-ledger-model)
- [124. Code is cheap: Harness 方法论——水流理论、最小混沌单元与反 slop](ch05/124-code-is-cheap-harness-slop)
- [125. HSCodeComp：阿里 ACL 2026 最佳资源论文——层级规则应用 Agent 基准](ch05/125-hscodecomp-acl-2026-agent)
- [126. 阿里 Harness 工程实战：Agent 自主迭代 17 小时优化业务 Agent](ch05/126-harness-agent-17-agent)
- [127. MoonBit：面向 Agent 协作的编程语言（语言即工具链 + 形式化验证 + Wasm 沙箱）](ch05/127-moonbit-agent-wasm)
- [128. browser-use v0.13 Browser Harness：薄抽象层设计哲学](ch05/128-browser-use-v0-13-browser-harness)
- [129. Harness进化论文 — M⋆记忆程序进化与AutoHarness动作约束](ch05/129-harness-m-autoharness)
