...
- [022. AI 生产开发工作流：OpenSpec 规范驱动 + Superpowers 工具链](ch05/022-ai-openspec-superpowers)
- [023. Martin Fowler AI 研发 Harness：非确定性承重层](ch05/023-martin-fowler-ai-harness)
- [024. AI Friendly 架构设计：后端系统面向无人值守开发时代的标准与路径](ch05/024-ai-friendly)
...
- [043. Trellis vs Superpowers 源码对比：不同抽象层的工程框架](ch05/043-trellis-vs-superpowers)
- [044. Martin Fowler 的 AI 研发提醒：非确定性进了研发链路，Harness 才真正开始承重](ch05/044-martin-fowler-ai-harness)
- [045. SkillOpt](ch05/045-skillopt)
- [046. Harness Engineering 概念框架](ch05/046-harness-engineering)
...
- [083. Engineering roles shift from developing code to managing AI](ch05/083-engineering-roles-shift-from-developing-code-to-managing-ai)
- [084. 清华大学：驾驭工程 (Harness Engineering) 研究报告](ch05/084-harness-engineering)
- [085. Agent Harness Skill 系统实战指南 — Reference/Action 类型、动态注入与 frontmatter 全解](ch05/085-agent-harness-skill-reference-action-frontmatter)
- [086. 全球首个完全AI编写的训练框架：面壁ForgeTrain速度反超英伟达Megatron，年底要把国产算力软件重写一遍](ch05/086-ai-forgetrain-megatron)
- [087. Claude Code 多 Agent Harness 源码拆解：留纸条、抠上下文、抠缓存、捆手脚](ch05/087-claude-code-agent-harness)
- [088. Thin Harness, Fat Skills：AI工程架构的本质](ch05/088-thin-harness-fat-skills-ai)
- [089. GSD 完胜 OpenSpec 和 Superpowers？源码拆完发现：三者防的是 context rot 的三道防线](ch05/089-gsd-openspec-superpowers-context-rot)
...
- [108. 快手 AgentX——推荐系统自我迭代的 Agent 驱动研发闭环](ch05/108-agentx-agent)
- [109. 驾驭AI Coding：面向团队的Harness Engineering落地规范](ch05/109-ai-coding-harness-engineering)
- [110. Loop Engineering，应该赞成还是反对？](ch05/110-loop-engineering)
- [111. MIT CSAIL RLM: Harness-Driven Length Generalization — 64K to 2M Tokens](ch05/111-mit-csail-rlm-harness-driven-length-generalization-64k-to)
- [112. 黄仁勋 × Harrison Chase 对话：未来公司将建立在 Harness 之上](ch05/112-harrison-chase-harness)
- [113. DataFlow-Harness — 北大 Code Agent 数据处理管线 Harness](ch05/113-dataflow-harness-code-agent-harness)
- [114. Harness 工程 2026 年度调研](ch05/114-harness-2026)
...
- [137. HSCodeComp：阿里 ACL 2026 最佳资源论文——层级规则应用 Agent 基准](ch05/137-hscodecomp-acl-2026-agent)
- [138. MoonBit：面向 Agent 协作的编程语言（语言即工具链 + 形式化验证 + Wasm 沙箱）](ch05/138-moonbit-agent-wasm)
- [139. 阿里 Harness 工程实战：Agent 自主迭代 17 小时优化业务 Agent](ch05/139-harness-agent-17-agent)
