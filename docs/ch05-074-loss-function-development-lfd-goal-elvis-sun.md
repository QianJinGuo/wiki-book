...
- [Hermes Agent Goal Runtime Architecture State Persistence Judge Closed Loop](/ch04-365-hermes-agent-goal-长任务运行时架构拆解-状态持久化-judge-闭环与自主续航/)（Hermes Agent Goal runtime 对照）
...
- [Hermes Agent Goal And Kanban](/ch01-592-hermes-agent-v0-13-goal-目标管理与-kanban-多-agent-协作/)（Hermes Goal + Kanban 对照）
...
- [Good Qc For Rl Data（RL 数据质量对照 — 强制熵的同源思想）](/ch01-667-architecture-data-foundations-for-ai-powered-search/)
