...
- [Nvidia Agentic Ai Subsurface Engineering](ch04/338-nvidia-agentic-ai-subsurface-engineering.md)
- [Nvidia Secure Local Agent Nemoclaw Openclaw](ch04/363-nvidia-secure-local-agent-nemoclaw-openclaw.md)
- [Nvidia Telco Reasoning Models Nemo](ch01/257-nvidia-telco-reasoning-models-nemo.md)
...
与 [Karpathy LLM Wiki V2 中文概述](ch01/216-0.md) 互补——原 entity 是中文入门解读，本文是 V2 深度技术分析 + 落地路线图 + 评测方法论。
...
- → [Karpathy LLM Wiki V2 中文概述](ch01/216-0.md) — 原版入门
...
- → [LLM Wiki 架构哲学](ch01/1171-llm.md)
...
- → [Mem0：Agent Harness 记忆现状](ch05/009-harness.md) — Mem0 等基线对比
...
- [Agent Harness Architecture Design Production Guide](ch05/009-harness.md)
...
- [the next generation of speculative decoding: dflash and spec](ch01/216-0.md)
