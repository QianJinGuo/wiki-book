...
## Ch10.001 【实践教程】真实AI客服落地全流程：意图识别、混合检索到数据飞轮
...
## Ch10.002 Nvidia Multimodal RAG Knowledge Systems
...
- [Nvidia Extreme Co Design Agentic Systems](ch04/088-nvidia-extreme-co-design-agentic-systems.html)
- [Nvidia Agentic Ai Subsurface Engineering](ch04/184-nvidia-agentic-ai-subsurface-engineering.html)
...
## Ch10.003 Manufacturing Intelligence with Amazon Nova Multimodal Embeddings
...
## Ch10.004 SkillCorpus: 大规模社区 Skill 生态的筛选、评测与边界分析

> 📊 Level ⭐⭐⭐ | 9.6KB | `entities/skillcorpus-consolidating-open-skill-ecosystem.md`
...
这正与 [Regression Tax](https://github.com/QianJinGuo/wiki-public/blob/main/entities/regression-tax-skills-hurt-llm-agents.md) 一类实证发现（技能有时反而拖累 agent）互为印证：既然质量分来自文本判断，它与真实表现的偏离就系统性存在，且方向可正可负。要闭合它，靠的不是更高的打分精度，而是把执行结果（是否被校验、是否被修正、最终是否成功）回灌为排序与门禁依据，即从「文档质量分」转向「行为置信度」——这也呼应了 [Harness Engineering](ch05/019-harness-engineering.html) 把执行闭环当作一等公民的思路。
...
- [Architecture Data Foundations For Ai Powered Search](ch01/328-architecture-data-foundations-for-ai-powered-search.html)
- [Rag技术框架的演进方向](https://github.com/QianJinGuo/wiki-public/blob/main/entities/rag技术框架的演进方向.md)
- [Skill Rag Tsinghua Sra](https://github.com/QianJinGuo/wiki-public/blob/main/entities/skill-rag-tsinghua-sra.md)
- [Harness Engineering Framework](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/harness-engineering-framework.md)
...
> Source: [第2原文存档](https://mp.weixin.qq.com/s/jBA-D_YJXecXCk-Ltt-ogg)
...
→ [第2原文存档](https://mp.weixin.qq.com/s/jBA-D_YJXecXCk-Ltt-ogg)

## 第 3 来源 — VibeCoder「SAG 知识引擎：用 SQL 做 RAG」(Vibe编码, 2026-06-17)

> Source: [第3原文存档](https://mp.weixin.qq.com/s/gB9MpJaHA1nK7pNUBJ0luw)
...
→ [第4原文存档](https://aws.amazon.com/blogs/machine-learning/hipporag-neurobiologically-inspired-rag-using-amazon-bedrock-amazon-neptune-and-personalized-pagerank)
...
→ [原文存档](https://huggingface.co/blog/ettin-reranker)
