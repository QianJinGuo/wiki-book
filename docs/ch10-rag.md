...
[向量库是Rag的前菜知识图谱是答案本体论是灵魂](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/向量库是rag的前菜知识图谱是答案本体论是灵魂.md)
...
→ [第4原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/hipporag-neurobiologically-inspired-rag-using-amazon-bedrock.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/nvidia-multimodal-rag-knowledge-systems.md)
...
→ [原文存档：分块向量化召回重排](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/rag-chunking-vectorization-rerank-distillation.md)
→ [原文存档：全链路技术详解](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/rag-full-pipeline-taobao.md)
→ [原文存档：流水线](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/rag-chunk-embedding-rerank-pipeline.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/amazon-nova-manufacturing-intelligence.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/rag-chunk-embedding-rerank-pipeline.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/mragent-memory-reconstructed-not-retrieved-nus-icml2026.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/www-2026-rag黑箱被打开opendecoder把文档质量写进解码.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/instacart-ads-retrieval-generative-token-by-token.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/实践教程真实ai客服落地全流程意图识别混合检索到数据飞轮.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/how-we-built-smithdb-s-inverted-index-for-full-text-search.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/common-crawl-blog-host-and-domain-level-web-graphs-april-may.md)

---

## Ch10.023 向量库是RAG的前菜，知识图谱是答案，本体论是灵魂
...
> 📊 Level ⭐⭐ | 3.5KB | `entities/powering-scientific-discovery-byokg-and-graphrag-for-intelli.md`

# Powering scientific discovery: BYOKG and GraphRAG for intelligent pharmaceutical research

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/powering-scientific-discovery-byokg-and-graphrag-for-intelli.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/graphrag-needed-aws-9-rag-comparison-2026.md)

---

## Ch10.026 3 倍于 VectorDBBench 榜首，火山 Milvus 如何把向量检索拉到新高度
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/3-倍于-vectordbbench-榜首火山-milvus-如何把向量检索拉到新高度.md)

## 第 2 Source — 字节跳动技术团队

> From WeChat MP 字节跳动技术团队, supplemental coverage of the same topic.

-> [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/3-倍于-vectordbbench-榜首火山-milvus-如何把向量检索拉到新高度-2026-07-08.md)

---

## Ch10.027 怎么短平快地把RAG做好：厦门国际银行数创金融杯RAG初赛方案

> 📊 Level ⭐⭐ | 2.7KB | `entities/xiamen-bank-rag-competition-financial-regulation-trustrag.md`

## 核心概述

厦门国际银行第五届数创金融杯大模型应用挑战赛初赛方案分享。该赛题为金融监管制度智能问答（经典RAG），基于给定金融文档库生成准确合规的答案，题型包括不定项选择题和问答题。硬件限制：CPU 8核 / 32G内存 / 24G显存。作者10天冲到top10。

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/xiamen-bank-rag-competition-financial-regulation-trustrag.md)
