...
## Ch07.046 SkillOpt — 微软训练 Skill 文档的方法论
...
- [Claude Design Skill](036-claude-design-skill.html)
...
- [Qoder Skill Ui Agent Human Collaboration](https://github.com/QianJinGuo/wiki-public/blob/main/entities/qoder-skill-ui-agent-human-collaboration.md)
