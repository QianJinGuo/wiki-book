...
## 相关对照
- [OpenSquilla](ch01/512-opensquilla.md) —— Meta Skill 的实现载体
- [SkillOpt](ch05/048-skillopt.md) —— 互补（Skill 变好 vs Skill 变多）
- [Impeccable](ch05/001-impeccable.md) —— skill 内命令的范例
- [Agent Skill 编写指南](ch04/245-skill.md)
- [10 篇论文看懂 AI Agent Skill](ch04/245-skill.md)
- [Agent Skills 系统性综述](ch04/245-skill.md)
- [Skills 系统设计三路对比](ch04/245-skill.md)
- [Agent/Skills/Teams 架构演进](ch04/245-skill.md)
...
- **多 Agent 收敛趋势**：Meta Skill 与 [Minimax Mavis](ch03/044-agent.md) 等 Agent 团队架构在"编排层"形成技术收敛，从单兵作战走向团队协作是 Agent 发展的必然方向 
