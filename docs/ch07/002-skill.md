...
> 详细解读参见 [Anthropic 官方 14 种设计模式](ch04/245-skill.md)
...
## Related
- [Agent Skill 编写指南](ch04/245-skill.md) — Skill 格式、渐进式披露、编写规范、评估迭代的基础知识
- [Hermes Agent](ch03/086-hermes-agent.md) — 支持 Skill 机制的核心开源 Agent
