...
## Ch07.032 CLI、MCP 和 CLI+Skill，应该如何选？
...
## 相关实体
- [Production Ai Agents Mcp Cli Skills Stack Ayi](ch04/256-skill.md)
...
- [Staragent Webterminal Cli Ali Infra Cli As Agent Hands](ch01/310-rag.md)
