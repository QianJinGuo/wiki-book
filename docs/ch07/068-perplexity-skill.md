...
## Ch07.068 Perplexity 内部 Skill 设计指南：四维体系与维护方法论

> 📊 Level ⭐⭐⭐⭐⭐ | 13.1KB | `entities/perplexity-internal-skill-design-guide.md`
...
- Perplexity Internal Skill Design Guide Xiaojianke — 原始文章存档
- [Agent Skill Writing Guide](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-skill-writing-guide.md) — 低配版 Skill 写作指南（质量较低，仅供参考）
