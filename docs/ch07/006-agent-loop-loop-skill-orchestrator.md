...
- [Harness Engineering 框架](https://github.com/QianJinGuo/wiki-public/blob/main/entities/harness-engineering-framework.md)——三层中 Orchestrator 层对应 Harness 的运行时职责
