...
- [Anthropic 14 个 Agent Skills 设计模式](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic-agent-skills-design-patterns-14.md) — 互补：14 设计模式讲 **怎么写**（结构/格式），9 分类法讲 **做什么**（任务类型）
...
- [Hermes Agent](../ch03/061-hermes-agent.html) — Hermes 的 Skill 系统实现参考
