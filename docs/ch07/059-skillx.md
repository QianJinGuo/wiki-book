...
与 [Agent Skill 编写指南](../ch04/684-agent-skill.html) 的实践视角互补： SkillX 从学习角度建立技能体系，Agent Skill 指南从编写规范角度约束技能格式。
...
- [Skill 设计模式](../ch04/339-skill.html)
