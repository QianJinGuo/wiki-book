...
- **HermesAgent 生产案例**：本文是 wiki 中首个 HermesAgent 在大型互联网应用中的端到端生产案例，与 [高德 SDD/Harness 编码范式](../ch05/128-ai-coding.html) 互补——前者讲 AI 编码，本文讲 Agent 在生产链路的编排
...
- **RAG 配置驱动**：与 [Flow2Spec 结构化知识路由](../ch01/1217-spec.html) 的"规则外置"思想同源——业务知识从代码中剥离出来
