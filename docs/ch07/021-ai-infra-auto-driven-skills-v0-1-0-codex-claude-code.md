...
## Ch07.021 AI-Infra-Auto-Driven-SKILLS v0.1.0：给 Codex / Claude Code 的推理框架工作流
...
- [Claude Code Skills Mcp Rules Source Analysis](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-skills-mcp-rules-source-analysis.md)
...
- [Claude Code Vs Codex Context Architecture 02](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-vs-codex-context-architecture-02.md)

- [Claude Code Hiring Engineers](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/claude-code-hiring-engineers.md)- [tliveomni vllm 适配与量化方案](https://github.com/QianJinGuo/wiki-public/blob/main/entities/tliveomni-vllm-quantization.md)
