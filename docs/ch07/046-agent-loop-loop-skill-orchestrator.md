...
## Ch07.046 Agent Loop 架构三层模型：Loop + Skill + Orchestrator
...
- [Inngest 产品概述](https://github.com/QianJinGuo/wiki/blob/main/entities/inngest-ai-and-backend-workflows-orchestrated-at-any-scale.md)——本文是 CTO 的架构愿景，产品概述侧重功能特性
- [Loop Engineering (Addy Osmani)](https://github.com/QianJinGuo/wiki/blob/main/entities/loop-engineering-addy-osmani-challengehub.md)——Osmani 拆解 loop 内部构成模块，本文把 loop 放进耐久执行层
- [Loop Engineering 反馈控制系统](https://github.com/QianJinGuo/wiki/blob/main/entities/loop-engineering-feedback-control-system.md)——反馈控制的前提是耐久执行层提供可靠 checkpoint
- [Agent Loop 工程手册](https://github.com/QianJinGuo/wiki/blob/main/entities/agent-loop-engineering-handbook-8-questions-chen-jin-tencent-self-2026.md)——8 问框架与本文三层模型互补
- [Harness Engineering 框架](https://github.com/QianJinGuo/wiki/blob/main/entities/harness-engineering-framework.md)——三层中 Orchestrator 层对应 Harness 的运行时职责
- [Self-Harness](https://github.com/QianJinGuo/wiki/blob/main/entities/self-harness-shanghai-ai-lab-agent-improves-harness.md)——自建 Skill agent 是 Self-Harness 的工程实现路径
- [Agentic Environment Engineering](https://github.com/QianJinGuo/wiki/blob/main/entities/agentic-environment-engineering-jiagoux-2026-06-27.md)——Environment 决定反馈质量，Orchestrator 决定执行耐久性
