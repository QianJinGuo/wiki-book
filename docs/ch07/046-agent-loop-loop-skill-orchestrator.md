...
- [Inngest 产品概述](ch04/277-ai.md)——本文是 CTO 的架构愿景，产品概述侧重功能特性
...
- [Agent Loop 工程手册](ch01/217-0.md)——8 问框架与本文三层模型互补
- [Harness Engineering 框架](ch05/061-harness-engineering.md)——三层中 Orchestrator 层对应 Harness 的运行时职责
- [Self-Harness](ch04/277-ai.md)——自建 Skill agent 是 Self-Harness 的工程实现路径
- [Agentic Environment Engineering](ch01/217-0.md)——Environment 决定反馈质量，Orchestrator 决定执行耐久性
