...
- [Agent Skill Writing Guide](../ch04/681-agent-skill.html) — Skill 编写方法论
...
- [Skill Engineering as Algorithm](../ch04/341-skill.html) — Skill 工程即算法
- [Anthropic 14 Skill Patterns](../ch01/499-anthropic-14-skill.html) — Anthropic 技能设计模式
- [百度网盘 KMP 迁移三层架构](../ch03/035-agent.html) — 同类跨平台迁移案例
- [SkillX 分层技能库](ch07/059-skillx.html) — 分层技能库架构
- [Skill Hub 组织资产](../ch04/341-skill.html) — 组织级技能管理中心
