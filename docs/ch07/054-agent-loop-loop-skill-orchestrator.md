...
- [Inngest 产品概述](ch05/100-ai.html)——本文是 CTO 的架构愿景，产品概述侧重功能特性
...
- [Self-Harness](ch05/100-ai.html)——自建 Skill agent 是 Self-Harness 的工程实现路径
- [Agentic Environment Engineering](ch03/035-agent.html)——Environment 决定反馈质量，Orchestrator 决定执行耐久性
