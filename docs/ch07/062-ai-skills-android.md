...
## Ch07.062 AI + Skills 打通中间件迁移：Android 到鸿蒙定位服务实践
...
- [Agent Skill Writing Guide](../ch04/264-agent-skill.html) — Skill 编写方法论
- [Hermes Skill System](ch07/017-hermes-skill.html) — Hermes 技能系统
- [Harness Engineering](../ch05/117-harness-engineering.html) — Harness 工程范式
...
- [Agent Skills vs 低代码平台](../ch04/399-agent-skills.html) — Skills 与低代码对比
- [Skill Craft](ch07/050-skill-craft-claude-skill.html) — Skill 工艺学
- [Skill Engineering as Algorithm](../ch04/266-skill.html) — Skill 工程即算法
- [Anthropic 14 Skill Patterns](../ch01/322-anthropic-14-skill.html) — Anthropic 技能设计模式
- [百度网盘 KMP 迁移三层架构](../ch03/046-agent.html) — 同类跨平台迁移案例
- [SkillX 分层技能库](ch07/053-skillx.html) — 分层技能库架构
