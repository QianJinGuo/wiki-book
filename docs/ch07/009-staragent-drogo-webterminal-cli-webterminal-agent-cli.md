...
- [CLI / MCP / SDK 选型](ch03/044-agent.md) — 工具原语选择（理论层）
- [AgentCore OpenClaw 多租户](ch03/044-agent.md) — AWS 视角的远程 Agent
- [OpenClaw Security 部署](ch11/210-openclaw.md) — OpenClaw 安全部署
...
- [250 行 CLI Agent 教程](ch03/044-agent.md) — minimal 教学
