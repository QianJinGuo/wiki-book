...
- [Anthropic Agent Skills Design Patterns 14](ch04/271-skill.html) — Anthropic 官方 14 条 Skill 设计模式
- [Skill System Design Three Way Comparison](ch04/271-skill.html) — OpenClaw / Claude Code / Hermes 三方 Skill 系统对比
- [Claude Code Skills Workflow Encapsulation Costa Long](ch04/271-skill.html) — Claude Code Skills 工作流封装机制
