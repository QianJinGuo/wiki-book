...
## Ch07.068 Skill 版本对比五大原则：从'两个数字比大小'到工程化质量门禁
...
```mermaid
mindmap
  root(("Skill 版本对比五大原则 从两个数字比大小到工程化质量门禁"))
    六种假改进陷阱
    五条原则
      ...
      原则 3 失败 case 必须人眼复核
    完整版本对比报告模板
    真实案例 db-query Skill v200 被 P0 回退拦下
    CI 自动化建议
```
...
- [Skill 版本管理五大原则](../ch04/271-skill.html) — 同作者同系列，版本管理侧
- [Agent Skill 写作评估](../ch04/269-agent-skill.html)
- [Harness Engineering](../ch05/120-harness-engineering.html)
- [Claw-SWE-Bench](../ch05/009-harness.html) — harness 独立评测基准
- [Agent Eval WalleZhang](../ch03/035-agent.html) — YAML 驱动评估框架
