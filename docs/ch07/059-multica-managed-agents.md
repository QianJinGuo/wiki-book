...
## 与现有知识关联
- [Claude Managed Agents 开发者指南](../ch04/485-claude-managed-agents.md) — Managed Agents 概念扩展
- [Anthropic PM 的 Agentic 工作流](../ch04/429-anthropic-pm-agentic.md) — 管理多个 Agent 的场景
- [Agentic AI 系统架构](../ch05/072-harness-skill.md) — 五层架构，管理层问题
- [Skill-RAG：清华 SRA](../ch04/262-skill.md) — Skill 检索增强相关
- [Agent自我改进六条路](../ch03/045-agent.md) — Skill 积累属于经验沉淀
