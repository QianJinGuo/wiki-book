...
## 与 SkillOpt 的对比
| 维度 | [SkillOpt](../ch05/054-skillopt.html) | Meta Skill |
|---|---|---|
...
- [SkillOpt](../ch05/054-skillopt.html) —— 互补（Skill 变好 vs Skill 变多）
...
- **用 [SkillOpt](../ch05/054-skillopt.html) 优化单 Skill、用 Meta Skill 组织多 Skill**：两者是互补关系而非竞争关系，单个 Skill 的质量决定了编排层的下限，两层一起才能构成完整闭环 
