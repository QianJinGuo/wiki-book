...
## Ch07.057 Microsoft Agent Framework Tools 总览：4 类工具 + Provider 矩阵 + Tool Approval
...
- [Microsoft Agent Framework Python Zizhi](https://github.com/QianJinGuo/wiki-public/blob/main/entities/microsoft-agent-framework-python-zizhi.md)
...
- [Open Claw Tool Bus Subagent Architecture](https://github.com/QianJinGuo/wiki-public/blob/main/entities/open-claw-tool-bus-subagent-architecture.md)
