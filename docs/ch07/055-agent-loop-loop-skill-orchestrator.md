...
- [Loop Engineering (Addy Osmani)](../ch05/122-loop-engineering.html)——Osmani 拆解 loop 内部构成模块，本文把 loop 放进耐久执行层
- [Loop Engineering 反馈控制系统](../ch05/122-loop-engineering.html)——反馈控制的前提是耐久执行层提供可靠 checkpoint
- [Agent Loop 工程手册](../ch05/122-loop-engineering.html)——8 问框架与本文三层模型互补
