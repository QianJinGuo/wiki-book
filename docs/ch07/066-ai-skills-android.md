...
- [Agent Skill Writing Guide](ch04/271-skill.html) — Skill 编写方法论
- [Hermes Skill System](ch04/271-skill.html) — Hermes 技能系统
- [Harness Engineering](ch05/120-harness-engineering.html) — Harness 工程范式
- [Thin Harness, Fat Skills](ch04/271-skill.html) — 薄 Harness 厚 Skills 架构
- [如何将经验编码为 Skills](ch04/271-skill.html) — 经验 → Skills 转化方法论
- [Agent Skills vs 低代码平台](ch04/271-skill.html) — Skills 与低代码对比
- [Skill Craft](ch04/271-skill.html) — Skill 工艺学
- [Skill Engineering as Algorithm](ch04/271-skill.html) — Skill 工程即算法
- [Anthropic 14 Skill Patterns](ch04/271-skill.html) — Anthropic 技能设计模式
- [百度网盘 KMP 迁移三层架构](ch05/094-ai.html) — 同类跨平台迁移案例
- [SkillX 分层技能库](ch04/271-skill.html) — 分层技能库架构
