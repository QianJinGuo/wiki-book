...
## Ch07.079 Introducing the MDN MCP server
...
- [Anthropic MCP 协议回顾](ch07/017-anthropic-mcp.html) — MCP 协议本身的设计
- [AWS Bedrock AgentCore MCP](../ch11/268-aws-bedrock-agentcore.html) — 商业 MCP server
- [Claude Code MCP server](ch07/031-claude-code-mcp-server.html) — Claude Code 工具系统
- [Hermes Agent 工具系统架构](../ch03/102-hermes-agent.html) — agent 工具调用一般化框架
