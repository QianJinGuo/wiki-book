...
## Ch07.071 李继刚 23 个 Skills 深度拆解——认知工序流水线

> 📊 Level ⭐⭐ | 5.7KB | `entities/ljg-skills-deep-dive-datastudio-2026.md`
...
```mermaid
mindmap
  root(("李继刚 23 个 Skills 深度拆解——认知工序流水线"))
    深度分析
      流水线范式：制造业逻辑迁移到认知系统
...
- [ljg 写作表达类 Skills](../ch03/072-skills.html)
- [规范驱动的认知框架](../ch01/1016-spec.html)
