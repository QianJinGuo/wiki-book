...
## Ch07.036 我把 Claude Design 做成了 Skill，人人都能成为顶级网站设计师

> 📊 Level ⭐⭐⭐⭐ | 20.7KB | `entities/claude-design-skill-web-design-engineer.md`

Claude Design Skill Web Design Engineer
...
- [浏览器 agent 的失忆问题：autobrowse 如何让每次探索变成永久技能](https://github.com/QianJinGuo/wiki-public/blob/main/entities/autobrowse-browserbase-persistent-skill-files.md)
→ 原文存档

**延伸阅读**：用户体验设计需要系统性的用户研究方法。[User Journey Map](https://github.com/QianJinGuo/wiki-public/blob/main/entities/user-journey-map.md) 提供了一种将用户行为、情感和痛点可视化的框架，帮助团队从"功能清单"转向"用户目标视角"。
