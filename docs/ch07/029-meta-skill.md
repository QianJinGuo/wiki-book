...
## 与 SkillOpt 的对比
| 维度 | [SkillOpt](../ch05/046-skillopt.html) | Meta Skill |
|---|---|---|
...
## 相关对照
- [OpenSquilla](../ch04/760-opensquilla-launches-open-source-ai-agent-to-cut-token-costs.html) —— Meta Skill 的实现载体
- [SkillOpt](../ch05/046-skillopt.html) —— 互补（Skill 变好 vs Skill 变多）
- [Impeccable](../ch05/001-impeccable.html) —— skill 内命令的范例
- [Agent Skill 编写指南](../ch04/680-agent-skill.html)
- [10 篇论文看懂 AI Agent Skill](../ch04/341-skill.html)
- [Agent Skills 系统性综述](../ch04/470-agent-skills.html)
- [Skills 系统设计三路对比](../ch04/341-skill.html)
- [Agent/Skills/Teams 架构演进](../ch04/305-agent-skills-teams.html)
...
- **用 [SkillOpt](../ch05/046-skillopt.html) 优化单 Skill、用 Meta Skill 组织多 Skill**：两者是互补关系而非竞争关系，单个 Skill 的质量决定了编排层的下限，两层一起才能构成完整闭环 
