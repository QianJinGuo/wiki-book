...
> 📊 Level ⭐⭐⭐⭐ | 12.0KB | `entities/mattpocock-skills-grill-me-grill-with-docs-caveman.md`
...
→ [三器合一工程化实战](https://github.com/QianJinGuo/wiki-public/blob/main/entities/three-tools-in-one-gstack-superpowers-openspec-engineering-ai-coding.md)
...
- [Stepan Gershuni Ai Native Startup Guide](https://github.com/QianJinGuo/wiki-public/blob/main/entities/stepan-gershuni-ai-native-startup-guide.md)
- [Matt Pocock Skills vs Superpowers](https://github.com/QianJinGuo/wiki-public/blob/main/entities/matt-pocock-skills-vs-superpowers-comparison.md)

## 顾旭东解读：Agent 开发的四类失控模型

顾旭东在深度分析中提出 Agent 开发的四类失控框架：

### 1. 对齐失败
Agent 理解的需求≠你真正的需求。grill-me 和 grill-with-docs 在开工前追问细节。

### 2. 语言失配
人与系统概念不统一，Agent 用泛泛描述绕圈子。grill-with-docs 把领域语言沉淀到 CONTEXT.md 和 ADR。

### 3. 反馈不足
Agent 写代码但缺乏验证。tdd（红绿重构循环）和 diagnose（诊断循环）提供工程反馈。

### 4. 架构失控
Agent 加速编码也加速软件熵。zoom-out（理解系统位置）和 improve-codebase-architecture（加深模块）防范架构劣化。
...
- 同题异语种孪生页：[2026 06 20 打造真实项目的 Ai 编程环境 Matt Pocock 的 Skill 工作流完 技术极简主义](https://github.com/QianJinGuo/wiki-public/blob/main/entities/2026-06-20-打造真实项目的-AI-编程环境-Matt-Pocock-的-Skill-工作流完-技术极简主义.md)（归并候选，提案卡 #11 批1）
