...
- [Knowledge Work Plugins Shuge Anthropic Deep Source](../ch01/846-anthropic.html) — 同源姊妹篇：数滴云对同一仓库的深度解读，互补视角
...
- [Claude Code Skills Workflow Encapsulation Costa Long](../ch03/075-claude-code.html) — Claude Code Skills 工作流封装机制
