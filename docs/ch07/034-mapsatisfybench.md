...
## Ch07.034 MapSatisfyBench：首个以满意度为核心目标的地图智能体评测基准
...
- 与 [高德 Uplift 模型迭代 Agent](ch04/502-agent.md) 同源（高德 AI 团队），但聚焦地图交互而非营销算法
...
- AR = ECR × IISR 的"乘法衰减"设计与 [Agent 可靠性](ch04/502-agent.md) 的"单点失败传播"模式一致
