...
## Ch07.024 高德扫街榜 HermesAgent 配图系统：VLM + Skill + 语言驱动的生产级 Agent 架构
...
- **Skill 化/MCP 层**：五层架构中的 MCP/Skill 层与 [Hermes Agent](../ch03/100-hermes-agent.html) 的 Skill 系统直接对应——每个能力被封装为可独立调用的工具
