...
## Ch07.048 Agent Loop 架构三层模型：Loop + Skill + Orchestrator
...
- [Inngest 产品概述](../ch01/769-inngest-ai-and-backend-workflows-orchestrated-at-any-scal.html)——本文是 CTO 的架构愿景，产品概述侧重功能特性
