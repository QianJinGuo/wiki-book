...
## 与现有知识关联
- [Claude Managed Agents 开发者指南](../ch01-329-claude-managed-agents-开发者指南/) — Managed Agents 概念扩展
- [Anthropic PM 的 Agentic 工作流](../ch04-383-anthropic-pm-的-agentic-工作流/) — 管理多个 Agent 的场景
- [Agentic AI 系统架构](../ch04-197-mcp-skill-agent-llm-harness-一张图讲清-agentic-ai-系统如何真/) — 五层架构，管理层问题
- [Skill-RAG：清华 SRA](../ch04-430-skill-retrieval-augmentation-for-agentic-ai-清华-skill-rag/) — Skill 检索增强相关
- [Agent自我改进六条路](../ch04-047-agent-自我改进的六条路/) — Skill 积累属于经验沉淀
