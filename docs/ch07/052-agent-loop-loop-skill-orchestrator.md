...
- [Inngest 产品概述](ch05/094-ai.html)——本文是 CTO 的架构愿景，产品概述侧重功能特性
...
- [Agent Loop 工程手册](ch03/035-agent.html)——8 问框架与本文三层模型互补
- [Harness Engineering 框架](ch05/120-harness-engineering.html)——三层中 Orchestrator 层对应 Harness 的运行时职责
- [Self-Harness](ch05/094-ai.html)——自建 Skill agent 是 Self-Harness 的工程实现路径
