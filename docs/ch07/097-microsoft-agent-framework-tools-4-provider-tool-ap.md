...
## 相关实体
- [Microsoft Agent Framework Structured Output](../ch03/019-agent.html)
- [Microsoft Agent Framework Python Zizhi](../ch04/491-python.html)
- [800行代码实现 Open Claw 的 Tool消息总线子Agent管理架构](../ch03/019-agent.html)
- [Open Claw Tool Bus Subagent Architecture](../ch03/019-agent.html)
