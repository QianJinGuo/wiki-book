...
## Ch07.097 Microsoft Agent Framework Tools 总览：4 类工具 + Provider 矩阵 + Tool Approval

> 📊 Level ⭐⭐⭐ | 26.5KB | `entities/microsoft-agent-framework-tools-overview-provider-matrix.md`
...
## 相关实体
- [Microsoft Agent Framework Structured Output](../ch03/006-agent.html)
- [Microsoft Agent Framework Python Zizhi](../ch04/492-python.html)
- [800行代码实现 Open Claw 的 Tool消息总线子Agent管理架构](../ch03/006-agent.html)
- [Open Claw Tool Bus Subagent Architecture](../ch03/006-agent.html)
