...
- [Anthropic 14 个 Agent Skills 设计模式](../ch04/077-anthropic-agent.html) — 互补：14 设计模式讲 **怎么写**（结构/格式），9 分类法讲 **做什么**（任务类型）
- [Skill 设计模式](054-skill.html) — 5 种核心结构模式（线性、Tool Wrapper、Generator 等），补充了 9 类分类中的生成/验证/运维类如何组织
- [从 Anthropic 到 Google：Agent Skills 进入设计模式阶段](../ch04/302-agent-skills.html) — Google 5 Agent Skill 设计模式 vs Anthropic 视角
- [Perplexity 内部 Skill 设计指南](054-skill.html) — 另一家的 Skill 工程方法论对比
- [Hermes Agent](../ch04/161-hermes-agent.html) — Hermes 的 Skill 系统实现参考
...
## 原始存档
→ [原文存档](https://mp.weixin.qq.com/s/i40ltoT_LodyFmv7FT5HUQ)
