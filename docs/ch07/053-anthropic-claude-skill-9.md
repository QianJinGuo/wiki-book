...
## Ch07.053 Anthropic Claude Skill 9 类任务分类法
...
- [从 Anthropic 到 Google：Agent Skills 进入设计模式阶段](../ch04/301-agent-skills.html) — Google 5 Agent Skill 设计模式 vs Anthropic 视角
