...
- [Agent Skill Writing Guide](../ch04/604-agent-skill.html) — Skill 编写方法论
...
- [Agent Skills vs 低代码平台](../ch04/392-agent-skills.html) — Skills 与低代码对比
...
- [Anthropic 14 Skill Patterns](../ch01/361-anthropic-14-skill.html) — Anthropic 技能设计模式
