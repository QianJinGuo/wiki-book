...
- Agent Skill 编写指南 — Skills 管「编排」，MCP 管「能力」，两者互补
- [Agent 上下文窗口管理对比](/ch04-149-agent-上下文窗口管理对比/) — MCP token 膨胀问题与上下文窗口管理相关
- OpenClaw 架构解析 — OpenClaw 的 Tool/MessageBus 设计可对比 MCP 架构
