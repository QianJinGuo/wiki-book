...
## Ch07.031 电商 AI 操作系统崛起：从「工具人」到「All in One」+ 行业 KnowHow Skill 化 + 5 巨头 Headless 布局
...
→ [电商智能体设计实践 (AWS Bedrock AgentCore)](../ch03/045-agent.html) — AWS 技术栈视角
→ [OpenClaw 电商平台应用场景](../ch11/222-openclaw.html) — OpenClaw 工具视角
