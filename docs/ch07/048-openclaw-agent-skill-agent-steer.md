...
> 京东技术发布的 OpenClaw 源码深度分析，聚焦 Agent 执行引擎、Skill 系统、子 Agent 架构和容错机制——与 [OpenClaw 与 Hermes 源码架构对比](../ch01/239-openclaw-hermes.html)（Gateway/Channel/Dreaming 记忆视角）互补。
