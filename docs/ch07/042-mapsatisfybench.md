...
## Ch07.042 MapSatisfyBench：首个以满意度为核心目标的地图智能体评测基准
...
- 与 [高德 SDD/Harness 体系](../ch05/121-ai-coding.html) 同源（高德技术团队），但聚焦评测而非编码
...
- AR = ECR × IISR 的"乘法衰减"设计与 [Agent 可靠性](../ch03/036-agent.html) 的"单点失败传播"模式一致
