...
> 详细解读参见 [Anthropic 官方 14 种设计模式](https://github.com/QianJinGuo/wiki-public/blob/main/entities/skill-design-patterns-anthropic.md)
...
- [Hermes Agent](../ch03/095-hermes-agent.html) — 支持 Skill 机制的核心开源 Agent
