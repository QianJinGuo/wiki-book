...
## Ch07.058 腾讯企业微信团队 Skill 流水线：AI代码生成率94%的需求开发全流程
...
### 外部知识载体 > 模型记忆
TECH_SPEC.md 作为跨会话知识传承的外部文件，比依赖模型的内在记忆更可靠。这与 [Anthropic Long Running Agent Architecture 6H Retroforge](../ch03/004-agent.html) 的"文件系统 > 模型记忆"原则一致。
