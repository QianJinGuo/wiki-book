...
- [读完 Claude Code 源码才发现 Skills/MCP/Rules 的区别远没有你想的那么大](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-skills-mcp-rules-source-analysis.md)
