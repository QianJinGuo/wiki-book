...
## Ch07.053 Multica — 开源 Managed Agents 平台
...
## 与现有知识关联
- [Claude Managed Agents 开发者指南](ch04/503-agent.md) — Managed Agents 概念扩展
- [Anthropic PM 的 Agentic 工作流](ch04/503-agent.md) — 管理多个 Agent 的场景
- [Agentic AI 系统架构](ch04/245-skill.md) — 五层架构，管理层问题
- [Skill-RAG：清华 SRA](ch04/245-skill.md) — Skill 检索增强相关
- [Agent自我改进六条路](ch04/503-agent.md) — Skill 积累属于经验沉淀
