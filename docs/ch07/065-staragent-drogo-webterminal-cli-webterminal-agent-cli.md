...
## Ch07.065 StarAgent/Drogo WebTerminal CLI：阿里基础设施把 WebTerminal 变成 Agent 手脚（CLI 才是 Skill 的执行面）
...
- [CLI / MCP / SDK 选型](https://github.com/QianJinGuo/wiki-public/blob/main/entities/cli-mcp-sdk-agent-tool-selection.md) — 工具原语选择（理论层）
- [AgentCore OpenClaw 多租户](https://github.com/QianJinGuo/wiki-public/blob/main/entities/using-amazon-bedrock-agentcore-openclaw-multi-2.md) — AWS 视角的远程 Agent
- [OpenClaw Security 部署](https://github.com/QianJinGuo/wiki-public/blob/main/entities/enterprise-openclaw-security-deploy-architecture-guide.md) — OpenClaw 安全部署
- [DIPG](https://github.com/QianJinGuo/wiki-public/blob/main/entities/dipg-ant-insurance-host-research-verify-offline-closed-loop.md) — 蚂蚁保险 verify 闭环（也是 Agent 远程任务）
- [250 行 CLI Agent 教程](https://github.com/QianJinGuo/wiki-public/blob/main/entities/minimal-cli-agent-250-line-python-ollama-7-stages.md) — minimal 教学
