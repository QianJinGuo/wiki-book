...
## Ch07.059 AI + Skills 打通中间件迁移：Android 到鸿蒙定位服务实践
...
- [Harness Engineering](../ch05/050-harness-engineering.html) — Harness 工程范式
- [Thin Harness, Fat Skills](../ch05/074-thin-harness-fat-skills-ai.html) — 薄 Harness 厚 Skills 架构
- [如何将经验编码为 Skills](../ch03/069-skills.html) — 经验 → Skills 转化方法论
- [Agent Skills vs 低代码平台](../ch04/384-agent-skills.html) — Skills 与低代码对比
...
- [Anthropic 14 Skill Patterns](../ch01/385-anthropic-14-skill.html) — Anthropic 技能设计模式
- [百度网盘 KMP 迁移三层架构](../ch03/045-agent.html) — 同类跨平台迁移案例
- [SkillX 分层技能库](ch07/049-skillx.html) — 分层技能库架构
