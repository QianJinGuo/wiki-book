...
## Ch07.085 Codex Record & Replay：GUI 演示到可复用 Skill 的工作流捕获
...
与 [Agent Skill 写作指南](../ch04/268-agent-skill.html) 的关系：传统 Skill 写作要求人手动定义触发条件、输入拆分、步骤表达、失败处理；Record & Replay 提供了"先演示再生成草稿"的替代路径。
