...
- [从 Anthropic 到 Google：Agent Skills 进入设计模式阶段](../ch04/390-agent-skills.html) — Google 5 Agent Skill 设计模式 vs Anthropic 视角
- [Perplexity 内部 Skill 设计指南](../ch04/267-skill.html) — 另一家的 Skill 工程方法论对比
- [Hermes Agent](../ch03/091-hermes-agent.html) — Hermes 的 Skill 系统实现参考
