...
- [Agent Skill 编写指南](../ch04/620-agent-skill.html) — Skills 管「编排」，MCP 管「能力」，两者互补
- [Agent 上下文窗口管理对比](../ch06/010-context-window-management-comparison.html) — MCP token 膨胀问题与上下文窗口管理相关
