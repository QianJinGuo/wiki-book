...
- 与 [高德 SDD/Harness 体系](../ch05/128-ai-coding.html) 同源（高德技术团队），但聚焦评测而非编码
- 与 [高德 Uplift 模型迭代 Agent](../ch05/066-agent-harness.html) 同源（高德 AI 团队），但聚焦地图交互而非营销算法
...
- AR = ECR × IISR 的"乘法衰减"设计与 [Agent 可靠性](../ch03/006-agent.html) 的"单点失败传播"模式一致
