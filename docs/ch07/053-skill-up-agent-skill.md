...
- [Agent Skill 评估与迭代](../ch04/680-agent-skill.html) — 侧重于手动测试方法论，与 skill-up 的自动化 CI 方案形成对照
...
- [SkillScan：智能体技能安全扫描](../ch04/680-agent-skill.html) — 技能安全扫描与 skill-up 的质量验证相辅相成
