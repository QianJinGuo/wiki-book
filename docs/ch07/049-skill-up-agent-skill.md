...
- [Alibaba Skill-Up：声明式 Agent Skill 评测框架（同主题深度解读）](../ch04/309-alibaba-skill-up-agent-skill.html) — 基于另一篇来源文章的全面分析，含对比评测框架
...
- [SWE-bench Agent 评估方法论](../ch04/676-swe-bench-agent.html) — 软件工程 Agent 评测基准方法论
