...
> 📊 Level ⭐⭐ | 25.4KB | `entities/skill-design-patterns.md`
...
> 详细解读参见 [Anthropic 官方 14 种设计模式](../ch01/1592-anthropic.html)
...
## Related
- [Agent Skill 编写指南](../ch04/614-agent-skill.html) — Skill 格式、渐进式披露、编写规范、评估迭代的基础知识
- [Hermes Agent](../ch03/099-hermes-agent.html) — 支持 Skill 机制的核心开源 Agent
