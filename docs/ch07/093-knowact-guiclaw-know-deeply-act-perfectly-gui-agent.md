...
KnowAct-GUIClaw 与 [MobileForge](../ch03/037-agent.html)、[MemGUI](../ch03/037-agent.html)、[SaaS-Bench](../ch03/037-agent.html) 同属 GUI Agent 前沿，其「主智能体记忆编排 + 自进化」路线与 [OpenClaw](../ch11/252-openclaw.html) 生态深度耦合。
