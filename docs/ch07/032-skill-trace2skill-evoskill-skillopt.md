...
## Ch07.032 Skill自进化三路线：Trace2Skill归纳法 / EvoSkill验证闭环 / SkillOpt训练范式
...
- [Hermes Agent 自进化](ch04/503-agent.md)
- [Agent 自改进六机制](ch04/503-agent.md)
- [阿里 Agentic Cloud](ch04/503-agent.md)
