...
## Ch07.007 Claude Code Skills / MCP / Rules 源码分析
...
- [Claude Code 架构解析：从 Skill 调用到 Prompt Cache](../ch03/084-claude-code.html)
...
- [Claude Code 12 个可复用的 Agentic Harness 设计模式](../ch03/074-claude-code-agent.html)
- [Claude Code Governance：软规则与项目级行为规范](../ch03/084-claude-code.html)
- [Agent Harness Context Management：Working Set 策略](../ch05/042-agent-harness.html)
