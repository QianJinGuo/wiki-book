...
- [Inngest 产品概述](../ch01/761-inngest-ai-and-backend-workflows-orchestrated-at-any-scal.html)——本文是 CTO 的架构愿景，产品概述侧重功能特性
...
- [Agentic Environment Engineering](../ch04/236-agentic.html)——Environment 决定反馈质量，Orchestrator 决定执行耐久性
