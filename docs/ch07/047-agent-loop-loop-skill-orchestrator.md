...
- [Inngest 产品概述](../ch01/732-inngest-ai-and-backend-workflows-orchestrated-at-any-scal.md)——本文是 CTO 的架构愿景，产品概述侧重功能特性
...
- [Agent Loop 工程手册](../ch05/006-loop-engineering.md)——8 问框架与本文三层模型互补
- [Harness Engineering 框架](../ch05/092-harness-engineering.md)——三层中 Orchestrator 层对应 Harness 的运行时职责
- [Self-Harness](../ch05/009-harness.md)——自建 Skill agent 是 Self-Harness 的工程实现路径
