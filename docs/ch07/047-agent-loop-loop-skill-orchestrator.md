...
- [Inngest 产品概述](../ch01/746-inngest-ai-and-backend-workflows-orchestrated-at-any-scal.md)——本文是 CTO 的架构愿景，产品概述侧重功能特性
...
- [Harness Engineering 框架](../ch05/062-harness-engineering.md)——三层中 Orchestrator 层对应 Harness 的运行时职责
