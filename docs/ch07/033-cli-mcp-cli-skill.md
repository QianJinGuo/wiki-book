...
## Ch07.033 CLI、MCP 和 CLI+Skill，应该如何选？
...
## 相关实体
- [Production Ai Agents Mcp Cli Skills Stack Ayi](ch04/255-skill.md)
...
- [Staragent Webterminal Cli Ali Infra Cli As Agent Hands](ch01/309-rag.md)
