...
这与 [Anthropic MCP 优化](/ch07-044-anthropic-mcp-重新定义-tool-search-代码编排/) 中 Tool Search 减少 85% tool definition token 的思路一脉相承。
...
- → [Prompt Caching 工程实践](/ch09-022-prompt-caching-工程实践-anthropic-claude-code-经验总结/)：缓存策略是 token 优化的另一维度
