...
## Ch01.272 knowledge-work-plugins拆解：Anthropic官方开源，4 种组件、3 级加载、2 层记忆，纯文件的 AI岗位插件集
...
- [**Model Context Protocol (MCP)** — Anthropic 主导的开放标准，knowledge-work-plugins 通过 MCP 连接 40+ 外部工具](/ch01-692-anthropic/)
- [**Agent Harness Engineering** — Skills + Hooks + Commands 的组合是 Harness 工程的纯文件实现](/ch05-031-harness-engineering-实战-ai-coding-率从-25-提升至-90/)
- [**Claude Code** — 同一个生态，Claude Code 是承载 knowledge-work-plugins 的产品形态](/ch03-002-obsidian-claude-code-集成指南/)
