...
## 与 [Hermes Agent Deep Dive](../ch04-418-hermes-agent) 的关系
...
- [Anthropic Mcp Revisited](../ch01-677-anthropic) — MCP 作为 Agent 工具调用协议，与 Memory 的世界模型有交叉（环境约束信息）
- [Gbrain](../ch01-220-gbrain-yc-ceo-garry-tan-的-postgres-native-ai-第二大脑-5-大设计决策) — Compiled Truth + Timeline 知识模型，与 Memory 的信念追踪机制相关
