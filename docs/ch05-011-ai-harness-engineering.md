...
- [Context Engineering — 第二层重心迁移](/ch04-229-yidian-tianxia-context-engineering-agentic-ai/)
...
- [深入理解 Claude Code Agent Harness](/ch01-170-深入理解-claude-code-源码中的-agent-harness-构建之道/) — Harness 在 Claude Code 源码层的具体构建
