...
## Ch04.330 Your First AI Agent Should Do One Thing Badly
...
- 与 [Your First Ai Agent Should Do One Thing Badly](/ch04-330-your-first-ai-agent-should-do-one-thing-badly/) 的"crawl, walk, run"与 [Claude Code 现状评估](/ch09-017-ethan-mollick-claude-code-and-what-comes-next-practitioner/) 的"一小时跑完"形成节奏对比——前者周迭代，后者小时级自治。
