...
## Ch09.089 复制这套神仙配置，让Claude Code全自动修Bug！告别每天重复教AI写代码
...
- [Agent Hooks：可编程工作流](../ch04-247-agent-hooks-把-agent-工作流变成可编程的) — Hooks 生命周期节点详解（PostToolUse/Stop/PreToolUse 等）
