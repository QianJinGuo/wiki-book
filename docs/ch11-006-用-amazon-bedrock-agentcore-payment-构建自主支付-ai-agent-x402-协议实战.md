...
## Ch11.006 用 Amazon Bedrock AgentCore Payment 构建自主支付 AI Agent：x402 协议实战
...
02 [二、项目介绍与整体架构](/ch11-#section2/)

04 [四、部署概要](/ch11-#section4/)

05 [五、结语](/ch11-#section5/)
...
- [Agentcore Payments X402 Agentic Commerce](/ch11-066-agentcore-payments-与代理商务创新-技术深度解析/)
...
- [Agentic Payment X402 Bedrock Agentcore](/ch11-092-让-ai-代理自己付钱-基于-amazon-bedrock-agentcore-与-x402-的-agentic-pay/)

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/bedrock-agentcore-payment-x402-agent.md)
- [Ai Research Assistant From Idea To App](/ch04-008-from-idea-to-ai-app-creating-intelligent-research-assistant/)
