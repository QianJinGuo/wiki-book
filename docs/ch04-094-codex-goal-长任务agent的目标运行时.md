...
## Ch04.094 Codex /goal：长任务Agent的目标运行时
...
- [高德伴行Agent](/ch04-113-高德伴行agent-空间智能高可用agent架构/)（工作现场六组件）
- [Hermes Agent](/ch07-007-hermes-agent-满配-12-层配置完整指南-从裸装到-24h-agent-团队/)（Karpathy 观点被多次引用）
- [Agent Memory Architecture](/ch04-029-agent-memory-architecture-past-influence-future-ruofei/)（状态为什么得落在模型外面）

## 相关页面
- [原文存档：Codex /goal 实现拆解](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/codex-goal-implementation-breakdown.md)

## 相关实体
- [Codex /goal: The Six-Hour Run That Survived a Five-Hour Pause](/ch09-052-codex-goal-six-hour-run/)
...
- [Openai Symphony Codex Orchestration Linear Control Plane](/ch09-015-openai-symphony-linear-即-codex-agent-控制平面/)
- MOC
## 深度分析
