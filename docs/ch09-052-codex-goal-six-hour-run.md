...
- [Codex /goal：长任务Agent的目标运行时](../ch04-094-codex-goal-长任务agent的目标运行时) — 若飞源码级拆解，目标状态机 + completion audit 协议 + budget_limit 收束模板
...
- [Anthropic Claude Code 大型代码库最佳实践](../ch01-677-anthropic) — Claude Code 在大规模代码库中的实践
