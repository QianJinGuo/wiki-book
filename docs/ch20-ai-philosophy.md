...
- [Willison Vibe Coding Convergence](ch09/047-coding-agent.html) —— Willison 的同主题回应
...
## 相关实体
- [Openai Buys Ai Consultancy Enterprises](ch05/094-ai.html)
- [Multilingual Ai](ch05/094-ai.html)
- [Baixing Ontoz Enterprise Ontology Multi Agent](ch05/094-ai.html)
- [Enterprise Ai Memory Substrate Three Layer Architecture](ch05/094-ai.html)
- [Skill Version Management Semantic Versioning Practices Winty](ch04/271-skill.html)
...
- [Harness Engineering](ch03/035-agent.html) — 约束驱动的自动化执行
...
## 相关实体
- [Fanling Company As Agent Ai Org Reflection](ch05/094-ai.html)
...
## 相关实体
- [Gitlab 14Pct Layoff Agent Platform Ai 2026Q1](ch05/094-ai.html)
...
- [Ai Agents Inside Perimeter Hackernews](ch05/094-ai.html)
- [Ai Phishing Attacks Are On The Rise Are You Prepared Bitward](https://github.com/QianJinGuo/wiki/blob/main/entities/AI-phishing-attacks-are-on-the-rise-Are-you-prepared-Bitward.md)
...
**RLHF 和 preference data**：在生产语言中进行偏好标注和 [RLHF](ch05/094-ai.html)，而非仅在英语或团队语言中进行。偏好信号的文化特异性意味着必须由真实目标语言用户产生。

**Production monitoring**：按语言、按地区追踪质量指标，在用户发现问题之前发现多语言质量退化。

## 质量保障基础设施

Welo Data 的 **NIMO**（Identity Verification and Quality Management System）提供了可审计的质量保证：评估者身份验证、contributor 元数据、异常检测报告，以及完整的[评估指标](ch04/271-skill.html)体系。
...
- [Harness Engineering Long Term Agent Tasks](ch03/035-agent.html) — Harness Engineering 让 AI 产出可预期、可衡量、可持续
...
## 相关实体
- [Improving token efficiency in GitHub Agentic Workflows](ch03/035-agent.html)
- [Token Efficiency](ch03/035-agent.html)
- [Improving Token Efficiency in GitHub Agentic Workflows — GitHub 内部 Agent 工作流 Token 优化实践](ch03/035-agent.html)
...
## 相关实体
- [企微的这些新功能补齐了Ai在你公司的最后一公里](ch05/094-ai.html)
- [Token Economics Ai Efficiency](ch05/094-ai.html)
...
- [腾讯 Token 经济学](ch05/094-ai.html) — AI 工具的成本-效率分析
...
- [Claude Code 大型代码库 Harness](ch03/077-claude-code.html) — AI 辅助开发的工具配置实践
...
- [How To Automate Ai Model Documentation With The Nvidia Mcg T 806Efb](ch05/094-ai.html)
...
- [Claude Opus 48 The System Card B8460F](ch01/976-claude.html) — Anthropic 前沿模型的安全评估方法
- [Dario Amodei Policy Ai Exponential Time Mismatch](ch05/094-ai.html) — 同源姊妹篇：聚焦 Treebeard 时间错配与四大政策原则的深度解读
...
- [anthropic vs dow (department of war) 与开源模型的 5-10 年权力均衡](ch01/913-20.html)
...
- [Mythos and Enterprise Security](ch12/030-mythos.html) — Zero-trust security architecture parallels with model safety
- [AI-Friendly Backend Standards](ch05/094-ai.html) — Architecture-level vs. surface-level approaches to AI system design
...
- [Alibaba Cloud AI Practices](ch05/094-ai.html) — Practical AI infrastructure engineering
...
组织需要一种方式将员工构建的工具带入管理环境，定义所有权、可审计性和治理。参见：[Claude Code 治理：软规则与硬约束](ch05/094-ai.html)
...
许多组织通过他们已经信任的工具使用 AI（这些工具处理企业数据），但并未意识到。领先组织正在通过在 RFP 中添加 AI 特定问题、更新合同以解决数据使用和模型行为问题，使第三方期望与内部 AI 政策保持一致来加强供应商监督。参见：[AI 工具中毒：企业 Agent 安全的一大缺陷](ch05/094-ai.html)
