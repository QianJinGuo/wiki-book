...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/human-aligning-to-machine-reverse-alignment-2026.md)
...
-> [original archive](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/workday-ai-inference-guardrails.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/王阳明心学被anthropic用来教claude做人了.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/teaching-models-to-forget-selective-unlearning-with-amazon-nova.md)
...
> 📊 Level ⭐⭐⭐⭐⭐ | 2.6KB | `entities/ai-philosophers-ethics-alignment-deepmind-anthropic-2026.md`
...
AI对齐不仅是技术问题——如何让AI遵守规则——更是哲学问题：该让AI遵守谁的规则？当人类自身在道德问题上没有共识时，如何让一个非人的智能体内化"人的善"？Google DeepMind的哲学研究团队（由牛津大学政治理论学博士Iason Gabriel领导）试图通过"公平对齐原则"消解这一困境，提出对齐必须满足全球公共道德、假说同意、社会选择理论三大标准。

## DeepMind 的哲学团队

DeepMind早在2017年成立伦理与社会研究部门。2026年4月，公司进一步聘用剑桥大学Henry Shevlin担任"哲学家"一职，专注于机器意识、人类与AI关系及AGI准备就绪度研究。Shevlin提出了"行为主义的复仇"概念——当亿万用户在日常交互中将AI视为有意识主体时，AI是否具有意识的问题已被交互行为本身所回答。他建议建立外部行为输出、内部表征逻辑、普适道德原则三层评估框架。

## Anthropic 的实践路径

Anthropic走的是"技术+哲学"融合路线，由哲学家Amanda Askell领导的"人格对齐团队"主导制定了Claude的"宪法"——一份约23000字的开源文件，是目前全球最成熟的AI伦理约束文档之一。

## 争议：自律还是表演？

OpenAI的"超级对齐"团队（由Ilya Sutskever和Jan Leike领导）在成立不到一年后解散，安全研究职能被分散到其他团队中。批评者质疑：公司雇佣哲学家解决伦理问题，到底是真正的自律，还是一场自说自话？

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/ai-公司为何把哲学家请进实验室.md)
