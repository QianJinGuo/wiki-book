...
- [Agent Harness Context Management Working Set](ch05/085-harness.md) — Agent 上下文管理与角色隔离
...
- [LASER ACL 2026 视觉推理](ch01/1146-laser-acl2026-latent-superposition-visual-reasoning.md) — **互补**: 同样针对 VLM, 但用 latent superposition 路线
- [DeepSeek 视觉原语](ch09/150-deepseek-visual-primitives.md) — **对比**: DeepSeek 用"视觉原语"做视觉推理的另一种思路

### 视觉/多模态相关
- [LLaVA-OneVision-2 全帧率 VLM](ch01/734-vlm.md) — VLM 架构
...
- [Laser Acl2026 Latent Superposition Visual Reasoning](ch01/1146-laser-acl2026-latent-superposition-visual-reasoning.md)
...
## 相关实体
- [visual para-thinker: 视觉并行思考框架 (arxiv 2602.13310)](ch01/734-vlm.md)
...
**与 [Agent Harness Engineering](ch01/216-0.md) 的呼应**：视频 Agent 化的核心瓶颈不是模型本身，而是**编排多种工具（扩散模型 + 传统剪辑）的 Harness 设计**——这正是 [Harness Engineering](ch05/085-harness.md) 的能力被复用的领域。
...
- 与 [Agent Harness Engineering Survey](ch01/216-0.md) 中描述的"AI 编程从一次生成走向多轮推理 + 调试 + 测试 + 提交 PR 的智能体系统"——Ethan 明确判断 **视频生成将经历完全相同的演化**。
...
- **复用 Harness 编排能力**：视频 Agent 的核心是工具编排（扩散模型 + 传统剪辑 + 资产库）——可复用 [Agent Harness Engineering](ch01/216-0.md) 的实践
...
- 与 [Agent Harness Engineering Survey](ch01/216-0.md) 互补：Harness 在视频 Agent 时代的能力复用
