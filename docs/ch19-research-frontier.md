...
- [DeepSeek 视觉原语](ch09/126-deepseek-visual-primitives.md) — **对比**: DeepSeek 用"视觉原语"做视觉推理的另一种思路
...
- [Deepseek Visual Primitives Thinking](ch09/126-deepseek-visual-primitives.md)
