...
参考 [AlphaEvolve Impact](ch04/378-alphaevolve-impact-deepmind.md) 和 [AlphaEvolve 一周年](ch04/310-ai.md) 了解 DeepMind 路线。
...
- 关联 entity：[Alphaevolve Impact Deepmind](ch04/378-alphaevolve-impact-deepmind.md)、[Agent Self Improvement Six Mechanisms](ch04/503-agent.md)、[Ai Recursive Self Improvement Nanogpt Prime Intellect](ch04/310-ai.md)、[Hermes Self Improving Loop Winty](https://github.com/QianJinGuo/wiki/blob/main/entities/hermes-self-improving-loop-winty.md)、[Deli Auto Research Skill V2 Continual Learning Self Improvement](ch04/245-skill.md)
...
- [DeepSeek 视觉原语](ch09/125-deepseek-visual-primitives.md) — **对比**: DeepSeek 用"视觉原语"做视觉推理的另一种思路
...
- [Deepseek Visual Primitives Thinking](ch09/125-deepseek-visual-primitives.md)
...
- [对图像内容进行精确分析 — bedrock 多模态案例实践（汽车油表识别）](ch11/236-bedrock.md)
...
- [some ideas for what comes next, may 2026 (interconnects)](ch01/937-some-ideas-for-what-comes-next-may-2026-interconnects.md)
