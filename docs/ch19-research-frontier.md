...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/美团-海报生成-aigc-技术创新实践-2026.md)
...
> **Background**：本文基于机器之心报道 [Arxiv Independent Nonprofit 2026 07 02](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/arxiv-independent-nonprofit-2026-07-02.md) 综合整理。arXiv 于 2026 年 7 月 1 日正式脱离康奈尔大学，转型为独立非营利组织 arXiv, Inc.
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/2026-06-30-AI圈刚开始谈Loop-Engineering-两位95后博士已经盯上了人类闭环-机器之心.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/loopwm-loop-world-models-2026-07-01.md)

## 关联

- → [第 1 来源（原始论文）原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/loopwm-looped-world-models.md)
- → [第 2 来源（机器之心）原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/2026-06-30-AI圈刚开始谈Loop-Engineering-两位95后博士已经盯上了人类闭环-机器之心.md)
- → [第 3 来源（量子位）原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/loopwm-loop-world-models-2026-07-01.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/genception-video-gen-models-general-purpose-vision-learners-arxiv-2607.md)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/huawei-fuxi-recommendation-system-ascend-npu-scaling-law.md)
...
→ [Claude Code 源码解析](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/claude-code-source-deep-dive-warrior.md) 的内部机制探索
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/世界模型的deepseek时刻魔芯flash-world-model降本70跑出50fps实时交互.md)

---

## Ch19.017 Qwen-AgentWorld: Language World Models for General Agents
...
## Ch19.019 标题取得好，Accept跑不了：NeurIPS in ICML论文标题技巧
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/neurips-in-icml-paper-title-tips-guidance-2026.md)

---

## Ch19.020 BAAI Orca — 智源悟界 RoboBrain Next-State Prediction 世界模型
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/baai-orca-next-state-prediction-world-model.md)

---

## Ch19.021 唐杰内部信曝光：两年死磕ASI！ — 智谱ASI路线图与Touch High计划
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/tangjie-zhipu-asi-internal-letter-2026.md)
