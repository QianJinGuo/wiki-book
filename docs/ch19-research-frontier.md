...
- [Spotify LLM Evals](ch01/1171-llm.md) —— 类比案例：Spotify 使用 LLM judges 进行 A/B 测试评估时，同样面临双层校准挑战——代理指标之上再增加代理指标，两层都可能漂移，这与 Pangram 在学术场景中的校准失效问题形成跨领域的方法论共鸣
...
参考 [AlphaEvolve Impact](ch04/410-alphaevolve-impact-deepmind.md) 和 [AlphaEvolve 一周年](ch04/069-ai.md) 了解 DeepMind 路线。
...
- **AI 进步已可被 AI 加速**：三个 SOTA 提升都不是"渐近修补"而是**数量级加速**（1.3× speedup、18% gap 缩小）。这与 [NanoGPT-Prime 递归自改进](ch04/069-ai.md) 路线同向。
...
- 关联 entity：[Alphaevolve Impact Deepmind](ch04/410-alphaevolve-impact-deepmind.md)、[Agent Self Improvement Six Mechanisms](ch03/045-agent.md)、[Ai Recursive Self Improvement Nanogpt Prime Intellect](ch04/069-ai.md)、[Hermes Self Improving Loop Winty](https://github.com/QianJinGuo/wiki/blob/main/entities/hermes-self-improving-loop-winty.md)、[Deli Auto Research Skill V2 Continual Learning Self Improvement](ch04/258-skill.md)
...
- [Agent Harness Context Management Working Set](ch05/009-harness.md) — Agent 上下文管理与角色隔离
...
- [Gaode Ai Companion Agent Architecture](ch04/069-ai.md)
...
### 同范式生态
- [ICML 2026 NPR 文本原生并行推理](ch01/216-0.md) — **同源**: 都推动"推理宽度扩展", NPR 在文本领域开辟
- [LASER ACL 2026 视觉推理](ch01/1173-laser-acl2026-latent-superposition-visual-reasoning.md) — **互补**: 同样针对 VLM, 但用 latent superposition 路线
- [DeepSeek 视觉原语](ch09/150-deepseek-visual-primitives.md) — **对比**: DeepSeek 用"视觉原语"做视觉推理的另一种思路

### 视觉/多模态相关
- [LLaVA-OneVision-2 全帧率 VLM](ch01/759-vlm.md) — VLM 架构
- [a16z 视觉 AI 下一个前沿是代码](ch04/069-ai.md) — 视觉 AI 趋势

### 推理范式
- [LLM 语言思维机制](ch01/1171-llm.md) — 推理机制基础
- [Layered Thinking 分层思维](ch04/069-ai.md) — 推理范式

## 相关实体

- [Native Parallel Reasoner Icml2026](ch01/216-0.md)
- [Laser Acl2026 Latent Superposition Visual Reasoning](ch01/1173-laser-acl2026-latent-superposition-visual-reasoning.md)
- [Llava Onevision 2 Full Frame Rate Vlm Glintlab](ch01/759-vlm.md)
- [Deepseek Visual Primitives Thinking](ch09/150-deepseek-visual-primitives.md)
- [Llm Language Thinking Mechanisms](ch01/1171-llm.md)- [count anything - 文本引导的通用目标计数框架](ch01/216-0.md)
- [language models need sleep: arxiv 2606.03979 持续学习 2 阶段范式](ch01/216-0.md)
...
## 相关实体
- [visual para-thinker: 视觉并行思考框架 (arxiv 2602.13310)](ch01/759-vlm.md)
- [qwen-image-flash: beyond objective design — few-step distill](ch01/1157-qwen-image-flash-beyond-objective-design-few-step-distill.md)
- [对图像内容进行精确分析 — bedrock 多模态案例实践（汽车油表识别）](ch11/251-bedrock.md)
...
## 相关实体
- [Onereason Kuaishou Reasoning Recommender System](ch04/069-ai.md)
- [Glm5 Scaling Pain](ch04/069-ai.md)
- [Video Agent Paradigm Compute Talent Flywheel Ethan He 20260606](ch01/216-0.md)
- [Noam Brown Ai Evaluation Reasoning Budget Performance Cost Curve](ch04/069-ai.md)
- [Aws Sagemaker Azerbaijani Lm](ch04/069-ai.md)
...
**与 [Agent Harness Engineering](ch05/009-harness.md) 的呼应**：视频 Agent 化的核心瓶颈不是模型本身，而是**编排多种工具（扩散模型 + 传统剪辑）的 Harness 设计**——这正是 [Harness Engineering](ch05/009-harness.md) 的能力被复用的领域。
...
- 与 [Agent Harness Engineering Survey](ch05/009-harness.md) 中描述的"AI 编程从一次生成走向多轮推理 + 调试 + 测试 + 提交 PR 的智能体系统"——Ethan 明确判断 **视频生成将经历完全相同的演化**。
...
### 与研究组织 / 算力
[AI Native 研发组织设计](ch04/069-ai.md) + [Ai Native Rd Org Design Xiaobin](ch04/069-ai.md) 中都暗示了**算力 = 研究上限**的趋势。Ethan 的访谈是**第一手证据**——"GPU 富人也出来找算力"。

### 与 Agent 时代的人才竞争
- [中文 AI 实验室 Nathan 洞察](ch04/069-ai.md)——Ethan 的"算力-人才飞轮"是这些上层判断的**微观机制**
...
- **复用 Harness 编排能力**：视频 Agent 的核心是工具编排（扩散模型 + 传统剪辑 + 资产库）——可复用 [Agent Harness Engineering](ch05/009-harness.md) 的实践
- **从"一次生成"到"生产级工作流"**：与 [画布 Agent 时代](ch04/069-ai.md) + [AI 视频工具第三阶段](ch04/069-ai.md) 的演化趋势一致
...
- 与 [Agent Harness Engineering Survey](ch05/009-harness.md) 互补：Harness 在视频 Agent 时代的能力复用
- 与 [画布 Agent 时代](ch04/069-ai.md) + [AI 视频工具第三阶段](ch04/069-ai.md) 互补：第一手研究人员视角补全产品视角
- 与 [Foundation Capital agent era 六洞察](ch04/181-foundation-capital-agent-era-six-insights.md) 互补：算力-人才飞轮的微观机制
...
## 相关实体
- [Natural Language Autoencoders — Anthropic 激活→文字可解释性方法](ch01/1200-natural-language-autoencoders-anthropic.md)
...
- [Skill-RM: Reward Model as Agent Skill](ch04/258-skill.md)
...
- [mira + mpa：深度原理 ai scientist 递归自训练打造材料基座模型，40 项实验全面 sota](ch04/069-ai.md)
- [some ideas for what comes next, may 2026 (interconnects)](ch01/216-0.md)
