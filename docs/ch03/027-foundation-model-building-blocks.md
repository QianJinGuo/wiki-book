...
## Summary
*(See [raw article](https://huggingface.co/blog/amazon/foundation-model-building-blocks))*
...
- [Genesis AI GENE-26.5 具身基础模型](https://github.com/QianJinGuo/wiki-public/blob/main/entities/genesis-ai-gene-25-embodied-foundation-model.md)
