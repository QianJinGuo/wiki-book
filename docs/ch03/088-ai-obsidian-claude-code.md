...
## Ch03.088 开源 AI 知识管理搭档 Obsidian + Claude Code 完整集成指南
...
- [打造可靠的 AI 编程环境：Claude Code Hooks 完整开发者指南](ch05/100-ai.html)
- [Obsidian + Claude Code 集成指南](ch03/084-claude-code.html)

- [微信读书官方skill与huashu-weread增强版](ch04/341-skill.html)
