...
## Ch03.078 pi-mono — 模块化 AI Agent 构建平台（OpenClaw 执行引擎核心）
...
## 相关
- [Openclaw Prompt Context Harness](../ch11/255-openclaw.html) — OpenClaw 架构，pi-mono 是它的 Agent 执行引擎
...
- [Agentcore Harness](../ch04/784-agentcore-harness.html) — AWS 托管 Harness 平台
