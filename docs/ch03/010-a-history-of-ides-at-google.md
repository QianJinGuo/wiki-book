...
> 📊 Level ⭐⭐ | 5.6KB | `entities/a-history-of-ides-at-google.md`
...
## 相关实体
- [Cli Mcp Sdk Agent Tool Selection](https://github.com/QianJinGuo/wiki-public/blob/main/entities/cli-mcp-sdk-agent-tool-selection.md)
...
→ [原文存档](https://laurent.le-brun.eu/blog/a-history-of-ides-at-google)
