...
## Agent 兼容性
支持 OpenClaw, [OpenCLI](ch03/094-opencli.html), Nanobot, Claude Code, Codex, Antigravity 等主流 Agent。
安装命令：
```bash
...
## Related
- [AutoCLI](ch03/130-autocli.html) — 极速网页信息获取 CLI
