...
## Ch03.134 Karpathy LLM Wiki 搭建实战——Obsidian + AGENTS.md 实现三层架构与三大操作
...
这与 [LLM Wiki 架构](../ch01/607-llm.html) 实体互补——该实体侧重概念框架，本文侧重具体实现。也与本 wiki 自身的运作模式一致（见 [Hermes Skills LLM Wiki](../ch07/017-hermes-skill.html)）。
