...
- **同 LLM Wiki / Obsidian 知识管理**：
  ...
  - [Obsidian 工具概览](../ch01/883-claude-code-memory-setup-obsidian-graphify.html)
  - [Claude Code Memory Setup (Obsidian + Graphify)](../ch01/883-claude-code-memory-setup-obsidian-graphify.html)
- **同 Hermes Agent 生态**：
