...
4. **"先只读再写"是初始化对齐而非谨慎措施**：步骤 5 的初始化检查（读 SCHEMA.md / index.md / log.md 并总结结构）的本质是**在 Agent 和 Wiki 之间建立共同认知基底**，确保 Agent 理解目录角色和操作规范。这与 [Karpathy LLM Wiki v2](../ch01/610-llm.html) 的"LLM Wiki 是关于如何组织知识而非存储知识"的核心理念一脉相承。
...
- **同 LLM Wiki / Obsidian 知识管理**：
  ...
  - [Karpathy LLM Wiki v2](../ch01/610-llm.html)（原始方法论）
  - [Karpathy LLM Wiki 第二大脑](../ch01/610-llm.html)
  - [Obsidian 工具概览](../ch01/934-claude-code-memory-setup-obsidian-graphify.html)
  - [Claude Code Memory Setup (Obsidian + Graphify)](../ch01/934-claude-code-memory-setup-obsidian-graphify.html)
- **同 Hermes Agent 生态**：
  - [Hermes Skills + LLM Wiki 越用越懂你](../ch07/017-hermes-skill.html)（三层互相喂养）
  - [Hermes Agent 自进化机制源码解析](ch03/093-hermes-agent.html)
  - [Hermes Agent Memory System vs OpenClaw](ch03/093-hermes-agent.html)
- **同上下文工程 / 记忆架构**：
  ...
  - [企业 AI 记忆 substrate 三层架构](../ch05/091-ai.html)
