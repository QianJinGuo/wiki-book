...
这种设计理念与 [Code As Agent Harness Survey 2026](ch09/051-code-as-agent-harness.md) 中描述的 Agent Harness 模式高度契合——OpenAgents 本质上是一个"协作层 Harness"。^[inferred]
...
### 与 [Hermes Agent V014 Architecture Shugex](ch01/216-0.md) 的关系
...
### 与 [Building Web Search Enabled Agents With Strands And Exa](ch04/411-building-web-search-enabled-agents-with-strands-and-exa.md) 的互补
...
- [Building Web Search Enabled Agents With Strands And Exa](ch04/411-building-web-search-enabled-agents-with-strands-and-exa.md)
