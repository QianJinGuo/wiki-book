...
这种设计理念与 [Code As Agent Harness Survey 2026](https://github.com/QianJinGuo/wiki/blob/main/entities/code-as-agent-harness-survey-2026.md) 中描述的 Agent Harness 模式高度契合——OpenAgents 本质上是一个"协作层 Harness"。^[inferred]
...
### 与 [Hermes Agent V014 Architecture Shugex](https://github.com/QianJinGuo/wiki/blob/main/entities/hermes-agent-v014-architecture-shugex.md) 的关系
...
### 与 [Building Web Search Enabled Agents With Strands And Exa](https://github.com/QianJinGuo/wiki/blob/main/entities/building-web-search-enabled-agents-with-strands-and-exa.md) 的互补
...
- → [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/openagents-workspace-multi-agent-collaboration-itech.md)
