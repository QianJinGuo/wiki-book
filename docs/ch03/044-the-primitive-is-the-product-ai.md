...
- [AI-Native 分层思维](https://github.com/QianJinGuo/wiki/blob/main/entities/ai-native-dan-shipper-every-layered-thinking-walkwalk.md) — AI 时代的产品思维框架
- [Stripe Agent 经济基础设施](https://github.com/QianJinGuo/wiki/blob/main/entities/stripe-agent-economic-infrastructure-5-products.md) — Stripe 的 Agent-first 产品实践
- [Stripe Agent 基础设施（Emily Sands）](https://github.com/QianJinGuo/wiki/blob/main/entities/stripe-agent-economic-infrastructure-emily-sands.md) — 支付原语的 agent 生态扩展
- [AI-Native 研发组织设计](https://github.com/QianJinGuo/wiki/blob/main/entities/ai-native-rd-org-design.md) — 组织如何适应 AI 时代
- [AI-Native 组织指南](https://github.com/QianJinGuo/wiki/blob/main/entities/ai-native-org-guide-slowdown.md) — AI 时代的组织原则

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/primitive-is-the-product-amplify-partners.md)
