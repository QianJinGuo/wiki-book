...
- [AI-Native 分层思维](ch04/150-ai.md) — AI 时代的产品思维框架
- [Stripe Agent 经济基础设施](ch03/044-agent.md) — Stripe 的 Agent-first 产品实践
- [Stripe Agent 基础设施（Emily Sands）](ch03/044-agent.md) — 支付原语的 agent 生态扩展
- [AI-Native 研发组织设计](ch04/150-ai.md) — 组织如何适应 AI 时代
- [AI-Native 组织指南](ch04/150-ai.md) — AI 时代的组织原则
