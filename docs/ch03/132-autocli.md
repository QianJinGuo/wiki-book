...
## autocli-skill
专为 ClaudeCode / [OpenCLI](ch03/095-opencli.html) / [Hermes-Agent](ch03/099-hermes-agent.html) 设计的 Skill，让 AI Agent 能够获取整个互联网的信息、抓取任意网页内容。
...
## Related
- [CLI-Anything](ch03/106-cli-anything.html) — 让所有软件 Agent 原生化
- [AgentBrowser](../ch09/080-agent-browser-claude-code-qoderwork.html) — AI 专用浏览器
