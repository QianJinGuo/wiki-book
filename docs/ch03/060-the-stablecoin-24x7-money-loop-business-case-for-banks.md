...
## Ch03.060 The stablecoin 24x7 money loop: business case for banks
...
- [Agentcore Payments X402 Agentic Commerce](ch04/502-agent.md) — AWS Bedrock AgentCore x402 协议（agent-to-agent 支付）
