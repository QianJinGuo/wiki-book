...
## Ch03.073 pi-mono — 模块化 AI Agent 构建平台（OpenClaw 执行引擎核心）
...
```mermaid
mindmap
  root(("pi-mono — 模块化 AI Agent 构建平台（…"))
    项目信息
    架构概述
      与 OpenClaw 的分工
      核心设计理念
...
## 相关
- [Openclaw Prompt Context Harness](../ch11/235-openclaw.html) — OpenClaw 架构，pi-mono 是它的 Agent 执行引擎
- [Harness Engineering Systematic Framework](../ch05/120-harness-engineering.html) — Harness Engineering 框架
...
- [Agentcore Harness](../ch04/689-agentcore-harness.html) — AWS 托管 Harness 平台
