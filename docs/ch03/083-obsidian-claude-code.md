...
- **策略 3（MCP 桥接）**：代码仓库和 Obsidian 完全分离，通过 [obsidian-claude-code-mcp](ch03/084-claude-code.html) 这类插件让 Claude 按需访问 Obsidian
...
- [Obsidian Claude Code Integration](ch03/084-claude-code.html) — 集成实践综述
- [Obsidian](ch09/146-obsidian-claude-code-integration-guide.html) — Obsidian 实体页
