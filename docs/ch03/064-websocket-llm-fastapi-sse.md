...
## Ch03.064 还在用WebSocket做LLM流式传输？FastAPI + SSE让你少踩一半坑
...
- [FastAPI SSE LLM 流式传输实战](../ch11/205-fastapi.html) — 同一主题的补充实践案例
- [FastAPI 认证限流零停机部署](../ch11/205-fastapi.html) — FastAPI 生产部署的最佳实践
- [Python 日志方案对比](../ch04/589-python.html) — 异步应用的可观测性建设

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/fastapi-sse-llm-streaming-vs-websocket-5e4a458abf18.md)
