...
## Related
- [CLI-Anything](../ch03-089-cli-anything/) — 让所有软件 Agent 原生化
- [AutoCLI](../ch03-111-autocli/) — 极速网页信息获取
...
- [Hermes-Agent](../ch04-418-hermes-agent/) — 支持从 OpenCLI 无缝迁移
- OpenClaw — **注意：与 OpenClaw（淘天 Agent 框架）无关系**，两者仅命名相似，实为完全不同项目：OpenCLI = 网页自动化工具，OpenClaw = AI Agent 执行框架
