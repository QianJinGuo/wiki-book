...
- [Harness Engineering Systematic Framework](../ch05/052-harness-engineering.html) — Harness Engineering 框架
...
- [Agentcore Harness](../ch04/654-agentcore-harness.html) — AWS 托管 Harness 平台
