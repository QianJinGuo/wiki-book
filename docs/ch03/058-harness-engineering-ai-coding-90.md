...
- [Claude Code Harness Deep Understanding](../ch01/635-claude-code-harness-deep-understanding.html) — Claude Code harness 另一深度解析
- [Claude Code Harness Deep Dive Founder Park](../ch05/086-claude-code-harness.html) — 同主题的另一种解读视角
- [Claude Code Dynamic Workflows 8Th Translation Xingxiaozhao](../ch09/103-claude-code-dynamic-workflows.html) — Claude Code 动态工作流的翻译对照
...
- [Cline Agent Runtime Sdk](ch03/036-agent.html) — Cline SDK 的分层可移植设计，与 Harness Engineering 形成"开源平台 vs 工程化体系"对照
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](../ch04/289-agentic.html) — Vibe Coding → Agentic Engineering 的范式跃迁
