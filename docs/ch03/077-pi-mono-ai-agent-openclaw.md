...
## Ch03.077 pi-mono — 模块化 AI Agent 构建平台（OpenClaw 执行引擎核心）
...
## 相关
- [Openclaw Prompt Context Harness](../ch11/248-openclaw.html) — OpenClaw 架构，pi-mono 是它的 Agent 执行引擎
- [Harness Engineering Systematic Framework](../ch05/057-harness-engineering.html) — Harness Engineering 框架
...
- [Agentcore Harness](../ch04/755-agentcore-harness.html) — AWS 托管 Harness 平台
