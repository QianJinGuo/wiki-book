...
### 与 [Hermes Agent V014 Architecture Shugex](ch03/093-hermes-agent.html) 的关系
...
### 与 [Building Web Search Enabled Agents With Strands And Exa](../ch04/455-building-web-search-enabled-agents-with-strands-and-exa.html) 的互补
