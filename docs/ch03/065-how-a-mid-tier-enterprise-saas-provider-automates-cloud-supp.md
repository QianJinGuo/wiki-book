...
```mermaid
mindmap
  root(("How a Mid-tier Enterprise SaaS"))
    The Ticket Triage Triangle That
    Mid-Tier SaaS Providers Pain
    Five Agents Unclog Cloud Support
    Hard Metrics Prove the Impact
    Why This Matter for Enterprise
    五智能体工作流的设计逻辑与多智能体协作模式的对应关系
    Ticket Triage
    从Brittle Automation到Agentic
```
