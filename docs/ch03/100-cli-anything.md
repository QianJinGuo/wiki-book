...
## Agent 兼容性
支持 OpenClaw, [OpenCLI](ch03/087-opencli.html), Nanobot, Claude Code, Codex, Antigravity 等主流 Agent。
安装命令：
```bash
...
## 与 [Hermes-Agent](ch03/095-hermes-agent.html) 的关系
 支持通过 Skill 机制调用外部 CLI 工具，CLI-Anything 正是此类工具的重要来源之一。

## Related
- [AutoCLI](ch03/124-autocli.html) — 极速网页信息获取 CLI
