...
这揭示了大型传统企业 AI 落地的关键前置条件——在 60 年历史的品牌上建立统一数据模型耗时巨大，但没有这个基础，AI 系统无法获得一致的训练信号。这与 [Netflix ML 平台建设](../ch11/243-democratizing-machine-learning-at-netflix-building-the-mode.md) 中讨论的数据治理挑战高度相似。
...
这与 [Platformer AI 就业影响讨论](../ch04/229-ai.md) 中 Box CEO 的观点形成呼应——技术是手段，业务价值才是目的。
...
- [Platformer Ai Job Loss Levie](../ch04/229-ai.md)
