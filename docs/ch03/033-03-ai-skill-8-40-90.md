...
## Ch03.033 03—AI Skill 测试用例设计完整指南：8 种类型 + 断言自检，覆盖率从 40% 到 90%
...
```mermaid
mindmap
  root(("03—AI Skill 测试用例设计完整指南：8 种类型…"))
    相关实体
    深度分析
    实践启示
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/ai-skill-测试用例设计.md)
