...
## Ch03.085 How Yahoo enhances search retargeting using Amazon Bedrock
...
- [Amazon Bedrock](../ch11/310-amazon-bedrock.html) — The serverless FM platform used by Yahoo for LLM access and inference
