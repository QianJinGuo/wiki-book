...
## Ch03.092 设计系统的新作者：从 Agent 读到 Agent 写
...
- [Figma MCP 的四种用法](../ch07/001-mcp.html) — Figma 的实践案例，展示了 Agent 如何使用 MCP 操作设计系统
- [Anthropic Skill Stack 架构](../ch01/1215-anthropic.html) — Agent Skills 规范的工程实现
...
- [Claude Code 治理软规则](ch03/084-claude-code.html) — 探讨 Agent 行为的治理模式与审查策略
- [设计发现性](https://github.com/QianJinGuo/wiki/blob/main/entities/lovable-discoverability-intro.md) — 探讨设计系统在 AI 时代的可发现性

## 参考来源

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/design-systems-agent-author-evolution-murphytrueman.md)
