...
## Ch03.104 FastAPI SSE — LLM流式传输的WebSocket替代方案
...
- [Thinking Machines 交互模型（Interaction Models）](../ch04/324-thinking-machines-interaction-models.html)
- [SGLang](../ch04/715-agent-assisted-sglang-ai-llm.html)

- [Fastapi Sse Llm Streaming Vs Websocket 5E4A458Abf18](../ch11/093-fastapi.html)
## 深度分析
