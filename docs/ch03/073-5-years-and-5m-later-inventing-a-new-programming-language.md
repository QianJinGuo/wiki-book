...
这与 [AI 友好架构设计](ch04/069-ai.md)中的核心思想完全一致：能让 AI 和人类同时推理应用结构的「单一真理源（single source of truth）」才是关键，载体是 DSL 还是 TS 是次要选择。
...
- [Ai Friendly Architecture Design Taobao](ch04/069-ai.md) — AI 友好架构设计
- [Anthropic Claude Code Large Codebase Best Practices 50002A089323](ch03/075-claude-code.md) — 大代码库最佳实践
...
- [qwen code skill testing framework: recording, playback, and](ch04/258-skill.md)
