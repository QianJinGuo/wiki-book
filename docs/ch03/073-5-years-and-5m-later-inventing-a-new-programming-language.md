...
这与 [AI 友好架构设计](ch04/277-ai.md)中的核心思想完全一致：能让 AI 和人类同时推理应用结构的「单一真理源（single source of truth）」才是关键，载体是 DSL 还是 TS 是次要选择。
...
- [Ai Friendly Architecture Design Taobao](ch04/277-ai.md) — AI 友好架构设计
...
- [qwen code skill testing framework: recording, playback, and](ch04/256-skill.md)
