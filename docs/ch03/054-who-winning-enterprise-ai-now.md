...
## Ch03.054 Who Winning Enterprise AI Now
...
- [Claude's next enterprise battle: 从模型之争到 agent 控制平面](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claudes_next_enterprise_battle_is_not_mo.md)
- [Anthropic](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic.md)
- [OpenAI 收购 AI 咨询公司加码企业市场](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openai-buys-ai-consultancy-enterprises.md)
- [企业 AI 投资与数据就绪度](https://github.com/QianJinGuo/wiki-public/blob/main/entities/enterprise-ai-investment-data-readiness-cio.md)
- [AI tool poisoning：企业 agent 安全缺陷](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-security-v2.md)
- [Amazon Quick：从企业数据到 AI 决策](https://github.com/QianJinGuo/wiki-public/blob/main/entities/amazon-quick-accelerating-the-path-from-enterprise-data-to-ai-powered-decisions.md)
