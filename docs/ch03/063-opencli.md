...
## Related
- [CLI-Anything](../ch04/316-cli-anything-agent-gui.html) — 让所有软件 Agent 原生化
- [AutoCLI](https://github.com/QianJinGuo/wiki-public/blob/main/entities/autocli.md) — 极速网页信息获取
- [AgentBrowser](../ch04/276-chromium-blink-v8-agent-browser-use.html) — AI 专用浏览器
...
- [Hermes-Agent](066-hermes-agent.html) — 支持从 OpenCLI 无缝迁移
