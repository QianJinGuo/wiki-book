...
## Ch03.045 The Primitive is the Product — AI 时代的产品哲学：从功能到原语
...
- [AI-Native 分层思维](../ch05/019-ai-native.html) — AI 时代的产品思维框架
- [Stripe Agent 经济基础设施](ch03/046-agent.html) — Stripe 的 Agent-first 产品实践
- [Stripe Agent 基础设施（Emily Sands）](ch03/046-agent.html) — 支付原语的 agent 生态扩展
- [AI-Native 研发组织设计](../ch05/019-ai-native.html) — 组织如何适应 AI 时代
- [AI-Native 组织指南](../ch05/019-ai-native.html) — AI 时代的组织原则
