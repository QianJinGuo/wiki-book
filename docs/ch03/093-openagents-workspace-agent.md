...
这种设计理念与 [Code As Agent Harness Survey](../ch09/060-code-as-agent-harness.html) 中描述的 Agent Harness 模式高度契合——OpenAgents 本质上是一个"协作层 Harness"。^[inferred]
...
### 与 [Building Web Search Enabled Agents With Strands And Exa](../ch04/546-building-web-search-enabled-agents-with-strands-and-exa.html) 的互补
