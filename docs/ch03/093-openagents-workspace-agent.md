...
## Ch03.093 OpenAgents Workspace：多 Agent 协作平台
...
这种设计理念与 [Code As Agent Harness Survey](../ch09/062-code-as-agent-harness.html) 中描述的 Agent Harness 模式高度契合——OpenAgents 本质上是一个"协作层 Harness"。^[inferred]
...
### 与 [Hermes Agent V014 Architecture Shugex](ch03/098-hermes-agent.html) 的关系
...
### 与 [Building Web Search Enabled Agents With Strands And Exa](../ch04/557-building-web-search-enabled-agents-with-strands-and-exa.html) 的互补
