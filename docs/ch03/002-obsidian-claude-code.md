...
- [Agent Memory 架构](ch04/503-agent.md) — 与 Obsidian vault 记忆模式的思想关联
- [Claude Code Hackathon 经验](ch03/073-claude-code.md) — Claude Code 实战相关
...
- [gstack — AI协作开发工作流 & 复杂度棘轮](ch04/310-ai.md)
