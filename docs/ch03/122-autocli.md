...
## autocli-skill
专为 ClaudeCode / [OpenCLI](ch03/086-opencli.html) / [Hermes-Agent](ch03/093-hermes-agent.html) 设计的 Skill，让 AI Agent 能够获取整个互联网的信息、抓取任意网页内容。
...
## Related
- [CLI-Anything](ch03/098-cli-anything.html) — 让所有软件 Agent 原生化
