...
## Ch03.087 设计系统的新作者：从 Agent 读到 Agent 写
...
- [Anthropic Skill Stack 架构](../ch01/989-anthropic.html) — Agent Skills 规范的工程实现
...
- [Claude Code 治理软规则](ch03/078-claude-code.html) — 探讨 Agent 行为的治理模式与审查策略
