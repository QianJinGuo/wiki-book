...
## 相关实体
- [Tether launches developer grants program for local AI payments](../ch09/143-tether-launches-developer-grants-program-for-local-ai-paymen.html) — 同一事件的平行条目
- [Tether launches developer grants program for local-first AI and payments infrastructure](../ch11/207-tether-launches-developer-grants-program-for-local-first-ai.html) — 同一事件的平行条目
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/tether-developer-grants-local-ai.md)
