...
> 📊 Level ⭐⭐⭐⭐⭐ | 31.6KB | `entities/harness-engineering耗时一周我是如何将应用的ai-coding率提升至90的.md`
...
- [Claude Code Harness Deep Understanding](../ch01/258-claude-code-harness-deep-understanding.html) — Claude Code harness 另一深度解析
...
- [Cline Agent Runtime Sdk](https://github.com/QianJinGuo/wiki-public/blob/main/entities/cline-agent-runtime-sdk.md) — Cline SDK 的分层可移植设计，与 Harness Engineering 形成"开源平台 vs 工程化体系"对照
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](https://github.com/QianJinGuo/wiki-public/blob/main/entities/karpathy-最新访谈从-vibe-coding-到-agentic-engineering.md) — Vibe Coding → Agentic Engineering 的范式跃迁
