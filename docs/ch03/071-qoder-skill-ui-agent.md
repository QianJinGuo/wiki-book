...
## Ch03.071 Qoder Skill UI — Agent 与人类的协作界面层
...
## 与 [Agent Skill Writing](../ch04/600-agent-skill.html) 的关系
...
## 相关主题
- [Claude Design Skill](../ch01/1355-claude-design-skill.html) — 设计领域 Skill 的实战案例（420行系统提示词 → Skill）
