...
> -> [harness-engineering耗时一周我是如何将应用的ai-coding率提升至90的.md](https://mp.weixi)
...
- [两万字详解Claude Code源码核心机制](057-claude-code.html) — Claude Code 源码级机制详解，与本文互补
- [深入理解 Claude Code 源码中的 Agent Harness 构建之道](../ch05/035-agent-harness.html) — Claude Code harness 设计的深度剖析
- [Claude Code Harness Deep Understanding](../ch01/338-claude-code-harness-deep-understanding.html) — Claude Code harness 另一深度解析
- [Claude Code Harness Deep Dive Founder Park](../ch05/059-claude-code-harness.html) — 同主题的另一种解读视角
- [Claude Code Dynamic Workflows 8Th Translation Xingxiaozhao](../ch09/073-claude-code-dynamic-workflows.html) — Claude Code 动态工作流的翻译对照
...
- [存之有序治之有矩Agent 记忆系统的工程实践与演进](004-agent.html) — Agent 记忆系统的工程实践，与"持久化在文件系统"理念呼应
- [Cline Agent Runtime Sdk](004-agent.html) — Cline SDK 的分层可移植设计，与 Harness Engineering 形成"开源平台 vs 工程化体系"对照
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](004-agent.html) — Vibe Coding → Agentic Engineering 的范式跃迁
