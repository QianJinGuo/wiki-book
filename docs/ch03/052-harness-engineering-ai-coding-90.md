...
- [Claude Code Dynamic Workflows 8Th Translation Xingxiaozhao](../ch09/088-claude-code-dynamic-workflows.html) — Claude Code 动态工作流的翻译对照
...
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](../ch04/610-agentic.html) — Vibe Coding → Agentic Engineering 的范式跃迁
