...
## Ch03.061 The stablecoin 24x7 money loop: business case for banks
...
- [Agentcore Payments X402 Agentic Commerce](../ch11/065-agentcore-payments.md) — AWS Bedrock AgentCore x402 协议（agent-to-agent 支付）
- [Amazon Bedrock Agentic Payments Guardrails](../ch11/152-amazon-bedrock.md) — Bedrock agentic payments 护栏
...
- [Tether Launches Developer Grants Program For Local Ai Paymen](../ch09/120-tether-launches-developer-grants-program-for-local-ai-paymen.md) — Tether 本地 AI 支付开发者资助
- [Crypto Funds Six Week Inflow Streak 4 9 Billion Coinshares](../ch01/682-9.md) — 加密基金 6 周连续流入
- [The Token Economy Pt2 The Intelligence Company Gets Built](../ch01/002-the-token-economy-pt2-the-intelligence-company-gets-built.md) — Token 经济与 AI 智能公司
