...
## Ch03.124 Bedrock AgentCore Pool Model Multi-Tenancy

> 📊 Level ⭐⭐ | 4.0KB | `entities/shared-infrastructure-isolated-tenants-pool-model-multi-tenancy-with-amazon-bedrock-agentcore.md`
...
- [Protein Research Copilot](../ch04/535-amazon-bedrock-agentcore.html) — 同系列文章，聚焦 AgentCore 的单租户 Agent 应用
