...
- [Claude Code Dynamic Workflows 8Th Translation Xingxiaozhao](ch03/077-claude-code.html) — Claude Code 动态工作流的翻译对照
...
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](ch03/035-agent.html) — Vibe Coding → Agentic Engineering 的范式跃迁
