...
- [Cline Agent Runtime Sdk](ch04/502-agent.md) — Cline SDK 的分层可移植设计，与 Harness Engineering 形成"开源平台 vs 工程化体系"对照
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](ch04/502-agent.md) — Vibe Coding → Agentic Engineering 的范式跃迁
