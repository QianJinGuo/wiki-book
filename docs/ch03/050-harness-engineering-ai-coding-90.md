...
## Ch03.050 Harness Engineering 详解：如何将 AI Coding 率提升至 90%
...
- [两万字详解Claude Code源码核心机制](ch03/074-claude-code.md) — Claude Code 源码级机制详解，与本文互补
...
- [Claude Code Dynamic Workflows 8Th Translation Xingxiaozhao](ch03/074-claude-code.md) — Claude Code 动态工作流的翻译对照
...
- [Cline Agent Runtime Sdk](ch03/044-agent.md) — Cline SDK 的分层可移植设计，与 Harness Engineering 形成"开源平台 vs 工程化体系"对照
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](ch03/044-agent.md) — Vibe Coding → Agentic Engineering 的范式跃迁
