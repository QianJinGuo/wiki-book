...
## Ch03.097 FastAPI SSE — LLM流式传输的WebSocket替代方案
...
- [Thinking Machines 交互模型（Interaction Models）](../ch04/252-thinking-machines-interaction-models.html)
- [SGLang](../ch04/612-agent-assisted-sglang-ai-llm.html)

- [Fastapi Sse Llm Streaming Vs Websocket 5E4A458Abf18](../ch11/207-fastapi.html)
## 深度分析
