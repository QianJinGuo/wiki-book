...
## Ch03.059 Harness Engineering 详解：如何将 AI Coding 率提升至 90%
...
- [Cline Agent Runtime Sdk](ch03/006-agent.html) — Cline SDK 的分层可移植设计，与 Harness Engineering 形成"开源平台 vs 工程化体系"对照
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](../ch04/298-agentic.html) — Vibe Coding → Agentic Engineering 的范式跃迁
