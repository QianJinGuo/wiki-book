...
## Ch03.066 Stripe Agent 经济基础设施 5 套图谱：MPP + Link + Projects + Metronome/Tempo + Radar
...
- AI 变现 / 定价 — [Aws Generative Ai Model Agility Framework](../ch11/170-aws-generative-ai-model-agility-framework.html) / [Agent Skills Comprehensive Survey](../ch04/466-agent-skills.html)
- Agent 平台化 — [Baixing Ontoz Enterprise Ontology Multi Agent](ch03/035-agent.html) / [Kimi Work Codex Vibe Working Paradigm Shift](../ch01/737-codex.html)
- Claude Code / Vibe Coding — [Claude Code Architecture](ch03/084-claude-code.html)
- Token 盗窃防护 — [Vscode Github Token Stealing 1 Click Pwn Ammaraskar 2026](../ch01/1183-github.html) / Vercel Token Theft 防护
...
- 稳定币 / 加密 — [Inngest Ai And Backend Workflows Orchestrated At Any Scale](../ch01/1053-inngest-ai-and-backend-workflows-orchestrated-at-any-scal.html)
