...
## Ch03.078 Qoder Skill UI — Agent 与人类的协作界面层
...
## 与 [Agent Skill Writing](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-skill-writing.md) 的关系
...
## 相关主题
- [Claude Design Skill](../ch07/036-claude-design-skill.html) — 设计领域 Skill 的实战案例（420行系统提示词 → Skill）
