...
## 相关工具与资源
- 原文存档
- [Agent Memory 架构](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-memory-architecture.md) — 与 Obsidian vault 记忆模式的思想关联
- [Claude Code Hackathon 经验](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-hackathon-expertise-digitization.md) — Claude Code 实战相关
