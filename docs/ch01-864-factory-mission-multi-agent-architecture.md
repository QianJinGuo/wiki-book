...
## Ch01.864 factory mission multi agent architecture
...
## 相关框架对比
- **[DeerFlow vs Hermes vs OpenClaw](/ch04-398-deerflow-hermes-openclaw-架构区别深度对比/)** — 都是 multi-agent 编排框架，与 Mission 的三角架构有相通之处
