...
- 原文: [追求-ai-记忆力的路线下rag-是否终将被抛弃](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/追求-ai-记忆力的路线下rag-是否终将被抛弃.md)
...
- 原文: [Mem0、Letta、Zep 和 VoltMem —— Agent记忆系统该选哪个？](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/agent-memory-four-schools-comparison-2026-07-22.md)
...
## Ch06.004 深度拆解 Hermes Agent 记忆系统

> 📊 Level ⭐⭐ | 29.5KB | `entities/hermes-agent-memory-system-openclaw-comparison.md`

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/hermes-agent-memory-system-openclaw-comparison.md)
...
- [Hermes Agent 记忆系统深度拆解](ch03/035-agent.html)
- [Hermes Agent vs OpenClaw 对比分析](ch03/035-agent.html)
- [AI Agent Gateway 架构设计 — OpenClaw/Claude Code/Hermes 三框架对比](ch01/1442-claude.html)
- [DeerFlow vs Hermes vs OpenClaw 深度对比](ch01/294-hermes.html)
- [Claude Code vs OpenClaw Agent 记忆系统对比](ch03/084-claude-code.html)
- [Agent Harness 上下文管理：聊天记录还是工作集](ch03/035-agent.html)
- [Claude Code Subagents 详解：上下文污染隔离](ch03/084-claude-code.html)
...
- [Agent Memory 模块化框架与评测](ch03/035-agent.html)
- [深度拆解 Hermes 记忆系统：它修正了 OpenClaw 的哪层误区](ch03/035-agent.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/agentmemory-source-analysis-coding-agent-local-memory.md)

## Related

- [AgentMemory 实体页面](ch09/047-agentmemory-coding-agent.html)
...
## 相关实体
- [Claude Code Openclaw Memory Comparison](ch03/084-claude-code.html)
- [Claude Code Openclaw Usage Ettin](ch09/040-claude-code-openclaw-usage-ettin.html)
- [Harness Engineering 7 Layers Openclaw Hermes Claude Code P1Anu](ch03/084-claude-code.html)
...
- [从 openclaw 到 openhuman：私人 ai runtime 的雏形](ch05/100-ai.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/agent-memory-evaluation-landscape-taobao-survey.md)
...
- [Agent Memory Architecture Essence](ch03/035-agent.html) — Agent 记忆架构本质
- [Agent Memory Architecture Ruofei](ch03/035-agent.html) — Agent 记忆架构（若飞）
- [Agent Memory Modular Framework](ch03/035-agent.html) — Agent 记忆模块化框架
- [Ai Agent Memory Systems](ch05/100-ai.html) — AI Agent 记忆系统
- [Ai Memory Architecture Deep Dive](ch05/100-ai.html) — 记忆架构深度分析
- [Memory In The Llm Era Iclr2026](ch01/1429-0.html) — Memory in the LLM Era（架构层面四组件框架）
- [Agentmemory Coding Agent Local Memory](ch09/047-agentmemory-coding-agent.html) — Coding Agent 本地记忆
- [Claude Code 7 Layer Memory Architecture](ch03/084-claude-code.html) — Claude Code 7 层记忆架构
- [Agent Memory Storage Six Schools Wiki Compile Vs Raw Data Debate](ch03/035-agent.html) — 记忆存储六派之争
- [Agentic Ai Infrastructure Practice Series Nine Context Engineering](ch05/100-ai.html) — AWS Context Engineering（基础设施层）
- [Agent Eval Wallezhang Yaml Driven Agent Evaluation Framework](ch03/035-agent.html) — YAML 驱动的 Agent 评测
- [Taobao Smart Shopping Guide Agent Evaluation Pzmx](ch03/035-agent.html) — 淘宝导购 Agent 评测
...
## Ch06.009 Context Window Management Comparison
...
## Ch06.010 Knowledge Base Layer Architecture: From RAG to Agent-native Knowledge Context Layer
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/pyramid-kb-knowledge-context-layer-banya.md)
...
- [Agent Evolution 四阶段六维](ch03/035-agent.html) — Memory 维度的"文件系统沉淀"与 Pyramid KB 的 L4/L5 对应
- [Hermes Agent Operator](ch03/035-agent.html) — Hermes 的 LLM-Wiki 模式实现（Karpathy 提出的范式二）
- [Claude Code 深度解析](ch03/084-claude-code.html) — Claude Code 的 CLAUDE.md / SKILL.md 是"渐进式披露"实践
...
- [Agent 记忆系统实践](ch03/035-agent.html) — Memory 模块的工程化对照
...
## 相关实体
- [Context Engineering Three Memory Paradigms](https://github.com/QianJinGuo/wiki/blob/main/entities/context-engineering-three-memory-paradigms.md)
- [Agent Memory Architecture Essence](ch03/035-agent.html)
...
这与 [Hermes Agent 记忆系统深度拆解](ch03/035-agent.html) 中提到的"档案室不等于随身备忘录"是同一设计哲学的两面表达。
...
- [Hermes Agent 三级 Memory 架构解析（One掌柜视角）](ch03/035-agent.html) — 同一作者的另一篇分析
- [AI Agent 记忆系统架构](ch04/214-how-ai-agent-memory-works.html) — Agent 记忆系统的通识性框架
- [17种Agent架构演进](ch03/035-agent.html) — 记忆设计在 Agent 演化中的位置
...
- [Skills赏析：使用skills-refiner提升skill质量](ch04/341-skill.html)
...
## 相关实体
- [Ai Job Interview Model Evaluation Mollick](ch05/100-ai.html)
...
- [Management As Ai Superpower Mollick](ch05/100-ai.html)
...
|| 相关文章 | 关联点 |
|---------|--------|
|| [Hermes Agent](ch03/102-hermes-agent.html) | MemOS 是 Hermes 的记忆插件，解决 Hermes 记忆乱的痛点 |
|| [Claude Code 架构解析](ch03/084-claude-code.html) | Claude Code 的 Query Loop 含上下文管理，和 MemOS 的记忆注入思路一致 |
|| [AgentCore Harness](ch04/751-agentcore-harness.html) | AgentCore 管运行时，MemOS 管记忆，是不同维度的 Agent 基础设施 |
...
- [Openclaw Boris Cherny Agent Loop Design Patterns](ch03/035-agent.html)
...
> 原文存档：[原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/google-okf-open-knowledge-format-v0-1-2026.md)
...
→ [LLM Wiki / Obsidian Wiki / GBrain 自组织自进化](ch05/100-ai.html) — 同领域不同项目对比
→ [Karpathy LLM Wiki 第二大脑 (awkthole)](ch05/100-ai.html) — Karpathy Wiki 详细解析
→ [Karpathy LLM Wiki v2 (2026)](ch01/1429-0.html) — Karpathy Wiki 2026 更新
→ [LLM Wiki Architecture](ch01/1476-llm.html) — LLM Wiki 架构
→ [Obsidian + LLM Wiki 本地化 (kytmanov)](ch01/1476-llm.html) — Obsidian 集成 LLM Wiki
→ [知识沉淀是护城河](https://github.com/QianJinGuo/wiki/blob/main/entities/knowledge-mgmt-is-moat.md) — 知识管理护城河论述
→ [腾讯知识 Harness 实践](ch05/085-harness.html) — 腾讯系知识管理
→ [Create Custom MCP Catalogs and Profiles](ch07/055-create-custom-mcp-catalogs-and-profiles.html) — MCP 目录 vs OKF bundle 关系
→ [GBrain](ch05/100-ai.html) — Postgres 持久化 + 知识图谱（可消费 OKF bundle）
...
- [Agent 记忆模块化框架](ch03/035-agent.html)
- [Agent 夜间任务编排](ch03/035-agent.html)
- [注意力塌陷与上下文管理](https://github.com/QianJinGuo/wiki/blob/main/entities/attention-collapse-context-management.md)
- [TencentDB Agent Memory 长期记忆金字塔](ch03/035-agent.html)
...
> 来源：[原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/how-we-built-cognitive-memory-for-agentic-systems.md)
...
## 相关实体
- [Memory Agent Systems Cobanov](ch04/674-memory-agent-systems-cobanov.html)
- [Stripe Sessions 2026 Ai Agents](ch04/432-stripe-sessions-2026-ai-agents.html)
- [Production Harness 12 Components Framework Comparison](ch05/085-harness.html)
- [Hermes Self Evolution Closed Loop Skill Reuse Winty](ch04/341-skill.html)
- [Agent Memory Architecture Past Influence Future Ruofei](ch03/035-agent.html)

## 原文链接

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/how-we-built-cognitive-memory-for-agentic-systems.md)
...
## 相关实体
- [Tmall Ai Coding Practice Team Knowledge Base](ch05/100-ai.html)
- [Tmall Ai Coding Practice Team Knowledge Base Npm](ch05/100-ai.html)
- [Tencent Ai Team Knowledge Harness](ch05/100-ai.html)
- [Tencent Ai Team Knowledge Mgmt Harness Moat](ch05/100-ai.html)
...
# 企业级AI记忆基质三层架构
> 来源：[原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/enterprise-ai-memory-substrate-three-layer-architecture.md) — AI 小老六，2026-05-14
...
## 相关实体
- [AgentMemory — Coding Agent 本地记忆](ch09/047-agentmemory-coding-agent.html) — Agent 记忆工程实践
- [Hermes Agent 三层 Memory](ch03/035-agent.html) — 工程实现视角
...
> 和 [Agent Memory 架构本质](ch03/035-agent.html) 的"write-manage-read 三链路闭环"角度不同，Hermes 更侧重**运行时成本控制和分层治理**。
...
这和 [Agent Harness 上下文管理：工作集视角](ch03/035-agent.html) 的判断一致：**窗口里留下来的，不应该是发生过的一切，而应该是下一轮推理真的要用的工作集**。
...
## 与相关条目的关系
- [Agent Memory 模块化框架与评测](ch03/035-agent.html) — 学术视角（ICLR 2026），四组件统一框架
...
- [ai agent memory systems](ch05/100-ai.html)
...
## 与现有知识的链接
- → [Harness Context Management](ch03/035-agent.html) — Context作为Agent的工作集
...
## 相关实体
- [OpenHuman: AI Agent 持久记忆框架](ch05/100-ai.html)
- [AI Coding Agent 记忆系统](ch05/100-ai.html)
...
- [Hermes-Agent](ch03/102-hermes-agent.html) — 可通过 Local REST API 与 Obsidian 交互
...
## Ch06.026 蚂蚁阿福医疗 Agent：从 0 到生产的工业级工程化落地

> 📊 Level ⭐⭐ | 7.1KB | `entities/ant-group-medical-agent-afu.md`

# 蚂蚁阿福医疗 Agent：从 0 到生产的工业级工程化落地

> 蚂蚁集团医疗健康资深专家郭春晓在 QCon 2026 北京的分享，全面覆盖医疗 Agent 在评测体系、上下文工程、Agentic RAG、记忆系统和训推优化的工业级实践。

## 医疗 Agent 独特挑战

> **零容错医疗场景**：一个致命回答可能就是一个家庭的悲剧。医疗 Agent 与其他领域的 Agent 有根本性差异——必须严格遵循循证逻辑（诊断必须依据指南和教科书），追求可解释、可复现、符合指南推理链的确定性输出，同时面对长期记忆缺失和严格的数据合规风险。

零容错、循证逻辑（诊断必须依据指南）、确定性要求（可解释/可复现/符合指南推理链）、长期记忆缺失、风险合规（数据泄露超 50 条可能触刑）。

## Agent 研发范式

传统 TDD → Benchmark 驱动 → **Badcase 驱动**快速迭代。关键转变：**代码数据化**——把逻辑转化为数据去训练模型。
...
结构化 20-30% + 非结构化混合；保留用户 query；**渐进式策略**（先看目录）；主子 Agent 上下文共享（返回 Index 而非原文）。原则：**非必要不搞 multi-agent**。
...
医疗场景对 AI 的本质要求是**从"生成"转向"验证"**。与传统客服 Agent 追求流畅对话不同，医疗 Agent 的每一次输出都必须回溯到可验证的医学证据链。蚂蚁的实践表明，这种确定性不是靠单一模型能力达成的，而是通过评测体系（EBPP）+ 上下文工程 + Agentic RAG 三层架构共同保障。其中 EBPP 的"起点是 Badcase"理念尤为关键——它把质量边界设定从"模型擅长什么"转向"业务不能接受什么"。

### 代码数据化：从 IF-ELSE 到训练数据

传统医疗决策系统依赖专家规则（IF 症状 THEN 诊断），维护成本高且覆盖不全。蚂蚁的"代码数据化"转变意味着：将临床指南、诊疗路径、用药规则转化为训练数据，让模型在数据层面学习医学逻辑，而非在代码层面硬编码。这降低了维护成本，同时提升了模型的泛化能力和对边缘案例的覆盖。

### Benchmark Overfitting 的工业级应对

蚂蚁团队发现 Benchmark 会随时间 overfitting——团队可能无意间"记住"了测试集。应对方案是持续通过 Badcase 补充评测集，保持评测的区分度。人工校准耗时 1-2 个月/场景，但这是医疗场景不可省略的投入。自动评分 + 人工校准的双轨机制，是医疗 Agent 评测体系的核心。

### 非必要不 Multi-Agent 的架构哲学

在医疗场景中，蚂蚁团队明确提出"非必要不要搞 multi-agent 架构"。这反映了**架构复杂性守恒定律**：每增加一个 Agent，通信、协调、错误传播的复杂度就翻倍。蚂蚁选择的是主子 Agent 模式（子 Agent 返回 Index 而非原文）+ 渐进式上下文策略，在保持架构简洁的同时实现复杂任务。

### 训推融合的工程创新

Speculative Decoding 的 SpecFog 方案将推理速度从 50 提升到 120 token/s，Prefill/Decode 分离让计算密集型和 HBM 密集型任务各得其所。这些优化不是通用技术，而是针对医疗 Agent 的使用场景（长文档分析 + 多轮对话 + 实时响应）专门设计的。
...
- [Agent 评测方法论与体系设计](ch03/035-agent.html) — 更通用的 Agent 评测体系设计
- [Agent 生产化 Harness](ch03/035-agent.html) — 与医疗 Agent 的生产化工程模式有交叉
- [RAG 向量与知识图谱融合](ch01/411-rag.html) — Agentic RAG 的技术背景
- **推测解码技术** (Speculative Decoding) — SpecFog 所在的技术谱系
- [Agent 生产化工程范式](ch03/035-agent.html) — 与蚂蚁的 Badcase 驱动研发范式相关

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/ant-group-medical-agent-afu-qcon-2026.md)
...
## Ch06.028 TencentDB Agent Memory 短期记忆压缩方案
...
## Ch06.029 Hermes Agent 三级 Memory 架构解析（One掌柜视角）
...
## Ch06.030 Building is just the beginning: Introducing Discoverability
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/lovable-discoverability-intro.md)
...
- [Obsidian + Claude Code 集成指南](ch03/084-claude-code.html)
- [柚漫剧 AI全流程提效拆解](ch05/100-ai.html)

---

## Ch06.031 OpenJiuwen AutoGenetic Memory — 华为开源自主生长Agent记忆引擎
...
- [Agent 记忆架构](ch03/035-agent.html) — Agent 记忆系统设计模式
- [若飞 Agent 记忆架构](ch03/035-agent.html) — 分层记忆视角对比
- [Hermes Agent 记忆系统](ch03/035-agent.html) — 记忆引擎实现对比
- [Agent Harness 记忆现状](ch03/035-agent.html) — Mem0 等同类引擎
- [淘宝 Agent 记忆评估全景](ch03/035-agent.html) — 记忆评估体系
- [AI Agent 记忆系统综述](ch05/100-ai.html) — 记忆系统综合对比
- [三种记忆范式对比](https://github.com/QianJinGuo/wiki/blob/main/entities/context-engineering-three-memory-paradigms.md) — 范式级对比
- [Claude Code 七层记忆架构](ch03/084-claude-code.html) — 分层记忆设计对比

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/openjiuwen-autogenetic-memory-agent-2026-07-02.md)

---

## Ch06.032 MFS：zilliztech 的 Agent 统一上下文 harness，一套动词打通 20+ 数据源
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/zilliztech-mfs-open-tag-claude-tag-shuge-2026.md)
...
- [Introducing Claude Tag](ch01/1439-introducing-claude-tag.html) — Open Tag 复刻的 Anthropic 范式
- [Anthropic Knowledge Work Plugins 分析](ch01/1532-anthropic.html) — Skills 的渐进式披露，MFS 用不同方式解决相同问题
...
## Ch06.033 OpenChronicle — AI可复用记忆层
...
## 与本文相关
-  — OpenClaw生态
- [Gstack Ai Workflow](ch05/100-ai.html) — AI协作工作流
- [Kuse Junior Ai Employee](ch05/100-ai.html) — AI员工（Org Memory对比）
-  — 详细报道（raw）
...
## Ch06.034 Qoder 发布团队知识引擎：组织级知识记忆是 Harness 自进化的重要组件

> 📊 Level ⭐⭐ | 4.2KB | `entities/qoder-team-knowledge-engine-compiled-knowledge.md`

# Qoder 发布团队知识引擎：组织级知识记忆是 Harness 自进化的重要组件

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/qoder-team-knowledge-engine-compiled-knowledge.md)
...
## Ch06.035 Claude Code Agent Memory Systems — L0~L3 四层记忆方案
...
## Ch06.036 Agent 记忆系统的主矛盾：历史增长 vs 临场上下文调度

> 📊 Level ⭐⭐ | 3.8KB | `entities/agent-memory-main-contradiction-context-scheduling.md`

# Agent 记忆系统的主矛盾：历史增长 vs 临场上下文调度

用"主次矛盾"框架重看 Agent Memory 方法谱系的系统性分析。核心论点：Agent 记忆系统的本质不是存储问题，而是**上下文调度问题**——在持续增长的历史和有限脆弱的临场上下文之间的矛盾。
...
- → [Agent 记忆系统的工程实践与演进](ch03/035-agent.html) — 更侧重工程落地（写入纪律、Prompt Cache、Embedding迁移等），本实体侧重理论框架
- → [State of Memory in Agent Harness](ch03/035-agent.html) — Mem0 的行业状态报告
...
## Ch06.038 面向复杂业务场景的智能分析 Skills 架构设计与演进实践
...
## Ch06.039 TencentDB Agent Memory：L0-L3 语义金字塔长期记忆
...
- [TencentDB Agent Memory 短期记忆压缩方案](ch03/035-agent.html) — 短期记忆压缩的另一种实现角度
...
## Ch06.041 LLM Wiki 知识管理

> 📊 Level ⭐⭐ | 1.8KB | `entities/llm-wiki-knowledge-management.md`

# LLM Wiki 知识管理

以 LLM 为核心的 Wiki 知识管理体系：利用大模型进行内容提取、摘要生成、关联推理、矛盾检测。Obsidian + AI Agent 的知识库范式。

## 深度分析

本页作为知识图谱锚点，连接了以下关键实体：[Google Open Knowledge Format (OKF) v0.1：AI 知识库通用格式标准 — 让 Markdown 知识库互通](ch01/1429-0.html)。 相关主题通过 [RAG vs LLM Wiki 深度对比：企业知识库架构选型指南](ch01/411-rag.html) 延伸。
...
2. 建议优先采集 LLM Wiki 知识管理 相关的一手来源（论文/官方文档/工程博客）
3. 通过交叉链接密度评估本领域的知识图谱成熟度

## 相关实体

- [Google Open Knowledge Format (OKF) v0.1：AI 知识库通用格式标准 — 让 Markdown 知识库互通](ch01/1429-0.html)
- [RAG vs LLM Wiki 深度对比：企业知识库架构选型指南](ch01/411-rag.html)
- [RAG Chunk Embedding Rerank Pipeline](ch01/411-rag.html)
- [构建 AI 时代的知识底座：直播数据 LLM Wiki 实践](ch05/100-ai.html)
- [手把手：用 Hermes Skills + Karpathy 的 LLM Wiki 让 AI 越用越懂你](ch04/341-skill.html)
...
Loop Engineering 是 2026 年 6 月由 Peter Steinberger（OpenClaw 作者，800 万浏览帖）、Boris Cherny（Anthropic Claude Code 负责人）、Addy Osmani（Google Chrome 工程师，6 月 7 日命名并成文）**独立同周**浮出水面、由 Osmani 定名的第四层工程范式。与 prompt/context/harness engineering 不同：前三者教人把活干得更好，loop engineering **把人从干活的位置上移除**——不再逐行喂 agent，而是设计一个自动给 agent

## 来源

- 原文: [Loop Engineering: The Anthropic Playbook — 设计替你提示 Agent 的系统（花叔橙皮书 v260615 conference 重排版）](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/loop-engineering-anthropic-playbook-orange-book-v260615-2026.md)
- 原始链接: : "local PDF: ~/.hermes/cache/documents/doc_45de9630867c_Loop Engineering.pdf"
- PDF 存档: `assets/Loop_Engineering_Anthropic_Playbook_Field_Study.pdf`（11 页原版，2026-08-01 从 Feishu 附件归档）
...
- 原文: [别让Agent什么都记 上交×腾讯提出 AdaMem](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/admem-memory-policy-selective-memory-sjtu-tencent-2026.md)
- 原始链接: : "https://www.xiaohongshu.com/discovery/item/6a6b01c2000000000401e623
...
- [Agent Memory 架构本质](ch03/035-agent.html) — Governance-centric view
- [Hermes Agent 记忆系统](ch03/035-agent.html) — Production implementation deep-dive
- [Memory in LLM Era — ICLR 2026](ch01/1429-0.html) — Academic framework and benchmarks
- [Memory vs RAG](ch03/035-agent.html) — Systematic framework distinguishing memory from RAG
- [向量数据库必要性反思](ch03/084-claude-code.html) — Critical re-examination of vector database role in agent memory

## References

- [Memory in the LLM Era — ICLR 2026 Paper](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/memory-in-the-llm-era-iclr2026.md)
- [Memory 不是 RAG — Agent 记忆系统性框架](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/memory-vs-rag-agent-memory-systematic-framework.md)
- [Hermes Agent Memory System Architecture](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/hermes-agent-memory-system-architecture.md)
...
## 相关对照
- [Agent Harness 架构](ch03/035-agent.html) —— 7 层模型
- [Rein](ch03/035-agent.html) —— Code Agent 架构
- [wow-harness v3](ch05/085-harness.html) —— 协议层治理
- [MAC Skills + Hooks](ch04/341-skill.html) —— 工程师个人框架
- [高德 AI-Native 生产线](ch05/100-ai.html) —— 企业级 R&D
- [晓斌 Agent-Oriented Infra](ch03/035-agent.html) —— 哲学框架
- [Kimi Work](ch01/736-codex.html) —— 本地 Agent
- [ANOLISA v0.3](ch03/035-agent.html) —— 阿里 Agentic OS
...
|| [Harness Engineering 系统梳理](ch05/129-harness-engineering.html) | Harness 是把经验沉淀成下一轮默认存在的能力 |
**上下文管理决定系统能不能持续协作。**
...
- [Minimax M2 7 Self Evolution](ch03/115-minimax-m2-7.html) — MiniMax 自我进化机制
- [Openclaw Multi Agent Team Practice](ch03/035-agent.html) — OpenClaw AgentOS 实践
- [Ai Agent Memory Systems](ch05/100-ai.html) — Agent 记忆管理方案对比
...
- [Minimax M2 7 Self Evolution](ch03/115-minimax-m2-7.html) — MiniMax 自我进化机制，提供了 M2 系列在模型层面的自我优化路径，与 Forge 系统架构形成互补
- [Openclaw Multi Agent Team Practice](ch03/035-agent.html) — OpenClaw AgentOS 实践，Peter Steinberger 的 OpenClaw 是本文 AgentOS 理念的重要实践源头
...
- [Harness Engineering](ch05/129-harness-engineering.html) 的系统性框架：模型外的 harness 决定下限
- [Anthropic PM 的 Agentic 工作流](ch03/035-agent.html)：任务委派和上下文边界的判断
...
**检索增强**：将文档切分为可寻址 chunk 并建立索引，查询时按相关性取回片段注入窗口，把"模型自己找信息"变成"系统先把信息找出来"，是最通用方案；代价是检索误差（chunk 粒度、排序、重排），信息分散时可能漏召回。与上下文工程结合（见 [上下文工程：三种 Agent Memory 方案对比实验](https://github.com/QianJinGuo/wiki/blob/main/entities/context-engineering-three-memory-paradigms.md)）是 Agent 系统的标准配置。

**工作集压缩**：借鉴操作系统缓存思想，把上下文分为热/温/冷三层，通过 compaction 将冷数据移出窗口并保留摘要或指针，核心是 token 预算管理。[Agent Harness 上下文管理：工作集视角](ch03/035-agent.html) 正是从这一视角审视主流 Harness。
...
Harness 的本质职责之一是决定"模型在每一步看到什么"——上下文管理因此是 Agent 可靠性的地基。[Harness Engineering 系统性解读](ch05/100-ai.html) 将上下文工程视为 Harness 的核心支柱：同一模型在不同上下文组织方式下的表现差异，往往大于不同模型之间的差异。

实践层面，[GSD 上下文管理工具：用 Plan 约束 Agent 行为边界](https://github.com/QianJinGuo/wiki/blob/main/entities/gsd-get-shit-done-context-management-tool.md) 用结构化 Plan 文件替代易腐烂的对话历史，[用好 Claude 的 18 个动作：搭一个个人 AI 工作台（Personal Harness）](ch05/100-ai.html) 展示通过动作编排控制上下文增长。注意力塌缩使长会话必然走向"上下文腐烂"（context rot），Harness 用 subagent 隔离、compaction 压缩、外部状态持久化，把不可控的注意力转化为可控的上下文编排。

### 前沿方向：长上下文模型、KV Cache 优化与记忆系统

**长上下文模型**：窗口已走向百万级，但容量不解决利用率问题，评测界开始用 Lost in the Middle 类基准衡量"有效利用长度"。**KV Cache 优化**：MQA/GQA、KV 量化、cache eviction（H2O、StreamingLLM 的 attention sink）是在系统层对注意力分布做显式取舍。**记忆系统**：把上下文管理升级为"窗口外的架构"——工作/情景/长期记忆分层、检索按需取回，[Agent 上下文窗口管理对比](https://github.com/QianJinGuo/wiki/blob/main/entities/context-window-management.md) 与 [Context Window Management Comparison](https://github.com/QianJinGuo/wiki/blob/main/entities/context-window-management-comparison.md) 对此类方案有系统对比；主动遗忘是记忆策略的显式组成部分。

总趋势：注意力塌缩不会消失，但上下文管理重心正从模型内部（更长窗口、更好位置编码）向系统外部（检索、压缩、记忆、遗忘）迁移——正如 [How LLMs Actually Work: 0xkato Transformer Walkthrough](ch01/1473-how-llms-actually-work-0xkato-transformer-walkthrough.html) 所揭示的"模型能力天花板由系统补足"的 Agent 时代范式。
...
- [Agent 上下文窗口管理对比](https://github.com/QianJinGuo/wiki/blob/main/entities/context-window-management.md)
- [Agent Harness 上下文管理：工作集视角](ch03/035-agent.html)
- [上下文工程：三种 Agent Memory 方案对比实验](https://github.com/QianJinGuo/wiki/blob/main/entities/context-engineering-three-memory-paradigms.md)
- [Harness Engineering 系统性解读](ch05/100-ai.html)
- [用好 Claude 的 18 个动作：搭一个个人 AI 工作台（Personal Harness）](ch05/100-ai.html)
- [GSD 上下文管理工具：用 Plan 约束 Agent 行为边界](https://github.com/QianJinGuo/wiki/blob/main/entities/gsd-get-shit-done-context-management-tool.md)
- [How LLMs Actually Work: 0xkato Transformer Walkthrough](ch01/1473-how-llms-actually-work-0xkato-transformer-walkthrough.html)
...
- [Agent Harness 上下文管理：工作集视角](ch03/035-agent.html) — 上下文≠聊天记录，工作集视角下的四框架对比
