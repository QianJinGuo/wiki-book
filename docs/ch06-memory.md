...
- [AI Agent Gateway 架构设计 — OpenClaw/Claude Code/Hermes 三框架对比](ch01-349-ai-agent-gateway-架构设计-openclaw-claude-code-hermes-三框架对比.html)
- [DeerFlow vs Hermes vs OpenClaw 深度对比](ch04-398-deerflow-hermes-openclaw-架构区别深度对比.html)
- [Claude Code vs OpenClaw Agent 记忆系统对比](ch01-309-复杂度棘轮-ai编程的质量只升不降机制.html)
- [Agent Harness 上下文管理：聊天记录还是工作集](ch05-038-agent-harness.html)
- [Claude Code Subagents 详解：上下文污染隔离](ch04-162-agivar-agent-jittor-2-3.html)
- [Harness Engineering Framework](ch05-049-harness-engineering-系统梳理.html)
- OpenClaw 架构解析
- [Agent Memory 架构本质](ch04-146-how-ai-agent-memory-works.html)
- [Agent Memory 模块化框架与评测](ch01-238-agent-memory-模块化框架与评测-memory-in-the-llm-era-4-模块-10-方案对比.html)
- [深度拆解 Hermes 记忆系统：它修正了 OpenClaw 的哪层误区](ch04-382-深度拆解-hermes-agent-记忆系统-它修正了-openclaw-的哪层误区.html)
...
## 相关实体
- [Context Engineering Three Memory Paradigms](ch04-229-yidian-tianxia-context-engineering-agentic-ai.html)
- [Agent Memory Architecture Essence](ch04-087-boris-cherny-ide-agent.html)
...
- [Agent Memory Architecture Ruofei](ch04-111-3-0-agent-agent-agent-5-6.html)
...
## 相关实体
- [Tmall Ai Coding Practice Team Knowledge Base](ch09-066-ai.html)
- [Tmall Ai Coding Practice Team Knowledge Base Npm](ch01-335-tmall-ai-coding-practice-team-knowledge-base-npm.html)
- [Tencent Ai Team Knowledge Harness](ch05-053-harness-engineering-ai.html)
- [Tencent Ai Team Knowledge Mgmt Harness Moat](ch05-027-harness不是目的-知识才是护城河-一个ai工程交付团队的知识沉淀实践.html)
- [Ai Team Knowledge Harness](ch01-348-agent框架owl原理详解.html)
...
## 与本文相关
-  — OpenClaw生态
- [Gstack Ai Workflow](ch03-058-gstack-ai.html) — AI协作工作流
- [Kuse Junior Ai Employee](ch03-043-kuse-ai-junior-全球第一个ai员工.html) — AI员工（Org Memory对比）
-  — 详细报道（raw）
...
- [Cve 2026 20182 Unauthenticated Cisco Sd Wan Control Plane Compromise Via Vhub Au](ch12-015-resecurity-cve-2026-20182-unauthenticated-cisco-sd-wan-co.html)
- [Anthropic Institute When Ai Builds Itself Jiagoux Interpretation](ch01-682-ai-ai-aigc.html)
- [Claude Code Dynamic Workflows Thariq Blog Gaia](ch01-805-从-harness-到动态工作流-claude-code-多智能体任务编排的新范式.html)
- [Hermes Agent Skills Source Code Analysis Shuge](ch04-447-hermes-agent-skills-源码级拆解-3级渐进加载-6步调度-5维安全扫描.html)
- [Harness Engineering Core Patterns Claude Code](ch01-698-mythos-30-10000.html)
- [Hermes Agent V014 Architecture Shugex](ch01-806-简单接口-返回最终响应字符串.html)
...
- [Minimax M2 7 Self Evolution](ch03-098-minimax-m2-7-开启模型的自我进化.html) — MiniMax 自我进化机制
...
- [Minimax M2 7 Self Evolution](ch03-098-minimax-m2-7-开启模型的自我进化.html) — MiniMax 自我进化机制，提供了 M2 系列在模型层面的自我优化路径，与 Forge 系统架构形成互补
- [Openclaw Multi Agent Team Practice — OpenClaw AgentOS 实践，Peter Steinberger 的 OpenClaw 是本文 AgentOS 理念的重要实践源头](ch04-038-openclaw-multi-agent-team-practice-v2.html)
...
## 与相关概念的关联
- [Claude Code 架构深度分析](ch01-846-claude-code-agent-harness.html) — 架构上下文压缩机制的源码级实现
- Agent Harness 上下文管理：工作集视角 — 上下文≠聊天记录，工作集视角下的四框架对比
- [Hermes Agent](ch04-418-hermes-agent.html) — 开源 Agent 的上下文管理策略对比

## 参考
- [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/claude-code-session-management-1m-context.md)

## 相关实体
- [Claude Code Subagent 上下文卫生](ch03-002-obsidian-claude-code.html)
- [深度解析 Claude Code 在 Prompt / Context / Harness 的设计与实践](ch03-002-obsidian-claude-code.html)
- [Agent 上下文窗口管理对比](ch04-149-agent-上下文窗口管理对比.html)
- [Agent 上下文管理工程模式收敛 — 多框架代码级横向对比](ch04-460-the-ui-is-dead-long-live-the-agent-servicenow-goes-headles.html)
