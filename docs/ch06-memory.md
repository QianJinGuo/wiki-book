...
> 📊 Level ⭐⭐ | 28.7KB | `entities/hermes-agent-memory-system-openclaw-comparison.md`

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/hermes-agent-memory-system-openclaw-comparison.md)
...
- [Agent Harness 上下文管理：聊天记录还是工作集](/ch05-038-agent生产级harness工程指南/)
- [Claude Code Subagents 详解：上下文污染隔离](/ch04-162-claude-code-subagents-深度指南-上下文卫生实战/)
- [Harness Engineering Framework](/ch05-049-harness-engineering-系统梳理/)
- OpenClaw 架构解析
- [Agent Memory 架构本质](/ch04-146-agent-memory-架构本质/)
- [Agent Memory 模块化框架与评测](/ch01-238-agent-memory-模块化框架与评测-memory-in-the-llm-era-4-模块-10-方案对比/)
...
- [AgentMemory 实体页面](/ch09-034-agentmemory/)
...
- [Claude Code Openclaw Usage Ettin](/ch09-028-claude-code-openclaw-usage-ettin/)
...
- [从 openclaw 到 openhuman：私人 ai runtime 的雏形](/ch04-123-从-openclaw-到-openhuman-私人-ai-runtime-的雏形/)

## 相关实体

- [`Agent Memory 架构本质`](/ch04-088-agent-memory/)
- [`AI Agent 记忆系统`](/ch11-193-ai-agent-的迁移与现代化-使用-amazon-bedrock-agentcore-将-openclaw-从单/)
- [`AgentMemory 本地记忆`](/ch09-034-agentmemory/)
- MOC
...
- [Agent Memory Architecture Essence](/ch04-087-agent-memory-架构本质/) — Agent 记忆架构本质
- [Agent Memory Architecture Ruofei](/ch04-111-agent-memory-架构解析/) — Agent 记忆架构（若飞）
- [Agent Memory Modular Framework](/ch01-238-agent-memory-模块化框架与评测-memory-in-the-llm-era-4-模块-10-方案对比/) — Agent 记忆模块化框架
- [Ai Agent Memory Systems — AI Agent 记忆系统](/ch11-193-ai-agent-的迁移与现代化-使用-amazon-bedrock-agentcore-将-openclaw-从单/)
- [Ai Memory Architecture Deep Dive — 记忆架构深度分析](/ch01-525-mollick-实用-ai-选型指南-模型选择-deep-research-voice-mode-agent-工作流/)
- [Memory In The Llm Era Iclr2026](/ch01-853-memory-in-the-llm-era-modular-architectures-and-strategies/) — Memory in the LLM Era（架构层面四组件框架）
- [Agentmemory Coding Agent Local Memory](/ch09-034-agentmemory/) — Coding Agent 本地记忆
- [Claude Code 7 Layer Memory Architecture](/ch01-857-claude-code-7-layer-memory-architecture/) — Claude Code 7 层记忆架构
- [Agent Memory Storage Six Schools Wiki Compile Vs Raw Data Debate](/ch07-012-agent-记忆存储方案深度洞察-6-大流派分歧-wiki-编译-vs-原始数据之争-hermes-agent-启示/) — 记忆存储六派之争
- [Agentic Ai Infrastructure Practice Series Nine Context Engineering](/ch04-403-agentic-ai-infrastructure-practice-series-9-context-enginee/) — AWS Context Engineering（基础设施层）
- [Agent Eval Wallezhang Yaml Driven Agent Evaluation Framework](/ch04-141-agenteval-yaml驱动的agent评测框架/) — YAML 驱动的 Agent 评测
- [Taobao Smart Shopping Guide Agent Evaluation Pzmx](/ch04-332-多轮-agent-场景下-滴滴的-eagle-3-训推加速实践/) — 淘宝导购 Agent 评测
...
- [claude code 从 demo 到产线 · 企业 harness 工程化的 8 道关卡（黄佳/咖哥 csdn）](/ch09-014-claude-code-从-demo-到产线-企业-harness-工程化的-8-道关卡-黄佳-咖哥-csdn/)
- [从 openclaw 到 openhuman：私人 ai runtime 的雏形](/ch04-123-从-openclaw-到-openhuman-私人-ai-runtime-的雏形/)

- [claude code 1.0.24 工具调用安全事故：静默删 .gitignore 与 redis flush 复盘](/ch01-223-claude-code-1-0-24-工具调用安全事故-静默删-gitignore-与-redis-flush-复盘/)
...
- [Pi (pi-mono) — harness 优先的经典设计代表，强制截断 + 教育提示](/ch03-068-pi-mono-模块化-ai-agent-构建平台-openclaw-执行引擎核心/)
- OpenClaw — 纵深防御设计，多层上限叠加 + 分块淘汰压缩
- [Claude Code — 双重门禁 + 可远程调参 + 九段 prompt compaction](/ch03-002-obsidian-claude-code-集成指南/)
- Letta — 向量索引优先，颠覆性的 memory-first 架构
- Arize Alyx — 独立收敛到相同设计的内部工具
- [Agent Runtime — 上下文管理是 Agent 运行时系统的核心子系统](/ch04-060-fable-5-的信号-agent-开始拼-runtime-架构师若飞的-runtime-contract-工程化拆/)
...
- [Context Engineering — 金字塔分层是 context engineering 的"知识侧"实现](/ch04-229-yidian-tianxia-context-engineering-agentic-ai/)
- [Agent Evolution 四阶段六维](/ch04-134-agent-evolution-four-stages-and-six-dimensions-alibaba-clo/) — Memory 维度的"文件系统沉淀"与 Pyramid KB 的 L4/L5 对应
- [Hermes Agent Operator](/ch04-067-hermes-agent-operator-上手-把一个-agent-养成可运营系统/) — Hermes 的 LLM-Wiki 模式实现（Karpathy 提出的范式二）
- [Claude Code 深度解析](/ch01-558-claude-code-harness-深度分析/) — Claude Code 的 CLAUDE.md / SKILL.md 是"渐进式披露"实践
- [Harness Engineering](/ch05-041-harness-engineering-概念框架/) — Knowledge Context Layer 是 Harness 的知识基础设施层
- [Agent 记忆系统实践](/ch01-707-存之有序-治之有矩-agent-记忆系统的工程实践与演进/) — Memory 模块的工程化对照
- RAG — Naive RAG 范式
- GraphRAG — 范式四
...
[Memory Vs Rag Agent Memory Systematic Framework](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/memory-vs-rag-agent-memory-systematic-framework.md)
...
- [Agent Memory Architecture Essence](/ch04-087-agent-memory-架构本质/)
...
这与 [Hermes Agent 记忆系统深度拆解](/ch04-068-hermes-agent-记忆系统深度拆解/) 中提到的"档案室不等于随身备忘录"是同一设计哲学的两面表达。
...
- [Hermes Agent 三级 Memory 架构解析（One掌柜视角） — 同一作者的另一篇分析](/ch04-418-hermes-agent/)
- [AI Agent 记忆系统架构](/ch04-145-how-ai-agent-memory-works/) — Agent 记忆系统的通识性框架
- [17种Agent架构演进](/ch04-507-17种agent架构演进-控制流设计的完整演化史/) — 记忆设计在 Agent 演化中的位置

- [Hermes Agent Core Architecture Self Evolution](/ch04-418-hermes-agent/)
## 深度分析
...
- [Management As Ai Superpower Mollick](/ch04-273-管理作为-ai-超级能力-mollick-的-agentic-work-delegation-方程/)
...
|| 相关文章 | 关联点 |
|---------|--------|
|| [Hermes Agent](/ch04-418-hermes-agent/) | MemOS 是 Hermes 的记忆插件，解决 Hermes 记忆乱的痛点 |
|| [Claude Code 架构解析](/ch01-571-claude-code-架构解析/) | Claude Code 的 Query Loop 含上下文管理，和 MemOS 的记忆注入思路一致 |
|| [AgentCore Harness](/ch04-206-agentcore-managed-harness/) | AgentCore 管运行时，MemOS 管记忆，是不同维度的 Agent 基础设施 |
...
## 相关实体
- [Ai Task Scheduling Dynamic Hibernate Aliyun Mse](/ch01-744-阿里云-mse-ai-任务调度-agent-sandbox-动态休眠-唤醒-openclaw-agent-成本下降/)

- [Tencentdb Agent Memory Context Offloading](/ch04-175-context-agent/)
...
- [Openclaw Boris Cherny Agent Loop Design Patterns](/ch01-835-openclaw-boris-cherny-agent-loop-design-patterns/)
...
→ [LLM Wiki / Obsidian Wiki / GBrain 自组织自进化](/ch01-499-llm-wiki-obsidian-wiki-gbrain-self-organization-self-evoluti/) — 同领域不同项目对比
→ [Karpathy LLM Wiki 第二大脑 (awkthole)](/ch01-321-卡帕西-llm-wiki-到底是什么-用-claude-obsidian-给自己造一个第二大脑的完整拆解/) — Karpathy Wiki 详细解析
→ [Karpathy LLM Wiki v2 (2026)](/ch01-271-karpathy-llm-wiki-v2-2026/) — Karpathy Wiki 2026 更新
→ LLM Wiki Architecture — LLM Wiki 架构
→ [Obsidian + LLM Wiki 本地化 (kytmanov)](/ch03-090-obsidian-llm-wiki-local-obsidian本地ai知识图谱自动构建/) — Obsidian 集成 LLM Wiki
→ [知识沉淀是护城河](/ch05-082-知识沉淀是护城河/) — 知识管理护城河论述
→ [腾讯知识 Harness 实践](/ch05-078-harness不是目的-知识才是护城河-一个ai工程交付团队的知识沉淀实践/) — 腾讯系知识管理
→ [Create Custom MCP Catalogs and Profiles](/ch07-057-create-custom-mcp-catalogs-and-profiles/) — MCP 目录 vs OKF bundle 关系
→ [GBrain](/ch01-220-gbrain-yc-ceo-garry-tan-的-postgres-native-ai-第二大脑-5-大设计决策/) — Postgres 持久化 + 知识图谱（可消费 OKF bundle）
...
## 相关实体
- [AgentMemory — Coding Agent 本地记忆](/ch09-034-agentmemory/) — Agent 记忆工程实践
- [Hermes Agent 三层 Memory — 工程实现视角](/ch04-418-hermes-agent/)
...
- [Rag Knowledge Retrieval](/ch04-430-skill-retrieval-augmentation-for-agentic-ai-清华-skill-rag/)
...
- [Tmall Ai Coding Practice Team Knowledge Base Npm](/ch01-335-tmall-ai-coding-practice-team-knowledge-base-npm/)
- [Tencent Ai Team Knowledge Harness](/ch05-053-腾讯-ai-team-知识沉淀体系-harness-engineering-实践/)
- [Tencent Ai Team Knowledge Mgmt Harness Moat](/ch05-027-harness不是目的-知识才是护城河-一个ai工程交付团队的知识沉淀实践/)
- [Ai Team Knowledge Harness](/ch01-348-tmall-ai-coding-practice-team-knowledge-base-npm/)
...
> 和 [Agent Memory 架构本质](/ch04-146-agent-memory-架构本质/) 的"write-manage-read 三链路闭环"角度不同，Hermes 更侧重**运行时成本控制和分层治理**。
...
## 与相关条目的关系
- [Agent Memory 模块化框架与评测](/ch01-238-agent-memory-模块化框架与评测-memory-in-the-llm-era-4-模块-10-方案对比/) — 学术视角（ICLR 2026），四组件统一框架
...
- [这个开源 agent 框架的核心设计，可能是目前最「聪明」的取舍](/ch04-012-这个开源-agent-框架的核心设计-可能是目前最-聪明-的取舍/)
- MOC
...
## Related
- AI 知识管理工具横向对比
- [NotebookLM](/ch01-017-notebooklm/) — 云端 AI 研究助手
- [ChatGPT Memory](/ch01-315-chatgpt-memory/) — 对话式记忆
- [Hermes-Agent](/ch04-418-hermes-agent/) — 可通过 Local REST API 与 Obsidian 交互
...
## 相关实体
- [AI Agent 记忆系统架构](/ch04-145-how-ai-agent-memory-works/)
- [LLM Wiki 架构](/ch01-550-llm-wiki-架构解析-karpathy-的-markdown-知识库模式/)
- [深度解析LLM Wiki / Obsidian-Wiki / GBrain：Agent时代知识的"自组织"与"自进化"](/ch01-499-llm-wiki-obsidian-wiki-gbrain-self-organization-self-evoluti/)
- [hermes-agent-self-evolving-source-analysis](/ch04-039-hermes-agent-self-evolving-source-analysis/)
- [AI Agent 工程师能力地图](/ch04-139-ai-agent-工程师能力地图/)
...
- [Agent Memory Storage Six Schools Quantumtransf Debate Frank](/ch01-788-agent-记忆存储方案深度洞察/)
- MOC
...
- 知识图谱 — 以关系为核心的知识表示方法
- [Design Systems — 设计系统的理论与实践](/ch04-040-nvidia-extreme-co-design-agentic-systems/)
- [Consistency, But in Excellence](/ch01-616-consistency-but-in-excellence-not-appearance/) — 系统化 vs 个体卓越的张力
- [RAG (Retrieval-Augmented Generation) — AI 检索增强生成](/ch04-430-skill-retrieval-augmentation-for-agentic-ai-清华-skill-rag/)
...
## 相关实体
- [Agent Memory Architecture](/ch04-146-agent-memory-架构本质/)
- [Agent Memory Evaluation Landscape Taobao Survey](/ch04-465-memory-agent-systems-cobanov/)
- [Ai Agent Memory Systems](/ch04-487-hidden-technical-debt-of-ai-systems-agent-harness/)
- [Agent Memory Modular Framework](/ch01-238-agent-memory-模块化框架与评测-memory-in-the-llm-era-4-模块-10-方案对比/)
- [How Ai Agent Memory Works](/ch04-145-how-ai-agent-memory-works/)
...
- [Hermes Agent Three Layer Memory Architecture One](/ch04-418-hermes-agent/)
- [Hermes Agent Core Architecture Self Evolution](/ch04-418-hermes-agent/)
...
## 与本文相关
-  — OpenClaw生态
- [Gstack Ai Workflow](/ch03-058-gstack-ai协作开发工作流-复杂度棘轮/) — AI协作工作流
- [Kuse Junior Ai Employee](/ch03-043-kuse-ai-junior-全球第一个ai员工/) — AI员工（Org Memory对比）
-  — 详细报道（raw）
...
> 📊 Level ⭐⭐ | 1.9KB | `entities/cve-2026-20182-cisco-sd-wan-vhub-bypass.md`

# CVE-2026-20182: Unauthenticated Cisco SD-WAN Control Plane Compromise via vHub Authentication Bypass

## 深度分析

Cisco SD-WAN vHub 绕过漏洞的安全分析：未认证攻击者可利用该漏洞绕过访问控制，影响企业广域网安全边界

### 技术要点

- **security架构**: 在security领域的设计理念与实现路径
- **工程挑战**: 实际落地中面临的关键问题与应对策略
- **行业趋势**: security方向的技术演进与新兴范式
...
- [Agent Memory 架构本质](/ch04-146-agent-memory-架构本质/) — Governance-centric view
- [Hermes Agent 记忆系统](/ch04-210-hermes-agent-记忆系统/) — Production implementation deep-dive
- [Memory in LLM Era — ICLR 2026](/ch01-853-memory-in-the-llm-era-modular-architectures-and-strategies/) — Academic framework and benchmarks
...
### vs [Agent Harness 架构](/ch04-207-agent-harness-架构/)
- 7 层 harness 模型 = 抽象框架
- **MiroFlow = "deep research 任务性质的脚手架"**——把 harness 设计哲学落到 deep research 任务上的**具体实现 + 工程决策**

### vs [Rein](/ch04-050-rein-4-模块-5-类型边界防止-agent-go-膨胀到-3000-行/)
- Rein = **Code Agent** 的 4 模块 + 5 类型边界
- **MiroFlow = Deep Research Agent 的 6 大工程差异**——与 Rein 互补
- 共同点：都强调"边界 / 工程约束"是 harness 关键

### vs [wow-harness v3](/ch05-028-wow-harness-v3-ai-开发的治理协议/)
- v3 = 跨 session 事件时间线（**协议层**治理）
- MiroFlow = 任务级别（**单次任务**）的完整执行流
- 共同点：都强调"治理"是 harness 关键

### vs [MAC Skills + Hooks](/ch05-026-mac-multi-agent-coding-skills-hooks-两层-harness-完全委托-0/)
- MAC = 工程师个人框架（**概率层 + 确定性层**）
- MiroFlow = **任务级别**（理解题 / 解题 / 总结 / 答案提取 4 阶段解耦）
- 共同点：都强调"用机制保证关键事件发生"

### vs [高德 AI-Native 生产线](/ch04-028-高德-ai-native-生产线-第-3-期-7x24-self-healing-pipeline-agent-自/)
- 高德 = 7×24 永动生产线（**企业级 R&D 链路**）
- MiroFlow = **Deep Research 单次任务执行**（在 GAIA / HLE 评测上打榜）

### vs [晓斌 Agent-Oriented Infra](/ch04-031-晓斌-从-people-oriented-到-agent-oriented-infra-意图驱动-代码沉淀的进/)
- 晓斌 = 哲学框架（4 层设计）
- MiroFlow = 任务级别（**理解题 / 解题 / 总结 / 答案提取** 4 阶段解耦）
...
- [Rein](/ch04-050-rein-4-模块-5-类型边界防止-agent-go-膨胀到-3000-行/) —— Code Agent 架构
- [wow-harness v3](/ch05-028-wow-harness-v3-ai-开发的治理协议/) —— 协议层治理
- [MAC Skills + Hooks](/ch05-026-mac-multi-agent-coding-skills-hooks-两层-harness-完全委托-0/) —— 工程师个人框架
- [高德 AI-Native 生产线](/ch04-028-高德-ai-native-生产线-第-3-期-7x24-self-healing-pipeline-agent-自/) —— 企业级 R&D
- [晓斌 Agent-Oriented Infra](/ch04-031-晓斌-从-people-oriented-到-agent-oriented-infra-意图驱动-代码沉淀的进/) —— 哲学框架
- [Kimi Work](/ch01-159-kimi-work-通用-agent-战场从云端迁移到本地/) —— 本地 Agent
- [ANOLISA v0.3](/ch04-055-anolisa-v0-3-阿里-agentic-os-agent-系统管家-4-层安全-token-节省/) —— 阿里 Agentic OS
...
|| [Harness Engineering 系统梳理](/ch05-049-harness-engineering-系统梳理/) | Harness 是把经验沉淀成下一轮默认存在的能力 |
...
- [Claude Code Session 管理与 1M 上下文最佳实践](/ch03-002-obsidian-claude-code-集成指南/)
...
> -> [MiniMax Token调用第一后：AgentOS现实与模型厂商的系统适配挑战](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/agentos-minimax-forge-model-adaptation-yaoge.md)
...
- [Minimax M2 7 Self Evolution](/ch03-098-minimax-m2-7-开启模型的自我进化/) — MiniMax 自我进化机制
- Openclaw Multi Agent Team Practice — OpenClaw AgentOS 实践
- Ai Agent Memory Systems — Agent 记忆管理方案对比
...
- [Minimax M2 7 Self Evolution](/ch03-098-minimax-m2-7-开启模型的自我进化/) — MiniMax 自我进化机制，提供了 M2 系列在模型层面的自我优化路径，与 Forge 系统架构形成互补
- [Openclaw Multi Agent Team Practice — OpenClaw AgentOS 实践，Peter Steinberger 的 OpenClaw 是本文 AgentOS 理念的重要实践源头](/ch04-038-openclaw-multi-agent-team-practice-v2/)
...
- [Harness Engineering](/ch05-049-harness-engineering-系统梳理/) 的系统性框架：模型外的 harness 决定下限
- [Anthropic PM 的 Agentic 工作流](/ch04-383-anthropic-pm-的-agentic-工作流/)：任务委派和上下文边界的判断
...
## 与相关概念的关联
- [Claude Code 架构深度分析](/ch01-846-claude-code-架构深度解析/) — 架构上下文压缩机制的源码级实现
- Agent Harness 上下文管理：工作集视角 — 上下文≠聊天记录，工作集视角下的四框架对比
- [Hermes Agent](/ch04-418-hermes-agent/) — 开源 Agent 的上下文管理策略对比

## 参考
- [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/claude-code-session-management-1m-context.md)
