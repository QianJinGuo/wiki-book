...
- [DeerFlow vs Hermes vs OpenClaw 深度对比](ch11/235-openclaw.html)
- [Claude Code vs OpenClaw Agent 记忆系统对比](ch03/077-claude-code.html)
- [Agent Harness 上下文管理：聊天记录还是工作集](ch03/035-agent.html)
- [Claude Code Subagents 详解：上下文污染隔离](ch03/077-claude-code.html)
...
- [深度拆解 Hermes 记忆系统：它修正了 OpenClaw 的哪层误区](ch03/095-hermes-agent.html)
...
- [AgentMemory 实体页面](ch09/047-coding-agent.html)
...
- [Harness Engineering 7 Layers Openclaw Hermes Claude Code P1Anu](ch03/077-claude-code.html)
...
- [从 openclaw 到 openhuman：私人 ai runtime 的雏形](ch05/094-ai.html)
...
- [Ai Agent Memory Systems](ch05/094-ai.html) — AI Agent 记忆系统
- [Ai Memory Architecture Deep Dive](ch05/094-ai.html) — 记忆架构深度分析
- [Memory In The Llm Era Iclr2026](ch01/1274-llm.html) — Memory in the LLM Era（架构层面四组件框架）
- [Agentmemory Coding Agent Local Memory](ch09/047-coding-agent.html) — Coding Agent 本地记忆
- [Claude Code 7 Layer Memory Architecture](ch03/077-claude-code.html) — Claude Code 7 层记忆架构
- [Agent Memory Storage Six Schools Wiki Compile Vs Raw Data Debate](ch03/035-agent.html) — 记忆存储六派之争
- [Agentic Ai Infrastructure Practice Series Nine Context Engineering](ch05/094-ai.html) — AWS Context Engineering（基础设施层）
...
- [claude code 1.0.24 工具调用安全事故：静默删 .gitignore 与 redis flush 复盘](ch03/077-claude-code.html)
...
- [Hermes Agent Operator](ch03/095-hermes-agent.html) — Hermes 的 LLM-Wiki 模式实现（Karpathy 提出的范式二）
- [Claude Code 深度解析](ch03/077-claude-code.html) — Claude Code 的 CLAUDE.md / SKILL.md 是"渐进式披露"实践
...
这与 [Hermes Agent 记忆系统深度拆解](ch03/095-hermes-agent.html) 中提到的"档案室不等于随身备忘录"是同一设计哲学的两面表达。
...
- [Hermes Agent 三级 Memory 架构解析（One掌柜视角）](ch03/095-hermes-agent.html) — 同一作者的另一篇分析
- [AI Agent 记忆系统架构](ch04/156-how-ai-agent-memory-works.html) — Agent 记忆系统的通识性框架
...
## 相关实体
- [深度解析LLM Wiki / Obsidian-Wiki / GBrain：Agent时代知识的"自组织"与"自进化"](ch05/094-ai.html)
- [Skills赏析：使用skills-refiner提升skill质量](ch04/271-skill.html)
- [企业级AI记忆基质三层架构：事实/交互/行动记忆](ch05/094-ai.html)
- [SkillClaw](ch04/271-skill.html)
- [Agent 自我改进的六条路](ch03/035-agent.html)
- [Skill 系统：Agent 如何把经验沉淀成可复用能力](ch04/271-skill.html)
- [GBrain](ch05/094-ai.html)
- [Demis Hassabis YC 专访：AGI / 记忆 / Agent / 创造性观点集](ch01/913-20.html)
- [OpenHuman: AI Agent 持久记忆框架](ch05/094-ai.html)
...
- [Management As Ai Superpower Mollick](ch05/094-ai.html)
...
|| [Claude Code 架构解析](ch03/077-claude-code.html) | Claude Code 的 Query Loop 含上下文管理，和 MemOS 的记忆注入思路一致 |
|| [AgentCore Harness](ch04/689-agentcore-harness.html) | AgentCore 管运行时，MemOS 管记忆，是不同维度的 Agent 基础设施 |
...
- [Hermes Agent 记忆系统深度拆解](ch03/095-hermes-agent.html)
- [AI Agent 工程师能力地图](ch05/094-ai.html)
## 相关实体
...
→ [LLM Wiki / Obsidian Wiki / GBrain 自组织自进化](ch05/094-ai.html) — 同领域不同项目对比
→ [Karpathy LLM Wiki 第二大脑 (awkthole)](ch05/094-ai.html) — Karpathy Wiki 详细解析
→ [Karpathy LLM Wiki v2 (2026)](ch01/1274-llm.html) — Karpathy Wiki 2026 更新
→ [LLM Wiki Architecture](ch01/1274-llm.html) — LLM Wiki 架构
→ [Obsidian + LLM Wiki 本地化 (kytmanov)](ch01/1274-llm.html) — Obsidian 集成 LLM Wiki
→ [知识沉淀是护城河](https://github.com/QianJinGuo/wiki/blob/main/entities/knowledge-mgmt-is-moat.md) — 知识管理护城河论述
→ [腾讯知识 Harness 实践](ch05/009-harness.html) — 腾讯系知识管理
→ [Create Custom MCP Catalogs and Profiles](ch07/082-create-custom-mcp-catalogs-and-profiles.html) — MCP 目录 vs OKF bundle 关系
→ [GBrain](ch05/094-ai.html) — Postgres 持久化 + 知识图谱（可消费 OKF bundle）
...
- [Production Harness 12 Components Framework Comparison](ch05/009-harness.html)
...
## Ch06.016 TencentDB Agent Memory：符号化短期记忆+分层式长期记忆

> 📊 Level ⭐⭐ | 10.4KB | `entities/tencentdb-agent-memory-hierarchical.md`
...
## 相关实体
- [AgentMemory — Coding Agent 本地记忆](ch09/047-coding-agent.html) — Agent 记忆工程实践
- [Hermes Agent 三层 Memory](ch03/095-hermes-agent.html) — 工程实现视角
...
## 相关实体
- [Tmall Ai Coding Practice Team Knowledge Base](ch05/094-ai.html)
- [Tmall Ai Coding Practice Team Knowledge Base Npm](ch05/094-ai.html)
- [Tencent Ai Team Knowledge Harness](ch05/094-ai.html)
- [Tencent Ai Team Knowledge Mgmt Harness Moat](ch05/094-ai.html)
- [Ai Team Knowledge Harness](https://github.com/QianJinGuo/wiki/blob/main/concepts/ai-team-knowledge-harness.md)

---

## Ch06.019 Hermes Agent 记忆系统 vs OpenClaw 记忆观
...
## 相关实体
- [OpenHuman: AI Agent 持久记忆框架](ch05/094-ai.html)
- [AI Coding Agent 记忆系统](ch05/094-ai.html)
...
## Ch06.023 蚂蚁阿福医疗 Agent：从 0 到生产的工业级工程化落地
...
- [RAG 向量与知识图谱融合](ch01/223-rag.html) — Agentic RAG 的技术背景
...
## Ch06.024 上下文工程：三种 Agent Memory 方案对比实验
...
## 相关实体
- [AI Agent 记忆系统架构](ch04/156-how-ai-agent-memory-works.html)
- [LLM Wiki 架构](ch01/1274-llm.html)
- [深度解析LLM Wiki / Obsidian-Wiki / GBrain：Agent时代知识的"自组织"与"自进化"](ch05/094-ai.html)
- [hermes-agent-self-evolving-source-analysis](ch03/095-hermes-agent.html)
- [AI Agent 工程师能力地图](ch05/094-ai.html)
...
- [Agent Memory Storage Six Schools Quantumtransf Debate Frank](ch03/035-agent.html)
- [MOC](https://github.com/QianJinGuo/wiki/blob/main/moc/prompt-engineering-guide.md)
...
## Ch06.026 TencentDB Agent Memory 短期记忆压缩方案
...
## 相关实体
- [Agent Memory Architecture](ch03/035-agent.html)
- [Agent Memory Evaluation Landscape Taobao Survey](ch03/035-agent.html)
- [Ai Agent Memory Systems](ch05/094-ai.html)
- [Agent Memory Modular Framework](ch03/035-agent.html)
- [How Ai Agent Memory Works](ch04/156-how-ai-agent-memory-works.html)
...
## Ch06.027 Hermes Agent 三级 Memory 架构解析（One掌柜视角）
...
- [Hermes Agent Three Layer Memory Architecture One](ch03/095-hermes-agent.html)
- [Hermes Agent Core Architecture Self Evolution](https://github.com/QianJinGuo/wiki/blob/main/queries/hermes-agent-core-architecture-self-evolution.md)

---

## Ch06.028 Building is just the beginning: Introducing Discoverability
...
- [Obsidian + Claude Code 集成指南](ch03/077-claude-code.html)
- [柚漫剧 AI全流程提效拆解](ch05/094-ai.html)

---

## Ch06.029 OpenJiuwen AutoGenetic Memory — 华为开源自主生长Agent记忆引擎
...
## 与本文相关
-  — OpenClaw生态
- [Gstack Ai Workflow](ch05/094-ai.html) — AI协作工作流
- [Kuse Junior Ai Employee](ch05/094-ai.html) — AI员工（Org Memory对比）
-  — 详细报道（raw）
...
## Ch06.031 MFS：zilliztech 的 Agent 统一上下文 harness，一套动词打通 20+ 数据源
...
- [Introducing Claude Tag](ch01/1241-introducing-claude-tag.html) — Open Tag 复刻的 Anthropic 范式
- [Anthropic Knowledge Work Plugins 分析](ch01/989-anthropic.html) — Skills 的渐进式披露，MFS 用不同方式解决相同问题
...
## Ch06.033 Claude Code Agent Memory Systems — L0~L3 四层记忆方案
...
## Ch06.034 Agent 记忆系统的主矛盾：历史增长 vs 临场上下文调度
...
> 📊 Level ⭐⭐ | 2.9KB | `entities/skill-orchestration-6-dependencies.md`
...
本页作为知识图谱锚点，连接了以下关键实体：[Google Open Knowledge Format (OKF) v0.1：AI 知识库通用格式标准 — 让 Markdown 知识库互通](ch01/913-20.html)。 相关主题通过 [RAG vs LLM Wiki 深度对比：企业知识库架构选型指南](ch01/1274-llm.html) 延伸。
...
- [Google Open Knowledge Format (OKF) v0.1：AI 知识库通用格式标准 — 让 Markdown 知识库互通](ch01/913-20.html)
- [RAG vs LLM Wiki 深度对比：企业知识库架构选型指南](ch01/1274-llm.html)
- [RAG Chunk Embedding Rerank Pipeline](ch01/223-rag.html)
- [构建 AI 时代的知识底座：直播数据 LLM Wiki 实践](ch05/094-ai.html)
- [手把手：用 Hermes Skills + Karpathy 的 LLM Wiki 让 AI 越用越懂你](ch04/271-skill.html)

---

## Ch06.040 AI Memory Architecture: Deep Dive
...
- [Hermes Agent 记忆系统](ch03/095-hermes-agent.html) — Production implementation deep-dive
- [Memory in LLM Era — ICLR 2026](ch01/1274-llm.html) — Academic framework and benchmarks
- [Memory vs RAG](ch03/035-agent.html) — Systematic framework distinguishing memory from RAG
- [向量数据库必要性反思](ch03/077-claude-code.html) — Critical re-examination of vector database role in agent memory
...
## Ch06.041 MiroFlow：Deep Research Agent 脚手架 —— 与 Code Agent 的 6 大工程差异
...
### vs [MAC Skills + Hooks](ch04/271-skill.html)
- MAC = 工程师个人框架（**概率层 + 确定性层**）
- MiroFlow = **任务级别**（理解题 / 解题 / 总结 / 答案提取 4 阶段解耦）
- 共同点：都强调"用机制保证关键事件发生"

### vs [高德 AI-Native 生产线](ch05/094-ai.html)
...
- [MAC Skills + Hooks](ch04/271-skill.html) —— 工程师个人框架
- [高德 AI-Native 生产线](ch05/094-ai.html) —— 企业级 R&D
...
## Ch06.042 Agent Harness 上下文管理：工作集视角
...
|| [Harness Engineering 系统梳理](ch05/120-harness-engineering.html) | Harness 是把经验沉淀成下一轮默认存在的能力 |
...
- [Claude Code Session 管理与 1M 上下文最佳实践](ch03/077-claude-code.html)
- [Agent Reliability: Context Drift & Tool Calling Hallucination](ch03/035-agent.html)
- [深度解析 Claude Code 在 Prompt / Context / Harness 的设计与实践](ch03/077-claude-code.html)
...
## Ch06.043 MiniMax Token调用第一后：AgentOS现实与模型厂商的系统适配挑战
...
- [Minimax M2 7 Self Evolution](ch03/109-minimax-m2-7.html) — MiniMax 自我进化机制
- [Openclaw Multi Agent Team Practice](ch03/035-agent.html) — OpenClaw AgentOS 实践
- [Ai Agent Memory Systems](ch05/094-ai.html) — Agent 记忆管理方案对比
...
- [Minimax M2 7 Self Evolution](ch03/109-minimax-m2-7.html) — MiniMax 自我进化机制，提供了 M2 系列在模型层面的自我优化路径，与 Forge 系统架构形成互补
...
## Ch06.044 Claude Code Subagent 上下文卫生

> 📊 Level ⭐⭐⭐ | 10.0KB | `entities/claude-code-subagent-context-hygiene.md`
...
- [Harness Engineering](ch05/120-harness-engineering.html) 的系统性框架：模型外的 harness 决定下限
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/qy_zaCZTCs1Ql3BIFmBMgg.md) ^["raw/articles/claude-code-subagents-context-hygiene"]
...
## Ch06.045 Claude Code Session 管理与 1M 上下文最佳实践
...
## Ch06.046 注意力塌缩与上下文管理

> 📊 Level ⭐⭐⭐ | 1.7KB | `entities/attention-collapse-context-management.md`

# 注意力塌缩与上下文管理

LLM 长上下文中的注意力塌缩现象：模型对中间位置的信息利用效率显著下降（Lost in the Middle）。上下文管理的工程对策：分层摘要、检索增强、工作集压缩、主动遗忘。

## 深度分析

本页作为知识图谱锚点，连接了以下关键实体：[Context Window Management Comparison](https://github.com/QianJinGuo/wiki/blob/main/entities/context-window-management-comparison.md)。 相关主题通过 [用好 Claude 的 18 个动作：搭一个个人 AI 工作台（Personal Harness）](ch05/094-ai.html) 延伸。
...
1. 本领域系统性内容尚待采集——当前知识库在此方向的覆盖密度偏低
2. 建议优先采集 注意力塌缩与上下文管理 相关的一手来源（论文/官方文档/工程博客）
3. 通过交叉链接密度评估本领域的知识图谱成熟度
...
- [用好 Claude 的 18 个动作：搭一个个人 AI 工作台（Personal Harness）](ch05/094-ai.html)
- [Harness Engineering 系统性解读](ch05/094-ai.html)
...
- [How LLMs Actually Work: 0xkato Transformer Walkthrough](ch01/1274-llm.html)
