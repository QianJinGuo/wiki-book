...
## 相关实体
- [Ai Job Interview Model Evaluation Mollick](https://github.com/QianJinGuo/wiki/blob/main/entities/ai-job-interview-model-evaluation-mollick.md)
...
- [Management As Ai Superpower Mollick](https://github.com/QianJinGuo/wiki/blob/main/entities/management-as-ai-superpower-mollick.md)
...
- [Agent 评测方法论与体系设计](https://github.com/QianJinGuo/wiki/blob/main/entities/agent-评测方法论与体系设计.md) — 更通用的 Agent 评测体系设计
- [Agent 生产化 Harness](https://github.com/QianJinGuo/wiki/blob/main/entities/agent-harness-production.md) — 与医疗 Agent 的生产化工程模式有交叉
- [RAG 向量与知识图谱融合](https://github.com/QianJinGuo/wiki/blob/main/entities/rag-vector-knowledge-graph-ontology.md) — Agentic RAG 的技术背景
- **推测解码技术** (Speculative Decoding) — SpecFog 所在的技术谱系
- [Agent 生产化工程范式](https://github.com/QianJinGuo/wiki/blob/main/entities/agent-harness-production.md) — 与蚂蚁的 Badcase 驱动研发范式相关
...
- [Agent 记忆架构](https://github.com/QianJinGuo/wiki/blob/main/entities/agent-memory-architecture.md) — Agent 记忆系统设计模式
- [若飞 Agent 记忆架构](https://github.com/QianJinGuo/wiki/blob/main/entities/agent-memory-architecture-ruofei.md) — 分层记忆视角对比
- [Hermes Agent 记忆系统](https://github.com/QianJinGuo/wiki/blob/main/entities/hermes-agent-memory-system.md) — 记忆引擎实现对比
- [Agent Harness 记忆现状](https://github.com/QianJinGuo/wiki/blob/main/entities/state-of-memory-in-agent-harness-mem0-2026.md) — Mem0 等同类引擎
- [淘宝 Agent 记忆评估全景](https://github.com/QianJinGuo/wiki/blob/main/entities/agent-memory-evaluation-landscape-taobao-survey.md) — 记忆评估体系
- [AI Agent 记忆系统综述](https://github.com/QianJinGuo/wiki/blob/main/entities/ai-agent-memory-systems.md) — 记忆系统综合对比
- [三种记忆范式对比](https://github.com/QianJinGuo/wiki/blob/main/entities/context-engineering-three-memory-paradigms.md) — 范式级对比
- [Claude Code 七层记忆架构](https://github.com/QianJinGuo/wiki/blob/main/entities/claude-code-7-layer-memory-architecture.md) — 分层记忆设计对比
...
## 与本文相关
-  — OpenClaw生态
- [Gstack Ai Workflow](https://github.com/QianJinGuo/wiki/blob/main/entities/gstack-ai-workflow.md) — AI协作工作流
- [Kuse Junior Ai Employee](https://github.com/QianJinGuo/wiki/blob/main/entities/kuse-junior-ai-employee.md) — AI员工（Org Memory对比）
-  — 详细报道（raw）
...
- → [Agent 记忆系统的工程实践与演进](https://github.com/QianJinGuo/wiki/blob/main/entities/存之有序治之有矩agent-记忆系统的工程实践与演进.md) — 更侧重工程落地（写入纪律、Prompt Cache、Embedding迁移等），本实体侧重理论框架
- → [State of Memory in Agent Harness](https://github.com/QianJinGuo/wiki/blob/main/entities/state-of-memory-in-agent-harness-mem0-2026.md) — Mem0 的行业状态报告
...
本页作为知识图谱锚点，连接了以下关键实体：[Google Open Knowledge Format (OKF) v0.1：AI 知识库通用格式标准 — 让 Markdown 知识库互通](https://github.com/QianJinGuo/wiki/blob/main/entities/google-okf-open-knowledge-format-v0-1-2026.md)。 相关主题通过 [RAG vs LLM Wiki 深度对比：企业知识库架构选型指南](https://github.com/QianJinGuo/wiki/blob/main/entities/rag-vs-llm-wiki-enterprise-knowledge-base.md) 延伸。
...
- [Google Open Knowledge Format (OKF) v0.1：AI 知识库通用格式标准 — 让 Markdown 知识库互通](https://github.com/QianJinGuo/wiki/blob/main/entities/google-okf-open-knowledge-format-v0-1-2026.md)
- [RAG vs LLM Wiki 深度对比：企业知识库架构选型指南](https://github.com/QianJinGuo/wiki/blob/main/entities/rag-vs-llm-wiki-enterprise-knowledge-base.md)
- [RAG Chunk Embedding Rerank Pipeline](https://github.com/QianJinGuo/wiki/blob/main/entities/rag-chunk-embedding-rerank-pipeline.md)
- [构建 AI 时代的知识底座：直播数据 LLM Wiki 实践](https://github.com/QianJinGuo/wiki/blob/main/entities/ai-knowledge-base-llm-wiki-practice-alicloud.md)
- [手把手：用 Hermes Skills + Karpathy 的 LLM Wiki 让 AI 越用越懂你](https://github.com/QianJinGuo/wiki/blob/main/entities/hermes-skills-llm-wiki-self-improving-knowledge-system.md)
...
- [Minimax M2 7 Self Evolution](https://github.com/QianJinGuo/wiki/blob/main/entities/minimax-m2-7-self-evolution.md) — MiniMax 自我进化机制
- [Openclaw Multi Agent Team Practice](https://github.com/QianJinGuo/wiki/blob/main/entities/openclaw-multi-agent-team-practice.md) — OpenClaw AgentOS 实践
- [Ai Agent Memory Systems](https://github.com/QianJinGuo/wiki/blob/main/entities/ai-agent-memory-systems.md) — Agent 记忆管理方案对比
...
- [Minimax M2 7 Self Evolution](https://github.com/QianJinGuo/wiki/blob/main/entities/minimax-m2-7-self-evolution.md) — MiniMax 自我进化机制，提供了 M2 系列在模型层面的自我优化路径，与 Forge 系统架构形成互补
- [Openclaw Multi Agent Team Practice](https://github.com/QianJinGuo/wiki/blob/main/entities/openclaw-multi-agent-team-practice.md) — OpenClaw AgentOS 实践，Peter Steinberger 的 OpenClaw 是本文 AgentOS 理念的重要实践源头
...
**工作集压缩**：借鉴操作系统缓存思想，把上下文分为热/温/冷三层，通过 compaction 将冷数据移出窗口并保留摘要或指针，核心是 token 预算管理。[Agent Harness 上下文管理：工作集视角](https://github.com/QianJinGuo/wiki/blob/main/entities/agent-harness-context-management-working-set.md) 正是从这一视角审视主流 Harness。
...
Harness 的本质职责之一是决定"模型在每一步看到什么"——上下文管理因此是 Agent 可靠性的地基。[Harness Engineering 系统性解读](https://github.com/QianJinGuo/wiki/blob/main/entities/harness-engineering-systematic-explainer.md) 将上下文工程视为 Harness 的核心支柱：同一模型在不同上下文组织方式下的表现差异，往往大于不同模型之间的差异。

实践层面，[GSD 上下文管理工具：用 Plan 约束 Agent 行为边界](https://github.com/QianJinGuo/wiki/blob/main/entities/gsd-get-shit-done-context-management-tool.md) 用结构化 Plan 文件替代易腐烂的对话历史，[用好 Claude 的 18 个动作：搭一个个人 AI 工作台（Personal Harness）](https://github.com/QianJinGuo/wiki/blob/main/entities/ruofei-claude-18-actions-personal-ai-workbench.md) 展示通过动作编排控制上下文增长。注意力塌缩使长会话必然走向"上下文腐烂"（context rot），Harness 用 subagent 隔离、compaction 压缩、外部状态持久化，把不可控的注意力转化为可控的上下文编排。
...
总趋势：注意力塌缩不会消失，但上下文管理重心正从模型内部（更长窗口、更好位置编码）向系统外部（检索、压缩、记忆、遗忘）迁移——正如 [How LLMs Actually Work: 0xkato Transformer Walkthrough](https://github.com/QianJinGuo/wiki/blob/main/entities/how-llms-actually-work-0xkato.md) 所揭示的"模型能力天花板由系统补足"的 Agent 时代范式。
...
- [上下文工程：三种 Agent Memory 方案对比实验](https://github.com/QianJinGuo/wiki/blob/main/entities/context-engineering-three-memory-paradigms.md)
- [Harness Engineering 系统性解读](https://github.com/QianJinGuo/wiki/blob/main/entities/harness-engineering-systematic-explainer.md)
- [用好 Claude 的 18 个动作：搭一个个人 AI 工作台（Personal Harness）](https://github.com/QianJinGuo/wiki/blob/main/entities/ruofei-claude-18-actions-personal-ai-workbench.md)
...
- [How LLMs Actually Work: 0xkato Transformer Walkthrough](https://github.com/QianJinGuo/wiki/blob/main/entities/how-llms-actually-work-0xkato.md)
