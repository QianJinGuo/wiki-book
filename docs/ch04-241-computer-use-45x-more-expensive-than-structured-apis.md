...
## Ch04.241 Computer Use 45x More Expensive Than Structured APIs
...
- [Anthropic 发布 Computer Use 最佳实践](/ch01-677-anthropic/) — Anthropic 官方的 Computer Use 优化建议，包括截图降采样等技巧
...
- [Claude Code Tool Design 演化](/ch01-677-anthropic/) — Anthropic 在 Agent 工具设计上的持续演进
