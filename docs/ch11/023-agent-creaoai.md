...
- [Claude Managed Agents 企业边界更新](../ch04/813-claude-managed-agents.html) = 同一系列，**关注企业 hybrid control plane**（self-hosted + Anthropic 推理）
...
- [AgentScope Builder](../ch04/796-self-evolving-agent.html) = 阿里云 Harness 框架 + 平台化，**关注 harness 框架**
