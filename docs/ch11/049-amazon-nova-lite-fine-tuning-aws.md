...
## 相关实体
- [Cost effective deployment of vision-language models for pet behavior detection on AWS Inferentia2](166-cost-effective-deployment-of-vision-language-models-for-pet.html)
...
- [AI Detection and Response (AIDR): A Zero-Impact Operating Model](../ch04/135-ai.html)
