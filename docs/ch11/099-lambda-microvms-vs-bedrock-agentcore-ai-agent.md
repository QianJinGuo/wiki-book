...
这种"统一底座 + 分层抽象"的策略——底层用同一套安全原语，上层暴露不同抽象级别的 API——是 AI 基础设施设计中的优秀实践，值得 [Harness 工程](../ch05/120-harness-engineering.html) 平台设计参考。
...
- [Amazon Bedrock Agent](../ch04/566-amazon-bedrock-agentcore.html)
- [Agent 代码沙箱安全](../ch04/409-sandboxing-an-ai-agent.html)
