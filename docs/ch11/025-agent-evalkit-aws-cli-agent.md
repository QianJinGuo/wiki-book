...
- [Agent Eval Wallezhang Yaml Driven Agent Evaluation Framework](ch03/044-agent.md) — YAML 驱动的 AgentEval 框架，Go 实现
- [Harness Engineered Business Agent Evaluation Aliyun Boyu](ch03/044-agent.md) — 阿里云泊予用 Claude Code 搭建评测 Harness
- [Langsmith Evaluation Concepts](ch03/124-langsmith-evaluation-concepts.md) — LangSmith 评测概念框架
- [Agent Harness Observability Production](ch03/044-agent.md) — Agent harness 生产可观测性
- [Agent Memory Evaluation Landscape Taobao Survey](ch03/044-agent.md) — Agent 记忆评估方法论全景
- [基于 aws 智能设备助手行业资产，构建社交渠道触达的消费级 agent 交互应用](ch03/044-agent.md)
- [使用 aws security agent 构建应用安全闭环：从代码提交到漏洞修复的自动化之路](ch03/044-agent.md)
