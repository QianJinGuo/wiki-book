...
## Ch11.189 使用 Kiro 规范驱动开发加速数据质量建设 | 亚马逊AWS官方博客
...
## 相关实体
- [使用 Kiro AI IDE 开发 AWS CDK 部署架构：从模糊需求到三层堆栈的协作实战 | 亚马逊AWS官方博客](../ch05/090-ai.html)
...
- [把 Kiro CLI 当作 Agent SDK：一键订阅即可构建你的Agent应用 | 亚马逊AWS官方博客](../ch03/046-agent.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/autoresearch-software-development.md)

- [AIDLC范式: 平台驱动到大数据工程的范式迁移](../ch05/090-ai.html)
