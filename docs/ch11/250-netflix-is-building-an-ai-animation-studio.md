...
## Ch11.250 Netflix is building an AI animation studio

> 📊 Level ⭐⭐ | 5.3KB | `entities/netflix-is-building-an-ai-animation-studio.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/netflix-is-building-an-ai-animation-studio.md)
