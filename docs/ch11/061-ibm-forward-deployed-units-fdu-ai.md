...
## Ch11.061 IBM Forward Deployed Units (FDU) AI 部署模型
...
- [硅谷一线 FDE 实践者圆桌](../ch01/1473-fde-field-deployment-engineer.html) — 与本文互补：IBM 是公司战略视角，该文是一线实践者视角，覆盖 FDE 三种形态、蒸馏飞轮、中国落地障碍等
