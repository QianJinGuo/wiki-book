...
> 📊 Level ⭐⭐ | 8.9KB | `entities/fast-fashion-ecommerce-agent-design-8-websocket-voice-system.md`
...
## 相关实体
- [你缺的不是更好的 AI，而是一个"装自己"的系统](https://github.com/QianJinGuo/wiki/blob/main/entities/vayne-lw-personal-agent-system.md)
