...
## Ch11.167 AI Infra 入门：RMSNorm、Softmax、Causal Mask、Sampling 的数学与底层优化

> 📊 Level ⭐⭐⭐⭐ | 16.2KB | `entities/ai-infra-math-foundations-rmsnorm-softmax-causal-mask-sampling-binnnliu-2026-06-17.md`
...
- [AI Infra 入门：vLLM 推理管线](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-infra-llm-efficient-inference-vllm.md) — 同作者同系列第一篇
- 模型推理对比
- 原文存档
