...
## Ch11.119 试用 Amazon Bedrock 中的新控制台体验：该体验针对兼容 Anthropic 和 OpenAI 的 API 进行了优化
...
- [Amazon Bedrock Agentcore Runtime Deep Dive And Scenario Analysis](../ch04/556-amazon-bedrock-agentcore.html) — Bedrock runtime 体系深度解析，与 bedrock-mantle 兼容端点互补
- [Agentops Operationalize Agentic Ai Amazon Bedrock](ch11/293-amazon-bedrock.html) — Bedrock 上 agent 的 production 化路径，包含 Guardrails / 知识库等安全机制
