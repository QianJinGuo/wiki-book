...
- [让 ai 代理自己付钱：基于 amazon bedrock agentcore 与 x402 的 agentic pay](ch11/048-bedrock-agentcore.md)
- [introducing claude platform on aws: anthropic’s native platf](../ch01/141-introducing-claude-platform-on-aws-anthropic-s-native-platf.md)
