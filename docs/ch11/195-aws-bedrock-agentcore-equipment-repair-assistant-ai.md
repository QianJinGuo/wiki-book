...
- [how baz improved its ai agent code review accuracy using ama](../ch04/279-ai-agent.html)
- [extending mcp support for amazon bedrock agentcore gateway](../ch04/392-amazon-bedrock-agentcore.html)
