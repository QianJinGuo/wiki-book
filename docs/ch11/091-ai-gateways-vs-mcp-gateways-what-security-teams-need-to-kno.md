...
## 关联阅读
- [Securing AI Agents: How AWS and Cisco AI Defense Scale MCP and A2A](../ch04/679-ai-agent.html) — MCP 和 A2A 协议在企业级部署中的规模实践
- [AI Tool Poisoning Exposes a Major Flaw in Enterprise Agent Security](../ch04/353-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s.html) — 工具投毒作为企业代理安全的核心缺陷
- [AI MAP: Security Testing for AI Agent Infrastructure — Bishop Fox](../ch04/518-introducing-aimap-security-testing-for-ai-agent-bishop-f.html) — Bishop Fox 的 AI 代理安全测试框架
