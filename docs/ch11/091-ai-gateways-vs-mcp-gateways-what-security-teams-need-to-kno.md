...
## 关联阅读
- [Securing AI Agents: How AWS and Cisco AI Defense Scale MCP and A2A](ch07/001-mcp.html) — MCP 和 A2A 协议在企业级部署中的规模实践
- [AI Tool Poisoning Exposes a Major Flaw in Enterprise Agent Security](ch05/100-ai.html) — 工具投毒作为企业代理安全的核心缺陷
- [AI MAP: Security Testing for AI Agent Infrastructure — Bishop Fox](ch05/100-ai.html) — Bishop Fox 的 AI 代理安全测试框架
- [AgentCore Runtime 部署 Apache Doris MCP Server](ch07/001-mcp.html) — MCP Server 部署实践
- [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/ai-gateways-vs-mcp-gateways-what-security-teams-need-to-know.md)
