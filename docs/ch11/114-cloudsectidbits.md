...
## 相关实体
- [AgentCore Identity: 3-legged OAuth + Session Binding 的安全架构](ch03/035-agent.html)
- [AWS IDP Accelerator](ch11/304-aws-idp-accelerator.html)
- [Secure AI agents with Policy and Lambda interceptors in Amazon Bedrock](ch05/100-ai.html)
