...
## Ch11.114 CloudSecTidbits：云安全研究摘要
...
## 相关实体
- [AgentCore Identity: 3-legged OAuth + Session Binding 的安全架构](ch11/266-aws-bedrock-agentcore.html)
- [AWS IDP Accelerator](ch11/304-aws-idp-accelerator.html)
- [Secure AI agents with Policy and Lambda interceptors in Amazon Bedrock](../ch04/209-ai-agent.html)
- [AWS Continuum：机器速度的安全自动化](../ch01/436-aws.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/cloudsectidbits-masso-cognito-sso.html.md)
