...
## Ch11.087 ai agent 的迁移与现代化 使用 amazon bedrock agentcore 将 openclaw 从单机改造为多租户 serverless 架构
...
- [Using Amazon Bedrock Agentcore Openclaw Multi 1](../ch04/648-amazon-bedrock-agentcore.html)
- [Openclaw Multi 5](ch11/253-openclaw.html)
