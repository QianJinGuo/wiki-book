...
## Ch11.149 在 Amazon Bedrock 上运行 MiniMax 模型
...
从 [Harness Engineering](https://github.com/QianJinGuo/wiki/blob/main/concepts/harness-engineering-framework.md) 视角看，M2.5 的 Agent-native 训练是对"能力-执行"分离模式的挑战：当模型本身就能理解 Agent 工作流时，外部的 Harness 层可以显著简化，仅仅负责资源调度和安全隔离，而非模型能力补全。这与 [Agent Harness 层级设计](../ch05/058-agent-harness.html) 中「智能体应具备自主工具选择能力」的理念一致。
