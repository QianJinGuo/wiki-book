...
这种组合模式与 [AgentCore 架构](../ch04/679-agentcore-harness.html) 中的「编排层 + 执行层」分离的思路一致。
...
- [AgentCore 多Agent系统AWS实现](../ch04/679-agentcore-harness.html)
- [Backend for Agent 架构](../ch03/035-agent.html)
- [腾讯 Harness Engineering 探索之旅](../ch05/112-harness-engineering.html)
- [企业级 Agent 编排](../ch04/511-agent-orchestration.html)
