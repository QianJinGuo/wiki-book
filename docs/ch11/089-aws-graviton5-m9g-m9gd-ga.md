...
- [aws 一周综述：amazon bedrock agentcore 付款、适用于 aws 的 agent 工具套件等（2](ch03/035-agent.html)
- [building blocks for foundation model training and inference](ch05/094-ai.html)
