...
- [aws 一周综述：amazon bedrock agentcore 付款、适用于 aws 的 agent 工具套件等（2](ch04/502-agent.md)
- [building blocks for foundation model training and inference](ch04/150-ai.md)
