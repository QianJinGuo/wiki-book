...
- [aws 一周综述：amazon bedrock agentcore 付款、适用于 aws 的 agent 工具套件等（2](../ch04/507-amazon-bedrock-agentcore.html)
- [building blocks for foundation model training and inference](ch11/117-building-blocks-for-foundation-model-training-and-inference.html)
