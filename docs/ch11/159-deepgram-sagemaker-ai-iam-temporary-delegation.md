...
- [AWS IDP Accelerator](ch11/304-aws-idp-accelerator.html) — AWS 上的文档处理加速器，另一个 AWS 托管服务的实践
- [Claude Code 学术文献审阅](../ch03/084-claude-code.html) — AI 辅助运维的另一个视角
- [Amazon Bedrock](ch11/306-amazon-bedrock.html) — AWS 的托管 LLM 推理服务，与自托管方案形成对比
