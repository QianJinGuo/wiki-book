...
## Ch11.177 Aderant transforms cloud operations with Amazon Quick
...
→ [Confluence + Amazon Quick 集成](ch11/039-integrate-atlassian-confluence-cloud-with-amazon-quick.md) — MCP 风格连接器在知识管理场景的具体配置
