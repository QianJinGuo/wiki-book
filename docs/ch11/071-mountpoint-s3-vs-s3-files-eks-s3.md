...
## Ch11.071 Mountpoint S3 vs S3 Files：EKS 上 S3 数据接入的两种方案实战对比
...
| [Eks Gpu Operator Custom Driver Cuda Workload](ch11/012-cuda.html) | EKS + GPU Operator + 自定义驱动 | 算力层，非存储层 |
| [Openclaw Leveraging Nova Mme S3 Vector Implement Skill](ch11/250-openclaw.html) | S3 Vector + Nova MME 实现 Skill 按需召回 | S3 Vector 语义检索，非挂载方案 |
| [Litellm Aws Ecs Eks Ai Gateway Architecture](../ch01/1132-llm.html) | LiteLLM AI 网关 + ECS/EKS | 推理网关，非存储 |
...
→ 原文存档：[原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/mountpoint-s3-与-s3-files-在-eks-上的实战对比.md)
## 相关实体

- [databricks storage ecosystem & opensharing：企业数据治理从 migrate e](../ch01/1268-rag.html)
