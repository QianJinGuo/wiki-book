...
## Ch11.246 AgentScope Java Harness Framework — 企业级 Agent 分布式场景的 Harness 实现
...
- [Agent Harness 架构](ch03/044-agent.md) — 7层金字塔模型，Harness 定位为 Agent 的"后台基础设施"
- [OpenClaw Prompt/Harness](ch11/209-openclaw.md) — 个人单机假设，workspace 即本地目录
...
- [上下文管理与 Working Set](ch03/044-agent.md) — AgentScope 的对话压缩 + 双层记忆沉淀 + FTS5 检索，是对 working set 理念的完整实现
