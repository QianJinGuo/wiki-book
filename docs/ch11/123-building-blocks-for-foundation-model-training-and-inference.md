...
## Ch11.123 Building Blocks for Foundation Model Training and Inference on AWS
...
- [SageMaker容量感知推理：实例池+优先级Fallback](../ch01/523-aws-sagemaker-capacity-aware-inference-fallback.html)
- [AI Infra 系统性拆解：传统后台工程师视角](../ch01/1555-ai-infra.html)
