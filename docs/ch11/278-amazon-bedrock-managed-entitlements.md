...
## Ch11.278 Amazon Bedrock Managed Entitlements — 多账号模型访问治理
...
- [AWS Budget Bedrock 成本治理](ch11/310-bedrock.html) — Bedrock 用量监控与预算告警
- [Bedrock Inference Profile 成本告警](ch11/306-amazon-bedrock.html) — 按业务单元追踪 Bedrock 成本
