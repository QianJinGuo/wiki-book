...
## Ch11.089 Amazon Cognito 多区域复制：跨区域用户认证韧性方案
...
### 5. 与 [Amazon Bedrock Cross Region Inference Cris Eu Gdpr](https://github.com/QianJinGuo/wiki-public/blob/main/entities/amazon-bedrock-cross-region-inference-cris-eu-gdpr.md) 的模式对比
