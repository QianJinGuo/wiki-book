...
## 相关实体
- [以 Kiro 快速部署云上 Agent：只需几个小时，从业务需求到部署于 Amazon Bedrock AgentCore 落地 | 亚马逊 AWS 官方博客](../ch04/640-amazon-bedrock-agentcore.html)
- [AgentCore Runtime 部署 Apache Doris MCP Server](ch11/192-apache-doris-mcp-server-quick-suite-ai.html)
- [使用 Kiro CLI 和 Agent Client Protocol 构建飞书 AI 聊天机器人 | 亚马逊 AWS 官方博客](../ch03/036-agent.html)
- [把 Kiro CLI 当作 Agent SDK：一键订阅即可构建你的 Agent 应用 | 亚马逊 AWS 官方博客](../ch03/036-agent.html)
- [Amazon Bedrock AgentCore + Quick Suite 构建 AI Analytics](../ch04/640-amazon-bedrock-agentcore.html)
