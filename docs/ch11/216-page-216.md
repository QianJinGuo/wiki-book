...
## Ch11.216 记忆体系工程实战：从设计选型到生产落地 — 存储分层、诊断框架与架构模式
...
与 [Hermes Agent 记忆系统架构](../ch03/093-hermes-agent.html) 互补——该实体聚焦 Hermes 记忆系统（SQLite/FTS5/sqlite-vec/Markdown）的具体源码实现，本实体提供通用的 **存储选型诊断框架与架构决策指南**。
...
- [Hermes Agent 记忆系统架构](../ch03/093-hermes-agent.html) — 互补：该实体聚焦 Hermes 源码实现，本实体提供通用选型框架
