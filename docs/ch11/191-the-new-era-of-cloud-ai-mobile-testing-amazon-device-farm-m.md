...
> 📊 Level ⭐⭐⭐⭐ | 8.6KB | `entities/cloud-ai-mobile-testing-new-era-amazon-device-farm-mcp-server-practical-guide-en.md`
...
- [停止编码的那天，就是失去架构判断力的开始：一位 30 年架构师的 AI 生存指南](https://github.com/QianJinGuo/wiki-public/blob/main/entities/stop-coding-architect-dennis-doomen-ai-era.md)
...
→ [原文存档](https://aws.amazon.com/cn/blogs/china/cloud-ai-mobile-testing-new-era-amazon-device-farm-mcp-server-practical-guide-en/)
