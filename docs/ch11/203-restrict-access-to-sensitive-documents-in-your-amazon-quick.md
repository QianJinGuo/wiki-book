...
## Ch11.203 Restrict access to sensitive documents in your Amazon Quick knowledge bases for Amazon S3 | Amazon Web Services
...
两者组合才能形成完整的防护：IAM 层面防止在敏感 bucket 上创建不带 ACL 的知识库，ACL 层面控制知识库内部的文档级访问。 See also [Harness Production Agent Engineering Deficit](ch04/503-agent.md)
