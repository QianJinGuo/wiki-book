...
网关模式通过在 agent 前面放置单一入口点来解决这个问题，无论 agent 运行在 [ECS](../ch04/289-agentic.html)、[Lambda](../ch04/498-agentrun.html)、Bedrock AgentCore Runtime、非 AWS 云还是混合环境。
...
- [Alibaba Cloud AgentRun 多 Agent A2A](../ch04/498-agentrun.html) — 不同云上的 A2A 实现
- [AWS/Cisco A2A 安全方案](../ch04/425-ai-agent.html) — A2A 安全治理生态
- [LangGraph A2A 对抗 Agent 团队](../ch04/261-langgraph.html) — A2A 协议的应用示例
