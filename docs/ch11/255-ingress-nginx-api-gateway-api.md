...
## Ch11.255 告别 Ingress Nginx：云原生 API 网关 Gateway API 使用指引
...
- [Aliyun Cloud Native Safety Guardrails Three Domains](https://github.com/QianJinGuo/wiki/blob/main/entities/aliyun-cloud-native-safety-guardrails-three-domains.md)
