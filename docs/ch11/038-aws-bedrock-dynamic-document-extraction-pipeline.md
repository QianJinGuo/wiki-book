...
### [Process Financial Documents Using Amazon Bedrock Data Automa](ch11/307-amazon-bedrock.html) — 同主题但不同角度
...
- [from pdfs to insights: architecting an intelligent document](ch11/262-from-pdfs-to-insights-architecting-an-intelligent-document.html)
