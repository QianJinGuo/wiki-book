...
## Ch11.052 基于 Prowler 与 GenAI 构建金融行业智能合规中枢
...
## 相关实体
- [基于 Prowler 与 GenAI 构建金融行业智能合规中枢](https://github.com/QianJinGuo/wiki/blob/main/entities/based-on-prowler-genai-build-fintech-intelligent-compliance-2.md)
