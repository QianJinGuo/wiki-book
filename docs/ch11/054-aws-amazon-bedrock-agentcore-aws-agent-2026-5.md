...
## Ch11.054 AWS 一周综述：Amazon Bedrock AgentCore 付款、适用于 AWS 的 Agent 工具套件等（2026 年 5 月 11 日）
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/aws-一周综述amazon-bedrock-agentcore-付款适用于-aws-的-agent-工具套件等2026-年-5-月-11-日.md)
...
- [build-custom-code-based-evaluators-in-amazon-bedrock-agentco](ch11/306-amazon-bedrock.html)- [aws graviton5 m9g/m9gd 实例 ga 公告](../ch01/437-aws.html)- [ec2 nat 实例选型与部署实践（aws 中国宁夏区域）](../ch01/437-aws.html)
