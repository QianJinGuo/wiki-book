...
这种"统一底座 + 分层抽象"的策略——底层用同一套安全原语，上层暴露不同抽象级别的 API——是 AI 基础设施设计中的优秀实践，值得 [Harness 工程](../ch05/050-harness-engineering.html) 平台设计参考。
...
- [Amazon Bedrock Agent](../ch04/666-amazon-bedrock-agentcore.html)
...
- [Agent 上下文管理](../ch05/066-agent-harness.html)
