...
这种"统一底座 + 分层抽象"的策略——底层用同一套安全原语，上层暴露不同抽象级别的 API——是 AI 基础设施设计中的优秀实践，值得 [Harness 工程](../ch05/096-harness-engineering.html) 平台设计参考。
...
- [Amazon Bedrock Agent](../ch04/674-amazon-bedrock-agentcore.html)
- [Agent 代码沙箱安全](../ch04/455-sandboxing-an-ai-agent.html)
- [AWS Lambda Serverless](ch11/145-what-you-need-to-know-about-lambda-microvms.html)
- [Harness Engineering](../ch05/096-harness-engineering.html)
- [Agent 上下文管理](../ch05/043-agent-harness.html)
