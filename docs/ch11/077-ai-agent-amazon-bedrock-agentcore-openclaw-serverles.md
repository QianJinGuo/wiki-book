...
## Ch11.077 ai agent 的迁移与现代化 使用 amazon bedrock agentcore 将 openclaw 从单机改造为多租户 serverless 架构
...
- [Using Amazon Bedrock Agentcore Openclaw Multi 4](../ch04/520-amazon-bedrock-agentcore.html)
- [Using Amazon Bedrock Agentcore Openclaw Multi 1](../ch04/520-amazon-bedrock-agentcore.html)
- [Openclaw Multi 5](ch11/225-openclaw.html)

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/ai-agent-的迁移与现代化-使用-amazon-bedrock-agentcore-将-openclaw-从单机改造为多租户-serverless-架构-.md)
