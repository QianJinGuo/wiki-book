...
## Ch11.081 Amazon Cognito 多区域复制：跨区域用户认证韧性方案
...
### 5. 与 [Amazon Bedrock Cross Region Inference Cris Eu Gdpr](ch11/181-amazon-bedrock.html) 的模式对比
...
## 相关实体
- [Aws Software Supply Chain Security Well Architected](../ch01/433-aws.html)
