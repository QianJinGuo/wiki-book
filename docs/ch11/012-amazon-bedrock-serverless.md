...
- [AWS Sagemaker Capacity Aware Inference Fallback](../ch01/229-aws-sagemaker-capacity-aware-inference-fallback.html) — 容量仲裁
...
- [Extending MCP support for Amazon Bedrock AgentCore Gateway](106-extending-mcp-support-for-amazon-bedrock-agentcore-gateway.html) — MCP三原语统一+OAuth委托网关机制
