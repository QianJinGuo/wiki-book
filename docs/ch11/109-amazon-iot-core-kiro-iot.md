...
## Ch11.109 基于 Amazon IoT Core 与 Kiro 构建可迁移的工业 IoT 数据管道
...
- [Kiro Quick Deploy Agent Deploy Amazon Bedrock Agentcore](../ch04/554-amazon-bedrock-agentcore.html)
- [Developing Flink Monitoring System On Amazon Emr With Kiro Ai Ide](../ch05/092-ai.html)
