...
## Ch11.213 AWS WAF AI Traffic Monetization — 内容所有者向 AI 收费的网络层基础设施
...
- [让 ai 代理自己付钱：基于 amazon bedrock agentcore 与 x402 的 agentic pay](ch11/050-bedrock-agentcore.html)
- [introducing claude platform on aws: anthropic’s native platf](../ch01/480-introducing-claude-platform-on-aws-anthropic-s-native-platf.html)
