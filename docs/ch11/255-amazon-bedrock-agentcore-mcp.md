...
## Ch11.255 使用 Amazon Bedrock AgentCore 构建企业级 MCP 服务器：四种架构模式
...
这一架构设计与以下实体相关：
- [AgentCore Harness](../ch04/759-agentcore-harness.html) — AgentCore 基础能力
- [AgentCore Managed Harness](../ch04/294-agentcore-managed-harness.html) — 托管式 AgentCore
- [Bedrock AgentCore 质量评估与策略控制](../ch04/643-amazon-bedrock-agentcore.html) — AgentCore 的评估治理能力
- [Bedrock AgentCore Gateway MCP Extension](../ch04/643-amazon-bedrock-agentcore.html) — AgentCore Gateway MCP 扩展
- [Anthropic 12 MCP Production Patterns](../ch01/1533-anthropic.html) — MCP 生产模式参考
