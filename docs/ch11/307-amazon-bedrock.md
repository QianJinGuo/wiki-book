...
## Ch11.307 Amazon Bedrock

> 📊 Level ⭐⭐ | 1.1KB | `entities/amazon-bedrock.md`

# Amazon Bedrock

> -> [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/miro-amazon-bedrock-bug-routing.md)
...
- [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/miro-amazon-bedrock-bug-routing.md)
- 原始链接: https://aws.amazon.com/blogs/machine-learning/how-miro-uses-amazon-bedrock-to-boost-software-bug-routing-accuracy-and-improve-time-to-resolution-from-days-to-hours/
