...
## Ch11.149 基于 Amazon ECS Fargate 自建 Keycloak 作为 AWS IAM Identity Center 外部 IdP，为 Kiro 提供企业级 SSO 登录

> 📊 Level ⭐⭐ | 8.2KB | `entities/基于-amazon-ecs-fargate-自建-keycloak-作为-aws-iam-identity-center.md`
...
**1. Fargate 免 EC2 的运维简化与多可用区成本权衡**^[].md]
...
**3. Secrets Manager 与 ECS Task Role 的安全集成模式**^[].md]
...
**4. SAML NameID = email 约定与身份治理的取舍**^[].md]
...
→ [[raw/articles/基于-amazon-ecs-fargate-自建-keycloak-作为-aws-iam-identity-center.md|原文存档]
