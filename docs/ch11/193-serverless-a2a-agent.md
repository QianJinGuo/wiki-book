...
## Ch11.193 构建 Serverless A2A 网关：Agent 发现、路由与访问控制
...
网关模式通过在 agent 前面放置单一入口点来解决这个问题，无论 agent 运行在 [ECS](ch03/044-agent.md)、[Lambda](ch03/044-agent.md)、Bedrock AgentCore Runtime、非 AWS 云还是混合环境。
...
- [Agentic Overlays：从 REST 到 A2A 的企业转型](ch03/044-agent.md) — REST → A2A 过渡的互补方案
- [Alibaba Cloud AgentRun 多 Agent A2A](ch03/044-agent.md) — 不同云上的 A2A 实现
- [AWS/Cisco A2A 安全方案](ch04/150-ai.md) — A2A 安全治理生态
- [LangGraph A2A 对抗 Agent 团队](ch03/044-agent.md) — A2A 协议的应用示例
