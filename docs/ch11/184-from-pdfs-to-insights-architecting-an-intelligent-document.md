...
- [optimize-blueprint-extraction-accuracy-in-amazon-bedrock-dat](../ch12/032-optimize-blueprint-extraction-accuracy-in-amazon-bedrock-dat.html) — 同 BDA 平台，本文是 IDP 4 层架构全景，optimize-blueprint 是单点 blueprint 优化深度
...
- [amazon-bedrock-agentcore-runtime-deep-dive-and-scenario-analysis](../ch04/392-amazon-bedrock-agentcore.html) — AgentCore Runtime 深度（与本文 Strands on AgentCore 对应）
