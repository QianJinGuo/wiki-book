...
这种组合模式与 [AgentCore 架构](../ch04/783-agentcore-harness.html) 中的「编排层 + 执行层」分离的思路一致。
...
- [AgentCore 多Agent系统AWS实现](../ch04/783-agentcore-harness.html)
- [Backend for Agent 架构](../ch03/019-agent.html)
