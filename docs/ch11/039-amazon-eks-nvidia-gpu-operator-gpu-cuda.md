...
## Ch11.039 在 Amazon EKS 上使用 NVIDIA GPU Operator 管理自定义 GPU 驱动与 CUDA 工作负载
...
- [mountpoint s3 vs s3 files：eks 上 s3 数据接入的两种方案实战对比](../ch01/413-rag.html)
- [规划 amazon eks 从 1.32 升级到 1.35：关键变更识别与逐版本实施路径](../ch01/200-1.html)
...
| 实体 | 焦点 | 与本文关系 |
|------|------|----------|
| [Building Blocks For Foundation Model Training And Inference On Aws](ch11/135-building-blocks-for-foundation-model-training-and-inference.html) | AWS 训练/推理基础设施通用构件 | 上层基础设施视角，本文专注 GPU 节点驱动管理 |
...
| [Gpu Virtualization Using Mig Technology On Amazon Sagemaker Hyperpod](../ch04/028-pod.html) | SageMaker HyperPod MIG 虚拟化 | SageMaker 路径，与 EKS 路径平行 |
...
- [Gpu Virtualization Using Mig Technology On Amazon Sagemaker Hyperpod](../ch04/028-pod.html)
- [Build Multi Tenant Ai Agent On Eks Graviton Openclaw K8S Practice](ch11/246-openclaw.html)
