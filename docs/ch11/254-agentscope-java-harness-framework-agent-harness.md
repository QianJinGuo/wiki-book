...
- [Agent Harness 架构](ch05/085-harness.md) — 7层金字塔模型，Harness 定位为 Agent 的"后台基础设施"
- [OpenClaw Prompt/Harness](ch05/085-harness.md) — 个人单机假设，workspace 即本地目录
...
- [Harness Engineering](ch05/091-harness-engineering.md) — Agent 从"聪明"到"可靠"的第三代工程范式；本文是 Java 生态的具体实现
- [上下文管理与 Working Set](ch05/085-harness.md) — AgentScope 的对话压缩 + 双层记忆沉淀 + FTS5 检索，是对 working set 理念的完整实现
- [Browser Harness](ch05/085-harness.md) — 浏览器端 Agent Harness；AgentScope 覆盖服务端 Java 场景
