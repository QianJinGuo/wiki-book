...
## Ch11.212 构建 Serverless A2A 网关：Agent 发现、路由与访问控制
...
网关模式通过在 agent 前面放置单一入口点来解决这个问题，无论 agent 运行在 [ECS](../ch04/289-agentic.html)、[Lambda](../ch04/005-agentrun.html)、Bedrock AgentCore Runtime、非 AWS 云还是混合环境。
...
- [AWS/Cisco A2A 安全方案](../ch04/762-ai-agent.html) — A2A 安全治理生态
