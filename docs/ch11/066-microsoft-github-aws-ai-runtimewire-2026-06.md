...
## Ch11.066 Microsoft / GitHub / AWS AI 算力承压事件分析（RuntimeWire 2026-06）
...
- [750B MoE PD 分离推理 EFA vs RoCE](../ch01/214-0.html) — AWS 上的 MoE 推理对比
- [NVIDIA Blackwell MLPerf Training 6.0](../ch05/084-ai.html) — Blackwell 训练性能基准
- [5237660](../ch01/214-0.html) — Sovereign Cloud 相关实体
