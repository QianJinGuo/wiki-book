...
## Ch11.176 ai agent 的迁移与现代化 使用 amazon bedrock agentcore 将 openclaw 从单机改造为多租户 serverless 架构
...
- [Using Amazon Bedrock Agentcore Openclaw Multi 4](https://github.com/QianJinGuo/wiki-public/blob/main/entities/using-amazon-bedrock-agentcore-openclaw-multi-4.md)
- [Using Amazon Bedrock Agentcore Openclaw Multi 1](https://github.com/QianJinGuo/wiki-public/blob/main/entities/using-amazon-bedrock-agentcore-openclaw-multi-1.md)
- [Openclaw Multi 5](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openclaw-multi-5.md)
