...
## Ch11.233 AI Infra 全景图：9 层 Agent 生产架构
...
- [腾讯研究院 AI 速递](../ch05/095-ai.html) — 行业动态
- [Agentic AI System Architecture](../ch05/091-harness-skill.html) — 分层 Agent 系统架构（5 层：Orchestrator → Harness → Skill → MCP → Model）
