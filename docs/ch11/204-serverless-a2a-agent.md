...
网关模式通过在 agent 前面放置单一入口点来解决这个问题，无论 agent 运行在 [ECS](../ch04/610-agentic.html)、[Lambda](../ch04/463-agentrun.html)、Bedrock AgentCore Runtime、非 AWS 云还是混合环境。
...
- [Agentic Overlays：从 REST 到 A2A 的企业转型](../ch04/610-agentic.html) — REST → A2A 过渡的互补方案
- [Alibaba Cloud AgentRun 多 Agent A2A](../ch04/463-agentrun.html) — 不同云上的 A2A 实现
