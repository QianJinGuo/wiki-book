...
- [Agent Eval Wallezhang Yaml Driven Agent Evaluation Framework](../ch03/019-agent.html) — YAML 驱动的 AgentEval 框架，Go 实现
...
- [基于 aws 智能设备助手行业资产，构建社交渠道触达的消费级 agent 交互应用](../ch03/019-agent.html)
