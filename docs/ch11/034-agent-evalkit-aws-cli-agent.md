...
- [Agent Eval Wallezhang Yaml Driven Agent Evaluation Framework](../ch03/037-agent.html) — YAML 驱动的 AgentEval 框架，Go 实现
- [Harness Engineered Business Agent Evaluation Aliyun Boyu](../ch05/077-harness.html) — 阿里云泊予用 Claude Code 搭建评测 Harness
...
- [基于 aws 智能设备助手行业资产，构建社交渠道触达的消费级 agent 交互应用](../ch03/037-agent.html)
- [使用 aws security agent 构建应用安全闭环：从代码提交到漏洞修复的自动化之路](../ch04/385-aws-security-agent.html)

- [基于浏览器请求录制与ai代码生成的e2e接口自动化测试实践](../ch05/109-ai.html)
