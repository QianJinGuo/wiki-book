...
## Ch11.238 AgentScope Java Harness Framework — 企业级 Agent 分布式场景的 Harness 实现
...
- [Browser Harness](ch04/327-browser-harness-agent.md) — 浏览器端 Agent Harness；AgentScope 覆盖服务端 Java 场景
