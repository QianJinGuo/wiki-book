...
## Ch11.126 LiteLLM + Amazon QuickSight 数据可视化配置：S3 + Athena + Aurora 三层数据源
...
- [LiteLLM Bedrock 成本治理实体](ch11/050-litellm-amazon-bedrock.html) — 同一 AI Gateway 主题
- [QuickSight Dataset Q&A](ch11/199-aws-quicksight-dataset-qa-natural-language.html) — QuickSight NL2SQL 能力
