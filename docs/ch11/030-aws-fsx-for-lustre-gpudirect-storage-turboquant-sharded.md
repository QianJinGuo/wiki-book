...
## Ch11.030 AWS FSx for Lustre + GPUDirect Storage + TurboQuant: Sharded LLM Model Loading
...
| 维度 | 现有 [Foundation Model Building Blocks](https://github.com/QianJinGuo/wiki/blob/main/entities/foundation-model-building-blocks.md) | 本文 |
|------|----------------------------------|------|
