...
## Ch11.211 在 Amazon EKS 上使用 NVIDIA GPU Operator 管理自定义 GPU 驱动与 CUDA 工作负载
...
| [Foundation Model Building Blocks](../ch03/039-foundation-model-building-blocks.html) | 训练/inference building blocks | 同上，更上层 |
...
- [Foundation Model Building Blocks](../ch03/039-foundation-model-building-blocks.html)
