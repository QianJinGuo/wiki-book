...
## Ch11.281 AgentScope Java Harness Framework — 企业级 Agent 分布式场景的 Harness 实现
...
- [OpenClaw Prompt/Harness](ch11/227-openclaw.html) — 个人单机假设，workspace 即本地目录
- [Thin Harness Fat Skills](../ch05/080-thin-harness-fat-skills-ai.html) — Thin Harness 理念：Harness 做薄（最小协调层），Skill 做厚（业务逻辑）
...
- [Harness Engineering](../ch05/116-harness-engineering.html) — Agent 从"聪明"到"可靠"的第三代工程范式；本文是 Java 生态的具体实现
- [上下文管理与 Working Set](../ch05/039-agent-harness.html) — AgentScope 的对话压缩 + 双层记忆沉淀 + FTS5 检索，是对 working set 理念的完整实现
- [Browser Harness](../ch05/131-browser-use-v0-13-browser-harness.html) — 浏览器端 Agent Harness；AgentScope 覆盖服务端 Java 场景
- [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/agentscope-java-harness-framework-enterprise-distributed.md)

## 相关实体
- [Harness Engineering 系统梳理](../ch05/116-harness-engineering.html)
