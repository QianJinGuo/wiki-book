...
> 📊 Level ⭐⭐⭐ | 7.0KB | `entities/enterprise-intelligent-data-query-solution-practice-based-on-strands-sdk.md`
...
- [从0到1:联想基于Strands Agent SDK的资源智能巡检Agent创新 | 亚马逊AWS官方博客](https://github.com/QianJinGuo/wiki-public/blob/main/entities/strands-agent-sdk-resource-intelligent-inspection-agent-innovation.md)
