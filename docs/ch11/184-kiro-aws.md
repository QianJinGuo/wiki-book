...
## Ch11.184 使用 Kiro 规范驱动开发加速数据质量建设 | 亚马逊AWS官方博客
...
## 相关实体
- [使用 Kiro AI IDE 开发 AWS CDK 部署架构：从模糊需求到三层堆栈的协作实战 | 亚马逊AWS官方博客](../ch05/085-ai.html)
...
- [AIDLC范式: 平台驱动到大数据工程的范式迁移](../ch05/085-ai.html)
