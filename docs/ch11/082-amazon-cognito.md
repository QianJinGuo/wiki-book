...
## Ch11.082 Amazon Cognito 多区域复制：跨区域用户认证韧性方案
...
### 5. 与 [Amazon Bedrock Cross Region Inference Cris Eu Gdpr](ch11/309-amazon-bedrock.html) 的模式对比
...
## 相关实体
- [Aws Software Supply Chain Security Well Architected](../ch01/432-aws.html)
