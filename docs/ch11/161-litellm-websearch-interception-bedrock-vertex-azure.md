...
## Ch11.161 LiteLLM WebSearch Interception 配置指南：让 Bedrock/Vertex/Azure 走代理 + 实时联网
...
- **AWS China Blog 同期 LiteLLM 矩阵**：
  - [LiteLLM 生产级部署](../ch01/1135-llm.html)
  - [LiteLLM Bedrock 成本管控](ch11/050-litellm-amazon-bedrock.html)
