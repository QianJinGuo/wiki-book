...
这一架构设计与以下实体相关：
- [AgentCore Harness](../ch04/766-agentcore-harness.html) — AgentCore 基础能力
- [AgentCore Managed Harness](../ch04/295-agentcore-managed-harness.html) — 托管式 AgentCore
- [Bedrock AgentCore 质量评估与策略控制](../ch04/648-amazon-bedrock-agentcore.html) — AgentCore 的评估治理能力
- [Bedrock AgentCore Gateway MCP Extension](../ch04/648-amazon-bedrock-agentcore.html) — AgentCore Gateway MCP 扩展
- [Anthropic 12 MCP Production Patterns](../ch01/776-anthropic.html) — MCP 生产模式参考
