...
## Ch11.085 Microsoft / GitHub / AWS AI 算力承压事件分析（RuntimeWire 2026-06）
...
- [AWS GRPO RLVR SageMaker](219-aws-grpo-rlvr-sagemaker-math-reasoning.html) — AWS 后训练栈
...
- [NVIDIA Blackwell MLPerf Training 6.0](https://github.com/QianJinGuo/wiki-public/blob/main/entities/nvidia-blackwell-mlperf-training-6-0-benchmark-results-2026-06.md) — Blackwell 训练性能基准
