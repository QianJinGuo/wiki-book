...
| [Foundation Model Building Blocks](../ch03/036-foundation-model-building-blocks.html) | 训练/inference building blocks | 同上，更上层 |
...
- [Foundation Model Building Blocks](../ch03/036-foundation-model-building-blocks.html)
