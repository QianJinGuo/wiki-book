...
## Ch11.168 将 AWS DevOps Agent 智能运维能力延伸到中国区
...
```mermaid
mindmap
  root(("将 AWS DevOps Agent 智能运维能力延伸到中国区"))
    分区隔离是架构级硬约束 非配置问题
...
**原文**: [将 Aws Devops Agent 智能运维能力延伸到中国区](ch11/287-aws-devops-agent.html)(raw/articles/将-aws-devops-agent-智能运维能力延伸到中国区.md)
