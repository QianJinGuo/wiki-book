...
## Ch11.146 LiteLLM WebSearch Interception 配置指南：让 Bedrock/Vertex/Azure 走代理 + 实时联网
...
- **AWS China Blog 同期 LiteLLM 矩阵**：
  - [LiteLLM 生产级部署](ch05/094-ai.html)
  - [LiteLLM Bedrock 成本管控](ch01/1274-llm.html)
  - [LiteLLM QuickSight 可视化](ch01/1274-llm.html)
