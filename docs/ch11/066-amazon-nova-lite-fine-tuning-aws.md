...
## 相关实体
- [Cost effective deployment of vision-language models for pet behavior detection on AWS Inferentia2](ch11/225-cost-effective-deployment-of-vision-language-models-for-pet.html)
...
- [AI Detection and Response (AIDR): A Zero-Impact Operating Model](../ch12/079-ai-detection-and-response-aidr-a-zero-impact-operating-model.html)
