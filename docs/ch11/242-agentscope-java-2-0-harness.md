...
## Ch11.242 AgentScope Java 2.0：企业级分布式 Harness 框架
...
- [AgentScope Java Harness Framework 42KB](ch04/502-agent.md) — 同 AgentScope Java 2.0 早期综述
- [AgentScope Builder](ch04/502-agent.md) — 同生态自进化视角
- [Loop Engineering](ch05/004-loop-engineering.md) — 同样强调"组织级流程约束"
- [MXC Execution Containers](ch04/150-ai.md) — 类似沙箱机制对比
- [Agent Harness Engineering Survey](ch04/502-agent.md) — Harness 行业全景
