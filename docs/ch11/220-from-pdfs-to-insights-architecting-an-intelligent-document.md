...
- [building-supercharger-how-rocket-close-optimized-title-opera](ch04/195-building-supercharger-how-rocket-close-optimized-title-oper.md) — 金融场景生产 case study (Rocket Close)，Strands Agents + Bedrock + MCP
...
- [process-financial-documents-using-amazon-bedrock-data-automa](ch11/251-bedrock.md) — 金融文档 BDA 案例
