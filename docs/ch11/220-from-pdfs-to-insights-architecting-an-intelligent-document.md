...
- [amazon-bedrock-agentcore-runtime-deep-dive-and-scenario-analysis](../ch04/500-amazon-bedrock-agentcore.md) — AgentCore Runtime 深度（与本文 Strands on AgentCore 对应）
