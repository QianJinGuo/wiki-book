...
| [Foundation Model Building Blocks](../ch03/092-foundation-model-building-blocks.html) | 训练/inference building blocks | 同上，更上层 |
| [在 Amazon Ec2 Gpu 实例上部署 Nvidia Nemoclaw 以 Amazon Bedrock 作为推理](ch11/295-amazon-bedrock.html) | Nemoclaw 安全沙箱 + Bedrock 混合推理 | 应用层，本文是底层 driver 管理 |
...
- [Foundation Model Building Blocks](../ch03/092-foundation-model-building-blocks.html)
