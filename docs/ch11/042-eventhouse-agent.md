...
- [Agent Harness 上下文管理：工作集视角](../ch05/043-agent-harness.html)：从 Harness 视角看上下文工作集管理
- [Agent Memory 架构本质](../ch04/524-perplexity-brain-self-improving-agent-memory-architecture.html)：记忆管理层
