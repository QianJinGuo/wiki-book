...
## Ch11.088 AWS Graviton5 M9g/M9gd 实例 GA 公告
...
- [aws 一周综述：amazon bedrock agentcore 付款、适用于 aws 的 agent 工具套件等（2](../ch04/530-amazon-bedrock-agentcore.html)
- [building blocks for foundation model training and inference](ch11/119-building-blocks-for-foundation-model-training-and-inference.html)
