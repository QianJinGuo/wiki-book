...
> 📊 Level ⭐⭐ | 11.3KB | `entities/agentcore-payments-x402-agentic-commerce.md`
...
## 相关实体
- [Bedrock Agentcore Payment X402 Agent](045-bedrock-agentcore.html)
- [Firecracker Bedrock Agentcore Multi Tenant](045-bedrock-agentcore.html)
- [Claude Code Aws Bedrock Guide](../ch09/070-claude-code-aws.html)
...
→ [原文存档](https://aws.amazon.com/blogs/machine-learning/agents-that-transact-introducing-amazon-bedrock-agentcore-payments-built-with-coinbase-and-stripe/)
