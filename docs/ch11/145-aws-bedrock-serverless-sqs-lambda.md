...
## 与知识库的连接
- → SunFinance ID提取：同样使用Bedrock作为推理后端，可复用此异步架构
- → OS-level Actions：AgentCore的Action执行可借助此管道实现高并发
---
## 深度分析
### 异步架构的本质：解耦与控速
...
*Source: [原文存档](https://aws.amazon.com/cn/blogs/china/amazon-bedrock-model-inference-serverless-architecture-case-study/)*
## 相关实体
...
- [Hapag-Lloyd：1.5万反馈/月95%情感准确率](https://github.com/QianJinGuo/wiki-public/blob/main/entities/aws-hapag-lloyd-bedrock-customer-feedback.md)
- [Halliburton Seismic Workflow with Amazon Bedrock and Generative AI](https://github.com/QianJinGuo/wiki-public/blob/main/entities/aws-bedrock-halliburton-seismic-workflow-genai.md)
...
- [55+ models, every modality. one api key, one bill.](https://github.com/QianJinGuo/wiki-public/blob/main/entities/digitalocean-serverless-inference-55-models.md)
- [aws bedrock dynamic document extraction pipeline](https://github.com/QianJinGuo/wiki-public/blob/main/entities/extract-data-with-on-demand-and-batch-pipelines-dynamically.md)
- [MOC](https://github.com/QianJinGuo/wiki-public/blob/main/moc/mcp-server-patterns.md)
