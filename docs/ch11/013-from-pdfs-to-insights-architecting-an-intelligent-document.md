...
- [optimize-blueprint-extraction-accuracy-in-amazon-bedrock-dat](../ch12/045-optimize-blueprint-extraction-accuracy-in-amazon-bedrock-dat.html) — 同 BDA 平台，本文是 IDP 4 层架构全景，optimize-blueprint 是单点 blueprint 优化深度
