...
## Ch11.276 Monitor Amazon SageMaker Pipelines cross-account with custom Amazon CloudWatch dashboards

> 📊 Level ⭐⭐ | 3.2KB | `entities/monitor-sagemaker-pipelines-cross-account.md`
...
- 对异常活动触发 CloudWatch 告警并通过 SNS 通知
