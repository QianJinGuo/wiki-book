...
## Ch11.057 在 Amazon Bedrock 上为 Claude 应用设计稳健的 Prompt Cache 策略
...
## 相关实体
- [Anthropic Prompt Caching for Claude Code](../ch01/288-anthropic-prompt-caching-claude-code.html) — Anthropic 官方博客解析：Prompt Caching 的 7 条经验与架构约束
...
- [Amazon Finance 监管查询自动化](ch11/009-how-amazon-finance-streamlines-regulatory-inquiries-by-using.html) — Bedrock + RAG 在金融合规场景的实战：多级 KV Cache、Query Expansion、DynamoDB 状态管理的完整架构
...
- [yc掌门人60天写了60万行代码：gstack开源](../ch01/637-garry-tan.html)
- [markdown 不会过时](../ch01/757-markdown.html)
- [miro-amazon-bedrock-bug-routing](ch11/163-miro-amazon-bedrock-bug.html)
