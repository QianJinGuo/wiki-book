...
## Ch11.232 AWS WAF AI Traffic Monetization — 内容所有者向 AI 收费的网络层基础设施
...
## 相关实体
- [使用 amazon cloudfront 和 aws waf 大规模交付 wordpress](../ch01/434-aws.html)
- [让 ai 代理自己付钱：基于 amazon bedrock agentcore 与 x402 的 agentic pay](ch11/059-bedrock-agentcore.html)
- [introducing claude platform on aws: anthropic’s native platf](../ch01/161-introducing-claude-platform-on-aws-anthropic-s-native-platf.html)
