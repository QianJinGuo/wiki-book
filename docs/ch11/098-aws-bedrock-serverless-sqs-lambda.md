...
## Ch11.098 AWS Bedrock Serverless 异步推理：SQS + Lambda
...
## 与知识库的连接
- → [SunFinance ID提取](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/aws-sun-finance-ai-id-extraction-fraud-detection.md)：同样使用Bedrock作为推理后端，可复用此异步架构
- → [OS-level Actions](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/aws-bedrock-agentcore-os-level-actions-browser.md)：AgentCore的Action执行可借助此管道实现高并发
---
## 深度分析
### 异步架构的本质：解耦与控速
...
- [Building Blocks for Foundation Model Training and Inference on AWS](ch11/135-building-blocks-for-foundation-model-training-and-inference.html)
