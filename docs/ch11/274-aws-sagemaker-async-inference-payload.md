...
## Ch11.274 AWS SageMaker Async Inference 内联 Payload 支持
...
- 异步推理架构参考：[SQS+Lambda 异步管道](ch11/020-aws-bedrock.html)
- SageMaker 工具链：[SageMaker SFT/DPO 工具调用](../ch01/432-aws.html)
