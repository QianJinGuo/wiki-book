...
> 📊 Level ⭐⭐⭐ | 13.6KB | `entities/from-manual-to-smart-use-kiro-cli-opensearch-mcp-to-make-everyone-an-opensearch-expert.md`
...
文章详细描述了 Kiro CLI 的四大核心能力，这些能力构成了一个完整的 Agent 系统：
...
1. 解析自然语言意图
2. 自动调用 OpenSearch MCP Server 的查询工具
3. 执行聚合查询
4. 生成分析结果并提炼关键发现
...
1. 自然语言查询索引情况
2. 检查现有索引模板（分片数、副本数、压缩算法）
3. 自然语言描述需求（"30天滚动周期"）
4. Kiro 自动生成并应用 ISM 策略
...
→ [原文存档](https://aws.amazon.com/cn/blogs/china/from-manual-to-smart-use-kiro-cli-opensearch-mcp-to-make-everyone-an-opensearch-expert/)
