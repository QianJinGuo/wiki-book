...
### 与知识库的连接
- 容量感知推理Fallback机制（[Aws Sagemaker Capacity Aware Inference Fallback](../ch01/525-aws-sagemaker-capacity-aware-inference-fallback.html)）体现了GPU资源管理的另一面——当容量受限时如何优雅降级
