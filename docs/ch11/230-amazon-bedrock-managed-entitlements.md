...
## Ch11.230 Amazon Bedrock Managed Entitlements — 多账号模型访问治理
...
- [AWS Budget Bedrock 成本治理](https://github.com/QianJinGuo/wiki/blob/main/entities/aws-budget-bedrock-cost-governance.md) — Bedrock 用量监控与预算告警
