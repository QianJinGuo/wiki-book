...
- [AgentScope Builder](ch03/045-agent.md) = 阿里云 Harness 框架 + 平台化，**关注 harness 框架**
...
### 与阿里云 Agentic Cloud
- [阿里云 Agentic Cloud](ch03/045-agent.md) = 关注 **云平台级别的 agent-as-a-service**（Bailian/Qwen/MaaS）——**关注平台对外的能力**
