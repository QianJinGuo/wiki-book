...
- [Claude Managed Agents 企业边界更新](../ch04/616-claude-managed-agents.html) = 同一系列，**关注企业 hybrid control plane**（self-hosted + Anthropic 推理）
...
### 与 RAG / Agent 评估
- [RAG 技术框架的演进方向](../ch01/284-rag.html) = 关注 **retrieval 充分性**（充分上下文智能体 = 信息的"够不够"判断）
