...
### 与 Cloud Agent 基础设施
- [Development environments for your cloud agents](ch03/044-agent.md) = Cursor 视角：dev environment 配置工具 + 多 repo 环境——**关注 dev tooling**，本文关注 **production runtime 隔离与凭据**
...
- [Claude Managed Agents 企业边界更新](ch03/044-agent.md) = 同一系列，**关注企业 hybrid control plane**（self-hosted + Anthropic 推理）

### 与多租户 / Serverless Agent
- [OpenClaw → Bedrock AgentCore 多租户迁移](ch04/150-ai.md) = 阿里云/AWS 的多租户 serverless 路径，**关注迁移路径**
- [AgentScope Builder](ch03/044-agent.md) = 阿里云 Harness 框架 + 平台化，**关注 harness 框架**
- [Stripe Agent 经济基础设施 5 套图谱](ch03/044-agent.md) = 关注 **agent 经济层基础设施**（支付/钱包/订阅），**与本文 runtime 隔离互补**
...
### 与阿里云 Agentic Cloud
- [阿里云 Agentic Cloud](ch03/044-agent.md) = 关注 **云平台级别的 agent-as-a-service**（Bailian/Qwen/MaaS）——**关注平台对外的能力**
