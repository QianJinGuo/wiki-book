...
## Ch11.178 Simplify model selection in Amazon Bedrock with the open source Model Router

> 📊 Level ⭐⭐ | 7.6KB | `entities/simplify-model-selection-in-amazon-bedrock-with-open-source-model-router.md`
