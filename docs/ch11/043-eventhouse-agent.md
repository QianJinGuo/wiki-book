...
## Ch11.043 阿里云 EventHouse 企业级 Agent 上下文构建五维框架
...
- [Agent Harness 上下文管理：工作集视角](../ch05/042-agent-harness.html)：从 Harness 视角看上下文工作集管理
- [Agent Memory 架构本质](../ch04/505-perplexity-brain-self-improving-agent-memory-architecture.html)：记忆管理层
...
- [智能体编排层中的上下文管理架构](../ch03/037-agent.html)：上下文管理架构模式
