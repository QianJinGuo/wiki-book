...
- 与 [LendingTree 多 Agent 架构](../ch04/758-how-lendingtree-built-a-multi-agent-mortgage-assistant-on-am.html) 同属"生产级多 Agent 架构"家族——都强调编排层与执行层解耦，但本文的核心增量是**规划/供给分离 + manifest 契约**（确定性执行 vs 对话式规划）
