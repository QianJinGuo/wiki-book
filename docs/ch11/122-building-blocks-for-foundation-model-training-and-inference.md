...
## Ch11.122 Building Blocks for Foundation Model Training and Inference on AWS
...
- [AWS Model Agility: 6步LLM跨代际迁移框架](ch11/172-aws-generative-ai-model-agility-framework.html)
...
- [EC2 Capacity Blocks：GPU短期容量决策指南](ch11/237-aws-ec2-capacity-blocks-gpu-ml.html)
- [SageMaker容量感知推理：实例池+优先级Fallback](../ch01/524-aws-sagemaker-capacity-aware-inference-fallback.html)
- [AI Infra 系统性拆解：传统后台工程师视角](../ch01/1577-ai-infra.html)
