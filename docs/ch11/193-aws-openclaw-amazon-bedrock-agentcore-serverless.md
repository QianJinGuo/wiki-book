...
- [from pdfs to insights: architecting an intelligent document](https://github.com/QianJinGuo/wiki-public/blob/main/entities/from-pdfs-to-insights-architecting-an-intelligent-document-p.md)
