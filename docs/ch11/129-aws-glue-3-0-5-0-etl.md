...
## Ch11.129 AWS Glue 3.0 到 5.0 版本升级实践：中国区大规模 ETL 平台的迁移方法论

> 📊 Level ⭐⭐ | 8.4KB | `entities/aws-glue-30-到-50-版本升级实践中国区大规模-etl-平台的迁移方法论.md`

# AWS Glue 3.0 到 5.0 版本升级实践：中国区大规模 ETL 平台的迁移方法论

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/aws-glue-30-到-50-版本升级实践中国区大规模-etl-平台的迁移方法论.md)
...
```mermaid
mindmap
  root(("AWS Glue 3.0 到 5.0 版本升级实践：中国…"))
    **一、引言**
    **二、升级范围评估**
    **三、中国区环境适配**
      2.1 Python 依赖离线化
