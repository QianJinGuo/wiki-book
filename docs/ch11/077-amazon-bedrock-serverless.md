...
## Ch11.077 Amazon Bedrock模型推理的Serverless异步架构 – 处理在线多模态高负载案例
...
- [[entities/introducing-os-level-actions-in-amazon-bedrock-agentcore-browser]- [gemma 4 模型发布 — google deepmind 开源权重家族在 amazon bedrock 上线](ch11/309-amazon-bedrock.html)
