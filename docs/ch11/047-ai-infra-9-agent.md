...
## Ch11.047 AI Infra 全景图：9 层 Agent 生产架构
...
- [Harness Engineering：AI 从"聪明"到"可靠"的第三代工程范式](../ch05/096-harness-engineering.html) — 互补概念：Harness 关注如何构建可靠 AI 系统，AI Infra 关注需要哪些基础设施组件
