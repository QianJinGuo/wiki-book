...
## Ch11.261 AWS BMad + AIDLC：用 BMAD Method 在 Serverless 上跑通可复制的 AI 驱动开发流程
...
1. **平台化视角** — AWS 官方出品的 AIDLC 实施指南，从云平台基础设施角度讲述，区别于 [spec-kit-bmad-sdd-practice-yexiaocha](../ch01/1213-spec.html) 的个人实践者视角
...
→ [SDD 规格驱动开发总结](../ch01/971-qoder.html)
