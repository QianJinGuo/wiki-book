...
5. **MoTS 去科层化** — 用单一职级消除办公室政治与官僚作风；与[Harness Engineering](../ch05/066-agent-harness.html)"减少人工翻译/人工兜底"的组织哲学一致
...
- [Harness Engineering 综述](../ch05/050-harness-engineering.html)（相关：构建大规模生产系统的工程能力）
- [Harness 架构](../ch05/066-agent-harness.html)（相关：Anthropic 40% 基础设施背景与 Harness 实践的组织基础）
