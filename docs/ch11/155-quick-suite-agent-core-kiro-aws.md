...
## 相关实体
- [以 Kiro 快速部署云上 Agent：只需几个小时，从业务需求到部署于 Amazon Bedrock AgentCore 落地 | 亚马逊 AWS 官方博客](https://github.com/QianJinGuo/wiki-public/blob/main/entities/kiro-quick-deploy-agent-deploy-amazon-bedrock-agentcore.md)
...
- [使用 Kiro CLI 和 Agent Client Protocol 构建飞书 AI 聊天机器人 | 亚马逊 AWS 官方博客](https://github.com/QianJinGuo/wiki-public/blob/main/entities/using-kiro-cli-agent-client-protocol-build-ai-chat.md)
- [把 Kiro CLI 当作 Agent SDK：一键订阅即可构建你的 Agent 应用 | 亚马逊 AWS 官方博客](https://github.com/QianJinGuo/wiki-public/blob/main/entities/use-kiro-cli-as-agent-sdk-build-your-agent-app-with-one-click-subscription.md)
- [Amazon Bedrock AgentCore + Quick Suite 构建 AI Analytics](https://github.com/QianJinGuo/wiki-public/blob/main/entities/mcp-serveramazon-bedrock-agentcorequick-suite.md)
- [原文存档](https://aws.amazon.com/cn/blogs/china/quick-suite-agent-core-kiro-logistics-quote-assistant/)
