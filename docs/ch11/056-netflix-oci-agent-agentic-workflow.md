...
> 📊 Level ⭐⭐ | 4.1KB | `entities/netflix-oci-agent-human-augmenting-causal-inference.md`
...
→ [原文存档](https://netflixtechblog.com/a-human-augmenting-agentic-workflow-for-causal-inference-4623f0a9c5af?source=rss----2615bd06b42e---4)
→ [LLM 主题 ≠ 真实变量 — 因果推断方法论](https://github.com/QianJinGuo/wiki-public/blob/main/entities/llm-themes-not-observations-causal-inference-william-gieng-2026.md)
