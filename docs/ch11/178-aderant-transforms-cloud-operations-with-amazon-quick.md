...
## Ch11.178 Aderant transforms cloud operations with Amazon Quick
...
## 关联阅读
→ [Amazon Quick: 从企业数据到 AI 决策的加速路径](ch04/310-ai.md) — Quick 平台整体能力介绍与定位
→ [Confluence + Amazon Quick 集成](ch11/038-integrate-atlassian-confluence-cloud-with-amazon-quick.md) — MCP 风格连接器在知识管理场景的具体配置
