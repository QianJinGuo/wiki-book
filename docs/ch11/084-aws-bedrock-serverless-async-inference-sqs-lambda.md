...
## Ch11.084 aws bedrock serverless async inference sqs lambda
...
## 与知识库的连接
- → [SunFinance ID提取](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/aws-sun-finance-ai-id-extraction-fraud-detection.md)：同样使用Bedrock作为推理后端，可复用此异步架构
- → [OS-level Actions](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/aws-bedrock-agentcore-os-level-actions-browser.md)：AgentCore的Action执行可借助此管道实现高并发
---
## 深度分析
### 异步架构的本质：解耦与控速
...
- [Hapag-Lloyd：1.5万反馈/月95%情感准确率](https://github.com/QianJinGuo/wiki/blob/main/entities/aws-hapag-lloyd-bedrock-customer-feedback.md)
- [Halliburton Seismic Workflow with Amazon Bedrock and Generative AI](https://github.com/QianJinGuo/wiki/blob/main/entities/aws-bedrock-halliburton-seismic-workflow-genai.md)
...
- [55+ models, every modality. one api key, one bill.](https://github.com/QianJinGuo/wiki/blob/main/entities/digitalocean-serverless-inference-55-models.md)
