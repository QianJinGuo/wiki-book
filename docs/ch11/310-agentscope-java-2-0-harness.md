...
## Ch11.310 AgentScope Java 2.0：企业级分布式 Harness 框架
...
- [AgentScope Builder](../ch04/768-self-evolving-agent.html) — 同生态自进化视角
- [Loop Engineering](../ch05/006-loop-engineering.html) — 同样强调"组织级流程约束"
- [MXC Execution Containers](../ch05/104-ai.html) — 类似沙箱机制对比
