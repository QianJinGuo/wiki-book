...
## Ch11.212 AWS FSx for Lustre + GPUDirect Storage + TurboQuant: Sharded LLM Model Loading
...
| 维度 | 现有 [Foundation Model Building Blocks](../ch03/039-foundation-model-building-blocks.html) | 本文 |
|------|----------------------------------|------|
