...
## Ch11.142 LiteLLM WebSearch Interception 配置指南：让 Bedrock/Vertex/Azure 走代理 + 实时联网
...
- **AWS China Blog 同期 LiteLLM 矩阵**：
  - [LiteLLM 生产级部署](../ch01/882-llm.html)
  - [LiteLLM Bedrock 成本管控](ch11/042-litellm-amazon-bedrock.html)
  - [LiteLLM QuickSight 可视化](ch11/217-amazon-quick.html)
