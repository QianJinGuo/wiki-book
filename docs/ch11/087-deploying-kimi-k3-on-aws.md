...
- [Kimi K3 2.8T Open Source Model 2026](../ch01/1422-kimi-k3.html) — Architectural deep dive on KDA, Attention Residuals, Stable LatentMoE, and GPU compiler innovations
...
- [Moe Architecture](../ch01/1451-moe-architecture.html) — Mixture of Experts architecture pattern used by Kimi K3 and other large-scale models
- [Amd Free Gpu Deepseek R1 Private Deployment](../ch01/803-deepseek.html) — AMD 上部署开源模型的先例
