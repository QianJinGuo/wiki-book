...
- [Kimi K3 2.8T Open Source Model 2026](../ch01/1418-kimi-k3.html) — Architectural deep dive on KDA, Attention Residuals, Stable LatentMoE, and GPU compiler innovations
...
- [Moe Architecture](../ch01/1446-moe-architecture.html) — Mixture of Experts architecture pattern used by Kimi K3 and other large-scale models
