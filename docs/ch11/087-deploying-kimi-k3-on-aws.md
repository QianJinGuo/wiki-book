...
## Ch11.087 Deploying Kimi K3 on AWS
...
- [Kimi K3 2.8T Open Source Model 2026](../ch01/1420-kimi-k3.html) — Architectural deep dive on KDA, Attention Residuals, Stable LatentMoE, and GPU compiler innovations
- [Kimi K3 2 8T Params Open Source](../ch01/890-kimi-k3-2-8t.html) — Coverage of the open-source release and model availability on Hugging Face
...
- [Vllm](../ch01/884-vllm.html) — The vLLM inference engine powering the Kimi K3 serving stack
- [Moe Architecture](../ch01/1448-moe-architecture.html) — Mixture of Experts architecture pattern used by Kimi K3 and other large-scale models
- [Amd Free Gpu Deepseek R1 Private Deployment](../ch01/1470-deepseek.html) — AMD 上部署开源模型的先例
