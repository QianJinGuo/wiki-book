...
## Ch11.129 基于 Amazon ECS Fargate 自建 Keycloak 作为 AWS IAM Identity Center 外部 IdP，为 Kiro 提供企业级 SSO 登录
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/基于-amazon-ecs-fargate-自建-keycloak-作为-aws-iam-identity-center.md)

- [Habib Hajallie S Meticulous Ballpoint Pen Drawings Examine The Depths Of Emotion](../ch03/005-habib-hajallie-s-meticulous-ballpoint-pen-drawings-examine-t.html)
