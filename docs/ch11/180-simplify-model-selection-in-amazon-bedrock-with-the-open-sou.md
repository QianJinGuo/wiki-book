...
## Ch11.180 Simplify model selection in Amazon Bedrock with the open source Model Router

> 📊 Level ⭐⭐ | 6.3KB | `entities/simplify-model-selection-in-amazon-bedrock-with-open-source-model-router.md`
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/simplify-model-selection-in-amazon-bedrock-with-open-source-model-router.md)
