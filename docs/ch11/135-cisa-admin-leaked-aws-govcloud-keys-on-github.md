...
## Ch11.135 CISA Admin Leaked AWS GovCloud Keys on Github
...
- [Open Source Projects Leaving Github](../ch01/903-github.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/cisa-admin-leaked-aws-govcloud-keys-on-github.md)- [github multilingual repositories dataset — 4000 万仓库多语言元数据](../ch01/903-github.html)
