...
## Ch11.236 Introducing Grok on Amazon Bedrock — Grok 4.3 GA with Mantle Inference Engine
...
- [Grok 4 5 Model Release Xai 2026 07](../ch05/094-ai.html) — Grok 4.5 model release (successor model)
...
- [Xai Dissolved Grok Colossus2 Analysis](../ch05/094-ai.html) — xAI Colossus cluster analysis
- [Openai Models Codex Amazon Bedrock Ga](ch11/295-amazon-bedrock.html) — OpenAI models on Bedrock GA
