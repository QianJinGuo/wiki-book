...
## Ch11.219 AWS EC2 Capacity Blocks GPU ML
...
mindmap
  root(("AWS EC2 Capacity Blocks GPU ML"))
    三个关键洞察
      Capacity Blocks vs Training Plans
      决策树
      短期GPU容量的新选择
    GPU容量供需失衡的结构性原因
    三层GPU短期方案的价值定位
...
### 与知识库的连接
- 容量感知推理Fallback机制（[Aws Sagemaker Capacity Aware Inference Fallback](../ch01/342-aws-sagemaker-capacity-aware-inference-fallback.html)）体现了GPU资源管理的另一面——当容量受限时如何优雅降级
