...
- [Factory Mission Multi Agent Architecture](../ch01/1476-factory-mission-multi-agent-architecture.html)
...
- [AgentScope Builder](../ch04/803-self-evolving-agent.html) — 同生态自进化视角
- [Loop Engineering](../ch05/006-loop-engineering.html) — 同样强调"组织级流程约束"
- [MXC Execution Containers](../ch05/111-ai.html) — 类似沙箱机制对比
