...
## Ch11.315 Netflix 分层通知系统：Thinking Fast & Slow 的 Slow-Fast RL 架构

> 📊 Level ⭐⭐⭐ | 7.7KB | `entities/netflix-notification-slow-fast-hierarchical-rl.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/thinking-fast-slow-for-a-personalized-notification-system.md)
...
- [VMAF v1](../ch01/334-1.html) — Netflix 视频质量度量
