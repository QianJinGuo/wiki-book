...
> 📊 Level ⭐⭐ | 5.3KB | `entities/using-kiro-cli-agent-client-protocol-build-ai-chat.md`
...
→ [原文存档](https://aws.amazon.com/cn/blogs/china/using-kiro-cli-agent-client-protocol-build-ai-chat/)
