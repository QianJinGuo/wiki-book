...
## Ch11.030 基于 Amazon WorkSpaces Applications 快速搭建企业级应用培训环境
...
## 相关产品
- [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/amazon-workspaces-applications-quick-build.md)
