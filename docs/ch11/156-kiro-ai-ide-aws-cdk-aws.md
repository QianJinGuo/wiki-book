...
## Ch11.156 使用 Kiro AI IDE 开发 AWS CDK 部署架构：从模糊需求到三层堆栈的协作实战 | 亚马逊AWS官方博客
...
```mermaid
mindmap
  root(("使用 Kiro AI IDE 开发 AWS CDK 部署架构"))
    Kiro AI IDE 的核心能力
    三层堆栈架构的演进逻辑
    关键技术决策点
    效率提升的关键路径
...
- [使用 Kiro 规范驱动开发加速数据质量建设 | 亚马逊AWS官方博客](../ch01/1026-spec.html)
