...
## Ch11.131 试用 Amazon Bedrock 中的新控制台体验：该体验针对兼容 Anthropic 和 OpenAI 的 API 进行了优化
...
- [Amazon Bedrock Agentcore Runtime Deep Dive And Scenario Analysis](../ch04/630-amazon-bedrock-agentcore.html) — Bedrock runtime 体系深度解析，与 bedrock-mantle 兼容端点互补
