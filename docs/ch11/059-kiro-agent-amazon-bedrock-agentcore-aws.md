...
> 📊 Level ⭐⭐ | 11.3KB | `entities/kiro-quick-deploy-agent-deploy-amazon-bedrock-agentcore.md`
...
- [三剑合璧Quick Suite + Agent Core + Kiro联动实践：海外物流报价助手实战 | 亚马逊AWS官方博客](../ch03/004-agent.html)
...
→ [原文存档](https://aws.amazon.com/cn/blogs/china/kiro-quick-deploy-agent-deploy-amazon-bedrock-agentcore/)
