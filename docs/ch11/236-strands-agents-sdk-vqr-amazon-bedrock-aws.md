...
## Ch11.236 用 Strands Agents SDK 构建确定性数据分析：语义层 + VQR 在 Amazon Bedrock 上的实践 | 亚马逊AWS官方博客

> 📊 Level ⭐⭐ | 5.5KB | `entities/strands-agents-sdk-build-analytics-layer-vqr-amazon-bedrock-practice.md`
...
## 相关实体
- [基于Strands Agents SDK和Amazon Bedrock AgentCore构建商品详情图广告词审查Agent | 亚马逊AWS官方博客](ch11/310-bedrock.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/build-financial-document-processing-with-pulse-ai-and-amazon-bedrock.md)
