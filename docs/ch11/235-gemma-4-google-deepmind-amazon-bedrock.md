...
## Ch11.235 Gemma 4 模型发布 — Google DeepMind 开源权重家族在 Amazon Bedrock 上线
...
- [amazon bedrock模型推理的serverless异步架构 – 处理在线多模态高负载案例](ch11/007-aws-bedrock.html)
...
- [diffusiongemma：扩散式文本生成模型（google 26b moe，4× 推理加速）](../ch01/927-20.html)
