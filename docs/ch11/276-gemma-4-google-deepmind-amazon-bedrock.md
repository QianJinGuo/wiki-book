...
## Ch11.276 Gemma 4 模型发布 — Google DeepMind 开源权重家族在 Amazon Bedrock 上线
...
## 相关实体
- [gemma 4 12b：google 多模态本地模型 —— 扔掉编码器](../ch01/621-gemma-4.html)
...
- [diffusiongemma：扩散式文本生成模型（google 26b moe，4× 推理加速）](../ch01/621-gemma-4.html)
