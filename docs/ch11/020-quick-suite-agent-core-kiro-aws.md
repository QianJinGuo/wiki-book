...
## 相关实体
- [以 Kiro 快速部署云上 Agent：只需几个小时，从业务需求到部署于 Amazon Bedrock AgentCore 落地 | 亚马逊 AWS 官方博客](../ch04/556-amazon-bedrock-agentcore.html)
...
- [Amazon Bedrock AgentCore + Quick Suite 构建 AI Analytics](../ch04/556-amazon-bedrock-agentcore.html)
