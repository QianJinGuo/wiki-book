...
- [使用 Kiro CLI 和 Agent Client Protocol 构建飞书 AI 聊天机器人 | 亚马逊 AWS 官方博客](ch05/094-ai.html)
- [把 Kiro CLI 当作 Agent SDK：一键订阅即可构建你的 Agent 应用 | 亚马逊 AWS 官方博客](ch03/035-agent.html)
- [Amazon Bedrock AgentCore + Quick Suite 构建 AI Analytics](ch03/035-agent.html)
