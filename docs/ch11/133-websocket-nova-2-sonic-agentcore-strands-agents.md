...
## Ch11.133 快时尚电商行业智能体设计思路与应用实践（八）基于 WebSocket 的语音系统：Nova 2 Sonic, AgentCore, Strands Agents 企业级架构实践 | 亚马逊AWS官方博客

> 📊 Level ⭐⭐ | 8.8KB | `entities/fast-fashion-ecommerce-agent-design-8-websocket-voice-system.md`
...
## 相关实体
- [你缺的不是更好的 AI，而是一个"装自己"的系统](../ch03/036-agent.html)
