...
## Summary
*(See [raw article](https://aws.amazon.com/cn/blogs/china/based-on-prowler-genai-build-fintech-intelligent-compliance/))*

## Notes
*(Add your notes here)*

## 相关实体
- [基于 Prowler 与 GenAI 构建金融行业智能合规中枢](049-prowler-genai.html)
