...
> 📊 Level ⭐⭐⭐⭐⭐ | 11.5KB | `entities/mountpoint-s3-vs-s3-files-eks-storage-comparison.md`
...
| [Openclaw Leveraging Nova Mme S3 Vector Implement Skill](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openclaw-leveraging-nova-mme-s3-vector-implement-skill.md) | S3 Vector + Nova MME 实现 Skill 按需召回 | S3 Vector 语义检索，非挂载方案 |
| [Litellm Aws Ecs Eks Ai Gateway Architecture](https://github.com/QianJinGuo/wiki-public/blob/main/entities/litellm-aws-ecs-eks-ai-gateway-architecture.md) | LiteLLM AI 网关 + ECS/EKS | 推理网关，非存储 |
...
→ 原文存档：[原文存档](https://aws.amazon.com/cn/blogs/china/mountpoint-s3-s3-files-eks-comparison)
## 相关实体

- [databricks storage ecosystem & opensharing：企业数据治理从 migrate e](https://github.com/QianJinGuo/wiki-public/blob/main/entities/databricks-storage-ecosystem-opensharing-govern-everything-2026.md)
