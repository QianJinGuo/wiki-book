...
## 相关实体
- [AgentCore Identity: 3-legged OAuth + Session Binding 的安全架构](ch11/280-aws-bedrock-agentcore.html)
- [AWS IDP Accelerator](ch11/303-aws-idp-accelerator.html)
- [Secure AI agents with Policy and Lambda interceptors in Amazon Bedrock](../ch04/237-ai-agent.html)
