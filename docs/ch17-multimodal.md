...
- [Nvidia Nemotron 3 Agents Rag Voice Safety](ch01/309-rag.md)（Nemotron 语音 + 智能体对照）
...
## 相关链接
- [Llava Onevision 2 Full Frame Rate Vlm](ch01/759-vlm.md)
...
## 相关页面
- [ChatGPT Memory](ch01/436-chatgpt-memory.md) — OpenAI 的记忆实现对比
...
- [Nemotron 3 5 Content Safety](ch01/517-nemotron-3-5-content-safety-customizable-multimodal-safety.md)
...
- [How To Build Audio Transcription Agent](ch04/437-how-to-build-audio-transcription-agent.md)
...
- [Agent 输入侧瓶颈背景](ch05/009-harness.md)
## 相关实体
- [Video Rag Chunking Strategy](ch01/309-rag.md)
- [MOC](https://github.com/QianJinGuo/wiki/blob/main/moc/vision-multimodal.md)
...
这与 [模型规模推演](ch01/575-model-size-scaling-in-2023-2031.md) 中关于 sparsity 作为参数放大器的讨论形成有趣对比——Moebius 走的是另一条路：不是增加总参数并稀疏化，而是直接在架构层面大幅压缩。
...
- [模型规模推演](ch01/575-model-size-scaling-in-2023-2031.md) — 模型大小与硬件约束的系统分析
