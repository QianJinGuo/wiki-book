...
## Ch17.056 DyRef：ECCV'26 Oral 多参考约束下的动态图像生成优化框架
...
## Ch17.057 高德 ABot-Earth 0.5：全球首个 3D 原生城市世界模型（1% 成本 + 千倍提效）
...
## Ch17.058 GenCeption — Video Generation Models are General-Purpose Vision Learners
