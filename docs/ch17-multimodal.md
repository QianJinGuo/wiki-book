...
## Ch17.022 CVPR 2026 | DGAF-VSR: 重思基于扩散模型的视频超分辨率
...
## Ch17.023 商汤SenseNova U1深度拆解，原生统一架构终结缝合时代
...
## Ch17.024 Normalizing Trajectory Models
...
## Ch17.025 Netflix 可控 AI 视频编辑：Vera 与 VOID 模型
...
## Ch17.026 Google's Gemini Omni video model surfaces ahead of I/O debut
...
## Ch17.028 OlmoEarth v1.1: A more efficient family of Earth observation models
...
## Ch17.029 MolmoMotion：语言引导的 3D 运动预测模型
...
## Ch17.030 Meta MSL（Multi-Scale Latent）：余家辉团队连发图像视频模型
...
## Ch17.031 Video World Model Hand Tracking — 视频生成模型实现手部动捕
...
## Ch17.033 Introducing 1-bit and Ternary Bonsai Image Models
...
## Ch17.034 Normalizing Trajectory Models
...
## Ch17.036 Moebius: 0.2B Lightweight Image Inpainting with 10B-Level Performance
...
## Ch17.037 Fine-Tuning NVIDIA Cosmos Predict 2.5 with LoRA/DoRA for Robot Video Generation
...
## Ch17.038 Stable Audio 3.0 开源音频生成模型
...
## Ch17.039 扩散模型视觉生成一致性框架（2026 综述）
...
## Ch17.040 Om AI VLX-Seek: 3B 细粒度感知 VLM 架构
...
## Ch17.041 vivo MagicBokeh — CVPR 2026 Best Paper Finalist，统一扩散框架长焦虚化
...
## Ch17.042 CoLT (Chain of Latent Thoughts): ECCV 2026 — 3步潜思维链加速多模态推理20+倍
...
## Ch17.043 20种机器人本体通吃！蚂蚁新一代VLA具身大脑刚刚开源了
...
## Ch17.044 Om AI VLX-Flow: 流式视频理解 VLM — VLX 系列开篇
...
## Ch17.045 Om AI VLX-Go: 0.6B 导航 VLM — VLX 系列收官
...
## Ch17.046 ShotStream: Streaming Multi-Shot Video Generation (ECCV 2026, 港中文&快手可灵)
...
## Ch17.047 ICRDrag：ECCV 2026 首个上下文区域拖拽图像编辑模型
