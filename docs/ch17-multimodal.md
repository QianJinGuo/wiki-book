...
## Ch17.021 CVPR 2026 | DGAF-VSR: 重思基于扩散模型的视频超分辨率
...
## Ch17.022 商汤SenseNova U1深度拆解，原生统一架构终结缝合时代
...
## Ch17.023 Normalizing Trajectory Models
...
## Ch17.024 Netflix 可控 AI 视频编辑：Vera 与 VOID 模型
...
## Ch17.025 Google's Gemini Omni video model surfaces ahead of I/O debut
...
## Ch17.027 OlmoEarth v1.1: A more efficient family of Earth observation models
...
## Ch17.028 MolmoMotion：语言引导的 3D 运动预测模型
...
## Ch17.029 Meta MSL（Multi-Scale Latent）：余家辉团队连发图像视频模型
...
## Ch17.030 Video World Model Hand Tracking — 视频生成模型实现手部动捕
...
## Ch17.032 Introducing 1-bit and Ternary Bonsai Image Models
...
## Ch17.033 Normalizing Trajectory Models
...
## Ch17.035 Moebius: 0.2B Lightweight Image Inpainting with 10B-Level Performance
...
## Ch17.036 Fine-Tuning NVIDIA Cosmos Predict 2.5 with LoRA/DoRA for Robot Video Generation
...
## Ch17.037 Stable Audio 3.0 开源音频生成模型
...
## Ch17.038 扩散模型视觉生成一致性框架（2026 综述）
...
## Ch17.039 Om AI VLX-Seek: 3B 细粒度感知 VLM 架构
...
## Ch17.040 vivo MagicBokeh — CVPR 2026 Best Paper Finalist，统一扩散框架长焦虚化
...
## Ch17.041 CoLT (Chain of Latent Thoughts): ECCV 2026 — 3步潜思维链加速多模态推理20+倍
...
## Ch17.042 20种机器人本体通吃！蚂蚁新一代VLA具身大脑刚刚开源了
...
## Ch17.043 Om AI VLX-Flow: 流式视频理解 VLM — VLX 系列开篇
...
## Ch17.044 Om AI VLX-Go: 0.6B 导航 VLM — VLX 系列收官
...
## Ch17.045 ShotStream: Streaming Multi-Shot Video Generation (ECCV 2026, 港中文&快手可灵)
...
## Ch17.046 ICRDrag：ECCV 2026 首个上下文区域拖拽图像编辑模型
...
## Ch17.048 智源悟界·RoboBrain Orca：多模态表征世界模型
...
## Ch17.049 维纳智能登上Nature通讯：AI不只会回答问题，开始生成高精度行业数据
