...
## Ch17.009 SunFinance: Textract+Claude准确率90.8%的ID提取方案
...
## Ch17.010 How transparent is DiffusionGemma (and why it matters)
...
## Ch17.011 FLAT: Feedforward Latent Triangle Splatting
...
## Ch17.012 Multimodal AI for Searchable Aerial Imagery at Scale
...
## Ch17.013 PersonaVLM — 长期个性化多模态大模型
...
## Ch17.014 LiteFrame: Efficient Vision Encoders Unlock Frame Scaling in Video LLMs
...
## Ch17.015 VoxCPM2：OpenBMB 开源 Tokenizer-free TTS，Voice Design 文字描述生成声音
...
## Ch17.016 别让格式杀死思想logics-parsing-v2定义文档解析新边界
...
## Ch17.017 小米多篇论文入选 ECCV 2026：人脸视频修复与视频模型加速
...
## Ch17.018 CVPR 2026 Highlight | 清华打破多模态音频生成的「通才困境」：Omni2Sound 音频基础模型开源！
...
## Ch17.019 Self-Filming Guide by Hello World Media
...
## Ch17.020 Gemma 4 12B：Google 多模态本地模型 —— 扔掉编码器
...
## Ch17.021 智源悟界·RoboBrain Orca：多模态表征世界模型
...
→ [新智元补充报道](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/智源悟界robobrain-orca多模态表征世界模型-2026-07-08.md)

---

## Ch17.022 ICRDrag：ECCV 2026 首个上下文区域拖拽图像编辑模型
...
## Ch17.023 CVPR 2026 | DGAF-VSR: 重思基于扩散模型的视频超分辨率
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/cvpr-2026-重思基于扩散模型的视频超分辨率利用对齐特征的稠密引导-dgaf-vsr.md)

---

## Ch17.024 商汤SenseNova U1深度拆解，原生统一架构终结缝合时代
...
## Ch17.026 Netflix 可控 AI 视频编辑：Vera 与 VOID 模型
...
## Ch17.027 Google's Gemini Omni video model surfaces ahead of I/O debut
...
## Ch17.028 豆包 Seed 2.0 Lite — Agent 前置多模态感官层
...
## Ch17.029 OlmoEarth v1.1: A more efficient family of Earth observation models
...
## Ch17.030 MolmoMotion：语言引导的 3D 运动预测模型
...
## Ch17.031 Meta MSL（Multi-Scale Latent）：余家辉团队连发图像视频模型
...
## Ch17.032 Video World Model Hand Tracking — 视频生成模型实现手部动捕
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/video-world-model-hand-tracking-2026.md)

---

## Ch17.033 美团海报生成 AIGC 技术创新与实践
...
## Ch17.034 Introducing 1-bit and Ternary Bonsai Image Models
...
## Ch17.035 Normalizing Trajectory Models
...
## Ch17.037 Moebius: 0.2B Lightweight Image Inpainting with 10B-Level Performance
...
## Ch17.038 Fine-Tuning NVIDIA Cosmos Predict 2.5 with LoRA/DoRA for Robot Video Generation
...
## Ch17.039 Stable Audio 3.0 开源音频生成模型
...
## Ch17.040 扩散模型视觉生成一致性框架（2026 综述）
...
## Ch17.041 Om AI VLX-Seek: 3B 细粒度感知 VLM 架构
...
## Ch17.042 vivo MagicBokeh — CVPR 2026 Best Paper Finalist，统一扩散框架长焦虚化
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/vivo-magicbokeh-cvpr-2026-generative-bokeh-diffusion.md)
...
## Ch17.043 CoLT (Chain of Latent Thoughts): ECCV 2026 — 3步潜思维链加速多模态推理20+倍
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/colt-eccv-2026-latent-thought-chain-multimodal-reasoning.md)

---

## Ch17.044 20种机器人本体通吃！蚂蚁新一代VLA具身大脑刚刚开源了
...
## Ch17.045 Om AI VLX-Flow: 流式视频理解 VLM — VLX 系列开篇
...
## Ch17.046 Om AI VLX-Go: 0.6B 导航 VLM — VLX 系列收官
...
## Ch17.047 ShotStream: Streaming Multi-Shot Video Generation (ECCV 2026, 港中文&快手可灵)

> 📊 Level ⭐⭐⭐ | 2.5KB | `entities/shotstream-streaming-multi-shot-video-cuhk-kling-eccv2026.md`
...
ShotStream 打破了传统双向架构的限制，将多镜头合成定义为基于历史上下文的下一镜头生成任务，用户可以通过动态流式提示词在运行时动态指导叙事走向。该模型在单张 H200 GPU 上实现了 16 FPS 的推理速度，相较于双向模型，将生成效率提升了 25 倍以上。
...
- 论文：[https://arxiv.org/pdf/2603.25746](https://arxiv.org/pdf/2603.25746)
...
## Ch17.049 高德 ABot-Earth 0.5：全球首个 3D 原生城市世界模型（1% 成本 + 千倍提效）
...
## Ch17.050 GenCeption — Video Generation Models are General-Purpose Vision Learners
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/genception-video-generation-general-purpose-vision-learner-2026.md)
