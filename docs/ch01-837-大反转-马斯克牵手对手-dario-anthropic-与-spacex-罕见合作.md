...
## Ch01.837 大反转！马斯克牵手对手 Dario，Anthropic 与 SpaceX 罕见合作
...
大反转！马斯克牵手对手 Dario，Anthropic 与 SpaceX 罕见合作 涉及anthropic领域的核心技术议题。
### 核心观点
1. 马斯克牵手对手 Dario，Anthropic 与 SpaceX 罕见合作
Anthropic 和马斯克的 SpaceX，官宣合作了。
2. Anthropic 官宣
这大概是最近最大反转的一条新闻：Anthropic 将使用 SpaceX 位于孟菲斯的 Colossus 1 超算集群的  ** 全部算力  ** ，超过 22 万块 NVIDIA GPU，涵盖 H100、H200 和最新的 GB200 加速器。
3. SpaceX 官宣
新增的算力超过  ** 300 兆瓦  ** ，一个月内就能部署完毕。
4. 换个说法就是：这相当于老马直接给 Claude 接上了一座小型发电站。
5. ##  火到宕机
而为什么 Anthropic 这么急着找算力呢？
