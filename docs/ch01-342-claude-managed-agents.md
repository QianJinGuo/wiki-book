...
## Ch01.342 Claude Managed Agents 开发者指南
...
## 与 PM 视角的关系
| 视角 | 本文（开发者指南） | [PM 视角](/ch04-383-anthropic-pm-的-agentic-工作流/) |
|------|-----------------|-----------------|
...
## Related
- [Claude Code Agent 工程设计](/ch04-015-claude-code-的-agent-工程/) — Claude Code 的本地 Harness 架构
- Agent Harness 上下文管理：工作集视角 — 托管 Harness 与本地 Harness 的上下文管理对比
- [Harness Engineering 框架](/ch05-041-harness-engineering-概念框架/) — Managed Agents 的 Harness 工程背景
