...
## Ch04.115 Pydantic AI: Progressive Agent Skills without Claude Model Lock-in
...
- [`Tencent Ai Infra Backend Engineer Huangrunpeng` — Python-first AI 框架的另一视角](/ch01-285-tencent-ai-infra-backend-engineer-s-guide-to-ai-system-hard/)
