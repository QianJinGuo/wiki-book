...
## Ch04.344 Greptile TREX：AI 代码审查的执行引擎与 Agent 嵌套架构
...
- [Claude Code 大型代码库 Harness](/ch09-006-claude-code-在大型代码库中的实战经验-从哪里入手-怎么做对/) — 代码库索引和 Agent 配置的工程实践
- [StackOverflow for Agents](/ch04-248-stack-overflow-for-agents-ephemeral-intelligence-gap-框架与-a/) — Agent 间知识共享的另一种模式
- [GitHub Agentic Token 效率](/ch04-169-improving-token-efficiency-in-github-agentic-workflows-git/) — Agent 在代码审查场景的 token 优化
