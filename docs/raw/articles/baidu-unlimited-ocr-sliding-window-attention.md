...
这份来源卡片记录一篇围绕“百度提出 Unlimited OCR：用 Reference Sliding Window Attention 实现长文档 OCR 常量 KV Cache”的第三方资料，主题标签为wechat、ocr、baidu。完整事实、论据、上下文与原文请以原始来源为准；公开仓库不保存正文副本。
