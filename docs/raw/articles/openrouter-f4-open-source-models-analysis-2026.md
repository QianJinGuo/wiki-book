...
模型  |  智力指数得分  |  价格(百万token输入/输出)  |  生成速度  |  适用场景
---|---|---|---|---
DeepSeek V4 Flash  |  40  |  0.054美元 / 0.242美元  |  约84个/秒  |  追求极致性价比，用白菜价跑出闭源头部级别代码能力
GLM 5.2  |  51 (开源第一)  |  0.447美元 / 3.31美元  |  约78个/秒  |  任务极度复杂，看重逻辑规划和长代码质量胜过看重低价
MiniMax M3  |  44  |  0.098美元 / 1.21美元  |  约59个/秒  |  智能体必须看图看视频，且需要处理超长上下文
Nemotron 3 Ultra  |  48  |  0.423美元 / 2.61美元 (有免费通道)  |  约75个/秒  |  看重供应商背景和企业级部署，需要融入英伟达技术栈
