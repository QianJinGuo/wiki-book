...
sha256: ac51b742bbb8547e68028e1e65e67168e0fec70d4b3426db920a17f7880b776e
source: newsletter
source_url: https://depthfirst.com/research/nginx-rift-achieving-nginx-rce-via-an-18-year-old-vulnerability
tags: [depthfirst]
fetcher: jina
review_value: 5
...
[Read about the Open Defense Initiative](https://depthfirst.com/open-defense)
[depthfirst](https://depthfirst.com/)[Platform](https://depthfirst.com/platform) Use cases [Customers](https://depthfirst.com/customer-stories)[Research](https://depthfirst.com/research)[Company](https://depthfirst.com/company)[Events](https://depthfirst.com/events)[Careers](https://depthfirst.com/careers)
...
[Supply Chain Know what's reachable, not just what's present](https://depthfirst.com/supply-chain)
[Secrets Stop leaks before they leave the repo](https://depthfirst.com/secrets)
[Dynamic Testing Find vulnerabilities in code that's already running](https://depthfirst.com/dynamic-testing)
...
![Image 1: The depthfirst system identified 4 remote memory corruption issues in NGINX](https://depthfirst.com/uploads/editorial/body/nginx-findings.png)
...
![Video 1](https://depthfirst.com/uploads/editorial/body/nginx_rce.mov)
**Proof of concept demonstrating unauthenticated RCE against NGINX via CVE-2026-42945.**
The source code of the proof of concept is available on our [GitHub repository](https://github.com/depthfirstdisclosures/nginx-rift).
## Affected Versions
...
*   5/13/2026: F5 released the [NGINX security advisory](https://my.f5.com/manage/s/article/K000160932).
*   5/13/2026: This blog post was published.
 Published  May 13, 2026 
 Author 
![Image 2: Zhenpeng (Leo) Lin avatar](https://depthfirst.com/uploads/editorial/authors/zhenpeng-leo-lin.jpeg)
Zhenpeng (Leo) Lin
[![Image 3](https://depthfirst.com/images/social/x-black.png)](https://x.com/markak_ "X")
