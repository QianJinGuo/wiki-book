...
这份来源卡片记录一篇围绕“Language model harnesses are compositional generalizers”的第三方资料，主题标签为harness、rlm、compositional-generalization。完整事实、论据、上下文与原文请以原始来源为准；公开仓库不保存正文副本。
