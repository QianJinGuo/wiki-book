...
sha256: 2a34ca05814b89cce672608fdd3cf845722a8f7b869ece0037b98aa4d1b1b6e5
---

source: wechat
source_url: https://mp.weixin.qq.com/s/fPVQx80oYRGHLhd6p3FGEw
ingested: 2026-07-24
source_published: 2026年7月23日 19:58
---
...
子图采样完成后，还需要转换为可阅读的自然语言题目。整个转换与验证流程分为三层：
  ...
  1. **题目生成** ：从子图抽取维基描述，改写为自然语言问题。

  2. **自动验证** ：检查问题是否完整覆盖子图关系，并由搜索智能体验证标准答案满足所有条件。

  3. **筛 选与复核**：排除多答案题和易答题，再由人工审核。
...
****[https://arxiv.org/abs/2606.12837](<https://arxiv.org/abs/2606.12837>)****
  ...
  * **HuggingFace：[ https://huggingface.co/datasets/meituan-longcat/LoHoSearch](<https://huggingface.co/datasets/meituan-longcat/LoHoSearch>)**
