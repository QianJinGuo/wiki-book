...
confidence: 6
source: lmsys
tags: [ml, inference, speculative-decoding, lmsys]
sha256: 127d2d9b5ec550dbe9e495c9ddc5c7feeede3f554b3463b8b0afd19308cd0557
---
...
Score: v=7, c=6, v×c=42, stars=4
Reason: Technically detailed LMSYS writeup on DFlash's diffusion+KV-injection speculative decoding with concrete benchmarks, ablations, and runnable SGLang code, but article is truncated and contains promotional framing.


Published Time: June 15, 2026
...
![Image 2](https://www.lmsys.org/images/blog/dflash-v2/dflash-arch-diagram.webp)
...
![Image 3](https://www.lmsys.org/images/blog/dflash-v2/dflash-vs-eagle-draft-latency.webp)
...
The key goal of the V2 engine as a whole is to reduce points of host-device synchronization, which [kill inference performance](https://modal.com/blog/host-overhead-inference-efficiency), no matter how fast the GPU is or how good the kernels are. The solution is called the _overlap scheduler_.
...
![Image 4](https://www.lmsys.org/images/blog/dflash-v2/dflash-perf-big-sweep.webp)For benchmark details and to reproduce the numbers yourself, see [the Hugging Face repo](https://huggingface.co/modal-labs/Qwen3.5-397B-A17B-DFlash/tree/main/benchmark).
