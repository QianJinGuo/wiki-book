...
sha256: 9e6ae656ba815f3cc0584b051d7416855fe32a453f2678f217274a78275b23b1
created: 2026-05-21
updated: 2026-05-21
review_value: 8
review_confidence: 8
...
To follow the walkthrough in this post, you need:
  ...
  * Familiarity with the Strands Evals `Case` → `Experiment` → `Report` workflow. If you are new to Strands Evals, see the [Strands Evals launch blog post](<https://aws.amazon.com/blogs/machine-learning/evaluating-ai-agents-for-production-a-practical-guide-to-strands-evals/>) for a quick tour.
...
Sangmin Woo is an Applied Scientist at AWS AI Labs, where he conducts research and develops machine learning solutions for agentic AI, with a focus on evaluation frameworks and advancing agent behavior and performance. His interests include agentic AI, generative models, and multimodal AI. Outside of work, he enjoys traveling and exploring new places.

### Sungyeon Kim

Sungyeon Kim is an Applied Scientist at Amazon Agentic AI. His research background spans computer vision, multimodal learning, and retrieval systems across both academia and industry. He currently works on agentic AI, with a particular focus on multimodal understanding and evaluation frameworks for AI agents.
...
Haibo Ding is a Principal Applied Scientist at Amazon Agentic AI, where his work spans both research and production on topics including Agent Evaluation, Tool Optimization, and Foundation Model Evaluation/Critic Models. He received his Ph.D. from the University of Utah, with research focused on NLP, large language models, prompt optimization, and constrained generation. He has served as an area chair for AAAI and ACL conferences.
