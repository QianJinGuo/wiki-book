...
sha256: df6730c53d54c9861db639fbf44f54b16af6a20a588c783e17af496b311a508a
---
...
就在前两天，工信部NVDB平台发布风险预警，明确指出**Claude Code 存在**安全后门隐患，可在用户不知情的情况下收集敏感信息。
...
从整体效果来看，SingGuard-NSFA在3大评测基准 _（用户请求安全、模型响应安全、跨数据集泛化）_ 上均取得**SOTA** ，最小的0.8B模型就能比肩8B竞品，9B大小更是在泛化上达到91.29% F1，精度与召回更加均衡。
