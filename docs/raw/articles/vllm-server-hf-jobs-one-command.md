...
created: 2026-06-27
updated: 2026-06-27
tags: [vllm, huggingface, inference, deployment, ai-infra]
---

# Run a vLLM Server on HF Jobs in One Command


Published Time: 2026-06-26T00:00:00.715Z

Markdown Content:
[Back to Articles](https://huggingface.co/blog)

[![Image 1: Quentin Gallouédec's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1677431596830-631ce4b244503b72277fc89f.jpeg)](https://huggingface.co/qgallouedec)

*   [Prerequisites](http://huggingface.co/blog/vllm-jobs#prerequisites "Prerequisites")

*   [Launch the server](http://huggingface.co/blog/vllm-jobs#launch-the-server "Launch the server")

*   [Query it from anywhere](http://huggingface.co/blog/vllm-jobs#query-it-from-anywhere "Query it from anywhere")

*   [Clean up](http://huggingface.co/blog/vllm-jobs#clean-up "Clean up")

*   [Going further: bigger models](http://huggingface.co/blog/vllm-jobs#going-further-bigger-models "Going further: bigger models")

*   [Going further: Chat with it in a UI](http://huggingface.co/blog/vllm-jobs#going-further-chat-with-it-in-a-ui "Going further: Chat with it in a UI")

*   [Going further: SSH into the running server](http://huggingface.co/blog/vllm-jobs#going-further-ssh-into-the-running-server "Going further: SSH into the running server")

*   [Going further: Use it as a coding-agent backend with Pi](http://huggingface.co/blog/vllm-jobs#going-further-use-it-as-a-coding-agent-backend-with-pi "Going further: Use it as a coding-agent backend with Pi")

*   [HF Jobs or Inference Endpoints?](http://huggingface.co/blog/vllm-jobs#hf-jobs-or-inference-endpoints "HF Jobs or Inference Endpoints?")

*   [Further reading](http://huggingface.co/blog/vllm-jobs#further-reading "Further reading")
...
## [](http://huggingface.co/blog/vllm-jobs#launch-the-server) Launch the server
...
## [](http://huggingface.co/blog/vllm-jobs#query-it-from-anywhere) Query it from anywhere
...
## [](http://huggingface.co/blog/vllm-jobs#going-further-bigger-models) Going further: bigger models
...
## [](http://huggingface.co/blog/vllm-jobs#going-further-chat-with-it-in-a-ui) Going further: Chat with it in a UI
...
[Video 5](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/vllm-jobs/demo.mp4)
## [](http://huggingface.co/blog/vllm-jobs#going-further-ssh-into-the-running-server) Going further: SSH into the running server
...
## [](http://huggingface.co/blog/vllm-jobs#going-further-use-it-as-a-coding-agent-backend-with-pi) Going further: Use it as a coding-agent backend with Pi
...
[Video 6](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/vllm-jobs/pi.mp4)
## [](http://huggingface.co/blog/vllm-jobs#hf-jobs-or-inference-endpoints) HF Jobs or Inference Endpoints?
...
## [](http://huggingface.co/blog/vllm-jobs#further-reading) Further reading
