---
title: 读完 Claude Code 和 OpenClaw 的 memory 源码，我对"Agent记忆需要向量数据库"这件事产生了怀疑……
source_url: https://mp.weixin.qq.com/s/m4wzwXCJoW5Tu4GA5ROodw
publish_date: 2026-05-16
tags: [wechat, article, claude, agent, rag, llm, openclaw]
review_value: 7
review_confidence: 7
review_recommendation: neutral
sha256: 30085a0f2a8a37ad024f297097a6516e2fcc3608ea5a8e0c301fe8e03ddbf8d2
---
...
1. 1\. 文本分块（Chunking）
2. 2\. 每个 chunk 生成 embedding 向量，存进 ` chunks_vec ` 虚拟表（用 sqlite-vec 扩展）
3. 3\. 同时建 FTS5 全文索引（ ` chunks_fts ` 表），支持 BM25 排名
