---
source: newsletter
source_url: https://softwaredoug.com/blog/2026/05/11/the-new-agentic-search-models.html
tags: [blog]
...
Don't fill this out if you're human:
 ...
 Subscribe [Learn more](http://softwaredoug.kit.com/)
 Check your email to confirm your subscription 
[](https://linkedin.com/in/softwaredoug)[](http://twitter.com/softwaredoug)[](mailto:doug@softwaredoug.com)[![Image 1](https://softwaredoug.com/assets/media/headshot2.jpg) Doug Turnbull](https://softwaredoug.com/)
[Consulting](https://softwaredoug.com/consulting) · [Training](http://maven.com/softwaredoug)
*   [Home](https://softwaredoug.com/)
[back home](https://softwaredoug.com/)
 May 11th, 2026 
...
But a new power is rising: **agentic search models.** LLMs trained _specifically_ on controlling the search task. Compared to GPT-5 and pals, these models might focus on tasks / domains. They can be smaller, faster, and easier to deploy in our search infrastructure.
Let’s set the stage.
With the traditional lego pieces, we build something like this thick search monolith:
![Image 2: image.png](https://softwaredoug.com/assets/2026/media/the-new-agentic-search-models/image.png)
...
![Image 3: image.png](https://softwaredoug.com/assets/2026/media/the-new-agentic-search-models/image%201.png)
...
## GPT-5 doesn’t _really_ know search
...
Teams advertise these replacements by training on document _search_ specifically - they focus on that last 20% needed to find useful results. Sid, for example, points to [smaller size and lower latency](https://www.sid.ai/research/sid-1) compared to GPT-5 for agentic search.
...
#### Starting May 18!
 Signup here - [http://maven.com/softwaredoug/cheat-at-search](http://maven.com/softwaredoug/cheat-at-search)[![Image 4](https://softwaredoug.com/assets/media/2026/cheat-at-search-social.png)](https://maven.com/softwaredoug/cheat-at-search)I hope you join me at [Cheat at Search with Agents](https://maven.com/softwaredoug/cheat-at-search) to learn use agents in search. build better RAG and use LLMs in query understanding. 
![Image 5](https://softwaredoug.com/assets/media/headshot2.jpg)
#### Doug Turnbull
[More from Doug](https://softwaredoug.com/)
[Twitter](https://twitter.com/softwaredoug/) | [LinkedIn](https://www.linkedin.com/in/softwaredoug/) | [Newsletter](https://softwaredoug.kit.com/) | [Bsky](https://bsky.app/profile/softwaredoug.bsky.social)
* * *
* * *
