...
source_url: https://mp.weixin.qq.com/s/B7sa6g6_51ya1LG0dfydKw
publish_date: 2026-05-10
tags: [wechat, article, openai, gpt, agent, rag, llm]
review_value: 7
review_confidence: 7
review_recommendation: neutral
sha256: 139e9f3bd2d052fff71b6842210ddb09b584a0c9657e94737f0a2c96a89e93ba
---
# Agent框架OWL原理详解
** 前言  **
...
** Assistant Agent的System Prompt：  **
    ...
    我必须一次只给你一条指令。你必须写出能恰当解决所请求指令的具体解决方案，并解释你的解决方案。如果由于物理、道德、法律原因或你的能力限制而无法执行指令，你必须诚实地拒绝并解释原因。除非我说任务已完成，否则你应该始终以以下内容开头：  
    解决方案：<你的解决方案>  
