...
sha256: 79da081320f9ad41d653d91734bd380fb06aae8dc19bea8f82b60b461b3c6225
---
...
**VitaBench 2.0 是 首个真实生活场景下面向长期动态用户建模的智能体评测基准，它系统性地评测大语言模型在长期、真实、动态的用户互动中个性化与主动性的能力。**
...
为了探究记忆在长期用户建模中的作用，VitaBench 2.0搭建了**首个真实用户 场景下的统一长期智能体评测平台**，通过可扩展的接口，让两种代表性机制在此对决：
