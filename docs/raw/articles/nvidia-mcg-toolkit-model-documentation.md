...
这份来源卡片记录一篇围绕“How to Automate AI Model Documentation with the NVIDIA MCG Toolkit”的第三方资料，主题标签为nvidia、documentation、tool。完整事实、论据、上下文与原文请以原始来源为准；公开仓库不保存正文副本。
