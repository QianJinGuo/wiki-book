...
ingested: 2026-06-03
sha256: 3e7c2fa715592f4821f93a125fee944dd1e05f93d6a9e708835dcb8fb212bc40
tags: [newsletter, ai]
---
...
2.   **Spin up a sandbox per candidate query**, the same sandboxes we use to run [PostHog Code](https://posthog.com/code), our coding agent and product editor (currently in beta).
...
If this works, "some queries in our codebase don't use the primary 
