...
created: 2026-08-18
updated: 2026-08-18
source_url: https://mp.weixin.qq.com/s?__biz=MzUxMDQxMDMyNg==&mid=2247520198&idx=1&sn=080a86b89d0bc24a9157913cb3839bd3
source_published: 2026-08-17
feed_name: WeChat-小米技术
ingested: 2026-08-18
sha256: 021716e8cd2b32ccb87db9f6b5d017ad69464f8dbc8ec43ad62445cad6524be0
---
...
复盘这个案例，RAG 主要遇到了三个问题：
  ...
  1. **碎片化****上下文** ：每段文档独立检索，彼此之间的业务层级关系在检索结果中被切断。模型看到的是孤立的字段说明，看不到它们在全量指标体系中的位置。
...
因此，治理工作主要包括三个方面：
  ...
  3. **补充数据过滤约束** ：发现部分指标底层存在未过滤的脏数据，查询时必须加过滤条件。
