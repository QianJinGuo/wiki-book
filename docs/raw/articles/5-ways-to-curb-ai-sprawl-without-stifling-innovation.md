...
“Shadow usage is dramatically outpacing production,” said [Chris Drumgoole](https://dxc.com/about-us/leadership-and-governance), president of global infrastructure services at IT service provider DXC Technology. In many organizations, unofficial AI usage already exceeds sanctioned deployments by several multiples. Worse, he said, IT teams often have very little visibility into where and how these tools are being used.
...
[Alla Valente](https://www.forrester.com/analyst-bio/alla-valente/BIO14124), principal analyst at Forrester Research, sees AI sprawl emerging from multiple directions. Some of it is driven by formal initiatives, but a growing share comes from unsanctioned employee usage or as new features added to existing software and services.
Many vendors are [adding AI capabilities to products companies already use](https://www.computerworld.com/article/1634120/generative-ai-productivity-apps-problems-solutions.html), often without those features being fully tracked or categorized. In some cases, these capabilities are enabled by default or introduced through routine updates, making them easy to miss.
...
As Valente notes, the pace of [AI innovation is outstripping governance](https://www.computerworld.com/article/4122948/responsible-ai-gap-why-ai-adoption-keeps-outrunning-governance-and-what-to-do-about-it.html). Risks are evolving faster than policies and controls, leaving organizations to manage them in real time rather than through established frameworks.
...
There is also growing concern about AI-generated outputs. These systems often produce responses that sound authoritative but are incorrect (colloquially known as “[hallucinations](https://www.computerworld.com/article/4067372/how-to-curb-hallucinations-in-copilot-and-other-genai-tools.html)”), increasing the risk that flawed information enters business decisions or operational workflows.
...
**Related reading:**
*   [Gartner sees untamed growth in agentic AI](https://www.computerworld.com/article/4165686/gartner-sees-untamed-growth-in-agentic-ai.html)
*   [New agentic AI tools bring new threat: agent sprawl](https://www.cio.com/article/3987692/new-agentic-ai-tools-bring-new-threat-agent-sprawl.html)
*   [Taming agent sprawl: 3 pillars of AI orchestration](https://www.cio.com/article/4132287/taming-agent-sprawl-3-pillars-of-ai-orchestration.html)
