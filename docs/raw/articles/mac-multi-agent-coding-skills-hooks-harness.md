...
source_url: "https://mp.weixin.qq.com/s/XZObIQdInhax3I7Q_gURTg"
publish_date: 2026-06-04
tags: [wechat, article, harness, mac, multi-agent-coding, skills, hooks, pdca, probabilistic, deterministic, claude-context, agent-coding]
review_value: 9
review_confidence: 9
review_recommendation: strong
sha256: c9687bfd79baaa0bd266ea62bda817c8689e705c9232b67849e9aaaf3aaff910
---

# MAC（multi-agent-coding）：Skills + Hooks 两层 Harness
> "**完全委托的前提，不是更强的模型，是更可靠的环境。**" —— MAC 设计者
>
> "**LLM 的指令遵从是概率性的**。在概率性之上堆更好的 prompt，得到的还是概率性的可靠。想要在规模上稳定，必须在 prompt 层之上加确定性约束。"
...
→ [[raw/articles/mac-multi-agent-coding-skills-hooks-harness|原文存档]]

## 一句话定位

**"Skills 引导 AI 做正确的事，Hooks 保证关键的事一定发生——两层叠在一起，Harness 才成立。"** —— 这是 Harness 设计的核心分层原则。
