...
这份来源卡片记录一篇围绕“Recent Developments in LLM Architectures: KV Sharing, mHC, and Compressed Attention（机器之心中文全文）”的第三方资料，主题标签为llm、architecture、kv-cache。完整事实、论据、上下文与原文请以原始来源为准；公开仓库不保存正文副本。
