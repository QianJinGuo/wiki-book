...
sha256: e46757bf8e686681dabdd52a4908120e328a92372af464f741c885fd7564c622
---
...
1. 1\. 设计循环：明确任务如何启动、如何推进、如何停止。
2. 2\. 设定边界：规定 AI 能读什么、能写什么、哪些动作必须确认。
3. 3\. 沉淀上下文：用 Skills 和 Memory 记录项目规则与历史决策。
4. 4\. 选择验证信号：明确什么叫「完成」，什么叫「失败」。
5. 5\. 审查最终结果：确认代码真的工作，而不是只相信系统摘要。
