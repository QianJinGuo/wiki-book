...
这份来源卡片记录一篇围绕“System Over Model, Tested: Reproducing Mythos’s FreeBSD Find on Local Open-Weight Models”的第三方资料，主题标签为article。完整事实、论据、上下文与原文请以原始来源为准；公开仓库不保存正文副本。
