...
sha256: 5e660a81b9efcbb4a20d56eb911f3bc34be19c13924be4d32098cc45f992f626
---

# Anthropic LLM ATT&CK Navigator: AI-Enabled Cyber Operations

> Source: [https://red.anthropic.com/2026/attack-navigator/](https://red.anthropic.com/2026/attack-navigator/)
> Author: Anthropic Red Team
> Ingested: 2026-06-12
...
![Image 1: Figure: Top 25 techniques by observations count, n=13,873 total observations across 832 accounts](http://red.anthropic.com/2026/attack-navigator/fig1.png)
...
![Image 2: Figure: Tactic share of total TTP observations](http://red.anthropic.com/2026/attack-navigator/fig2.png)
...
![Image 3: Figure: Tactics by mean actor risk score](http://red.anthropic.com/2026/attack-navigator/fig3.png)
...
![Image 4: Figure: Technique and tactic coverage per actor](http://red.anthropic.com/2026/attack-navigator/fig4.png)
...
![Image 5: Figure: Risk category distribution across the first and second halves of the study period](http://red.anthropic.com/2026/attack-navigator/fig5.png)
...
[[1]](http://red.anthropic.com/2026/attack-navigator/#ftnt_ref1) For the DBIR, we provided analysis of 11 months of threat actor data, and rounded this out to 12 months for this report.

[[2]](http://red.anthropic.com/2026/attack-navigator/#ftnt_ref2) We observe sub-techniques from both the Enterprise and the Mobile technique matrices from MITRE. Enterprise techniques account for 99% of observations.
