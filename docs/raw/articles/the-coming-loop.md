...
ingested: 2026-06-24
sha256: 67a3634b42e9f0ee59b44d8ca752075e192a1ee9733c6f18e2bb7caf2ca51f6d
tags: [agent, loop, harness, ai-systems, architecture]
---
...
Over the last months I have watched more and more people build something on top of coding agents that feels meaningfully different from just using a coding agent. Some of this happens on top of [Pi](https://pi.dev/) which is cool to see for sure! The pattern is the same everywhere though: work is put into a queue of sorts, a machine picks it up, attempts it, stops, and then some harness decides whether that was actually the end.
...
[copy as](https://lucumr.pocoo.org/2026/6/23/the-coming-loop.md) / [view](https://lucumr.pocoo.org/2026/6/23/the-coming-loop.md) markdown
