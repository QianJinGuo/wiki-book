...
## Ch01.350 谷歌PM公开：2026开发者五大新技能——问题塑形/上下文设计/审美/编排/判断力
...
## 相关主题
- [Agent Orchestration](../ch04-409-agent-orchestration) — Agent 编排模式（AWS Step Functions 控制平面）
- [Claude Code Governance Soft Rules](../ch09-067-claude-code-可控性-软规则无法变成硬约束) — Claude Code 可控性设计
- [Openai Skills Shell Compaction Agent Primitives](../ch05-024-openai-skills-shell-compaction-终结提示词工程的三位一体agent原语) — OpenAI Skills/Shell/Compaction 三位一体
