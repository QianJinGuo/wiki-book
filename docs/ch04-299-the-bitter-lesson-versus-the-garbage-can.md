...
- 与 [Claude Code 现状](/ch09-017-ethan-mollick-claude-code-and-what-comes-next-practitioner/)对照：Claude Code 是"工艺派"——精心设计的 harness + Opus 4.5 智能 + Skills + Subagents + MCP。属于"精心打造"的 agent 范式——但其作者团队同时投入算力与训练。
