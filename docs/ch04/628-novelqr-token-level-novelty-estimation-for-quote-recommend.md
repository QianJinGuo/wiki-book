...
## Ch04.628 NOVELQR — Token-Level Novelty Estimation for Quote Recommendation
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/novelqr-用agent做深度语义标签-token级新颖性破解自回归偏差.md)
