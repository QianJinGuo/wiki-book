...
## Ch04.678 Skill Hub MVP：可评估、可回滚、可发布的 Agent Skill 治理平台
...
- → [企业级 Skill 8 块最小骨架 + 8 条 checklist](ch04/270-skill.html) — 同作者 winty，侧重 Skill 本身的设计规范
- → [Skill Hell：Agent Skill 工程落地](ch04/364-skill-hell-agent-skill.html) — Skill 工程化的实践挑战
