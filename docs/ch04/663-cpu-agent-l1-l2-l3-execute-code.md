...
## Ch04.663 CPU 缓存类比下的 Agent 上下文管理：L1/L2/L3 层级架构与 execute_code 单工具设计
...
### 与 [Anthropic 工具数量陷阱](ch04/552-ai-agent.html) 的对比
...
- [AI Agent 工具数量陷阱](ch04/552-ai-agent.html) — "5-10 工具"是 Anthropic 答案；"1 execute_code"是本文答案（更激进的同向论述）
...
- [Codex 上下文工程 LastWhisper](../ch01/535-codex.html) — 另一家 Code 厂商的上下文视角
- [上下文工程系列](ch04/565-agentic-ai.html) — 系列化上下文工程讨论
