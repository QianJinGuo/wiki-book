...
## Ch04.318 Building Agentic AI Applications with Data Mesh on AWS
...
- [Agentic Overlays](../ch03/045-agent.html) — 另一种 agent 化路径：REST 服务的 A2A overlay
...
- [Agent Harnesses Are Dead](ch04/612-agent-harnesses-are-dead-long-live-agent-harnesses.html) — Agent Harness 架构演进
