...
## Ch04.395 Agent架构关键变化：Harness正在成为新后端
...
related:
  ...
  - [Harness 工程化体系](../ch05/092-harness-engineering.html)
  - [Context Management 与 Working Set](../ch05/042-agent-harness.html)
...
- [Agent Harness 12 组件与 7 个关键决策](../ch05/042-agent-harness.html)
- [Harness Engineering：让 Coding Agent 可靠完成长程任务](../ch05/092-harness-engineering.html)
