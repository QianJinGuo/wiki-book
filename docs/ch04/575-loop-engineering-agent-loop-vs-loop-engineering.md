...
与 [Loop Engineering 系统框架](../ch05/122-loop-engineering.html) 的关系：梦朝思夕的四次跃迁框架（Prompt → Context → Harness → Loop）提供了历史脉络，本文则从 Agent Loop 底层机制出发，解释了为什么 Loop Engineering 是"此 Loop 非彼 Loop"。
...
- [Loop Engineering 系统框架](../ch05/122-loop-engineering.html) — 四次跃迁、五要素模型、成本公式
- [Agent Loop 工程手册](../ch05/122-loop-engineering.html) — 腾讯陈进的8个未解问题
- [Loop Engineering: 设计替你写提示词的循环](../ch05/122-loop-engineering.html) — Addy Osmani 原始框架
