...
- [Harness Engineering 框架](../ch05/062-harness-engineering.md)——Environment 是 Harness 的外层延伸
- [Harness 之后：可删的工作现场](../ch05/083-harness-engineering-deletable-worksite-ruofei.md)——"可删的工作现场"概念与 Environment 的可恢复性呼应
...
- [清华 Harness Engineering 报告](../ch05/062-harness-engineering.md)——EurekAgent 的权限/产物/预算/人在环四工程与清华报告互补
