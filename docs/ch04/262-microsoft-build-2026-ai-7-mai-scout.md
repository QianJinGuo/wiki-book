...
## 相关实体
- [Microsoft Build 2026 Qbitai Full Scope](https://github.com/QianJinGuo/wiki-public/blob/main/entities/microsoft-build-2026-qbitai-full-scope.md)

→ [原文存档（AI 前线版）](https://mp.weixin.qq.com/s/H6dZibozzF8Q_j8pumvsJw)
→ [原文存档（量子位全景版）](https://mp.weixin.qq.com/s/qeb0jxNQIUYPVZum0guvfg)
...
### vs [OpenClaw](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openclaw-architecture-8-part-summary.md)
...
## 相关对照
- [Kimi Work](https://github.com/QianJinGuo/wiki-public/blob/main/entities/kimi-work-codex-vibe-working-paradigm-shift.md) —— 本地桌面 Agent + Vibe Working
...
- [OpenClaw](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openclaw-architecture-8-part-summary.md) —— 开源 AI 编程框架（Scout 基于它）
