...
## Ch04.377 AI Agent 时代选型指南：模型·应用· Harness（Mollick）
...
- [Co Existence Paradigm Shift Agentic Ai Mollick 2026](../ch01/827-ai-mollick.html) — Mollick 2026-06 范式转换叙事（同一作者更新的 agentic 时代框架）
