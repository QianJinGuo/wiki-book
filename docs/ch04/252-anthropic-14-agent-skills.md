...
## Ch04.252 Anthropic 14 个 Agent Skills 设计模式
...
- [Agent/Skills/Teams 架构演进与选型](ch04/255-skill.md) — Anthropic Skills 认知一致性机制
...
- [Trace2Skill: 轨迹经验蒸馏为可迁移 Agent Skills](ch04/255-skill.md)
