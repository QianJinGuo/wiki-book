...
> 📊 Level ⭐⭐⭐⭐ | 9.2KB | `entities/qy_zacztcs1ql3bifmbmgg.md`
...
- [k-dense — the model is no longer the bottleneck](295-k-dense-the-model-is-no-longer-the-bottleneck.html)

## 关联

- 同题异语种孪生页：[Subagents 详解Claude Code 如何避免上下文污染](https://github.com/QianJinGuo/wiki-public/blob/main/entities/subagents-详解claude-code-如何避免上下文污染.md)（归并候选，提案卡 #11 批1）
