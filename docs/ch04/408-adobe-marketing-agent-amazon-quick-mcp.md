...
## Ch04.408 Adobe Marketing Agent 与 Amazon Quick MCP 集成实战
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/accelerate-campaign-workflow-with-insights-from-adobe-market.md)
...
- [Amazon Bedrock AgentCore Web Search](ch04/268-amazon-bedrock-agentcore-web-search-ga.html)
