...
## Ch04.755 在数据所在处构建 Agent: CrewAI + Snowflake 企业级 Agent 部署
...
- [Agent 数据治理模式](../ch03/036-agent.html) 聚焦数据库凭证安全，本文聚焦企业级构建吞吐量和 Snowflake 集成
- [CrewAI 小步快跑](../ch03/036-agent.html) 聚焦开发方法论，本文聚焦数据治理和平台集成
- [Agent 安全三步序列](../ch05/017-harness.html) 聚焦安全，本文聚焦数据所在处的 Agent 构建
...
- [Agent 数据治理模式](../ch03/036-agent.html)
- [CrewAI 小步快跑](../ch03/036-agent.html)
- [Agent 安全三步序列](../ch05/017-harness.html)
- [Agentium Agent 框架](../ch01/1448-agentium-agent.html)
- [Snowflake Agentic Enterprise Summit](ch04/289-agentic.html)
