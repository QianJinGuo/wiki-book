...
## 与 vault 知识关联
- [Agent Harness 架构](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-harness-architecture.md) — Agent 与企业软件的交互层，Harness 是 Agent 执行时的"护城河"
...
- [Agent Memory 模块化框架](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-memory-modular-framework.md) — 数据排放（data exhaust）与记忆系统的关系
...
- [from](../ch01/511-from-system-of-record-to-system-of-intelligence.html)
- [From System Of Record To System Of Intelligence](../ch01/511-from-system-of-record-to-system-of-intelligence.html)
