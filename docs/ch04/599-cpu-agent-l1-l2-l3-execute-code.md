...
## Ch04.599 CPU 缓存类比下的 Agent 上下文管理：L1/L2/L3 层级架构与 execute_code 单工具设计
...
### 与 [Anthropic 工具数量陷阱](ch04/147-ai-agent.md) 的对比
...
- [AI Agent 工具数量陷阱](ch04/147-ai-agent.md) — "5-10 工具"是 Anthropic 答案；"1 execute_code"是本文答案（更激进的同向论述）
- [Agent Harness 上下文管理工作集视角](../ch05/038-agent-harness.md) — 工作集是 **L1 内部**的精细化设计；本文是工作集的 L1/L2/L3 宏观扩展
...
- [Codex 上下文工程 LastWhisper](../ch01/520-codex.md) — 另一家 Code 厂商的上下文视角
- [上下文工程系列](ch04/059-agentic-ai.md) — 系列化上下文工程讨论
