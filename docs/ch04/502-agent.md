...
## Ch04.502 Agent核心技术概念与范式发生了哪些演变以及背后的思考
...
4. （本文覆盖的4阶段+6维度Agent框架已由 entity [Agent 四阶段演化与六维度技术变化](ch04/502-agent.md) 完整收录。
5. ）
### Prompt：渐进式披露
