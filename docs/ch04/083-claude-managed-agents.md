...
> -> [原文存档](https://claude.com/blog/new-in-claude-managed-agents)
...
**Source**: [raw article](https://claude.com/blog/new-in-claude-managed-agents) | **Review**: value=8 confidence=9
...
→ [原文存档](https://mp.weixin.qq.com/s/lF7yYI2Q2b_D5-jSsrfGcQ)
