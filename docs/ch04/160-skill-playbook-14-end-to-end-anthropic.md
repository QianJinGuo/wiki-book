...
- [Agent Skill Writing Guide](ch04/608-agent-skill.html) — 21KB，"从 0 到 1" 入门级（岗位职责说明书 + SOP + 避坑指南）。本实体是**进阶 + 团队管理 + 工程化评估**的扩展版。
- [Ai Skill Skill Creator 源码拆解](ch04/372-skill-skill.html) — 28KB，skill-creator 源码深度拆解（3 Agent 评审）。本实体是 Skill Creator **5 步工作流 + 3 阶段评估的实战使用**视角，那个是**源码内部机制**视角。
...
- [Anthropic 官方技能最佳实践14 个可复用的 Agent Skills 设计模式](ch04/486-agent-skills.html) — Anthropic 官方 14 patterns 译本。命名相似但内容不同。
- [Agent Skill Writing Practices](ch04/608-agent-skill.html) / [Agent Skill Writing Advanced](ch04/608-agent-skill.html) / [Agent Skill Writing Evaluation](ch04/608-agent-skill.html) — 系列其他 skill 写作视角。本实体是**鹅厂完整 Playbook 视角**。
...
- Skill 系统综述 — [Agent Skills Comprehensive Survey](ch04/486-agent-skills.html)
- Skill 元技能 — [Meta Skill](../ch07/029-meta-skill.html)
- Skill vs Coze/Dify/n8n — [Agent Skills Vs Coze Dify N8N Lowcode Yexiaocha](ch04/486-agent-skills.html)
- Skill 质量优化 — [Skills Refiner Design Quality Evaluation Framework](../ch03/076-skills.html)
- Anthropic 95% 数据分析 Skill 栈 — [Anthropic 95Pct Data Analysis Skill Stack Architecture](../ch01/1586-anthropic.html)
