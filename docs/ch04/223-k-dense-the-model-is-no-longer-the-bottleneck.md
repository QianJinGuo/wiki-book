...
## Ch04.223 K-Dense — The Model Is No Longer the Bottleneck
...
- **支持 [Miroflow Deep Research Agent Harness Mirothinker](../ch05/042-agent-harness.html)** — Deep Research 类 harness 是设计典范，单模型质量不及 harness
- **补充 [Agent Harness Engineering Survey 2026](../ch05/065-harness-engineering.html)** — Survey 中 "context engineering" 一节的科学 AI 实例
