...
## Ch04.235 Agent 开发应小步快跑：第一个 Agent 只需做一件事（哪怕很烂）
...
- `[Agent Harness Engineering Survey 2026](../ch05/129-harness-engineering.html)` — Harness Engineering 综述，提供"harness 是什么"的理论基础
