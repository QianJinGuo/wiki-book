...
## Ch04.117 Sub-Agent vs Agent Team 选型指南
...
- [Minimax Agent Team Mavis Owner Worker Verifier](../ch01/1295-owner-worker-verifier.html)
- [Huggingface Ai Agent Glossary Model Scaffolding Harness Tool Skill Subagent](ch04/402-ai-agent.html)
- [Sub Agent Vs Agent Team Selection](ch04/117-sub-agent-vs-agent-team.html)
