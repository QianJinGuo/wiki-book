...
这些场景与 [AgentCore 运行时深度分析](ch03/035-agent.html) 中覆盖的 Agent 生命周期管理直接衔接。而 [AgentCore 记忆哲学](ch05/100-ai.html) 则从更底层的记忆系统角度讨论了数据持久性的设计理念。
...
- [突破上下文窗口壁垒](ch03/035-agent.html) — AgentCore 上下文管理
- [结构化记忆与元数据过滤](ch03/035-agent.html) — AgentCore 记忆系统
- [Agent 记忆工程税](ch03/035-agent.html) — 记忆系统的工程挑战
