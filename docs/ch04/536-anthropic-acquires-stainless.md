...
## Ch04.536 Anthropic Acquires Stainless
...
- [Anthropic 12 个 MCP 生产模式](../ch01/778-anthropic.html) — Anthropic 官方 MCP 设计模式，与收购后自营 MCP server 工具链直接相关
- [Anthropic 14 个 Skill 最佳实践](../ch01/454-anthropic-14-skill.html) — Anthropic 开发者体验体系中的另一支柱
- [Anthropic Agent 平台演进](ch04/690-anthropic-agent-platform.html) — Claude Platform 与代理连接战略的宏观背景
