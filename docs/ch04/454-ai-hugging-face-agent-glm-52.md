...
## Ch04.454 ai-黑客真的来了hugging-face-遭遇-agent-自主攻击靠自建glm-52反击成功

> 📊 Level ⭐⭐ | 6.8KB | `entities/ai-黑客真的来了hugging-face-遭遇-agent-自主攻击靠自建glm-52反击成功-xixiaoyao.md`
...
```mermaid
mindmap
  root(("ai-黑客真的来了hugging-face-遭遇-agent-自主攻"))
    事件时间线
      攻击入口 恶意数据集
      攻击规模
      攻击基础设施特征
...
- 供应链安全
- [OpenAI 模型逃逸事件](../ch01/390-openai.html)
