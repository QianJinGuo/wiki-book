...
## Ch04.595 Agent Protocol 不变层：跨框架的 6 个稳定 Runtime 对象
...
- [Agent Runtime 7 大职责](ch01/217-0.md) — 从 Runtime 职责视角（状态持久化、工具编排、可观测性等）出发，与本文的 Protocol 视角互补
...
- [MCP · Skill · Agent · LLM · Harness](ch04/256-skill.md) — 高层架构关系图
