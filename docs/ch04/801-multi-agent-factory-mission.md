...
## Ch04.801 Multi-Agent 架构：Factory Mission 系统的方法论
...
这与 [AgentOps on Bedrock](ch04/298-agentops-operationalize-agentic-ai-at-scale-with-amazon-bed.html) 中关于"多模型编排降低单点故障"的设计哲学一致——异构性是鲁棒性的来源。
...
- [Claude Managed Agents 企业自托管](ch04/809-claude-managed-agents.html)——Multi-Agent 的企业部署形态
- [Agent 记忆系统工程实践](../ch03/037-agent.html)——过程资产积累的方向
- [Harness 状态边界与失败闭环](../ch05/077-harness.html)——边界即文档的工程哲学
- [AgentOps on Bedrock](ch04/298-agentops-operationalize-agentic-ai-at-scale-with-amazon-bed.html)——多模型编排降低单点故障
