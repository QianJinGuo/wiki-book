...
## Ch04.087 高德 Marketing AutoResearch：营销增长 AI Native 经营托管框架
...
| 现有 entity | 应用域 | 核心方法 |
|-------------|--------|---------|
| [AI 自主科研 L0-L4](ch04/070-ai.md) (6KB) | 科学发现 (AlphaFold / The AI Scientist) | L0-L4 五级自主性框架 |
...
- vs [AI 科研 L0-L4](ch04/070-ai.md) — 科学发现域，本文是营销业务域
...
- vs [天猫营销 AI 工作流](ch04/070-ai.md) — 营销自动化，本文是营销**研究**（研究 + 实验 + 反馈循环）
