...
- [Lessons From 2 Billion Agentic Workflows](../ch03/004-agent.html) — 20 亿次工作流的三核心模式
- [Agentcore Harness](../ch05/008-harness.html) — AgentCore 工程化
- [Hands Free First Notice Of Loss Using Strands Agents And Ama](308-hands-free-first-notice-of-loss-using-strands-agents-and-am.html) — 保险 FNOL 中的人类角色重置
- [Build An Ai Powered Equipment Repair Assistant Using Amazon ](198-build-an-ai-powered-equipment-repair-assistant-using-amazon.html) — AgentCore 维修助手的记忆层设计
