...
## Ch04.547 AgentBrowser：Agent 浏览器工具框架
...
## Related
- [CLI-Anything](../ch03/096-cli-anything.html) — Agent 工具生态
- [AutoCLI](../ch03/120-autocli.html) — 信息获取 CLI
- [Hermes-Agent](../ch03/091-hermes-agent.html) — 可通过 AgentBrowser 扩展能力
