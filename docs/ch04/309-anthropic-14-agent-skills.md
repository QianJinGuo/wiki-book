...
> 📊 Level ⭐⭐⭐⭐ | 10.1KB | `entities/anthropic-agent-skills-design-patterns-14.md`
...
## 与现有知识库内容的关联
- [Claude Managed Agents](../ch01/461-claude-managed-agents.html) — 托管 Harness 平台
...
## 原始存档
→ [原文存档](https://mp.weixin.qq.com/s/x7IhRhK4Ndmlg6d61PyKuw)
...
- [Skills 详解：拆一个技能，看 Anthropic 和 OpenAI 的思路差异](../ch01/136-skills-anthropic-openai-comparison-frontend-design.html)
