...
## Ch04.753 在数据所在处构建 Agent: CrewAI + Snowflake 企业级 Agent 部署
...
- [Agent 安全三步序列](../ch05/085-harness.html) 聚焦安全，本文聚焦数据所在处的 Agent 构建
...
- [Agent 安全三步序列](../ch05/085-harness.html)
- [Agentium Agent 框架](../ch01/1447-agentium-agent.html)
- [Snowflake Agentic Enterprise Summit](ch04/718-agentic.html)
