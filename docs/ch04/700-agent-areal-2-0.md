...
## Ch04.700 Agent的自演进，被刚刚开源的AReaL 2.0按下了加速键
...
- [Agent自我改进循环](../ch05/110-harness.html) — Agent 通过运行轨迹持续优化的核心理念
- [Hermes Agent](../ch03/093-hermes-agent.html) — AReaL 2.0 的 Hermes 接入范例
