...
## Ch04.596 Tokenspeed Agentic Inference Engine
...
- [GLM-5 Scaling Pain 推理优化 — 高并发 Coding Agent 场景的推理问题复盘](ch04/277-ai.md)
- [AgentCore Managed Harness — AWS 的托管 Harness 平台，与推理引擎紧密配合](ch03/045-agent.md)
