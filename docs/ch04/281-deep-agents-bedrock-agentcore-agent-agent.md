...
## Ch04.281 Deep Agents + Bedrock AgentCore：多 Agent 编排 + 隔离基础设施的端到端研究 Agent 实战
...
| 实体 | 关注点 | 本文差异 |
|------|--------|---------|
| [Agentcore Harness](ch04/746-agentcore-harness.html) | AgentCore 平台概念 + Harness 趋势 | 偏理论，无代码 |
| [Agentcore Managed Harness](ch04/288-agentcore-managed-harness.html) | 托管 Harness 平台 overview | 无具体 subagent 编排 |
