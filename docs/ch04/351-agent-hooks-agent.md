...
## Ch04.351 Agent Hooks：把 Agent 工作流变成可编程的
...
- [Claude Code Agent Teams Task Decomposition Ruofei](../ch01/520-claude-code-agent-teams.html)
- [Claude Code开发负责人 为何放弃Rag而选择Agentic Search](../ch03/084-claude-code.html)
- [Anthropic Pm Agentic Workflow](ch04/575-anthropic-pm-agentic.html)
