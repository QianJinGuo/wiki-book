...
## Ch04.602 深度拆解：AI 智能体 Harness 的构造【译】
...
- [从零构建大语言模型 —— 读完这篇你就懂了](../ch01/855-llm.html)
...
- [democratizing machine learning at netflix: building the mode](../ch11/296-democratizing-machine-learning-at-netflix-building-the-mode.html)
...
- [building is just the beginning: introducing discoverability](../ch12/092-building-is-just-the-beginning-introducing-discoverability.html)
...
- [neurips 2026 使用闭源 ai 检测器 pangram 批量 desk-reject 论文事件](../ch01/1098-20.html)
- [qoder 发布团队知识引擎：组织级知识记忆是 harness 自进化的重要组件](../ch01/949-qoder.html)
- [scaling camera file processing at netflix](../ch11/028-scaling-camera-file-processing-at-netflix.html)
...
- [the recent history of ai in 32 otters](../ch01/824-the-recent-history-of-ai-in-32-otters.html)
