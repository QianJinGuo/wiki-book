...
当用户提出需求时，系统首先做的不是直接生成答案，而是**匹配合适的 SOP**。个性化智能引擎综合考虑用户画像、历史任务偏好、当前请求的语义特征，从 SOP 库中推荐最适用的几个选项。 用户不必担心选中哪个模型、配什么参数，这些决策已经被前置到 SOP 的训练阶段完成。
...
- [NVIDIA Agentic Systems](https://github.com/QianJinGuo/wiki-public/blob/main/entities/nvidia-agentic-systems-extreme-co-design.md) — 英伟达在 Agent 系统层面的超大规模协同设计实践
- [Kimi K2 Agent 数据库](https://github.com/QianJinGuo/wiki-public/blob/main/entities/kimi-k2-6-tidb-agent-database.md) — 国产 Agent 在数据库场景的应用
- [Claude Managed Agents](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-managed-agents-self-hosted-sandbox-mcp-tunnels-enterprise.md) — Claude 的托管 Agent 架构与 MCP 集成

→ [原文存档](https://mp.weixin.qq.com/s/8WF-w_M7JRpYTBfpYV4mPg)（机器之心，2026-05-12）
