...
## Ch04.407 直击GPU集群真实故障，首个AI Infra运维智能体基准开源
...
5. **从"故障修复"到"效率优化"的运维 Agent 定位升级**：AISHPerf 将运维问题置于"Token 工厂"效率框架下思考，运维 Agent 的终极目标不是"修好服务器"，而是"最大化 GPU 集群的 Token 产出效率"。这一视角与 [Harness Engineering](../ch05/050-harness-engineering.html) 中的系统性工程思维高度一致。

## 相关实体

- [Harness Engineering 探索实践](../ch05/050-harness-engineering.html)
