...
### 与 [Hermes Agent](../ch03/102-hermes-agent.html) 和 [Agent Harness 生产化](../ch05/042-agent-harness.html) 的关系
...
- [Agent 评测方法论与体系设计](../ch03/036-agent.html)
- [阿里云 AI 实践](../ch05/104-ai.html)
- [Agent Teams 群聊模式](../ch01/1218-claude.html)
