...
→ [Harness Engineering Survey 2026](../ch05/052-harness-engineering.html) — 同样社区层面的 Agent 工程化范式整理，但**侧重 12 组件分类**
...
→ [从 Prompt 到 Harness 工程三次进化](../ch05/099-harness.html) — 同样腾讯系但讲**进化论**（从 Prompt 到 Harness 的迁移）
