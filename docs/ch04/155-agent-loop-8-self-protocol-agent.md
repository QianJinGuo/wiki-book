...
→ [Harness Engineering Survey 2026](../ch05/115-harness-engineering.html) — 同样社区层面的 Agent 工程化范式整理，但**侧重 12 组件分类**
→ [Harness Architecture Production Guide](../ch05/039-agent-harness.html) — Harness 12 组件 vs Agent Loop 7 件套（不同抽象层级）
→ [腾讯 Skill 写作 Playbook](ch04/267-skill.html) — 同样腾讯系但讲 **Skill 写作**（如何写好一个 Skill）
