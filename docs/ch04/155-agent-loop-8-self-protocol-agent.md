...
→ [Harness Engineering Survey 2026](../ch05/068-harness-engineering.html) — 同样社区层面的 Agent 工程化范式整理，但**侧重 12 组件分类**
→ [Harness Architecture Production Guide](../ch05/062-agent-harness.html) — Harness 12 组件 vs Agent Loop 7 件套（不同抽象层级）
...
→ [Harness Observability Production](../ch05/062-agent-harness.html) — 同样讲 Harness 但侧重**可观测性**
