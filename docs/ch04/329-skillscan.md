...
SkillScan 与 [Agent Skill 设计模式](ch04/260-agent-skill.md) 和 [Hermes Agent 技能设计分析](../ch01/387-hermes-agent-skill.md) 形成了"设计—部署—安全"的完整闭环。具体来说：
...
- [SkillScan 字节跳动版](ch04/260-agent-skill.md)
- [SkillSieve Agent 技能安全](ch04/411-skillsieve-agent-skill.md)
- [Claude Code 安全审查偏见分析](../ch03/075-claude-code.md)
- [Claude Code 遥测安全争议](../ch01/342-anthropic-claude-code.md)
