...
## Ch04.447 Harness 工程 14 步路线图：从单 Agent 到自改进系统
...
```mermaid
mindmap
  root(("Harness 工程 14 步路线图 从单 Agent 到自改进系统"))
    三层楼模型
...
- [Claude Code 大型代码库配置](../ch03/078-claude-code.html)：聚焦企业级大型代码库中的 harness 配置实践
- [软规则 vs 硬约束](../ch03/078-claude-code.html)：深入分析 CLAUDE.md 软规则的治理陷阱

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/harness-engineering-14-step-roadmap.md)
