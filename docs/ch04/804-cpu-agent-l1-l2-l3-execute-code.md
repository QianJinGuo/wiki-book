...
## Ch04.804 CPU 缓存类比下的 Agent 上下文管理：L1/L2/L3 层级架构与 execute_code 单工具设计
...
### 与 [Anthropic 工具数量陷阱](ch04/588-ai-agent.html) 的对比
...
- [AI Agent 工具数量陷阱](ch04/588-ai-agent.html) — "5-10 工具"是 Anthropic 答案；"1 execute_code"是本文答案（更激进的同向论述）
...
- [上下文工程三种记忆范式对比](../ch06/015-memory.html) — 记忆/上下文/信息的层级
