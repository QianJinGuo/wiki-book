...
## Ch04.504 CLI-Anything：让 Agent 自主驱动任意 GUI 软件
...
- [你不知道的 Agent原理架构与工程实践 V2](../ch03/006-agent.html) — Agent 架构与工具使用模式
- [存之有序治之有矩Agent 记忆系统的工程实践与演进](../ch03/006-agent.html) — Agent 长流程中的上下文管理
