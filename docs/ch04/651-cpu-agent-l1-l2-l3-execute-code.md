...
## Ch04.651 CPU 缓存类比下的 Agent 上下文管理：L1/L2/L3 层级架构与 execute_code 单工具设计
...
- [Agent Harness 上下文管理工作集视角](../ch05/062-agent-harness.html) — 工作集是 **L1 内部**的精细化设计；本文是工作集的 L1/L2/L3 宏观扩展
...
- [Code as Agent Harness Survey](../ch09/052-code-as-agent-harness.html) — 编程语言作为 Agent 接口的更广义论述
...
- [Codex 上下文工程 LastWhisper](../ch01/541-codex.html) — 另一家 Code 厂商的上下文视角
- [上下文工程系列](ch04/556-agentic-ai.html) — 系列化上下文工程讨论
