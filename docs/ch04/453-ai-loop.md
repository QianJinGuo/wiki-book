...
- [Environment Engineering：Agent 不能只靠一条提示](../ch03/045-agent.md) — 架构师系列中提出 AGENT.md / STATE.md / EVIDENCE.md / PERMISSIONS.md 的先行概念
- [Harness Engineering](../ch05/062-harness-engineering.md) — Agent 运行底座工程范式
