...
## Ch04.606 A²RD: Agentic Autoregressive Diffusion for Long Video Consistency
...
## 相关
- [Source](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/a2rd-agentic-autoregressive-diffusion-long-video.md)

## 相关实体
> [主题导航](https://github.com/QianJinGuo/wiki/blob/main/queries/ai-model-research-latest-directions.md)

- [A²RD: Agentic Autoregressive Diffusion for Long Video Consistency](ch04/073-agentic.html)
...
- [Extreme Co-Design for Agentic Systems Complexity (NVIDIA)](ch04/103-nvidia-extreme-co-design-agentic-systems.html)
