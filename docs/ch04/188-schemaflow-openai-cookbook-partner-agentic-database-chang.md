...
## Ch04.188 SchemaFlow: OpenAI Cookbook Partner — Agentic Database Change Impact Analysis, SQL Generation, and Eval Guardrails
...
- [Agent Harness Architecture Deep Dive Aksahy](ch03/044-agent.md)
