...
## Ch04.744 EverMind Raven：自进化 Agent Harness 与数字生命框架
...
- [MemOS Hermes 记忆插件](../ch01/295-hermes.html) — Hermes 的记忆插件系统，与 EverOS 记忆架构互补
- [Mem0 vs WorkBuddy：Agent 记忆层对比](ch04/336-mem0-vs-workbuddy-agent.html) — 与 EverOS 的对比参考
