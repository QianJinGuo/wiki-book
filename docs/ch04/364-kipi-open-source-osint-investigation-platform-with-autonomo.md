...
## Ch04.364 Kipi: Open-source OSINT Investigation Platform with Autonomous Agent
...
这与 [Claude Code 的动态工作流](../ch09/102-claude-code-dynamic-workflows.html) 有相似的架构模式：LLM 做决策，工具做执行，人类做监督。
...
这与 [SchemaFlow](ch04/289-agentic.html) 的思路互补：SchemaFlow 将 LLM 约束在数据库 schema 中，kipi 将 LLM 约束在图结构中。
...
- 证据分级系统仍需人工校准
- 与 [prompt injection](../ch01/1079-github.html) 相关的安全风险：Agent 处理的网页内容可能包含恶意指令
...
- [Claude Code Workflows](../ch09/102-claude-code-dynamic-workflows.html) — Agent 动态工作流
- [SchemaFlow](ch04/289-agentic.html) — 结构化数据的 LLM 约束
- [Gray Swan](https://github.com/QianJinGuo/wiki/blob/main/entities/latent-space-p-gray-swan.md) — AI 安全与 red-teaming
- [Role Confusion](../ch01/1079-github.html) — Prompt injection 理论
