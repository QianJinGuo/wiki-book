...
本文在现有 [LangGraph 状态机](ch04/271-langgraph.html) 和 [Strands Agents](ch04/810-strands-agents.html) 知识基础上贡献了以下独特角度：
...
- [Building web search agents with Strands and Exa](ch04/577-building-web-search-enabled-agents-with-strands-and-exa.html)
- [Deep Agents 子 Agent 编排](ch04/630-agent-orchestration.html)
