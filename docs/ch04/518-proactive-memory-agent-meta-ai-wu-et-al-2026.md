...
## Ch04.518 Proactive Memory Agent — Meta AI (Wu et al. 2026)
...
- [AGENT MEMORY MODULAR FRAMEWORK](ch04/102-agent-memory.html) 和 [Agent Memory Architecture](ch04/417-perplexity-brain-self-improving-agent-memory-architecture.html) 主要关注记忆存储的层次化结构，而这篇论文聚焦于记忆的 **主动干预时机**；
- [Hermes Agent Memory System](../ch03/093-hermes-agent.html) 的三层架构侧重持久化存储，论文的贡献在于何时以及如何 **注入记忆**；
...
- [Agent Memory Injection](ch04/102-agent-memory.html) 从注入维度角度探讨了相似主题。
...
- [Agentic RL Frameworks Long-Horizon Wolfe 2026](ch04/434-agentic-rl.html)
- [RoadmapBench Long-Horizon Benchmark](ch04/253-roadmapbench-long-horizon-agentic-software-development.html)
- [Memory Agent Systems Cobanov](ch04/587-memory-agent-systems-cobanov.html)
- [Agent Memory Storage Six Schools](ch04/102-agent-memory.html)
- [Self-Evolution GUI Agents Memory](../ch03/035-agent.html)
- [State of Memory in Agent Harness Mem0 2026](../ch05/058-agent-harness.html)
