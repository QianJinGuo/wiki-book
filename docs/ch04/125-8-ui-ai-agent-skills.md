...
> 📊 Level ⭐⭐⭐ | 12.0KB | `entities/精选-8-个-ui-设计师必备的-ai-智能体技能agent-skills.md`

[精选 8 个 Ui 设计师必备的 Ai 智能体技能Agent Skills](https://mp.weixin.qq.com/s/9o-VhaqRtQRtge6q74K5TA)
...
→ [frontend-design 实体对比](https://github.com/QianJinGuo/wiki-public/blob/main/entities/skills-anthropic-openai-comparison-frontend-design.md)
→ [开发者技能清单](https://github.com/QianJinGuo/wiki-public/blob/main/entities/精选-10-个开发者常用的-ai-智能体技能agent-skills.md)
