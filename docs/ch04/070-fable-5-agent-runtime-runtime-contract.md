...
- vs **[Claude Code agent teams task decomposition ruofei](../ch01/373-claude-code-agent-teams.html)** — 那是**任务分解**(具体执行);本文是**任务协议** (前置契约)。
...
- [Claude Code agent teams task decomposition](../ch01/373-claude-code-agent-teams.html)
