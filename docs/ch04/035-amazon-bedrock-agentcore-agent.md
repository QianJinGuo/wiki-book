...
## Ch04.035 利用-amazon-bedrock-agentcore-快速为您的-agent-接入联网搜索和网页浏览
...
- 原文: [利用-amazon-bedrock-agentcore-快速为您的-agent-接入联网搜索和网页浏览](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/利用-amazon-bedrock-agentcore-快速为您的-agent-接入联网搜索和网页浏览.md)
