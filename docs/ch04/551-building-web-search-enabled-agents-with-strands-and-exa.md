...
## Ch04.551 Building web search-enabled agents with Strands and Exa
...
- [Agentic Scheduler with Strands AgentCore for Multi-Region GPU Inference](ch03/035-agent.html)
- [Product Ad Review Agent with Strands SDK and Bedrock](ch03/035-agent.html)
