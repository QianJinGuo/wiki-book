...
## Ch04.255 Enterprise Software Moats in the Agent Era — 系统性护城河分析框架
...
## 与 vault 知识关联
- [Agent Harness 架构](../ch05/062-agent-harness.html) — Agent 与企业软件的交互层，Harness 是 Agent 执行时的"护城河"
...
- [Agent Memory 模块化框架](ch04/178-agent-memory.html) — 数据排放（data exhaust）与记忆系统的关系
...
- [AI tool poisoning exposes a major flaw in enterprise agent security | VentureBeat](ch04/529-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s.html)
...
- [from](../ch01/443-from-system-of-record-to-system-of-intelligence.html)
- [From System Of Record To System Of Intelligence](../ch01/443-from-system-of-record-to-system-of-intelligence.html)
- [meet customers where they are: agentforce contact center now](ch04/690-meet-customers-where-they-are-agentforce-contact-center-now.html)
