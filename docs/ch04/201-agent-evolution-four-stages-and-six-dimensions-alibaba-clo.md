...
- **Cloud Code / Codex / OpenClaw / Hermes** → [Claude Code](../ch05/083-claude-code-harness.html) / [OpenClaw](../ch11/248-openclaw.html) / Hermes Agent 等
...
- [Claude Code 深度解析](../ch05/083-claude-code-harness.html) — 自主 Agent 阶段（阶段三）代表
- [OpenClaw 完整指南](../ch11/248-openclaw.html) — 自主 Agent 阶段（阶段三）代表
