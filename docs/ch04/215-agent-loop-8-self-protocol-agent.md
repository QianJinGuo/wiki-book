...
→ [Harness Architecture Production Guide](ch03/035-agent.html) — Harness 12 组件 vs Agent Loop 7 件套（不同抽象层级）
...
→ [Harness Observability Production](ch03/035-agent.html) — 同样讲 Harness 但侧重**可观测性**
