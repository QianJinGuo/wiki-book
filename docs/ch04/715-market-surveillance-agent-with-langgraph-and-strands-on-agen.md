...
本文在现有 [LangGraph 状态机](ch04/271-langgraph.html) 和 [Strands Agents](ch04/799-strands-agents.html) 知识基础上贡献了以下独特角度：
...
- [Strands Agents](ch04/799-strands-agents.html)
...
- [AgentCore Gateway MCP](ch04/666-amazon-bedrock-agentcore.html)
