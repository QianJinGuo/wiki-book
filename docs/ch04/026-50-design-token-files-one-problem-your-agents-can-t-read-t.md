...
- [DESIGN.md](../ch01/1087-agent-ai.html) -- also an AI Agent interface for design systems
- [Claude Design Skill](../ch01/1352-claude-design-skill.html) -- agent operating design systems in practice
