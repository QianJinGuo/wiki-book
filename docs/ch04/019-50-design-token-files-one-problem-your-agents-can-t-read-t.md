...
- [DESIGN.md](ch04/150-ai.md) -- also an AI Agent interface for design systems
- [Claude Design Skill](ch04/245-skill.md) -- agent operating design systems in practice
