...
## Ch04.260 LangGraph 1.0：别再用 DAG 写 Agent 了，你的 Agent 需要一个操作系统
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/langgraph-10别再用-dag-写-agent-了你的-agent-需要一个操作系统.md)
