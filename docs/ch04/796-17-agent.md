...
## Ch04.796 17种Agent架构演进：控制流设计的完整演化史
...
[Factory 的 Mission 系统](../ch03/037-agent.html) 是 Multi-Agent 架构的典型实践：Validator-Creator 分离、Validation Contract 预承诺机制、串行优先于并行的调度策略。
