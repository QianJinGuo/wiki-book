...
| 现有 entity | 应用域 | 核心方法 |
|-------------|--------|---------|
| [AI 自主科研 L0-L4](ch04/310-ai.md) (6KB) | 科学发现 (AlphaFold / The AI Scientist) | L0-L4 五级自主性框架 |
...
|----|------|------------|
| 第 1-2 期 | (背景调研)| 待补充 |
| **第 3 期** | **7×24 Self-Healing Pipeline + Agent 自进化** (研发生产线) | [Gaode Ai Native 7X24 Pipeline Self Healing](ch04/310-ai.md) (30KB) |
...
### 与 [高德 AI Companion Agent 架构](ch04/310-ai.md) 的层级关系
...
这是 [高德 SDD Harness 团队 AI 编码范式](ch04/310-ai.md) 的**业务侧对应**——SDD 关注"代码的正确性"，AutoResearch 关注"决策的正确性"。
...
- vs [AI 科研 L0-L4](ch04/310-ai.md) — 科学发现域，本文是营销业务域
- vs [多 Agent 软件开发](ch04/503-agent.md) — 软件开发域，本文是营销业务域
- vs [高德 7x24 Self-Healing Pipeline](ch04/310-ai.md) — 同公司研发线，本文是营销业务线
- vs [高德 AI Companion Agent](ch04/310-ai.md) — C 端用户交互，本文是 B 端业务托管
- vs [天猫营销 AI 工作流](ch04/310-ai.md) — 营销自动化，本文是营销**研究**（研究 + 实验 + 反馈循环）
...
## 相关实体
- [Autoresearch Marketing Growth Amap Ai Native](ch04/310-ai.md)
