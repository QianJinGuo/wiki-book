...
与现有 [WorkBuddy 产品架构](../ch03/019-agent.html) 文章从提示词和产品化角度切入不同，本文聚焦于**工程实现层面**——如何在 AgentScope 框架上构建一个具备完整功能的 Agent 产品。
...
- [WorkBuddy 产品架构](../ch03/019-agent.html) — 提示词与产品化视角，本文补充了工程实现视角
