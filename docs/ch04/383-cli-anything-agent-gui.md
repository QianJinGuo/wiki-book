...
## Ch04.383 CLI-Anything：让 Agent 自主驱动任意 GUI 软件
...
- [两万字详解Claude Code源码核心机制](../ch03/075-claude-code.html) — Claude Code 的工具调用与插件机制
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](ch04/597-agentic.html) — Vibe Coding 到 Agentic Engineering 的范式转变
- [你不知道的 Agent原理架构与工程实践 V2](../ch03/045-agent.html) — Agent 架构与工具使用模式
- [存之有序治之有矩Agent 记忆系统的工程实践与演进](../ch03/045-agent.html) — Agent 长流程中的上下文管理
