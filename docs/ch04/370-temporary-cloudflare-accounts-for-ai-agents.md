...
## Ch04.370 Temporary Cloudflare Accounts for AI agents
...
这与 [AWS DevOps Agent](ch03/044-agent.md) 中的 Agent 安全模型形成了有趣的对比：AWS 侧重于运行时的安全控制，而 Cloudflare 侧重于部署时的安全简化。
...
- [AWS DevOps Agent](ch03/044-agent.md) — 另一个生产级 Agent 基础设施案例
- [ATH Agent Trust Handshake Protocol](ch03/044-agent.md) — Agent 信任协议设计
