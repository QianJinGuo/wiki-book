...
GUI 导航任务本质上是**部分可观察马尔可夫决策过程（POMDP）**：智能体无法完全观察环境状态，只能基于局部截图文本来决策。这从根本上决定了「记不住」和「学不会」的双重困境。
...
## 相关实体
- [Hermes Agent Self Evolution Tengxun](../ch03/066-hermes-agent.html)
- [Self Learning Evolvable Agents For Cultural Tourism Info Extraction With Agentcore](../ch03/004-agent.html)
...
- [World Knowledge Agent Self Evolution Tencent Hkustgz](233-world-knowledge-agent.html)

→ [原文存档](https://mp.weixin.qq.com/s/7lIMXc0JWWrFrARszSnU5A)
...
- [thought-aligner：智能体行为安全新范式——可插拔思维校正层（icml 2026）](052-ai.html)
