...
这种模式与 [Cloudflare 临时账户](ch04/147-ai-agent.md) 形成了 Agent 基础设施的两个互补维度：Cloudflare 解决了部署时的零摩擦问题，Datadog MCP Server 解决了运行时的数据访问问题。
...
- [Cloudflare 临时账户](ch04/147-ai-agent.md) — Agent 基础设施的部署维度
