...
## Ch04.464 Agentic Overlays -- Retrofit Legacy REST Services into A2A Agents
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/retrofit-dont-rebuild-agentic-overlays-for-transforming-lega.md)
...
- [Agentic AI Data Mesh](ch04/060-agentic-ai.html) — 另一种 agent 化路径：data mesh 的 MCP 暴露
...
- [Agent Harnesses Are Dead](ch04/686-agent-harnesses-are-dead-long-live-agent-harnesses.html) — Agent Harness 架构演进讨论
