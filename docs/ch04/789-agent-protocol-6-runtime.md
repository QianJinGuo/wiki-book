...
- [Agent Harness 架构](ch03/035-agent.html) — Harness 作为 Runtime 的上层封装
- [Agent 架构关键变化：Harness 成为新后端](ch03/035-agent.html) — Harness 作为 Runtime 演进方向
- [MCP · Skill · Agent · LLM · Harness](ch07/001-mcp.html) — 高层架构关系图
