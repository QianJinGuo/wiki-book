...
## Ch04.454 Karpathy AI Agent（七）：bits 与程序员价值
...
## 相关篇章
- [Karpathy vibe coding 到 agentic engineering](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/karpathy-vibe-coding-agentic-engineering-v4.md)
