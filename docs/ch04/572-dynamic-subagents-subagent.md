...
## Ch04.572 Dynamic Subagents: 代码驱动的 Subagent 编排
...
- [Anthropic Dynamic Workflows](../ch01/1292-anthropic.html)
- [Generator-Evaluator 对抗验证](../ch01/1292-anthropic.html)
- [Claude Code Subagent 规则](../ch09/084-claude-code-1.html)
