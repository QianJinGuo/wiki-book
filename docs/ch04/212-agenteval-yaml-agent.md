...
## Ch04.212 AgentEval：YAML驱动的Agent评测框架
...
## 相关实体
- [Anthropic Generator-Evaluator Harness](ch01/1532-anthropic.html) — 另一种评测闭环思路
- [Superpowers](ch07/032-claude-code-skills.html) — Agent 工作流规范
- [Skill Writing Patterns](ch04/341-skill.html) — Skill 质量评估相关
