...
- [Harness 模式 6-SubAgent 实战 — 17哥 vs 评测平台](../ch05/066-harness-engineering.html) — 互补 (决策者 vs 动手者)
...
- [Harness Engineering Practical 17Ge Versus 6 Subagent](../ch05/066-harness-engineering.html) — 互补的 Harness 模式（决策者 vs 动手者）
