...
## Ch04.354 多轮 Agent 场景下，滴滴的 EAGLE-3 训推加速实践
...
- [Didi Eagle 3 Speculative Decoding Agents](ch09/043-coding-agent.md)
- [Langsmith Trajectory Evals](ch01/692-langsmith-trajectory-evals.md)
