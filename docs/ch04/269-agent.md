...
## Ch04.269 为了让agent更安全的工作，有多少人操碎了心
...
- [Agent Protocol 到 Harness Skill](ch04/424-from-agent-protocol-to-harness-skill.html)
- [AgentCore Gateway 认证](ch04/283-building-a-secure-auth-code-flow-setup-using-agentcore-gatew.html)
