...
## Ch04.331 The Bitter Lesson versus The Garbage Can
...
- 与 [CrewAI 迭代论](ch04/372-your-first-ai-agent-should-do-one-thing-badly.html)的张力：迭代论强调"先做糟糕的 agent 再迭代"；苦味教训暗示"算力取代工艺"。前者是工程路径，后者是范式断言。
- 与 [管理即超能力](../ch01/523-management-as-ai-superpower.html)互补：Mollick 在商业文章中强调"管理能力"为稀缺资源；本文同一作者暗示 AI 找到路径后，管理定义"好结果"的能力成为新稀缺。
