...
## Ch04.254 Enterprise Software Moats in the Agent Era — 系统性护城河分析框架
...
## 与 vault 知识关联
- [Agent Harness 架构](../ch05/042-agent-harness.html) — Agent 与企业软件的交互层，Harness 是 Agent 执行时的"护城河"
...
- [Agent Memory 模块化框架](ch04/215-agent-memory.html) — 数据排放（data exhaust）与记忆系统的关系
...
- [阿里云 EventHouse 企业级 Agent 上下文供给体系](../ch03/036-agent.html)
- [AI tool poisoning exposes a major flaw in enterprise agent security | VentureBeat](ch04/538-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s.html)
...
- [快手首个打工人Agent](../ch03/036-agent.html)
- [from](../ch01/439-from-system-of-record-to-system-of-intelligence.html)
- [From System Of Record To System Of Intelligence](../ch01/439-from-system-of-record-to-system-of-intelligence.html)
- [meet customers where they are: agentforce contact center now](ch04/490-meet-customers-where-they-are-agentforce-contact-center-now.html)
