...
- [amazon-bedrock-agentcore-runtime-deep-dive-and-scenario-analysis](ch04/674-amazon-bedrock-agentcore.html) — 同 Bedrock agent 体系（AgentCore runtime vs Strands Agents）
- [secure-ai-agents-policy-lambda-interceptors-aws](ch04/684-ai-agent.html) — Bedrock Agent 安全护栏（与本文的 Guardrails + row-level entitlements 对应）
...
- [Amazon Bedrock Agentcore Runtime Deep Dive And Scenario Analysis](ch04/674-amazon-bedrock-agentcore.html) — 同为 Bedrock agent 体系，AgentCore runtime vs Strands Agents 的技术选型对比
- [Secure Ai Agents Policy Lambda Interceptors Aws](ch04/684-ai-agent.html) — Bedrock Agent 安全护栏，与本文的 Guardrails + row-level entitlements 设计思路一致
