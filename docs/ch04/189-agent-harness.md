...
- [Harness Engineering](../ch05/026-harness-engineering.html)（Harness 工程方法论）

## 相关实体
- [Agent架构关键变化：Harness正在成为新后端](../ch05/008-harness.html)
- [Agent Harness 组件解析](../ch05/035-agent-harness.html)
...
- [Agent Harness 12 组件与 7 个关键决策](../ch05/035-agent-harness.html)
- [Agent架构关键变化：Harness正在成为新后端](../ch05/008-harness.html)
...
- [Design Patterns for AI Agents 2026](073-design-patterns-for-ai-agents-2026-4-5-reflection.html)
...
- [从多智能体编排到AI自主决策：资损防控体系的架构演进](052-ai.html)
...
- [Agent Harness 解析：智能体架构深度拆解](../ch05/035-agent-harness.html)
