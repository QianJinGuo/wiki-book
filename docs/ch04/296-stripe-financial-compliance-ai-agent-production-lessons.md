...
- [Agent Harness Architecture Deep Dive Aksahy](ch03/044-agent.md) — Agent Harness 通用架构深度分析
- [17 Agent Architectures Evolution](ch03/044-agent.md) — 17 种 Agent 架构演化全景
