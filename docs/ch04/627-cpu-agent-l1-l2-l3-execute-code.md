...
## Ch04.627 CPU 缓存类比下的 Agent 上下文管理：L1/L2/L3 层级架构与 execute_code 单工具设计
...
- [Codex 上下文工程 LastWhisper](../ch01/534-codex.html) — 另一家 Code 厂商的上下文视角
- [上下文工程系列](ch04/543-agentic-ai.html) — 系列化上下文工程讨论
