...
## Ch04.248 Stripe Financial Compliance AI Agent: Production Lessons
...
- [Agent Harness Architecture Deep Dive Aksahy](../ch05/035-agent-harness.html) — Agent Harness 通用架构深度分析
- [17 Agent Architectures Evolution](440-17-agent.html) — 17 种 Agent 架构演化全景
