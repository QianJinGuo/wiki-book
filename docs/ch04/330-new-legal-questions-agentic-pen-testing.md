...
## Ch04.330 New legal questions: agentic pen testing
...
这种 "authorisation gap" 不仅存在于渗透测试，而是所有 agentic AI 部署面临的根本性法律挑战。对于 Agent 安全威胁模型 和 [Agent 内存架构](/ch04-146-agent-memory-架构本质/) 领域，这是一个必须正视的问题。
...
这对 [Agent 内存架构](/ch04-146-agent-memory-架构本质/) 提出了全新要求：需要可审计的、不可伪造的、可追溯到 human principal 的 agent identity 体系。
...
- [DeepMind AI Agent 安全](/ch04-521-securing-the-future-of-ai-agents/) — Agent 安全的技术框架
- [CVE 实践](/ch12-073-getting-a-cve-without-shipping-slop/) — 安全研究的实操视角
- Agent 安全威胁模型 — Agent 安全概念框架
- [Agent 内存架构](/ch04-146-agent-memory-架构本质/) — Agent 身份管理与归属

→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/agentic-penetration-testing-legal-questions.md)
