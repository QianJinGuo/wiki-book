...
## Related
- [CLI-Anything](ch03/089-cli-anything.md) — Agent 工具生态
- [AutoCLI](ch03/112-autocli.md) — 信息获取 CLI
- [Hermes-Agent](ch03/086-hermes-agent.md) — 可通过 AgentBrowser 扩展能力
