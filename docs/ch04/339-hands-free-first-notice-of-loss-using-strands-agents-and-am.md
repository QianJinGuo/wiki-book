...
- [Build An Ai Powered Equipment Repair Assistant Using Amazon ](ch04/277-ai.md) — AgentCore + Knowledge Base 的维修助手
- [Building Web Search Enabled Agents With Strands And Exa](ch04/406-building-web-search-enabled-agents-with-strands-and-exa.md) — Strands SDK 搜索 Agent
...
- [Agentcore Harness](ch03/045-agent.md) — AgentCore 工程化
