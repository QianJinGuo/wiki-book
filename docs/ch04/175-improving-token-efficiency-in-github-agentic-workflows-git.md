...
文章提供了 **生产级 Agentic CI workflow 的 token 成本优化路线图**，是 [Token 经济学](ch04/277-ai.md) 在工程实践层面的具体落地案例。
...
- → [Agent Harness 12 组件与 7 个关键决策](ch03/045-agent.md)：工具选择决策树与本文的 MCP vs CLI 选型呼应
