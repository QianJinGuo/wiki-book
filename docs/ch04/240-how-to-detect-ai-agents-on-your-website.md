...
## Ch04.240 How to Detect AI Agents on Your Website
...
> [!contradiction] 另参见 [Anthropic](../ch01/1299-anthropic.html) 持相反观点 — Anthropic 主张 Model Context Protocol (MCP) 将成为 AI 代理与网站交互的主流范式，浏览器层检测的必要性将被 API 层替代
