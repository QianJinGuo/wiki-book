...
## Ch04.263 The Bitter Lesson versus The Garbage Can
...
- 与 [CrewAI 迭代论](300-your-first-ai-agent-should-do-one-thing-badly.html)的张力：迭代论强调"先做糟糕的 agent 再迭代"；苦味教训暗示"算力取代工艺"。前者是工程路径，后者是范式断言。
...
- [Your First Ai Agent Should Do One Thing Badly](300-your-first-ai-agent-should-do-one-thing-badly.html)
