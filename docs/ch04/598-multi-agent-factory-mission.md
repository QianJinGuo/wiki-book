...
这一设计与 [Harness 状态边界与失败闭环](ch05/085-harness.md) 中强调的"边界即文档"的工程哲学一致——Agent 系统的可靠性不来自 Agent 自身的记忆，而来自跨边界时强制落盘的中间表示。
...
这与 [AgentOps on Bedrock](ch04/069-ai.md) 中关于"多模型编排降低单点故障"的设计哲学一致——异构性是鲁棒性的来源。
...
- [OpenClaw 多 Agent 团队实践](ch04/043-openclaw-multi-agent-team-practice-v2.md)——多 Agent 落地的国内实践
- [Claude Managed Agents 企业自托管](ch03/045-agent.md)——Multi-Agent 的企业部署形态
- [Agent 记忆系统工程实践](ch03/045-agent.md)——过程资产积累的方向
- [Harness 状态边界与失败闭环](ch05/085-harness.md)——边界即文档的工程哲学
- [AgentOps on Bedrock](ch04/069-ai.md)——多模型编排降低单点故障
