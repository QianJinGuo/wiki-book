...
## 相关概念
- [GBrain 自进化体系](../ch01/614-llm-wiki-obsidian-wiki-gbrain.md) — skillify 是 gbrain 自演化的核心机制
- [Harness Engineering](../ch05/092-harness-engineering.md) — 传感器失效是 latent space 工作分类错位的体现
- [Harness 从 Prompt 到工程体系](../ch05/009-harness.md) — 约束与自主权的辩证关系
- [AIAIGC峰会嘉宾阵容](ch04/474-aiaigc.md)
...
- [Harness Engineering 实战：AI Coding 率从 25% 提升至 90%](../ch05/092-harness-engineering.md)
