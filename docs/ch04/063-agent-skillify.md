...
## 相关概念
- [GBrain 自进化体系](ch05/094-ai.html) — skillify 是 gbrain 自演化的核心机制
- [Harness Engineering](ch05/120-harness-engineering.html) — 传感器失效是 latent space 工作分类错位的体现
- [Harness 从 Prompt 到工程体系](ch01/976-claude.html) — 约束与自主权的辩证关系
...
- [Harness Engineering 实战：AI Coding 率从 25% 提升至 90%](ch05/094-ai.html)
