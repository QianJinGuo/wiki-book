...
## Ch04.209 Amazon Bedrock AgentCore AG-UI 协议：为 AI Agent 构建生成式 UI

> 📊 Level ⭐⭐ | 11.2KB | `entities/build-generative-ui-for-ai-agents-on-amazon-bedrock-agentcor.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/build-generative-ui-for-ai-agents-on-amazon-bedrock-agentcor.md)
