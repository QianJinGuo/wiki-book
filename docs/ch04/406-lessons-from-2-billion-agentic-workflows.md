...
## Ch04.406 Lessons From 2 Billion Agentic Workflows
...
- [A Missing Layer In Agentic Systems](ch04/348-a-missing-layer-in-agentic-systems.html) — HITL 作为 Agentic 系统第三层的论述
- [Agentcore Harness](ch04/474-amazon-bedrock-agentcore-harness-ga-api-agent.html) — AgentCore 工程化实践
