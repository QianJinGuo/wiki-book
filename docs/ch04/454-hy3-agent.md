...
## Ch04.454 姚顺雨评测腾讯混元 Hy3 Agent 能力
...
与 [Claude Code](../ch03/084-claude-code.html) 等面向开发者的 Coding Agent 不同，元宝 Agent 的目标用户是微信生态内的普通用户——他们不需要注册新账号、不需要熟悉新软件、无需复杂调试配置，在对话框内直接完成整套任务。
