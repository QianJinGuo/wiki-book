...
## Ch04.678 Agent Harnesses Are Dead. Long Live Agent Harnesses.
...
这一洞察与 [Claude Code 动态工作流](../ch09/087-claude-code-dynamic-workflows.html) 中讨论的"工作流即基础设施"观点一致：真正的护城河不是 Agent 框架本身，而是围绕 Agent 建立的运营数据、用户习惯和组织流程。
...
- [Claude Code 动态工作流](../ch09/087-claude-code-dynamic-workflows.html)
...
- [Prime Intellect Auto NanoGPT](../ch01/215-0.html)
