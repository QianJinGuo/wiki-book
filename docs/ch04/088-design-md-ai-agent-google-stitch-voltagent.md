...
## Ch04.088 DESIGN.md：AI 设计 Agent 的视觉约束对齐文件（Google Stitch × VoltAgent）
...
## 相关实体
- [Agentexecutorgooglesdistributedagentruntime](ch04/476-agentrun.html)
...
- [Scalable Voice Agent Design With Amazon Nova Sonic Multi Agent Tools And Session](../ch11/295-amazon-nova.html)
- [MOC](https://github.com/QianJinGuo/wiki/blob/main/moc/openai-developer-ecosystem.md)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/design-md-google-stitch-voltagent-ai-design-agent.md)
