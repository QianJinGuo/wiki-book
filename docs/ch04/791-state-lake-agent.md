...
## Ch04.791 State Lake：火山引擎面向 Agent 时代的存储基础设施重构
...
- [Agent Harness 工程全景](../ch05/096-harness-engineering.html) — Harness 工程中存储层的角色定位
- [Cloud Agent Infrastructure](../ch03/006-agent.html) — Agent 基础设施的另一种视角（状态/代码/凭证隔离）
