...
## Ch04.379 AgentCore Browser OS级操作：Action-Screenshot-Reaction闭环
...
## 与知识库的连接
- → 原文存档：OS Level Actions官方详解，包含8个原子操作完整示例
- → Agent-Guided Workflows：同属AgentCore生态，Actions是workflow的底层执行单元
---
*Source: 原文存档*
