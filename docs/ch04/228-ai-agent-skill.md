...
→ [原文存档](https://mp.weixin.qq.com/s/zsy5sCkqCGA5_vTs2Qvxpg)
...
- [CLI Agent 时代](https://github.com/QianJinGuo/wiki-public/blob/main/entities/why-cli-agent-era-alibaba-tech.md)
- [Harness Engineering](../ch05/066-harness-engineering.html)
- [一行命令让 AI 自己找技能](https://github.com/QianJinGuo/wiki-public/blob/main/entities/狂揽24万星标一行命令ai会自己找技能了.md)
- [Claude Code 团队部署与 Agent Harness](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-large-codebase-team-deployment-agent-harness.md)
- [下一代企业架构：CLI 流程与 Skill](https://github.com/QianJinGuo/wiki-public/blob/main/entities/enterprise-next-gen-architecture-system-cli-process-skill-employee-agent-zhan.md)
- [阿里云 LLM Wiki 实践](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-knowledge-base-llm-wiki-practice-alicloud.md)
- [可观测与监控 MOC](https://github.com/QianJinGuo/wiki-public/blob/main/moc/observability-monitoring.md)
