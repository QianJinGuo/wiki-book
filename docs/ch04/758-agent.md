...
## Ch04.758 万字长文拆解 Agent 架构设计（二）：工具系统设计
...
- [AI Agent 工具数量陷阱](ch04/679-ai-agent.html) — 5 个边界清楚的工具胜过 20 个模糊工具，与 Claude Code 工具设计互补
- [Agent Harness 架构设计与实现](../ch05/042-agent-harness.html) — 生产级 Agent 系统设计参考
