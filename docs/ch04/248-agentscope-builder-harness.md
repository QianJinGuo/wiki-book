...
## Ch04.248 AgentScope Builder 快速体验：用 Harness 框架快速构建企业自进化智能体
...
- [AgentScope Java Harness Framework 企业分布式版](ch05/085-harness.md) — 同一作者，更早的框架介绍
## 相关实体

- [enterprise readiness maturity model](ch11/207-enterprise-readiness-maturity-model.md)
