...
- [Anthropic 发布 Computer Use 最佳实践](../ch01/865-anthropic-computer-use.html) — Anthropic 官方的 Computer Use 优化建议，包括截图降采样等技巧
- [Codex 支持通过 Computer Use 控制桌面设备](../ch09/126-codex-can-now-control-other-desktop-devices-via-computer-use.html) — Codex 的 Computer Use 扩展应用
- [Claude Code Tool Design 演化](../ch03/076-claude-code.html) — Anthropic 在 Agent 工具设计上的持续演进
- [Ettin Reranker Family](../ch01/454-introducing-the-ettin-reranker-family.html) — 高效的排序模型，可用于优化 Agent 任务路由
