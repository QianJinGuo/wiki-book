...
## Ch04.545 We Ran 250 AI Agent Evals to Find Out if Skills Beat Docs. The Answer Is More Complicated Than We Expected

> 📊 Level ⭐⭐ | 4.1KB | `entities/we-ran-250-ai-agent-evals-to-find-out-if-skills-beat-docs-th.md`
