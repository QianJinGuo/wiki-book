...
## Ch04.703 Dynamic Subagents: 代码驱动的 Subagent 编排
...
- [Anthropic Dynamic Workflows](../ch01/1586-anthropic.html)
- [Generator-Evaluator 对抗验证](../ch01/1586-anthropic.html)
- [Claude Code Subagent 规则](../ch09/100-claude-code-1.html)
