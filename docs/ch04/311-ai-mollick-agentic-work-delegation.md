...
## Ch04.311 管理作为 AI 超级能力：Mollick 的 Agentic Work Delegation 方程
...
- [Jagged Ai Frontier Mollick](../ch05/092-ai.html) — Jagged Frontier（Mollick 提出的 AI 能力不规则分布概念，是 delegation equation 的背景）
...
- [Ai Job Interview Model Evaluation Mollick](../ch05/092-ai.html) — AI 面试方法论（同一作者，GDPval 评估框架）
