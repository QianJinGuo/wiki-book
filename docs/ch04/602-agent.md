...
## Ch04.602 Agent核心技术概念与范式发生了哪些演变以及背后的思考
...
- [《从零实现 agent 系统》连载 01｜agent 系统是什么：问题空间与架构切片](../ch03/046-agent.html)
...
- [review agent：后台复盘 agent 如何判断什么值得保存](../ch03/046-agent.html)
- [不用再学ai了！生成结果包稳的agent来了](../ch03/046-agent.html)
...
4. （本文覆盖的4阶段+6维度Agent框架已由 entity [Agent 四阶段演化与六维度技术变化](../ch03/046-agent.html) 完整收录。
5. ）
### Prompt：渐进式披露
