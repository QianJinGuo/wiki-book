...
## Ch04.329 火山引擎 AI 搜索千万级 Agent 架构演进与实践：从 ReAct 三节点到 Unified Policy
...
3. **二次开发简化**：新功能的接入不需要修改核心 DAG 代码，只需注册新的 Tool——这与 [Codex 五层架构](../ch01/519-codex.html) 中的"技能注册"模式异曲同工
