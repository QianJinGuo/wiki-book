...
- [Agent Harness 工程学调研 2026](ch03/045-agent.md) — Self-Harness 是该领域的最新论文
- [Agent Harness 工程学调研 etcvlovg Taxonomy](ch03/045-agent.md)
- [Agent Production Harness Engineering](ch03/045-agent.md)
...
- [SGLang](ch01/672-1-sglang-radixark-ai.md) — Qwen3.5 部署用到的推理引擎
...
- [复旦 AHE Agentic Harness Engineering](ch03/045-agent.md)
