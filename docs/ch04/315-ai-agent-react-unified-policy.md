...
3. **二次开发简化**：新功能的接入不需要修改核心 DAG 代码，只需注册新的 Tool——这与 [Codex 五层架构](../ch01/533-codex.html) 中的"技能注册"模式异曲同工
...
- [腾讯 Harness Engineering 探索之旅](../ch05/112-harness-engineering.html)
