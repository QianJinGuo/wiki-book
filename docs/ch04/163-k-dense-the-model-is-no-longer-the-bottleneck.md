...
- **呼应 [How Harnesses And Post Training Close The Open Weight Bug Finding Gap 20260606](../ch01/322-how-harnesses-and-post-training-close-the-open-weight-bug-fi.md)** — Anthropic 主张 harness > pretraining；K-Dense 用科学 AI 数据给出量化证明
...
- **补充 [Agent Harness Engineering Survey 2026](../ch05/062-harness-engineering.md)** — Survey 中 "context engineering" 一节的科学 AI 实例
...
1. **科学 AI 的瓶颈已从"模型能做什么"转向"系统让模型做什么"**
   ...
   - 实践价值：当"用更强的模型"带来的提升<5%时，工程资源应转向 harness 设计。这与 [How Harnesses And Post Training Close The Open Weight Bug Finding Gap 20260606](../ch01/322-how-harnesses-and-post-training-close-the-open-weight-bug-fi.md) 中 Anthropic 的主张呼应。
