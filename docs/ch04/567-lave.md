...
- [D Opsd Diffusion Llm On Policy Self Distillation](../ch01/180-d-opsd.html) — 扩散 LLM 在线自蒸馏
- [Residual Context Diffusion Apple Ml 2026 07](../ch01/963-20.html) — Apple 残差上下文扩散
