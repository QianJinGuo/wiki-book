...
## 与 Wiki 已有内容的关系
- 补充 [Agent 工程实践](../ch03/004-agent.html)的"架构演进路径"章节（增加量化数据）
- 补充 [Hermes Agent 深度解析](../ch03/066-hermes-agent.html)的 Multi-Agent 协作部分（Google 论文 5 条结论）
...
- [从 Anthropic 到 Google：Agent Skills 进入设计模式阶段](160-anthropic-google-agent-skills.html)
...
- [Autoresearch Next Phase Async Multi Agent Ai寒武纪](../ch03/004-agent.html)
