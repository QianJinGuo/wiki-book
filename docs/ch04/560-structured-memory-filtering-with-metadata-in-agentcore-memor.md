...
## Ch04.560 Structured Memory Filtering with Metadata in AgentCore Memory
...
- `[Agent 记忆工程挑战 (AWS China)](ch03/045-agent.md)` — AgentCore 记忆系统工程实践概述
- `[AgentCore Harness](ch03/045-agent.md)` — AgentCore 整体平台
