...
- → [AutoResearch：AI 科学发现 L0-L4](../ch05/110-ai.html) — 定义了 AI Scientist 的自主性层级
- → [Harness Engineering Self-Improvement Survey](../ch05/066-harness-engineering.html) — Lilian Weng 的自我改进综述，覆盖 AI Scientist 领域
