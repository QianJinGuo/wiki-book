...
## Ch04.346 Codex /goal：长任务Agent的目标运行时
...
- [Hermes Agent](../ch03/100-hermes-agent.html)（Karpathy 观点被多次引用）
...
## 相关页面
- 原文存档：Codex /goal 实现拆解

## 相关实体
- [Codex /goal: The Six-Hour Run That Survived a Five-Hour Pause](../ch09/103-codex-goal-six-hour-run.html)
- [Cline releases open-source agent runtime SDK](285-cline-releases-open-source-agent-runtime-sdk.html)
