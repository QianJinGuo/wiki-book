...
## Ch04.228 Harness Engineering：让 Coding Agent 可靠完成长程任务
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/harness-engineering-long-term-agent-tasks.md)
