...
## Ch04.154 AgentEval：YAML驱动的Agent评测框架
...
## 相关实体
- [Anthropic Generator-Evaluator Harness](../ch01/971-anthropic.html) — 另一种评测闭环思路
- [Superpowers](../ch01/491-claude-code-skills-superpowers.html) — Agent 工作流规范
- [Skill Writing Patterns](ch04/272-skill.html) — Skill 质量评估相关
