...
## Ch04.408 Agent Harness 实现对比 A3：SubAgent（7 框架 Prompt 双语对照）
...
- [Claude Code Subagents 上下文卫生](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-subagents-context-hygiene.md)
- 原文存档
