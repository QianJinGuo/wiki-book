...
## Ch04.595 Twilight of the Chatbots：从聊天机器人到自主 Agent 的转型
...
这一观点与 [Hermes Agent 的 Skill 设计](ch04/256-skill.md) 理念一致：好的 Harness 不是简单的 API 封装，而是能放大模型能力的系统性框架。模型的能力曲线和 Harness 的工程优化存在乘数效应。
...
- [Hermes Agent Skill 设计分析](ch04/256-skill.md)
