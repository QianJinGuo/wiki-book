...
## Ch04.280 美团 LongCat 开源 VitaBench 2.0：长期动态智能体基准新标杆

> 📊 Level ⭐⭐ | 11.0KB | `entities/meituan-longcat-vitabench-20-long-term-dynamic-agent-benchmark.md`
...
- [CODA-Bench 代码 Agent 数据基准](../ch09/109-coda-bench-code-agent.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/meituan-longcat-vitabench-20-long-term-dynamic-agent-benchmark.md)
