...
- [From Agent Protocol to Harness Skill](ch04/419-from-agent-protocol-to-harness-skill.html) — 从 MCP/A2A 协议到 Harness Skill 的演进路径，与本文的 Runtime Protocol 抽象视角不同
...
- [Agent 架构关键变化：Harness 成为新后端](../ch05/110-harness.html) — Harness 作为 Runtime 演进方向
