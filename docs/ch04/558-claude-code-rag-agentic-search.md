...
## Ch04.558 Claude Code 开发负责人：为何放弃 RAG 而选择 Agentic Search
...
这与 [Claude Code 源码分析](../ch03/085-claude-code.html) 中揭示的架构一致：Claude Code 的核心不是 RAG pipeline，而是工具编排能力。
...
- Agent Harness
- Agent 记忆系统
- [Claude Code 源码分析](../ch03/085-claude-code.html)
- [Karpathy: Agentic Engineering](ch04/836-karpathy-vibe-coding-agentic-engineering.html)
