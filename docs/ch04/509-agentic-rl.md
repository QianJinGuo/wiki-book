...
- [Agentic RL: Token-In, Token-Out Done Right](ch04/567-agentic-rl-token-in-token-out-done-right.md) — 同主题早期文章，本文是更全面的系统综述
- [港中文 SLIM：动态技能生命周期管理](ch04/509-agentic-rl.md) — Agentic RL 中的技能管理
- [LLM-as-a-Verifier](../ch01/586-llm.md) — Agent 轨迹验证方法
