...
## 与现有 Wiki 的关联
与 [Hermes Agent Deep Dive](../ch03/092-hermes-agent.html) 互补：Hermes Agent 的 Skill 提炼和 nudging 在本文有更系统化的分类定位。
...
与 [Agent Engineering Principles Architecture Practice](../ch03/046-agent.html) 互补：后者 Harness 比模型关键 → 前者第六条机制具体展示如何自动化 Harness。
...
- [Memento-Skills — 技能外部记忆让 Agent 自进化（arXiv 2603.18743）](ch04/403-memento-skills-agent.html)
- [AI Coding Agent 记忆系统](ch04/321-ai-coding-agent.html)
...
- [Harness Engineering：让 Coding Agent 可靠完成长程任务](../ch05/117-harness-engineering.html)
- [Harness Engineering: 让 Coding Agent 可靠完成长程任务](../ch05/117-harness-engineering.html)
- [Karpathy LLM Wiki V2](https://github.com/QianJinGuo/wiki/blob/main/concepts/karpathy-llm-wiki-v2.md)
- [深度解析LLM Wiki / Obsidian-Wiki / GBrain：Agent时代知识的"自组织"与"自进化"](../ch01/642-llm-wiki-obsidian-wiki-gbrain.html)
...
- [深入理解 Claude Code 源码中的 Agent Harness 构建之道](../ch01/425-claude-code-harness-deep-understanding.html)
...
- [深度解析 OpenClaw 在 Prompt / Context / Harness 三个维度中的设计哲学与实践](../ch11/228-openclaw.html)
- [Agent Memory System 设计指南](https://github.com/QianJinGuo/wiki/blob/main/queries/agent-memory-system-design.md)
- [企业级AI记忆基质三层架构：事实/交互/行动记忆](../ch05/090-ai.html)
...
- [SkillClaw](ch04/455-skillclaw-nacos-agent-skill-registry.html)
...
- [Chatgpt Dreaming V3 Long Term Memory Xinzhiyuan](../ch01/1092-chatgpt-dreaming-v3.html)
- [Chatgpt Dreaming V3 Long Term Memory Openai](../ch01/1092-chatgpt-dreaming-v3.html)
- [llm 自我提升系统综述 — yang 等 113 页四阶段闭环框架（zesearch nlp lab）](../ch01/882-llm.html)
- [recursive first steps toward automated ai research：sota 三基准自](../ch05/090-ai.html)
...
- 这与 [Foundation Capital agent era](ch04/184-foundation-capital-agent-era-six-insights.html) 中"infra 厂商抢应用层 IP"的趋势一致，**但 OpenAI 反向操作：放弃应用层 IP 换生产方法论**——是更上游的卡位
...
- **生产方法论 > 应用层 IP**：OpenAI 放弃 Tax AI IP 换范式，是把"自我改进工程"作为下一代护城河，与 [Harness Engineering 长程任务](../ch05/117-harness-engineering.html) 中"Big Harness > Big Model"的判断完全一致
