...
## Ch04.539 OpenClaw、WorkBuddy、Loop 工程：谁在火，谁有用，谁还在 Demo
...
文章中提到的"Token 换架构"观点——Agent 用更高的计算、效率和稳定性成本换取更强的场景泛化能力——是对 Harness 工程核心权衡的精准表述，与 [Harness Engineering](../ch05/115-harness-engineering.html) 中描述的工程框架形成互补。
