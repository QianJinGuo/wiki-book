...
参考：[Agent Harness Engineering Survey](../ch05/115-harness-engineering.html) 中的 ETCLOVG 治理维度。
...
[17种Agent架构](ch04/665-17-agent.html)的演化史本质上是三条路线在不同历史阶段的不同侧重：
...
- [fanling company as agent ai org reflection v2](../ch01/869-agent-ai.html)
