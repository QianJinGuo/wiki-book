...
### 与 [Anthropic 工具数量陷阱](ch05/100-ai.html) 的对比
...
- [AI Agent 工具数量陷阱](ch05/100-ai.html) — "5-10 工具"是 Anthropic 答案；"1 execute_code"是本文答案（更激进的同向论述）
- [Agent Harness 上下文管理工作集视角](ch03/035-agent.html) — 工作集是 **L1 内部**的精细化设计；本文是工作集的 L1/L2/L3 宏观扩展
...
- [上下文工程系列](ch05/100-ai.html) — 系列化上下文工程讨论
