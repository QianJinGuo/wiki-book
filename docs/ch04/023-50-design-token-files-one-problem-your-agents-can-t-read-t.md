...
- [DESIGN.md](../ch01/884-agent-ai.html) -- also an AI Agent interface for design systems
- [Claude Design Skill](../ch01/1131-claude-design-skill.html) -- agent operating design systems in practice
