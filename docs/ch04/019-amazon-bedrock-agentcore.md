...
## Ch04.019 Amazon Bedrock AgentCore: 知识扩展与持续学习新能力
...
## 与现有 [AgentCore Harness](397-agentcore-managed-harness.html) 实体的差异化
...
- [Agentcore Managed Harness](397-agentcore-managed-harness.html) — 前篇：Harness 编排框架
