...
## Ch04.671 GenericAgent — 复旦肖仰华自进化智能体设计哲学
...
- [Hermes Agent 自进化](../ch03/099-hermes-agent.html) — 另一自进化智能体实现，对比 GenericAgent 的 "做减法" vs Hermes 的 Skill 演化路径
- [TACO：让 CLI Agent 学会丢掉无用上下文](../ch03/037-agent.html) — 上下文压缩的另一条路线，奖励模型驱动的自适应丢弃策略
- [上下文工程与三种记忆范式](../ch06/015-memory.html) — 与 GenericAgent 五层记忆形成对比（分层 vs 三种范式）
