...
### 与 [Anthropic 工具数量陷阱](ch04/310-ai.md) 的对比
...
- [AI Agent 工具数量陷阱](ch04/310-ai.md) — "5-10 工具"是 Anthropic 答案；"1 execute_code"是本文答案（更激进的同向论述）
...
- [上下文工程系列](ch04/310-ai.md) — 系列化上下文工程讨论
