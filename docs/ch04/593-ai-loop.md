...
## Ch04.593 企业 AI Loop 落地框架：五类工程对象
...
- [Loop Engineering: 把反馈循环放进工程现场](../ch05/006-loop-engineering.html) — 同一账号（架构师）的系列 Loop 梳理
- [Environment Engineering：Agent 不能只靠一条提示](ch04/294-agentic.html) — 架构师系列中提出 AGENT.md / STATE.md / EVIDENCE.md / PERMISSIONS.md 的先行概念
- [Harness Engineering](../ch05/065-harness-engineering.html) — Agent 运行底座工程范式
