...
## Ch04.590 Proactive Memory Agent — Meta AI (Wu et al. 2026)
...
- [AGENT MEMORY MODULAR FRAMEWORK](ch04/215-agent-memory.html) 和 [Agent Memory Architecture](ch04/498-perplexity-brain-self-improving-agent-memory-architecture.html) 主要关注记忆存储的层次化结构，而这篇论文聚焦于记忆的 **主动干预时机**；
...
- [Agent Memory Injection](ch04/215-agent-memory.html) 从注入维度角度探讨了相似主题。
...
- [Memory Agent Systems Cobanov](ch04/680-memory-agent-systems-cobanov.html)
- [Agent Memory Storage Six Schools](ch04/215-agent-memory.html)
- [Self-Evolution GUI Agents Memory](../ch03/036-agent.html)
