...
## Ch04.305 Stop hand-tuning kernels: How Neuron Agentic Development accelerates AWS Trainium optimizations
...
- [Building A Secure Auth Code Flow Setup Using Agentcore Gatew](ch04/266-building-a-secure-auth-code-flow-setup-using-agentcore-gatew.md) — AgentCore 安全配置
- [Agentcore Harness](ch03/045-agent.md) — AgentCore 工程化
- [Build An Ai Powered Equipment Repair Assistant Using Amazon ](ch04/277-ai.md) — AgentCore + Strands 实践
