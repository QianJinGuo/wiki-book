...
## Ch04.593 Proactive Memory Agent — Meta AI (Wu et al. 2026)
...
- [AGENT MEMORY MODULAR FRAMEWORK](ch04/179-agent-memory.html) 和 [Agent Memory Architecture](ch04/505-perplexity-brain-self-improving-agent-memory-architecture.html) 主要关注记忆存储的层次化结构，而这篇论文聚焦于记忆的 **主动干预时机**；
