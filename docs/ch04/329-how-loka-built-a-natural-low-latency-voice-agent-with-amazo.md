...
这与 [医疗预约 Agent](ch04/546-build-a-healthcare-appointment-agent-with-amazon-nova-2-soni.md) 的设计选择一致——两者都采用了 Nova 2 Sonic 作为核心模型。
...
- [医疗预约 Agent](ch04/546-build-a-healthcare-appointment-agent-with-amazon-nova-2-soni.md) — Nova 2 Sonic 在医疗场景的应用
