...
## Ch04.259 Building a secure auth code flow setup using AgentCore Gateway with MCP clients
...
## 相关实体
- [Amazon Bedrock Agentcore Gateway Mcp Extension](ch04/502-agent.md)
- [Spec Review Agent Baz Bedrock Agentcore Multi Agent](ch04/502-agent.md)
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/building-a-secure-auth-code-flow-setup-using-agentcore-gatew.md)
