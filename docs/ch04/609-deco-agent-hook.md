...
## Ch04.609 DECO — 腾讯数据工程 Agent Hook 护栏层实践
...
- [腾讯混元 Hy3 Agent 产品](../ch01/114-hy3-preview.html) — 腾讯同系的 Agent 产品发展
- [腾讯 K8s + Ray AI Workload 调度](../ch11/271-k8s-ray-ai-workload.html) — 腾讯另一生产级 AI 系统实践
