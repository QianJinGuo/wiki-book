...
## Ch04.301 Stripe Financial Compliance AI Agent: Production Lessons
...
- [Agent Harness Architecture Deep Dive Aksahy](ch05/009-harness.md) — Agent Harness 通用架构深度分析
