...
## Ch04.616 Amazon Bedrock AgentCore 数据持久化文件系统：Session Storage、EFS、S3 Files
...
这些场景与 [AgentCore 运行时深度分析](ch04/554-amazon-bedrock-agentcore.html) 中覆盖的 Agent 生命周期管理直接衔接。而 [AgentCore 记忆哲学](ch04/554-amazon-bedrock-agentcore.html) 则从更底层的记忆系统角度讨论了数据持久性的设计理念。
...
- [AWS Bedrock AgentCore](../ch11/267-aws-bedrock-agentcore.html) — AgentCore 整体架构
- [突破上下文窗口壁垒](ch04/554-amazon-bedrock-agentcore.html) — AgentCore 上下文管理
- [结构化记忆与元数据过滤](ch04/655-data-agent.html) — AgentCore 记忆系统
