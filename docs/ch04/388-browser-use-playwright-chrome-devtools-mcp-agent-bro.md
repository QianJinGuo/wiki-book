...
## Ch04.388 五款浏览器自动化工具横向对比：browser-use / Playwright / chrome-devtools-mcp / agent-browser / BrowserAct
...
| **Skill Forge 流程打包** | ❌ | ❌ | ❌ | ❌ | ✅（注：与 [古法程序员 spec-as-code](https://github.com/QianJinGuo/wiki-public/blob/main/entities/gufabiancheng-spec-for-complex-tasks-cc-codex.md) 的 SKILL.md 模式重叠） |
...
**来源**：原文存档（reject-as-supplementary）
...
把跑通的网页流程打包成 SKILL.md + 脚本，下次 Agent 直接调用。**注：与 古法程序员 spec-as-code 的 SKILL.md 模式直接重叠**——古法程序员是通用框架，BrowserAct 是网页操作特化。
