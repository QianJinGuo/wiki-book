...
## 相关实体
- [Microsoft Build 2026 Qbitai Full Scope](257-ai.html)
...
## 相关对照
- [Kimi Work](../ch01/393-codex.html) —— 本地桌面 Agent + Vibe Working
- [wow-harness v3](../ch05/008-harness.html) —— 跨 session 事件时间线
- [OpenClaw](176-openclaw.html) —— 开源 AI 编程框架（Scout 基于它）
