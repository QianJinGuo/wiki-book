...
| [Hermes Agent Skill Crossover Optimization](../ch01/523-hermes-agent-skill.html) | **Hermes Skill 互优化** | SkillEvolver × Darwin × EmbodiSkill 4 轮闭环（277 行）— Skill 之间的相互优化 |
| [Skill Self Evolution Three Approaches](ch04/339-skill.html) | **Skill 自进化 3 路线** | Trace2Skill 归纳法 / EvoSkill 验证闭环 / SkillOpt 训练范式（45 行）；本文是 SkillOpt + EvoSkill 的工程化展开 |
...
| [Darwin Skill 2 Huashu](ch04/339-skill.html) | **Darwin Skill 2** | Darwin Skill 进化 |
...
| [Hermes 9 Module Architecture](../ch01/293-hermes.html) | **Hermes 9 模块** | Hermes 9 模块架构 |
...
| [Slim Cuhk Skill Lifecycle Agentic Rl](ch04/304-agentic-rl.html) | **SLIM Skill 生命周期** | CUHK SLIM Skill 生命周期 + Agentic RL |
| [Deli Auto Research Skill V2 Continual Learning Self Improvement](ch04/339-skill.html) | **Deli Auto Research** | Continual learning + self-improvement |
