...
→ [原文存档](https://aws.amazon.com/blogs/machine-learning/building-agentic-ai-applications-with-a-modern-data-mesh-strategy-on-aws/)
...
- [Agentic Overlays](../ch03/004-agent.html) — 另一种 agent 化路径：REST 服务的 A2A overlay
...
- [Agent Harnesses Are Dead](468-agent-harnesses-are-dead-long-live-agent-harnesses.html) — Agent Harness 架构演进
