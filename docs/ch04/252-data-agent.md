...
## Ch04.252 什么是数据智能体Data Agent--数据智能体-火山引擎

> 📊 Level ⭐⭐⭐ | 7.8KB | `entities/volcengine-data-agent-product-overview.md`
...
- [高德 AI 原生数据智能体](https://github.com/QianJinGuo/wiki-public/blob/main/entities/gaode-ai-native-data-agent.md)
- [火山引擎 SearchCLI 智能体](https://github.com/QianJinGuo/wiki-public/blob/main/entities/volcengine-searchcli-agent-driven-search-self-iteration.md)
...
- [Karpathy：从 Vibe Coding 到 Agentic Engineering](356-karpathy-vibe-coding-agentic-engineering.html)
- 智能体驱动的数据访问
