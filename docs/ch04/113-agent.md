...
| 层次 | 对应路线 | 核心能力 | 代表系统 |
|------|---------|---------|---------|
| **理解层**（上下文） | 个人上下文 | 用户意图理解、上下文记忆、偏好推断 | [Agent Harness 工作集管理](ch04/503-agent.md) |
| **学习层**（进化） | 自我进化 | 经验沉淀、Skills 版本化、可审计的回滚 | [Small Hermes 自我进化架构](ch04/503-agent.md) |
...
参考：[Agent Harness Engineering Survey](ch04/503-agent.md) 中的 ETCLOVG 治理维度。
...
[17种Agent架构](ch04/503-agent.md)的演化史本质上是三条路线在不同历史阶段的不同侧重：
