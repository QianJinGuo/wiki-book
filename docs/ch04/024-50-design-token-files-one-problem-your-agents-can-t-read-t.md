...
## Ch04.024 50 design token files, one problem: your agents can't read the meaning
...
- [DESIGN.md](../ch01/892-agent-ai.html) -- also an AI Agent interface for design systems
- [Claude Design Skill](../ch01/1138-claude-design-skill.html) -- agent operating design systems in practice
