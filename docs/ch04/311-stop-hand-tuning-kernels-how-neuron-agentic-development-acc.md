...
## Ch04.311 Stop hand-tuning kernels: How Neuron Agentic Development accelerates AWS Trainium optimizations
...
- [Building A Secure Auth Code Flow Setup Using Agentcore Gatew](ch04/265-building-a-secure-auth-code-flow-setup-using-agentcore-gatew.md) — AgentCore 安全配置
- [Agentcore Harness](ch05/085-harness.md) — AgentCore 工程化
- [Build An Ai Powered Equipment Repair Assistant Using Amazon ](ch04/069-ai.md) — AgentCore + Strands 实践
