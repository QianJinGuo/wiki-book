...
## Ch04.726 意识×Loop：AGENTS.md/MEMORY.md/USER.md 三层文件驱动的跨 Session Loop 自进化
...
- → [Loop Engineering：Addy Osmani 的六个框架](../ch05/006-loop-engineering.html) — 本文的 Loop 六大框架理论基础
- → [Agentic Loop Engineering 工程手册](../ch05/006-loop-engineering.html) — 17 种 Loop 工程化技术
