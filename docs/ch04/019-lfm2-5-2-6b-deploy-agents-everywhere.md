...
- **Agentic RL 数据路线**：在真实 harness（Hermes/OpenClaw）内训练是「让模型适应 Agent 环境」的务实路径，与 [Harness Engineering](../ch05/019-harness-engineering.html) 领域关注点一致——环境即训练数据
