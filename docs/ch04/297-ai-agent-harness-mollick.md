...
## Ch04.297 AI Agent 时代选型指南：模型·应用· Harness（Mollick）
...
- [Co Existence Paradigm Shift Agentic Ai Mollick 2026](../ch01/582-ai-mollick.html) — Mollick 2026-06 范式转换叙事（同一作者更新的 agentic 时代框架）
- [Management As Ai Superpower Mollick](../ch01/499-management-as-ai-superpower.html) — 管理作为 AI 超级能力（同一作者，同期但不同议题）
