...
- [基于Bedrock AgentCore+Strands构建企业级智能搜索平台实践](../ch11/045-bedrock-agentcore.html) — AgentCore + Strands 组合的企业级构建范式
- [Building web search-enabled agents with Strands and Exa](341-building-web-search-enabled-agents-with-strands-and-exa.html) — Strands Agents 工具调用模式的深度分析
- [Product Ad Review Agent with Strands SDK and Bedrock](../ch11/211-bedrock.html) — Strands SDK + Bedrock 商品审查 Agent 实践
