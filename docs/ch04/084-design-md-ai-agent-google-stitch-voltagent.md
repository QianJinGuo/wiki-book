...
## Ch04.084 DESIGN.md：AI 设计 Agent 的视觉约束对齐文件（Google Stitch × VoltAgent）
...
## 相关实体
- [Agentexecutorgooglesdistributedagentruntime](ch04/366-agentrun.html)
- [Anthropic Google Agent Skills Design Patterns](ch04/489-anthropic-google-agent-skills.html)
- [Google Agentic Rag Sufficient Context Agent Framesqa](../ch01/340-google-agentic-rag-sufficient-context-agent-framesqa-90.html)
