...
## 与 vault 知识关联
- [Agent Harness 架构](../ch05/043-agent-harness.html) — Agent 与企业软件的交互层，Harness 是 Agent 执行时的"护城河"
...
- [meet customers where they are: agentforce contact center now](ch04/509-meet-customers-where-they-are-agentforce-contact-center-now.html)
