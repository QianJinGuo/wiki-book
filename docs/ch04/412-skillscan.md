...
## Ch04.412 SkillScan — 智能体技能安全扫描最佳实践
...
SkillScan 与 [Agent Skill 设计模式](ch04/342-agent-skill.html) 和 [Hermes Agent 技能设计分析](../ch01/521-hermes-agent-skill.html) 形成了"设计—部署—安全"的完整闭环。具体来说：
...
- [SkillScan 字节跳动版](ch04/342-agent-skill.html)
- [SkillSieve Agent 技能安全](ch04/544-skillsieve-agent-skill.html)
- [Claude Code 安全审查偏见分析](../ch03/084-claude-code.html)
- [Claude Code 遥测安全争议](../ch01/480-anthropic-claude-code.html)
