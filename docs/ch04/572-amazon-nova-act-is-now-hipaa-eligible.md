...
## Ch04.572 Amazon Nova Act is now HIPAA eligible

> 📊 Level ⭐⭐ | 6.1KB | `entities/amazon-nova-act-is-now-hipaa-eligible.md`
...
- [Prompting Amazon Nova 2 For Content Moderation](../ch01/668-prompting-amazon-nova-2-for-content-moderation.html)
- [Evaluate Amazon Nova Sonic Voice Agent Scale No Mic](../ch11/317-amazon-nova.html)
- [Scalable Voice Agent Design With Amazon Nova Sonic Multi Agent Tools And Session](../ch11/317-amazon-nova.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/amazon-nova-act-is-now-hipaa-eligible.md)
