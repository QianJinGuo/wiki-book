...
这一设计与 [Harness 状态边界与失败闭环](../ch05/110-harness.html) 中强调的"边界即文档"的工程哲学一致——Agent 系统的可靠性不来自 Agent 自身的记忆，而来自跨边界时强制落盘的中间表示。
...
- [Harness 状态边界与失败闭环](../ch05/110-harness.html)——边界即文档的工程哲学
