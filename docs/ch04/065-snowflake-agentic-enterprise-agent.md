...
- [Building Multi Tenant Agents With Amazon Bedrock Agentcore](ch04/500-amazon-bedrock-agentcore.md)（AWS Bedrock AgentCore — 对比平台）
- [Anthropic 官方 Agent Harness 平台Claude Managed Agents 完整指南](ch04/606-claude-managed-agents.md)（Anthropic Managed Agents — 另一家厂商视角）
