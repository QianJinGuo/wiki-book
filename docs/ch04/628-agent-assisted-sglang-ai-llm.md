...
## Ch04.628 Agent-Assisted SGLang 开发：AI 辅助 LLM 推理框架工程实践
...
本文档与 wiki 中的 [Agent Skill 设计模式](ch04/271-skill.html)、[BBuf AI-Infra-Auto-Driven-SKILLS](../ch01/770-ai-infra.html) 和 [Skill Engineering](ch04/271-skill.html) 实体直接关联。SGLang 的实践展示了如何在真实的生产级基础设施项目中应用 Agent Skill Engineering 的方法论。
