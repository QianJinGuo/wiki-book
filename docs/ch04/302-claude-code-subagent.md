...
## Ch04.302 Claude Code Subagent 详解：把探索过程关进独立工作区
...
- [k-dense — the model is no longer the bottleneck](ch04/164-k-dense-the-model-is-no-longer-the-bottleneck.html)
