...
## Ch04.210 OpenClaw 与 Claude Code 的 Agent Loop 设计范式
...
- [OpenClaw 技术架构分析](../ch03/004-agent.html) — 本文补充了设计哲学层面的循环范式
- [Agent 架构演进](440-17-agent.html) — 可作为循环阶段的系统性补充
- [Hermes Agent 0.14 架构](161-hermes-agent.html) — 具体实现层面的循环机制
...
## 相关实体
- [Steipete Skill Cleaner Liangzide](../ch07/054-skill.html)
