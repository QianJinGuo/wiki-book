...
## Ch04.516 The #1 AI Agent for financial services | Fin
...
## 相关实体
- [Intercom（Fin）推出管理另一个 AI Agent 的 Agent](ch04/491-intercom-now-called-fin-launches-an-ai-agent-whose-only-jo.html)
...
- [厦门国际银行数创金融杯 RAG 方案](../ch01/1269-rag.html)
...
- [The UI is dead, long live the agent：ServiceNow goes headless and opens its platform](ch04/455-the-ui-is-dead-long-live-the-agent-servicenow-goes-headles.html)
