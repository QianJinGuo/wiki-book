...
## Ch04.043 晓斌：从 People-Oriented 到 Agent-Oriented Infra —— 意图驱动 + 代码沉淀的进化体
...
### vs [Agent Harness 上下文管理](../ch05/057-agent-harness.html)
- 上下文管理 = 工作集视角
...
- [Kimi Work](../ch01/518-codex.html) —— 本地桌面 Agent
