...
| [Hermes Agent Skill Crossover Optimization](../ch01/334-hermes-agent-skill.html) | **Hermes Skill 互优化** | SkillEvolver × Darwin × EmbodiSkill 4 轮闭环（277 行）— Skill 之间的相互优化 |
...
| [Hermes 9 Module Architecture](../ch01/737-9.html) | **Hermes 9 模块** | Hermes 9 模块架构 |
...
| [Slim Cuhk Skill Lifecycle Agentic Rl](ch04/329-agentic-rl.html) | **SLIM Skill 生命周期** | CUHK SLIM Skill 生命周期 + Agentic RL |
