...
## Ch04.419 SkillScan — 智能体技能安全扫描最佳实践
...
SkillScan 与 [Agent Skill 设计模式](ch04/614-agent-skill.html) 和 [Hermes Agent 技能设计分析](../ch01/521-hermes-agent-skill.html) 形成了"设计—部署—安全"的完整闭环。具体来说：
...
- [SkillSieve Agent 技能安全](ch04/559-skillsieve-agent-skill.html)
