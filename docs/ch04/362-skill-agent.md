...
## Ch04.362 Skill 系统：Agent 如何把经验沉淀成可复用能力
...
## 相关页面
→ [Hermes Agent 自进化机制](https://github.com/QianJinGuo/wiki-public/blob/main/entities/hermes-agent-self-evolving.md)（Skills 系统概述）
→ winty·Hermes Self-Improving 概览（同系列）
