...
## Ch04.148 Apache RocketMQ 5.5.0 LiteTopic：AI Agent 异步通信消息模型
...
## 相关实体
- [Rocketmq Litetopic Ai Agent Messaging](ch04/030-ai-agent.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/rocket-mq-5-litetopic-ai-agent-async-cloudnative.md)
