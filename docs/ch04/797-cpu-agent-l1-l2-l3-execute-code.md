...
## Ch04.797 CPU 缓存类比下的 Agent 上下文管理：L1/L2/L3 层级架构与 execute_code 单工具设计
...
### 与 [Anthropic 工具数量陷阱](ch04/105-ai-agent.html) 的对比
...
- [AI Agent 工具数量陷阱](ch04/105-ai-agent.html) — "5-10 工具"是 Anthropic 答案；"1 execute_code"是本文答案（更激进的同向论述）
