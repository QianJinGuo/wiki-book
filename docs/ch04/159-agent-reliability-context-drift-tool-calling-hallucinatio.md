...
## 与 vault 知识关联
- [Agent Harness 架构](ch04/503-agent.md) — Context Manager 处理上下文；工具调用校验是 Harness 层的职责
- [Ralph Loop + Harness Takeover](ch04/503-agent.md) — 长周期 Agent 的可靠性机制，与本文上下文漂移问题高度相关
