...
## Ch04.270 现代浏览器内部机制：Chromium/Blink/V8 架构（Agent Browser Use 向）
...
- [BrowserBC：人类轨迹 Skill 蒸馏](../ch01/782-browserbc.html)
- [Agent Harness Context Management](../ch05/035-agent-harness.html)
