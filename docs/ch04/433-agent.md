...
## Ch04.433 万字长文拆解 Agent 架构设计（二）：工具系统设计
...
3. **优先用递归复用抽象而非新建框架**：当子 Agent、子任务等能力可以经既有工具抽象递归实现时直接复用——少一个特化层就少一处复杂度与维护成本，参见 [nanobot 的单文件调度](../ch03/019-agent.html) 与 [OpenClaw 的工具总线-子 Agent 架构](../ch03/019-agent.html) 的同源印证。
...
- [MCP 工具设计权衡](../ch01/1605-anthropic.html) — 工具接口设计的 Anthropic 视角
- [OpenClaw 工具总线与子 Agent 架构](../ch03/019-agent.html) — 同源思想的另一实现
