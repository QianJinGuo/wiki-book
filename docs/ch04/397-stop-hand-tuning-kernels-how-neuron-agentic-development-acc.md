...
## Ch04.397 Stop hand-tuning kernels: How Neuron Agentic Development accelerates AWS Trainium optimizations
...
- [Building A Secure Auth Code Flow Setup Using Agentcore Gatew](ch04/351-building-a-secure-auth-code-flow-setup-using-agentcore-gatew.html) — AgentCore 安全配置
- [Agentcore Harness](ch04/761-agentcore-harness.html) — AgentCore 工程化
- [Build An Ai Powered Equipment Repair Assistant Using Amazon ](ch04/300-build-an-ai-powered-equipment-repair-assistant-using-amazon.html) — AgentCore + Strands 实践
