...
## Ch04.550 Structured Memory Filtering with Metadata in AgentCore Memory
...
- `[Agent 记忆工程挑战 (AWS China)](ch03/044-agent.md)` — AgentCore 记忆系统工程实践概述
- `[AgentCore Harness](ch03/044-agent.md)` — AgentCore 整体平台
- `[AI Agent Memory Systems](ch04/150-ai.md)` — Agent 记忆系统综述
