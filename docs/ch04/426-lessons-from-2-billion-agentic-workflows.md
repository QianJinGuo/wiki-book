...
## Ch04.426 Lessons From 2 Billion Agentic Workflows
...
- [A Missing Layer In Agentic Systems](ch04/360-a-missing-layer-in-agentic-systems.html) — HITL 作为 Agentic 系统第三层的论述
- [Agentcore Harness](ch04/660-agentcore-harness.html) — AgentCore 工程化实践
- [Agentops Operationalize Agentic Ai Amazon Bedrock](../ch11/160-amazon-bedrock.html) — AgentOps 可观测性实践
