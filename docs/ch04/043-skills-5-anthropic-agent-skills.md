...
## Ch04.043 面向 Skills 编程：大淘宝企业购 5 阶段演进与 Anthropic Agent Skills 标准实战
...
mindmap
  root(("面向 Skills 编程：大淘宝企业购 5 阶段演进与 …"))
    ...
    2. 业务背景：企业购客户对接场景
      ...
      2.2 三大业务域
      2.3 四大典型特征
    3. 五阶段演进路径（2025.8 - 202…
      3.1 阶段 1：Vibe Coding（20…
      3.2 阶段 2：Prompt 模板（2025…
      3.3 阶段 3：SDD 规范驱动开发（202…
      3.4 阶段 4：Skill 沉淀（2026.…
    ...
    6. 经验总结：Skills 构建的核心原则
      6.1 基础认知
      6.2 质量控制四层防线
    7. 知识库体系：三级索引 + kn-fetc…
      7.1 为什么需要知识库？
      7.2 三种存储载体协同
      7.3 三级索引结构（借鉴 Anthropic…
