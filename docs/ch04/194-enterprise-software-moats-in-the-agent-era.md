...
## Ch04.194 Enterprise Software Moats in the Agent Era — 系统性护城河分析框架
...
- [Agent Memory 模块化框架](ch04/120-agent-memory.md) — 数据排放（data exhaust）与记忆系统的关系
...
- [from](../ch01/310-from-system-of-record-to-system-of-intelligence.md)
- [From System Of Record To System Of Intelligence](../ch01/310-from-system-of-record-to-system-of-intelligence.md)
- [meet customers where they are: agentforce contact center now](ch04/536-meet-customers-where-they-are-agentforce-contact-center-now.md)
