...
## Ch04.405 Lessons From 2 Billion Agentic Workflows
...
- [A Missing Layer In Agentic Systems](ch04/347-a-missing-layer-in-agentic-systems.html) — HITL 作为 Agentic 系统第三层的论述
- [Agentcore Harness](ch04/470-amazon-bedrock-agentcore-harness-ga-api-agent.html) — AgentCore 工程化实践
- [Agentops Operationalize Agentic Ai Amazon Bedrock](../ch11/152-amazon-bedrock.html) — AgentOps 可观测性实践
