...
## Ch04.327 Agentic RL 六框架实践地图：从算法到系统的长程智能体训练

> 📊 Level ⭐⭐ | 8.6KB | `entities/agentic-rl-frameworks-practices-long-horizon-wolfe-2026.md`
...
```mermaid
mindmap
  root(("Agentic RL 六框架实践地图 从算法到系统的长程智能体训练"))
    核心概述
    从单轮 MDP 到多轮环境交互
    六大框架
    新型失稳模式 RAGEN
...
- [港中文 SLIM：动态技能生命周期管理](ch04/327-agentic-rl.html) — Agentic RL 中的技能管理
- [LLM-as-a-Verifier](../ch01/1274-llm.html) — Agent 轨迹验证方法
