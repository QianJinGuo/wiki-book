...
## Ch04.305 AgentBrowser：Agent 浏览器工具框架

> 📊 Level ⭐⭐⭐ | 4.3KB | `entities/agent-browser.md`
...
## Related
- [CLI-Anything](../ch03/090-cli-anything.html) — Agent 工具生态
- [AutoCLI](https://github.com/QianJinGuo/wiki-public/blob/main/entities/autocli.md) — 信息获取 CLI
- [Hermes-Agent](../ch03/100-hermes-agent.html) — 可通过 AgentBrowser 扩展能力
