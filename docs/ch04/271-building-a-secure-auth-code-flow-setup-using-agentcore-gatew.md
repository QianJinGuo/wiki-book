...
## Ch04.271 Building a secure auth code flow setup using AgentCore Gateway with MCP clients
...
## 相关实体
- [Amazon Bedrock Agentcore Gateway Mcp Extension](ch04/501-amazon-bedrock-agentcore.md)
- [Spec Review Agent Baz Bedrock Agentcore Multi Agent](../ch11/048-bedrock-agentcore.md)
