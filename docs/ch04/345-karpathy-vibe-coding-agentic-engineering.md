...
> 📊 Level ⭐⭐⭐⭐ | 10.1KB | `entities/karpathy-vibe-coding-agentic-engineering-v2.md`
...
## 关联条目
- [同主题入库（宝玉解读、不同角度）](https://github.com/QianJinGuo/wiki-public/blob/main/entities/karpathy-vibe-coding-to-agentic-engineering.md)
- [Harness Engineering — Agent 工程化落地的实践体系](https://github.com/QianJinGuo/wiki-public/blob/main/entities/harness-engineering-systematic-framework.md)
- [Vibe Coding 主题入库文章](https://mp.weixin.qq.com/s/Ru3Z7wUVOlUwXUZUO5xw2A)
...
- [从Vibe Coding到Agentic Engineering：重构后台开发全流程 — 腾讯技术工程](334-tencent-vibe-coding-to-agentic-engineering-backend.html)
