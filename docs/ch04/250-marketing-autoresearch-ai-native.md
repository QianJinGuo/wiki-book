...
| 现有 entity | 应用域 | 核心方法 |
|-------------|--------|---------|
| [AI 自主科研 L0-L4](https://github.com/QianJinGuo/wiki-public/blob/main/entities/autoresearch-ai-scientific-discovery-l0-l4-challengehub.md) (6KB) | 科学发现 (AlphaFold / The AI Scientist) | L0-L4 五级自主性框架 |
| [AutoResearch 多 Agent 软件开发](https://github.com/QianJinGuo/wiki-public/blob/main/entities/autoresearch-multi-agent-software.md) (14KB) | 软件开发 (Codex / Claude Code) | 多 Agent 异步 + 评审者回路 |
...
**与 [多 Agent 软件开发](https://github.com/QianJinGuo/wiki-public/blob/main/entities/autoresearch-multi-agent-software.md) 的方法论共鸣**：
...
|----|------|------------|
| 第 1-2 期 | (背景调研)| 待补充 |
| **第 3 期** | **7×24 Self-Healing Pipeline + Agent 自进化** (研发生产线) | [Gaode Ai Native 7X24 Pipeline Self Healing](https://github.com/QianJinGuo/wiki-public/blob/main/entities/gaode-ai-native-7x24-pipeline-self-healing.md) (30KB) |
...
### 与 [高德 AI Companion Agent 架构](https://github.com/QianJinGuo/wiki-public/blob/main/entities/gaode-ai-companion-agent-architecture.md) 的层级关系
...
### 与 [Harness Engineering](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/harness-engineering-framework.md) 的深度共鸣
...
这是 [高德 SDD Harness 团队 AI 编码范式](https://github.com/QianJinGuo/wiki-public/blob/main/entities/gaode-sdd-harness-team-ai-coding-paradigm-ibjfu.md) 的**业务侧对应**——SDD 关注"代码的正确性"，AutoResearch 关注"决策的正确性"。
...
- vs [AI 科研 L0-L4](https://github.com/QianJinGuo/wiki-public/blob/main/entities/autoresearch-ai-scientific-discovery-l0-l4-challengehub.md) — 科学发现域，本文是营销业务域
- vs [多 Agent 软件开发](https://github.com/QianJinGuo/wiki-public/blob/main/entities/autoresearch-multi-agent-software.md) — 软件开发域，本文是营销业务域
- vs [高德 7x24 Self-Healing Pipeline](https://github.com/QianJinGuo/wiki-public/blob/main/entities/gaode-ai-native-7x24-pipeline-self-healing.md) — 同公司研发线，本文是营销业务线
- vs [高德 AI Companion Agent](https://github.com/QianJinGuo/wiki-public/blob/main/entities/gaode-ai-companion-agent-architecture.md) — C 端用户交互，本文是 B 端业务托管
- vs [天猫营销 AI 工作流](https://github.com/QianJinGuo/wiki-public/blob/main/entities/tmall-marketing-ai-workflow-best-practices.md) — 营销自动化，本文是营销**研究**（研究 + 实验 + 反馈循环）
...
## 相关实体
- [Autoresearch Marketing Growth Amap Ai Native](https://github.com/QianJinGuo/wiki-public/blob/main/entities/autoresearch-marketing-growth-amap-ai-native.md)

→ [原文存档（高德技术 2026-06-09）](https://mp.weixin.qq.com/s/MKfuVIwIsKg9QhRywbbxSw)
