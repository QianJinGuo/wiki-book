...
## Ch04.241 Agent Skills 终于有 UI 了

> 📊 Level ⭐⭐ | 10.4KB | `entities/qoder-skill-ui-agent-human-collaboration.md`

[Qoder Skill Ui Agent Human Collaboration](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/qoder-skill-ui-agent-human-collaboration.md)
...
- [精选 8 个 Ui 设计师必备的 Ai 智能体技能Agent Skills](ch04/404-agent-skills.html)
- [Agent Skills Comprehensive Survey](ch04/404-agent-skills.html)
