...
## Ch04.522 Building for the Rising Complexity of Agentic Systems with Extreme Co-Design
...
> [!info] 参见
> → [Claude Code 深层架构分析](/ch01-846-claude-code-架构深度解析//) — Claude Code 编码轨迹数据与源码分析
> → 上下文管理 Agent 系统 — Agent 上下文管理核心机制
...
> [!info] 参见
> → Inference Optimization — NVIDIA 推理优化技术栈（Dynamo, TRT-LLM, Speculative Decoding）
> → Cloud AI Infrastructure — AI 原生网络与大规模部署技术
...
这与 [Harness Engineering 框架](/ch05-041-harness-engineering-概念框架//) 中上下文管理层需要硬件支持的观点高度一致。
...
→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/nvidia-agentic-systems-extreme-co-design.md)
