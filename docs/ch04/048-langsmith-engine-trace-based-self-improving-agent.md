...
## Ch04.048 LangSmith Engine: Trace-Based Self-Improving Agent
...
- [Hermes Agent Operator](../ch03/091-hermes-agent.html) — "模型侧自改进"路径（定时任务把对话总结成 Skill），与本文"系统侧自改进"互补
...
- [Claude Code 深度解析](../ch05/067-claude-code-harness.html) — Claude Code 的评估观测层工程实践
...
- [Agent 记忆系统实践](../ch03/046-agent.html) — Agent Overview 是 Memory 模块的诊断侧应用- [langchain × fireworks 100x cheaper trace judge — 通用 trace 评估](../ch05/085-ai.html)
