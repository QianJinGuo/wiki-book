...
## Ch04.497 Proactive Memory Agent — Meta AI (Wu et al. 2026)
...
- [AGENT MEMORY MODULAR FRAMEWORK](ch04/121-agent-memory.html) 和 [Agent Memory Architecture](ch04/400-perplexity-brain-self-improving-agent-memory-architecture.html) 主要关注记忆存储的层次化结构，而这篇论文聚焦于记忆的 **主动干预时机**；
- [Hermes Agent Memory System](../ch03/090-hermes-agent.html) 的三层架构侧重持久化存储，论文的贡献在于何时以及如何 **注入记忆**；
...
- [Agentic RL Frameworks Long-Horizon Wolfe 2026](ch04/533-agentic-rl.html)
...
- [Self-Evolution GUI Agents Memory](../ch03/045-agent.html)
