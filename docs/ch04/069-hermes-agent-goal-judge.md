...
## Ch04.069 Hermes Agent /goal 长任务运行时架构拆解：状态持久化、Judge 闭环与自主续航

> 📊 Level ⭐⭐ | 6.9KB | `entities/hermes-agent-goal-runtime-architecture-state-persistence-judge-closed-loop.md`
...
- [Hermes Agent Kanban Deep Test By Wjjagi 2026](https://github.com/QianJinGuo/wiki-public/blob/main/entities/hermes-agent-kanban-deep-test-by-wjjagi-2026.md)
