...
- [Agent Skill Writing Guide](ch04/604-agent-skill.html) — 21KB，"从 0 到 1" 入门级（岗位职责说明书 + SOP + 避坑指南）。本实体是**进阶 + 团队管理 + 工程化评估**的扩展版。
...
- [Agent Skill Writing Practices](ch04/604-agent-skill.html) / [Agent Skill Writing Advanced](ch04/604-agent-skill.html) / [Agent Skill Writing Evaluation](ch04/604-agent-skill.html) — 系列其他 skill 写作视角。本实体是**鹅厂完整 Playbook 视角**。
