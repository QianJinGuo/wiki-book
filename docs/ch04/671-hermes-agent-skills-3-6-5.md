...
## Ch04.671 Hermes Agent Skills 源码级拆解：3级渐进加载 × 6步调度 × 5维安全扫描
...
- [hermes新顶流agent skills闭环系统深度解析](../ch07/019-hermes-skill.html)
...
> 源码分析版（vs [Hermes Agent Skill 系统深度解析](../ch07/019-hermes-skill.html) winty版）
## 核心定位
Hermes 两套记忆机制：
- **通用记忆**（MEMORY.
