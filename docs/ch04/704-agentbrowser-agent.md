...
## Ch04.704 AgentBrowser：Agent 浏览器工具框架
...
## Related
- [CLI-Anything](../ch03/106-cli-anything.html) — Agent 工具生态
- [AutoCLI](../ch03/132-autocli.html) — 信息获取 CLI
- [Hermes-Agent](../ch03/099-hermes-agent.html) — 可通过 AgentBrowser 扩展能力
