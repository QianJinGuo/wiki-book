...
## Ch04.534 tokenspeed agentic inference engine
...
- [LightSeek TokenSpeed — TokenSpeed 的姐妹项目，专注于轻量级推理优化](ch01/850-lightseek-tokenspeed.md)
- [GLM-5 Scaling Pain 推理优化 — 高并发 Coding Agent 场景的推理问题复盘](ch04/310-ai.md)
- [AgentCore Managed Harness — AWS 的托管 Harness 平台，与推理引擎紧密配合](ch04/503-agent.md)
