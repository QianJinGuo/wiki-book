...
## Ch04.517 ES 做 Agent 记忆层，召回率0.89
...
三索引分型的思路与 [Harness Engineering](../ch05/120-harness-engineering.html) 中的分层思想一致，都是将不同生命周期的信息用不同的策略管理。
