...
**2. Compaction 的触发线设计反映了框架对"安全"的优先级排序**
...
**4. 向量嵌入 + LRU 的 Letta 方案代表了一条尚未被充分验证的路**
...
- [Claude Code 架构解析](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-architecture.md) — 文件读取双层门禁、查询前优化、compaction 触发机制
- [Agent Skill 编写指南](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-skill-writing.md) — Skill 的渐进式上下文注入机制
...
- [Claude Code MCP Server](../ch07/050-claude-code-mcp-server.html)
