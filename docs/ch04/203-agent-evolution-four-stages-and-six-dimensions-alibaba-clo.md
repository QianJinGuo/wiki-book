...
- **Cloud Code / Codex / OpenClaw / Hermes** → [Claude Code](../ch05/086-claude-code-harness.html) / [OpenClaw](../ch11/251-openclaw.html) / Hermes Agent 等
...
- [OpenClaw 完整指南](../ch11/251-openclaw.html) — 自主 Agent 阶段（阶段三）代表
