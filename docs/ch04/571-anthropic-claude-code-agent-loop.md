...
## Ch04.571 Anthropic 大规模代码迁移方法论 — Claude Code 多 Agent Loop 的工程实践
...
- [Claude Code Loop Types](../ch09/136-claude-code-loop-types.html)（loop 类型官方分类）
- [Agentic Loop Engineering](../ch05/005-loop-engineering.html)（loop 工程框架）
