...
## Ch04.430 Anthropic PM 的 Agentic 工作流
...
## 相关
- [Claude Code 搜索架构](../ch03/075-claude-code.html)
- [Cat Wu: Claude Code PM 工作流](../ch03/075-claude-code.html)
- [AutoResearch 多 Agent 开发](../ch03/045-agent.html)
- [Agent Memory 模块化框架](ch04/096-agent-memory.html)
