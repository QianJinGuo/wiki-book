...
- [从 0 到 1 教你写 Agent Skill，让 AI 懂你的"潜规则"](ch04/555-agent-skill.html)（同主题不同 MP — 实操指引）
...
- [Harness Engineering 90 Percent Pillars](../ch05/062-harness-engineering.html)（与 Skill 同源的工程化思路）
...
- [qoder 团队知识引擎](../ch01/803-qoder.html)
