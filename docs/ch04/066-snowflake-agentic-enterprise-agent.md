...
- [Building Multi Tenant Agents With Amazon Bedrock Agentcore](ch04/499-amazon-bedrock-agentcore.md)（AWS Bedrock AgentCore — 对比平台）
- [Anthropic 官方 Agent Harness 平台Claude Managed Agents 完整指南](ch04/485-claude-managed-agents.md)（Anthropic Managed Agents — 另一家厂商视角）
- [Spec As Aios Anti Entropy Architecture Gaode Ai Native Series 2](../ch05/018-ai-native.md)（Spec-as-AIOS — 治理即架构同思路）
- [Taobao Ai Sre Digital Employee Code Quality Governance](../ch01/1001-ai-sre.md)（数字员工治理 — 行业对照）
