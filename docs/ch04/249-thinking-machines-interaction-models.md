...
## Ch04.249 Thinking Machines 交互模型（Interaction Models）
...
ByteByteGo 对 Thinking Machines 交互模型的深度科普，核心贡献在**人类视角的重新定位**。

互补角度 4 条：
1. **人类被边缘化**：当前 AI 行业专注于"自主能力"（任务下发→自动完成），ByteByteGo 指出这种框架将人类排除在协作过程之外
2. **Harness 类比**：用"信件往来的学者"比喻当前语音 AI 的辅助系统架构（VAD/STT/TTS/Dialog Manager 围绕轮次模型）
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/bytebytego-inside-thinking-machines-interaction-models.md)
...
- [thinking-machines-interaction-models-ai-cold](ch04/249-thinking-machines-interaction-models.html)
