...
## Ch04.561 What it feels like to work with Mythos
...
> [!contradiction] 参见 [Anthropic Mythos Glasswing 30Days Vulnerability Report](ch01/707-anthropic.md) 和 [Anthropic N Days Frontier Agent Vulnerability Research](ch04/236-anthropic-n-days-frontier-agent-vulnerability-research.md) 中 Anthropic 官方对 Mythos 能力的描述。本文的第三方实测在某些指标上给出了不同的能力边界评估。
