...
- [amazon-bedrock-agentcore-runtime-deep-dive-and-scenario-analysis](ch04/657-amazon-bedrock-agentcore.html) — 同 Bedrock agent 体系（AgentCore runtime vs Strands Agents）
- [secure-ai-agents-policy-lambda-interceptors-aws](ch04/581-ai-agent.html) — Bedrock Agent 安全护栏（与本文的 Guardrails + row-level entitlements 对应）
...
- [Amazon Bedrock Agentcore Runtime Deep Dive And Scenario Analysis](ch04/657-amazon-bedrock-agentcore.html) — 同为 Bedrock agent 体系，AgentCore runtime vs Strands Agents 的技术选型对比
- [Secure Ai Agents Policy Lambda Interceptors Aws](ch04/581-ai-agent.html) — Bedrock Agent 安全护栏，与本文的 Guardrails + row-level entitlements 设计思路一致
