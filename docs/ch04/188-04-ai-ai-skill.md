...
> **关联**：四层验证体系是 [Harness Engineering](../ch05/065-harness-engineering.html) 在 AI Skill 评测场景的具体实现——Layer 0-1 对应 Harness 的执行基础设施，Layer 2a/2b 对应评估回路，Layer 3 对应可观测性管道。
