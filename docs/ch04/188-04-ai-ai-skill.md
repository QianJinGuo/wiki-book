...
## Ch04.188 04—为什么不能让 AI 自己评审自己？AI Skill 四层验证体系完整解析
...
> **关联**：四层验证体系是 [Harness Engineering](../ch05/050-harness-engineering.html) 在 AI Skill 评测场景的具体实现——Layer 0-1 对应 Harness 的执行基础设施，Layer 2a/2b 对应评估回路，Layer 3 对应可观测性管道。
