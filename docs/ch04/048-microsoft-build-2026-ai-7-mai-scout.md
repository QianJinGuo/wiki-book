...
## Ch04.048 Microsoft Build 2026：微软 AI 独立日 —— 7 款 MAI 模型 + Scout 智能体
...
## 相关实体
- [Microsoft Build 2026 Qbitai Full Scope](ch04/277-ai.md)
...
### vs [OpenClaw](ch11/215-openclaw.md)
...
- [OpenClaw](ch11/215-openclaw.md) —— 开源 AI 编程框架（Scout 基于它）
