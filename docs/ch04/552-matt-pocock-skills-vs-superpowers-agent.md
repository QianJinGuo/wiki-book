...
## Ch04.552 Matt Pocock Skills vs Superpowers：Agent 技能工程的两条路线
...
→ [深度原文存档：四大支柱与元方法论](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/12-行-vs-689-行-mattpocock-skills-与-superpowers-的路线之争.md)
...
- [Superpowers 三器合一](../ch05/105-ai-coding.html) — Superpowers 在 Comet+OpenSpec 流水线中的角色
- [Agent vs Workflow 控制权连续谱](ch04/645-agent-vs-workflow.html) — "控制权交给谁"是这场路线之争的本质
