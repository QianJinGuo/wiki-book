...
## Ch04.691 我用阿里 AgentScope 复刻了一个 WorkBuddy — 从开源框架到可运行 Agent 的实践拆解
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/我用阿里-agentscope-复刻了一个-workbuddy.md)
