...
## Ch04.186 Enterprise Software Moats in the Agent Era — 系统性护城河分析框架
...
## 与 vault 知识关联
- [Agent Harness 架构](ch03/044-agent.md) — Agent 与企业软件的交互层，Harness 是 Agent 执行时的"护城河"
...
- [Agent Memory 模块化框架](ch03/044-agent.md) — 数据排放（data exhaust）与记忆系统的关系
...
- [from](ch04/259-from-system-of-record-to-system-of-intelligence.md)
- [from](ch04/259-from-system-of-record-to-system-of-intelligence.md)
- [meet customers where they are: agentforce contact center now](ch03/044-agent.md)
