...
## Ch04.240 美团 LongCat 开源 VitaBench 2.0：长期动态智能体基准新标杆
...
- [CODA-Bench 代码 Agent 数据基准](https://github.com/QianJinGuo/wiki/blob/main/entities/coda-bench-code-agent-data-benchmark-renmin-2026.md)
- [Agent 评测方法论](https://github.com/QianJinGuo/wiki/blob/main/entities/agent-评测方法论与体系设计.md)
