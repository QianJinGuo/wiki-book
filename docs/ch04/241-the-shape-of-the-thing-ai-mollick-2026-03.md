...
## Ch04.241 The Shape of the Thing：AI 指数曲线·软件工厂·滚动颠覆（Mollick 2026-03）
...
- [Jagged Ai Frontier Mollick](../ch05/110-ai.html) — Jagged Frontier / Bottleneck / Reverse Salient（Mollick 的能力地图框架）
- [Co Existence Paradigm Shift Agentic Ai Mollick 2026](../ch01/827-ai-mollick.html) — Co-Existence 范式（Mollick 2026-06 更新，更激进的 agentic 叙事）
