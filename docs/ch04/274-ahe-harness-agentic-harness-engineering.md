...
## Ch04.274 复旦 AHE：让 Harness 自进化的 Agentic Harness Engineering
...
- [Harness Engineering Core Patterns Claude Code](../ch05/116-harness-engineering.html)
