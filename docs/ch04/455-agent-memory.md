...
## 与 [Hermes Agent Deep Dive](https://github.com/QianJinGuo/wiki-public/blob/main/entities/hermes-agent-deep-dive.md) 的关系
...
## 相关主题
- [Agent Skill Writing](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-skill-writing.md) — Skill 是 Memory 系统持久化的载体之一
- [Anthropic Mcp Revisited](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic-mcp-revisited.md) — MCP 作为 Agent 工具调用协议，与 Memory 的世界模型有交叉（环境约束信息）
- [Gbrain](https://github.com/QianJinGuo/wiki-public/blob/main/entities/gbrain.md) — Compiled Truth + Timeline 知识模型，与 Memory 的信念追踪机制相关
- [原文存档](https://mp.weixin.qq.com/s/aBWunszbTVjI4bdguLIOvg)
...
- [AI Agent 记忆系统架构](143-how-ai-agent-memory-works.html)
