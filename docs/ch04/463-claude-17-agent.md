...
## Ch04.463 Claude的17个能力背后：Agent正在从聊天框搬进工作流
...
```mermaid
mindmap
  root(("Claude的17个能力背后 Agent正在从聊天框搬进工作流"))
    AI 工作流体检表
    五维体检详解
      第一维 上下文入口
      第二维 可审查产物
    ...
    若飞的方法论
    17 个能力的本质 从聊天框到工作流的基础设施
    五维体检表 Agent 工作流就绪度评估
    CLAUDEmd 作为上下文入口的关键角色
    Skills 和 Scheduled Tasks 流程可复用性
```
