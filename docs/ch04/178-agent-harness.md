...
## 参见
- 原文存档
- [Harness Engineering](../ch05/096-harness-engineering.html)（Harness 工程方法论）
...
- [Agent Harness 解析：智能体架构深度拆解](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-harness-architecture-deep-dive-aksahy.md)
