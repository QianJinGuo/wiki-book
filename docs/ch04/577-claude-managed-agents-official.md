...
## Ch04.577 Claude Managed Agents Official
...
## 相关资源
- [Agent Memory 架构](ch04/412-perplexity-brain-self-improving-agent-memory-architecture.html)
...
- [从 Prompt 到 Harness：最小实操指南](../ch05/018-harness.html)
