...
- [Agent Evolution 四阶段六维](../ch03/019-agent.html) — 第四阶段"自进化 Agent"包含本文的系统侧自改进机制
...
- [Agent YAML 评测](../ch03/019-agent.html) — YAML-driven evaluation 是 Evaluator 工程化的一种
...
- [Agent 记忆系统实践](../ch03/019-agent.html) — Agent Overview 是 Memory 模块的诊断侧应用- [langchain × fireworks 100x cheaper trace judge — 通用 trace 评估](../ch01/346-langchain.html)
