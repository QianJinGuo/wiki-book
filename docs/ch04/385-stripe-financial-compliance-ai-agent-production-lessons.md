...
- [Agent Harness Architecture Deep Dive Aksahy](ch03/035-agent.html) — Agent Harness 通用架构深度分析
- [17 Agent Architectures Evolution](ch03/035-agent.html) — 17 种 Agent 架构演化全景
