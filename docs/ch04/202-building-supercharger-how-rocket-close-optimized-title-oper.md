...
- [secure-ai-agents-policy-lambda-interceptors-aws](ch05/094-ai.html) — Bedrock Agent 安全护栏（与本文的 Guardrails + row-level entitlements 对应）
- [agentic-payment-x402-bedrock-agentcore](ch03/035-agent.html) — 金融场景 agent 应用
- [agentops-operationalize-agentic-ai-amazon-bedrock](ch05/094-ai.html) — Bedrock 上 agent 的 production 化
...
- [Secure Ai Agents Policy Lambda Interceptors Aws](ch05/094-ai.html) — Bedrock Agent 安全护栏，与本文的 Guardrails + row-level entitlements 设计思路一致
- [Agentic Payment X402 Bedrock Agentcore](ch03/035-agent.html) — 金融场景 agent 应用案例，与 Rocket Close 同属金融行业 AI 落地
- [Agentops Operationalize Agentic Ai Amazon Bedrock](ch05/094-ai.html) — Bedrock 上 agent 的 production 化路径，包含监控 / 审计 / 部署最佳实践
