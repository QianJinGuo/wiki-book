...
## Ch04.028 Secure AI agents with Policy and Lambda interceptors in Amazon Bedrock

> 📊 Level ⭐⭐ | 32.6KB | `entities/secure-ai-agents-policy-lambda-interceptors-aws.md`
...
- [Break The Context Window Barrier With Amazon Bedrock Agentcore](ch03/044-agent.md)
