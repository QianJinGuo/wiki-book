...
## Ch04.396 Agent架构关键变化：Harness正在成为新后端
...
从微信文章 [Agent架构关键变化：Harness正在成为新后端](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/agent架构关键变化harness正在成为新后端.md) 提取。
...
related:
  ...
  - [Harness 工程化体系](../ch05/129-harness-engineering.html)
  - [Context Management 与 Working Set](../ch05/062-agent-harness.html)
...
- [Agent Harness 12 组件与 7 个关键决策](../ch05/062-agent-harness.html)
- [Harness Engineering：让 Coding Agent 可靠完成长程任务](../ch05/129-harness-engineering.html)
