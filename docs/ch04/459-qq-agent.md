...
## Ch04.459 QQ 浏览器团队 Agent 经验管理 — 从个人记忆到团队语境
...
与 [Agent 记忆架构](ch04/524-perplexity-brain-self-improving-agent-memory-architecture.html) 主题互补——个人记忆 vs 团队经验库；工程实现上属于 [Harness/Skill 工程](../ch05/110-harness-skill.html) 的团队层扩展。 评测见 [Agent 记忆评测](ch04/180-agent-memory.html)，姊妹篇 [腾讯团队经验管理](../ch05/129-ai-coding.html)。
