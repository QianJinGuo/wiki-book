...
## Ch04.597 Agent-Assisted SGLang 开发：AI 辅助 LLM 推理框架工程实践
...
本文档与 wiki 中的 [Agent Skill 设计模式](ch04/266-skill.html)、[BBuf AI-Infra-Auto-Driven-SKILLS](../ch01/1204-ai-infra.html) 和 [Skill Engineering](ch04/266-skill.html) 实体直接关联。SGLang 的实践展示了如何在真实的生产级基础设施项目中应用 Agent Skill Engineering 的方法论。

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/agent-assisted-sglang-development-lmsys-2026-07.md)
