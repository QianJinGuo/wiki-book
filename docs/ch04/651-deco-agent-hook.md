...
## Ch04.651 DECO — 腾讯数据工程 Agent Hook 护栏层实践
...
- [Harness Engineering 阿里 Java 实践](../ch05/120-harness-engineering.html) — 企业级 Harness 工程另一视角
- [腾讯混元 Hy3 Agent 产品](../ch01/117-hy3-preview.html) — 腾讯同系的 Agent 产品发展
- [腾讯 K8s + Ray AI Workload 调度](../ch11/142-k8s-ray-ai-workload.html) — 腾讯另一生产级 AI 系统实践
