...
## Ch04.381 浪潮信息 2026 OCP — Agent 规模化基础设施
...
- [Lambda Microvms Vs Bedrock Agentcore Ai Agent Comparison](../ch11/271-lambda-microvms-vs-bedrock-agentcore-ai-agent.html) — Agent 基础设施的对比分析
- [Tencent K8S Ray Ai Workload Scheduling](../ch11/269-k8s-ray-ai-workload.html) — 腾讯的 Agent 调度方案，与浪潮信息的 CPU+GPU 协同形成对照
