...
## Ch04.360 姚顺雨评测腾讯混元 Hy3 Agent 能力
...
与 [Claude Code](../ch03/075-claude-code.html) 等面向开发者的 Coding Agent 不同，元宝 Agent 的目标用户是微信生态内的普通用户——他们不需要注册新账号、不需要熟悉新软件、无需复杂调试配置，在对话框内直接完成整套任务。
...
- [Claude Code 治理软规则](../ch03/075-claude-code.html) — Coding Agent vs 普通用户 Agent 的治理对比
- [Agent Harness 架构](../ch05/062-agent-harness.html) — Agent 系统的架构设计模式
...
- [Claude Code 系统工程指南](../ch03/075-claude-code.html) — 对比 Coding Agent 能力
