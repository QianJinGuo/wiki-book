...
## Ch04.585 GLM-5.2 is the step change for open agents

> 📊 Level ⭐⭐ | 3.8KB | `entities/glm-52-is-the-step-change-for-open-agents.md`

# GLM-5.2 is the step change for open agents

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/glm-52-is-the-step-change-for-open-agents.md)
