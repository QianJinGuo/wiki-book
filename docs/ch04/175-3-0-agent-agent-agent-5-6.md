...
## Ch04.175 扣子 3.0 多 Agent 协同实战：指挥所有 Agent 的 Agent + 5 人团队 6 步流水线
...
- [Coze 3 0 Local Agent Project Orchestration](../ch03/036-agent.html)
...
- [Baidu Netdisk Three Layer Agent Architecture](../ch03/036-agent.html)
