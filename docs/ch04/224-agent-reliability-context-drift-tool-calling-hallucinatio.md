...
## 与 vault 知识关联
- [Agent Harness 架构](ch03/035-agent.html) — Context Manager 处理上下文；工具调用校验是 Harness 层的职责
- [Ralph Loop + Harness Takeover](ch03/035-agent.html) — 长周期 Agent 的可靠性机制，与本文上下文漂移问题高度相关
...
- [AI tool poisoning exposes a major flaw in enterprise agent security | VentureBeat](ch05/100-ai.html)
