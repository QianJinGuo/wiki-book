...
## Ch04.224 Agent Reliability: Context Drift & Tool Calling Hallucination
...
## 与 vault 知识关联
- [Agent Harness 架构](../ch05/062-agent-harness.html) — Context Manager 处理上下文；工具调用校验是 Harness 层的职责
- [Ralph Loop + Harness Takeover](../ch05/085-harness.html) — 长周期 Agent 的可靠性机制，与本文上下文漂移问题高度相关
...
- [AI tool poisoning exposes a major flaw in enterprise agent security | VentureBeat](ch04/534-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s.html)
...
- [柚漫剧 AI 全流程提效拆解](../ch05/100-ai.html)
...
- [Thin Harness Fat Skills](../ch05/092-thin-harness-fat-skills-ai.html)
