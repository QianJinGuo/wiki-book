...
## Ch04.184 Anthropic 上线「做梦」功能，让 Agent 越睡越聪明

> 📊 Level ⭐⭐⭐ | 10.4KB | `entities/anthropic-dreaming-claude-managed-agents-ovz5v7jjkqdksu9xmxwt8w.md`
...
- [Harness Engineering 框架](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/harness-engineering-framework.md) — Managed Agents 是 Anthropic 官方 Harness 产品
