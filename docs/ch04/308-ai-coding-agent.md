...
## Ch04.308 AI Coding Agent 记忆系统

> 📊 Level ⭐⭐ | 8.5KB | `entities/ai-coding-agent-memory-system.md`

## 相关实体
- [Hermes Agent 记忆系统 vs OpenClaw 记忆观](../ch03/090-hermes-agent.md)
- [Agent 记忆架构](ch04/387-perplexity-brain-self-improving-agent-memory-architecture.md)
- [Agent 记忆模块化框架](ch04/120-agent-memory.md)
- [AI Agent 记忆系统](ch04/120-agent-memory.md)
- [上下文窗口管理](https://github.com/QianJinGuo/wiki/blob/main/entities/context-window-management.md)
- [Agent Harness 上下文管理：工作集模型](../ch05/038-agent-harness.md)
...
- [AI Context Layer 框架](ch04/229-ai.md)
