...
## Ch04.536 Matt Pocock Skills vs Superpowers：Agent 技能工程的两条路线
...
- [Superpowers 三器合一](../ch05/098-ai-coding.html) — Superpowers 在 Comet+OpenSpec 流水线中的角色
- [Agent vs Workflow 控制权连续谱](ch04/632-agent-vs-workflow.html) — "控制权交给谁"是这场路线之争的本质
