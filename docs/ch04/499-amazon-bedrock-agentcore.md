...
## 与现有 [AgentCore Harness](ch04/220-agentcore-managed-harness.md) 实体的差异化
...
- [Agentcore Managed Harness](ch04/220-agentcore-managed-harness.md) — 前篇：Harness 编排框架
- [Agentcore Harness](ch04/462-amazon-bedrock-agentcore-harness-ga-api-agent.md) — 同期：其他 AgentCore 工程实践
- [Agentcore Payments X402 Agentic Commerce](../ch11/065-agentcore-payments.md) — 同期：x402 商业化
