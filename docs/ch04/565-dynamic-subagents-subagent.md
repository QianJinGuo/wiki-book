...
## Ch04.565 Dynamic Subagents: 代码驱动的 Subagent 编排
...
- [Anthropic Dynamic Workflows](../ch01/1286-anthropic.html)
- [Generator-Evaluator 对抗验证](../ch01/1286-anthropic.html)
- [Claude Code Subagent 规则](../ch09/163-claude-code-1.html)
