...
这与 [Claude Code 的动态工作流](../ch09/089-claude-code-dynamic-workflows.html) 有相似的架构模式：LLM 做决策，工具做执行，人类做监督。
...
这与 [SchemaFlow](ch04/612-agentic.html) 的思路互补：SchemaFlow 将 LLM 约束在数据库 schema 中，kipi 将 LLM 约束在图结构中。
...
- [Claude Code Workflows](../ch09/089-claude-code-dynamic-workflows.html) — Agent 动态工作流
- [SchemaFlow](ch04/612-agentic.html) — 结构化数据的 LLM 约束
