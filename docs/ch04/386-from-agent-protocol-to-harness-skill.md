...
## Ch04.386 From Agent Protocol to Harness Skill
...
- [huashu-design 2.0 — agent skill 反收敛三套逻辑](../ch01/203-0.md)
- [introducing the mdn mcp server](../ch01/897-20.md)
- [当 agentic ai 重塑生产关系：智能体浪潮下的企业战略与行动框架](ch04/060-agentic-ai.md)
