...
## Ch04.662 Anthropic 大规模代码迁移方法论 — Claude Code 多 Agent Loop 的工程实践
...
- [Claude Code Dynamic Workflows](../ch09/103-claude-code-dynamic-workflows.html)（动态工作流基础）
- [Claude Code Loop Types](../ch09/097-claude-code-loop-types.html)（loop 类型官方分类）
