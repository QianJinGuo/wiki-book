...
## Ch04.575 What it feels like to work with Mythos

> 📊 Level ⭐⭐ | 1.9KB | `entities/what-it-feels-like-to-work-with-mythos.md`
...
> [!contradiction] 参见 [Anthropic Mythos Glasswing 30Days Vulnerability Report](https://github.com/QianJinGuo/wiki/blob/main/entities/anthropic-mythos-glasswing-30days-vulnerability-report.md) 和 [Anthropic N Days Frontier Agent Vulnerability Research](https://github.com/QianJinGuo/wiki/blob/main/entities/anthropic-n-days-frontier-agent-vulnerability-research.md) 中 Anthropic 官方对 Mythos 能力的描述。本文的第三方实测在某些指标上给出了不同的能力边界评估。
