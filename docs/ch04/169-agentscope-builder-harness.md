...
- [AgentScope Java Harness Framework 企业分布式版](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agentscope-java-harness-framework-enterprise-distributed.md) — 同一作者，更早的框架介绍
## 相关实体
