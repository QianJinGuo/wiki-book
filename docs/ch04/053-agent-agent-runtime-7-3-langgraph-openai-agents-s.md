...
## Ch04.053 Agent 的骨架:Agent Runtime 7 大职责 + 3 主流框架对比 (LangGraph / OpenAI Agents SDK / 自研)
...
- vs **[阿里云云原生安全护栏三域演进](257-ai.html)** — 那是从云资源到 AI 模型到模型间路由的**三域护栏**;本文的"风险控制"职责是 Guardrail 的**单点实现**视角
...
- vs **[Google Agent Executor Distributed Runtime](290-agentrun.html)** — Google 自家 Runtime 实现;与本文 LangGraph / OpenAI SDK 平行
...
- vs **[AgentCore Harness](../ch05/008-harness.html)** / **[AgentCore Managed Harness](187-agentcore-managed-harness.html)** — AWS 实现的 8 职责具体形态
...
- **未涉及 prompt injection / 越权 / 隐私等高级 Guardrail**: 本文风险控制仅 1 段;深度安全参考 [阿里云安全护栏三域](257-ai.html)
...
- [Google Agent Executor Runtime](290-agentrun.html)
