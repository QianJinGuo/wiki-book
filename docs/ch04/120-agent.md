...
| 层次 | 对应路线 | 核心能力 | 代表系统 |
|------|---------|---------|---------|
| **理解层**（上下文） | 个人上下文 | 用户意图理解、上下文记忆、偏好推断 | [Agent Harness 工作集管理](../ch05/038-agent-harness.html) |
| **学习层**（进化） | 自我进化 | 经验沉淀、Skills 版本化、可审计的回滚 | [Small Hermes 自我进化架构](../ch03/045-agent.html) |
...
参考：[Agent Harness Engineering Survey](../ch05/092-harness-engineering.html) 中的 ETCLOVG 治理维度。
...
[17种Agent架构](ch04/606-17-agent.html)的演化史本质上是三条路线在不同历史阶段的不同侧重：
...
## 相关实体
- [清华 ai 自进化组织研究报告：ai 业务资产化与公司形态重构](../ch05/077-ai.html)
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/acker-agent-evolution-three-routes-convergence.md)

- [fanling company as agent ai org reflection v2](../ch01/939-agent-ai.html)
