...
## Ch04.253 精选 8 个 UI 设计师必备的 AI 智能体技能（Agent Skills）
...
→ [frontend-design 实体对比](../ch01/962-skills-anthropic-openai-comparison-frontend-design.html)
→ [开发者技能清单](ch04/481-agent-skills.html)
