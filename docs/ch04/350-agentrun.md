...
## Ch04.350 用两行代码将 AgentRun 集成到你的应用
...
- [Cli Mcp Sdk Agent Tool Selection](../ch03/045-agent.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/aliyun-agentrun-2line-integration.md)
