...
## 相关实体
- [Microsoft Build 2026 Qbitai Full Scope](052-ai.html)
...
## 相关对照
- [Kimi Work](../ch01/367-codex.html) —— 本地桌面 Agent + Vibe Working
- [wow-harness v3](../ch05/008-harness.html) —— 跨 session 事件时间线
- [OpenClaw](180-openclaw.html) —— 开源 AI 编程框架（Scout 基于它）
