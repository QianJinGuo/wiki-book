...
- [Asana Agentic Work Management Platform Lettertwo](ch04/610-agentic.html)（Asana — 另一个企业级 Agent 平台视角）
- [Building Multi Tenant Agents With Amazon Bedrock Agentcore](ch04/530-amazon-bedrock-agentcore.html)（AWS Bedrock AgentCore — 对比平台）
...
- [Taobao Ai Sre Digital Employee Code Quality Governance](../ch01/1070-ai-sre.html)（数字员工治理 — 行业对照）
- [Agentops Operationalize Agentic Ai Amazon Bedrock](../ch11/156-amazon-bedrock.html)（AgentOps — 智能体可观测性对照）
- [Ai Tool Poisoning Exposes A Major Flaw In Enterprise Agent Security](ch04/432-ai-tool-poisoning-exposes-a-major-flaw-in-enterprise-agent-s.html)（企业 Agent 安全风险同主题）
