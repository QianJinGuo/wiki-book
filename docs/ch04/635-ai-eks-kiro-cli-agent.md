...
## Ch04.635 AI 时代的 EKS 升级范式：Kiro-cli Agent 接管识别、升级与排障
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/ai-eks-upgrade-kiro-cli-agent-paradigm-2026.md)
