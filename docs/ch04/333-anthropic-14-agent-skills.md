...
## Ch04.333 Anthropic 14 个 Agent Skills 设计模式
...
- [Agent/Skills/Teams 架构演进与选型](ch04/308-agent-skills-teams.html) — Anthropic Skills 认知一致性机制
...
- [9个Agent技能模块化SageMaker微调生命周期](ch04/499-aws-sagemaker-ai-agent.html)
...
- [Perplexity 内部 Skill 设计指南：四维体系与维护方法论](ch04/344-skill.html)
...
- [Trace2Skill: 轨迹经验蒸馏为可迁移 Agent Skills](ch04/477-agent-skills.html)
