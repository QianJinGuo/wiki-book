...
- [NVIDIA Agentic Systems](ch04/503-agent.md) — 英伟达在 Agent 系统层面的超大规模协同设计实践
- [Kimi K2 Agent 数据库](ch04/503-agent.md) — 国产 Agent 在数据库场景的应用
- [Claude Managed Agents](ch04/503-agent.md) — Claude 的托管 Agent 架构与 MCP 集成
