...
## Ch04.066 Agent Loop 源码导读：一次 Hermes 任务的完整生命周期
...
- [Gateway Architecture Openclaw Claude Hermes Comparison](../ch11/230-openclaw.html)
...
- **Core Loop 9 步** 与 [Hermes Agent Goal And Kanban](ch04/375-hermes-agent-goal.html) 的 `/goal` + kanban 集成直接对应 — 同一架构的两种视角
