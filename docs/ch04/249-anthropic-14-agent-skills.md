...
## Ch04.249 Anthropic 14 个 Agent Skills 设计模式
...
## 与现有知识库内容的关联
- [Claude Managed Agents](ch04/474-claude-managed-agents.md) — 托管 Harness 平台
- [Agent/Skills/Teams 架构演进与选型](ch04/256-skill.md) — Anthropic Skills 认知一致性机制
