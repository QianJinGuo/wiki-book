...
## 与知识库的连接
- → AgentCore Identity：OAuth认证模式可复用到MCP server
...
- [让 AI 理解你的组件库：新一代智能 D2C架构 — 基于 AWS Kiro MCP Skills 的智能转换实践 | 亚马逊AWS官方博客](https://github.com/QianJinGuo/wiki-public/blob/main/entities/ai-understanding-component-library-intelligent-d2c-architecture-aws-kiro-mcp-skills.md)
...
- [AWS DevOps Agent × MCP Server：打通混合云网络排障的最后一公里](https://github.com/QianJinGuo/wiki-public/blob/main/entities/aws-devops-agent-mcp-server打通混合云网络排障的最后一公里.md)
...
- [Extending Mcp Support For Amazon Bedrock Agentcore Gateway](../ch11/106-extending-mcp-support-for-amazon-bedrock-agentcore-gateway.html)
...
- [Hands Free First Notice Of Loss Using Strands Agents And Ama](https://github.com/QianJinGuo/wiki-public/blob/main/entities/hands-free-first-notice-of-loss-using-strands-agents-and-ama.md)
- [How Baz Improved Its Ai Agent Code Review Accuracy Using Ama](https://github.com/QianJinGuo/wiki-public/blob/main/entities/how-baz-improved-its-ai-agent-code-review-accuracy-using-ama.md)
- [Secure Ai Agents With Policy And Lambda Interceptors In Amaz](https://github.com/QianJinGuo/wiki-public/blob/main/entities/secure-ai-agents-with-policy-and-lambda-interceptors-in-amaz.md)
