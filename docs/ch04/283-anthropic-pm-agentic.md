...
## Ch04.283 Anthropic PM 的 Agentic 工作流
...
## 相关
- [Claude Code 搜索架构](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-architecture.md)
- [Cat Wu: Claude Code PM 工作流](https://github.com/QianJinGuo/wiki-public/blob/main/entities/cat-wu-claude-code-pm.md)
...
- [AI Team 知识 Harness](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/ai-team-knowledge-harness.md)
