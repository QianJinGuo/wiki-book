...
## Ch04.236 Agent/Skills/Teams 架构演进过程及技术选型之道
...
## 与 Wiki 已有内容的关系
- 补充 [Agent 工程实践](../ch03/045-agent.html)的"架构演进路径"章节（增加量化数据）
- 补充 [Hermes Agent 深度解析](../ch03/090-hermes-agent.html)的 Multi-Agent 协作部分（Google 论文 5 条结论）
...
- [Autoresearch Next Phase Async Multi Agent Ai寒武纪](../ch01/977-agent-ai.html)
