...
### vs [Kimi Work](../ch01/541-codex.html)
...
- [Kimi Work](../ch01/541-codex.html) —— 本地桌面 Agent
- [PilotDeck](../ch03/045-agent.html) —— 多项目隔离
- [Rein](../ch03/045-agent.html) —— 4 模块 + 5 类型边界
- [Microsoft Build 2026](../ch03/045-agent.html) —— 全栈 AI
- [Claude Code 20000 字符源码分析](../ch03/075-claude-code.html) —— 98.4% 基础设施
