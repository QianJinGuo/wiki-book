...
## Ch04.041 晓斌：从 People-Oriented 到 Agent-Oriented Infra —— 意图驱动 + 代码沉淀的进化体
...
### vs [Agent Harness 上下文管理](../ch05/039-agent-harness.html)
- 上下文管理 = 工作集视角
...
- [wow-harness v3](../ch05/099-harness.html) —— 跨 session 事件时间线
- [Kimi Work](../ch01/535-codex.html) —— 本地桌面 Agent
