...
## Ch04.252 高德Proactive Agent — LBS场景时空思考型主动服务Agent
...
## 相关实体
- [Lbs Intent Bench Lbs Intentbench](ch04/269-lbs-intentbench.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/amap-proactive-agent-lbs-spacetime.md)
