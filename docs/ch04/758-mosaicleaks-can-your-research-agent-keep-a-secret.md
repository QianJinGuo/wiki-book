...
## Ch04.758 MosaicLeaks: Can your research agent keep a secret?
...
- 与 [Nvidia Secure Local Agent Nemoclaw Openclaw](ch04/514-nvidia-secure-local-agent-nemoclaw-openclaw.html) 的本地安全 Agent 方案互补：NVIDIA 方案从架构层隔离，MosaicLeaks 从训练层优化
- 隐私保护是 [Harness Engineering](https://github.com/QianJinGuo/wiki/blob/main/concepts/harness-engineering-framework.md) 中安全层的重要维度
- 研究 Agent 的隐私问题与 [Interconnects What Comes Next With Open Models](../ch01/1467-what-comes-next-with-open-models.html) 讨论的开源模型安全话题相关
