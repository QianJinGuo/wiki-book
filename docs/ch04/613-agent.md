...
本页作为知识图谱锚点，连接了以下关键实体：[一个 Mission 跑 16 天、烧 7.78 亿 Token：Factory 公开了多 Agent 系统的构建哲学](ch04/161-factory-missions.md)。 相关主题通过 [AutoResearch 异步多 Agent AI 寒武纪新阶段](../ch01/924-agent-ai.md) 延伸。
...
- [一个 Mission 跑 16 天、烧 7.78 亿 Token：Factory 公开了多 Agent 系统的构建哲学](ch04/161-factory-missions.md)
- [AutoResearch 异步多 Agent AI 寒武纪新阶段](../ch01/924-agent-ai.md)
- [Anthropic Multi Agent Research System](ch04/506-anthropic-multi-agent-research-system.md)
- [Code as Agent Harness 综述](../ch09/051-code-as-agent-harness.md)
- [Orchestrating Self-Evolving Agents with CrewAI and NVIDIA NemoClaw](ch04/216-self-evolving-agents.md)
