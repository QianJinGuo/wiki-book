...
## Ch04.163 Codex /goal：长任务Agent的目标运行时
...
- [Agent Memory Architecture](ch04/497-perplexity-brain-self-improving-agent-memory-architecture.html)（状态为什么得落在模型外面）
...
- [Cline releases open-source agent runtime SDK](ch04/568-cline-releases-open-source-agent-runtime-sdk.html)
- [Cline releases open-source agent runtime SDK](../ch03/035-agent.html)

- [Openai Symphony Codex Orchestration Linear Control Plane](../ch01/227-openai.html)
