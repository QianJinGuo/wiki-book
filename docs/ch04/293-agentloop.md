...
AgentLoop 的"Agent + Harness → 观测 → 评估 → 优化"链路，与 [Harness Engineering 2026 全景](../ch05/052-harness-engineering.html) 中描述的"可观测性是 Harness 的核心支柱"完全一致。AgentLoop 通过 MVP 五环将 Harness 工程的观测侧做实，使 Agent 能够在生产环境中自我进化。
...
- [Agent Teams 群聊模式](../ch01/1207-claude.html)
