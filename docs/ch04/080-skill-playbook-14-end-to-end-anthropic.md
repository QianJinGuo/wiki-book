...
- [Ai Skill Skill Creator 源码拆解](235-skill-skill.html) — 28KB，skill-creator 源码深度拆解（3 Agent 评审）。本实体是 Skill Creator **5 步工作流 + 3 阶段评估的实战使用**视角，那个是**源码内部机制**视角。
...
- [Anthropic 官方技能最佳实践14 个可复用的 Agent Skills 设计模式](302-agent-skills.html) — Anthropic 官方 14 patterns 译本。命名相似但内容不同。
...
- Skill 系统综述 — [Agent Skills Comprehensive Survey](302-agent-skills.html)
- Skill 元技能 — [Meta Skill](../ch07/024-meta-skill.html)
- Skill vs Coze/Dify/n8n — [Agent Skills Vs Coze Dify N8N Lowcode Yexiaocha](302-agent-skills.html)
