...
## Ch04.072 Fable 5 的信号:Agent 开始拼 Runtime — 架构师若飞的 Runtime Contract 工程化拆解
...
- vs **[Claude Fable 5 and new AI safety fables](../ch01/890-claude-fable-5-and-new-ai-safety-fables.html)** — Nathan Lambert 的**政策分析**(数据保留/prompt 过滤/用户未告知模型修改),本文**不**涉及政策。
...
- [Claude Fable 5 and new AI safety fables](../ch01/890-claude-fable-5-and-new-ai-safety-fables.html)
