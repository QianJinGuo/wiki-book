...
- [Claude Code 架构解析](ch03/073-claude-code.md) — 文件读取双层门禁、查询前优化、compaction 触发机制
...
- [OpenClaw Agent 可观测性体系 — Session 审计日志 + OTEL + SLS](ch04/502-agent.md)
...
- [Boris Cherny — 从 IDE 到 Agent 控制台](ch04/502-agent.md)
