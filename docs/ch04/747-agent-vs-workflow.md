...
## Ch04.747 Agent vs Workflow：控制权连续谱与生产级选型框架
...
- [AI Agent 工具数量陷阱](ch04/762-ai-agent.html) — Agent 工具工程
- [阿里 Harness 工程实战：Agent 自主迭代 17 小时](../ch05/085-harness.html) — 父子 Agent 模式体现了控制权连续谱的层级 delegation
