...
- [DESIGN.md](../ch01/986-agent-ai.html) -- also an AI Agent interface for design systems
- [Claude Design Skill](../ch01/1096-claude-design-skill.html) -- agent operating design systems in practice
