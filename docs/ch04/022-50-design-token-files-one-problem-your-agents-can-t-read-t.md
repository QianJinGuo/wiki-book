...
- [DESIGN.md](ch04/069-ai.md) -- also an AI Agent interface for design systems
- [Claude Design Skill](ch01/1021-claude-design-skill.md) -- agent operating design systems in practice
