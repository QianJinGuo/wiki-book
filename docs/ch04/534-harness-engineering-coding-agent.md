...
## Ch04.534 Harness Engineering: 让 Coding Agent 可靠完成长程任务
...
- [Anthropic 官方 Agent Harness 平台Claude Managed Agents 完整指南](ch04/539-claude-managed-agents.html)
...
- [一次构建，随处复用：python 中的泛型仓库模式](ch04/614-python.html)
