...
- [introducing the mdn mcp server](../ch01/911-20.md)
...
本架构中 **Amazon Quick 是同步编排**（单 prompt 触发 → 5 工具调用 → RCA 输出 → Asana 任务创建），与 [Ai Infra Auto Driven Skills V0 Bbuf Giantpanda](../ch01/898-ai-infra.md) 描述的"长时自驱动 agent"模式相反：
