...
- [Claude Code 大型代码库 Harness](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-large-codebase-harness-configuration.md) — 代码库索引和 Agent 配置的工程实践
- [StackOverflow for Agents](https://github.com/QianJinGuo/wiki-public/blob/main/entities/stackoverflow-for-agents-launch-2026.md) — Agent 间知识共享的另一种模式
- [GitHub Agentic Token 效率](https://github.com/QianJinGuo/wiki-public/blob/main/entities/github-agentic-token-efficiency.md) — Agent 在代码审查场景的 token 优化

→ [原文存档](https://www.greptile.com/blog/trex-code-execution)
