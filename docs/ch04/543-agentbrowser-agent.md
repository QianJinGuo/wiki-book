...
## Ch04.543 AgentBrowser：Agent 浏览器工具框架
...
## Related
- [CLI-Anything](../ch03/095-cli-anything.html) — Agent 工具生态
- [AutoCLI](../ch03/119-autocli.html) — 信息获取 CLI
- [Hermes-Agent](../ch03/090-hermes-agent.html) — 可通过 AgentBrowser 扩展能力
