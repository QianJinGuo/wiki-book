...
### vs Agent Harness 上下文管理（[Agent Harness Context Management Working Set](../ch05/057-agent-harness.html)）
- 工作集视角：logical_messages 原样保留 + 投影 = Rein 的"存储完整，发送压缩"

### vs wow-harness v3 事件溯源（[Wow Harness V3 Governance Protocol](../ch05/009-harness.html)）
...
- [Agent Harness 上下文管理](../ch05/057-agent-harness.html) —— 工作集视角
- [wow-harness v3](../ch05/009-harness.html) —— 事件溯源 + 概念图
- [PilotDeck](../ch03/035-agent.html) —— 白盒记忆
- [Agent Harness 架构](../ch05/057-agent-harness.html) —— 7 层 harness 模型
- [17 种 agent 架构演进](ch04/693-17-agent.html) —— 类型边界视角
