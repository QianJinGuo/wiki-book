...
## Ch04.427 SkillClaw × Nacos：从一次 Agent 会话到可治理 Skill Registry 的自动演化闭环
...
这与 [Agent Capability Library](ch04/573-an-agent-capability-library.html) 的设计理念相通——都需要一个中心化的 Skill 治理基础设施。
...
这种"生成-治理分离"的架构与 [Anthropic 对抗式架构](../ch01/847-anthropic.html) 中的"合同谈判机制"有异曲同工之妙——都强调生成方和验证方的职责隔离。
...
- [Agent Capability Library](ch04/573-an-agent-capability-library.html)
