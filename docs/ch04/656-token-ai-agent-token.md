...
## Ch04.656 鹅厂 Token 刺客：AI Agent 使用中的 Token 浪费反模式与实践教训
...
- 与 [GitHub Agentic Token 效率](ch04/724-agentic.html) 的"消灭未使用的 MCP 工具注册"（40 工具 → 每轮 10-15KB schema 开销）同源。
...
- [GitHub Agentic Token 效率](ch04/724-agentic.html) — 基础设施层（API proxy 审计/Optimizer 自动裁剪），本实体是使用层（开发者日常行为反模式）
