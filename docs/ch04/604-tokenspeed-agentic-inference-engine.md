...
## Ch04.604 Tokenspeed Agentic Inference Engine
...
- [GLM-5 Scaling Pain 推理优化 — 高并发 Coding Agent 场景的推理问题复盘](../ch01/549-scaling.md)
- [AgentCore Managed Harness — AWS 的托管 Harness 平台，与推理引擎紧密配合](ch04/464-amazon-bedrock-agentcore-harness-ga-api-agent.md)
