...
- [cola dlm：字节跳动连续潜空间扩散语言模型](../ch01/396-cola-dlm.md)
- [explicit vs. implicit in the age of intelligences — le secré](ch04/229-ai.md)
- [review agent：后台复盘 agent 如何判断什么值得保存](../ch03/045-agent.md)
- [不用再学ai了！生成结果包稳的agent来了](../ch03/045-agent.md)
