...
## 与 vault 知识关联
- [Agent Harness 架构](ch03/035-agent.html) — Agent 与企业软件的交互层，Harness 是 Agent 执行时的"护城河"
...
- [Agent Memory 模块化框架](ch03/035-agent.html) — 数据排放（data exhaust）与记忆系统的关系
...
- [meet customers where they are: agentforce contact center now](ch03/035-agent.html)
