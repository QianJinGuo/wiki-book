...
- [Agentic Overlays](ch04/610-agentic.html) — 另一种 agent 化路径：REST 服务的 A2A overlay
...
- [Agent Harnesses Are Dead](ch04/679-agent-harnesses-are-dead-long-live-agent-harnesses.html) — Agent Harness 架构演进
