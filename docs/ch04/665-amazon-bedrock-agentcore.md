...
## Ch04.665 Amazon Bedrock AgentCore: 知识扩展与持续学习新能力
...
## 与现有 [AgentCore Harness](ch04/299-agentcore-managed-harness.html) 实体的差异化
...
- [Agentcore Managed Harness](ch04/299-agentcore-managed-harness.html) — 前篇：Harness 编排框架
- [Agentcore Harness](ch04/782-agentcore-harness.html) — 同期：其他 AgentCore 工程实践
- [Agentcore Payments X402 Agentic Commerce](../ch11/073-agentcore-payments.html) — 同期：x402 商业化
