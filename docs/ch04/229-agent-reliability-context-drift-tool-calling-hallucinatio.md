...
## Ch04.229 Agent Reliability: Context Drift & Tool Calling Hallucination
...
## 与 vault 知识关联
- [Agent Harness 架构](../ch05/043-agent-harness.html) — Context Manager 处理上下文；工具调用校验是 Harness 层的职责
- [Ralph Loop + Harness Takeover](../ch05/080-harness.html) — 长周期 Agent 的可靠性机制，与本文上下文漂移问题高度相关
...
- [Agent Harness 上下文管理：工作集视角](../ch05/043-agent-harness.html)
...
- [CLI、MCP、API 选型：Agent 接入层决策指南](../ch03/006-agent.html)
...
- [柚漫剧 AI 全流程提效拆解](../ch05/113-ai.html)
