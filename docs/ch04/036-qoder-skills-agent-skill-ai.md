...
## Ch04.036 Qoder Skills 完全指南 + Agent Skill 迭代式编写 — AI 按你的标准执行
...
- [从 0 到 1 教你写 Agent Skill，让 AI 懂你的"潜规则"](ch04/265-agent-skill.html)（同主题不同 MP — 实操指引）
- [Anthropic 14 个 Agent Skills 设计模式](ch04/252-anthropic-agent.html)
- [Agent Skill 设计模式](ch04/382-agent-skills.html)（Anthropic → Google 演进）
...
- [AI 行业就业八大变化（腾讯研究院纵向对比）](../ch05/079-ai.html)
...
- [Garry Tan](../ch01/631-garry-tan.html)
- [Agent Workflows](ch04/340-agent-workflows.html)
...
- [Skillx Zhejiang University](../ch07/048-skillx.html)
...
- [qoder 团队知识引擎](../ch01/818-qoder.html)
