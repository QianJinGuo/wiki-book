...
## Ch04.286 Stripe Financial Compliance AI Agent: Production Lessons
...
- [Agent Harness Architecture Deep Dive Aksahy](ch04/503-agent.md) — Agent Harness 通用架构深度分析
- [17 Agent Architectures Evolution](ch04/503-agent.md) — 17 种 Agent 架构演化全景
