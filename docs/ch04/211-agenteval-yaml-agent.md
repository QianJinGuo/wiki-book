...
## Ch04.211 AgentEval：YAML驱动的Agent评测框架
...
## 相关实体
- [Anthropic Generator-Evaluator Harness](../ch01/1215-anthropic.html) — 另一种评测闭环思路
- [Superpowers](../ch01/705-claude-code-skills-superpowers.html) — Agent 工作流规范
- [Skill Writing Patterns](ch04/340-skill.html) — Skill 质量评估相关
