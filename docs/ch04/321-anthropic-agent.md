...
## Ch04.321 Anthropic 上线「做梦」功能，让 Agent 越睡越聪明
...
这本质上是数据随时间污染的问题，需要像 Dreaming 这样的异步后处理机制来解决。.md]^[].md]
...
→ [[raw/articles/anthropic-dreaming-claude-managed-agents-ovZ5v7jJkqDKSu9xmxwt8w.md|原文存档].md]
