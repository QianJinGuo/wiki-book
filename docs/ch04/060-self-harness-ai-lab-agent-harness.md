...
## Ch04.060 Self-Harness：上海AI Lab 提出的 Agent 自我改进 Harness 范式
...
- [SGLang](ch04/558-agent-assisted-sglang-ai-llm.html) — Qwen3.5 部署用到的推理引擎
- [DeepAgent 架构演进](../ch03/045-agent.html) — 初始 Harness 基于 DeepAgent SDK
- [ByteDance TRAE Harness Engineering Guide](../ch01/656-trae-harness-engineering.html)
