...
## Ch04.255 精选 8 个 UI 设计师必备的 AI 智能体技能（Agent Skills）

> 📊 Level ⭐⭐ | 11.8KB | `entities/精选-8-个-ui-设计师必备的-ai-智能体技能agent-skills.md`
...
→ [frontend-design 实体对比](../ch01/967-skills-anthropic-openai-comparison-frontend-design.html)
→ [开发者技能清单](ch04/487-agent-skills.html)
