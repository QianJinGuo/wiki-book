...
## 相关概念
- [Factory Mission](../ch01/1232-factory-mission-multi-agent-architecture.html) — 同为 Agent Loop 架构，但 Mission 侧重多 Agent 编排，易点天下侧重企业级单 Agent 深度工程
---
*Last updated: 2026-05-08*
*评审：Value 8 × Confidence 7 = 56 | ★★★★ | STRONG PASS*

## 相关实体
- [Agentic AI for Subsurface Engineering Simulation (NVIDIA)](ch04/373-nvidia-agentic-ai-subsurface-engineering.html)
