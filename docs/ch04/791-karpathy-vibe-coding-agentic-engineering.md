...
## Ch04.791 Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering

> 📊 Level ⭐⭐⭐ | 10.0KB | `entities/karpathy-vibe-coding-agentic-engineering-v2.md`
...
## 关联条目
- [同主题入库（宝玉解读、不同角度）](ch04/724-agentic.html)
- [Harness Engineering — Agent 工程化落地的实践体系](../ch05/092-harness-engineering.html)
