...
## Ch04.511 AI Agent Skill 系统设计：淘宝技术工程实践
...
- [Skill 设计模式](ch04/338-skill.html) — **互补**：设计模式讲 Skill 内部结构组织（线性/Tool Wrapper/Generator 等），本文讲 Skill 的工程过程（创建/验证/门控/适配）
...
- [Perplexity 内部 Skill 设计指南](ch04/338-skill.html) — Perplexity 的四维评价体系与本文的验证方法论可对照
