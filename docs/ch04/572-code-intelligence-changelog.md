...
## Ch04.572 Code Intelligence – Changelog
...
- [Is Software Losing Its Head](../ch01/1167-is-software-losing-its-head.html)
- [Engineering Roles Shift From Developing Code To Managing Ai](../ch05/084-engineering-roles-shift-from-developing-code-to-managing-ai.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/code-intelligence-changelog-1.md)- [linear code intelligence: controlled codebase access for lin](../ch01/1100-20.html)
