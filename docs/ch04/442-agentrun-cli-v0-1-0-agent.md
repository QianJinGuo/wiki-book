...
## Ch04.442 AgentRun CLI v0.1.0 正式开源：一行命令运行您的托管 Agent
...
## 相关实体
- [Hermes Agent Kanban Deep Test By Wjjagi 2026](../ch03/099-hermes-agent.html)
- [深势科技携手阿里云 Agentrun加速科研 Ai Agent 全速运行](ch04/684-ai-agent.html)
- [Minimal Cli Agent 250 Line Python Ollama 7 Stages](ch04/494-python.html)
- [Aliyun Agentrun 5Min Quickstart](ch04/005-agentrun.html)
