...
## Ch04.569 浏览器 Agent 的失忆问题：Autobrowse 如何让每次探索变成永久技能
...
- [浏览器 agent 的失忆问题：autobrowse 如何让每次探索变成永久技能](../ch07/038-autobrowse-browserbase-persistent-skill.html)
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/autobrowse-browser-agent-persistent-skills-sense-ai.md)
