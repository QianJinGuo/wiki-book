...
## Ch04.472 Amazon Bedrock AgentCore: 知识扩展与持续学习新能力
...
## 与现有 [AgentCore Harness](ch04/210-agentcore-managed-harness.md) 实体的差异化
...
- [Agentcore Managed Harness](ch04/210-agentcore-managed-harness.md) — 前篇：Harness 编排框架
