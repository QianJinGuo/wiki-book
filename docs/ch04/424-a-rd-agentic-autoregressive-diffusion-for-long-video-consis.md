...
## Ch04.424 A²RD: Agentic Autoregressive Diffusion for Long Video Consistency
...
- [A²RD: Agentic Autoregressive Diffusion for Long Video Consistency](ch04/503-agent.md)
- [The UI is dead, long live the agent: ServiceNow goes headless and opens its platform](ch04/503-agent.md)
- [Extreme Co-Design for Agentic Systems Complexity (NVIDIA)](ch04/041-nvidia-extreme-co-design-agentic-systems.md)
