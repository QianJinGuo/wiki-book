...
- [amazon-bedrock-agentcore-runtime-deep-dive-and-scenario-analysis](ch04/518-amazon-bedrock-agentcore.html) — 同 Bedrock agent 体系（AgentCore runtime vs Strands Agents）
...
- [agentops-operationalize-agentic-ai-amazon-bedrock](../ch11/154-amazon-bedrock.html) — Bedrock 上 agent 的 production 化
...
- [Amazon Bedrock Agentcore Runtime Deep Dive And Scenario Analysis](ch04/518-amazon-bedrock-agentcore.html) — 同为 Bedrock agent 体系，AgentCore runtime vs Strands Agents 的技术选型对比
...
- [Agentops Operationalize Agentic Ai Amazon Bedrock](../ch11/154-amazon-bedrock.html) — Bedrock 上 agent 的 production 化路径，包含监控 / 审计 / 部署最佳实践
