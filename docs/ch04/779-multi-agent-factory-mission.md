...
## Ch04.779 Multi-Agent 架构：Factory Mission 系统的方法论
...
- [Factory Missions Multi-Agent Shipping](ch04/220-factory-missions.html)——同主题的姊妹篇
...
- [Claude Managed Agents 企业自托管](ch04/614-claude-managed-agents.html)——Multi-Agent 的企业部署形态
