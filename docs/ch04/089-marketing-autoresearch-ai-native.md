...
|----|------|------------|
| 第 1-2 期 | (背景调研)| 待补充 |
| **第 3 期** | **7×24 Self-Healing Pipeline + Agent 自进化** (研发生产线) | [Gaode Ai Native 7X24 Pipeline Self Healing](ch05/094-ai.html) (30KB) |
...
### 与 [高德 AI Companion Agent 架构](ch05/094-ai.html) 的层级关系
...
这是 [高德 SDD Harness 团队 AI 编码范式](ch05/094-ai.html) 的**业务侧对应**——SDD 关注"代码的正确性"，AutoResearch 关注"决策的正确性"。
...
- vs [高德 7x24 Self-Healing Pipeline](ch05/094-ai.html) — 同公司研发线，本文是营销业务线
- vs [高德 AI Companion Agent](ch05/094-ai.html) — C 端用户交互，本文是 B 端业务托管
...
## 相关实体
- [Autoresearch Marketing Growth Amap Ai Native](ch05/094-ai.html)
