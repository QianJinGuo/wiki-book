...
## Ch04.458 从 Anthropic 到 Google：Agent Skills 正在进入\"设计模式\"阶段
...
- [Anthropic Google Agent Skills Design Patterns](ch04/352-anthropic-google-agent-skills.md)
- [Anthropic 14 Skill Patterns Best Practices](../ch01/371-anthropic-14-skill.md)
- [Anthropic 官方技能最佳实践14 个可复用的 Agent Skills 设计模式](ch04/375-agent-skills.md)
- [Anthropic Agent Skills Design Patterns 14](ch04/247-anthropic-agent.md)

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/从-anthropic-到-googleagent-skills-正在进入设计模式阶段.md)
- [nature | anthropic：蒸馏过程潜意识传递行为偏好](ch04/229-ai.md)
