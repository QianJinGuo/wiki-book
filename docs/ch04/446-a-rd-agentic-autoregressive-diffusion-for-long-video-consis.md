...
## Ch04.446 A²RD: Agentic Autoregressive Diffusion for Long Video Consistency
...
- [A²RD: Agentic Autoregressive Diffusion for Long Video Consistency](ch03/044-agent.md)
- [The UI is dead, long live the agent: ServiceNow goes headless and opens its platform](ch03/044-agent.md)
- [Extreme Co-Design for Agentic Systems Complexity (NVIDIA)](ch04/042-nvidia-extreme-co-design-agentic-systems.md)
