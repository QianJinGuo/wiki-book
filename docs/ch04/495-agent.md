...
- [Harness Engineering 框架](../ch05/057-harness-engineering.html) — Agent 运行底座的系统性方法论
- [上下文工作集管理](../ch05/063-agent-harness.html) — 上下文作为运行时工作集的具体实践
- [Harness 正在成为新后端](../ch05/017-harness.html) — 从后端视角看 Agent 作为新调用方
