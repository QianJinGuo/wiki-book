...
## Ch04.387 Hands-free first notice of loss: Using Strands Agents and Amazon Bedrock AgentCore Browser Tool for intelligent claims intake
...
- [Build An Ai Powered Equipment Repair Assistant Using Amazon ](ch04/230-build-an-ai-powered-equipment-repair-assistant-using-amazon.html) — AgentCore + Knowledge Base 的维修助手
- [Building Web Search Enabled Agents With Strands And Exa](ch04/471-building-web-search-enabled-agents-with-strands-and-exa.html) — Strands SDK 搜索 Agent
...
- [Agentcore Harness](ch04/690-agentcore-harness.html) — AgentCore 工程化
- [Aws Bedrock Agentcore Doris Mcp Server](../ch11/272-aws-bedrock-agentcore.html) — AgentCore + MCP Server
