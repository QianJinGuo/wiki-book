...
## Ch04.649 在数据所在处构建 Agent: CrewAI + Snowflake 企业级 Agent 部署
...
- [Agent 安全三步序列](../ch05/018-harness.html) 聚焦安全，本文聚焦数据所在处的 Agent 构建
...
- [Agentium Agent 框架](../ch01/1212-agentium-agent.html)
- [Snowflake Agentic Enterprise Summit](ch04/612-agentic.html)
