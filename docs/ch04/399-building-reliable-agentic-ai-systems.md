...
## Ch04.399 Building Reliable Agentic AI Systems
...
- [AWS DevOps Agent](https://github.com/QianJinGuo/wiki-public/blob/main/entities/aws-devops-agent-autonomous-incident-resolution-datadog.md) — 另一个生产级多 Agent 系统案例
- [When I Reject AI Code](https://github.com/QianJinGuo/wiki-public/blob/main/entities/when-i-reject-ai-code-even-if-it-works-vinibrasil.md) — 同样关注 AI 系统的工程可靠性
