...
## Ch04.115 Rein：4 模块 + 5 类型边界防止 agent.go 膨胀到 3000 行
...
### vs PilotDeck 白盒记忆（[Pilotdeck Agent Os Openbmb Tsinghua](../ch03/019-agent.html)）
...
- [PilotDeck](../ch03/019-agent.html) —— 白盒记忆
- [Agent Harness 架构](../ch05/043-agent-harness.html) —— 7 层 harness 模型
- [17 种 agent 架构演进](ch04/806-17-agent.html) —— 类型边界视角
- [Agent 工程原则](../ch03/019-agent.html) —— 模块化设计实践
- [短期记忆压缩](../ch06/009-tencentdb-agent-memory.html) —— 投影压缩对比
