...
## Ch04.232 Kipi: Open-source OSINT Investigation Platform with Autonomous Agent
...
这与 [Claude Code 的动态工作流](../ch09/069-claude-code-dynamic-workflows.html) 有相似的架构模式：LLM 做决策，工具做执行，人类做监督。
...
这与 [SchemaFlow](../ch01/316-openai.html) 的思路互补：SchemaFlow 将 LLM 约束在数据库 schema 中，kipi 将 LLM 约束在图结构中。
...
- 证据分级系统仍需人工校准
- 与 [prompt injection](../ch01/473-github.html) 相关的安全风险：Agent 处理的网页内容可能包含恶意指令
...
- [Role Confusion](../ch01/473-github.html) — Prompt injection 理论
