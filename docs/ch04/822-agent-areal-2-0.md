...
## Ch04.822 Agent的自演进，被刚刚开源的AReaL 2.0按下了加速键
...
- [Agent自我改进循环](../ch05/091-harness.html) — Agent 通过运行轨迹持续优化的核心理念
- [Hermes Agent](../ch03/099-hermes-agent.html) — AReaL 2.0 的 Hermes 接入范例
- [Claude Code 架构分析](../ch03/085-claude-code.html) — Claude Code 的 Agent RL 训练范例
- [Agent落地真相](../ch03/006-agent.html) — Agent 从演示到投产的挑战
- [Harness Engineering](../ch05/050-harness-engineering.html) — Agent 控制平面的系统方法论
