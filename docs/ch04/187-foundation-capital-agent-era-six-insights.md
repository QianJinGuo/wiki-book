...
## Ch04.187 Foundation Capital Agent Era Six Insights
...
- [Factory Mission](../ch01/1230-factory-mission-multi-agent-architecture.html) — 多 Agent 协作框架 vs. Foundation Capital 的 Agent 主用户原则相互印证
