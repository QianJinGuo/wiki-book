...
## 与现有 Wiki 的关联
与 [Hermes Agent Deep Dive](../ch03/066-hermes-agent.html) 互补：Hermes Agent 的 Skill 提炼和 nudging 在本文有更系统化的分类定位。
...
- [Memento-Skills — 技能外部记忆让 Agent 自进化（arXiv 2603.18743）](315-memento-skills-agent.html)
- [AI Coding Agent 记忆系统](260-ai-coding-agent.html)
...
- [Agent Memory 架构解析](097-agent-memory.html)
...
- [Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](096-karpathy-vibe-coding-agentic-engineering.html)
- [深度解析 OpenClaw 在 Prompt / Context / Harness 三个维度中的设计哲学与实践](180-openclaw.html)
...
- [SkillClaw](343-skillclaw-nacos-agent-skill-registry.html)
...
- [Chatgpt Dreaming V3 Long Term Memory Openai](../ch01/286-openai.html)
- [llm 自我提升系统综述 — yang 等 113 页四阶段闭环框架（zesearch nlp lab）](../ch01/422-llm.html)
- [recursive first steps toward automated ai research：sota 三基准自](052-ai.html)
...
- 这与 [Foundation Capital agent era](136-foundation-capital-agent-era-six-insights.html) 中"infra 厂商抢应用层 IP"的趋势一致，**但 OpenAI 反向操作：放弃应用层 IP 换生产方法论**——是更上游的卡位
...
- **生产方法论 > 应用层 IP**：OpenAI 放弃 Tax AI IP 换范式，是把"自我改进工程"作为下一代护城河，与 [Harness Engineering 长程任务](../ch05/026-harness-engineering.html) 中"Big Harness > Big Model"的判断完全一致
