...
- **Skill Loop**: 把 procedure 编码为 SKILL.md 改变未来执行(与 [Hermes Skill System](ch04/258-skill.md) 同源)
...
- **Skill Loop** 与 [Hermes Skill System](ch04/258-skill.md) 直接对应 — Hermes 技能系统
