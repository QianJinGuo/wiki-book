...
## Ch04.239 火山引擎发布 Agentic 全栈数据管理服务
...
- [Backend for Agent](../ch03/035-agent.html) — 面向 Agent 的后端架构设计
- [AI 原生企业转型](../ch05/018-ai-native.html) — 数据基础设施转型的组织视角
- [Agent Harness 钉钉招聘](../ch05/057-agent-harness.html) — Agent 生产部署实践
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/火山引擎-agentic-全栈数据管理服务-2026.md)
