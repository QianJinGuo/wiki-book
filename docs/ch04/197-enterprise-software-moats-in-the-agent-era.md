...
## Ch04.197 Enterprise Software Moats in the Agent Era — 系统性护城河分析框架
...
## 与 vault 知识关联
- [Agent Harness 架构](../ch05/039-agent-harness.html) — Agent 与企业软件的交互层，Harness 是 Agent 执行时的"护城河"
...
- [Agent Memory 模块化框架](ch04/099-agent-memory.html) — 数据排放（data exhaust）与记忆系统的关系
- [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/salesforce-headless-software-losing-head-a16z.md)
...
- [from](../ch01/317-from-system-of-record-to-system-of-intelligence.html)
- [From System Of Record To System Of Intelligence](../ch01/317-from-system-of-record-to-system-of-intelligence.html)
- [meet customers where they are: agentforce contact center now](ch04/577-meet-customers-where-they-are-agentforce-contact-center-now.html)
