...
## Ch04.286 Anthropic 长时运行 Agent 架构：对抗式设计 + 合同谈判 + 审美量化
...
## 关联
- [Anthropic Long Running Agent Architecture 6H Retroforge](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/anthropic-long-running-agent-architecture-6h-retroforge.md) — 原始文章存档
...
- [LBS-IntentBench — 首个真实出行隐式意图评测基准](ch04/275-lbs-intentbench.html)
...
- [claude opus 4.8: the system card](../ch01/1328-claude-opus-4-8.html)
