...
## 相关概念
- [Harness Engineering](/ch05-041-harness-engineering-概念框架//) — Harness 工程框架的核心概念
- [Agent Architecture & Harness](/ch04-027-agent架构关键变化-harness正在成为新后端//) — Agent 架构与 Harness 的关系
- [Open-Claw Tool 消息总线](/ch01-157-800行代码实现-open-claw-的-tool-消息总线-子agent管理架构//) — 子 Agent 管理架构实践
...
- [Harness不是目的，知识才是护城河 —— 一个AI工程交付团队的知识沉淀实践](/ch05-027-harness不是目的-知识才是护城河-一个ai工程交付团队的知识沉淀实践//)- [Harness不是目的，知识才是护城河 —— 一个AI工程交付团队的知识沉淀实践](/ch05-078-harness不是目的-知识才是护城河-一个ai工程交付团队的知识沉淀实践//)
