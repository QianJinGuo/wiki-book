...
- [Agent 工具研究](../ch03/006-agent.html) — 工具与 agent 能力的实证关系
- [采用 AI coding agent 的六个教训](ch04/410-ai-coding-agent.html) — coding agent 实际能力边界的并行证据
- [Agentic RL 框架实践](ch04/315-agentic-rl.html) — 长时域 agent 行为的另一视角
