...
- [Harness Engineering](ch05/129-harness-engineering.html)（Harness 工程方法论）
...
- [Agent Harness 12 组件与 7 个关键决策](ch03/035-agent.html)
- [Agent架构关键变化：Harness正在成为新后端](ch03/035-agent.html)
...
- [AI Native 时代 —— 研发组织何去何从](ch05/100-ai.html)
...
- [Agent Harness 解析：智能体架构深度拆解](ch03/035-agent.html)
