...
- [Build An Ai Powered Equipment Repair Assistant Using Amazon ](ch04/231-build-an-ai-powered-equipment-repair-assistant-using-amazon.html) — AgentCore + Knowledge Base 的维修助手
- [Building Web Search Enabled Agents With Strands And Exa](ch04/459-building-web-search-enabled-agents-with-strands-and-exa.html) — Strands SDK 搜索 Agent
...
- [Agentcore Harness](ch04/679-agentcore-harness.html) — AgentCore 工程化
