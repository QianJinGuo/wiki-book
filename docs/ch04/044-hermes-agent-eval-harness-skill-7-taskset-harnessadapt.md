...
| [Skillopt Microsoft Train Skill Like Neural Network](ch04/271-skill.html) | **SkillOpt 产品视角** | 别再手写 Skill！像神经网络一样训练（58 行）：SkillOpt 产品介绍 |
| [Skillopt Microsoft Train Skill Hyman'S Blog](ch04/271-skill.html) | **SkillOpt Hyman 视角** | 微软等 SkillOpt 解读（64 行） |
| [Hermes Agent Skill Crossover Optimization](ch04/271-skill.html) | **Hermes Skill 互优化** | SkillEvolver × Darwin × EmbodiSkill 4 轮闭环（277 行）— Skill 之间的相互优化 |
...
| [Pith Train Agent Native Moe Training Framework](ch05/094-ai.html) | **Pith 训练框架** | Agent 原生 MoE 训练 |
...
| [Harness Engineering 7 Layers Openclaw Hermes Claude Code P1Anu](ch03/077-claude-code.html) | **7 层 Harness** | OpenClaw/Hermes/Claude Code 7 层 Harness |
| [Slim Cuhk Skill Lifecycle Agentic Rl](ch04/271-skill.html) | **SLIM Skill 生命周期** | CUHK SLIM Skill 生命周期 + Agentic RL |
