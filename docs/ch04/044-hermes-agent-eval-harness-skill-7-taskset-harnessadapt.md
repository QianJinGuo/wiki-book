...
## Ch04.044 Hermes Agent Eval Harness：可验证 Skill 进化的 7 模块闭环（TaskSet/HarnessAdapter/TrajectoryStore/Verifier/Selection Gate/Regression Gate/Report & Replay + 6 类 Verifier + 3 类 Regression + 6 阶段落地路径）
...
| [Hermes Agent Skill Crossover Optimization](../ch01/387-hermes-agent-skill.md) | **Hermes Skill 互优化** | SkillEvolver × Darwin × EmbodiSkill 4 轮闭环（277 行）— Skill 之间的相互优化 |
...
| [Ai Recursive Self Improvement Nanogpt Prime Intellect](ch04/229-ai.md) | **递归自改进** | nanogpt + Prime Intellect |
...
| [Slim Cuhk Skill Lifecycle Agentic Rl](ch04/507-agentic-rl.md) | **SLIM Skill 生命周期** | CUHK SLIM Skill 生命周期 + Agentic RL |
