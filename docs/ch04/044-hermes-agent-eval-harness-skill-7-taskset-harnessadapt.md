...
| [Skillopt Microsoft Train Skill Like Neural Network](ch04/258-skill.md) | **SkillOpt 产品视角** | 别再手写 Skill！像神经网络一样训练（58 行）：SkillOpt 产品介绍 |
| [Skillopt Microsoft Train Skill Hyman'S Blog](ch04/258-skill.md) | **SkillOpt Hyman 视角** | 微软等 SkillOpt 解读（64 行） |
| [Hermes Agent Skill Crossover Optimization](ch04/258-skill.md) | **Hermes Skill 互优化** | SkillEvolver × Darwin × EmbodiSkill 4 轮闭环（277 行）— Skill 之间的相互优化 |
| [Skill Self Evolution Three Approaches](ch04/258-skill.md) | **Skill 自进化 3 路线** | Trace2Skill 归纳法 / EvoSkill 验证闭环 / SkillOpt 训练范式（45 行）；本文是 SkillOpt + EvoSkill 的工程化展开 |
| [Agent Self Improvement Six Mechanisms](ch03/045-agent.md) | **6 大自改进机制** | Agent 自改进的 6 大机制 |
| [Ai Recursive Self Improvement Nanogpt Prime Intellect](ch04/069-ai.md) | **递归自改进** | nanogpt + Prime Intellect |
| [Darwin Skill 2 Huashu](ch04/258-skill.md) | **Darwin Skill 2** | Darwin Skill 进化 |
| [Embabel](ch07/020-embabel.md) | **Embabel** | Embabel 自进化框架 |
| [Pith Train Agent Native Moe Training Framework](ch04/069-ai.md) | **Pith 训练框架** | Agent 原生 MoE 训练 |
...
| [Slim Cuhk Skill Lifecycle Agentic Rl](ch04/258-skill.md) | **SLIM Skill 生命周期** | CUHK SLIM Skill 生命周期 + Agentic RL |
| [Deli Auto Research Skill V2 Continual Learning Self Improvement](ch04/258-skill.md) | **Deli Auto Research** | Continual learning + self-improvement |
