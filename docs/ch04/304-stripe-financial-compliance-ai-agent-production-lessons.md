...
- [Agent Harness Architecture Deep Dive Aksahy](../ch05/038-agent-harness.html) — Agent Harness 通用架构深度分析
- [17 Agent Architectures Evolution](ch04/606-17-agent.html) — 17 种 Agent 架构演化全景
