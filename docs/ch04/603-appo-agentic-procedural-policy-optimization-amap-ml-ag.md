...
## 相关实体
- [Agentic RL: Token-In Token-Out Done Right](ch04/567-agentic-rl-token-in-token-out-done-right.md)（相关：Token-In/Token-Out RL 训练框架，但 APPO 进一步细化到决策点）
- [港中文 SLIM：动态技能生命周期管理](ch04/509-agentic-rl.md)（相关：另一条 Agentic RL 主线——技能生命周期管理）
- [高德 Harness/SDD 体系](../ch05/082-ai-coding.md)（同公司高德不同主题：SDD 体系 vs Agentic RL）
- [Harness Engineering 综述](../ch05/062-harness-engineering.md)（相关：APPO 是 Agentic RL 的"过程工程化"）
...
- [高德路线规划双路线：mobilitybench（agent 基准）+ transitlm（端到端 rllm）](../ch01/911-20.md)
