...
## Ch04.305 Agent/Skills/Teams 架构演进过程及技术选型之道
...
- 补充 [Hermes Agent 深度解析](ch03/035-agent.html)的 Multi-Agent 协作部分（Google 论文 5 条结论）
...
- [Autoresearch Next Phase Async Multi Agent Ai寒武纪](ch05/100-ai.html)
