...
本页作为知识图谱锚点，连接了以下关键实体：[后端架构 AI Friendly 的标准与路径：面向无人值守开发时代的系统重构](ch04/150-ai.md)。 相关主题通过 [Agent架构关键变化：Harness正在成为新后端](ch03/045-agent.md) 延伸。
...
- [后端架构 AI Friendly 的标准与路径：面向无人值守开发时代的系统重构](ch04/150-ai.md)
- [Agent架构关键变化：Harness正在成为新后端](ch03/045-agent.md)
- [AI 友好架构设计](ch04/150-ai.md)
