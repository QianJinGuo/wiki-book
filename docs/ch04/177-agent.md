...
| **学习层**（进化） | 自我进化 | 经验沉淀、Skills 版本化、可审计的回滚 | [Small Hermes 自我进化架构](ch04/754-self-evolving-agent.html) |
...
参考：[Agent Harness Engineering Survey](../ch05/126-harness-engineering.html) 中的 ETCLOVG 治理维度。
...
[17种Agent架构](ch04/758-17-agent.html)的演化史本质上是三条路线在不同历史阶段的不同侧重：
