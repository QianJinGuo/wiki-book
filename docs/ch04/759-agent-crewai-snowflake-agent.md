...
## Ch04.759 在数据所在处构建 Agent: CrewAI + Snowflake 企业级 Agent 部署
...
- [Agent 数据治理模式](../ch03/037-agent.html) 聚焦数据库凭证安全，本文聚焦企业级构建吞吐量和 Snowflake 集成
- [CrewAI 小步快跑](../ch03/037-agent.html) 聚焦开发方法论，本文聚焦数据治理和平台集成
...
- [Agentium Agent 框架](../ch01/1451-agentium-agent.html)
- [Snowflake Agentic Enterprise Summit](ch04/724-agentic.html)
