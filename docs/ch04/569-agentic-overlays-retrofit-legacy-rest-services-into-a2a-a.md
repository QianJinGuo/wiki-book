...
- [Agentic AI Data Mesh](ch04/677-agentic-ai.html) — 另一种 agent 化路径：data mesh 的 MCP 暴露
...
- [Agent Harnesses Are Dead](ch04/794-agent-harnesses-are-dead-long-live-agent-harnesses.html) — Agent Harness 架构演进讨论
