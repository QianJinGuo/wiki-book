...
- **解决方案**：搭配 MemOS 插件（见 [MemOS 记忆插件](https://github.com/QianJinGuo/wiki-public/blob/main/entities/memos-hermes-plugin.md)）
...
## Related
- [Hermes-Agent 自进化机制](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/hermes-agent.md) — Skill 生成 + RL 训练双路径详解
- [原始调研存档](https://mp.weixin.qq.com/s/2xFei8dMx99lc-iyrZZrww)
...
- [从Vibe Coding到Agentic Engineering：重构后台开发全流程 — 腾讯技术工程](299-tencent-vibe-coding-to-agentic-engineering-backend.html)
