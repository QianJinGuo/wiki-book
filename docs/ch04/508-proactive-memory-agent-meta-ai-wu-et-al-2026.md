...
## Ch04.508 Proactive Memory Agent — Meta AI (Wu et al. 2026)
...
- [AGENT MEMORY MODULAR FRAMEWORK](ch04/099-agent-memory.html) 和 [Agent Memory Architecture](ch04/409-perplexity-brain-self-improving-agent-memory-architecture.html) 主要关注记忆存储的层次化结构，而这篇论文聚焦于记忆的 **主动干预时机**；
...
- [Agentic RL Frameworks Long-Horizon Wolfe 2026](ch04/425-agentic-rl.html)
