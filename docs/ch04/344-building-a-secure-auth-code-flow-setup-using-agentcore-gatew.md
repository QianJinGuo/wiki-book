...
## Ch04.344 Building a secure auth code flow setup using AgentCore Gateway with MCP clients
...
- [Spec Review Agent Baz Bedrock Agentcore Multi Agent](../ch11/059-bedrock-agentcore.html)
