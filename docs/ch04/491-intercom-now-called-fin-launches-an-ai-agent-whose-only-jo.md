...
## Ch04.491 Intercom, now called Fin, launches an AI agent whose only job is managing another AI agent
...
- 来源：venturebeat
## 相关实体
- [Opensquilla Launches Open Source Ai Agent To Cut Token Costs](ch04/784-opensquilla-launches-open-source-ai-agent-to-cut-token-costs.html)
