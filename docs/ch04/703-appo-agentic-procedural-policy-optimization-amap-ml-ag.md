...
## Ch04.703 APPO (Agentic Procedural Policy Optimization)：阿里高德 AMAP-ML 把 Agent RL 信用分配细化到每个决策点
...
- [港中文 SLIM：动态技能生命周期管理](ch04/271-skill.html)（相关：另一条 Agentic RL 主线——技能生命周期管理）
- [高德 Harness/SDD 体系](ch05/094-ai.html)（同公司高德不同主题：SDD 体系 vs Agentic RL）
- [Harness Engineering 综述](ch03/035-agent.html)（相关：APPO 是 Agentic RL 的"过程工程化"）
