...
## Ch04.348 Spec-Kit vs BMAD：AI 原生 SDD 双框架实战对比（叶小钗重构迁移案例）
...
| **OpenSpec** | 轻量级规格变更 | proposal(范围/边界锁定) + design + tasks + specs(ADDED/MODIFIED/REMOVED 增量化)，已有 [Openspec Spec Driven Development Trae Solo](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openspec-spec-driven-development-trae-solo.md) 实体 |
...
- [Openspec Spec Driven Development Trae Solo](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openspec-spec-driven-development-trae-solo.md) — Trae IDE 内置的 OpenSpec 框架（proposal/design/tasks/specs 四类文档）。本实体是**外部 SDD 工具对比**（Spec-Kit/BMAD），那个是**集成 IDE 的 SDD 工具**；形成"独立工具谱系 ↔ IDE 集成 SDD"对照。
...
- 多 Agent 圆桌协作 — [Openclaw Multi Agent Team Practice V2](455-openclaw-multi-agent-team-practice-v2.html)
