...
## Ch04.468 Hands-free first notice of loss: Using Strands Agents and Amazon Bedrock AgentCore Browser Tool for intelligent claims intake
...
- [Building Web Search Enabled Agents With Strands And Exa](ch04/559-building-web-search-enabled-agents-with-strands-and-exa.html) — Strands SDK 搜索 Agent
...
- [Agentcore Harness](ch04/763-agentcore-harness.html) — AgentCore 工程化
