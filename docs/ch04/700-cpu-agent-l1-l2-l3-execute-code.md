...
### 与 [Anthropic 工具数量陷阱](ch05/094-ai.html) 的对比
...
- [AI Agent 工具数量陷阱](ch05/094-ai.html) — "5-10 工具"是 Anthropic 答案；"1 execute_code"是本文答案（更激进的同向论述）
...
- [上下文工程系列](ch05/094-ai.html) — 系列化上下文工程讨论
