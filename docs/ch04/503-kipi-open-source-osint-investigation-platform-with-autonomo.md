...
## Ch04.503 Kipi: Open-source OSINT Investigation Platform with Autonomous Agent

> 📊 Level ⭐⭐⭐⭐⭐ | 9.2KB | `entities/kipi-osint-autonomous-agent-investigation.md`
...
这与 [Claude Code 的动态工作流](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-dynamic-workflows-thariq-practical-patterns.md) 有相似的架构模式：LLM 做决策，工具做执行，人类做监督。
...
这与 [SchemaFlow](https://github.com/QianJinGuo/wiki-public/blob/main/entities/schemaflow-agentic-database-sql-generation-openai-cookbook.md) 的思路互补：SchemaFlow 将 LLM 约束在数据库 schema 中，kipi 将 LLM 约束在图结构中。
...
- 证据分级系统仍需人工校准
- 与 [prompt injection](https://github.com/QianJinGuo/wiki-public/blob/main/entities/role-confusion-github-io.md) 相关的安全风险：Agent 处理的网页内容可能包含恶意指令
...
- [Claude Code Workflows](https://github.com/QianJinGuo/wiki-public/blob/main/entities/claude-code-dynamic-workflows-thariq-practical-patterns.md) — Agent 动态工作流
- [SchemaFlow](https://github.com/QianJinGuo/wiki-public/blob/main/entities/schemaflow-agentic-database-sql-generation-openai-cookbook.md) — 结构化数据的 LLM 约束
- [Gray Swan](https://github.com/QianJinGuo/wiki-public/blob/main/entities/latent-space-p-gray-swan.md) — AI 安全与 red-teaming
- [Role Confusion](https://github.com/QianJinGuo/wiki-public/blob/main/entities/role-confusion-github-io.md) — Prompt injection 理论
