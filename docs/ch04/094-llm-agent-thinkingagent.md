...
## Ch04.094 从零设计准生产级 LLM Agent：ThinkingAgent 完整架构与可靠性体系
...
- [Skills Driven Programming Taobao Enterprise 5 Phase Evolution 2026 06 17](ch04/256-skill.md)：大淘宝 Skills 编程 — ThinkingAgent 的 Anti-Skills 立场与之形成互补视角
- [Agent Loop Engineering Handbook 8 Questions Chen Jin Tencent Self 2026](ch01/217-0.md)：Agent Loop 8 个未解问题 — ThinkingAgent 对其中多个问题给出了工程答案
