...
## Ch04.764 一文讲清 Agent 如何理解业务：把对象、状态和权限接进执行流程
...
- 与 [企业 AI Loop 落地五对象](ch04/588-ai-loop.html) 互补：本文聚焦"业务语义接入"，五对象聚焦企业落地框架
- 状态机实现见 [LangGraph State Machine](ch04/266-langgraph.html)
