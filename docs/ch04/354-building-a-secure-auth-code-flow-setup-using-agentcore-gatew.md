...
## Ch04.354 Building a secure auth code flow setup using AgentCore Gateway with MCP clients
...
- [Spec Review Agent Baz Bedrock Agentcore Multi Agent](../ch11/060-bedrock-agentcore.html)
