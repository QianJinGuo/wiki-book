...
## Ch04.720 Agent Protocol 不变层：跨框架的 6 个稳定 Runtime 对象
...
- [From Agent Protocol to Harness Skill](ch04/426-from-agent-protocol-to-harness-skill.html) — 从 MCP/A2A 协议到 Harness Skill 的演进路径，与本文的 Runtime Protocol 抽象视角不同
