...
## Ch04.328 一篇看懂 Agent Harness 的结构！ — 12组件+7决策完整框架
...
- [Langchain Anatomy Agent Harness](https://github.com/QianJinGuo/wiki-public/blob/main/entities/langchain-anatomy-agent-harness.md)
