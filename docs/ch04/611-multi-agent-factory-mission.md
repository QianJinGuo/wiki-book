...
## Ch04.611 Multi-Agent 架构：Factory Mission 系统的方法论
...
这与 [Harness Engineering Core Patterns](../ch05/092-harness-engineering.html) 中关于"声明式优先于命令式"的设计原则形成强对应——编排层应当尽量薄，复杂逻辑让模型在 prompt 中处理，这样模型升级能自动带动系统升级。
...
- [Harness Engineering Core Patterns](../ch05/092-harness-engineering.html)——声明式编排的工程哲学
- [OpenClaw 多 Agent 团队实践](ch04/046-openclaw-multi-agent-team-practice-v2.html)——多 Agent 落地的国内实践
- [Claude Managed Agents 企业自托管](ch04/616-claude-managed-agents.html)——Multi-Agent 的企业部署形态
