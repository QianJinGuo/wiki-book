...
## Ch04.542 Building effective human-agent teams
...
## 相关主题
- [Claude Code Agent Teams Architecture](../ch01/392-claude-code-agent-teams.md)
- [Sub Agent Vs Agent Team Selection Guide](ch04/110-sub-agent-vs-agent-team.md)
