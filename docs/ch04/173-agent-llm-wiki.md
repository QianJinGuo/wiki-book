...
- 高德信息业务中心系列：本文与 [高德 AI Native 数据 Agent（NL2SQL）](ch04/469-data-agent.html)（#102，v=72）同一团队不同主题——数据 Agent 解决「查数据」，内容数字员工解决「查证据」；与 [CodeWiki](../ch01/1459-codewiki-llm.html)（代码知识库）互补——CodeWiki 是「代码 Wiki」层实现，本文给出它在上层工作台中的定位（实现导航）
...
- 证据导向：[腾讯知识 Harness](../ch05/080-harness.html) 与 [skill 安全](../ch01/390-trail-of-bits-skill-scanner-bypass.html) 同为「证据优先」工程哲学的实例
