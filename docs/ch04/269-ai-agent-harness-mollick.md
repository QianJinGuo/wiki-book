...
## Ch04.269 AI Agent 时代选型指南：模型·应用· Harness（Mollick）
...
- [Co Existence Paradigm Shift Agentic Ai Mollick 2026](../ch04-181-co-existence-vs-co-intelligence-mollick-s-paradigm-shift-on/) — Mollick 2026-06 范式转换叙事（同一作者更新的 agentic 时代框架）
- [Management As Ai Superpower Mollick](../ch04-273-管理作为-ai-超级能力-mollick-的-agentic-work-delegation-方程/) — 管理作为 AI 超级能力（同一作者，同期但不同议题）
- [Gpt5 Just Does Stuff Mollick](../ch01-418-gpt-5-it-just-does-stuff-mollick-的主动式-ai-原语/) — GPT-5 "It Just Does Stuff"（同一作者，模型能力侧写）
