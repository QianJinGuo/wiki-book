...
## Ch04.246 xAI Grok：Musk 训练新一代模型

> 📊 Level ⭐⭐ | 11.9KB | `entities/xai-grok-musk-training-new-model-wechat.md`
...
## 摘要
xAI解散，但Grok还没死！马斯克声称新模型正在训练^[].md]
...
整体并入SpaceX旗下，统一品牌「SpaceXAI」。^[].md]

一句话，一家AI公司就从市场上消失了。
xAI 2023年7月成立，估值从0冲到2500亿美元只用了不到三年。^[].md]

马斯克当年绘制的蓝图很硬核：  用Grok正面打OpenAI和Anthropic  ，让最大限度追求真相的AI成为下一代标准。
然后，到了2026年5月7日，他亲手解散了xAI。^[].md]

但他在5月8日早晨告诉所有人：  xAI虽然解散，但是  ** Grok还没死  ** 。^[].md]

** xAI这家公司是怎么走到这一步的  **^[].md]

不是突然的。
按时间线倒回去看，你会发现，这件事早有苗头。^[].md]

* 2月那一步是资本结构上的并入。
* 3月底创始团队全员清零，是组织层面的瓦解。
* 5月6日只是把品牌也并掉。
xAI作为独立公司这件事，  2026年初  就开始走向终点。^[].md]

** **
** 但Grok还没死
**
5月8日早晨，马斯克发推回应Grok死亡论。^[].md]

因为xAI被解散，所以社区开始流传马斯克放弃搞AI模型，直接「加入」Claude阵营。^[].md]
...
听起来份量很重。
但Colossus 1的GPU构成是这样的——^[].md]

主体是Hopper架构的老卡——20万张Hopper，3万张Blackwell。^[].md]

这是什么概念？
GB200单卡FP8算力大约是H100的2.5倍。^[].md]

再加上NVL72机柜内联带宽的优势，整体训练效率比Hopper集群高一个量级。^[].md]

最新一代旗舰大模型——Opus 4.7、GPT-5.5、Gemini 3.1 Pro——的训练算力来源已经全面切换到Blackwell。
再用H100训练前沿模型，等于用上一代芯片打次代竞争。^[].md]

而Colossus 2不一样。
它从一开始就规划成全Blackwell架构。^[].md]

初期目标部署11万张GB200，最终目标350K GPU，配套世界最大规模的Tesla Megapack电池备份。
** Colossus 2  才是马斯克手上真正能训练前沿Grok的资产。  **^[].md]

把这一层弄清楚，5月7日那笔合作的逻辑就清晰了——^[].md]

马斯克送给Anthropic的是上一代算力。^[].md]

Hopper卡再过两三年就要面临大幅折旧，与其闲置不如租出去换战略合作权和现金流。^[].md]

而自己留下的Colossus 2，全是Blackwell主力，专门训新Grok。^[].md]

给的是上一代的，留下的是次代的。
** xAI为什么必须「死」  **
既然，马斯克还要继续在AI模型的牌桌上，为何他要解散xAI？^[].md]

把xAI解散和Colossus 1租给Anthropic拼起来看，能看到一个更完整的故事。^[].md]

xAI作为独立公司，过去两年面对四个无解的问题。^[].md]
