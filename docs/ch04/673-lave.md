...
- [Baddlm Diffusion Language Model Backdoor 2026](../ch01/872-baddlm.html) — 扩散语言模型后门攻击
- [D Opsd Diffusion Llm On Policy Self Distillation](../ch01/181-d-opsd.html) — 扩散 LLM 在线自蒸馏
- [Residual Context Diffusion Apple Ml 2026 07](../ch01/1100-20.html) — Apple 残差上下文扩散
