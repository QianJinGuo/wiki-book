...
### 与 [Anthropic 工具数量陷阱](312-ai-agent.html) 的对比
...
- [AI Agent 工具数量陷阱](312-ai-agent.html) — "5-10 工具"是 Anthropic 答案；"1 execute_code"是本文答案（更激进的同向论述）
...
- [Code as Agent Harness Survey](../ch09/044-code-as-agent-harness.html) — 编程语言作为 Agent 接口的更广义论述
