...
### 与 [Anthropic 工具数量陷阱](423-ai-agent.html) 的对比
...
- [AI Agent 工具数量陷阱](423-ai-agent.html) — "5-10 工具"是 Anthropic 答案；"1 execute_code"是本文答案（更激进的同向论述）
...
- [Codex 上下文工程 LastWhisper](../ch01/391-codex.html) — 另一家 Code 厂商的上下文视角
