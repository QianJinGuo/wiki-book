...
## Ch04.687 Microsoft Foundry 生产级 Agent 工程：Harness 与模型的等价重要性
...
## 相关实体
- [Microsoft Agent Framework Tools 总览](../ch03/036-agent.html)
- [Microsoft Build 2026：微软 AI 独立日](../ch03/036-agent.html)
