...
## Ch04.050 LangSmith Engine: Trace-Based Self-Improving Agent
...
- [Hermes Agent Operator](../ch03/093-hermes-agent.html) — "模型侧自改进"路径（定时任务把对话总结成 Skill），与本文"系统侧自改进"互补
...
- [OpenClaw 完整指南](../ch11/230-openclaw.html) — 开源 Agent 的故障处理与自我恢复机制
- [Agent 记忆系统实践](../ch03/035-agent.html) — Agent Overview 是 Memory 模块的诊断侧应用- [langchain × fireworks 100x cheaper trace judge — 通用 trace 评估](../ch05/091-ai.html)
