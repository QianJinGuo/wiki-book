...
## Ch04.547 Agentic RL 六框架实践地图：从算法到系统的长程智能体训练
...
- [港中文 SLIM：动态技能生命周期管理](ch04/547-agentic-rl.html) — Agentic RL 中的技能管理
- [LLM-as-a-Verifier](../ch01/1237-llm.html) — Agent 轨迹验证方法
