...
## Ch04.362 英伟达力荐，小团队两个月开源一款「光速级」智能体推理引擎

> 📊 Level ⭐⭐ | 8.1KB | `entities/2026-05-07-英伟达力荐-小团队两个月开源一款-光速级-智能体推理引擎-机器之心.md`
...
source: wechat
url: https://mp.weixin.qq.com/s/dx8T76mEGxbySqTH88X94g
mp_name: 机器之心
...
```mermaid
mindmap
  root(("英伟达力荐，小团队两个月开源一款「光速级」智能体推理引擎"))
    详细信息
    原文
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/2026-05-07-英伟达力荐-小团队两个月开源一款-光速级-智能体推理引擎-机器之心.md)
