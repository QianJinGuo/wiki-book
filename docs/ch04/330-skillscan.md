...
## Ch04.330 SkillScan — 智能体技能安全扫描最佳实践
...
SkillScan 与 [Agent Skill 设计模式](ch04/555-agent-skill.md) 和 [Hermes Agent 技能设计分析](../ch01/389-hermes-agent-skill.md) 形成了"设计—部署—安全"的完整闭环。具体来说：
