...
> 评分：v=6, c=7, v×c=42 → 作为 [OpenCLI](../ch03/085-opencli.html) entity 的补充
...
| **Skill Forge 流程打包** | ❌ | ❌ | ❌ | ❌ | ✅（注：与 [古法程序员 spec-as-code](../ch01/509-codex.html) 的 SKILL.md 模式重叠） |
...
把跑通的网页流程打包成 SKILL.md + 脚本，下次 Agent 直接调用。**注：与 [古法程序员 spec-as-code](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/gufabiancheng-spec-for-complex-tasks-cc-codex.md) 的 SKILL.md 模式直接重叠**——古法程序员是通用框架，BrowserAct 是网页操作特化。
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/four-browser-automation-tools-comparison.md)
→ [BrowserAct 原文存档（待验证）](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/browseract-agent-browser-execution-layer-rejected.md)
