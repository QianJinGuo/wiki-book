...
## Ch04.706 Market surveillance agent with LangGraph and Strands on AgentCore
...
本文在现有 [LangGraph 状态机](ch04/269-langgraph.html) 和 [Strands Agents](ch04/788-strands-agents.html) 知识基础上贡献了以下独特角度：
...
- [Strands Agents](ch04/788-strands-agents.html)
...
- [Evaluating AI agents production blueprint](ch04/105-ai-agent.html)
- [AgentCore Gateway MCP](ch04/658-amazon-bedrock-agentcore.html)
