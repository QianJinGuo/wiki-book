...
## Ch04.096 晓斌：从 People-Oriented 到 Agent-Oriented Infra —— 意图驱动 + 代码沉淀的进化体
...
### vs [Agent Harness 上下文管理](ch03/035-agent.html)
- 上下文管理 = 工作集视角
...
- [wow-harness v3](ch05/085-harness.html) —— 跨 session 事件时间线
- [Kimi Work](ch01/736-codex.html) —— 本地桌面 Agent
- [PilotDeck](ch03/035-agent.html) —— 多项目隔离
- [Rein](ch03/035-agent.html) —— 4 模块 + 5 类型边界
- [Microsoft Build 2026](ch05/100-ai.html) —— 全栈 AI
- [Claude Code 20000 字符源码分析](ch03/084-claude-code.html) —— 98.4% 基础设施
