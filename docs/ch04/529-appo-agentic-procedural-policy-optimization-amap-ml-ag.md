...
## Ch04.529 APPO (Agentic Procedural Policy Optimization)：阿里高德 AMAP-ML 把 Agent RL 信用分配细化到每个决策点
...
- [高德 Harness/SDD 体系](ch04/310-ai.md)（同公司高德不同主题：SDD 体系 vs Agentic RL）
