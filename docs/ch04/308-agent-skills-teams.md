...
## Ch04.308 Agent/Skills/Teams 架构演进过程及技术选型之道
...
## 与 Wiki 已有内容的关系
- 补充 [Agent 工程实践](../ch03/037-agent.html)的"架构演进路径"章节（增加量化数据）
- 补充 [Hermes Agent 深度解析](../ch03/098-hermes-agent.html)的 Multi-Agent 协作部分（Google 论文 5 条结论）
- 补充 [OpenClaw 架构解析](https://github.com/QianJinGuo/wiki/blob/main/concepts/openclaw-architecture.md)的错误放大效应数据
- 补充 [Anthropic MCP 重新定义](../ch07/017-anthropic-mcp.html)的 Skills 机制解析
---
...
- [Autoresearch Next Phase Async Multi Agent Ai寒武纪](../ch01/1091-agent-ai.html)
...
---
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/agent-skills-teams-architecture-evolution-selection-guide.md)
