...
## Ch04.278 Anthropic Acquires Stainless
...
- [Anthropic 12 个 MCP 生产模式](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic-12-mcp-production-patterns.md) — Anthropic 官方 MCP 设计模式，与收购后自营 MCP server 工具链直接相关
- [Anthropic 14 个 Skill 最佳实践](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic-14-skill-patterns-best-practices.md) — Anthropic 开发者体验体系中的另一支柱
- [Anthropic Agent 平台演进](https://github.com/QianJinGuo/wiki-public/blob/main/entities/anthropic-agent-platform-evolution-three-executives.md) — Claude Platform 与代理连接战略的宏观背景
- [CLI Agent 与 MCP Shell 模式](https://github.com/QianJinGuo/wiki-public/blob/main/entities/cli-agent-patterns-mcp-shell-agents.md) — SDK/CLI 工具链在代理场景中的落地形态
- [OpenAI 收购 AI 咨询公司](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openai-buys-ai-consultancy-enterprises.md) — 竞对收购策略对照，两种生态路线之争
