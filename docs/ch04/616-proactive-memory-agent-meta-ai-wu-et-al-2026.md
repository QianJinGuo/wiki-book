...
- [AGENT MEMORY MODULAR FRAMEWORK](ch04/179-agent-memory.html) 和 [Agent Memory Architecture](ch04/524-perplexity-brain-self-improving-agent-memory-architecture.html) 主要关注记忆存储的层次化结构，而这篇论文聚焦于记忆的 **主动干预时机**；
...
- [Self-Evolution GUI Agents Memory](../ch06/049-memory.html)
