...
- [Building web search-enabled agents with Strands and Exa](348-building-web-search-enabled-agents-with-strands-and-exa.html) — Strands Agents 工具调用模式的深度分析
- [Product Ad Review Agent with Strands SDK and Bedrock](../ch11/201-bedrock.html) — Strands SDK + Bedrock 商品审查 Agent 实践
