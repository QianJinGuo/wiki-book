...
## Ch04.040 清华浙大等开源发布SEED：自进化OPD的长程Agent强化学习训练方法
...
- 原文: [清华浙大等开源发布SEED：自进化OPD的长程Agent强化学习训练方法](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/seed-self-evolving-opd-long-horizon-agent-rl-tsinghua-zju-2026.md)
