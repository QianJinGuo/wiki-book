...
## Ch04.364 Alibaba Skill-Up：声明式 Agent Skill 评测框架
...
与 [Agent Skill 评估与迭代](ch04/612-agent-skill.html)（侧重于手动测试方法论）相比，skill-up 提供了完全自动化、CI 可集成的工程化方案。

## 相关实体

- [AgentEval：YAML驱动的Agent评测框架](../ch03/037-agent.html)
- [Agent Skill 评估与迭代](ch04/612-agent-skill.html)
- [Agent 可靠性工程：Skillify 与持续改进](ch04/349-skill.html)
- [Agent 评估系统指南](../ch03/037-agent.html)
- [SWE-bench Agent 评估](ch04/479-swe-bench-agent.html)
