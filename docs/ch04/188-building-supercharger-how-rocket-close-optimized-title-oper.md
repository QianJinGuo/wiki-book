...
- [amazon-bedrock-agentcore-runtime-deep-dive-and-scenario-analysis](ch04/502-agent.md) — 同 Bedrock agent 体系（AgentCore runtime vs Strands Agents）
...
- [agentic-payment-x402-bedrock-agentcore](ch04/502-agent.md) — 金融场景 agent 应用
...
- [Amazon Bedrock Agentcore Runtime Deep Dive And Scenario Analysis](ch04/502-agent.md) — 同为 Bedrock agent 体系，AgentCore runtime vs Strands Agents 的技术选型对比
...
- [Agentic Payment X402 Bedrock Agentcore](ch04/502-agent.md) — 金融场景 agent 应用案例，与 Rocket Close 同属金融行业 AI 落地
