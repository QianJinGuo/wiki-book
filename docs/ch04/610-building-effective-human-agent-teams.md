...
## Ch04.610 Building effective human-agent teams
...
## 相关主题
- [Claude Code Agent Teams Architecture](../ch01/334-claude-code-agent-teams.html)
- [Sub Agent Vs Agent Team Selection Guide](ch04/116-sub-agent-vs-agent-team.html)
