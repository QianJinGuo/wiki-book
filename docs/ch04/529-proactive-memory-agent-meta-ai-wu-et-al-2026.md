...
## Ch04.529 Proactive Memory Agent — Meta AI (Wu et al. 2026)
...
- [AGENT MEMORY MODULAR FRAMEWORK](ch04/121-agent-memory.html) 和 [Agent Memory Architecture](ch04/428-perplexity-brain-self-improving-agent-memory-architecture.html) 主要关注记忆存储的层次化结构，而这篇论文聚焦于记忆的 **主动干预时机**；
- [Hermes Agent Memory System](../ch03/095-hermes-agent.html) 的三层架构侧重持久化存储，论文的贡献在于何时以及如何 **注入记忆**；
...
- [Agentic RL Frameworks Long-Horizon Wolfe 2026](ch04/327-agentic-rl.html)
- [RoadmapBench Long-Horizon Benchmark](ch04/248-roadmapbench-long-horizon-agentic-software-development.html)
- [Memory Agent Systems Cobanov](ch04/601-memory-agent-systems-cobanov.html)
