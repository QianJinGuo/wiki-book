...
| Agent Harness | 推理→执行→验证闭环 | [Loop Engineering](ch05/100-ai.html) 的具身实现 |
...
与 [Loop Engineering](ch05/100-ai.html) 中的 Loop/Harness 概念高度一致，但在具身领域增加了**物理世界验证**这一不可或缺的环节（Verifier）。
...
- **具身化 Loop/Harness**：[Loop Engineering 实体](ch05/100-ai.html) 讨论了 Graph/Loop/Harness 三层概念。ABot-AgentOS 是 Loop 概念在**物理世界**的具身实现——增加了物理验证（Verifier）这一关键环节
...
- [Loop Engineering 会是 AI 的下个关键词吗？](ch05/100-ai.html) — Loop/Harness/Graph 三层概念
