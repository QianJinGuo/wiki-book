...
## Ch04.511 The UI is dead, long live the agent: ServiceNow goes headless and opens its platform
...
- [ServiceNow 同题实体：The UI is dead, long live the agent](../ch03/037-agent.html)
- [同文完整 slug 实体](ch04/388-the-ui-is-dead-long-live-the-agent-servicenow-goes-headles.html)
- [Salesforce 主动砍掉了界面（a16z）](../ch01/332-1.html)
