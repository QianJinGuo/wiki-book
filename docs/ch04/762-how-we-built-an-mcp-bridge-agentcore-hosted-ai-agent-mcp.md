...
## Ch04.762 How we built an MCP bridge: AgentCore-hosted AI agent 访问本地 MCP 工具
...
- Claude Cowork 生态：[Claude Managed Agents MCP Tunnels](ch04/614-claude-managed-agents.html) 是企业版托管隧道，本文是自托管实现
