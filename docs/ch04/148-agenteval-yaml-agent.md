...
## Ch04.148 AgentEval：YAML驱动的Agent评测框架
...
## 相关实体
- [Anthropic Generator-Evaluator Harness](ch05/009-harness.md) — 另一种评测闭环思路
- [Superpowers](ch04/255-skill.md) — Agent 工作流规范
- [Skill Writing Patterns](ch04/255-skill.md) — Skill 质量评估相关
