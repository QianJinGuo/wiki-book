...
## Ch04.611 深度拆解：AI 智能体 Harness 的构造【译】
...
- [从零构建大语言模型 —— 读完这篇你就懂了](../ch01/859-llm.html)
...
- [neurips 2026 使用闭源 ai 检测器 pangram 批量 desk-reject 论文事件](../ch01/1108-20.html)
- [qoder 发布团队知识引擎：组织级知识记忆是 harness 自进化的重要组件](../ch01/955-qoder.html)
- [scaling camera file processing at netflix](../ch11/135-scaling-camera-file-processing-at-netflix.html)
- [state of routing in model serving](../ch11/200-state-of-routing-in-model-serving.html)
- [大模型可控新突破：steering 机制、评估体系与开源落地](../ch01/1247-steering.html)
