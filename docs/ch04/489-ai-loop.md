...
## Ch04.489 企业 AI Loop 落地框架：五类工程对象
...
- [Environment Engineering：Agent 不能只靠一条提示](ch04/238-agentic.html) — 架构师系列中提出 AGENT.md / STATE.md / EVIDENCE.md / PERMISSIONS.md 的先行概念
- [Harness Engineering](../ch05/118-harness-engineering.html) — Agent 运行底座工程范式
