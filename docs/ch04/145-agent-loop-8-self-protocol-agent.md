...
→ [Harness Engineering Survey 2026](ch04/502-agent.md) — 同样社区层面的 Agent 工程化范式整理，但**侧重 12 组件分类**
→ [Harness Architecture Production Guide](ch04/502-agent.md) — Harness 12 组件 vs Agent Loop 7 件套（不同抽象层级）
...
→ [Harness Observability Production](ch04/502-agent.md) — 同样讲 Harness 但侧重**可观测性**
