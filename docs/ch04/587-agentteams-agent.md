...
## Ch04.587 阿里云 AgentTeams 企业级多 Agent 平台

> 📊 Level ⭐⭐ | 4.3KB | `entities/alibaba-cloud-agentteams-enterprise-multi-agent.md`
...
与 [Agent Harness 6 种运行时模式](../ch05/057-agent-harness.html) 中提到的分层委托模式一致，但 AgentTeams 强调 TL 层解决管理幅度问题。
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/alibaba-cloud-agentteams-enterprise-multi-agent.md)
