...
## Ch04.226 Build an AI-Powered Equipment Repair Assistant Using Amazon Bedrock AgentCore
...
- [Building Web Search Enabled Agents With Strands And Exa](ch04/416-building-web-search-enabled-agents-with-strands-and-exa.md) — Strands SDK 构建搜索 Agent 的实践
...
- [Agentcore Harness](ch04/462-amazon-bedrock-agentcore-harness-ga-api-agent.md) — AgentCore 工程化实践
- [Building A Secure Auth Code Flow Setup Using Agentcore Gatew](ch04/271-building-a-secure-auth-code-flow-setup-using-agentcore-gatew.md) — AgentCore 安全认证流程
- [Aws Bedrock Agentcore Doris Mcp Server](../ch11/229-aws-bedrock-agentcore.md) — AgentCore + MCP Server 集成
