...
- [Anthropic 发布 Computer Use 最佳实践](../ch01/1198-anthropic-computer-use.html) — Anthropic 官方的 Computer Use 优化建议，包括截图降采样等技巧
...
- [Ettin Reranker Family](../ch01/624-introducing-the-ettin-reranker-family.html) — 高效的排序模型，可用于优化 Agent 任务路由
