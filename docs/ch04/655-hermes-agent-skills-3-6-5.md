...
## Ch04.655 Hermes Agent Skills 源码级拆解：3级渐进加载 × 6步调度 × 5维安全扫描

> 📊 Level ⭐⭐ | 4.4KB | `entities/hermes-agent-skills-source-code-analysis-shuge.md`
...
> 源码分析版（vs [Hermes Agent Skill 系统深度解析](../ch07/018-hermes-skill.html) winty版）
## 核心定位
Hermes 两套记忆机制：
- **通用记忆**（MEMORY.
