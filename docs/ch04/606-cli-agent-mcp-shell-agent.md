...
## Ch04.606 CLI Agent 模式：MCP 与 Shell Agent
...
本页作为知识图谱锚点，连接了以下关键实体：[CLI、MCP 和 CLI+Skill，应该如何选？](ch04/267-skill.html)。 相关主题通过 [如何构建生产准备的AI代理：MCP、CLI与技能——适合合适的工作的工具](ch04/291-ai-agent.html) 延伸。
...
- [如何构建生产准备的AI代理：MCP、CLI与技能——适合合适的工作的工具](ch04/291-ai-agent.html)
- [Agent-EvalKit：AWS 开源 CLI Agent 评测工具包](../ch03/046-agent.html)
- [CLI-Anything：让 Agent 自主驱动任意 GUI 软件](../ch03/096-cli-anything.html)
- [AI Agent 的内核是 250 行 while 循环：用 Python + Ollama 从零搭建 CLI Agent 的 7 阶段教程](ch04/573-python.html)
