...
## Ch04.594 APPO (Agentic Procedural Policy Optimization)：阿里高德 AMAP-ML 把 Agent RL 信用分配细化到每个决策点
...
- [港中文 SLIM：动态技能生命周期管理](ch04/255-skill.md)（相关：另一条 Agentic RL 主线——技能生命周期管理）
