...
## Ch04.379 Hands-free first notice of loss: Using Strands Agents and Amazon Bedrock AgentCore Browser Tool for intelligent claims intake
...
- [Building Web Search Enabled Agents With Strands And Exa](ch04/455-building-web-search-enabled-agents-with-strands-and-exa.html) — Strands SDK 搜索 Agent
...
- [Agentcore Harness](ch04/676-agentcore-harness.html) — AgentCore 工程化
- [Aws Bedrock Agentcore Doris Mcp Server](../ch11/264-aws-bedrock-agentcore.html) — AgentCore + MCP Server
