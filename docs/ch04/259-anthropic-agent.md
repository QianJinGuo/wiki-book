...
## Ch04.259 Anthropic 上线「做梦」功能，让 Agent 越睡越聪明
...
## 相关实体
- [Anthropic 官方生产级 Agent 最佳实践12 个可复用的 Mcp 设计模式](../ch01/1327-anthropic.html)
- [Anthropic 12 Mcp Production Patterns](../ch01/1327-anthropic.html)
- [Anthropic 14 Skill Patterns Best Practices](../ch01/317-anthropic-14-skill.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/anthropic-dreaming-claude-managed-agents-ovZ5v7jJkqDKSu9xmxwt8w.md).md]
