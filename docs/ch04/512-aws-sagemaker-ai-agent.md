...
## Ch04.512 AWS SageMaker AI Agent 引导式工作流微调
...
## 相关实体
- [Aws Reinforcement Fine Tuning Llm As Judge](../ch01/1146-llm.html)
...
- [将 Aws Devops Agent 智能运维能力延伸到中国区](../ch11/294-aws-devops-agent.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/aws-sagemaker-ai-agent-guided-workflows-finetuning.md)
