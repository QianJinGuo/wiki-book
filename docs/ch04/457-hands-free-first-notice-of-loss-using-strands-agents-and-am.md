...
## Ch04.457 Hands-free first notice of loss: Using Strands Agents and Amazon Bedrock AgentCore Browser Tool for intelligent claims intake
...
- [Building Web Search Enabled Agents With Strands And Exa](ch04/546-building-web-search-enabled-agents-with-strands-and-exa.html) — Strands SDK 搜索 Agent
...
- [Aws Bedrock Agentcore Doris Mcp Server](../ch11/280-aws-bedrock-agentcore.html) — AgentCore + MCP Server
