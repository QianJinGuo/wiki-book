...
## Ch04.824 Agent Harnesses Are Dead. Long Live Agent Harnesses.
...
这与 [Hermes Agent Operator](../ch03/099-hermes-agent.html) 中讨论的"Agent 可运营性"形成呼应——当 Agent 构建足够便宜，竞争焦点从"能否构建"转向"能否运营和持续改进"。
...
这一洞察与 [Claude Code 动态工作流](../ch09/106-claude-code-dynamic-workflows.html) 中讨论的"工作流即基础设施"观点一致：真正的护城河不是 Agent 框架本身，而是围绕 Agent 建立的运营数据、用户习惯和组织流程。
...
4. **Harness 选型的未来-proof 原则**：优先选择那些"薄而开放"的 Harness（如 [Hermes Agent](../ch03/099-hermes-agent.html)），它们提供核心约束但不绑定到特定模型或基础设施。避免选择"厚而封闭"的 Harness，后者在模型提供商吸收栈后迅速贬值。
...
- [Claude Code 动态工作流](../ch09/106-claude-code-dynamic-workflows.html)
- [Harness Generator-Evaluator](../ch01/1592-anthropic.html)
- [Agent Reliability Engineering](ch04/349-skill.html)
- [当 AI 构建自身](../ch01/1592-anthropic.html)
- [Prime Intellect Auto NanoGPT](../ch01/1468-0.html)
