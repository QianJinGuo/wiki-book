...
## Ch04.132 从 OpenClaw 到 OpenHuman：私人 AI Runtime 的雏形
...
- [OpenHuman Memory Tree](https://github.com/QianJinGuo/wiki/blob/main/entities/openhuman-ai-agent-memory-tree-tokenjuice.md) — 记忆框架核心
- Composio — SaaS 集成平台
- Tauri — 桌面壳框架
- Agent Harness 工程 — 缰绳设计模式

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/openhuman-private-ai-runtime-from-openclaw.md)
