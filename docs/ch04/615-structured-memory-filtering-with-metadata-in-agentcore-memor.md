...
## Ch04.615 Structured Memory Filtering with Metadata in AgentCore Memory
...
- `[AgentCore Harness](ch04/480-amazon-bedrock-agentcore-harness-ga-api-agent.html)` — AgentCore 整体平台
