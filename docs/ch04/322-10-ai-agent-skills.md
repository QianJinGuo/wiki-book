...
## Ch04.322 精选 10 个开发者常用的 AI 智能体技能（Agent Skills）
...
- [AI MAP: Security Testing for AI Agent Infrastructure — Bishop Fox](ch04/505-introducing-aimap-security-testing-for-ai-agent-bishop-f.html)
...
- [2 小时，0 行手写代码，我用 Claude 做了一个生产级 VSCode 插件](../ch01/1441-claude.html)
...
- [从Vibe Coding到Agentic Engineering：重构后台开发全流程](ch04/074-agentic.html)
...
- [token级，精准控制生成长度：3b模型击败gpt 5.4、claude](../ch01/1441-claude.html)
