...
## Ch04.222 Agent Reliability: Context Drift & Tool Calling Hallucination
...
## 与 vault 知识关联
- [Agent Harness 架构](../ch05/042-agent-harness.html) — Context Manager 处理上下文；工具调用校验是 Harness 层的职责
...
- [Agent Harness 上下文管理：工作集视角](../ch05/042-agent-harness.html)
...
- [CLI、MCP、API 选型：Agent 接入层决策指南](../ch03/036-agent.html)
