...
## Ch04.593 Agent Protocol 不变层：跨框架的 6 个稳定 Runtime 对象
...
- [Agent Harness 架构](ch03/045-agent.md) — Harness 作为 Runtime 的上层封装
- [Agent 架构关键变化：Harness 成为新后端](ch03/045-agent.md) — Harness 作为 Runtime 演进方向
