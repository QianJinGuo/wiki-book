...
- → [Agent Skill 规范、构建与设计模式](ch04/619-agent-skill.html) — 更多关注如何构建 skill（Skill-Creator、设计模式等）
- → [Hermes Agent Skills 源码级拆解](ch04/536-hermes-agent-skills.html) — 同一作者（术哥）的源码级分析
