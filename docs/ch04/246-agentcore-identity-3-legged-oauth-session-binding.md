...
## Ch04.246 AgentCore Identity: 3-legged OAuth+Session Binding的安全架构
...
- [Hapag-Lloyd：1.5万反馈/月95%情感准确率](../ch11/207-aws-hapag-lloyd-bedrock-customer-feedback.html)
- [Halliburton Seismic Workflow with Amazon Bedrock and Generative AI](../ch11/019-aws-bedrock.html)
...
- [自己的工具自己控：MCP Server、Amazon Bedrock AgentCore、Quick Suite集成指南](ch04/666-amazon-bedrock-agentcore.html)
