...
## Ch04.232 LangChain Deep Agents v0.7: 精简 Agent Harness

> 📊 Level ⭐⭐ | 10.6KB | `entities/langchain-deep-agents-v0-7-2026-07-29.md`
...
- [Deep Agents Bedrock 集成](ch04/523-agent-orchestration.html) — Deep Agents 在 AWS Bedrock 上的部署和 subagent 编排
...
- [Codex Context Engineering](../ch01/520-codex.html) — Codex 在 context engineering 上的不同实践路径
