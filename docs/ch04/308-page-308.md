...
> 📊 Level ⭐⭐⭐⭐ | 11.0KB | `entities/航班变更信息智能识别解决方案.md`
...
- [基于Bedrock AgentCore+Strands构建企业级智能搜索平台实践](https://github.com/QianJinGuo/wiki-public/blob/main/entities/building-enterprise-level-with-bedrock-agentcore-and-strands.md) — AgentCore + Strands 组合的企业级构建范式
- [Building web search-enabled agents with Strands and Exa](066-building-web-search-enabled-agents-with-strands-and-exa.html) — Strands Agents 工具调用模式的深度分析
- [Product Ad Review Agent with Strands SDK and Bedrock](https://github.com/QianJinGuo/wiki-public/blob/main/entities/product-ad-review-agent-with-strands-sdk-bedrock.md) — Strands SDK + Bedrock 商品审查 Agent 实践
- [基于 Strands SDK 的企业级智能数据查询解决方案实践](https://github.com/QianJinGuo/wiki-public/blob/main/entities/enterprise-intelligent-data-query-solution-practice-based-on-strands-sdk.md) — Strands SDK 企业级应用系列
