...
## Ch04.257 Anthropic 上线「做梦」功能，让 Agent 越睡越聪明
...
## 相关实体
- [Anthropic 官方生产级 Agent 最佳实践12 个可复用的 Mcp 设计模式](../ch01/986-anthropic.html)
- [Anthropic 12 Mcp Production Patterns](../ch01/986-anthropic.html)
