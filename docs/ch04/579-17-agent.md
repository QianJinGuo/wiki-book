...
## Ch04.579 17种Agent架构演进：控制流设计的完整演化史
...
[Factory 的 Mission 系统](ch04/150-ai.md) 是 Multi-Agent 架构的典型实践：Validator-Creator 分离、Validation Contract 预承诺机制、串行优先于并行的调度策略。

[AI Native 研发组织设计](ch04/150-ai.md) 则从组织维度探讨了 Multi-Agent 时代的架构演化。
