...
## Ch04.649 GenericAgent — 复旦肖仰华自进化智能体设计哲学
...
- [Hermes Agent 自进化](../ch03/098-hermes-agent.html) — 另一自进化智能体实现，对比 GenericAgent 的 "做减法" vs Hermes 的 Skill 演化路径
- [TACO：让 CLI Agent 学会丢掉无用上下文](../ch03/037-agent.html) — 上下文压缩的另一条路线，奖励模型驱动的自适应丢弃策略
...
- [阿里云 Agent 进化四阶段六维度](../ch03/037-agent.html) — 企业级 Agent 进化的不同视角

## 退出

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/genericagent-self-evolving-agent-xiao-yanghua-fudan-2026-07-16.md)
