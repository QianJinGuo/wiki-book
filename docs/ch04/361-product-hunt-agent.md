...
## Ch04.361 Product Hunt 日榜第一！把任何网站变成可被 Agent 复用的技能
...
- [Browser Use v13](../ch05/110-harness.html) — 浏览器 Agent 能力框架
- [MCP 协议](https://github.com/QianJinGuo/wiki/blob/main/concepts/model-context-protocol-mcp.md) — Agent 工具调用的标准化协议
- [Hermes Agent 操作手册](../ch03/093-hermes-agent.html) — Agent 操作系统的实践指南
