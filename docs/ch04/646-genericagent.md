...
## Ch04.646 GenericAgent — 复旦肖仰华自进化智能体设计哲学
...
- [TACO：让 CLI Agent 学会丢掉无用上下文](../ch03/036-agent.html) — 上下文压缩的另一条路线，奖励模型驱动的自适应丢弃策略
...
- [阿里云 Agent 进化四阶段六维度](../ch03/036-agent.html) — 企业级 Agent 进化的不同视角
