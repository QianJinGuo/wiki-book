...
## Ch04.369 AI Agent 时代选型指南：模型·应用· Harness（Mollick）
...
- [Co Existence Paradigm Shift Agentic Ai Mollick 2026](../ch01/823-ai-mollick.html) — Mollick 2026-06 范式转换叙事（同一作者更新的 agentic 时代框架）
- [Management As Ai Superpower Mollick](../ch01/675-management-as-ai-superpower.html) — 管理作为 AI 超级能力（同一作者，同期但不同议题）
