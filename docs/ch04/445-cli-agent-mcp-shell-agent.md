...
## Ch04.445 CLI Agent 模式：MCP 与 Shell Agent
...
- [如何构建生产准备的AI代理：MCP、CLI与技能——适合合适的工作的工具](ch04/581-ai-agent.html)
- [Agent-EvalKit：AWS 开源 CLI Agent 评测工具包](../ch03/037-agent.html)
- [CLI-Anything：让 Agent 自主驱动任意 GUI 软件](../ch03/105-cli-anything.html)
- [AI Agent 的内核是 250 行 while 循环：用 Python + Ollama 从零搭建 CLI Agent 的 7 阶段教程](ch04/483-python.html)
