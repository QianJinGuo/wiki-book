...
- vs **[Claude Fable 5 and new AI safety fables](../ch01/907-claude-fable-5-and-new-ai-safety-fables.html)** — Nathan Lambert 的**政策分析**(数据保留/prompt 过滤/用户未告知模型修改),本文**不**涉及政策。
...
- vs **[Claude Code agent teams task decomposition ruofei](../ch01/332-claude-code-agent-teams.html)** — 那是**任务分解**(具体执行);本文是**任务协议** (前置契约)。
...
- [Claude Fable 5 and new AI safety fables](../ch01/907-claude-fable-5-and-new-ai-safety-fables.html)
...
- [Claude Code agent teams task decomposition](../ch01/332-claude-code-agent-teams.html)
