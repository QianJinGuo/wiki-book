...
## Ch04.195 Co-Existence vs Co-Intelligence: Mollick's Paradigm Shift on AI Autonomy
...
- [Stochastic Parrot Deep Mystery Llms](../ch01/756-stochastic-parrot-deep-mystery-llms.html) — 引述 Mollick 关于"next-word prediction 是否模拟思维"的挑战 — 同一作者不同议题
