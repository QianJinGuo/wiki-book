...
## Ch04.304 Agent/Skills/Teams 架构演进过程及技术选型之道
...
## 与 Wiki 已有内容的关系
- 补充 [Agent 工程实践](../ch03/036-agent.html)的"架构演进路径"章节（增加量化数据）
...
- [Autoresearch Next Phase Async Multi Agent Ai寒武纪](../ch01/1087-agent-ai.html)
