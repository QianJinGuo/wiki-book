...
- **Aderant 场景**（[Aderant Transforms Cloud Operations With Amazon Quick](../ch11/154-aderant-transforms-cloud-operations-with-amazon-quick.html)）：Quick 接入 6 个供应商系统的 MCP servers，专注 cross-source RAG 搜索
...
- [Aderant Transforms Cloud Operations With Amazon Quick](../ch11/154-aderant-transforms-cloud-operations-with-amazon-quick.html) — Amazon Quick 在法律行业的 cross-source RAG 案例（同一产品不同应用场景）
