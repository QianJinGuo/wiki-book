...
- → [Prompt Caching 工程实践](../ch01/277-anthropic-prompt-caching-claude-code.md)：缓存策略是 token 优化的另一维度
...
## 相关实体
- [Improving token efficiency in GitHub Agentic Workflows](../ch01/751-github.md)

- [Token Efficiency](../ch01/751-github.md)
````
