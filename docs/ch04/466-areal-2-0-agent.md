...
## Ch04.466 AReaL 2.0：面向自演进 Agent 的在线强化学习系统基础设施
...
```mermaid
mindmap
  root(("AReaL 20 面向自演进 Agent 的在线强化学习系统基础设施"))
    在线 RL 基建是 Agent 自演进的关键基础设施
    微服务化重构是 RL 工程化的必然路径
    轨迹数据协议 ATDP 是 Agent 可观测性的升级版
    治理优先的演进决策机制
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/areal-2-agentic-rl-online-learning-self-evolving.md)
