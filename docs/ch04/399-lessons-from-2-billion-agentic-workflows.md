...
- [A Missing Layer In Agentic Systems](ch04/342-a-missing-layer-in-agentic-systems.md) — HITL 作为 Agentic 系统第三层的论述
- [Agentcore Harness](ch04/463-amazon-bedrock-agentcore-harness-ga-api-agent.md) — AgentCore 工程化实践
- [Agentops Operationalize Agentic Ai Amazon Bedrock](../ch11/152-amazon-bedrock.md) — AgentOps 可观测性实践
