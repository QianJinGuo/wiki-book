...
## Ch04.430 AgentRun CLI v0.1.0 正式开源：一行命令运行您的托管 Agent
...
## 相关实体
- [Hermes Agent Kanban Deep Test By Wjjagi 2026](../ch03/098-hermes-agent.html)
- [深势科技携手阿里云 Agentrun加速科研 Ai Agent 全速运行](ch04/679-ai-agent.html)
- [Minimal Cli Agent 250 Line Python Ollama 7 Stages](ch04/476-python.html)
- [Aliyun Agentrun 5Min Quickstart](ch04/428-agentrun.html)
- [Skills Registry 公测开启为企业打造私有的 Skill 管理中心](../ch03/076-skills.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/agentrun-cli-v010-正式开源一行命令运行您的托管-agent.md)
