...
## Ch04.380 CLI-Anything：让 Agent 自主驱动任意 GUI 软件
...
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](ch04/235-agentic.html) — Vibe Coding 到 Agentic Engineering 的范式转变
