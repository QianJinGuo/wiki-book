...
- [Claude Code Dynamic Workflows](ch05/094-ai.html)（动态工作流基础）
- [Claude Code Loop Types](ch03/077-claude-code.html)（loop 类型官方分类）
- [Agentic Loop Engineering](ch03/035-agent.html)（loop 工程框架）
