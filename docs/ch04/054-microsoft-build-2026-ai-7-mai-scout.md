...
## Ch04.054 Microsoft Build 2026：微软 AI 独立日 —— 7 款 MAI 模型 + Scout 智能体
...
## 相关实体
- [Microsoft Build 2026 Qbitai Full Scope](../ch05/091-ai.html)
...
### vs [OpenClaw](../ch11/230-openclaw.html)
...
## 相关对照
- [Kimi Work](../ch01/514-codex.html) —— 本地桌面 Agent + Vibe Working
- [wow-harness v3](../ch05/018-harness.html) —— 跨 session 事件时间线
- [OpenClaw](../ch11/230-openclaw.html) —— 开源 AI 编程框架（Scout 基于它）
