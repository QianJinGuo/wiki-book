...
## Ch04.091 从零设计准生产级 LLM Agent：ThinkingAgent 完整架构与可靠性体系
...
- [Claude Code Tool Call Security Incident Gitignore Redis Anthropic Apology 2026 06 17](ch03/074-claude-code.md)：Claude Code 安全事故 — ThinkingAgent 的 Safeguard 代理模式是直接应对方案
...
- [Agent Loop Engineering Handbook 8 Questions Chen Jin Tencent Self 2026](ch03/044-agent.md)：Agent Loop 8 个未解问题 — ThinkingAgent 对其中多个问题给出了工程答案
