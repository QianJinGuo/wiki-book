...
## Ch04.253 Computer Use 45x More Expensive Than Structured APIs
...
- [Anthropic 发布 Computer Use 最佳实践](ch01/830-anthropic-computer-use.md) — Anthropic 官方的 Computer Use 优化建议，包括截图降采样等技巧
...
- [Ettin Reranker Family](ch01/479-introducing-the-ettin-reranker-family.md) — 高效的排序模型，可用于优化 Agent 任务路由
