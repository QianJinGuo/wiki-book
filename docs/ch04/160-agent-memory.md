...
## 与 [Hermes Agent Deep Dive](../ch03/093-hermes-agent.html) 的关系
...
## 相关主题
- [Agent Skill Writing](ch04/268-agent-skill.html) — Skill 是 Memory 系统持久化的载体之一
- [Anthropic Mcp Revisited](../ch07/016-anthropic-mcp.html) — MCP 作为 Agent 工具调用协议，与 Memory 的世界模型有交叉（环境约束信息）
- [Gbrain](../ch01/259-gbrain-yc-ceo-garry-tan-postgres-native-ai-5-llm.html) — Compiled Truth + Timeline 知识模型，与 Memory 的信念追踪机制相关
...
- [Hermes Agent 记忆系统 vs OpenClaw 记忆观](../ch03/093-hermes-agent.html)
- [AI Agent 记忆系统架构](ch04/159-how-ai-agent-memory-works.html)
- [深度拆解 Hermes Agent 记忆系统](../ch03/093-hermes-agent.html)
- [ai agent memory systems](ch04/102-agent-memory.html)
- [Personal AI 工作台：Claude 18 动作框架](../ch05/091-ai.html)
