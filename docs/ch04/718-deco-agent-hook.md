...
## Ch04.718 DECO — 腾讯数据工程 Agent Hook 护栏层实践
...
- [Harness Engineering 阿里 Java 实践](../ch05/126-harness-engineering.html) — 企业级 Harness 工程另一视角
- [腾讯混元 Hy3 Agent 产品](../ch01/129-hy3-preview.html) — 腾讯同系的 Agent 产品发展
