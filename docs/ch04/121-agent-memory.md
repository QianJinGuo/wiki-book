...
## 关联实体
- [Hermes Agent 记忆系统](../ch03/092-hermes-agent.html) — 本文的 memory 管理理念与 Hermes 实现直接对应
- [Agent Harness 上下文管理](../ch05/039-agent-harness.html) — Memory 是 Harness 控制面的一层
- [Claude Code Agent 工程化](../ch03/068-claude-code-agent.html) — CLAUDE.md / AGENTS.md 工作区文件实践
...
- [memory agent systems cobanov](ch04/578-memory-agent-systems-cobanov.html)

- [AI Agent 记忆系统架构](ch04/155-how-ai-agent-memory-works.html)
