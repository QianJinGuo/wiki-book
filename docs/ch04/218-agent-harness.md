...
## 参见
- [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/agent-harness-architecture-design-production-guide.md)
- [Harness Engineering](../ch05/092-harness-engineering.html)（Harness 工程方法论）

## 相关实体
- [Agent架构关键变化：Harness正在成为新后端](../ch05/009-harness.html)
- [Agent Harness 组件解析](../ch05/038-agent-harness.html)
...
- [Agent Harness 12 组件与 7 个关键决策](../ch05/038-agent-harness.html)
- [Agent架构关键变化：Harness正在成为新后端](../ch05/009-harness.html)
...
- [从多智能体编排到AI自主决策：资损防控体系的架构演进](../ch05/077-ai.html)
...
- [Agent Harness 解析：智能体架构深度拆解](../ch05/038-agent-harness.html)
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/agent-harness-architecture-deep-dive-aksahy.md)
