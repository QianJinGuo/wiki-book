...
## Ch04.206 Self-Evolving Agents 系统性综述
...
- [Memento Skills Agent Self Evolving](ch04/245-skill.md) — 技能外部记忆维度，与 Environment-Centric Static Knowledge Evolution 相关
- [Agent Self Improvement Six Mechanisms](ch03/044-agent.md) — Agent 自我改进六条路，与本文 taxonomy 有重叠但视角不同
- [Agent Memory Modular Framework](ch03/044-agent.md) — Memory 模块化框架，与 Environment-Centric Modular Architecture Evolution 相关
...
- [基于AgentCore构建自学习、可进化的文旅行业近似信息抽取Agents | 亚马逊AWS官方博客](ch03/044-agent.md)
...
- [17种Agent架构演进：控制流设计的完整演化史](ch03/044-agent.md)
