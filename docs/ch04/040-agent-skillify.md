...
## 相关概念
- [GBrain 自进化体系](../ch01/448-llm-wiki-obsidian-wiki-gbrain.html) — skillify 是 gbrain 自演化的核心机制
- [Harness Engineering](../ch05/026-harness-engineering.html) — 传感器失效是 latent space 工作分类错位的体现
...
- [从提需求到部署发布全AI全自动化后研发效能全面跃升](052-ai.html)
- [Hermes Agent vs OpenClaw 对比分析](../ch03/066-hermes-agent.html)
- [AutoClaw 使用体验：自带 66 个 Skill、可接入聊天工具、安全性高](../ch07/045-skill.html)
- [Harness Engineering 实战：AI Coding 率从 25% 提升至 90%](../ch05/026-harness-engineering.html)
