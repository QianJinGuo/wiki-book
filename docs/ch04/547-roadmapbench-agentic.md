...
## Ch04.547 RoadmapBench — 跨版本升级的长周期 Agentic 软件开发评估基准
...
RoadmapBench 填补了从 SWE-Bench（单 bug fix）到 [Codex 六小时目标运行](../ch09/067-codex-goal-six-hour-run.html)（端到端功能开发）之间的评估空白。 它的定位类似 SWE-Bench 的"跨版本升级"增强版，关注的是 Agent 在已知代码库上进行系统性演进的能力，而非从零开始的创作能力。
...
- [Codex 六小时目标运行](../ch09/067-codex-goal-six-hour-run.html) — 长链 Agent 执行的实际案例
