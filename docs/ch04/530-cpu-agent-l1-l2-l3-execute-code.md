...
## Ch04.530 CPU 缓存类比下的 Agent 上下文管理：L1/L2/L3 层级架构与 execute_code 单工具设计
...
- [Agent Harness 上下文管理工作集视角](ch04/503-agent.md) — 工作集是 **L1 内部**的精细化设计；本文是工作集的 L1/L2/L3 宏观扩展
- [智能体编排层中的上下文管理架构](ch04/503-agent.md) — 框架主动约束 vs 模型自主管理的权衡；本文是同向的更激进的 execute_code 推论
...
- [Claude Code 工具设计演进](ch03/073-claude-code.md) — Anthropic 工具设计的演进
...
- [Claude Code 上下文工程 Thariq](ch03/073-claude-code.md) — 官方 Anthropic 视角
- [Codex 上下文工程 LastWhisper](ch01/434-codex.md) — 另一家 Code 厂商的上下文视角
