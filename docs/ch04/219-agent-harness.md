...
- [Harness Engineering](../ch05/092-harness-engineering.md)（Harness 工程方法论）

## 相关实体
- [Agent架构关键变化：Harness正在成为新后端](../ch05/009-harness.md)
- [Agent Harness 组件解析](../ch05/038-agent-harness.md)
...
- [从多智能体编排到AI自主决策：资损防控体系的架构演进](ch04/229-ai.md)
- [AI Native 时代 —— 研发组织何去何从](../ch05/018-ai-native.md)
