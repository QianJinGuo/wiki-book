...
- [Claude Code 架构解析](../ch03/085-claude-code.html) — 文件读取双层门禁、查询前优化、compaction 触发机制
- [Agent Skill 编写指南](ch04/619-agent-skill.html) — Skill 的渐进式上下文注入机制
...
## 相关实体
- [AIAIGC峰会嘉宾阵容](ch04/629-aiaigc.html)
