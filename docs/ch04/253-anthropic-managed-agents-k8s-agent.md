...
## Ch04.253 Anthropic Managed Agents：用 K8s 思路虚拟化 Agent 组件
...
- [Anthropic Claude Managed Agents Platform 2026](../ch01/158-anthropic-claude-managed-agents.html)
...
- [Anthropic Demystifying Evals For Ai Agents](423-ai-agent.html)
