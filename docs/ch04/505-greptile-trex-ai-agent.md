...
## Ch04.505 Greptile TREX：AI 代码审查的执行引擎与 Agent 嵌套架构
...
- [StackOverflow for Agents](../ch03/037-agent.html) — Agent 间知识共享的另一种模式
- [GitHub Agentic Token 效率](ch04/742-agentic.html) — Agent 在代码审查场景的 token 优化
