...
- [Harness 模式 6-SubAgent 实战 — 17哥 vs 评测平台](ch03/035-agent.html) — 互补 (决策者 vs 动手者)
...
- [Harness Engineering Practical 17Ge Versus 6 Subagent](ch03/035-agent.html) — 互补的 Harness 模式（决策者 vs 动手者）
- [深入理解 Claude Code 源码中的 Agent Harness 构建之道](ch03/077-claude-code.html) — Claude Code harness 架构参考
