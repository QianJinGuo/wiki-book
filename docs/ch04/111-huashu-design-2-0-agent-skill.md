...
```mermaid
mindmap
  root(("Huashu-Design 2.0 — Agent Sk…"))
    关键定位: Skill vs 软件
    3 个真实坑 工业级失败案例
      坑一 · 设计收敛成'安全极简'
      坑二 · 内容网站没有真图 = 空壳
    ...
    跨域可复用的 3 条原则
      ...
      原则 3: 事实验证第 0 原则
    项目元数据
    PPT 范式转变: HTML deck 优于 …
    与 17哥 vs 比较
    相关实体
    深度分析
      核心观点：Skill 的'反收敛'问题是 AI…
      技术要点：3 套并行逻辑的设计原理
      实践价值：为什么'图片前置'和'事实验证第 0…
...
- [Harness 模式 6-SubAgent 实战 — 17哥 vs 评测平台](../ch05/120-harness-engineering.html) — 互补 (决策者 vs 动手者)
