...
## Ch04.517 Loop Engineering 概念解析：Agent Loop vs Loop Engineering、六大框架与实践思考
...
与 [Loop Engineering 系统框架](ch01/216-0.md) 的关系：梦朝思夕的四次跃迁框架（Prompt → Context → Harness → Loop）提供了历史脉络，本文则从 Agent Loop 底层机制出发，解释了为什么 Loop Engineering 是"此 Loop 非彼 Loop"。
...
- [Loop Engineering 系统框架](ch01/216-0.md) — 四次跃迁、五要素模型、成本公式
- [Agent Loop 工程手册](ch01/216-0.md) — 腾讯陈进的8个未解问题
