...
与 [Agent Engineering Principles Architecture Practice](../ch03/006-agent.html) 互补：后者 Harness 比模型关键 → 前者第六条机制具体展示如何自动化 Harness。
...
## 相关实体
- [foundation capital agent era six insights](ch04/220-foundation-capital-agent-era-six-insights.html)
- [Hermes Agent 自进化机制源码解析](../ch03/099-hermes-agent.html)
- [Memento-Skills — 技能外部记忆让 Agent 自进化（arXiv 2603.18743）](ch04/503-memento-skills-agent.html)
- [AI Coding Agent 记忆系统](ch04/409-ai-coding-agent.html)
- [Martin Fowler AI 研发 Harness：非确定性承重层](../ch05/080-harness.html)
...
- [深度解析LLM Wiki / Obsidian-Wiki / GBrain：Agent时代知识的"自组织"与"自进化"](../ch01/913-llm-wiki-obsidian-wiki-gbrain.html)
- [长周期 Agent 详解：从 Ralph Loop 到可接管 Harness](../ch05/080-harness.html)
...
- [企业级AI记忆基质三层架构：事实/交互/行动记忆](../ch06/049-memory.html)
...
- [SkillClaw](ch04/568-skillclaw-nacos-agent-skill-registry.html)
...
- [上下文工程 - 三种Memory方案对比](../ch06/049-memory.html)
- [AI Agent 工程师能力地图](ch04/684-ai-agent.html)

- [Chatgpt Dreaming V3 Long Term Memory Xinzhiyuan](../ch01/1367-chatgpt-dreaming-v3.html)
- [Chatgpt Dreaming V3 Long Term Memory Openai](../ch01/1367-chatgpt-dreaming-v3.html)
- [llm 自我提升系统综述 — yang 等 113 页四阶段闭环框架（zesearch nlp lab）](../ch01/1156-llm.html)
- [recursive first steps toward automated ai research：sota 三基准自](../ch05/113-ai.html)
...
- 这与 [Foundation Capital agent era](ch04/220-foundation-capital-agent-era-six-insights.html) 中"infra 厂商抢应用层 IP"的趋势一致，**但 OpenAI 反向操作：放弃应用层 IP 换生产方法论**——是更上游的卡位
...
- **生产方法论 > 应用层 IP**：OpenAI 放弃 Tax AI IP 换范式，是把"自我改进工程"作为下一代护城河，与 [Harness Engineering 长程任务](../ch05/096-harness-engineering.html) 中"Big Harness > Big Model"的判断完全一致
