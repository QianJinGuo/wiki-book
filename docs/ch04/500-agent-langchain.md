...
## Ch04.500 改进 Agent：数据挖掘视角与 LangChain 实践
...
- [Agent vs Workflow 控制权连续谱](ch04/788-agent-vs-workflow.html) — Agent 工程化
- [Loop Engineering](../ch05/006-loop-engineering.html) — Agent 循环决策与 Harness 工程的交叉
- [Spec Kit/OpenSpec/Superpowers 融合 Harness](../ch05/057-openspec.html) — Harness 工程实践
