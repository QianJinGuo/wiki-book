...
- [Hermes Agent Operator](../ch03/102-hermes-agent.html) — "模型侧自改进"路径（定时任务把对话总结成 Skill），与本文"系统侧自改进"互补
- [Agent Evolution 四阶段六维](../ch03/036-agent.html) — 第四阶段"自进化 Agent"包含本文的系统侧自改进机制
...
- [Agent YAML 评测](../ch03/036-agent.html) — YAML-driven evaluation 是 Evaluator 工程化的一种
...
- [OpenClaw 完整指南](../ch11/250-openclaw.html) — 开源 Agent 的故障处理与自我恢复机制
- [Agent 记忆系统实践](../ch03/036-agent.html) — Agent Overview 是 Memory 模块的诊断侧应用- [langchain × fireworks 100x cheaper trace judge — 通用 trace 评估](../ch01/347-langchain.html)
