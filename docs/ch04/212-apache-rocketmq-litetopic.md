...
## Ch04.212 Apache RocketMQ LiteTopic 消息模型

> 📊 Level ⭐⭐ | 13.0KB | `entities/rocketmq-litetopic-ai-agent-messaging.md`
...
→ [[raw/articles/rocketmq-5-5-0-litetopics-ai-agent-messaging|原文存档]
