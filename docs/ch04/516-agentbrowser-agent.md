...
## Ch04.516 AgentBrowser：Agent 浏览器工具框架
...
## Related
- [CLI-Anything](../ch03/094-cli-anything.md) — Agent 工具生态
- [AutoCLI](../ch03/117-autocli.md) — 信息获取 CLI
- [Hermes-Agent](../ch03/090-hermes-agent.md) — 可通过 AgentBrowser 扩展能力
