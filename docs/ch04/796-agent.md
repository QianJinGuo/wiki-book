...
- [一个 Mission 跑 16 天、烧 7.78 亿 Token：Factory 公开了多 Agent 系统的构建哲学](ch04/217-factory-missions.html)
- [AutoResearch 异步多 Agent AI 寒武纪新阶段](../ch01/1087-agent-ai.html)
- [Anthropic Multi Agent Research System](ch04/651-anthropic-multi-agent-research-system.html)
- [Code as Agent Harness 综述](../ch09/061-code-as-agent-harness.html)
- [Orchestrating Self-Evolving Agents with CrewAI and NVIDIA NemoClaw](ch04/284-self-evolving-agents.html)
- [AWS Bedrock 多智能体协作指南](../ch11/017-aws-bedrock.html)
- [Multi-Agent 的四种协作模式：Supervisor、Swarm、网状、流水线，怎么选？](../ch03/036-agent.html)
- [Agent vs Workflow：控制权连续谱与生产级选型框架](ch04/749-agent-vs-workflow.html)
