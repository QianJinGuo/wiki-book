...
## Ch04.808 CPU 缓存类比下的 Agent 上下文管理：L1/L2/L3 层级架构与 execute_code 单工具设计
...
### 与 [Anthropic 工具数量陷阱](ch04/377-ai-agent.html) 的对比
...
- [上下文工程三种记忆范式对比](../ch06/048-memory.html) — 记忆/上下文/信息的层级
