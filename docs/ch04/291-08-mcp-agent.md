...
## Ch04.291 第 08 篇 · MCP：让 Agent 跟外部生态对接
...
- [Agent Tool Registry 模式](ch03/045-agent.md)
- [Hermes Agent 上手](ch03/045-agent.md)
- [MCP 基础认知](ch01/307-agi.md)
- [Agent Harness 框架](https://github.com/QianJinGuo/wiki/blob/main/concepts/agent-harness-framework.md)
