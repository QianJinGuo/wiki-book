...
## Ch04.574 Anthropic 大规模代码迁移方法论 — Claude Code 多 Agent Loop 的工程实践
...
- [Claude Code Dynamic Workflows](../ch09/093-claude-code-dynamic-workflows.html)（动态工作流基础）
- [Claude Code Loop Types](../ch09/137-claude-code-loop-types.html)（loop 类型官方分类）
- [Agentic Loop Engineering](../ch05/004-loop-engineering.html)（loop 工程框架）
- [Claude Code Engineering Truth](../ch03/077-claude-code.html)（工程实践）
