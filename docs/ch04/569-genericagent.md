...
## Ch04.569 GenericAgent — 复旦肖仰华自进化智能体设计哲学
...
```mermaid
mindmap
  root(("GenericAgent 复旦肖仰华自进化智能体设计哲学"))
    设计原则
      密度大于长度
      最小工具集 5类9原子
      能力生长闭环
...
- [Hermes Agent 自进化](../ch03/096-hermes-agent.html) — 另一自进化智能体实现，对比 GenericAgent 的 "做减法" vs Hermes 的 Skill 演化路径
