...
> 📊 Level ⭐⭐⭐ | 8.1KB | `entities/three-rag-architectures-classic-graph-agentic.md`
...
→ [原文存档](https://mp.weixin.qq.com/s/UNAD6ZS5p0eofHdSwaZvvg)
...
- 同题异语种孪生页：[Rag技术框架的演进方向](https://github.com/QianJinGuo/wiki-public/blob/main/entities/rag技术框架的演进方向.md)（归并候选，提案卡 #11 批1）
