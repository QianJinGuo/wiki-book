...
## Ch04.327 Fable 5 的信号:Agent 开始拼 Runtime — 架构师若飞的 Runtime Contract 工程化拆解
...
- vs **[Claude Fable 5 and new AI safety fables](../ch01/567-claude-fable-5-and-new-ai-safety-fables.html)** — Nathan Lambert 的**政策分析**(数据保留/prompt 过滤/用户未告知模型修改),本文**不**涉及政策。
...
- vs **[Harness Engineering Deletable Worksite](../ch05/046-harness-engineering-deletable-worksite-ruofei.html)** — 那是 **Harness 可删工作位**的精简原则;本文是 **Runtime 4 层**(包含 Harness 作为"工具路由层"的子集)。
...
- [Claude Fable 5 and new AI safety fables](../ch01/567-claude-fable-5-and-new-ai-safety-fables.html)
...
- [Harness Engineering Deletable Worksite](../ch05/046-harness-engineering-deletable-worksite-ruofei.html)
