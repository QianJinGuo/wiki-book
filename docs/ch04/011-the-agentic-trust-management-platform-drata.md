...
- [Stripe Financial Compliance AI Agent](ch04/385-stripe-financial-compliance-ai-agent-production-lessons.html) — 生产级合规 Agent 的架构决策与经验，与 Drata 互为实践参照
- [CrewAI Fintech Compliance Agentic AI](ch04/038-crewai-fintech-compliance-reporting-agentic-ai.html) — agentic AI 在合规报告场景的另一种落地
