...
本页作为知识图谱锚点，连接了以下关键实体：[一个 Mission 跑 16 天、烧 7.78 亿 Token：Factory 公开了多 Agent 系统的构建哲学](ch04/160-factory-missions.html)。 相关主题通过 [AutoResearch 异步多 Agent AI 寒武纪新阶段](../ch01/939-agent-ai.html) 延伸。
...
- [AutoResearch 异步多 Agent AI 寒武纪新阶段](../ch01/939-agent-ai.html)
