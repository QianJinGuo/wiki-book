...
## Ch04.657 鹅厂 Token 刺客：AI Agent 使用中的 Token 浪费反模式与实践教训
...
- 与 [GitHub Agentic Token 效率](ch04/727-agentic.html) 的"消灭未使用的 MCP 工具注册"（40 工具 → 每轮 10-15KB schema 开销）同源。
...
- [GitHub Agentic Token 效率](ch04/727-agentic.html) — 基础设施层（API proxy 审计/Optimizer 自动裁剪），本实体是使用层（开发者日常行为反模式）
- [Claude Code token 成本对比](../ch03/084-claude-code.html) — harness 间 token 差异（最多 30 倍），本实体是单 harness 内使用习惯的浪费
- [Token 不经济](../ch01/1119-20.html) — 经济学视角，本实体是工程实践视角
