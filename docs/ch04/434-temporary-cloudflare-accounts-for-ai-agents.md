...
这与 [AWS DevOps Agent](../ch11/278-aws-devops-agent.html) 中的 Agent 安全模型形成了有趣的对比：AWS 侧重于运行时的安全控制，而 Cloudflare 侧重于部署时的安全简化。
...
- [AWS DevOps Agent](../ch11/278-aws-devops-agent.html) — 另一个生产级 Agent 基础设施案例
