...
## Ch04.506 Dynamic Subagents: 代码驱动的 Subagent 编排
...
- [Anthropic Dynamic Workflows](ch01/707-anthropic.md)
- [Generator-Evaluator 对抗验证](ch01/707-anthropic.md)
- [Claude Code Subagent 规则](ch03/074-claude-code.md)
