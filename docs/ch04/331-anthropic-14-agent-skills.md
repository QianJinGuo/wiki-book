...
## Ch04.331 Anthropic 14 个 Agent Skills 设计模式
...
## 与现有知识库内容的关联
- [Claude Managed Agents](ch04/775-claude-managed-agents.html) — 托管 Harness 平台
- [Agent/Skills/Teams 架构演进与选型](ch04/341-skill.html) — Anthropic Skills 认知一致性机制
- [Skill 形式化理论](https://github.com/QianJinGuo/wiki/blob/main/concepts/skill-formal-theory-survey.md) — Skill 的六元组定义与 DAG 步骤计划

## 原始存档
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/anthropic-agent-skills-design-patterns-14.md)
...
## 相关实体
- [从 Anthropic 到 Google：Agent Skills 进入设计模式阶段](ch04/341-skill.html)
- [Anthropic 官方技能最佳实践：14 个可复用的 Agent Skills 设计模式](ch04/341-skill.html)
- [Anthropic 官方 14 种 Skill 设计模式](ch04/341-skill.html)
- [Skills 详解：拆一个技能，看 Anthropic 和 OpenAI 的思路差异](ch01/950-skills-anthropic-openai-comparison-frontend-design.html)
...
- [从 0 到 1 教你写 Agent Skill，让 AI 懂你的"潜规则"](ch04/341-skill.html)
- [Qoder Skills 完全指南](ch04/341-skill.html)
- [Hermes Agent](ch03/102-hermes-agent.html)
- [你写的 Skill，及格了吗？](ch04/341-skill.html)
...
- [9个Agent技能模块化SageMaker微调生命周期](ch05/100-ai.html)
- [SkillX — 层次化技能知识库](ch04/341-skill.html)
...
- [Trace2Skill: 轨迹经验蒸馏为可迁移 Agent Skills](ch04/341-skill.html)
...
### 与Harness模式的对应关系
[前文拆解的12个Harness设计模式](entities/claude-code-12-agentic-harness-design-patterns)关注底层机制（Loop、Planner、Tool等），而这14个Skill模式关注上层建筑（如何写技能让Claude正确使用）。两者结合才构成完整的Agent工程体系。
