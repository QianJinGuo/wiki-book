...
## 相关实体
- [Microsoft Build 2026 Qbitai Full Scope](../ch05/085-ai.html)
...
### vs [OpenClaw](../ch11/225-openclaw.html)
...
## 相关对照
- [Kimi Work](../ch01/540-codex.html) —— 本地桌面 Agent + Vibe Working
- [wow-harness v3](../ch05/018-harness.html) —— 跨 session 事件时间线
- [OpenClaw](../ch11/225-openclaw.html) —— 开源 AI 编程框架（Scout 基于它）
