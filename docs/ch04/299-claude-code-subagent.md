...
## Ch04.299 Claude Code Subagent 详解：把探索过程关进独立工作区

> 📊 Level ⭐⭐ | 8.3KB | `entities/qy_zaCZTCs1Ql3BIFmBMgg.md`
...
- [k-dense — the model is no longer the bottleneck](ch04/155-k-dense-the-model-is-no-longer-the-bottleneck.md)
