...
## Ch04.258 精选 10 个开发者常用的 AI 智能体技能（Agent Skills）
...
- [AI MAP: Security Testing for AI Agent Infrastructure — Bishop Fox](ch04/426-introducing-aimap-security-testing-for-ai-agent-bishop-f.html)
...
- [十年老技术开发的 AI Agent 探索之路](ch04/402-ai-agent.html)
- [ai agent memory systems](ch04/102-agent-memory.html)
...
- [Anthropic 联创：2028 年实现 AI 自我构建的概率超过 60%](../ch01/1324-anthropic.html)
- [国产顶尖模型 benchmark 评分那么高，可实际效果为什么差？看完 Anthropic 这篇博客，刷分的因素太单一了](../ch01/1324-anthropic.html)
- [2 小时，0 行手写代码，我用 Claude 做了一个生产级 VSCode 插件](../ch01/964-claude.html)
...
- [天猫新品营销技术团队AI编码实战指南（上）](../ch05/091-ai.html)
- [深入理解 Claude Code 源码中的 Agent Harness 构建之道](../ch05/058-agent-harness.html)
- [从Vibe Coding到Agentic Engineering：重构后台开发全流程](ch04/238-agentic.html)
...
- [深度拆解 Hermes Agent 记忆系统：它修正了 OpenClaw 的哪层误区？](../ch03/093-hermes-agent.html)
...
- [token级，精准控制生成长度：3b模型击败gpt 5.4、claude](../ch01/964-claude.html)
