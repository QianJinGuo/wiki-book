...
## 与 [Hermes Agent Deep Dive](../ch03/099-hermes-agent.html) 的关系
...
## 相关主题
- [Agent Skill Writing](ch04/614-agent-skill.html) — Skill 是 Memory 系统持久化的载体之一
...
- [Personal AI 工作台：Claude 18 动作框架](../ch05/109-ai.html)
