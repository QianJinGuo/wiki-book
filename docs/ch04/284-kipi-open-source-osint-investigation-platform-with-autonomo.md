...
## Ch04.284 Kipi: Open-source OSINT Investigation Platform with Autonomous Agent
...
这与 [Claude Code 的动态工作流](../ch09-070-claude-code-dynamic-workflows-实战模式与构建技巧/) 有相似的架构模式：LLM 做决策，工具做执行，人类做监督。
...
这与 [SchemaFlow](../ch04-499-schemaflow-agentic-database-change-impact-analysis-sql-gen/) 的思路互补：SchemaFlow 将 LLM 约束在数据库 schema 中，kipi 将 LLM 约束在图结构中。
...
这些设计对于情报分析的可信度至关重要——也与 [Gray Swan](../ch01-900-red-teaming-after-mythos-zico-kolter-matt-fredrikson-gr/) 强调的 AI 安全理念一致。
...
- 证据分级系统仍需人工校准
- 与 [prompt injection](../ch01-500-prompt-injection-as-role-confusion/) 相关的安全风险：Agent 处理的网页内容可能包含恶意指令
