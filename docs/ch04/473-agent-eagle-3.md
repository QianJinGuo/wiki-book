...
## Ch04.473 多轮 Agent 场景下，滴滴的 EAGLE-3 训推加速实践
...
- [Didi Eagle 3 Speculative Decoding Agents](../ch09/051-coding-agent.html)
- [Langsmith Trajectory Evals](../ch01/990-langsmith-trajectory-evals.html)
- [Ai Skill Metrics System](../ch01/660-ai-skill.html)

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/taobao-smart-shopping-guide-agent-evaluation-pzmx.md)
