...
- [Codex 支持通过 Computer Use 控制桌面设备](../ch09/063-codex-can-now-control-other-desktop-devices-via-computer-use.html) — Codex 的 Computer Use 扩展应用
...
- [Ettin Reranker Family](../ch01/737-introducing-the-ettin-reranker-family.html) — 高效的排序模型，可用于优化 Agent 任务路由
