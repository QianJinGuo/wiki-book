...
> -> 原文存档
从微信文章 Anthropic 最新论文：阻止 AI 叛变的方法 提取。
...
- [Yc Ryo Self Improving Company Ai](https://github.com/QianJinGuo/wiki-public/blob/main/entities/yc-ryo-self-improving-company-ai.md)
