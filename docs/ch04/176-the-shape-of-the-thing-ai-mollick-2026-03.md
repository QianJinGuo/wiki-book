...
- [Jagged Ai Frontier Mollick](../ch05/082-ai.html) — Jagged Frontier / Bottleneck / Reverse Salient（Mollick 的能力地图框架）
- [Co Existence Paradigm Shift Agentic Ai Mollick 2026](../ch01/589-ai-mollick.html) — Co-Existence 范式（Mollick 2026-06 更新，更激进的 agentic 叙事）
- [Management As Ai Superpower Mollick](../ch01/529-management-as-ai-superpower.html) — 管理作为 AI 超级能力（同一作者，delegation 方程）
