...
```mermaid
mindmap
  root(("The Shape of the Thing AI"))
    AI 能力指数曲线
...
- [Jagged Ai Frontier Mollick](../ch05/094-ai.html) — Jagged Frontier / Bottleneck / Reverse Salient（Mollick 的能力地图框架）
- [Co Existence Paradigm Shift Agentic Ai Mollick 2026](../ch01/582-ai-mollick.html) — Co-Existence 范式（Mollick 2026-06 更新，更激进的 agentic 叙事）
