...
> 📊 Level ⭐ | 5.7KB | `entities/karpathy-vibe-coding-agentic-engineering.md`

> 本页原内容在 2026-09-07 质量闭环中判定为 **dup-0.8**，已按导航页（MOC）重建；
> 原文备份见 `_archive/hub-rewrite-2026-09-07/karpathy-vibe-coding-agentic-engineering.md`，一手来源仍见下方 sources。
...
- 同题异语种孪生页：[Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](https://github.com/QianJinGuo/wiki-public/blob/main/entities/karpathy-最新访谈从-vibe-coding-到-agentic-engineering.md)（归并候选，提案卡 #11 批1）
