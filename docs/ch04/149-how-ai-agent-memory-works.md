...
## Ch04.149 How AI Agent Memory Works
...
Semantic Memory 存储抽象的事实知识和概念——不依附于特定事件，而是跨实例通用的知识表示。例如"Python 是一种解释型语言"或"React 使用虚拟 DOM"。在 Agent 系统中，Semantic Memory 常通过[知识图谱](https://github.com/QianJinGuo/wiki-public/blob/main/entities/rag-vector-knowledge-graph-ontology.md)实现，以三元组（主体-关系-客体）为存储单元，支持多跳推理和一致性查询。
...
- [Video Rag Chunking Strategy Deephub Imba](https://github.com/QianJinGuo/wiki-public/blob/main/entities/video-rag-chunking-strategy-deephub-imba.md)
