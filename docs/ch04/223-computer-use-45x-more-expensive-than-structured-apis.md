...
- [Anthropic 发布 Computer Use 最佳实践](../ch01/566-anthropic-computer-use.html) — Anthropic 官方的 Computer Use 优化建议，包括截图降采样等技巧
...
- [Ettin Reranker Family](../ch01/303-introducing-the-ettin-reranker-family.html) — 高效的排序模型，可用于优化 Agent 任务路由
...
> [!contradiction] 参见 [Anthropic Computer Use 最佳实践](../ch01/566-anthropic-computer-use.html) 持相反观点：认为 Computer Use 在某些场景下是合理选择，核心优化在于截图降采样而非完全弃用。
