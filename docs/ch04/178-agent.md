...
| **学习层**（进化） | 自我进化 | 经验沉淀、Skills 版本化、可审计的回滚 | [Small Hermes 自我进化架构](ch04/813-self-evolving-agent.html) |
...
[17种Agent架构](ch04/817-17-agent.html)的演化史本质上是三条路线在不同历史阶段的不同侧重：
...
- [fanling company as agent ai org reflection v2](../ch01/1111-agent-ai.html)
