...
- [cola dlm：字节跳动连续潜空间扩散语言模型](../ch01/274-cola-dlm.html)
- [explicit vs. implicit in the age of intelligences — le secré](052-ai.html)
...
4. （本文覆盖的4阶段+6维度Agent框架已由 entity [Agent 四阶段演化与六维度技术变化](../ch03/004-agent.html) 完整收录。
5. ）
### Prompt：渐进式披露
