...
- [Anthropic 发布 Computer Use 最佳实践](../ch01/934-anthropic-computer-use.html) — Anthropic 官方的 Computer Use 优化建议，包括截图降采样等技巧
- [Codex 支持通过 Computer Use 控制桌面设备](../ch09/142-codex-can-now-control-other-desktop-devices-via-computer-use.html) — Codex 的 Computer Use 扩展应用
- [Claude Code Tool Design 演化](../ch03/077-claude-code.html) — Anthropic 在 Agent 工具设计上的持续演进
