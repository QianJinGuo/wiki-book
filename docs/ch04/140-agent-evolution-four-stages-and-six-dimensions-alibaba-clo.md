...
## Ch04.140 Agent Evolution: Four Stages and Six Dimensions (Alibaba Cloud)

> 📊 Level ⭐⭐ | 13.5KB | `entities/agent-evolution-four-stages-six-dimensions-aliyun.md`

# Agent Evolution: Four Stages and Six Dimensions (Alibaba Cloud)

→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/agent-evolution-four-stages-six-dimensions-aliyun.md)
...
- **Cloud Code / Codex / OpenClaw / Hermes** → [Claude Code](ch03/074-claude-code.md) / [OpenClaw](ch11/210-openclaw.md) / Hermes Agent 等
...
- [Claude Code 深度解析](ch03/074-claude-code.md) — 自主 Agent 阶段（阶段三）代表
- [OpenClaw 完整指南](ch11/210-openclaw.md) — 自主 Agent 阶段（阶段三）代表
- [Claude Code Dynamic Workflows](ch03/074-claude-code.md) — 阶段三到阶段四过渡的 Dynamic Workflow 范式
- [从氛围编程到智能体工程](ch04/118-karpathy-vibe-coding-agentic-engineering.md) — Agentic Engineering 范式演进
- [Agent 记忆系统实践](ch03/044-agent.md) — Memory 模块工程化
- [Hermes Agent Operator](ch03/044-agent.md) — 自进化 Agent（阶段四）代表
- [Agent YAML 评测](ch03/044-agent.md) — 自进化机制中的评估反馈环
