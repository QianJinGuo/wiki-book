...
## Ch04.621 Tsinghua AIR AIM：AI 数学家从解题到参与前沿研究的协同工作流
...
- → [AutoResearch：AI 科学发现 L0-L4](../ch05/092-ai.html) — 定义了 AI Scientist 的自主性层级
- → [Harness Engineering Self-Improvement Survey](../ch05/112-harness-engineering.html) — Lilian Weng 的自我改进综述，覆盖 AI Scientist 领域
