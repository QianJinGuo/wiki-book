...
| 现有 entity | 应用域 | 核心方法 |
|-------------|--------|---------|
| [AI 自主科研 L0-L4](../ch05/108-ai.html) (6KB) | 科学发现 (AlphaFold / The AI Scientist) | L0-L4 五级自主性框架 |
...
这是 [高德 SDD Harness 团队 AI 编码范式](../ch05/125-ai-coding.html) 的**业务侧对应**——SDD 关注"代码的正确性"，AutoResearch 关注"决策的正确性"。
...
- vs [AI 科研 L0-L4](../ch05/108-ai.html) — 科学发现域，本文是营销业务域
...
- vs [天猫营销 AI 工作流](../ch05/108-ai.html) — 营销自动化，本文是营销**研究**（研究 + 实验 + 反馈循环）
