...
- [AgentScope Java Harness Framework 企业分布式版](ch04/503-agent.md) — 同一作者，更早的框架介绍
## 相关实体

- [enterprise readiness maturity model](ch11/197-enterprise-readiness-maturity-model.md)
