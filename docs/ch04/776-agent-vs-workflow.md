...
## Ch04.776 Agent vs Workflow：控制权连续谱与生产级选型框架
...
- [Loop Engineering](../ch05/122-loop-engineering.html) — Agent 的循环决策架构
- [Claude Code 工具系统](../ch03/085-claude-code.html) — 生产级 Agent 工具系统设计
- [AI Agent 工具数量陷阱](ch04/377-ai-agent.html) — Agent 工具工程
