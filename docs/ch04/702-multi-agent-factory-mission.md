...
## Ch04.702 Multi-Agent 架构：Factory Mission 系统的方法论
...
这与 [Harness Engineering Core Patterns](../ch05/120-harness-engineering.html) 中关于"声明式优先于命令式"的设计原则形成强对应——编排层应当尽量薄，复杂逻辑让模型在 prompt 中处理，这样模型升级能自动带动系统升级。
...
- [Claude Managed Agents 企业自托管](ch04/539-claude-managed-agents.html)——Multi-Agent 的企业部署形态
