...
## Ch04.076 LoongSuite GenAI 可观测语义规范
...
## 关联实体
- [Hermes 可观测性](https://github.com/QianJinGuo/wiki-public/blob/main/entities/hermes-observability.md) — LoongSuite 已支持 Hermes Agent 插桩
- 遵循 [OpenTelemetry](https://opentelemetry.io/) GenAI SemConv 标准，LoongSuite 是厂商增强扩展
- [Harness Engineering 框架](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/harness-engineering-framework.md) — 可观测是 Harness 的关键维度
→ 原文存档
