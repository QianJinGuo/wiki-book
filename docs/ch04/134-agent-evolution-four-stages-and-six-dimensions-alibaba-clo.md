...
## Ch04.134 Agent Evolution: Four Stages and Six Dimensions (Alibaba Cloud)
...
- **Cloud Code / Codex / OpenClaw / Hermes** → [Claude Code](ch03/073-claude-code.md) / [OpenClaw](ch11/207-openclaw.md) / Hermes Agent 等
...
- [Claude Code 深度解析](ch03/073-claude-code.md) — 自主 Agent 阶段（阶段三）代表
- [OpenClaw 完整指南](ch11/207-openclaw.md) — 自主 Agent 阶段（阶段三）代表
