...
- **Cloud Code / Codex / OpenClaw / Hermes** → [Claude Code](ch03/073-claude-code.md) / [OpenClaw](ch03/012-openclaw.md) / Hermes Agent 等
...
- [OpenClaw 完整指南](ch03/012-openclaw.md) — 自主 Agent 阶段（阶段三）代表
