...
- **Cloud Code / Codex / OpenClaw / Hermes** → [Claude Code](../ch05/070-claude-code-harness.html) / [OpenClaw](../ch11/232-openclaw.html) / Hermes Agent 等
...
- [OpenClaw 完整指南](../ch11/232-openclaw.html) — 自主 Agent 阶段（阶段三）代表
...
- [gene/gep — evomap×清华 提出的「策略基因」经验对象框架（arxiv 2604.15097）](../ch01/1316-15.html)
