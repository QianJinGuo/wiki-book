...
- **Cloud Code / Codex / OpenClaw / Hermes** → [Claude Code](../ch05/070-claude-code-harness.html) / [OpenClaw](../ch11/230-openclaw.html) / Hermes Agent 等
...
- [OpenClaw 完整指南](../ch11/230-openclaw.html) — 自主 Agent 阶段（阶段三）代表
...
- [Hermes Agent Operator](../ch03/093-hermes-agent.html) — 自进化 Agent（阶段四）代表
...
- [gene/gep — evomap×清华 提出的「策略基因」经验对象框架（arxiv 2604.15097）](../ch01/1318-15.html)
