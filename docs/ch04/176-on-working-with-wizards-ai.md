...
## Ch04.176 On Working with Wizards: AI 从协作到召唤的范式转变
...
- [Openai Gdpval Real Ai Agents Threshold](https://github.com/QianJinGuo/wiki-public/blob/main/entities/openai-gdpval-real-ai-agents-threshold.md)
- [Mass Intelligence](https://github.com/QianJinGuo/wiki-public/blob/main/entities/mass-intelligence.md)
