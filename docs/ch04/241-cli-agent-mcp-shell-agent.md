...
## Ch04.241 CLI Agent 模式：MCP 与 Shell Agent
...
- [CLI、MCP 和 CLI+Skill，应该如何选？](https://github.com/QianJinGuo/wiki-public/blob/main/entities/cli-mcp-skill-architecture-decision-vibecoder.md)
- [如何构建生产准备的AI代理：MCP、CLI与技能——适合合适的工作的工具](https://github.com/QianJinGuo/wiki-public/blob/main/entities/production-ai-agents-mcp-cli-skills-stack-ayi.md)
...
- [CLI-Anything：让 Agent 自主驱动任意 GUI 软件](https://github.com/QianJinGuo/wiki-public/blob/main/entities/cli-anything-wechat-demo-conglin.md)
- [AI Agent 的内核是 250 行 while 循环：用 Python + Ollama 从零搭建 CLI Agent 的 7 阶段教程](https://github.com/QianJinGuo/wiki-public/blob/main/entities/minimal-cli-agent-250-line-python-ollama-7-stages.md)
- [MCP Protocol](https://github.com/QianJinGuo/wiki-public/blob/main/entities/mcp-protocol.md)
- [为什么 Agent 时代大家都在做 CLI——CLI/MCP/SKILL 三层模型与 AI 友好设计](https://github.com/QianJinGuo/wiki-public/blob/main/entities/why-cli-agent-era-alibaba-tech.md)
- [Harness Engineering 核心模式](https://github.com/QianJinGuo/wiki-public/blob/main/entities/harness-engineering-core-patterns.md)
