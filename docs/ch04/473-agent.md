...
## Ch04.473 一句话生图要过时了？开源图像生成Agent进化出「工具编排」

> 📊 Level ⭐⭐ | 6.5KB | `entities/一句话生图要过时了开源图像生成agent进化出工具编排.md`
...
```mermaid
mindmap
  root(("一句话生图要过时了？开源图像生成Agent进化出「工具编排」"))
    详细信息
    原文
```
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/一句话生图要过时了开源图像生成agent进化出工具编排.md)
