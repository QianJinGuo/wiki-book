...
- **Cloud Code / Codex / OpenClaw / Hermes** → [Claude Code](../ch05/087-claude-code-harness.html) / [OpenClaw](../ch11/254-openclaw.html) / Hermes Agent 等
...
- [Agent 记忆系统实践](../ch03/019-agent.html) — Memory 模块工程化
- [Hermes Agent Operator](../ch03/099-hermes-agent.html) — 自进化 Agent（阶段四）代表
- [Agent YAML 评测](../ch03/019-agent.html) — 自进化机制中的评估反馈环
