...
## Ch04.640 Structured Memory Filtering with Metadata in AgentCore Memory
...
- `[Agent 记忆工程挑战 (AWS China)](ch04/121-agent-memory.html)` — AgentCore 记忆系统工程实践概述
- `[AgentCore Harness](ch04/660-agentcore-harness.html)` — AgentCore 整体平台
- `[AI Agent Memory Systems](ch04/121-agent-memory.html)` — Agent 记忆系统综述

→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/structured-memory-filtering-metadata-agentcore-memory.md)
