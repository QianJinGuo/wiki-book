...
- [Anthropic Multi Agent Research System](ch04/646-anthropic-multi-agent-research-system.html) — Anthropic 多智能体研究系统
- [Multi Agent Mission Factory Luke Aiengineer](../ch03/035-agent.html) — 多智能体任务工厂
- [Agent Orchestration Multi Agent Systems](ch04/596-agent-orchestration.html) — Agent 编排与多智能体系统
