...
## Ch04.065 Agent 可靠性的工程解法：从 Skillify 看持续改进机制
...
## 相关概念
- [GBrain 自进化体系](../ch01/634-llm-wiki-obsidian-wiki-gbrain.html) — skillify 是 gbrain 自演化的核心机制
...
- [AIAIGC峰会嘉宾阵容](ch04/482-aiaigc.html)
