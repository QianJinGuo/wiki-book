...
## Ch04.369 Browser Harness — 自愈型浏览器 Agent 框架
...
与 [AgentBrowser](../ch09/069-agent-browser-claude-code-qoderwork.html)、Playwright/Selenium 等方案不同，Browser Harness 不构建厚重抽象层，而是让 Agent 直接通过 CDP WebSocket 与浏览器原生状态交互。
