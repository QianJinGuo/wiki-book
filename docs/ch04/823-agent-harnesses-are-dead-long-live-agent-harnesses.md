...
## Ch04.823 Agent Harnesses Are Dead. Long Live Agent Harnesses.
...
这一洞察与 [Claude Code 动态工作流](../ch09/105-claude-code-dynamic-workflows.html) 中讨论的"工作流即基础设施"观点一致：真正的护城河不是 Agent 框架本身，而是围绕 Agent 建立的运营数据、用户习惯和组织流程。
...
- [Claude Code 动态工作流](../ch09/105-claude-code-dynamic-workflows.html)
- [Harness Generator-Evaluator](../ch01/779-anthropic.html)
- [Agent Reliability Engineering](ch04/349-skill.html)
- [当 AI 构建自身](../ch01/779-anthropic.html)
