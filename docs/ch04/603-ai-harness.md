...
## Ch04.603 深度拆解：AI 智能体 Harness 的构造【译】
...
- [从零构建大语言模型 —— 读完这篇你就懂了](../ch01/854-llm.html)
- [canvas hackers shinyhunters say their official domain was su](../ch05/097-ai.html)
...
- [democratizing machine learning at netflix: building the mode](../ch11/297-democratizing-machine-learning-at-netflix-building-the-mode.html)
- [from silos to service topology: why netflix built a real-tim](../ch11/018-from-silos-to-service-topology-why-netflix-built-a-real-tim.html)
...
- [building is just the beginning: introducing discoverability](../ch12/093-building-is-just-the-beginning-introducing-discoverability.html)
...
- [neurips 2026 使用闭源 ai 检测器 pangram 批量 desk-reject 论文事件](../ch01/1100-20.html)
- [qoder 发布团队知识引擎：组织级知识记忆是 harness 自进化的重要组件](../ch01/950-qoder.html)
- [scaling camera file processing at netflix](../ch11/024-scaling-camera-file-processing-at-netflix.html)
- [state of routing in model serving](../ch11/199-state-of-routing-in-model-serving.html)
- [大模型可控新突破：steering 机制、评估体系与开源落地](../ch01/1241-steering.html)
- [the recent history of ai in 32 otters](../ch01/823-the-recent-history-of-ai-in-32-otters.html)
- [吴恩达2026新课上线！3小时包教包会，零代码小白也能成为ai超级玩家](../ch05/097-ai.html)
