...
[17种Agent架构](ch04/593-17-agent.md)的演化史本质上是三条路线在不同历史阶段的不同侧重：
...
## 相关实体
- [清华 ai 自进化组织研究报告：ai 业务资产化与公司形态重构](ch04/229-ai.md)
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/acker-agent-evolution-three-routes-convergence.md)

- [fanling company as agent ai org reflection v2](../ch01/924-agent-ai.md)
