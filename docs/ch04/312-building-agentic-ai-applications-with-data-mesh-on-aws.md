...
## Ch04.312 Building Agentic AI Applications with Data Mesh on AWS
...
- [Agent Harnesses Are Dead](ch04/594-agent-harnesses-are-dead-long-live-agent-harnesses.md) — Agent Harness 架构演进
