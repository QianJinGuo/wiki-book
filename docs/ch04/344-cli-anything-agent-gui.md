...
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](ch04/502-agent.md) — Vibe Coding 到 Agentic Engineering 的范式转变
- [你不知道的 Agent原理架构与工程实践 V2](ch04/502-agent.md) — Agent 架构与工具使用模式
- [存之有序治之有矩Agent 记忆系统的工程实践与演进](ch04/502-agent.md) — Agent 长流程中的上下文管理
