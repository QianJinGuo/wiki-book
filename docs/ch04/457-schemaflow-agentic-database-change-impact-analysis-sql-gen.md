...
## Ch04.457 SchemaFlow: Agentic Database Change Impact Analysis, SQL Generation, and Eval Guardrails
...
- [MCP 12 设计模式](../ch01/885-anthropic.html)
- [Agent Loop 设计模式](ch04/552-agent-loop.html)
