...
## Ch04.616 A Human-Augmenting Agentic Workflow for Causal Inference
...
5. **从"AutoML"到"Auto-Science"的范式转变**：Agent 正在从自动化工程任务扩展到自动化科学方法论。关注这一趋势，在 [AgentScope](../ch05/091-harness.html) 等分布式 Agent 框架中嵌入可审计的因果推断能力，可能成为差异化竞争优势。
