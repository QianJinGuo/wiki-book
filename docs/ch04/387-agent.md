...
## Ch04.387 Agent的编排层：长任务中的上下文管理架构

> 📊 Level ⭐⭐ | 7.8KB | `entities/2026-05-01-Agent的编排层-长任务中的上下文管理架构-unknown.md`
...
source: wechat
url: https://mp.weixin.qq.com/s/vT_KE8GnvA24BfrMAQVvPw
mp_name: Unknown
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/2026-05-01-Agent的编排层-长任务中的上下文管理架构-unknown.md)
