...
## Ch04.644 Agent Skills 无依赖设计：Skill 之间不传数据的哲学与实践
...
- → [Agent Skill 规范、构建与设计模式](ch04/612-agent-skill.html) — 更多关注如何构建 skill（Skill-Creator、设计模式等）
- → [Hermes Agent Skills 源码级拆解](ch04/532-hermes-agent-skills.html) — 同一作者（术哥）的源码级分析
