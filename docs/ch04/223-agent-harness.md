...
- [Harness Engineering](ch05/120-harness-engineering.html)（Harness 工程方法论）

## 相关实体
- [Agent架构关键变化：Harness正在成为新后端](ch03/035-agent.html)
- [Agent Harness 组件解析](ch05/094-ai.html)
...
- [AI Native 时代 —— 研发组织何去何从](ch05/094-ai.html)
