...
mindmap
  root(("Secure AI agents with Policy…"))
    ...
    Policy enforcement in A…
      ...
      Policy evaluation resul…
      Benefits of policy-base…
    Interceptors for dynami…
      Design 2: Interceptor o…
      Call flow for the Inter…
      Dynamic tool filtering …
    When to use Policy comp…
    Combining Policy and La…
      Design 3: Policy + Inte…
      Policy evaluation resul…
    End-to-end implementati…
      Step 1: Pre-deploy gen…
      Step 2: CDK deploy
      Step 3: Validate with t…
    Observability: end-to-e…
```
