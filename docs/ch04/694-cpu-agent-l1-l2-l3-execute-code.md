...
## Ch04.694 CPU 缓存类比下的 Agent 上下文管理：L1/L2/L3 层级架构与 execute_code 单工具设计
...
### 与 [Anthropic 工具数量陷阱](ch04/505-ai-agent.html) 的对比
...
- [AI Agent 工具数量陷阱](ch04/505-ai-agent.html) — "5-10 工具"是 Anthropic 答案；"1 execute_code"是本文答案（更激进的同向论述）
- [Agent Harness 上下文管理工作集视角](../ch05/057-agent-harness.html) — 工作集是 **L1 内部**的精细化设计；本文是工作集的 L1/L2/L3 宏观扩展
...
- [Codex 上下文工程 LastWhisper](../ch01/518-codex.html) — 另一家 Code 厂商的上下文视角
- [上下文工程系列](ch04/063-agentic-ai.html) — 系列化上下文工程讨论
