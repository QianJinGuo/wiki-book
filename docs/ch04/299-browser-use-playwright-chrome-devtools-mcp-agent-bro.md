...
把跑通的网页流程打包成 SKILL.md + 脚本，下次 Agent 直接调用。**注：与 [古法程序员 spec-as-code](https://mp.weixin.qq.com/s/Q_k2duvAIv7hm9y6VxH3mQ) 的 SKILL.md 模式直接重叠**——古法程序员是通用框架，BrowserAct 是网页操作特化。
...
→ [原文存档](https://mp.weixin.qq.com/s/2aqrTvswa6FtqI-GK-EmvQ)
→ [BrowserAct 原文存档（待验证）](https://mp.weixin.qq.com/s/2CJS3LNKLAR1rQE4zxoFcg)
