...
## Ch04.214 AgentEval：YAML驱动的Agent评测框架
...
## 相关实体
- [Anthropic Generator-Evaluator Harness](../ch01/1592-anthropic.html) — 另一种评测闭环思路
- [Superpowers](../ch01/707-claude-code-skills-superpowers.html) — Agent 工作流规范
