...
## Ch04.478 Loop Engineering 概念解析：Agent Loop vs Loop Engineering、六大框架与实践思考
...
与 [Loop Engineering 系统框架](../ch05/005-loop-engineering.html) 的关系：梦朝思夕的四次跃迁框架（Prompt → Context → Harness → Loop）提供了历史脉络，本文则从 Agent Loop 底层机制出发，解释了为什么 Loop Engineering 是"此 Loop 非彼 Loop"。
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/loop-engineering-实战实现从日志扫描到预发部署的全自主闭环.md)

## 相关实体

- [Loop Engineering 系统框架](../ch05/005-loop-engineering.html) — 四次跃迁、五要素模型、成本公式
- [Agent Loop 工程手册](../ch05/005-loop-engineering.html) — 腾讯陈进的8个未解问题
- [Loop Engineering: 设计替你写提示词的循环](../ch05/005-loop-engineering.html) — Addy Osmani 原始框架
