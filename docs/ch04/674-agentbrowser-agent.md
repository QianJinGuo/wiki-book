...
## Ch04.674 AgentBrowser：Agent 浏览器工具框架
...
## Related
- [CLI-Anything](../ch03/105-cli-anything.html) — Agent 工具生态
- [AutoCLI](../ch03/130-autocli.html) — 信息获取 CLI
- [Hermes-Agent](../ch03/102-hermes-agent.html) — 可通过 AgentBrowser 扩展能力
