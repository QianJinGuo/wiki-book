...
## Ch04.815 Agent Protocol 不变层：跨框架的 6 个稳定 Runtime 对象
...
- [From Agent Protocol to Harness Skill](ch04/511-from-agent-protocol-to-harness-skill.html) — 从 MCP/A2A 协议到 Harness Skill 的演进路径，与本文的 Runtime Protocol 抽象视角不同
...
- [Agent 架构关键变化：Harness 成为新后端](../ch05/077-harness.html) — Harness 作为 Runtime 演进方向
- [MCP · Skill · Agent · LLM · Harness](../ch05/102-harness-skill.html) — 高层架构关系图
