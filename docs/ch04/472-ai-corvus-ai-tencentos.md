...
## Ch04.472 科维斯 AI（Corvus AI）— TencentOS 内核漏洞研究智能体首秀
...
- [Agent 安全攻防综述](ch04/581-ai-agent.html)
- [Agent 评测综述（IBM/Yale 2026）](../ch03/037-agent.html)
- [Fragnesia：Linux 内核 LPE（ESP-in-TCP）](../ch01/408-rag.html)
...
- [AI 漏洞研究的历史重演视角](../ch05/107-ai.html)
