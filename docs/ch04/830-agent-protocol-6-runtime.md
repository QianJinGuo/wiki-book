...
## Ch04.830 Agent Protocol 不变层：跨框架的 6 个稳定 Runtime 对象
...
- [From Agent Protocol to Harness Skill](ch04/520-from-agent-protocol-to-harness-skill.html) — 从 MCP/A2A 协议到 Harness Skill 的演进路径，与本文的 Runtime Protocol 抽象视角不同
- [Google Agent Executor](../ch03/037-agent.html) — 分布式 Runtime 实现案例
- [Agent Harness 架构](../ch05/043-agent-harness.html) — Harness 作为 Runtime 的上层封装
