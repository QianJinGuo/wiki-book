...
本文档与 wiki 中的 [Agent Skill 设计模式](ch04/341-skill.html)、[BBuf AI-Infra-Auto-Driven-SKILLS](ch04/341-skill.html) 和 [Skill Engineering](ch04/341-skill.html) 实体直接关联。SGLang 的实践展示了如何在真实的生产级基础设施项目中应用 Agent Skill Engineering 的方法论。
