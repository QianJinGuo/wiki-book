...
## Ch04.340 ACL 2026 | XG-Guard：用图异常检测抓出多智能体网络中的内鬼
...
- [Anthropic Multi Agent Research System](ch04/571-anthropic-multi-agent-research-system.html) — Anthropic 多智能体研究系统
- [Multi Agent Mission Factory Luke Aiengineer](../ch03/035-agent.html) — 多智能体任务工厂
- [Agent Orchestration Multi Agent Systems](ch04/513-agent-orchestration.html) — Agent 编排与多智能体系统
- [Icml 2026如何对Multi Agent系统进行过程评估重新认识多智能体系统中的Orchestrator](../ch01/1291-icml-2026.html) — ICML 2026 MAS 过程评估
