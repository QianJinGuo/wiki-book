...
## Ch04.713 训练LLM智能体的七条实战经验——Agentic RL最佳实践
...
- [2026 年面向 LLM 的 RL 方法总结](../ch01/617-llm.html)
- [Amazon Nova 多轮 RL 推理基础设施](../ch11/297-deploying-multi-turn-rl-infrastructure-for-amazon-nova-on-am.html)
- [Harness 工程实践：如何让 Agent 完成自主迭代](../ch05/110-harness.html)
