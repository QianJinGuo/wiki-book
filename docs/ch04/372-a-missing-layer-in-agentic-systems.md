...
- [Hands Free First Notice Of Loss Using Strands Agents And Ama](ch03/035-agent.html) — 保险 FNOL 中的人类角色重置
- [Build An Ai Powered Equipment Repair Assistant Using Amazon ](ch05/094-ai.html) — AgentCore 维修助手的记忆层设计
