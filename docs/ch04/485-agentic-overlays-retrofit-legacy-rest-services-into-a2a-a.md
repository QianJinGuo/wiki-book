...
## Ch04.485 Agentic Overlays -- Retrofit Legacy REST Services into A2A Agents
...
- [Agent Harnesses Are Dead](ch04/719-agent-harnesses-are-dead-long-live-agent-harnesses.html) — Agent Harness 架构演进讨论
