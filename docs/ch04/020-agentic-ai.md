...
- [AI Infra 运维智能体基准](https://github.com/QianJinGuo/wiki-public/blob/main/entities/直击gpu集群真实故障首个ai-infra运维智能体基准开源.md) — Agent 评测与精度保障
- [Spec as AIOS：AI-Native 架构](https://github.com/QianJinGuo/wiki-public/blob/main/entities/spec-as-aios-anti-entropy-architecture-gaode-ai-native-series-2.md) — 阿里巴巴系 AI Native 实践，与维纳的推理数据生成互补
- [Lilian Weng Harness Engineering — RSI 从 Harness 开始](https://github.com/QianJinGuo/wiki-public/blob/main/entities/lilian-weng-harness-engineering-self-improvement.md) — Harness 自进化方向与维纳的闭环反馈理念相通
