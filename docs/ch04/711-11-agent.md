...
## Ch04.711 第 11 篇 · 上下文压缩：让 Agent 在长会话中持续工作
...
## 相关实体
- [Langchain用Agent做销售获客3个月转化率提升25倍看完后我发现国内 Agent 落地的方法都错了](../ch01/346-langchain.html)
...
- [Tencentdb Agent Memory Long Term Pyramid](../ch06/009-tencentdb-agent-memory.html)
