...
- `[Agent Harness 12 Components 7 Decisions](ch05/085-harness.md)` — 复杂多 Agent 系统的设计参考（harness 12 组件 + 7 决策），本实体的下游
- `[Agent Harness Engineering Survey 2026](ch01/216-0.md)` — Harness Engineering 综述，提供"harness 是什么"的理论基础
