...
## Ch04.256 Anthropic 14 个 Agent Skills 设计模式
...
## 与现有知识库内容的关联
- [Claude Managed Agents](ch04/485-claude-managed-agents.md) — 托管 Harness 平台
- [Agent/Skills/Teams 架构演进与选型](ch04/233-agent-skills-teams.md) — Anthropic Skills 认知一致性机制
...
- [Anthropic 官方 14 种 Skill 设计模式](../ch01/833-anthropic.md)
- [Skills 详解：拆一个技能，看 Anthropic 和 OpenAI 的思路差异](../ch01/652-skills-anthropic-openai-comparison-frontend-design.md)
...
- [从 0 到 1 教你写 Agent Skill，让 AI 懂你的"潜规则"](ch04/260-agent-skill.md)
