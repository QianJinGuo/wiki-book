...
## Ch04.535 Harness Handbook — 行为级 Agent Harness 手册：可理解、可审计、可编辑
...
- [Harness Engineering](../ch05/117-harness-engineering.html)、[Harness Engineering Framework](../ch05/117-harness-engineering.html)（工程范式）
