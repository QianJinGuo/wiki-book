...
## Ch04.471 Anthropic PM 的 Agentic 工作流
...
## 相关
- [Claude Code 搜索架构](../ch03/077-claude-code.html)
- [Cat Wu: Claude Code PM 工作流](../ch03/077-claude-code.html)
- [AutoResearch 多 Agent 开发](../ch03/035-agent.html)
- [Agent Memory 模块化框架](ch04/101-agent-memory.html)
- [AI Team 知识 Harness](https://github.com/QianJinGuo/wiki/blob/main/concepts/ai-team-knowledge-harness.md)

## 相关实体
- [Japan's PM orders cybersecurity review to defend against Anthropic Mythos](../ch01/1326-anthropic.html)
