...
## Ch04.542 Asana Agentic Work Management Platform — Work Graph as Agentic OS
...
- 与 **[claude-code-large-codebase-harness-configuration](ch03/074-claude-code.md)** 的关系:Command by Asana 试图用 workflow 框架而非 coding agent 实现「人+代理协作」,与 Claude Code 在 coding 场景的 agentic 思路形成对比(work-graph orchestration vs direct coding agent)
