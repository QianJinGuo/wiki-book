...
| [Agent Self Improvement Six Mechanisms](ch03/044-agent.md) | **6 大自改进机制** | Agent 自改进的 6 大机制 |
...
| [Hermes Agent 12 Layer Full Configuration Guide](ch03/044-agent.md) | **Hermes 12 层配置** | Hermes Agent 12 层完整配置 |
| [Hermes 9 Module Architecture](ch01/342-hermes-9-module-architecture-winty.md) | **Hermes 9 模块** | Hermes 9 模块架构 |
| [Harness Engineering 7 Layers Openclaw Hermes Claude Code P1Anu](ch03/074-claude-code.md) | **7 层 Harness** | OpenClaw/Hermes/Claude Code 7 层 Harness |
...
| [Claude Code Vs Hermes Session Vs Goal Lifecycle](ch03/074-claude-code.md) | **Hermes 生命周期** | Session vs Goal lifecycle 对比 |
