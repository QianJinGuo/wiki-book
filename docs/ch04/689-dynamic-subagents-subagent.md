...
## Ch04.689 Dynamic Subagents: 代码驱动的 Subagent 编排
...
- [Anthropic Dynamic Workflows](../ch01/776-anthropic.html)
- [Generator-Evaluator 对抗验证](../ch01/776-anthropic.html)
- [Claude Code Subagent 规则](../ch09/099-claude-code-1.html)
