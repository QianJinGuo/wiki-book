...
- [Agent Architecture & Harness](../ch05/009-harness.md) — Agent 架构与 Harness 的关系
- [Open-Claw Tool 消息总线](../ch03/045-agent.md) — 子 Agent 管理架构实践
...
- [Harness不是目的，知识才是护城河 —— 一个AI工程交付团队的知识沉淀实践](../ch05/009-harness.md)- [Harness不是目的，知识才是护城河 —— 一个AI工程交付团队的知识沉淀实践](../ch05/009-harness.md)
