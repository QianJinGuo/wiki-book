...
## Ch04.350 Greptile TREX：AI 代码审查的执行引擎与 Agent 嵌套架构
...
- [Claude Code 大型代码库 Harness](ch03/073-claude-code.md) — 代码库索引和 Agent 配置的工程实践
- [StackOverflow for Agents](ch04/503-agent.md) — Agent 间知识共享的另一种模式
- [GitHub Agentic Token 效率](ch04/503-agent.md) — Agent 在代码审查场景的 token 优化
