...
- vs **[Anthropic Claude Fable 5 on AWS:Mythos 级功能](../ch01/1607-anthropic-claude.html)** — 那是**AWS 官方产品介绍**(功能/部署/内置保护),本文是**架构师工程化拆解**(Runtime 协议层)。两者互补。
...
- [Anthropic Claude Fable 5 on AWS](../ch01/1607-anthropic-claude.html)
