...
- vs **[Anthropic Claude Fable 5 on AWS:Mythos 级功能](../ch01/1588-anthropic-claude.html)** — 那是**AWS 官方产品介绍**(功能/部署/内置保护),本文是**架构师工程化拆解**(Runtime 协议层)。两者互补。
...
- vs **[Claude Fable 5 — Mollick patron vs wizard](../ch01/473-claude-fable-5.html)** — Mollick 的**hands-on 用户体验视角**(4 用例 + patron vs wizard 框架),本文是**架构师工程视角**。两者对应"产品体验"vs"产品架构"。
- vs **[Claude Fable 5 提示词泄漏 — Runtime Control Plane 安全工程启示](../ch01/473-claude-fable-5.html)** — 同样用"Runtime"概念,但**VibeCoder 重点在安全工程** (Prompt 不能当保险箱 / 攻击面像系统 / 分类器组合风险),**本文重点在工程协议** (Task Brief / 能力路由 / 状态账本 / 治理层)。两者**完全互补**: 一个看 Runtime 怎么被攻击,一个看 Runtime 怎么被设计。
...
- vs **[Claude Code agent teams task decomposition ruofei](../ch01/518-claude-code-agent-teams.html)** — 那是**任务分解**(具体执行);本文是**任务协议** (前置契约)。
...
- [Claude Fable 5 提示词泄漏 — Runtime Control Plane](../ch01/473-claude-fable-5.html)
- [Anthropic Claude Fable 5 on AWS](../ch01/1588-anthropic-claude.html)
- [Claude Fable 5 and new AI safety fables](../ch01/1175-claude-fable-5-and-new-ai-safety-fables.html)
- [Claude Fable 5 — Mollick patron vs wizard](../ch01/473-claude-fable-5.html)
- [若飞 5 张卡治理](../ch03/098-hermes-agent.html)
- [若飞 Ralph loop 状态交接](../ch05/077-harness.html)
- [Claude Code agent teams task decomposition](../ch01/518-claude-code-agent-teams.html)
