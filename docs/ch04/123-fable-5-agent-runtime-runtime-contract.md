...
- vs **[Anthropic Claude Fable 5 on AWS:Mythos 级功能](../ch01/1134-anthropic-claude.html)** — 那是**AWS 官方产品介绍**(功能/部署/内置保护),本文是**架构师工程化拆解**(Runtime 协议层)。两者互补。
- vs **[Claude Fable 5 and new AI safety fables](../ch01/1168-claude-fable-5-and-new-ai-safety-fables.html)** — Nathan Lambert 的**政策分析**(数据保留/prompt 过滤/用户未告知模型修改),本文**不**涉及政策。
...
- vs **[若飞 long-running agent ralph loop 状态交接](../ch05/085-harness.html)** — 那是 **Ralph loop 状态交接**具体工程模式;本文是 **Runtime 协议**宏观框架。
- vs **[Claude Code agent teams task decomposition ruofei](../ch01/521-claude-code-agent-teams.html)** — 那是**任务分解**(具体执行);本文是**任务协议** (前置契约)。
...
- [Anthropic Claude Fable 5 on AWS](../ch01/1134-anthropic-claude.html)
- [Claude Fable 5 and new AI safety fables](../ch01/1168-claude-fable-5-and-new-ai-safety-fables.html)
- [Claude Fable 5 — Mollick patron vs wizard](../ch01/474-claude-fable-5.html)
- [若飞 5 张卡治理](../ch03/102-hermes-agent.html)
- [若飞 Ralph loop 状态交接](../ch05/085-harness.html)
- [Claude Code agent teams task decomposition](../ch01/521-claude-code-agent-teams.html)
