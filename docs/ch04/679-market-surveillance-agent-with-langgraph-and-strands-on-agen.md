...
## Ch04.679 Market surveillance agent with LangGraph and Strands on AgentCore
...
- [Building web search agents with Strands and Exa](ch04/550-building-web-search-enabled-agents-with-strands-and-exa.html)
- [Deep Agents 子 Agent 编排](ch04/595-agent-orchestration.html)
- [Evaluating AI agents production blueprint](ch04/209-ai-agent.html)
- [AgentCore Gateway MCP](ch04/634-amazon-bedrock-agentcore.html)
