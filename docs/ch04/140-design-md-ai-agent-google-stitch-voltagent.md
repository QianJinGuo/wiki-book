...
## Ch04.140 DESIGN.md：AI 设计 Agent 的视觉约束对齐文件（Google Stitch × VoltAgent）
...
- [Anthropic Google Agent Skills Design Patterns](ch04/254-anthropic-google-agent-skills.html)
