...
## Ch04.532 LangChain × Fireworks 100x Cheaper Trace Judge — 通用 trace 评估器
...
## 相关实体
- [langsmith engine: trace-based self-improving agent](../ch03/046-agent.html)
- [skillsui 企业 agent 中间层](../ch03/101-skillsui.html)
