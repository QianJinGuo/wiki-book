...
## 关联实体
- [Hermes Agent 记忆系统](../ch06/013-hermes-agent-memory.html) — 本文的 memory 管理理念与 Hermes 实现直接对应
- [Agent Harness 上下文管理](../ch05/043-agent-harness.html) — Memory 是 Harness 控制面的一层
- [Claude Code Agent 工程化](../ch03/075-claude-code-agent.html) — CLAUDE.md / AGENTS.md 工作区文件实践
...
## 相关实体
- [Agent Memory 架构本质](ch04/517-perplexity-brain-self-improving-agent-memory-architecture.html)
