...
## Ch04.486 CLI-Anything：让 Agent 自主驱动任意 GUI 软件
...
- [两万字详解Claude Code源码核心机制](../ch03/084-claude-code.html) — Claude Code 的工具调用与插件机制
- [Karpathy 最新访谈从 Vibe Coding 到 Agentic Engineering](ch04/073-agentic.html) — Vibe Coding 到 Agentic Engineering 的范式转变
