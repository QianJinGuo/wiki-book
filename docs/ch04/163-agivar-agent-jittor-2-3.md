...
## Ch04.163 Agivar 录屏教学桌面 Agent：清华非十科技 大脑小脑双层架构 + Jittor 推理引擎 + 2.3× 速度 + 三层确定性
...
→ [Anthropic Computer Use 最佳实践](ch01/689-anthropic-computer-use.md) — 通用多模态大模型路径
→ [Computer Use 45× 成本问题](ch04/248-computer-use-45x-more-expensive-than-structured-apis.md) — Computer Use 的成本痛点
