...
- **Cloud Code / Codex / OpenClaw / Hermes** → [Claude Code](../ch05/064-claude-code-harness.html) / [OpenClaw](../ch11/225-openclaw.html) / Hermes Agent 等
...
- [Claude Code 深度解析](../ch05/064-claude-code-harness.html) — 自主 Agent 阶段（阶段三）代表
- [OpenClaw 完整指南](../ch11/225-openclaw.html) — 自主 Agent 阶段（阶段三）代表
- [Claude Code Dynamic Workflows](../ch09/083-claude-code-dynamic-workflows.html) — 阶段三到阶段四过渡的 Dynamic Workflow 范式
