...
- **Cloud Code / Codex / OpenClaw / Hermes** → [Claude Code](../ch05/063-claude-code-harness.html) / [OpenClaw](../ch11/214-openclaw.html) / Hermes Agent 等
...
- [gene/gep — evomap×清华 提出的「策略基因」经验对象框架（arxiv 2604.15097）](../ch01/1247-15.html)
