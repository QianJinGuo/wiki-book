...
- [Agentic RL: Token-In, Token-Out Done Right](ch04/845-agentic-rl-token-in-token-out-done-right.html) — 同主题早期文章，本文是更全面的系统综述
- [港中文 SLIM：动态技能生命周期管理](ch04/314-agentic-rl.html) — Agentic RL 中的技能管理
- [LLM-as-a-Verifier](../ch01/1523-llm.html) — Agent 轨迹验证方法
