...
## Ch04.185 不用再学AI了！生成结果包稳的Agent来了
...
- [NVIDIA Agentic Systems](ch04/238-agentic.html) — 英伟达在 Agent 系统层面的超大规模协同设计实践
- [Kimi K2 Agent 数据库](../ch03/035-agent.html) — 国产 Agent 在数据库场景的应用
- [Claude Managed Agents](ch04/529-claude-managed-agents.html) — Claude 的托管 Agent 架构与 MCP 集成
