...
| 层次 | 对应路线 | 核心能力 | 代表系统 |
|------|---------|---------|---------|
| **理解层**（上下文） | 个人上下文 | 用户意图理解、上下文记忆、偏好推断 | [Agent Harness 工作集管理](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-harness-context-management-working-set.md) |
| **学习层**（进化） | 自我进化 | 经验沉淀、Skills 版本化、可审计的回滚 | [Small Hermes 自我进化架构](https://github.com/QianJinGuo/wiki-public/blob/main/entities/small-hermes-self-evolving-agent-architecture.md) |
...
参考：[Agent Harness Engineering Survey](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-harness-engineering-survey-2026.md) 中的 ETCLOVG 治理维度。
...
[17种Agent架构](https://github.com/QianJinGuo/wiki-public/blob/main/entities/17-agent-architectures-evolution.md)的演化史本质上是三条路线在不同历史阶段的不同侧重：
