...
## Ch04.094 Anthropic 官方技能最佳实践：14 个可复用的 Agent Skills 设计模式
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/anthropic-官方技能最佳实践14-个可复用的-agent-skills-设计模式.md)
