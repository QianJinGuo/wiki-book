...
## Ch04.343 Agentic Environment Engineering：Harness 之上下一层门槛
...
- [Harness 之后：可删的工作现场](../ch05/091-harness-engineering-deletable-worksite-ruofei.html)——"可删的工作现场"概念与 Environment 的可恢复性呼应
