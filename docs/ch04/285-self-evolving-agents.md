...
## Ch04.285 Self-Evolving Agents 系统性综述
...
- [Agent Memory Modular Framework](ch04/154-agent-memory.html) — Memory 模块化框架，与 Environment-Centric Modular Architecture Evolution 相关
