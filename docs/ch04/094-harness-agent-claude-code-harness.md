...
- [Better Harness Eval Trace Harness Hill Climbing](ch05/085-harness.md) — Trace-driven 评测 + Harness hill-climbing 自优化循环。本实体是"评测方案设计"的人工智能辅助；那个是"评测驱动的 Harness 优化"反馈环。
