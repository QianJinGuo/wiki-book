...
## Ch04.537 Proactive Memory Agent — Meta AI (Wu et al. 2026)
...
- [AGENT MEMORY MODULAR FRAMEWORK](ch04/098-agent-memory.html) 和 [Agent Memory Architecture](ch04/433-perplexity-brain-self-improving-agent-memory-architecture.html) 主要关注记忆存储的层次化结构，而这篇论文聚焦于记忆的 **主动干预时机**；
- [Hermes Agent Memory System](../ch03/096-hermes-agent.html) 的三层架构侧重持久化存储，论文的贡献在于何时以及如何 **注入记忆**；
...
- [Agent Memory Injection](ch04/098-agent-memory.html) 从注入维度角度探讨了相似主题。
...
- [Agentic RL Frameworks Long-Horizon Wolfe 2026](ch04/236-agentic-rl.html)
...
- [Agent Memory Storage Six Schools](ch04/098-agent-memory.html)
