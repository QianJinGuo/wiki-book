...
## Ch04.607 AIAIGC峰会嘉宾阵容

> 📊 Level ⭐⭐ | 5.4KB | `entities/aiaigc-summit-guest-lineup.md`

> -> [[raw/articles/aiaigc-summit-guest-lineup.md|原文存档]
...
## 深度分析
**嘉宾构成反映AIGC产业发展三大趋势**^[].md]

从本次公布的嘉宾阵容可以清晰看出AIGC领域的三条演进主线：^[].md]

**1. 具身智能从实验室走向规模化应用**^[].md]
...
**从「讨论AI未来」到「现在就用起来」的主题转变**^[].md]

本届峰会口号极具象征意义：不再只讨论AI的未来，而是现在就用起来。这意味着：^[].md]
