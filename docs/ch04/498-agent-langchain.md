...
## Ch04.498 改进 Agent：数据挖掘视角与 LangChain 实践
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/agent-improvement-data-mining-trace.md)
...
- [Agent vs Workflow 控制权连续谱](ch04/777-agent-vs-workflow.html) — Agent 工程化
- [Loop Engineering](../ch05/123-loop-engineering.html) — Agent 循环决策与 Harness 工程的交叉
- [Spec Kit/OpenSpec/Superpowers 融合 Harness](../ch05/056-openspec.html) — Harness 工程实践
