...
| 实体 | 关注点 | 本文差异 |
|------|--------|---------|
| [Agentcore Harness](ch04/464-amazon-bedrock-agentcore-harness-ga-api-agent.html) | AgentCore 平台概念 + Harness 趋势 | 偏理论，无代码 |
| [Agentcore Managed Harness](ch04/219-agentcore-managed-harness.html) | 托管 Harness 平台 overview | 无具体 subagent 编排 |
| [Langchain Harrison Chase Sandbox Architecture](../ch05/077-ai.html) | LangChain 沙箱架构演进 | 聚焦 sandbox，不涉及 Bedrock AgentCore 集成 |
