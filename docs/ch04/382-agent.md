...
- [Harness Engineering 框架](../ch05/062-harness-engineering.html) — Agent 运行底座的系统性方法论
- [上下文工作集管理](../ch05/038-agent-harness.html) — 上下文作为运行时工作集的具体实践
