...
## Ch04.368 Kipi: Open-source OSINT Investigation Platform with Autonomous Agent
...
这与 [SchemaFlow](ch04/725-agentic.html) 的思路互补：SchemaFlow 将 LLM 约束在数据库 schema 中，kipi 将 LLM 约束在图结构中。
...
- [SchemaFlow](ch04/725-agentic.html) — 结构化数据的 LLM 约束
