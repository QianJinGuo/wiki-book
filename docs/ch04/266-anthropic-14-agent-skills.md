...
## Ch04.266 Anthropic 14 个 Agent Skills 设计模式
...
## 与现有知识库内容的关联
- [Claude Managed Agents](ch04/537-claude-managed-agents.html) — 托管 Harness 平台
- [Agent/Skills/Teams 架构演进与选型](ch04/240-agent-skills-teams.html) — Anthropic Skills 认知一致性机制
...
## 相关实体
- [从 Anthropic 到 Google：Agent Skills 进入设计模式阶段](ch04/194-anthropic-google-agent-skills.html)
- [Anthropic 官方技能最佳实践：14 个可复用的 Agent Skills 设计模式](ch04/398-agent-skills.html)
- [Anthropic 官方 14 种 Skill 设计模式](../ch01/1327-anthropic.html)
- [Skills 详解：拆一个技能，看 Anthropic 和 OpenAI 的思路差异](../ch01/715-skills-anthropic-openai-comparison-frontend-design.html)
...
- [9个Agent技能模块化SageMaker微调生命周期](ch04/417-aws-sagemaker-ai-agent.html)
...
- [Trace2Skill: 轨迹经验蒸馏为可迁移 Agent Skills](ch04/398-agent-skills.html)
