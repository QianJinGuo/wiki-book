...
| 层次 | 对应路线 | 核心能力 | 代表系统 |
|------|---------|---------|---------|
| **理解层**（上下文） | 个人上下文 | 用户意图理解、上下文记忆、偏好推断 | [Agent Harness 工作集管理](../ch05/063-agent-harness.html) |
...
参考：[Agent Harness Engineering Survey](../ch05/057-harness-engineering.html) 中的 ETCLOVG 治理维度。
