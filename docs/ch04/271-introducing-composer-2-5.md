...
## 相关实体
- [Nomshub Cursor Remote Tunnel Sandbox Breakout Straiker](https://github.com/QianJinGuo/wiki-public/blob/main/entities/nomshub-cursor-remote-tunnel-sandbox-breakout-straiker.md)
...
- [Cursor 复盘 Harness模型决定能力上限Harness 决定生产下限](https://github.com/QianJinGuo/wiki-public/blob/main/entities/cursor-复盘-harness模型决定能力上限harness-决定生产下限.md)
...
→ [原文存档](https://cursor.com/blog/composer-2-5)
