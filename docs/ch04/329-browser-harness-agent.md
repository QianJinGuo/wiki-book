...
与 [CLI-Anything](ch03/091-cli-anything.md)/[OpenCLI](ch03/080-opencli.md)/[AutoCLI](ch03/114-autocli.md) 等 CLI 化方案不同，Browser Harness 走的是**浏览器原生操作**路线而非命令行封装，二者互补而非替代。
