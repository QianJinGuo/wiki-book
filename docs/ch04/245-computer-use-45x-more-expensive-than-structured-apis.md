...
- [Anthropic 发布 Computer Use 最佳实践](ch01/689-anthropic-computer-use.md) — Anthropic 官方的 Computer Use 优化建议，包括截图降采样等技巧
...
- [Claude Code Tool Design 演化](ch03/074-claude-code.md) — Anthropic 在 Agent 工具设计上的持续演进
