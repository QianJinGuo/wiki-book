...
## Ch04.099 智能时空思考Agent｜首个真实出行隐式意图评测基准LBS-IntentBench正式开源
...
## 相关实体
- [Lbs Intentbench](414-lbs-intentbench.html)
- [Programbench Agent Benchmark](377-programbench-agent-benchmark.html)
- [Computer Use 45X More Expensive Than Structured Apis](411-computer-use-45x-more-expensive-than-structured-apis.html)
- [3 Persons 100 Ai Programmers 1 3 Million Openai Pays](https://github.com/QianJinGuo/wiki-public/blob/main/entities/3-persons-100-ai-programmers-1-3-million-openai-pays.md)
