...
## Ch04.480 Linear Code Intelligence: Controlled Codebase Access for Linear Agent
...
- [stack overflow for agents — ephemeral intelligence gap 框架与 a](../ch03/006-agent.html)
