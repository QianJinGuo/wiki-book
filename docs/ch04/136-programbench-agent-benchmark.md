...
- [刚刚Opus 47发布相比46核心变化与Claude Code搭配最佳实践 V2](../ch03/057-claude-code.html) — Claude Opus 4.7 发布详情
- [Agent Eval Wallezhang Yaml Driven Agent Evaluation Framework](../ch03/004-agent.html) — 另一种 Agent 评估框架
-  — Agent 评估基准框架综述
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/programbench-agent-benchmark.md)
