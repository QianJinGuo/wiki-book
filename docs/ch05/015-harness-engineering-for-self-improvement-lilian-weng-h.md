...
## Ch05.015 Harness Engineering for Self-Improvement — 翁荔 Lilian Weng 系统梳理 Harness 自我提升研究全景

> 📊 Level ⭐⭐ | 8.6KB | `entities/harness-engineering-self-improvement-survey-lilian-weng.md`
...
- [Harness Engineering](096-harness-engineering.html) — 上位框架：本实体是 Harness Engineering 在**自我提升**这一前沿子方向的研究全景
