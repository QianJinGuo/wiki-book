...
- → [Harness Engineering 实体](ch05/112-harness-engineering.html)：Harness 部分与该实体高度互补，提供更完整的框架拆解
- → [2026 Harness 工程survey](ch05/112-harness-engineering.html)：行业层面的 Harness 工程全景图
- → [生产级 Harness 工程](ch05/112-harness-engineering.html)：侧重生产环境的治理与 control plane 实践
