...
## Ch05.078 Agent Harness Skill 系统实战指南 — Reference/Action 类型、动态注入与 frontmatter 全解
...
- [Harness Engineering](ch05/117-harness-engineering.html) — 上位框架：Skill 是 Harness Engineering 六层架构中"工具与技能体系"层的具体实现
