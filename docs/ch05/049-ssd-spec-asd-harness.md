...
## Ch05.049 SSD Spec 驱动开发实战：从四条约束到 ASD Harness 的工程落地
...
- [术哥三器对比：Comet/OpenSpec/Superpowers](ch05/094-ai.html) — 同作者系列第二篇
- [Spec 作为 AIOS 反熵架构](ch05/094-ai.html)
- [OpenSpec Spec-Driven Development](ch01/1016-spec.html)
