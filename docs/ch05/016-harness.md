...
- **基础理论**：
  - [Harness Engineering Survey](ch05/115-harness-engineering.html)（CMU/Yale/Johns Hopkins，ETCLOVG 七层分类的源头）
  - [Harness Engineering — ETCLOVG Taxonomy](ch05/115-harness-engineering.html)（七层分类的独立条目）
- **同作者系列**：
...
- **互补实践**：
  ...
  - [Anthropic 长时运行 Agent 架构](../ch01/933-anthropic.html)（对抗式设计 + 合同谈判 + 审美量化）
