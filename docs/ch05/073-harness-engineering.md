...
## Ch05.073 Harness Engineering 核心模式
...
- [Anthropic Managed Agents 架构：脑手分离设计](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/managed-agents-architecture.md)
