...
- 是 **Agent 用 Harness 循环改进另一个 Agent**（元 Harness），区别于 [Lilian Weng Harness Engineering Self Improvement](ch05/096-harness-engineering.html) 的理论框架
...
- 父子 Agent 模式体现了 [Agent Vs Workflow Control Continuum Framework](../ch04/788-agent-vs-workflow.html) 中"控制权连续谱"的层级 delegation
