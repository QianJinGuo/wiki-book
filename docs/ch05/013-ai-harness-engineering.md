...
- [Claude Code 深度解析](ch03/084-claude-code.html) — Anthropic Harness 的具体实现
- [Claude Code Dynamic Workflows](ch03/084-claude-code.html) — Harness 第三层执行编排的 Dynamic Workflow 实现
...
- [Hermes Agent Operator](ch03/035-agent.html) — 自进化 Agent 的 Harness 实现
- [Agent YAML 评测](ch03/035-agent.html) — Harness 第五层评估与观测的工程实现
- [深入理解 Claude Code Agent Harness](ch03/084-claude-code.html) — Harness 在 Claude Code 源码层的具体构建
