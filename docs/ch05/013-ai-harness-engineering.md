...
- [Claude Code 深度解析](ch05/088-claude-code-harness.html) — Anthropic Harness 的具体实现
- [Claude Code Dynamic Workflows](../ch09/107-claude-code-dynamic-workflows.html) — Harness 第三层执行编排的 Dynamic Workflow 实现
- [OpenClaw 完整指南](../ch11/255-openclaw.html) — OpenAI-style 渐进式披露 + Agent-first 工程环境
- [Agent Evolution 四阶段六维](../ch03/006-agent.html) — Harness 维度在六维框架中的对应
- [Hermes Agent Operator](../ch03/099-hermes-agent.html) — 自进化 Agent 的 Harness 实现
- [Agent YAML 评测](../ch03/006-agent.html) — Harness 第五层评估与观测的工程实现
- [深入理解 Claude Code Agent Harness](ch05/066-agent-harness.html) — Harness 在 Claude Code 源码层的具体构建
