...
- [OpenClaw 完整指南](../ch11/250-openclaw.html) — OpenAI-style 渐进式披露 + Agent-first 工程环境
- [Agent Evolution 四阶段六维](../ch03/036-agent.html) — Harness 维度在六维框架中的对应
- [Hermes Agent Operator](../ch03/102-hermes-agent.html) — 自进化 Agent 的 Harness 实现
