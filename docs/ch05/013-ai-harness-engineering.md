...
- [Claude Code 深度解析](ch05/083-claude-code-harness.html) — Anthropic Harness 的具体实现
- [Claude Code Dynamic Workflows](../ch09/102-claude-code-dynamic-workflows.html) — Harness 第三层执行编排的 Dynamic Workflow 实现
- [OpenClaw 完整指南](../ch11/248-openclaw.html) — OpenAI-style 渐进式披露 + Agent-first 工程环境
...
- [深入理解 Claude Code Agent Harness](ch05/063-agent-harness.html) — Harness 在 Claude Code 源码层的具体构建
