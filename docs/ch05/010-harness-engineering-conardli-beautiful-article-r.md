...
- **与 [Harness Engineering 实体](ch05/091-harness-engineering.md)（290 行 5 source merged）**：Harness 理论 + 5 制品 + 3 阵营 + 5 原则；本 ConardLi 实践 = Harness 理论的**工程实现**
...
- [Agent Harness 与 Context Management：Working Set 管理](ch05/085-harness.md)
