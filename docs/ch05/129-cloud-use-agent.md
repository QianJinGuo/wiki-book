...
## Ch05.129 Cloud Use 框架：Agent 作为云上受治理主体的四层模型
...
- Cloud Use 的 **四层模型 (Identity→Credential→Tool→Runtime)** 是 Agent 云工作负载的完整治理栈，补充了 [Qoder Cloud Agents 用云新范式](ch04/271-skill.html) 中 Skills 层的底层基础设施视角
