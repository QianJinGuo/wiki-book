...
## Ch05.090 GSD 完胜 OpenSpec 和 Superpowers？源码拆完发现：三者防的是 context rot 的三道防线
...
- 涉及 [Openspec Spec Driven Development Trae Solo](ch05/055-openspec.html) 和 [Three Tools In One Gstack Superpowers Openspec Engineering Ai Coding](ch05/121-ai-coding.html)：从源码角度分析了 OpenSpec 和 Superpowers 的机制差异。
