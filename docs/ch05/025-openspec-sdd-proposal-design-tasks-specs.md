...
## Ch05.025 OpenSpec 规范驱动开发（SDD）框架 — proposal/design/tasks/specs 四类文档意图锁定
...
## 相关实体
- [Openspec 四步法深度复盘 流程完整不等于代码正确](ch05/053-openspec.html)
- [Spec Kit Bmad Sdd Practice Yexiaocha](../ch01/1188-spec.html)
