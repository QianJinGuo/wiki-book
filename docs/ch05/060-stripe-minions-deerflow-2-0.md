...
> 📊 Level ⭐⭐⭐⭐ | 14.4KB | `entities/wall-not-model-harness-three-case-studies-stripe-deerflow-ant.md`
...
- [Agent Harness Engineering: A Survey](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-harness-engineering-survey-2026.md) — 学术 7 层 ETCLOVG 分类法
- [AHE：Agentic Harness Engineering](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agentic-harness-engineering-ahe.md) — 复旦/北大自动优化 Harness
- [长周期 Agent：Ralph Loop → 可接管 Harness](https://github.com/QianJinGuo/wiki-public/blob/main/entities/long-running-agent-ralph-loop-handover-harness-ruofei.md) — Ralph Loop 漂移治理 + 5 张卡框架
