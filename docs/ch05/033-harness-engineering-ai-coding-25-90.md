...
- [Cursor Harness 复盘](../ch01/453-cursor-harness-model-production-floor.html) — 模型决定上限，Harness 决定生产下限
- [字节跳动 TRAE Harness Engineering 指南](../ch01/887-trae-harness-engineering.html) — R.E.S.T 框架/PPAF 循环/上下文 Token 流水线
