...
## Ch05.061 Loop Engineering 实践指南：CodeBuddy 中的自主循环系统 — Inner/Outer Loop + /goal + /loop + Team 对抗验证 + 状态外置
...
- [OpenClaw Agent Loop 设计范式](../ch01/1030-openclaw-agent.html)
- [AI Agent Loops Claude Code Codex](../ch03/077-claude-code.html)
- [Hermes Agent Loop 架构](../ch04/238-hermes-agent-loop.html)
