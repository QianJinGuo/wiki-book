...
### 与其他 Harness 实践的关系
腾讯 AI Team 的知识沉淀体系，与 [系统化 Harness Engineering 框架](ch05/062-harness-engineering.html) 中的治理（Governance）支柱高度对齐，也与 [Thin Harness Fat Skills](ch05/068-thin-harness-fat-skills-ai.html) 的核心主张（工具链薄，知识技能厚）形成呼应。知识自动衰减机制与 LLM Wiki Pattern 的 Lint 机制一脉相承。
