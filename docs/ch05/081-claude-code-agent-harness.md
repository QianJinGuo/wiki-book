...
- [Harness 实践指南 10步](ch05/118-harness-engineering.html) 的 Step 3（上下文管理）和 Step 10（并行多 agent）在本文有源码级对照
...
- [Gufabiancheng Spec For Complex Tasks Cc Codex](../ch01/514-codex.html)
