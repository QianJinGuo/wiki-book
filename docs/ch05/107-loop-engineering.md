...
- [Claude Code Loop Engineering Guide](../ch09/144-claude-code-loop-engineering.html) — Claude Code Loop Engineering 指南
- [Claude Code Loop Control Rights Four Levels](../ch09/169-claude-code-loop.html) — Loop 权限控制的四个层次
...
- [Anthropic Dynamic Workflows Ultracode Deep Research Lyuyuebannzi](../ch01/986-anthropic.html) — Dynamic Workflows 与 Ultracode
- [Harness Engineering](ch05/120-harness-engineering.html) — Harness Engineering 概念体系
- [Claude Code 27 Tips Engineering Upgrade Jiagoux 2026](../ch09/100-claude-code-27.html) — Claude Code 工程实践技巧
