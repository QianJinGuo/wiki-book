...
## Ch05.107 Loop Engineering，应该赞成还是反对？
...
- [一文看懂 Ai 编程智能体工程化新范式Loop Engineering](ch05/094-ai.html) — Loop Engineering 全景介绍
- [Claude Code Loop Engineering Guide](ch03/077-claude-code.html) — Claude Code Loop Engineering 指南
- [Claude Code Loop Control Rights Four Levels](ch03/077-claude-code.html) — Loop 权限控制的四个层次
- [Anthropic 8X Output Verification Bottleneck Fiona Fung](ch09/100-anthropic-8x.html) — Agent 验证瓶颈讨论
- [Anthropic Claude Code Large Scale Code Migration 2026](ch03/077-claude-code.html) — Anthropic 大规模代码迁移实践
- [Agentic Loop Engineering Handbook Empirical Framework](ch03/035-agent.html) — Loop Engineering 经验框架
- [Ai Agent Loops Claude Code Codex](ch05/094-ai.html) — AI Agent 循环模式
...
- [Claude Code 27 Tips Engineering Upgrade Jiagoux 2026](ch03/077-claude-code.html) — Claude Code 工程实践技巧
