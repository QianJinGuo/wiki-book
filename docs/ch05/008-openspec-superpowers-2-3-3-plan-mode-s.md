...
| [Three Tools Comet Openspec Superpowers Ai Coding Shuge 2026 06 17](ch05/088-ai-coding.html) | **同作者 6/17 三件套** | 术哥 6/17 OpenSpec+Superpowers+Comet 三件套（420 行）；与本文 6/18 OpenSpec+Superpowers **主动下线**形成强烈对照 — 同作者 24 小时内从"整合"到"拆分"的决策弧 |
| [Three Tools In One Gstack Superpowers Openspec Engineering Ai Coding](ch05/088-ai-coding.html) | **同三件套范式** | gstack + Superpowers + OpenSpec 三器合一工程化（114 行） |
...
| [Claude Code Skills Superpowers Practice](../ch01/504-claude-code-skills-superpowers.html) | **Superpowers 技能实践** | Superpowers Skills 实践 |
| [Spec Kit Bmad Sdd Practice Yexiaocha](../ch01/1051-spec.html) | **Spec-Kit + BMAD** | Spec-Kit + BMAD SDD 实践（不同 SDD 流派） |
