...
| [Openspec 四步法深度复盘 流程完整不等于代码正确](ch01/1065-spec.md) | **同主题批判视角** | OpenSpec 流程完整 ≠ 代码正确（与本文"流程完整不等于工程有效"同脉） |
| [Three Tools Comet Openspec Superpowers Ai Coding Shuge 2026 06 17](ch04/277-ai.md) | **同作者 6/17 三件套** | 术哥 6/17 OpenSpec+Superpowers+Comet 三件套（420 行）；与本文 6/18 OpenSpec+Superpowers **主动下线**形成强烈对照 — 同作者 24 小时内从"整合"到"拆分"的决策弧 |
| [Three Tools In One Gstack Superpowers Openspec Engineering Ai Coding](ch04/277-ai.md) | **同三件套范式** | gstack + Superpowers + OpenSpec 三器合一工程化（114 行） |
| [Ai Production Development Workflow Openspec Superpowers Gstack](ch04/277-ai.md) | **gstack 三件套** | 同上 gstack 三件套另一角度（233 行） |
...
| [Claude Code Skills Superpowers Practice](ch04/255-skill.md) | **Superpowers 技能实践** | Superpowers Skills 实践 |
| [Spec Kit Bmad Sdd Practice Yexiaocha](ch01/1065-spec.md) | **Spec-Kit + BMAD** | Spec-Kit + BMAD SDD 实践（不同 SDD 流派） |
| [Spec As Aios Anti Entropy Architecture Gaode Ai Native Series 2](ch04/277-ai.md) | **Spec-as-AIOS** | 高德 Spec-as-AIOS 反熵架构（Spec 即操作系统的不同视角） |
| [Openspec Spec Driven Development Trae Solo](ch01/1065-spec.md) | **OpenSpec 单独实战** | OpenSpec + TRAE 单独使用 |
