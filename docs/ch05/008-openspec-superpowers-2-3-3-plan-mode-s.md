...
| 实体 | 关系 | 互补角度 |
|---|---|---|
| [Ssd Spec Driven Development Harness Asd Shuge 2026 06 17](ch01/217-0.md) | **同作者昨日（6/17）ASD 实战文** | 116 行深度文档：4 条设计约束 + ASD 三层架构 + 8 步闸门管道 + 5 Agent Skill；本文是其次日（6/18）的反思篇，专攻"缝合怪识别 + 减法决策论" |
...
| [Claude Code Skills Superpowers Practice](ch04/256-skill.md) | **Superpowers 技能实践** | Superpowers Skills 实践 |
...
**同作者系列**：
- 03 篇（SSD 实战 / 6/17）：[Ssd Spec Driven Development Harness Asd Shuge 2026 06 17](ch01/217-0.md)
- 04 篇（本反思 / 6/18）：本文
