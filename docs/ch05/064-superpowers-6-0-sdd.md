...
与 [术哥的反作弊视角](ch01/1429-0.html) 互补——术哥聚焦 reviewer 隔离堵作弊路径，本文聚焦文件交接降低上下文成本 + 多平台 harness 映射。
...
- → [术哥反作弊视角分析](ch01/1429-0.html) — 互补视角
- → [三器合一工程化实战](ch05/100-ai.html) — Superpowers + OpenSpec + gstack 串联
