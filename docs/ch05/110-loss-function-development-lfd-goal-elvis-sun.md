...
- [Openclaw Boris Cherny Agent Loop Design Patterns](../ch04/560-agent-loop.html)（OpenClaw agent loop 对照）
- [Mimo Code Xiaomi Coding Harness 2026](ch05/101-harness-2026.html)（MiMo Code Max Mode + Goal 机制同主线）
- [Snowflake Agentic Enterprise Summit 2026](../ch04/612-agentic.html)（Snowflake — 可审计治理同主线）
