...
- [Claude Code 20000 字符源码分析](../ch03/084-claude-code.html) —— 98.4% 基础设施论据
- [Agent Harness 上下文管理](ch05/042-agent-harness.html) —— 工作集视角 + subagent 隔离
- [Harness Engineering](ch05/092-harness-engineering.html) —— 系统性 harness 实践
- [Agent Self-Improvement Six Mechanisms](../ch03/036-agent.html) —— 长期连贯性相关
- [From Agent Protocol to Harness Skill](../ch04/500-from-agent-protocol-to-harness-skill.html) —— 协议 → skill 演化
