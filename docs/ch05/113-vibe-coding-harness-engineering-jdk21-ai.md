...
## Ch05.113 从 Vibe Coding 到 Harness Engineering：小米 JDK21 升级中可控演进的 AI 工程实践
...
- → [Harness Engineering](ch05/112-harness-engineering.html) — 本文是该方法论在维护性工程场景的实证
- → [Agent Skill 规范、构建与设计模式](../ch04/270-agent-skill.html) — jdk-upgrade Skill 的设计与渐进式披露机制
