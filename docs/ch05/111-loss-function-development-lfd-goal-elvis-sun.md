...
## Ch05.111 Loss Function Development (LFD) — 损失函数开发与 /goal 循环（Elvis Sun）
...
- [Interconnects The Distillation Panic](../ch01/320-the-distillation-panic.html)（蒸馏恐慌 — 同期产业反应）
...
- [Openclaw Boris Cherny Agent Loop Design Patterns](../ch04/569-agent-loop.html)（OpenClaw agent loop 对照）
- [Mimo Code Xiaomi Coding Harness 2026](ch05/102-harness-2026.html)（MiMo Code Max Mode + Goal 机制同主线）
