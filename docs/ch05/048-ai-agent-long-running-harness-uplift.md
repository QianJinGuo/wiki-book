...
- [高德 Marketing AutoResearch](ch04/277-ai.md) — 同属营销算法团队，本文聚焦 Uplift 模型迭代自动化，对方聚焦营销决策托管
- [高德 AI 伴行架构](ch04/277-ai.md) — 空间智能场景的 Agent 架构
- [阿里 LoongSuite Pilot 观测审计](ch09/047-coding-agent.md) — 企业级 Agent 可观测性方案
- [Agent Harness Engineering Survey 2026](ch05/061-harness-engineering.md) — 业界 harness 范式综述
...
- [高德路线规划双路线：mobilitybench（agent 基准）+ transitlm（端到端 rllm）](ch01/216-0.md)
