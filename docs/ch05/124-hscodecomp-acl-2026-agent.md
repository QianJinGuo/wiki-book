...
## Ch05.124 HSCodeComp：阿里 ACL 2026 最佳资源论文——层级规则应用 Agent 基准
...
- [Harness Engineering](ch05/112-harness-engineering.html) — Agent Harness 提供 +8.5pt 增益，验证了 Harness 对规则应用的基础作用
