...
- [Agent Harness Engineering: A Survey](ch04/502-agent.md) — 学术 7 层 ETCLOVG 分类法
- [AHE：Agentic Harness Engineering](ch04/502-agent.md) — 复旦/北大自动优化 Harness
- [长周期 Agent：Ralph Loop → 可接管 Harness](ch04/502-agent.md) — Ralph Loop 漂移治理 + 5 张卡框架
