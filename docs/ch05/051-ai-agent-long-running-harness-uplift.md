...
## Ch05.051 面向复杂算法任务的 AI Agent：高德 Long-Running Harness 架构与 Uplift 模型迭代应用
...
- [Agent Harness Engineering Survey 2026](ch05/057-harness-engineering.html) — 业界 harness 范式综述
