...
- [Enterprise Readiness Maturity Model](../ch11/220-enterprise-readiness-maturity-model.html) — 企业成熟度模型
- [从 SDD 到 Lattice Harness](ch05/101-ai-coding.html) — 另一团队级 AI Coding harness 实践
- [AI Infra 全景 9 层架构](../ch01/765-ai-infra.html) — AI 基础设施全景
