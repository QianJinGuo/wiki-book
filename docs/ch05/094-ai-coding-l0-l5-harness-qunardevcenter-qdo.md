...
- [Enterprise Readiness Maturity Model](../ch11/221-enterprise-readiness-maturity-model.html) — 企业成熟度模型
- [从 SDD 到 Lattice Harness](ch05/104-ai-coding.html) — 另一团队级 AI Coding harness 实践
