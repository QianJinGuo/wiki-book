...
这个观察与 [Agent Harness Engineering Survey](ch05/096-harness-engineering.html) 中关于「Harness 的演进——从自然语言到确定性结构」的趋势完全一致——效率优化的动力来自用户端而非厂商端。
...
- [Agent Harness Engineering Survey](ch05/096-harness-engineering.html)
- [Skill 编排的6种依赖关系](../ch04/349-skill.html)
- [CLI Agent模式——MCP与Shell Agent](../ch03/006-agent.html)
- [Skill Hub MVP评估与发布](../ch04/349-skill.html)
