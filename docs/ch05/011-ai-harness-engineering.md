...
- [Claude Code 深度解析](ch05/060-claude-code-harness.md) — Anthropic Harness 的具体实现
- [Claude Code Dynamic Workflows](../ch09/078-claude-code-dynamic-workflows.md) — Harness 第三层执行编排的 Dynamic Workflow 实现
- [OpenClaw 完整指南](../ch11/213-openclaw.md) — OpenAI-style 渐进式披露 + Agent-first 工程环境
- [Agent Evolution 四阶段六维](../ch03/045-agent.md) — Harness 维度在六维框架中的对应
- [Hermes Agent Operator](../ch03/090-hermes-agent.md) — 自进化 Agent 的 Harness 实现
- [Agent YAML 评测](../ch03/045-agent.md) — Harness 第五层评估与观测的工程实现
- [深入理解 Claude Code Agent Harness](ch05/038-agent-harness.md) — Harness 在 Claude Code 源码层的具体构建
