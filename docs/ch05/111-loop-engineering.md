...
## Ch05.111 Loop Engineering，应该赞成还是反对？
...
- [Claude Code Loop Control Rights Four Levels](../ch01/340-claude-code-loop.html) — Loop 权限控制的四个层次
- [Anthropic 8X Output Verification Bottleneck Fiona Fung](../ch09/098-anthropic-8x.html) — Agent 验证瓶颈讨论
- [Anthropic Claude Code Large Scale Code Migration 2026](../ch01/789-anthropic-claude-code.html) — Anthropic 大规模代码迁移实践
...
- [Anthropic Dynamic Workflows Ultracode Deep Research Lyuyuebannzi](../ch01/1215-anthropic.html) — Dynamic Workflows 与 Ultracode
- [Harness Engineering](ch05/126-harness-engineering.html) — Harness Engineering 概念体系
- [Claude Code 27 Tips Engineering Upgrade Jiagoux 2026](../ch01/339-claude-code-27.html) — Claude Code 工程实践技巧
