...
## Ch05.104 How I Cut an AI Agent's Token Use by 94% — 将 Skill 从自然语言编译为确定性代码
...
- 与 [Agent Harness Engineering Survey](ch05/112-harness-engineering.html) 中"Harness 的演进——从自然语言到确定性结构"的趋势一致
