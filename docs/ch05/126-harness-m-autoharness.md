...
## Ch05.126 Harness进化论文 — M⋆记忆程序进化与AutoHarness动作约束
...
- **来源**: 数据派THU（背靠清华大学）
- **日期**: 2026-04-25
- **相关实体**: [Hermes Agent Deep Dive](../ch03/091-hermes-agent.html)（Hermes的Self-Evolution机制）
- **相关实体**: [Minimax M2 7](../ch03/105-minimax-m2-7.html)（MiniMax的自我进化实践）
