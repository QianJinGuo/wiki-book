...
## 相关实体
- [Agent Harness Context Management Working Set](ch04/502-agent.md)（相关：上下文装载层是 Harness 第一层）
- [Agent Harness Architecture](ch04/502-agent.md)（相关：Harness 7 层是 agent-harness-architecture 的具体化）
- [Agent Harness Engineering Survey 2026](ch04/502-agent.md)（相关：Harness Engineering 综述与本文 Harness 7 层互补）
