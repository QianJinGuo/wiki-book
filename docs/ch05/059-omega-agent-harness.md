...
## Ch05.059 OMEGA: 面向多机器人协作的具身Agent Harness
...
- [Agent Orchestration Multi Agent Systems](../ch04/601-agent-orchestration.html) — 多智能体编排的基础架构模式，OMEGA 将其扩展到物理机器人领域
- [Coze 3 Multimagent Team Orchestration Wangheige](../ch03/036-agent.html) — Coze 的团队级编排设计，提供软件侧的参考对比
