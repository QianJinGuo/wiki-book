...
## Ch05.102 Lilian Weng Harness Engineering for Self-Improvement — RSI 从 Harness 开始
...
Harness Engineering 的递进链条（Context→Workflow→Self-Harness→Evolution）与 [Loop Engineering](ch05/122-loop-engineering.html) 的反馈控制理念一脉相承。Self-Harness 的 Weakness Mining→Proposal→Validation 循环是对 ACE/MCE 的进一步抽象——从优化上下文升级为优化 Harness 本身。
...
- [阿里 Harness 工程实战：Agent 自主迭代 17 小时](ch05/077-harness.html) — 真实落地案例，实践了翁荔提出的 Harness 三模式 + Champion-Challenger 防 Reward Hacking
