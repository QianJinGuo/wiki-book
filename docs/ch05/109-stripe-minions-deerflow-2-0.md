...
## Ch05.109 墙比模型更重要：Stripe Minions + 字节 DeerFlow 2.0 + 蚂蚁支小助 的同结论
...
- [Agent Harness Engineering: A Survey](ch05/066-harness-engineering.html) — 学术 7 层 ETCLOVG 分类法
- [AHE：Agentic Harness Engineering](ch05/066-harness-engineering.html) — 复旦/北大自动优化 Harness
