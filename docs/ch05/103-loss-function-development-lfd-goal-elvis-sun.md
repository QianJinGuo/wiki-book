...
## Ch05.103 Loss Function Development (LFD) — 损失函数开发与 /goal 循环（Elvis Sun）
...
- [Openclaw Boris Cherny Agent Loop Design Patterns](../ch04/553-agent-loop.html)（OpenClaw agent loop 对照）
