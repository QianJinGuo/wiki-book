...
- [Claude Code 深度解析](ch05/066-claude-code-harness.html) — Anthropic Harness 的具体实现
- [Claude Code Dynamic Workflows](../ch09/084-claude-code-dynamic-workflows.html) — Harness 第三层执行编排的 Dynamic Workflow 实现
...
- [深入理解 Claude Code Agent Harness](ch05/062-agent-harness.html) — Harness 在 Claude Code 源码层的具体构建
