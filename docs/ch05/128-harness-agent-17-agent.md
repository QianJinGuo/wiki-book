...
## Ch05.128 阿里 Harness 工程实战：Agent 自主迭代 17 小时优化业务 Agent
...
- 是 **Agent 用 Harness 循环改进另一个 Agent**（元 Harness），区别于 [Lilian Weng Harness Engineering Self Improvement](ch05/115-harness-engineering.html) 的理论框架
