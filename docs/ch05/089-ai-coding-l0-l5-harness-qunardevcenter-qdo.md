...
## Ch05.089 去哪儿网 AI Coding 研发平台实践：L0-L5 自动化分级 + Harness 四把锁 + QunarDevCenter + 天弦 QDO
...
- [从 SDD 到 Lattice Harness](ch05/092-ai-coding.html) — 另一团队级 AI Coding harness 实践
- [AI Infra 全景 9 层架构](../ch01/1181-ai-infra.html) — AI 基础设施全景
