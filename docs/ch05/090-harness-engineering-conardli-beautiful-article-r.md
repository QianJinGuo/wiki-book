...
## Ch05.090 Harness Engineering 综合性指南（ConardLi 系列 · 含 Beautiful Article 实证 + Reacticle 协议）
...
→ 第 1 来源 ConardLi Harness 综合性指南原文存档
→ 第 2 来源 ConardLi Beautiful Article Skill 原文存档
...
- **与 [Harness Engineering 实体](096-harness-engineering.html)（290 行 5 source merged）**：Harness 理论 + 5 制品 + 3 阵营 + 5 原则；本 ConardLi 实践 = Harness 理论的**工程实现**
