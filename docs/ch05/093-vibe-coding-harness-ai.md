...
## Ch05.093 从Vibe Coding到Harness—— 一套大仓AI工程化实战

> 📊 Level ⭐⭐ | 4.7KB | `entities/从vibe-coding到harness-一套大仓ai工程化实战.md`
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/从vibe-coding到harness-一套大仓ai工程化实战.md)
