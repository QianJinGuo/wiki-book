...
## Ch05.060 腾讯 AI Team 知识沉淀体系（Harness Engineering 实践）
...
### 与其他 Harness 实践的关系
腾讯 AI Team 的知识沉淀体系，与 [系统化 Harness Engineering 框架](ch05/068-harness-engineering.html) 中的治理（Governance）支柱高度对齐，也与 [Thin Harness Fat Skills](ch05/077-thin-harness-fat-skills-ai.html) 的核心主张（工具链薄，知识技能厚）形成呼应。知识自动衰减机制与 LLM Wiki Pattern 的 Lint 机制一脉相承。
...
→  — 三支柱架构对照
→  — 知识 vs 工具链的务实立场
→ [Agent Memory 架构本质](../ch04/400-perplexity-brain-self-improving-agent-memory-architecture.html) — 与知识层级的关联讨论
