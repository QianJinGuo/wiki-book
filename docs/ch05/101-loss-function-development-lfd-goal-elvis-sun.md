...
## Ch05.101 Loss Function Development (LFD) — 损失函数开发与 /goal 循环（Elvis Sun）
...
- [Interconnects The Distillation Panic](../ch01/630-the-distillation-panic.html)（蒸馏恐慌 — 同期产业反应）
...
- [Openclaw Boris Cherny Agent Loop Design Patterns](../ch04/550-agent-loop.html)（OpenClaw agent loop 对照）
