...
- [Harness 实践指南 10步](ch05/117-harness-engineering.html) 的 Step 3（上下文管理）和 Step 10（并行多 agent）在本文有源码级对照
...
- [Harness Engineering 10 Step Practical Guide 2026](ch05/117-harness-engineering.html)
...
- [Gufabiancheng Spec For Complex Tasks Cc Codex](../ch01/509-codex.html)
