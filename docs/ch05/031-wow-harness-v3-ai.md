...
## Ch05.031 wow-harness v3：AI 开发的治理协议
...
- [Agent Harness 上下文管理](ch05/063-agent-harness.html) —— 工作集视角 + subagent 隔离
- [Harness Engineering](ch05/057-harness-engineering.html) —— 系统性 harness 实践
