...
## Ch05.153 HSCodeComp：阿里 ACL 2026 最佳资源论文——层级规则应用 Agent 基准
...
- [Harness Engineering](ch05/050-harness-engineering.html) — Agent Harness 提供 +8.5pt 增益，验证了 Harness 对规则应用的基础作用
- [AINMM 成熟度模型](ch05/022-ai-native.html) — 验证回路依赖规则锚定而非模型自省
- [AI Agent 评测 5 维体系](ch05/128-ai-coding.html) — 评测方法论参考
