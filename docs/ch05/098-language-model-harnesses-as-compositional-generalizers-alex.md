...
- [Reinforcing Recursive Language Models（RLM）](../ch01/864-reinforcing-recursive-language-models-alphaxiv.html) — RLM 的训练方法论
- [Agent Harness Engineering Survey](ch05/118-harness-engineering.html) — AVS 的多层 harness 分类法
