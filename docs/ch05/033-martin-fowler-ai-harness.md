...
## Ch05.033 Martin Fowler AI 研发 Harness：非确定性承重层
...
- [腾讯 CDN LEGO Harness Engineering](https://github.com/QianJinGuo/wiki-public/blob/main/entities/tencent-cdn-lego-harness.md) — 57 案例 13 类问题中，不确定性处理是核心挑战之一
...
## 相关实体
- [Martin Fowler AI 研发提醒：Harness 承重层](https://github.com/QianJinGuo/wiki-public/blob/main/entities/martin-fowler-ai-rd-harness-nondeterminism-devnote.md)
