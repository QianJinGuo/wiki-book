...
## Ch05.117 阿里 Harness 工程实战：Agent 自主迭代 17 小时优化业务 Agent
...
- 父子 Agent 模式体现了 [Agent Vs Workflow Control Continuum Framework](../ch04/616-agent-vs-workflow.html) 中"控制权连续谱"的层级 delegation
