...
### vs [wow-harness v3](008-harness.html)
...
### vs [高德 AI-Native 生产线](018-ai-native.html)
...
### vs [Claude Code Dynamic Workflows](../ch09/069-claude-code-dynamic-workflows.html)
...
### vs [Agent Harness 架构](035-agent-harness.html)
- 7 层 harness 模型 = 抽象框架
...
- [wow-harness v3](008-harness.html) —— 跨 session 治理
- [高德 AI-Native 生产线](018-ai-native.html) —— 企业级 R&D 生产线
- [Claude Code Dynamic Workflows](../ch09/069-claude-code-dynamic-workflows.html) —— 动态工作流
