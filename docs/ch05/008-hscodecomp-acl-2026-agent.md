...
> 📊 Level ⭐ | 4.5KB | `entities/hscodecomp-acl-2026-best-resource-paper.md`
...
- [Harness Engineering](061-harness-engineering.html) — Agent Harness 提供 +8.5pt 增益，验证了 Harness 对规则应用的基础作用
