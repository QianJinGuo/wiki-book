...
## Ch05.027 MAC（multi-agent-coding）：Skills + Hooks 两层 Harness —— 完全委托 0-20% 的解法
...
### vs [Claude Code Dynamic Workflows](../ch09/087-claude-code-dynamic-workflows.html)
...
- [高德 AI-Native 生产线](ch05/019-ai-native.html) —— 企业级 R&D 生产线
- [Claude Code Dynamic Workflows](../ch09/087-claude-code-dynamic-workflows.html) —— 动态工作流
