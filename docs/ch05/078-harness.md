...
本页作为知识图谱锚点，连接了以下关键实体：[场景营销前端 AI Coding — 从问题到方案](ch04/277-ai.md)。 相关主题通过 [Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](ch03/045-agent.md) 延伸。
...
- [AI Coding 入门指南：如何更好地让 AI 真正帮你干活](ch04/277-ai.md)
- [Harness Engineering 详解：如何将 AI Coding 率提升至 90%](ch04/277-ai.md)
