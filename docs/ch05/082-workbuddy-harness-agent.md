...
## Ch05.082 WorkBuddy 产品实践：从模型到 Harness 的 Agent 可用产品架构
...
- [Mem0 vs WorkBuddy Agent 记忆对比](../ch04/346-mem0-vs-workbuddy-agent.html)
- [OpenClaw/WorkBuddy/Loop 工程对比](ch05/122-loop-engineering.html)
