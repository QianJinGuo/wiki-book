...
## 子页面
- [四根支柱与四要素架构](ch05/116-harness-engineering.html) — 四根支柱详解、四要素架构、关键经验、效果对比
...
- [Cursor Harness 复盘](../ch01/276-cursor-harness-model-production-floor.html) — 模型决定上限，Harness 决定生产下限
...
- [Harness Engineering实践，做了一个平台让AI一晚上自动评测和优化你的系统](ch05/116-harness-engineering.html)
