...
## Ch05.026 OpenAI Skills/Shell/Compaction：终结提示词工程的三位一体Agent原语
...
## 相关主题
- [Skills Anthropic Openai Comparison Frontend Design](../ch01/714-skills-anthropic-openai-comparison-frontend-design.html) — Anthropic/Google Skills 设计模式对比
