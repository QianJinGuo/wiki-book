...
## 子页面
- [四根支柱与四要素架构](ch05/096-harness-engineering.html) — 四根支柱详解、四要素架构、关键经验、效果对比
...
- [字节跳动 TRAE Harness Engineering 指南](../ch01/902-trae-harness-engineering.html) — R.E.S.T 框架/PPAF 循环/上下文 Token 流水线
