...
5. 与 [Coding Harness Engineering](https://github.com/QianJinGuo/wiki-public/blob/main/concepts/coding-harness-engineering.md) 一脉相承：通过 Skill 组合 + 开发规范 + 流程约束推动 AI 产出收敛
...
- [三合一工具深度对比](076-ai-coding.html)
- [Superpowers 实战](../ch01/381-claude-code-skills-superpowers.html)
