...
- [Hermes Agent Goal Runtime Architecture State Persistence Judge Closed Loop](ch04/502-agent.md)（Hermes Agent Goal runtime 对照）
...
- [Snowflake Agentic Enterprise Summit 2026](ch04/502-agent.md)（Snowflake — 可审计治理同主线）
- [Hermes Agent Goal And Kanban](ch04/502-agent.md)（Hermes Goal + Kanban 对照）
