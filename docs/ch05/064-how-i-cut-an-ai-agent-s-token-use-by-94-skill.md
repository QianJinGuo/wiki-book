...
## Ch05.064 How I Cut an AI Agent's Token Use by 94% — 将 Skill 从自然语言编译为确定性代码
...
这个观察与 [Agent Harness Engineering Survey](ch05/066-harness-engineering.html) 中关于「Harness 的演进——从自然语言到确定性结构」的趋势完全一致——效率优化的动力来自用户端而非厂商端。
...
- [Agent Harness Engineering Survey](ch05/066-harness-engineering.html)
