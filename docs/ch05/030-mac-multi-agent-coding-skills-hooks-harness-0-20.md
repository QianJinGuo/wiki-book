...
### vs [Claude Code Dynamic Workflows](../ch09/104-claude-code-dynamic-workflows.html)
...
- [Claude Code Dynamic Workflows](../ch09/104-claude-code-dynamic-workflows.html) —— 动态工作流
