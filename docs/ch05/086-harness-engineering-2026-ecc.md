...
## Ch05.086 Harness Engineering 综合论述：为什么 2026 年真正重要的是它（含 ECC 开源实现案例）
...
参考 [Agent Harness 上下文管理](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-harness-context-management-working-set.md) 的工作集视角。
...
- [loop engineering: 把反馈循环放进工程现场](https://github.com/QianJinGuo/wiki-public/blob/main/entities/loop-engineering-feedback-control-system.md)
...
→ 第 1 篇原文存档 · 第 2 篇原文存档 · 第 3 篇原文存档 · 第 4 篇原文存档​
