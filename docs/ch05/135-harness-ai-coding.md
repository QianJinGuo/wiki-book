...
## Ch05.135 应用宝活动平台 Harness 工程实践——从对话式 AI Coding 到工程化系统
...
在 [Harness 综合实体](ch05/129-harness-engineering.html) 的基础上，本文贡献了一个可操作的知识库工程架构：
...
本文提出贯穿整套 Harness 工程的核心原则，是已有的 [Harness 综合实体](ch05/129-harness-engineering.html) 未覆盖的生产级判断准则：
...
> 参见 [Code is cheap: Harness 方法论——水流理论、最小混沌单元与反 slop](ch05/085-harness.html)——前者从第一性原理推导 Harness 方法论，本文提供生产级实现细节，两者互补。本文也补充了 [腾讯技术工程 Harness 探索之旅](ch05/129-harness-engineering.html) 中缺失的工程细节。
