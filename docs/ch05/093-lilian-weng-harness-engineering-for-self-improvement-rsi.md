...
## Ch05.093 Lilian Weng Harness Engineering for Self-Improvement — RSI 从 Harness 开始
...
- [阿里 Harness 工程实战：Agent 自主迭代 17 小时](ch05/085-harness.html) — 真实落地案例，实践了翁荔提出的 Harness 三模式 + Champion-Challenger 防 Reward Hacking
