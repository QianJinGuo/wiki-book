...
## Ch05.030 Harness Engineering 实战：AI Coding 率从 25% 提升至 90%
...
## 子页面
- [四根支柱与四要素架构](057-harness-engineering.html) — 四根支柱详解、四要素架构、关键经验、效果对比
...
- [字节跳动 TRAE Harness Engineering 指南](../ch01/462-trae-harness-engineering.html) — R.E.S.T 框架/PPAF 循环/上下文 Token 流水线
