...
## Ch05.105 Language Model Harnesses as Compositional Generalizers (Alex Zhang, 2026)
...
- [Reinforcing Recursive Language Models（RLM）](../ch01/892-reinforcing-recursive-language-models-alphaxiv.html) — RLM 的训练方法论
