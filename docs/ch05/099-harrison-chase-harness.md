...
## Ch05.099 黄仁勋 × Harrison Chase 对话：未来公司将建立在 Harness 之上
...
- [NVIDIA Nemotron-3-Ultra](../ch04/610-agentic.html) — 对话中提到的模型，开源权重达到前沿性能
- [NVIDIA 安全本地 Agent：Nemoclaw/OpenClaw](../ch04/391-nvidia-secure-local-agent-nemoclaw-openclaw.html) — NVIDIA 的本地 Agent 运行环境（NIM）
- [NVIDIA Agentic Systems Extreme Co-Design](../ch04/610-agentic.html) — NVIDIA Agent 系统的另一次深度技术阐述
