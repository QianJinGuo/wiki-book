...
- [高德 AI 伴行架构](../ch03/006-agent.html) — 空间智能场景的 Agent 架构
- [阿里 LoongSuite Pilot 观测审计](../ch09/055-coding-agent.html) — 企业级 Agent 可观测性方案
- [Agent Harness Engineering Survey 2026](ch05/096-harness-engineering.html) — 业界 harness 范式综述
