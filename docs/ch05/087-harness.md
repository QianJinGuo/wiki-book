...
本页作为知识图谱锚点，连接了以下关键实体：[场景营销前端 AI Coding — 从问题到方案](ch05/088-ai-coding.html)。 相关主题通过 [Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](../ch03/045-agent.html) 延伸。
...
- [场景营销前端 AI Coding — 从问题到方案](ch05/088-ai-coding.html)
- [Karpathy 最新访谈：从 Vibe Coding 到 Agentic Engineering](../ch03/045-agent.html)
- [AI Coding 入门指南：如何更好地让 AI 真正帮你干活](ch05/088-ai-coding.html)
