...
## Ch05.082 Claude Harness 设计：Generator-Evaluator 架构与 Context Reset 演进
...
- [Agent Harness 上下文管理：工作集视角](ch04/503-agent.md) — compaction 光谱 + session/harness/sandbox 解耦
