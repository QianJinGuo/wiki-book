...
- → [GSD vs OpenSpec vs Superpowers 源码对比](ch05/093-gsd-openspec-superpowers-context-rot.html)（同一作者的前作，聚焦 context rot）
...
- → [Superpowers 深度解析](ch05/113-ai.html)（superpowers 全景）
