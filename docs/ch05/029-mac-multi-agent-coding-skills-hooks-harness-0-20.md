...
## Ch05.029 MAC（multi-agent-coding）：Skills + Hooks 两层 Harness —— 完全委托 0-20% 的解法
...
### vs [Claude Code Dynamic Workflows](../ch09/103-claude-code-dynamic-workflows.html)
...
- [Claude Code Dynamic Workflows](../ch09/103-claude-code-dynamic-workflows.html) —— 动态工作流
