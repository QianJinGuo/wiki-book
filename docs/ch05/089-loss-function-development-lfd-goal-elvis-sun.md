...
- [Interconnects The Distillation Panic](../ch01/355-the-distillation-panic.md)（蒸馏恐慌 — 同期产业反应）
...
- [Hermes Agent Goal Runtime Architecture State Persistence Judge Closed Loop](../ch04/351-hermes-agent-goal.md)（Hermes Agent Goal runtime 对照）
...
- [Mimo Code Xiaomi Coding Harness 2026](ch05/077-harness-2026.md)（MiMo Code Max Mode + Goal 机制同主线）
- [Snowflake Agentic Enterprise Summit 2026](../ch03/045-agent.md)（Snowflake — 可审计治理同主线）
- [Hermes Agent Goal And Kanban](../ch04/351-hermes-agent-goal.md)（Hermes Goal + Kanban 对照）
