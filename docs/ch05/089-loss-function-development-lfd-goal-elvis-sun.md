...
## Ch05.089 Loss Function Development (LFD) — 损失函数开发与 /goal 循环（Elvis Sun）
...
- [Openclaw Boris Cherny Agent Loop Design Patterns](../ch11/213-openclaw.html)（OpenClaw agent loop 对照）
