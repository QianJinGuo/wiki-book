...
## Ch05.037 Martin Fowler 的 AI 研发提醒：非确定性进了研发链路，Harness 才真正开始承重
...
- → [Harness Engineering 实体](096-harness-engineering.html)：Harness 部分与该实体高度互补，提供更完整的框架拆解
- → [2026 Harness 工程survey](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-harness-engineering-survey-2026.md)：行业层面的 Harness 工程全景图
- → [生产级 Harness 工程](https://github.com/QianJinGuo/wiki-public/blob/main/entities/agent-production-harness-engineering.md)：侧重生产环境的治理与 control plane 实践
