...
## Ch05.017 高德广告工程 Harness/SDD 体系演进：从\"氛围编程\"治理到 AI Native 全流程闭环
...
- [Harness Engineeringai 能在真正出事会炸的后端系统里写代码吗 V2](ch05/069-harness-engineering.html)
...
- [Harness Engineering 综述](ch05/069-harness-engineering.html)（相关：三阶段 Prompt→Context→Harness）
- [Spec as AIOS (高德 App 平台)](../ch01/1099-spec.html)（同团队同主题另一视角）
