...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/harness-vla-tsinghua-embodied-intelligence-2026.md)
...
- [Agent Orchestration Multi Agent Systems](../ch04/495-agent-orchestration.html) — 多智能体编排的基础架构模式，OMEGA 将其扩展到物理机器人领域
