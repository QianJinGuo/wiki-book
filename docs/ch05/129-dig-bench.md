...
## Ch05.129 dig.bench — 文本游戏科学发现智能体基准
...
dig.bench 把「智能体实验/发现能力」从通用 QA 基准中独立出来，与 [AutoResearch](ch05/111-ai.html) 同属 AI 科学发现评估前沿。其「基础模型 vs Agentic Harness」双层测法为 [Agent 评测](../ch03/006-agent.html) 提供了实验驱动的基准范式。
