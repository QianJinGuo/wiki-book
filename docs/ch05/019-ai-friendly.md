...
## Ch05.019 AI Friendly 架构设计：后端系统面向无人值守开发时代的标准与路径
...
- [Spec As Aios Anti Entropy Architecture Gaode App Platform 2026](../ch04/135-ai.html)（相关：Spec as AIOS 是 Spec 工程化的另一视角）
