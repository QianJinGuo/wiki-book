...
## Ch05.094 Language Model Harnesses as Compositional Generalizers (Alex Zhang, 2026)
...
- [Reinforcing Recursive Language Models（RLM）](../ch01/847-reinforcing-recursive-language-models-alphaxiv.html) — RLM 的训练方法论
- [Agent Harness Engineering Survey](ch05/115-harness-engineering.html) — AVS 的多层 harness 分类法
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/language-model-harnesses-compositional-generalizers-alex-zhang-2026.md)
