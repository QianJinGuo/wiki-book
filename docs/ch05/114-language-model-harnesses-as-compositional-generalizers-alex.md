...
## Ch05.114 Language Model Harnesses as Compositional Generalizers (Alex Zhang, 2026)
...
- [Agent Harness Engineering Survey](ch05/092-harness-engineering.html) — AVS 的多层 harness 分类法
