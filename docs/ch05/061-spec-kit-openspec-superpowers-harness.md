...
- [Matt Pocock Skills vs Superpowers](ch04/271-skill.html) — 同一路线对比的另一视角
...
- [Spec-Driven Development Harness](ch01/1016-spec.html) — 与 Spec 层配合的 Harness 方法论
- [AI-Friendly 后端标准化路径](ch05/094-ai.html) — 另一视角的工程规范建设实践
