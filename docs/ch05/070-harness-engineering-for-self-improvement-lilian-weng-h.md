...
## Ch05.070 Harness Engineering for Self-Improvement — 翁荔 Lilian Weng 系统梳理 Harness 自我提升研究全景
...
- [Harness Engineering](ch05/066-harness-engineering.html) — 上位框架：本实体是 Harness Engineering 在**自我提升**这一前沿子方向的研究全景
- [Agent 自我提升六种机制](../ch03/006-agent.html) — 互补：该实体从 Agent 视角归纳六种路径，本实体从 **Harness 优化**视角系统梳理研究论文
- [Harness 工程五大支柱](ch05/066-harness-engineering.html) — 互补：该实体聚焦生产级 Harness 实践，本实体聚焦前沿研究
