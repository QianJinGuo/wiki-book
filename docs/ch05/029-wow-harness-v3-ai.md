...
## Ch05.029 wow-harness v3：AI 开发的治理协议
...
→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/wow-harness-v3-governance-protocol.md)
...
- [Claude Code 20000 字符源码分析](../ch03/075-claude-code.html) —— 98.4% 基础设施论据
- [Agent Harness 上下文管理](ch05/039-agent-harness.html) —— 工作集视角 + subagent 隔离
- [Harness Engineering](ch05/050-harness-engineering.html) —— 系统性 harness 实践
- [Agent Self-Improvement Six Mechanisms](../ch03/045-agent.html) —— 长期连贯性相关
- [From Agent Protocol to Harness Skill](../ch04/394-from-agent-protocol-to-harness-skill.html) —— 协议 → skill 演化
