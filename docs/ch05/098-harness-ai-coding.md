...
## Ch05.098 应用宝活动平台 Harness 工程实践——从对话式 AI Coding 到工程化系统

> 📊 Level ⭐⭐⭐ | 8.7KB | `entities/appstore-activity-harness-engineering-tencent.md`

# 应用宝活动平台 Harness 工程实践——从对话式 AI Coding 到工程化系统

> 原文归档：[原文归档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/tencent-appstore-activity-platform-harness-2026-07-03.md)
...
在 [Harness 综合实体](https://github.com/QianJinGuo/wiki/blob/main/entities/harness-engineering.md) 的基础上，本文贡献了一个可操作的知识库工程架构：
...
本文提出贯穿整套 Harness 工程的核心原则，是已有的 [Harness 综合实体](https://github.com/QianJinGuo/wiki/blob/main/entities/harness-engineering.md) 未覆盖的生产级判断准则：
...
> 参见 [Code is cheap: Harness 方法论——水流理论、最小混沌单元与反 slop](https://github.com/QianJinGuo/wiki/blob/main/entities/code-is-cheap-harness-water-flow-wuyue-aliyun-2026.md)——前者从第一性原理推导 Harness 方法论，本文提供生产级实现细节，两者互补。本文也补充了 [腾讯技术工程 Harness 探索之旅](https://github.com/QianJinGuo/wiki/blob/main/entities/harness-engineering-exploration-journey-tencent.md) 中缺失的工程细节。

## 标签

#HarnessEngineering #腾讯 #应用宝 #生产实践 #知识工程 #状态驱动 #专家Agent #ForkJoin #冲突治理 #脚本执行 #DevOps集成 #TDD #代码架构

→ [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/tencent-appstore-activity-platform-harness-2026-07-03.md)
