...
## Ch05.121 Harness 工程可视化：Vibe Coding 中重建工程可控性
...
- Tool: Routa Desktop v0.12.1 (https://github.com/phodal/routa/releases/tag/v0.12.1) See also [Harness Engineering](ch05/117-harness-engineering.html)
