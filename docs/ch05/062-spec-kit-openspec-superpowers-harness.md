...
这与 [Agent vs Workflow 控制权连续谱](../ch04/756-agent-vs-workflow.html)中描述的"受控自主"模式一致：不是完全信任 AI 的自主性，也不是完全剥夺 AI 的灵活性，而是在多层约束中给 AI 留出可控的自由度。
...
- [Agent vs Workflow 控制权连续谱](../ch04/756-agent-vs-workflow.html) — 架构选择的底层框架
