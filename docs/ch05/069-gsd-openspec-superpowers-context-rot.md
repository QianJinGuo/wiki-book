...
## Ch05.069 GSD 完胜 OpenSpec 和 Superpowers？源码拆完发现：三者防的是 context rot 的三道防线
...
> → [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/gsd-openspec-superpowers-context-rot-three-defenses-运维有术.md)
...
- 涉及 [Openspec Spec Driven Development Trae Solo](https://github.com/QianJinGuo/wiki/blob/main/entities/openspec-spec-driven-development-trae-solo.md) 和 [Three Tools In One Gstack Superpowers Openspec Engineering Ai Coding](https://github.com/QianJinGuo/wiki/blob/main/entities/three-tools-in-one-gstack-superpowers-openspec-engineering-ai-coding.md)：从源码角度分析了 OpenSpec 和 Superpowers 的机制差异。
