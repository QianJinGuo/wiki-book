...
- 涉及 [Openspec Spec Driven Development Trae Solo](ch05/047-openspec.md) 和 [Three Tools In One Gstack Superpowers Openspec Engineering Ai Coding](ch05/081-ai-coding.md)：从源码角度分析了 OpenSpec 和 Superpowers 的机制差异。
