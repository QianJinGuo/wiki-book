...
- 涉及 [Openspec Spec Driven Development Trae Solo](ch01/1026-spec.md) 和 [Three Tools In One Gstack Superpowers Openspec Engineering Ai Coding](ch04/069-ai.md)：从源码角度分析了 OpenSpec 和 Superpowers 的机制差异。
