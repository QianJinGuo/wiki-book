...
- [Agent Harness 上下文管理](ch05/057-agent-harness.html) —— 工作集视角 + subagent 隔离
...
- [From Agent Protocol to Harness Skill](../ch04/425-from-agent-protocol-to-harness-skill.html) —— 协议 → skill 演化
