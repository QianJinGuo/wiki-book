...
- [Claude Code 20000 字符源码分析](ch03/074-claude-code.md) —— 98.4% 基础设施论据
- [Agent Harness 上下文管理](ch03/044-agent.md) —— 工作集视角 + subagent 隔离
- [Harness Engineering](ch05/061-harness-engineering.md) —— 系统性 harness 实践
- [Agent Self-Improvement Six Mechanisms](ch03/044-agent.md) —— 长期连贯性相关
