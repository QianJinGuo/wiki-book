...
## Ch05.056 SSD Spec 驱动开发实战：从四条约束到 ASD Harness 的工程落地
...
- [术哥三器对比：Comet/OpenSpec/Superpowers](ch05/128-ai-coding.html) — 同作者系列第二篇
- [Spec 作为 AIOS 反熵架构](ch05/022-ai-native.html)
