...
## Ch05.059 Trellis vs Superpowers 源码对比：不同抽象层的工程框架
...
- → [GSD vs OpenSpec vs Superpowers 源码对比](ch05/079-gsd-openspec-superpowers-context-rot.html)（同一作者的前作，聚焦 context rot）
...
- → [Superpowers 深度解析](ch05/085-ai.html)（superpowers 全景）
