...
→ [Cursor Harness 复盘](ch01/350-cursor-harness-model-production-floor.md)（模型 vs Harness 组合）
→ [Claude Code 提示词体系](ch03/075-claude-code.md)
→ [Agent Harness 上下文管理](ch05/009-harness.md)
