...
- [Agent Orchestration Multi Agent Systems](../ch04/590-agent-orchestration.html) — 多智能体编排的基础架构模式，OMEGA 将其扩展到物理机器人领域
...
- [阿里云刚发布的 Agentloop 是什么](../ch04/348-agentloop.html) — 阿里云的 AgentLoop 编排方案，为软件侧的多 agent 协作提供另一种范式参考
