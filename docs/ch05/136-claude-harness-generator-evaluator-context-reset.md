...
- [Agent Harness 上下文管理：工作集视角](ch05/043-agent-harness.html) — compaction 光谱 + session/harness/sandbox 解耦
- [LangChain Anatomy of Agent Harness](ch05/043-agent-harness.html) — Ralph 循环 + 规划/自我验证双闭环
...
- [Agent Harnesses Are Dead Long Live Agent Harnesses](../ch04/824-agent-harnesses-are-dead-long-live-agent-harnesses.html)
...
- [Anthropic Institute When Ai Builds Itself Jiagoux Interpretation](../ch01/1592-anthropic.html)
