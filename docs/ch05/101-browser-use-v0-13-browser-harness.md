...
## Ch05.101 browser-use v0.13 Browser Harness：薄抽象层设计哲学
...
> → [原文存档](https://raw.githubusercontent.com/QianJinGuo/wiki/main/raw/articles/browser-use-v13-harness-thin-abstraction-数据STUDIO.md)
