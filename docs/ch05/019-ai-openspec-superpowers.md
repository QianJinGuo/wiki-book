...
## Ch05.019 AI 生产开发工作流：OpenSpec 规范驱动 + Superpowers 工具链
...
→ [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/ai-production-development-workflow-openspec-superpowers-gstack.md)
...
补充自 [原文存档](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/openspec-superpowers-gstack-vibe-coding-interview-carl-2026-06-12.md)，提供同一三件套的**面试导向解读**——把第 1 来源的工程视角转为求职问答结构，补充 5 个高频面试题标准答法 + "什么时候该用/别用"的决策框架。
