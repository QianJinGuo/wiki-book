...
## Ch05.147 browser-use v0.13 Browser Harness：薄抽象层设计哲学
...
- 补充 [Browser Harness](ch05/147-browser-use-v0-13-browser-harness.html)：该实体覆盖 Browser Harness 早期版本概念（来自 GitHub 仓库），本文聚焦 v0.13.2 最新架构变化和设计哲学。
