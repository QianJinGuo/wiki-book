...
| [Claude Code Skills Superpowers Practice](../ch01/703-claude-code-skills-superpowers.html) | **Superpowers 技能实践** | Superpowers Skills 实践 |
| [Spec Kit Bmad Sdd Practice Yexiaocha](../ch01/1191-spec.html) | **Spec-Kit + BMAD** | Spec-Kit + BMAD SDD 实践（不同 SDD 流派） |
