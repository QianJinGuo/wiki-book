...
## Ch05.050 OpenSpec 四步法深度复盘：流程完整 ≠ 代码正确
...
这些问题的共同点是：它们不会出现在文档里，但会出现在运行时。 See also [Harness Engineering](ch05/120-harness-engineering.html)
