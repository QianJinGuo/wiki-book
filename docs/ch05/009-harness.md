...
- [Harness Engineering Systematic Framework](ch05/092-harness-engineering.md)
...
- [协作涌现：agent room 的多智能体决策框架](../ch04/601-agent-room.md)
- [programbench swe agent benchmark](../ch04/497-programbench-swe-agent-benchmark.md)
- [harness 工程可视化：vibe coding 中重建工程可控性](ch05/092-harness-engineering.md)
