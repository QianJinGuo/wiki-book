...
### vs [Claude Code Dynamic Workflows](ch03/077-claude-code.html)
...
- [高德 AI-Native 生产线](ch05/094-ai.html) —— 企业级 R&D 生产线
- [Claude Code Dynamic Workflows](ch03/077-claude-code.html) —— 动态工作流
