...
### vs [Claude Code Dynamic Workflows](ch03/073-claude-code.md)
...
- [高德 AI-Native 生产线](ch04/310-ai.md) —— 企业级 R&D 生产线
- [Claude Code Dynamic Workflows](ch03/073-claude-code.md) —— 动态工作流
