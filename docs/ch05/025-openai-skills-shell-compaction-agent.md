...
## 相关主题
- [Skills Anthropic Openai Comparison Frontend Design](../ch01/697-skills-anthropic-openai-comparison-frontend-design.html) — Anthropic/Google Skills 设计模式对比
- [Claude Code Openclaw Memory Comparison](../ch03/075-claude-code.html) — OpenClaw vs Claude Code 内存对比
