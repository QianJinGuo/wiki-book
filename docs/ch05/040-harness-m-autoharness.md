...
- **来源**: 数据派THU（背靠清华大学）
- **日期**: 2026-04-25
- **相关实体**: [Hermes Agent Deep Dive](https://github.com/QianJinGuo/wiki-public/blob/main/entities/hermes-agent-deep-dive.md)（Hermes的Self-Evolution机制）
- **相关实体**: [Minimax M2 7](../ch03/007-minimax-m2-7.html)（MiniMax的自我进化实践）
