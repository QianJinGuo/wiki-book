...
## Ch05.115 Loop Engineering，应该赞成还是反对？
...
- [Claude Code Loop Engineering Guide](../ch09/174-claude-code-loop-engineering.html) — Claude Code Loop Engineering 指南
- [Claude Code Loop Control Rights Four Levels](../ch01/337-claude-code-loop.html) — Loop 权限控制的四个层次
- [Anthropic 8X Output Verification Bottleneck Fiona Fung](../ch09/098-anthropic-8x.html) — Agent 验证瓶颈讨论
- [Anthropic Claude Code Large Scale Code Migration 2026](../ch01/477-anthropic-claude-code.html) — Anthropic 大规模代码迁移实践
...
- [Harness Engineering](ch05/057-harness-engineering.html) — Harness Engineering 概念体系
- [Claude Code 27 Tips Engineering Upgrade Jiagoux 2026](../ch01/336-claude-code-27.html) — Claude Code 工程实践技巧
