...
## 相关对照
- [Agent Skill 编写指南](ch04/258-skill.md) —— 通用 skill 格式 + 渐进式披露
- [Agent Harness 架构](ch05/009-harness.md) —— 7 层 harness 模型
- [Agent Skills 综合调研](ch04/258-skill.md) —— skill 系统全景
- [Skills Refiner 设计质量评估框架](ch04/258-skill.md)
...
## 关联阅读
- [Agent Skill 编写指南](ch04/258-skill.md) —— skill 格式规范与渐进式披露机制
- [Karpathy Vibe Coding → Agentic Engineering](ch03/045-agent.md) —— Vibe Coding 原始定义与 Software 3.0 演化
- [Claude Design Skill](ch01/1021-claude-design-skill.md) —— Anthropic 的设计 skill 实践对比
- [前端 Design Skills 全景对比](ch01/677-skills-anthropic-openai-comparison-frontend-design.md) —— Anthropic vs OpenAI 设计 skill 生态比较
