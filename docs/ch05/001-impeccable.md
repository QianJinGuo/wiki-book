...
## 相关对照
- [Agent Skill 编写指南](../ch04/604-agent-skill.html) —— 通用 skill 格式 + 渐进式披露
...
## 关联阅读
- [Agent Skill 编写指南](../ch04/604-agent-skill.html) —— skill 格式规范与渐进式披露机制
- [Karpathy Vibe Coding → Agentic Engineering](../ch04/610-agentic.html) —— Vibe Coding 原始定义与 Software 3.0 演化
