...
## 相关对照
- [Agent Skill 编写指南](../ch04/619-agent-skill.html) —— 通用 skill 格式 + 渐进式披露
- [Agent Harness 架构](ch05/066-agent-harness.html) —— 7 层 harness 模型
- [Agent Skills 综合调研](../ch04/497-agent-skills.html) —— skill 系统全景
...
## 关联阅读
- [Agent Skill 编写指南](../ch04/619-agent-skill.html) —— skill 格式规范与渐进式披露机制
...
- [前端 Design Skills 全景对比](../ch01/970-skills-anthropic-openai-comparison-frontend-design.html) —— Anthropic vs OpenAI 设计 skill 生态比较
