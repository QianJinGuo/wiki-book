...
## 相关对照
- [Agent Skill 编写指南](ch04/271-skill.html) —— 通用 skill 格式 + 渐进式披露
- [Agent Harness 架构](ch03/035-agent.html) —— 7 层 harness 模型
- [Agent Skills 综合调研](ch04/271-skill.html) —— skill 系统全景
- [Skills Refiner 设计质量评估框架](ch04/271-skill.html)
...
## 关联阅读
- [Agent Skill 编写指南](ch04/271-skill.html) —— skill 格式规范与渐进式披露机制
