...
## 相关对照
- [Agent Skill 编写指南](../ch04/614-agent-skill.html) —— 通用 skill 格式 + 渐进式披露
- [Agent Harness 架构](ch05/043-agent-harness.html) —— 7 层 harness 模型
- [Agent Skills 综合调研](../ch04/492-agent-skills.html) —— skill 系统全景
...
## 关联阅读
- [Agent Skill 编写指南](../ch04/614-agent-skill.html) —— skill 格式规范与渐进式披露机制
- [Karpathy Vibe Coding → Agentic Engineering](../ch04/297-agentic.html) —— Vibe Coding 原始定义与 Software 3.0 演化
- [Claude Design Skill](../ch01/1372-claude-design-skill.html) —— Anthropic 的设计 skill 实践对比
