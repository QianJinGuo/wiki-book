...
## Ch05.145 Code is cheap: Harness 方法论——水流理论、最小混沌单元与反 slop
...
> 参见也（see also）：[生产级 Harness 架构设计](ch05/042-agent-harness.html)、[Harness 综合范式](ch05/065-harness-engineering.html)
