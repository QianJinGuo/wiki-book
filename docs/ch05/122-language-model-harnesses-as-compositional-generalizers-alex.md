...
- [Reinforcing Recursive Language Models（RLM）](../ch01/1133-reinforcing-recursive-language-models-alphaxiv.html) — RLM 的训练方法论
- [Agent Harness Engineering Survey](ch05/096-harness-engineering.html) — AVS 的多层 harness 分类法
