...
## Ch05.130 OpenSpec + Superpowers：用 OpenCode 搭建 SDD+TDD 双驱动 AI 编程工作流
...
- 原文: [OpenSpec + Superpowers：用 OpenCode 搭建 SDD+TDD 双驱动 AI 编程工作流](https://github.com/QianJinGuo/wiki-book/tree/main/docs/raw/articles/openspec-superpowers-opencode-sdd-tdd-workflow-2026.md)
- 原始链接: : "https://mp.weixin.qq.com/s/Et3q4VVVH4e2VHk597Im4Q
