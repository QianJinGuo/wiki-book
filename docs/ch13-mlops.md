...
## 相关实体
- [Loongsuite Genai Semconv](../ch04-376-loongsuite-genai-可观测语义规范)
...
- [从多智能体编排到Ai自主决策资损防控体系的架构演进](../ch01-305-从多智能体编排到ai自主决策-资损防控体系的架构演进)
- [给氛围编程系上安全带阿里集团 Ai 代码评审实践与 Benchmark 开源](../ch01-310-给-氛围编程-系上安全带-阿里集团-ai-代码评审实践与-benchmark-开源)
...
|---|---|---|
| Loop Engineering | [Tsinghua Harness Engineering Report](../ch05-060-清华大学-驾驭工程-harness-engineering-研究报告) (清华前一份) | **演进**：Harness → Loop，前者讲"系统层"，后者讲"循环层" |
| Loop Stack 六件套 | [Agent Harness 12 Components 7 Decisions](../ch04-061-一篇看懂-agent-harness-的结构-12组件-7决策完整框架) | **视角互补**：六件套偏"循环骨架"，12 件套偏"工程组件" |
| Loop Ledger | [Agent Harness Observability Production](../ch04-468-agent-harness-可观测性-生产级-ai-项目必须补上的一课) | **深化**：从可观测性到可审计账本 |
| Worktree Fleet | [Agent Engineering Principles Architecture Practice](../ch04-435-agent-engineering-principles-architecture-practice) | **深化**：从"隔离原则"到"舰队编排" |
| Entropy Janitor | [Hermes Agent Closed Learning Loop](../ch01-326-hermes-agent-closed-learning-loop) | **扩展**：闭环学习的"清理步骤"形式化 |
...
## 相关实体
- [清华 ai 自进化组织研究报告：ai 业务资产化与公司形态重构](../ch01-246-清华-ai-自进化组织研究报告-ai-业务资产化与公司形态重构)
...
- [MobileGym](../ch04-052-mobilegym-中科院开源浏览器内安卓仿真平台-mobile-agent-训练与评测基础设施) — Mobile Agent 训练与评测基础设施
- [YAML 驱动的 Agent 评估框架](../ch01-746-从手动到自动化-用agenteval构建agent评测体系)
...
- [AI 评估的三种方法](../ch01-492-evals-到底在评什么-一文拆解-ai-评估的三种方法)
- [Agent Skill 写作评估](https://github.com/QianJinGuo/wiki/blob/main/entities/agent-skill-writing-evaluation.md)
- [AI 工作面试与模型评估](../ch01-460-给-ai-做工作面试-mollick-的模型评估方法论)
- [Inngest 2026 AI 评测报告](../ch01-150-inngest-ai-in-production-the-2026-benchmark-report)
- [Agent Harness 生产设计指南](../ch04-021-agent-harness-架构设计与实现-生产级-agent-系统落地指南)
- [Agent 工程原则](../ch04-435-agent-engineering-principles-architecture-practice)
- [SkillClaw Hyman 阿里 Skill 框架](../ch04-407-agent-技能夜间自进化-阿里开源-skillclaw-最高提升-88)
- [SkillX 浙大 Hyman](../ch01-584-浙大开源skillx-全自动构建agent技能知识库-即插即用提升10-性能)
- [Claude Code 最佳社区 Fork 演进](../ch01-797-claude-code-泄露后的漏网之鱼-claude-code-best-这两个月到底演进了什么)
...
→ [测评指标体系](../ch01-383-ai-skill-测评指标体系)
...
## Related
- [Hermes Agent](../ch07-007-hermes-agent-满配-12-层配置完整指南-从裸装到-24h-agent-团队) — Nous Research 开源 Agent 框架，可观测性是其生产落地关键能力
- [Hermes Agent 深度解析](../ch04-418-hermes-agent) — Self-Evolving/动态 Skill 沉淀/RL 训练闭环等深度解析
...
- [Claude Code 深度解析](../ch01-846-claude-code-架构深度解析) — agentic 系统的性能—成本权衡
...
MCG 在无法置信填充字段时，输出 "not found" 或 "information not available" 而非猜测捏造。这一设计选择对监管合规场景至关重要——[治理软规则](../ch09-067-claude-code-可控性-软规则无法变成硬约束) 中同样指出，不确定情况下的"猜测性生成"在审计场景会构成风险。模型卡需要具备完整的审计追溯性，自动生成的内容若是编造而非基于真实数据，反而会加剧监管风险。MCG 将"Gap 发现"功能定位为卖点而非缺陷，这意味着它既适合文档完善的团队加速生产，也适合文档初建的团队识别缺口。
...
- **与 [CVPR 2026 小米 SVOR 视频掩码](../ch01-716-cvpr冠军代码开源-小米svor破解视频消除三大顽疾-连人带影一键抹除)**：同属 CVPR 2026 + 顶级中国大厂 + 视频/图像生成；**互补不重复**（小米是视频生成，美团是海报生成）
- **与 [JOYAI Echo 长视频框架（京东）](../ch04-099-joyai-echo-京东开源长音视频生成框架-5-分钟一致性-7-5x-dmd-加速-director-age)**：同属顶会论文 + 顶级中国大厂 + 内容生成；美团侧重**海报（静态 + 文字）**，京东侧重**视频**
- **与 [GPT-Image-2 完全指南](../ch01-654-gpt-image-2-完全指南-附大量玩法案例-顺便开源我的生图-skill)**：都讲 AIGC 文生图；GPT-Image-2 是**工具使用**，美团 PosterCraft 是**学术论文级** + 完整技术体系
- **与 [腾讯陈进 Agent Loop 工程手册](../ch04-143-agent-loop-工程手册-8-个未解问题-self-protocol-治理薄壳-腾讯陈进的二手解读与单-age)**：都强调"评估驱动生成"思想（陈进的 SELF Protocol 30 天实验 / 美团 PosterReward RL 奖励信号）
...
- [CVPR 2026 小米 SVOR 视频掩码](../ch01-716-cvpr冠军代码开源-小米svor破解视频消除三大顽疾-连人带影一键抹除)
- [JOYAI Echo 长视频框架（京东）](../ch04-099-joyai-echo-京东开源长音视频生成框架-5-分钟一致性-7-5x-dmd-加速-director-age)
- [GPT-Image-2 完全指南](../ch01-654-gpt-image-2-完全指南-附大量玩法案例-顺便开源我的生图-skill)
- [腾讯陈进 Agent Loop 工程手册](../ch04-143-agent-loop-工程手册-8-个未解问题-self-protocol-治理薄壳-腾讯陈进的二手解读与单-age)
