...
| Loop Stack 六件套 | [Agent Harness 12 Components 7 Decisions](ch04/502-agent.md) | **视角互补**：六件套偏"循环骨架"，12 件套偏"工程组件" |
| Loop Ledger | [Agent Harness Observability Production](ch04/502-agent.md) | **深化**：从可观测性到可审计账本 |
...
| Triage 三种输出 | [Agent Harness Context Management Working Set](ch04/502-agent.md) | **深化**：从"上下文管理"到"信号路由" |
...
- [EVA-Bench Data 2.0](ch04/502-agent.md) — 语音 Agent 垂直领域评估
- [MobileGym](ch04/502-agent.md) — Mobile Agent 训练与评测基础设施
- [YAML 驱动的 Agent 评估框架](ch04/502-agent.md)
- [Agent 记忆评估综述](ch04/502-agent.md)
...
- [Agent Harness 生产设计指南](ch04/502-agent.md)
...
- [Hermes Agent 深度解析](ch04/502-agent.md) — Self-Evolving/动态 Skill 沉淀/RL 训练闭环等深度解析
...
- **与 [腾讯陈进 Agent Loop 工程手册](ch04/502-agent.md)**：都强调"评估驱动生成"思想（陈进的 SELF Protocol 30 天实验 / 美团 PosterReward RL 奖励信号）
...
- [腾讯陈进 Agent Loop 工程手册](ch04/502-agent.md)
