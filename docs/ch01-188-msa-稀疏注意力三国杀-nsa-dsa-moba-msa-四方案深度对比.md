...
- [MiniMax M3 开源 Frontier 模型](../ch09-062-minimax-m3-开源-frontier-模型) — MSA 是 M3 的核心架构创新
- [DeepSeek V4 Flash Pro 1M 上下文](../ch01-726-deepseek-v4-flash-pro-通往百万级上下文与万亿参数推理的新纪元) — 压得狠路线的最新代表
- [DeepSeek V4 训练方法学](https://github.com/QianJinGuo/wiki/blob/main/entities/deepseek-v4-training-methodology.md) — 训练配方对比
- [Lighthouse Attention](../ch01-071-lighthouse-attention) — 另一款稀疏 attention 方案（对称 Q/K/V 池化）
...
- [近期 LLM 架构进展](../ch01-847-recent-developments-in-llm-architectures-kv-sharing-mhc-a) — 注意力架构的近期综述
- [Agent 自我改进循环](https://github.com/QianJinGuo/wiki/blob/main/concepts/agent-self-improvement-loops.md) — KL 对齐作为 "强教弱" 范式的理论基础
- [M3 开源三件套](../ch01-814-国内首个-frontier-三件套开源大模型-minimax-m3-完整技术拆解) — 同一文章的不同角度解读
