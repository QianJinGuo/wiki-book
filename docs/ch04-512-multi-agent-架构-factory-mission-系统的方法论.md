...
这一设计与 [Harness 状态边界与失败闭环](../ch05-015-harness-之后-状态边界与失败闭环-若飞续篇) 中强调的"边界即文档"的工程哲学一致——Agent 系统的可靠性不来自 Agent 自身的记忆，而来自跨边界时强制落盘的中间表示。
...
这与 [AgentOps on Bedrock](../ch04-268-agentops-operationalize-agentic-ai-at-scale-with-amazon-bed) 中关于"多模型编排降低单点故障"的设计哲学一致——异构性是鲁棒性的来源。
...
- [Claude Managed Agents 企业自托管](../ch04-421-claude-managed-agents)——Multi-Agent 的企业部署形态
- [Agent 记忆系统工程实践](../ch01-707-存之有序-治之有矩-agent-记忆系统的工程实践与演进)——过程资产积累的方向
- [Harness 状态边界与失败闭环](../ch05-015-harness-之后-状态边界与失败闭环-若飞续篇)——边界即文档的工程哲学
- [AgentOps on Bedrock](../ch04-268-agentops-operationalize-agentic-ai-at-scale-with-amazon-bed)——多模型编排降低单点故障
