...
## Ch11.150 What You Need to Know About Lambda MicroVMs
...
- [Firecracker — Lambda MicroVMs 的底层虚拟化技术](/ch11-150-what-you-need-to-know-about-lambda-microvms/)
- [Serverless — Lambda MicroVMs 扩展了 serverless 的边界](/ch11-084-aws-bedrock-serverless-async-inference-sqs-lambda/)
- [E2B — 应用层 sandbox 方案，Lambda MicroVMs 的替代选择](/ch11-150-what-you-need-to-know-about-lambda-microvms/)
