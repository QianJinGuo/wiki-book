...
- "通用 Pass + 配置化范围约束" 类似 [nanobot](/ch01-208-nanobot-4000行极简-agent-框架架构解析/) 的"统一 Tool 接口 + Skill 范围声明"
...
- [Nanobot Agent Framework Architecture Deep Dive](/ch01-208-nanobot-4000行极简-agent-框架架构解析/) — "通用机制 + 范围约束"的元模式在 Agent 领域的应用
- [Harness Engineering Framework](/ch05-041-harness-engineering-概念框架//) — 系统工程中"通用 + 可配置"的范式
