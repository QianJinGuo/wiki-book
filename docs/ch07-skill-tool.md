...
- [060. AIOps MCP Agent](ch07/060-aiops-mcp-agent)
- [061. Skill Craft：Claude Skill 质量工程工具](ch07/061-skill-craft-claude-skill)
- [062. Anthropic MCP 重新定义：Tool Search + 代码编排](ch07/062-anthropic-mcp-tool-search)
- [063. 重新定义Skill开发：保姆级教程&一站式开发助手发布](ch07/063-skill)
- [064. 你写的 Skill，及格了吗？](ch07/064-skill)
- [065. 我用 SKILL.md 做了一个简历生成器](ch07/065-skill-md)
- [066. 高德交易 VOC 自动排查：基于 Hermes 的多 Agent 架构实践](ch07/066-voc-hermes-agent)
- [067. WorkBuddy Skill 全拆解](ch07/067-workbuddy-skill)
- [068. Anthropic Claude Skill 9 类任务分类法](ch07/068-anthropic-claude-skill-9)
- [069. NeurIPS 2026 Rebuttal Skill — 开源论文回复 Skill 工作流](ch07/069-neurips-2026-rebuttal-skill-skill)
- [070. AI + Skills 打通中间件迁移：Android 到鸿蒙定位服务实践](ch07/070-ai-skills-android)
- [071. Skill 版本对比五大原则：从'两个数字比大小'到工程化质量门禁](ch07/071-skill)
- [072. 李继刚 23 个 Skills 深度拆解——认知工序流水线](ch07/072-23-skills)
- [073. Multica — 开源 Managed Agents 平台](ch07/073-multica-managed-agents)
- [074. 龙虾之父教你省钱：开源Skill给你的Skill减肥](ch07/074-skill-skill)
- [075. 腾讯企业微信团队 Skill 流水线：AI代码生成率94%的需求开发全流程](ch07/075-skill-ai-94)
- [076. 如何构建生产准备的AI代理：MCP、CLI与技能——适合合适的工作的工具](ch07/076-ai-mcp-cli)
- [077. CLI系列④·选型CLI、MCP还是API？](ch07/077-cli-cli-mcp-api)
- [078. 让 Amazon Quick 操作飞书：构建远程 MCP 服务的设计实践](ch07/078-amazon-quick-mcp)
- [079. Introducing the MDN MCP server](ch07/079-introducing-the-mdn-mcp-server)
- [080. 当我把AI变成一个\"算法\"：Skill工程化设计的心路历程](ch07/080-ai-skill)
- [081. SkillComposer: 生成式技能组合](ch07/081-skillcomposer)
- [082. Building and connecting a production-ready ecommerce MCP server using Amazon Bedrock AgentCore and Mistral AI Studio](ch07/082-building-and-connecting-a-production-ready-ecommerce-mcp-ser)
- [083. skill-mcp — 把 AI 技能当软件包管理（MCP 权限网关 + 只调度不执行的 Pipeline）](ch07/083-skill-mcp-ai-mcp-pipeline)
- [084. PagePilot — PC端AI测试Skill设计与实战](ch07/084-pagepilot-pc-ai-skill)
- [085. LibTV把导演的手艺装进了Skill商店，我拿三支片子验了验](ch07/085-libtv-skill)
