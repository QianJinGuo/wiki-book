...
- [049. skill-up: 阿里开源 Agent Skill 评测框架](ch07/049-skill-up-agent-skill)
- [050. Skill Craft — Claude Skill 质量工程框架](ch07/050-skill-craft-claude-skill)
- [051. Agent Loop 架构三层模型：Loop + Skill + Orchestrator](ch07/051-agent-loop-loop-skill-orchestrator)
- [052. 李继刚 ljg Skills 系列（四）：表达写作类 Skill](ch07/052-ljg-skills-skill)
- [053. SkillX — 层次化技能知识库](ch07/053-skillx)
- [054. 让Skill"有图可依"：openJiuwen首发多模态Skill范式Skill-Omni](ch07/054-skill-openjiuwen-skill-skill-omni)
- [055. 我给 WorkBuddy 加浏览器 Skill](ch07/055-workbuddy-skill)
- [056. Skill Craft：Claude Skill 质量工程工具](ch07/056-skill-craft-claude-skill)
- [057. Anthropic MCP 重新定义：Tool Search + 代码编排](ch07/057-anthropic-mcp-tool-search)
- [058. 重新定义Skill开发：保姆级教程&一站式开发助手发布](ch07/058-skill)
- [059. 你写的 Skill，及格了吗？](ch07/059-skill)
- [060. 我用 SKILL.md 做了一个简历生成器](ch07/060-skill-md)
- [061. 高德交易 VOC 自动排查：基于 Hermes 的多 Agent 架构实践](ch07/061-voc-hermes-agent)
- [062. Anthropic 官方生产级 Agent 最佳实践：12 个可复用的 MCP 设计模式](ch07/062-anthropic-agent-12-mcp)
- [063. WorkBuddy Skill 全拆解](ch07/063-workbuddy-skill)
- [064. How Smartsheet built a remote MCP server on AWS](ch07/064-how-smartsheet-built-a-remote-mcp-server-on-aws)
- [065. Anthropic Claude Skill 9 类任务分类法](ch07/065-anthropic-claude-skill-9)
- [066. AI + Skills 打通中间件迁移：Android 到鸿蒙定位服务实践](ch07/066-ai-skills-android)
- [067. Skill 版本对比五大原则：从'两个数字比大小'到工程化质量门禁](ch07/067-skill)
- [068. Multica — 开源 Managed Agents 平台](ch07/068-multica-managed-agents)
- [069. 龙虾之父教你省钱：开源Skill给你的Skill减肥](ch07/069-skill-skill)
- [070. 李继刚 23 个 Skills 深度拆解——认知工序流水线](ch07/070-23-skills)
- [071. 腾讯企业微信团队 Skill 流水线：AI代码生成率94%的需求开发全流程](ch07/071-skill-ai-94)
- [072. 如何构建生产准备的AI代理：MCP、CLI与技能——适合合适的工作的工具](ch07/072-ai-mcp-cli)
- [073. CLI系列④·选型CLI、MCP还是API？](ch07/073-cli-cli-mcp-api)
- [074. 让 Amazon Quick 操作飞书：构建远程 MCP 服务的设计实践](ch07/074-amazon-quick-mcp)
- [075. Introducing the MDN MCP server](ch07/075-introducing-the-mdn-mcp-server)
- [076. 当我把AI变成一个\"算法\"：Skill工程化设计的心路历程](ch07/076-ai-skill)
- [077. skill-mcp — 把 AI 技能当软件包管理（MCP 权限网关 + 只调度不执行的 Pipeline）](ch07/077-skill-mcp-ai-mcp-pipeline)
- [078. SkillComposer: 生成式技能组合](ch07/078-skillcomposer)
...
- [080. Create Custom MCP Catalogs and Profiles](ch07/080-create-custom-mcp-catalogs-and-profiles)
- [081. PagePilot — PC端AI测试Skill设计与实战](ch07/081-pagepilot-pc-ai-skill)
- [082. LibTV把导演的手艺装进了Skill商店，我拿三支片子验了验](ch07/082-libtv-skill)
- [083. 25个Skills详解：从生产力清单到AI工作流资产](ch07/083-25-skills-ai)
- [084. Perplexity 首次公开了内部 Skill 设计指南](ch07/084-perplexity-skill)
- [085. Codex Record & Replay：GUI 演示到可复用 Skill 的工作流捕获](ch07/085-codex-record-replay-gui-skill)
- [086. 一份可信来源，终结 Skill 管理混乱：Skill 治理最佳实践](ch07/086-skill-skill)
- [087. NeurIPS 2026 Rebuttal Skill — 开源论文回复 Skill 工作流](ch07/087-neurips-2026-rebuttal-skill-skill)
