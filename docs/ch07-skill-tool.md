...
- [032. Skill自进化三路线：Trace2Skill归纳法 / EvoSkill验证闭环 / SkillOpt训练范式](ch07/032-skill-trace2skill-evoskill-skillopt.md)
- [033. MapSatisfyBench：首个以满意度为核心目标的地图智能体评测基准](ch07/033-mapsatisfybench.md)
- [034. Matt Pocock Skills — AI编程技能集合](ch07/034-matt-pocock-skills-ai.md)
- [035. Autobrowse Browserbase Persistent Skill](ch07/035-autobrowse-browserbase-persistent-skill.md)
- [036. 使用 Kiro 和 MCP 自动化大规模升级 RDS MySQL 8.0 至 RDS MySQL 8.4](ch07/036-kiro-mcp-rds-mysql-8-0-rds-mysql-8-4.md)
- [037. AI-Infra-Auto-Driven-SKILLS v0.1.0：给 Codex / Claude Code 的推理框架工作流](ch07/037-ai-infra-auto-driven-skills-v0-1-0-codex-claude-code.md)
- [038. Wiki Evolver Skill System Design (GPT-5.5 Copilot Session)](ch07/038-wiki-evolver-skill-system-design-gpt-5-5-copilot-session.md)
- [039. Autonomous Vulnerability Hunting with MCP](ch07/039-autonomous-vulnerability-hunting-with-mcp.md)
- [040. AWS DevOps Agent × MCP Server：打通混合云网络排障的最后一公里](ch07/040-aws-devops-agent-mcp-server.md)
- [041. Skill 版本管理五大原则：从越改越差到持续演进](ch07/041-skill.md)
- [042. Skill Craft — Claude Skill 质量工程框架](ch07/042-skill-craft-claude-skill.md)
- [043. Agent Loop 架构三层模型：Loop + Skill + Orchestrator](ch07/043-agent-loop-loop-skill-orchestrator.md)
- [044. SkillX — 层次化技能知识库](ch07/044-skillx.md)
- [045. Skill Craft：Claude Skill 质量工程工具](ch07/045-skill-craft-claude-skill.md)
- [046. Anthropic MCP 重新定义：Tool Search + 代码编排](ch07/046-anthropic-mcp-tool-search.md)
- [047. 重新定义Skill开发：保姆级教程&一站式开发助手发布](ch07/047-skill.md)
- [048. 你写的 Skill，及格了吗？](ch07/048-skill.md)
- [049. 我用 SKILL.md 做了一个简历生成器](ch07/049-skill-md.md)
- [050. Anthropic 官方生产级 Agent 最佳实践：12 个可复用的 MCP 设计模式](ch07/050-anthropic-agent-12-mcp.md)
- [051. AI + Skills 打通中间件迁移：Android 到鸿蒙定位服务实践](ch07/051-ai-skills-android.md)
- [052. Skill 版本对比五大原则：从'两个数字比大小'到工程化质量门禁](ch07/052-skill.md)
- [053. Multica — 开源 Managed Agents 平台](ch07/053-multica-managed-agents.md)
- [054. 龙虾之父教你省钱：开源Skill给你的Skill减肥](ch07/054-skill-skill.md)
- [055. 如何构建生产准备的AI代理：MCP、CLI与技能——适合合适的工作的工具](ch07/055-ai-mcp-cli.md)
- [056. CLI系列④·选型CLI、MCP还是API？](ch07/056-cli-cli-mcp-api.md)
