...
- [025. 三层 Agent 架构：Skill / SubAgent / Agent Team 工程实践](ch07/025-agent-skill-subagent-agent-team)
- [026. Claude Code MCP Server](ch07/026-claude-code-mcp-server)
- [027. SkillOpt — 微软训练 Skill 文档的方法论](ch07/027-skillopt-skill)
...
- [030. Skill自进化三路线：Trace2Skill归纳法 / EvoSkill验证闭环 / SkillOpt训练范式](ch07/030-skill-trace2skill-evoskill-skillopt)
- [031. 电商 AI 操作系统崛起：从「工具人」到「All in One」+ 行业 KnowHow Skill 化 + 5 巨头 Headless 布局](ch07/031-ai-all-in-one-knowhow-skill-5-headless)
- [032. 京东健康 OPC 团队产品全流程 Skill 探索](ch07/032-opc-skill)
- [033. Qoder Skills 完全指南](ch07/033-qoder-skills)
- [034. Claude Code Skills 实战指南 — 发现机制、编写与安全](ch07/034-claude-code-skills)
- [035. CLI、MCP 和 CLI+Skill，应该如何选？](ch07/035-cli-mcp-cli-skill)
- [036. The new AI lock-in](ch07/036-the-new-ai-lock-in)
- [037. MapSatisfyBench：首个以满意度为核心目标的地图智能体评测基准](ch07/037-mapsatisfybench)
- [038. Autobrowse Browserbase Persistent Skill](ch07/038-autobrowse-browserbase-persistent-skill)
- [039. Wiki Evolver Skill System Design (GPT-5.5 Copilot Session)](ch07/039-wiki-evolver-skill-system-design-gpt-5-5-copilot-session)
- [040. 使用 Kiro 和 MCP 自动化大规模升级 RDS MySQL 8.0 至 RDS MySQL 8.4](ch07/040-kiro-mcp-rds-mysql-8-0-rds-mysql-8-4)
- [041. AI-Infra-Auto-Driven-SKILLS v0.1.0：给 Codex / Claude Code 的推理框架工作流](ch07/041-ai-infra-auto-driven-skills-v0-1-0-codex-claude-code)
- [042. 高德扫街榜 HermesAgent 配图系统：VLM + Skill + 语言驱动的生产级 Agent 架构](ch07/042-hermesagent-vlm-skill-agent)
- [043. Autonomous Vulnerability Hunting with MCP](ch07/043-autonomous-vulnerability-hunting-with-mcp)
- [044. AWS DevOps Agent × MCP Server：打通混合云网络排障的最后一公里](ch07/044-aws-devops-agent-mcp-server)
- [045. OpenClaw 深度架构分析：Agent 引擎、多源 Skill 系统、子 Agent steer 重定向、五层容错](ch07/045-openclaw-agent-skill-agent-steer)
...
- [049. SkillX — 层次化技能知识库](ch07/049-skillx)
- [050. Skill Craft：Claude Skill 质量工程工具](ch07/050-skill-craft-claude-skill)
- [051. Anthropic MCP 重新定义：Tool Search + 代码编排](ch07/051-anthropic-mcp-tool-search)
...
- [057. Anthropic 官方生产级 Agent 最佳实践：12 个可复用的 MCP 设计模式](ch07/057-anthropic-agent-12-mcp)
- [058. Anthropic Claude Skill 9 类任务分类法](ch07/058-anthropic-claude-skill-9)
- [059. AI + Skills 打通中间件迁移：Android 到鸿蒙定位服务实践](ch07/059-ai-skills-android)
- [060. Skill 版本对比五大原则：从'两个数字比大小'到工程化质量门禁](ch07/060-skill)
- [061. Multica — 开源 Managed Agents 平台](ch07/061-multica-managed-agents)
- [062. 龙虾之父教你省钱：开源Skill给你的Skill减肥](ch07/062-skill-skill)
- [063. 李继刚 23 个 Skills 深度拆解——认知工序流水线](ch07/063-23-skills)
- [064. 如何构建生产准备的AI代理：MCP、CLI与技能——适合合适的工作的工具](ch07/064-ai-mcp-cli)
- [065. CLI系列④·选型CLI、MCP还是API？](ch07/065-cli-cli-mcp-api)
- [066. 让 Amazon Quick 操作飞书：构建远程 MCP 服务的设计实践](ch07/066-amazon-quick-mcp)
- [067. Introducing the MDN MCP server](ch07/067-introducing-the-mdn-mcp-server)
- [068. 当我把AI变成一个\"算法\"：Skill工程化设计的心路历程](ch07/068-ai-skill)
