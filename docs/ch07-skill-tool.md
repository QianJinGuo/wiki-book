...
- [009. 我把 Claude Design 做成了 Skill，人人都能成为顶级网站设计师](ch07/009-claude-design-skill)
- [010. 重新定义Skill开发：保姆级教程&一站式开发助手](ch07/010-skill)
...
- [021. Skill自进化三路线：Trace2Skill归纳法 / EvoSkill验证闭环 / SkillOpt训练范式](ch07/021-skill-trace2skill-evoskill-skillopt)
- [022. MCP tool design: Practical approaches and tradeoffs](ch07/022-mcp-tool-design-practical-approaches-and-tradeoffs)
- [023. MCP-based Interactive PDF Text Extraction from Amazon S3](ch07/023-mcp-based-interactive-pdf-text-extraction-from-amazon-s3)
- [024. Matt Pocock Skills — AI编程技能集合](ch07/024-matt-pocock-skills-ai)
- [025. Embabel](ch07/025-embabel)
- [026. Claude Code SKILL.md 写作指南](ch07/026-claude-code-skill-md)
- [027. Anthropic knowledge-work-plugins 源码拆解：4 种组件、3 级加载、2 层记忆、岗位型插件市场](ch07/027-anthropic-knowledge-work-plugins-4-3-2)
