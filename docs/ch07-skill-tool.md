...
- [085. 25个Skills详解：从生产力清单到AI工作流资产](ch07/085-25-skills-ai)
- [086. Perplexity 首次公开了内部 Skill 设计指南](ch07/086-perplexity-skill)
- [087. Codex Record & Replay：GUI 演示到可复用 Skill 的工作流捕获](ch07/087-codex-record-replay-gui-skill)
- [088. 一份可信来源，终结 Skill 管理混乱：Skill 治理最佳实践](ch07/088-skill-skill)
- [089. Amazon EKS MCP Server](ch07/089-amazon-eks-mcp-server)
- [090. MCP Protocol](ch07/090-mcp-protocol)
- [091. AIOps MCP Agent](ch07/091-aiops-mcp-agent)
