...
- [054. Skill Craft：Claude Skill 质量工程工具](ch07/054-skill-craft-claude-skill)
- [055. Anthropic MCP 重新定义：Tool Search + 代码编排](ch07/055-anthropic-mcp-tool-search)
- [056. 重新定义Skill开发：保姆级教程&一站式开发助手发布](ch07/056-skill)
- [057. 你写的 Skill，及格了吗？](ch07/057-skill)
- [058. 我用 SKILL.md 做了一个简历生成器](ch07/058-skill-md)
- [059. 高德交易 VOC 自动排查：基于 Hermes 的多 Agent 架构实践](ch07/059-voc-hermes-agent)
- [060. Anthropic 官方生产级 Agent 最佳实践：12 个可复用的 MCP 设计模式](ch07/060-anthropic-agent-12-mcp)
- [061. Anthropic Claude Skill 9 类任务分类法](ch07/061-anthropic-claude-skill-9)
- [062. AI + Skills 打通中间件迁移：Android 到鸿蒙定位服务实践](ch07/062-ai-skills-android)
- [063. Skill 版本对比五大原则：从'两个数字比大小'到工程化质量门禁](ch07/063-skill)
- [064. Multica — 开源 Managed Agents 平台](ch07/064-multica-managed-agents)
- [065. 龙虾之父教你省钱：开源Skill给你的Skill减肥](ch07/065-skill-skill)
- [066. 李继刚 23 个 Skills 深度拆解——认知工序流水线](ch07/066-23-skills)
- [067. 腾讯企业微信团队 Skill 流水线：AI代码生成率94%的需求开发全流程](ch07/067-skill-ai-94)
- [068. 如何构建生产准备的AI代理：MCP、CLI与技能——适合合适的工作的工具](ch07/068-ai-mcp-cli)
- [069. CLI系列④·选型CLI、MCP还是API？](ch07/069-cli-cli-mcp-api)
- [070. 让 Amazon Quick 操作飞书：构建远程 MCP 服务的设计实践](ch07/070-amazon-quick-mcp)
- [071. Introducing the MDN MCP server](ch07/071-introducing-the-mdn-mcp-server)
- [072. 当我把AI变成一个\"算法\"：Skill工程化设计的心路历程](ch07/072-ai-skill)
- [073. skill-mcp — 把 AI 技能当软件包管理（MCP 权限网关 + 只调度不执行的 Pipeline）](ch07/073-skill-mcp-ai-mcp-pipeline)
- [074. SkillComposer: 生成式技能组合](ch07/074-skillcomposer)
- [075. Building and connecting a production-ready ecommerce MCP server using Amazon Bedrock AgentCore and Mistral AI Studio](ch07/075-building-and-connecting-a-production-ready-ecommerce-mcp-ser)
- [076. Create Custom MCP Catalogs and Profiles](ch07/076-create-custom-mcp-catalogs-and-profiles)
- [077. PagePilot — PC端AI测试Skill设计与实战](ch07/077-pagepilot-pc-ai-skill)
- [078. 25个Skills详解：从生产力清单到AI工作流资产](ch07/078-25-skills-ai)
- [079. Perplexity 首次公开了内部 Skill 设计指南](ch07/079-perplexity-skill)
- [080. Codex Record & Replay：GUI 演示到可复用 Skill 的工作流捕获](ch07/080-codex-record-replay-gui-skill)
- [081. 一份可信来源，终结 Skill 管理混乱：Skill 治理最佳实践](ch07/081-skill-skill)
- [082. 让Skill“有图可依”：openJiuwen首发多模态Skill范式Skill-Omni](ch07/082-skill-openjiuwen-skill-skill-omni)
- [083. Microsoft Agent Framework Tools 总览：4 类工具 + Provider 矩阵 + Tool Approval](ch07/083-microsoft-agent-framework-tools-4-provider-tool-ap)
