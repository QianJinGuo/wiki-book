...
## 相关概念
- LLM Artifact Optimization — 文本/制品进化优化专题
- [AlphaEvolve](/ch01-466-alphaevolve-a-coding-agent-for-scientific-and-algorithmic-d/) — DeepMind 代码进化型科学发现 Agent
- [Agent Memory 模块化框架与评测](/ch01-238-agent-memory-模块化框架与评测-memory-in-the-llm-era-4-模块-10-方案对比/) — ICLR 2026 评测基准
- [Skill RAG 清华 SRA](/ch04-430-skill-retrieval-augmentation-for-agentic-ai-清华-skill-rag/) — 技能增强型检索
...
## 相关实体
- [2026年最值得关注的15款开发者工具你用过几个](/ch01-483-2026年最值得关注的15款开发者工具-你用过几个/)

→ [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/2026.md)

- [原文存档](https://github.com/QianJinGuo/wiki/blob/main/raw/articles/gepa-optimize-anything-universal-text-optimization.md)
- [腾讯研究院Ai速递 20260507](/ch01-671-腾讯研究院ai速递-20260507/)
- [Karpathy Ai Agent 7 Bits Value Decline 2026 Allentan](/ch04-142-karpathy-怎么看-ai-agent-七-当程序员贡献的-bits-越来越少-什么技能还值钱/)
- [Kasra Blog Llm Hacking Empirical Test](/ch01-380-kasra-blog-llm-agent-黑客能力实测-usd-1500-投石问路-14-模型/)
- [Hermes Agent V014 Architecture Shugex](/ch01-806-简单接口-返回最终响应字符串/)
## 与 Hermes Agent Skill 互优化的关联

**[Hermes Agent Skill 互优化](/ch04-041-hermes-agent-skill-互优化-skillevolver-darwin-embodiskill-4/)**（KK大叔 4 轮互优化实验，2026-06）是 GEPA 通用优化方法论在 **Skill 自进化场景**的具体落地。
